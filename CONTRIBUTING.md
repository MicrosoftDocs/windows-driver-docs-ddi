...
The reference docs are generated by merging the syntax block from Windows headers with descriptions and remarks stored in the *.md files in this repo.
Because the API surface (signature, requirements) is auto-generated, changes to the following sections will be discarded:   
...
If you would like to provide feedback rather than suggesting a change to documentation, [create an issue](https://github.com/MicrosoftDocs/windows-driver-docs-ddi/issues).
