...
ms.date: 2/22/2018
ms.keywords: audmp-routines_66106418-566d-4203-a6d6-faae74a6db13.xml, audio.idrmaudiostream_setcontentid, SetContentId, IDrmAudioStream::SetContentId, SetContentId method [Audio Devices], IDrmAudioStream interface, IDrmAudioStream interface [Audio Devices], SetContentId method, IDrmAudioStream, SetContentId method [Audio Devices], drmk/IDrmAudioStream::SetContentId
