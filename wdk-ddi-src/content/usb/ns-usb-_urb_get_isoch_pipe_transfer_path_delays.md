...
ms.date: 2/15/2018
ms.keywords: buses._urb_get_isoch_pipe_transfer_path_delays, _URB_GET_ISOCH_PIPE_TRANSFER_PATH_DELAYS, _URB_GET_ISOCH_PIPE_TRANSFER_PATH_DELAYS structure [Buses], usb/_URB_GET_ISOCH_PIPE_TRANSFER_PATH_DELAYS
