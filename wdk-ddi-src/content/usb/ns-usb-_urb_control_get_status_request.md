...
tech.root: usbref
ms.date: 05/07/2018
keywords: ["URB_CONTROL_GET_STATUS_REQUEST structure"]
...
# _URB_CONTROL_GET_STATUS_REQUEST structure (usb.h)
...
Pointer to a <a href="/windows-hardware/drivers/ddi/usb/ns-usb-_urb_header">_URB_HEADER</a> structure that specifies the URB header information. <b>Hdr.Length</b> must be <code>sizeof(_URB_CONTROL_GET_STATUS_REQUEST)</code>, and <b>Hdr.Function</b> must be one of the following values:
...
Drivers can use the <a href="/windows-hardware/drivers/ddi/usbdlib/nf-usbdlib-usbbuildgetstatusrequest">UsbBuildGetStatusRequest</a> service routine to format this URB.
