...
# WDF_REL_TIMEOUT_IN_US function (wdfcore.h)
...
The following code example starts a timer. The framework will call the timer's <a href="/windows-hardware/drivers/ddi/wdftimer/nc-wdftimer-evt_wdf_timer">EvtTimerFunc</a> callback function after one hundred microseconds. 
...
<a href="/windows-hardware/drivers/ddi/wdfcore/nf-wdfcore-wdf_abs_timeout_in_us">WDF_ABS_TIMEOUT_IN_US</a>
