...
Drivers can use <a href="/windows-hardware/drivers/ddi/wdfcore/nf-wdfcore-wdf_align_size_up">WDF_ALIGN_SIZE_UP</a> or <b>WDF_ALIGN_SIZE_DOWN</b> to calculate a buffer size that is aligned to a specified alignment offset. This calculation is useful if your driver must allocate multiple contiguous buffers, if each buffer must begin at an address alignment boundary.
...
<a href="/windows-hardware/drivers/ddi/wdfcore/nf-wdfcore-wdf_align_size_up">WDF_ALIGN_SIZE_UP</a>
