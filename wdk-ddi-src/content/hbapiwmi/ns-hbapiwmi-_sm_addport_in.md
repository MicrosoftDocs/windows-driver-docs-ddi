...
ms.date: 1/10/2018
ms.keywords: PSM_AddPort_IN, *PSM_AddPort_IN, structs-Fibre_c9c9fceb-e4ec-414c-98f8-e9867b69add5.xml, PSM_AddPort_IN structure pointer [Storage Devices], SM_AddPort_IN, storage.sm_addport_in, hbapiwmi/SM_AddPort_IN, hbapiwmi/PSM_AddPort_IN, _SM_AddPort_IN, SM_AddPort_IN structure [Storage Devices]
