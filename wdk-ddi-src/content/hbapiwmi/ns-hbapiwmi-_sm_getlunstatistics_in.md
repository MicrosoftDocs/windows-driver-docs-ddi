...
ms.date: 1/10/2018
ms.keywords: PSM_GetLUNStatistics_IN, SM_GetLUNStatistics_IN, *PSM_GetLUNStatistics_IN, hbapiwmi/SM_GetLUNStatistics_IN, SM_GetLUNStatistics_IN structure [Storage Devices], _SM_GetLUNStatistics_IN, PSM_GetLUNStatistics_IN structure pointer [Storage Devices], structs-Fibre_537f91a2-0183-4e6d-a3ef-22474349e6e7.xml, storage.sm_getlunstatistics_in, hbapiwmi/PSM_GetLUNStatistics_IN
