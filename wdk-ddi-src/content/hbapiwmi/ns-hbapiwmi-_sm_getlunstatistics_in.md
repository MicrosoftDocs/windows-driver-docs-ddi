...
ms.date: 1/10/2018
ms.keywords: SM_GetLUNStatistics_IN structure [Storage Devices], hbapiwmi/SM_GetLUNStatistics_IN, *PSM_GetLUNStatistics_IN, structs-Fibre_537f91a2-0183-4e6d-a3ef-22474349e6e7.xml, _SM_GetLUNStatistics_IN, PSM_GetLUNStatistics_IN structure pointer [Storage Devices], SM_GetLUNStatistics_IN, hbapiwmi/PSM_GetLUNStatistics_IN, storage.sm_getlunstatistics_in, PSM_GetLUNStatistics_IN
