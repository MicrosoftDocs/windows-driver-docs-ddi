...
ms.date: 1/10/2018
ms.keywords: storage.scsireadcapacity_out2, hbapiwmi/PScsiReadCapacity_OUT, ScsiReadCapacity_OUT, PScsiReadCapacity_OUT structure pointer [Storage Devices], hbapiwmi/ScsiReadCapacity_OUT, structs-Fibre_b362afaf-6cf2-4e2b-9239-11d7fdec3d74.xml, ScsiReadCapacity_OUT structure [Storage Devices], *PScsiReadCapacity_OUT, _ScsiReadCapacity_OUT, PScsiReadCapacity_OUT
