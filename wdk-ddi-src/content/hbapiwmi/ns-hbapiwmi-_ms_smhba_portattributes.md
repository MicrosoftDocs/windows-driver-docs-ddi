...
ms.date: 2/16/2018
ms.keywords: MS_SMHBA_PORTATTRIBUTES structure [Storage Devices], structs-Fibre_66af1ae7-5db4-4dd3-bacc-0665dd757660.xml, hbapiwmi/MS_SMHBA_PORTATTRIBUTES, storage.ms_smhba_portattributes, *PMS_SMHBA_PORTATTRIBUTES, PMS_SMHBA_PORTATTRIBUTES structure pointer [Storage Devices], _MS_SMHBA_PORTATTRIBUTES, PMS_SMHBA_PORTATTRIBUTES, MS_SMHBA_PORTATTRIBUTES, hbapiwmi/PMS_SMHBA_PORTATTRIBUTES
