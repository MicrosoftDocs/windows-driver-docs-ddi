...
The RemoveTarget_OUT structure is used by an HBA miniport driver to report the output parameter data of the <a href="/windows-hardware/drivers/storage/removetarget">RemoveTarget</a> WMI method to the WMI client.
...
The WMI tool suite generates a declaration of the RemoveTarget_OUT structure in <i>Hbapiwmi.h </i>when it compiles the <a href="/windows-hardware/drivers/storage/msfc-eventcontrol-wmi-class">MSFC_EventControl WMI Class</a>.
