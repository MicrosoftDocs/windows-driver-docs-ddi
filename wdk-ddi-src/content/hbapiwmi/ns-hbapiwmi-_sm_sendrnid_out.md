...
ms.date: 1/10/2018
ms.keywords: PSM_SendRNID_OUT structure pointer [Storage Devices], structs-Fibre_9e6a1fff-df92-4d26-af84-b99b9feecbef.xml, *PSM_SendRNID_OUT, hbapiwmi/PSM_SendRNID_OUT, _SM_SendRNID_OUT, PSM_SendRNID_OUT, hbapiwmi/SM_SendRNID_OUT, SM_SendRNID_OUT structure [Storage Devices], storage.sm_sendrnid_out, SM_SendRNID_OUT
