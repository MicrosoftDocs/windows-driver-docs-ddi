...
ms.date: 1/10/2018
ms.keywords: storage.sm_sendrnid_out, structs-Fibre_9e6a1fff-df92-4d26-af84-b99b9feecbef.xml, _SM_SendRNID_OUT, hbapiwmi/PSM_SendRNID_OUT, PSM_SendRNID_OUT, hbapiwmi/SM_SendRNID_OUT, PSM_SendRNID_OUT structure pointer [Storage Devices], SM_SendRNID_OUT structure [Storage Devices], *PSM_SendRNID_OUT, SM_SendRNID_OUT
