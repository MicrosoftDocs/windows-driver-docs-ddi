...
ms.date: 1/10/2018
ms.keywords: storage.sm_setrnidmgmtinfo_in, _SM_SetRNIDMgmtInfo_IN, hbapiwmi/PSM_SetRNIDMgmtInfo_IN, SM_SetRNIDMgmtInfo_IN, *PSM_SetRNIDMgmtInfo_IN, structs-Fibre_1da5987a-4759-4d2a-9e33-5c33123314fc.xml, SM_SetRNIDMgmtInfo_IN structure [Storage Devices], PSM_SetRNIDMgmtInfo_IN structure pointer [Storage Devices], hbapiwmi/SM_SetRNIDMgmtInfo_IN, PSM_SetRNIDMgmtInfo_IN
