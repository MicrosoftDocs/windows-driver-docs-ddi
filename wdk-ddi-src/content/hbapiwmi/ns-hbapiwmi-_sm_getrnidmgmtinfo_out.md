...
ms.date: 1/10/2018
ms.keywords: SM_GetRNIDMgmtInfo_OUT structure [Storage Devices], SM_GetRNIDMgmtInfo_OUT, *PSM_GetRNIDMgmtInfo_OUT, hbapiwmi/SM_GetRNIDMgmtInfo_OUT, PSM_GetRNIDMgmtInfo_OUT, storage.sm_getrnidmgmtinfo_out, PSM_GetRNIDMgmtInfo_OUT structure pointer [Storage Devices], hbapiwmi/PSM_GetRNIDMgmtInfo_OUT, _SM_GetRNIDMgmtInfo_OUT, structs-Fibre_c5f33dc4-bde0-43bb-8528-9cb2e0d2ee3f.xml
