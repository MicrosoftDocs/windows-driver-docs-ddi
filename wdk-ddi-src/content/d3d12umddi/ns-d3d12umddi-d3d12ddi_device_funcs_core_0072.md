---
UID: NS:d3d12umddi.D3D12DDI_DEVICE_FUNCS_CORE_0072
title: D3D12DDI_DEVICE_FUNCS_CORE_0072
ms.date: 03/24/2020
targetos: Windows
tech.root: display
description: Core device functions available in D3D12 Release 7, Build rev 2.
...
req.target-type: 
req.typenames: D3D12DDI_DEVICE_FUNCS_CORE_0072
req.umdf-ver: 
req.unicode-ansi: 
topic_type:
 - apiref
...
# D3D12DDI_DEVICE_FUNCS_CORE_0072 structure (d3d12umddi.h)
