...
description: The PFND3D12DDI_CALC_PRIVATE_SHADER_SIZE_0026 callback function determines the size of the user-mode display driver's private region of memory (that is, the size of internal driver structures, not the size of the resource video memory) for a shader.
tech.root: display
ms.date: 11/28/2018
