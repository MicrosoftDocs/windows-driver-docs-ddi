...
description: PFND3D12DDI_CALCPRIVATEELEMENTLAYOUTSIZE_0010 determines the size of the private memory region used by the user-mode display driver for an element layout.
ms.date: 10/19/2018
