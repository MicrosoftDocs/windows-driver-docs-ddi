---
UID: NS:d3d12umddi.D3D12DDI_D3D12_OPTIONS_DATA_0080
tech.root: display
title: D3D12DDI_D3D12_OPTIONS_DATA_0080
ms.date: 05/13/2021
targetos: Windows
description: The D3D12DDI_D3D12_OPTIONS_DATA_0080 structure contains display options data supported by the driver/hardware.
...
req.target-type: 
req.typenames: D3D12DDI_D3D12_OPTIONS_DATA_0080
req.umdf-ver: 
req.unicode-ansi: 
topic_type:
 - apiref
...
f1_keywords:
 - D3D12DDI_D3D12_OPTIONS_DATA_0080
 - d3d12umddi/D3D12DDI_D3D12_OPTIONS_DATA_0080
dev_langs:
 - c++
---

# D3D12DDI_D3D12_OPTIONS_DATA_0080 structure (d3d12umddi.h)
