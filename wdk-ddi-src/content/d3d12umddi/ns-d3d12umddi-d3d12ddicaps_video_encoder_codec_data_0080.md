---
UID: NS:d3d12umddi.D3D12DDICAPS_VIDEO_ENCODER_CODEC_DATA_0080
tech.root: display
title: D3D12DDICAPS_VIDEO_ENCODER_CODEC_DATA_0080
ms.date: 02/16/2022
targetos: Windows
description: Learn more about the D3D12DDICAPS_VIDEO_ENCODER_CODEC_DATA_0080 structure.
prerelease: false
...
req.target-type: 
req.typenames: D3D12DDICAPS_VIDEO_ENCODER_CODEC_DATA_0080
req.umdf-ver: 
req.unicode-ansi: 
topic_type:
 - apiref
...
f1_keywords:
 - D3D12DDICAPS_VIDEO_ENCODER_CODEC_DATA_0080
 - d3d12umddi/D3D12DDICAPS_VIDEO_ENCODER_CODEC_DATA_0080
dev_langs:
 - c++
helpviewer_keywords:
 - D3D12DDICAPS_VIDEO_ENCODER_CODEC_DATA_0080
...
The D3D runtime calls [**PFND3D12DDI_VIDEO_GETCAPS**](nc-d3d12umddi-pfnd3d12ddi_video_getcaps.md) with [**D3D12DDICAPS_TYPE_VIDEO_0080_ENCODER_CODEC**](ne-d3d12umddi-d3d12ddicaps_type_video_0020.md) specified as the capability type.
