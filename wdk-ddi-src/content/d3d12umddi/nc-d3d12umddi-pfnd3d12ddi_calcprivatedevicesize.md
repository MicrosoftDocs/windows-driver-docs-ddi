...
description: The PFND3D12DDI_CALCPRIVATEDEVICESIZE callback function determines the size of a memory region that the user-mode display driver requires from the Microsoft Direct3D runtime to store frequently-accessed data.
tech.root: display
ms.date: 11/28/2018
