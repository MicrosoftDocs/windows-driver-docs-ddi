...
description: PFND3D12DDI_CALCPRIVATEBLENDSTATESIZE determines the size of the private memory region used by the user-mode display driver for a blend state.
tech.root: display
ms.date: 11/28/2018
