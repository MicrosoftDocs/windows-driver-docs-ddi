...
ms.date: 10/19/2018
keywords: ["D3D12DDIARG_TEX1D_RENDER_TARGET_VIEW structure"]
...
req.unicode-ansi: 
req.max-support: 
req.typenames: D3D12DDIARG_TEX1D_RENDER_TARGET_VIEW
targetos: Windows
ms.custom: RS5
tech.root: display
f1_keywords:
...
# D3D12DDIARG_TEX1D_RENDER_TARGET_VIEW structure (d3d12umddi.h)
