---
UID: NS:d3d12umddi.D3D12DDI_RENDER_PASS_BEGINNING_ACCESS_PRESERVE_LOCAL_PARAMETERS_0101
tech.root: display
title: D3D12DDI_RENDER_PASS_BEGINNING_ACCESS_PRESERVE_LOCAL_PARAMETERS_0101
ms.date: 03/28/2025
targetos: Windows
description: Learn more about the D3D12DDI_RENDER_PASS_BEGINNING_ACCESS_PRESERVE_LOCAL_PARAMETERS_0101 structure.
prerelease: false
...
req.target-type: 
req.typenames: D3D12DDI_RENDER_PASS_BEGINNING_ACCESS_PRESERVE_LOCAL_PARAMETERS_0101
...
f1_keywords:
 - D3D12DDI_RENDER_PASS_BEGINNING_ACCESS_PRESERVE_LOCAL_PARAMETERS_0101
 - d3d12umddi/D3D12DDI_RENDER_PASS_BEGINNING_ACCESS_PRESERVE_LOCAL_PARAMETERS_0101
dev_langs:
 - c++
helpviewer_keywords:
 - D3D12DDI_RENDER_PASS_BEGINNING_ACCESS_PRESERVE_LOCAL_PARAMETERS_0101
...
This structure is used when the beginning access [**Type**](ns-d3d12umddi-d3d12ddi_render_pass_beginning_access_0053.md) for a resource within a render pass is one of the following values. For each of these types, the end of the previous pass must specify the matching [**D3D12DDI_RENDER_PASS_ENDING_ACCESS_TYPE_0053_PRESERVE_LOCAL_*XXX***](ne-d3d12umddi-d3d12ddi_render_pass_ending_access_type_0053.md) value and the same **AdditionalWidth**/**AdditionalHeight** parameters.
