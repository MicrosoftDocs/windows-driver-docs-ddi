...
title: D3D12DDIARG_TEX1D_UNORDERED_ACCESS_VIEW (d3d12umddi.h)
description: Describes a one-dimensional (1-D) texture that is used to create an unordered access view.
ms.date: 10/19/2018
keywords: ["D3D12DDIARG_TEX1D_UNORDERED_ACCESS_VIEW structure"]
...
f1_keywords:
 ...
 - d3d12umddi/D3D12DDIARG_TEX1D_UNORDERED_ACCESS_VIEW
topic_type:
 - apiref
api_type:
 - HeaderDef
...
# D3D12DDIARG_TEX1D_UNORDERED_ACCESS_VIEW structure (d3d12umddi.h)
