...
description: PFND3D12DDI_CALCPRIVATEBLENDSTATESIZE_0010 determines the size of the private memory region used by the user-mode display driver for a blend state.
ms.date: 10/19/2018
