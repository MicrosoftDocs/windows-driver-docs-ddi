...
description: The PFND3D12DDI_CALCPRIVATEBLENDSTATESIZE_0010 callback function determines the size of the user-mode display driver's private region of memory (that is, the size of internal driver structures, not the size of the resource video memory) for a blend state.
ms.date: 10/19/2018
