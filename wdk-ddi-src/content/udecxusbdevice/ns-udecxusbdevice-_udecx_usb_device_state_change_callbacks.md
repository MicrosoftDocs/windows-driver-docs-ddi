...
ms.date: 2/15/2018
ms.keywords: PUDECX_USB_DEVICE_STATE_CHANGE_CALLBACKS structure pointer [Buses], udecxusbdevice/UDECX_USB_DEVICE_STATE_CHANGE_CALLBACKS, _UDECX_USB_DEVICE_STATE_CHANGE_CALLBACKS, UDECX_USB_DEVICE_STATE_CHANGE_CALLBACKS, UDECX_USB_DEVICE_STATE_CHANGE_CALLBACKS structure [Buses], PUDECX_USB_DEVICE_STATE_CHANGE_CALLBACKS, buses.udecx_usb_device_state_change_callbacks, *PUDECX_USB_DEVICE_STATE_CHANGE_CALLBACKS, udecxusbdevice/PUDECX_USB_DEVICE_STATE_CHANGE_CALLBACKS
