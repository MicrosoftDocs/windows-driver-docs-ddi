...
tech.root: usbref
ms.date: 05/07/2018
keywords: ["UDECX_USB_ENDPOINT_INIT_AND_METADATA structure"]
...
f1_keywords:
 ...
 - udecxusbdevice/_UDECX_USB_ENDPOINT_INIT_AND_METADATA
 - PUDECX_USB_ENDPOINT_INIT_AND_METADATA
 - udecxusbdevice/PUDECX_USB_ENDPOINT_INIT_AND_METADATA
...
A pointer to a <b>UDECXUSBDEVICE_INIT</b> structure that contains initialization parameters for the virtual USB device. The client driver retrieved this pointer in the previous call to <a href="/windows-hardware/drivers/ddi/udecxusbdevice/nf-udecxusbdevice-udecxusbdeviceinitallocate">UdecxUsbDeviceInitAllocate</a>.
...
Required. A buffer containing the endpoint descriptor. The descriptor is described in a <a href="/windows-hardware/drivers/ddi/usbspec/ns-usbspec-_usb_endpoint_descriptor">USB_ENDPOINT_DESCRIPTOR</a> structure.

### -field SuperSpeedEndpointCompanionDescriptor

Optional. A USB-defined SuperSpeed Endpoint Companion descriptor. For more information, see section 9.6.7 and Table 9-20 in the official USB 3.0 specification. The descriptor is described in a <a href="/windows-hardware/drivers/ddi/usbspec/ns-usbspec-_usb_superspeed_endpoint_companion_descriptor">USB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR</a> structure.
