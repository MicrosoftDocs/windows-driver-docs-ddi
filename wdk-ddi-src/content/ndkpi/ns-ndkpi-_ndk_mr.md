...
ms.date: 2/16/2018
ms.keywords: PNDK_MR, NDK_MR structure [Network Drivers Starting with Windows Vista], PNDK_MR structure pointer [Network Drivers Starting with Windows Vista], ndkpi/NDK_MR, NDK_MR, ndkpi/PNDK_MR, _NDK_MR, netvista.ndk_mr
