...
ms.date: 1/18/2018
ms.keywords: netvista.ndk_mr, NDK_MR, _NDK_MR, ndkpi/PNDK_MR, PNDK_MR, PNDK_MR structure pointer [Network Drivers Starting with Windows Vista], NDK_MR structure [Network Drivers Starting with Windows Vista], ndkpi/NDK_MR
