...
ms.date: 1/18/2018
ms.keywords: NDK_OBJECT_HEADER structure [Network Drivers Starting with Windows Vista], _NDK_OBJECT_HEADER, PNDK_OBJECT_HEADER, ndkpi/PNDK_OBJECT_HEADER, PNDK_OBJECT_HEADER structure pointer [Network Drivers Starting with Windows Vista], ndkpi/NDK_OBJECT_HEADER, NDK_OBJECT_HEADER, netvista.ndk_object_header
