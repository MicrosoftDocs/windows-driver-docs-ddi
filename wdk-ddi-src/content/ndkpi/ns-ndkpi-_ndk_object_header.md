...
ms.date: 1/18/2018
ms.keywords: PNDK_OBJECT_HEADER, ndkpi/PNDK_OBJECT_HEADER, ndkpi/NDK_OBJECT_HEADER, NDK_OBJECT_HEADER, netvista.ndk_object_header, NDK_OBJECT_HEADER structure [Network Drivers Starting with Windows Vista], PNDK_OBJECT_HEADER structure pointer [Network Drivers Starting with Windows Vista], _NDK_OBJECT_HEADER
