...
ms.date: 1/18/2018
ms.keywords: NDK_CQ structure [Network Drivers Starting with Windows Vista], netvista.ndk_cq, NDK_CQ, ndkpi/NDK_CQ, _NDK_CQ, PNDK_CQ structure pointer [Network Drivers Starting with Windows Vista], ndkpi/PNDK_CQ, PNDK_CQ
