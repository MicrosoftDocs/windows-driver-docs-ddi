...
ms.date: 1/18/2018
ms.keywords: NDK_CQ, NDK_CQ structure [Network Drivers Starting with Windows Vista], ndkpi/NDK_CQ, PNDK_CQ, ndkpi/PNDK_CQ, _NDK_CQ, netvista.ndk_cq, PNDK_CQ structure pointer [Network Drivers Starting with Windows Vista]
