...
ms.date: 1/18/2018
ms.keywords: netvista.ndk_mw_dispatch, ndkpi/NDK_MW_DISPATCH, _NDK_MW_DISPATCH, PNDK_MW_DISPATCH structure pointer [Network Drivers Starting with Windows Vista], NDK_MW_DISPATCH structure [Network Drivers Starting with Windows Vista], PNDK_MW_DISPATCH, ndkpi/PNDK_MW_DISPATCH, NDK_MW_DISPATCH
