...
ms.date: 2/16/2018
ms.keywords: ndkpi/NDK_PD_DISPATCH, NDK_PD_DISPATCH structure [Network Drivers Starting with Windows Vista], _NDK_PD_DISPATCH, NDK_PD_DISPATCH, netvista.ndk_pd_dispatch
