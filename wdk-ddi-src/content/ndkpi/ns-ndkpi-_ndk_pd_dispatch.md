...
ms.date: 2/16/2018
ms.keywords: ",  , ,, A, C, D, H, I, K, N, NDK_PD_DISPATCH, NDK_PD_DISPATCH structure [Network Drivers Starting with Windows Vista], P, S, T, _, _NDK_PD_DISPATCH, ndkpi/NDK_PD_DISPATCH, netvista.ndk_pd_dispatch"
