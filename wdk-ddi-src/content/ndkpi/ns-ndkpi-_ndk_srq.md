...
ms.date: 1/18/2018
ms.keywords: NDK_SRQ structure [Network Drivers Starting with Windows Vista], ndkpi/PNDK_SRQ, NDK_SRQ, _NDK_SRQ, PNDK_SRQ structure pointer [Network Drivers Starting with Windows Vista], netvista.ndk_srq, ndkpi/NDK_SRQ, PNDK_SRQ
