...
ms.date: 1/18/2018
ms.keywords: ndkpi/NDK_SRQ, _NDK_SRQ, NDK_SRQ, PNDK_SRQ, PNDK_SRQ structure pointer [Network Drivers Starting with Windows Vista], netvista.ndk_srq, ndkpi/PNDK_SRQ, NDK_SRQ structure [Network Drivers Starting with Windows Vista]
