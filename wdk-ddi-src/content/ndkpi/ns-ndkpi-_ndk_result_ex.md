...
ms.date: 2/16/2018
ms.keywords: netvista.ndk_result_ex, PNDK_RESULT_EX structure pointer [Network Drivers Starting with Windows Vista], ndkpi/PNDK_RESULT_EX, NDK_RESULT_EX structure [Network Drivers Starting with Windows Vista], PNDK_RESULT_EX, _NDK_RESULT_EX, NDK_RESULT_EX, ndkpi/NDK_RESULT_EX
