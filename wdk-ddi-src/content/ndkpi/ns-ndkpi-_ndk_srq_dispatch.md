...
ms.date: 2/16/2018
ms.keywords: netvista.ndk_srq_dispatch, _NDK_SRQ_DISPATCH, NDK_SRQ_DISPATCH structure [Network Drivers Starting with Windows Vista], ndkpi/NDK_SRQ_DISPATCH, NDK_SRQ_DISPATCH
