...
ms.date: 2/16/2018
ms.keywords: PNDK_EXTENSION_INTERFACE structure pointer [Network Drivers Starting with Windows Vista], PNDK_EXTENSION_INTERFACE, NDK_EXTENSION_INTERFACE, NDK_EXTENSION_INTERFACE structure [Network Drivers Starting with Windows Vista], netvista.ndk_extension_interface, _NDK_EXTENSION_INTERFACE, ndkpi/PNDK_EXTENSION_INTERFACE, ndkpi/NDK_EXTENSION_INTERFACE
