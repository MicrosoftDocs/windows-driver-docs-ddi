...
f1_keywords:
 ...
 - ndkpi/NDK_FN_CONNECT_WITH_SHARED_ENDPOINT
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
[in]
A pointer to an NDK queue pair (QP) object (<a href="/windows-hardware/drivers/ddi/ndkpi/ns-ndkpi-_ndk_qp">NDK_QP</a>) to be associated with the connection.
