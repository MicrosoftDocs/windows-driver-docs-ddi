...
ms.date: 1/18/2018
ms.keywords: NDK_PD, ndkpi/NDK_PD, _NDK_PD, ndkpi/PNDK_PD, NDK_PD structure [Network Drivers Starting with Windows Vista], netvista.ndk_pd, PNDK_PD, PNDK_PD structure pointer [Network Drivers Starting with Windows Vista]
