...
ms.date: 2/15/2018
ms.keywords: COMPOSITE_DEVICE_CAPABILITIES_INIT routine [Buses], usbdlib/COMPOSITE_DEVICE_CAPABILITIES_INIT, COMPOSITE_DEVICE_CAPABILITIES_INIT, buses.composite_driver_capabilities_init
