...
ms.date: 1/4/2018
ms.keywords: PREGISTER_COMPOSITE_DEVICE, usbdlib/REGISTER_COMPOSITE_DEVICE, _REGISTER_COMPOSITE_DEVICE, REGISTER_COMPOSITE_DEVICE, *PREGISTER_COMPOSITE_DEVICE, PREGISTER_COMPOSITE_DEVICE structure pointer [Buses], REGISTER_COMPOSITE_DEVICE structure [Buses], usbdlib/PREGISTER_COMPOSITE_DEVICE, buses.register_composite_driver
