...
TBD - The ACX_AUDIOENGINE_CONFIG_INIT_ID function initializes an TBD TBD TBD [ACX_AUDIOENGINE_CONFIG](ns-acxelements-acx_audioengine_config.md) structure.

It is different from [ACX_AUDIOENGINE_CONFIG_INIT](nf-acxelements-acx_audioengine_config_init.md) function in that and Id is TBD TBD TBD.
