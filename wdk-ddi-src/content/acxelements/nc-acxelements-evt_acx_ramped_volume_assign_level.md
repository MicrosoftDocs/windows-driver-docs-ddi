...
ms.date: 09/16/2021
targetos: Windows
description: TBD - EVT_ACX_RAMPED_VOLUME_ASSIGN_LEVEL tells the driver that request to assign the ramped volume level has made???.
prerelease: true
req.assembly: 
...
TBD - EVT_ACX_RAMPED_VOLUME_ASSIGN_LEVEL tells the driver that request to assign the ramped volume level has made???.
