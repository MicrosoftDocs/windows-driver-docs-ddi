...
description: "Microsoft reserves the RILGETTOKENPARAMMASK enumeration for internal use only. Don't use this enumeration in your code."
...
# RILGETTOKENPARAMMASK enumeration (oemrilapitypes.h)
