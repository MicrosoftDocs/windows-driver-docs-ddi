...
description: "Microsoft reserves the RILGBACAPABLE enumeration for internal use only. Don't use this enumeration in your code."
...
# RILGBACAPABLE enumeration (oemrilapitypes.h)
