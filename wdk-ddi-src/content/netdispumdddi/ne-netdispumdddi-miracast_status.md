...
ms.date: 12/29/2017
ms.keywords: MIRACAST_STATUS_CRITICAL_ERROR, netdispumdddi/MIRACAST_STATUS_SINK_FAILED_STANDARD_MODE_CHANGE, MIRACAST_STATUS_SINK_DISOCNNECT_REQUEST, netdispumdddi/MIRACAST_STATUS, netdispumdddi/MIRACAST_STATUS_MISSING_KEEPALIVE, MIRACAST_STATUS_SINK_FAILED_STANDARD_MODE_CHANGE, netdispumdddi/MIRACAST_STATUS_INSUFFICIENT_BANDWIDTH, netdispumdddi/MIRACAST_STATUS_FORCE_UINT32, netdispumdddi/MIRACAST_STATUS_SINK_DISOCNNECT_REQUEST, MIRACAST_STATUS enumeration [Display Devices], MIRACAST_STATUS_FORCE_UINT32, MIRACAST_STATUS_INSUFFICIENT_BANDWIDTH, MIRACAST_STATUS_MISSING_KEEPALIVE, display.miracast_status, MIRACAST_STATUS, netdispumdddi/MIRACAST_STATUS_CRITICAL_ERROR
