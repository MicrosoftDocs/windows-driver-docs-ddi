...
ms.date: 2/22/2018
ms.keywords: display.miracast_driver_interface, netdispumdddi/MIRACAST_DRIVER_INTERFACE, MIRACAST_DRIVER_INTERFACE, _MIRACAST_DRIVER_INTERFACE, PMIRACAST_DRIVER_INTERFACE structure pointer [Display Devices], MIRACAST_DRIVER_INTERFACE structure [Display Devices], PMIRACAST_DRIVER_INTERFACE, *PMIRACAST_DRIVER_INTERFACE, netdispumdddi/PMIRACAST_DRIVER_INTERFACE
