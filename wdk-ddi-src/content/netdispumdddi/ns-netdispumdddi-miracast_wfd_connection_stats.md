...
ms.date: 12/29/2017
ms.keywords: display.miracast_wfd_connection_stats, MIRACAST_WFD_CONNECTION_STATS structure [Display Devices], MIRACAST_WFD_CONNECTION_STATS, netdispumdddi/MIRACAST_WFD_CONNECTION_STATS
