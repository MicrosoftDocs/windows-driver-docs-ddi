...
ms.date: 09/10/2021
targetos: Windows
description: The WifiPowerOffloadGetAdapter function gets the net adapter for a Wi-Fi low power protocol offload.
req.assembly: 
...
The **WifiPowerOffloadGetAdapter** function gets the net adapter for a Wi-Fi low power protocol offload.
...
Returns the NETADAPTER object that represents the net adapter for this power offload.
