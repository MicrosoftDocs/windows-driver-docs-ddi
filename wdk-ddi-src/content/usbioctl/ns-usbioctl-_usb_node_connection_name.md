...
ms.date: 1/4/2018
ms.keywords: USB_NODE_CONNECTION_NAME, usbstrct_51cb29d4-aac8-4138-bddd-908f9859bad3.xml, PUSB_NODE_CONNECTION_NAME structure pointer [Buses], *PUSB_NODE_CONNECTION_NAME, usbioctl/USB_NODE_CONNECTION_NAME, buses.usb_node_connection_name, USB_NODE_CONNECTION_NAME structure [Buses], usbioctl/PUSB_NODE_CONNECTION_NAME, PUSB_NODE_CONNECTION_NAME, _USB_NODE_CONNECTION_NAME
