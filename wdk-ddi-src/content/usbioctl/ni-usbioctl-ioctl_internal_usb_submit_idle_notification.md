...
For additional information, see [Supporting Devices that Have Wake-Up Capabilities](/windows-hardware/drivers/kernel/supporting-devices-that-have-wake-up-capabilities) and [USB Selective Suspend](/windows-hardware/drivers/usbcon/usb-selective-suspend).
