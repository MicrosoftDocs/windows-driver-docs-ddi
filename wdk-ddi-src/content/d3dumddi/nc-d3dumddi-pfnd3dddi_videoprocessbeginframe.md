...
f1_keywords:
 ...
 - d3dumddi/PFND3DDDI_VIDEOPROCESSBEGINFRAME
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The <i>VideoProcessBeginFrame</i> function notifies the user-mode display driver that its <a href="/windows-hardware/drivers/ddi/d3dumddi/nc-d3dumddi-pfnd3dddi_videoprocessblt">VideoProcessBlt</a> function can be called on the specified video processing device.
