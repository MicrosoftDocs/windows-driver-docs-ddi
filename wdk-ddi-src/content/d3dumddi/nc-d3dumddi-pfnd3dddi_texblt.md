...
ms.date: 05/10/2018
keywords: ["PFND3DDDI_TEXBLT callback function"]
...
A pointer to a <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dumddi/ns-d3dumddi-_d3dddiarg_texblt">D3DDDIARG_TEXBLT</a> structure that defines the parameters for the texture bitblt operation.
...
To copy an arbitrary level of a MIP-map texture, the runtime calls the driver's <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dumddi/nc-d3dumddi-pfnd3dddi_blt">Blt</a> function instead.
...
<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dumddi/ns-d3dumddi-_d3dddiarg_texblt">D3DDDIARG_TEXBLT</a>
