...
##### - Operations.FORMATOP_TEXTURE (0x00000001L)

Surfaces of the specified pixel format can be used as MIP-mapped textures.


##### - Operations.FORMATOP_SAME_FORMAT_UP_TO_ALPHA_RENDERTARGET (0x00000100L)
...
##### - Operations.FORMATOP_VIDEO_ENCODER (0x10000000L)
...
##### - Operations.FORMATOP_NOALPHABLEND (0x00200000L)

Surfaces of this format cannot be used with alpha blending.


##### - Operations.FORMATOP_DMAP (0x00020000L)

The displacement map sampler can sample surfaces of this format.


##### - Operations.FORMATOP_SAME_FORMAT_RENDERTARGET (0x00000010L)
...
##### - Operations.FORMATOP_CAPTURE (0x08000000L)
...
##### - Operations.FORMATOP_NOFILTER (0x00040000L)

Surfaces of this format cannot be used with texture filtering.


##### - Operations.FORMATOP_AUTOGENMIPMAP (0x00400000L)
...
##### - Operations.FORMATOP_CONVERT_TO_ARGB (0x00002000L)
...
##### - Operations.FORMATOP_ZSTENCIL_WITH_ARBITRARY_COLOR_DEPTH (0x00000080L)
...
##### - Operations.FORMATOP_SRGBWRITE (0x00100000L)
...
##### - Operations.FORMATOP_PIXELSIZE (0x00001000L)
...
##### - Operations.FORMATOP_VOLUMETEXTURE (0x00000002L)
...
##### - Operations.FORMATOP_SRGBREAD (0x00008000L)
...
##### - Operations.FORMATOP_3DACCELERATION (0x00000800L)
...
##### - Operations.FORMATOP_OFFSCREENPLAIN (0x00004000L)

The driver can stretch to and from and color fill surfaces of this format.


##### - Operations.FORMATOP_MEMBEROFGROUP_ARGB (0x00080000L)
...
##### - Operations.FORMATOP_DISPLAYMODE (0x00000400L)
...
##### - Operations.FORMATOP_BUMPMAP (0x00010000L)
...
##### - Operations.FORMATOP_CUBETEXTURE (0x00000004L)
...
##### - Operations.FORMATOP_ZSTENCIL (0x00000040L)
...
##### - Operations.FORMATOP_NOTEXCOORDWRAPNORMIP (0x01000000L)
...
##### - Operations.FORMATOP_VERTEXTEXTURE (0x00800000L)
...
##### - Operations.FORMATOP_OFFSCREEN_RENDERTARGET (0x00000008L)
...
##### - Operations.FORMATOP_OVERLAY (0x04000000L)

Surfaces of this format are used for overlay operations.


##### - Operations.FORMATOP_PLANAR (0x02000000L)
...
##### - Operations.FORMATOP_MULTIPLANE_OVERLAY (0x20000000L)
