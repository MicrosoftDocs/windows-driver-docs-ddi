...
ms.date: 2/22/2018
ms.keywords: FORMATOP_DMAP (0x00020000L), FORMATOP_TEXTURE (0x00000001L), FORMATOP_NOFILTER (0x00040000L), FORMATOP_OFFSCREENPLAIN (0x00004000L), FORMATOP_VERTEXTEXTURE (0x00800000L), FORMATOP_PIXELSIZE (0x00001000L), FORMATOP, FORMATOP_PLANAR (0x02000000L), FORMATOP_CAPTURE (0x08000000L), FORMATOP_VIDEO_ENCODER (0x10000000L), FORMATOP_AUTOGENMIPMAP (0x00400000L), FORMATOP_DISPLAYMODE (0x00000400L), FORMATOP structure [Display Devices], FORMATOP_OFFSCREEN_RENDERTARGET (0x00000008L), D3D_other_Structs_c60ed644-61b9-4700-8944-131765951138.xml, FORMATOP_SRGBWRITE (0x00100000L), d3dumddi/FORMATOP, FORMATOP_CONVERT_TO_ARGB (0x00002000L), FORMATOP_SAME_FORMAT_UP_TO_ALPHA_RENDERTARGET (0x00000100L), FORMATOP_ZSTENCIL (0x00000040L), FORMATOP_SAME_FORMAT_RENDERTARGET (0x00000010L), FORMATOP_3DACCELERATION (0x00000800L), FORMATOP_VOLUMETEXTURE (0x00000002L), FORMATOP_BUMPMAP (0x00010000L), FORMATOP_SRGBREAD (0x00008000L), _FORMATOP, FORMATOP_NOALPHABLEND (0x00200000L), FORMATOP_ZSTENCIL_WITH_ARBITRARY_COLOR_DEPTH (0x00000080L), FORMATOP_OVERLAY (0x04000000L), FORMATOP_MULTIPLANE_OVERLAY (0x20000000L), FORMATOP_CUBETEXTURE (0x00000004L), FORMATOP_NOTEXCOORDWRAPNORMIP (0x01000000L), FORMATOP_MEMBEROFGROUP_ARGB (0x00080000L), display.formatop
...
<a href="mailto:wsddocfb@microsoft.com?subject=Documentation%20feedback [display\display]:%20FORMATOP structure%20 RELEASE:%20(2/22/2018)&amp;body=%0A%0APRIVACY STATEMENT%0A%0AWe use your feedback to improve the documentation. We don't use your email address for any other purpose, and we'll remove your email address from our system after the issue that you're reporting is fixed. While we're working to fix this issue, we might send you an email message to ask for more info. Later, we might also send you an email message to let you know that we've addressed your feedback.%0A%0AFor more info about Microsoft's privacy policy, see http://privacy.microsoft.com/en-us/default.aspx." title="Send comments about this topic to Microsoft">Send comments about this topic to Microsoft</a>
