...
description: The _D3DDDI_MULTIPLANE_OVERLAY_FEATURE_CAPS enumeration contains values that indicate the capabilites of the overlay plane.
old-location: display\d3dddi_multiplane_overlay_feature_caps.htm
tech.root: display
ms.date: 05/10/2018
keywords: ["D3DDDI_MULTIPLANE_OVERLAY_FEATURE_CAPS enumeration"]
...
f1_keywords:
 ...
 - d3dumddi/_D3DDDI_MULTIPLANE_OVERLAY_FEATURE_CAPS
