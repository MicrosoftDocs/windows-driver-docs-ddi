...
A pointer to a <a href="/windows-hardware/drivers/ddi/d3dumddi/ns-d3dumddi-_d3dddiarg_renderstate">D3DDDIARG_RENDERSTATE</a> structure that describes how to update the render state.
