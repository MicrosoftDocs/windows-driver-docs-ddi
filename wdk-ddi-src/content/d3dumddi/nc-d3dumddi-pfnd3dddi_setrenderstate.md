...
ms.date: 05/10/2018
keywords: ["PFND3DDDI_SETRENDERSTATE callback function"]
...
f1_keywords:
 ...
 - d3dumddi/PFND3DDDI_SETRENDERSTATE
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
A pointer to a <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dumddi/ns-d3dumddi-_d3dddiarg_renderstate">D3DDDIARG_RENDERSTATE</a> structure that describes how to update the render state.
