...
description: The D3DDDICAPS_SHADER_MIN_PRECISION enumeration specifies minimum precision levels that the user-mode driver supports in shaders.
...
# D3DDDICAPS_SHADER_MIN_PRECISION enumeration (d3dumddi.h)
