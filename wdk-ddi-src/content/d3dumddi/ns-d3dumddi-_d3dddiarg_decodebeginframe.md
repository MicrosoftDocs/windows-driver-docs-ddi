...
f1_keywords:
 - _D3DDDIARG_DECODEBEGINFRAME
 - d3dumddi/_D3DDDIARG_DECODEBEGINFRAME
...
A pointer to the <a href="/windows-hardware/drivers/ddi/d3dumddi/ns-d3dumddi-_dxvaddi_pvp_setkey">DXVADDI_PVP_SETKEY</a> structure that contains a key that the driver requires for the decode device to start operating.
