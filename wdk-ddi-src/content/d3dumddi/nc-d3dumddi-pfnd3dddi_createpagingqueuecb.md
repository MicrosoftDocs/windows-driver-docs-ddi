...
A pointer to a <a href="/windows-hardware/drivers/ddi/d3dumddi/ns-d3dumddi-d3dddicb_createpagingqueue">D3DDDICB_CREATEPAGINGQUEUE</a> structure that provides the details of the requested operation.
