...
tech.root: display
ms.date: 05/10/2018
keywords: ["GETENCRYPTIONBLTKEY structure"]
...
# D3DDDIARG_GETENCRYPTIONBLTKEY structure (d3dumddi.h)
...
The _GETENCRYPTIONBLTKEY structure describes an encrypted bit-block transfer (bitblt) session for which the <a href="/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_getencryptionbltkey">GetEncryptionBltKey</a> function retrieves the encryption key.
