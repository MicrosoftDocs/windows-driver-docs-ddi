...
f1_keywords:
 ...
 - d3dumddi/PFND3DDDI_DXVAHD_DESTROYVIDEOPROCESSOR
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
A handle to the DirectX VA video processor that the <a href="/windows-hardware/drivers/ddi/d3dumddi/nc-d3dumddi-pfnd3dddi_dxvahd_createvideoprocessor">CreateVideoProcessor</a> function creates.
...
The <b>DestroyVideoProcessor</b> function notifies the driver to destroy the handle to the DirectX VA video processor that the <a href="/windows-hardware/drivers/ddi/d3dumddi/nc-d3dumddi-pfnd3dddi_dxvahd_createvideoprocessor">CreateVideoProcessor</a> function previously created. The driver can then release resources that are associated with the DirectX VA video processor handle.
