...
description: The D3DDDI_MULTIPLANE_OVERLAY_FLAGS enumeration identifies a flip operation to be performed on an overlay plane.
...
# D3DDDI_MULTIPLANE_OVERLAY_FLAGS enumeration (d3dumddi.h)
