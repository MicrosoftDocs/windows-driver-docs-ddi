...
ms.date: 05/10/2018
keywords: ["DXVAHDDDI_STREAM_STATE_DESTINATION_RECT_DATA structure"]
...
f1_keywords:
 ...
 - d3dumddi/_DXVAHDDDI_STREAM_STATE_DESTINATION_RECT_DATA
...
[in] A <a href="https://docs.microsoft.com/windows/win32/api/windef/ns-windef-tagrect">RECT</a> structure that specifies the coordinates of the destination rectangle relevant to the target rectangle. This member is relevant only when the <b>Enable</b> member is set to <b>TRUE</b>. The default value is empty (0,0,0,0).
