...
ms.date: 2/16/2018
ms.keywords: WdmlibProcgrpInitialize function [Kernel-Mode Driver Architecture], procgrp_ba92a7bb-1a2b-4056-bebd-d9df299768c1.xml, kernel.wdmlibprocgrpinitialize, WdmlibProcgrpInitialize, procgrp/WdmlibProcgrpInitialize
