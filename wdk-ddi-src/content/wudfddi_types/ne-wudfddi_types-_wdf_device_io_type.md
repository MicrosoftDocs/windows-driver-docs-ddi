...
description: Learn that the WDF_DEVICE_IO_TYPE enumeration is used to specify a method for accessing data buffers.
...
# WDF_DEVICE_IO_TYPE enumeration (wudfddi_types.h)
