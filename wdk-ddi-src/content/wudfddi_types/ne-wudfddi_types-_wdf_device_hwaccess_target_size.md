...
description: This enumeration is used internally by the framework. Do not use. This enumeration is defined in wudfddi_types.h.
...
f1_keywords:
 ...
 - wudfddi_types/_WDF_DEVICE_HWACCESS_TARGET_SIZE
 - PWDF_DEVICE_HWACCESS_TARGET_SIZE
 - wudfddi_types/PWDF_DEVICE_HWACCESS_TARGET_SIZE
 - WDF_DEVICE_HWACCESS_TARGET_SIZE
 - wudfddi_types/WDF_DEVICE_HWACCESS_TARGET_SIZE
topic_type:
 - APIRef
 - kbSyntax
api_type:
