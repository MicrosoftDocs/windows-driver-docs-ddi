...
description: Learn how the WDF_TRI_STATE enumeration type defines three values that the framework uses for some structure members and function parameters.
old-location: wdf\wdf_tri_state.htm
tech.root: wdf
ms.date: 02/26/2018
keywords: ["WDF_TRI_STATE enumeration"]
...
f1_keywords:
 - _WDF_TRI_STATE
 - wudfddi_types/_WDF_TRI_STATE
 - PWDF_TRI_STATE
 - wudfddi_types/PWDF_TRI_STATE
 - WDF_TRI_STATE
...
# WDF_TRI_STATE enumeration (wudfddi_types.h)
