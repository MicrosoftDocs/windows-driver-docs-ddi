...
The [**NDIS_OBJECT_HEADER**](../ntddndis/ns-ntddndis-_ndis_object_header.md) structure for the **NDIS_POLL_DATA** structure. Set the members of this structure as follows:
