...
ms.date: 2/16/2018
ms.keywords: EnergyTrackerCreate, wdm/SystemPowerStateNotifyHandler, wdm/SystemExecutionState, UserPresence, wdm/PlmPowerRequestCreate, ProcessorIdleDomains, wdm/ProcessorPowerPolicyDc, wdm/ProcessorInformation, wdm/ProcessorIdleDomains, SystemVideoState, wdm/SystemMonitorHiberBootPowerOff, wdm/GetPowerRequestList, SystemHiberFileSize, wdm/SystemBatteryState, wdm/BatteryDeviceState, wdm/ProcessorIdleStates, ThermalStandby, wdm/UpdateBlackBoxRecorder, SessionPowerCleanup, ProcessorCap, SystemPowerPolicyCurrent, BatteryDeviceState, VerifySystemPolicyAc, SetShutdownSelectedTime, wdm/EnergyTrackerCreate, wdm/ProcessorStateHandler2, ProcessorPerfCapHv, ThermalEvent, TraceApplicationPowerMessage, wdm/ProcessorCap, NotifyUserPowerSetting, PlatformIdleStates, wdm/ProcessorPowerPolicyAc, wdm/LastSleepTime, wdm/TraceServicePowerMessage, wdm/ProcessorSetIdle, wdm/PowerInformationLevelUnused0, wdm/PowerRequestActionInternal, ProcessorPowerPolicyDc, ScreenOff, wdm/VerifySystemPolicyAc, ProcessorLoad, wdm/SystemPowerStateLogging, wdm/SystemPowerStateHandler, SystemPowerCapabilities, wdm/ThermalStandby, FirmwareTableInformationRegistered, wdm/SystemReserveHiberFile, PowerShutdownNotification, wdm/SessionPowerInit, POWER_INFORMATION_LEVEL enumeration [Kernel-Mode Driver Architecture], VerifyProcessorPowerPolicyAc, wdm/ProcessorIdleVeto, SystemWakeSource, wdm/ProcessorStateHandler, wdm/WakeTimerList, wdm/SessionConnectNotification, wdm/SuspendResumeInvocation, wdm/SystemBatteryStatePrecise, wdm/DisplayBurst, wdm/PowerRequestCreate, wdm/ExitLatencySamplingPercentage, wdm/ProcessorLoad, IdleResiliency, wdm/SessionPowerCleanup, SystemHiberFileInformation, wdm/PlatformIdleStates, wdm/SystemHiberFileType, wdm/SessionDisplayState, LastWakeTime, wdm/SystemPowerCapabilities, PlmPowerRequestCreate, wdm/VerifyProcessorPowerPolicyAc, SessionDisplayState, wdm/LogicalProcessorIdling, SystemPowerInformation, wdm/MonitorInvocation, SystemPowerStateNotifyHandler, wdm/PdcInvocation, wdm/MonitorCapabilities, wdm/ProcessorPerfCapHv, AdministratorPowerPolicy, wdm/QueryPotentialDripsConstraint, QueryPotentialDripsConstraint, ProcessorStateHandler, VerifyProcessorPowerPolicyDc, wdm/ProcessorPerfStatesHv, wdm/SetShutdownSelectedTime, SetPowerSettingValue, wdm/SessionLockState, wdm/PowerRequestAction, wdm/PowerShutdownNotification, PlatformRole, MonitorInvocation, SessionConnectNotification, wdm/VerifySystemPolicyDc, wdm/SystemWakeSource, wdm/PlatformRole, wdm/PlatformIdleVeto, wdm/ProcessorPowerPolicyCurrent, wdm/ProcessorPerfStates, PowerRequestAction, wdm/GroupPark, wdm/FirmwareTableInformationRegistered, ProcessorPowerPolicyCurrent, ProcessorInformationEx, SuspendResumeInvocation, SystemBatteryState, ExitLatencySamplingPercentage, PowerInformationInternal, GroupPark, PowerSettingNotificationName, wdm/NotifyUserModeLegacyPowerEvent, ProcessorInformation, TraceApplicationPowerMessageEnd, WakeTimerList, SystemBatteryStatePrecise, PowerInformationLevelUnused0, GetPowerRequestList, SystemPowerPolicyAc, wdm/PowerInformationInternal, SystemMonitorHiberBootPowerOff, wdm/ProcessorIdleStatesHv, wdm/SystemPowerLoggingEntry, MonitorCapabilities, GetPowerSettingValue, wdm/PlatformInformation, wdm/RegisterSpmPowerSettings, wdm/NotifyUserPowerSetting, wdm/LastWakeTime, wdm/SessionRITState, VerifySystemPolicyDc, ProcessorPerfStatesHv, POWER_INFORMATION_LEVEL, wdm/GetPowerSettingValue, SessionPowerInit, wdm/SystemHiberbootState, PlatformIdleVeto, TraceServicePowerMessage, wdm/ScreenOff, SystemPowerStateHandler, wdm/SystemPowerPolicyAc, SystemHiberFileType, SystemPowerStateLogging, wdm/TraceApplicationPowerMessage, wdm/UserPresence, wdm/PhysicalPowerButtonPress, PowerInformationLevelMaximum, PdcInvocation, wdm/CsDeviceNotification, wdm/SetPowerSettingValue, ProcessorStateHandler2, wdm/ProcessorInformationEx, kernel.power_information_level, SystemReserveHiberFile, wdm/SystemPowerInformation, CsDeviceNotification, PhysicalPowerButtonPress, PowerRequestActionInternal, wdm/TraceApplicationPowerMessageEnd, EnergyTrackerQuery, NotifyUserModeLegacyPowerEvent, SystemPowerPolicyDc, wdm/SystemPowerPolicyCurrent, PowerRequestCreate, LastResumePerformance, ProcessorSetIdle, ProcessorPowerPolicyAc, SystemExecutionState, wdm/IdleResiliency, UpdateBlackBoxRecorder, SystemPowerLoggingEntry, wdm/SystemPowerPolicyDc, wdm/ThermalEvent, wdm/LastResumePerformance, SessionLockState, DisplayBurst, RegisterSpmPowerSettings, ProcessorIdleVeto, wdm/SystemHiberFileSize, LogicalProcessorIdling, wdm/AdministratorPowerPolicy, ProcessorPerfStates, wdm/EnergyTrackerQuery, SessionRITState, ProcessorIdleStatesHv, LastSleepTime, wdm/POWER_INFORMATION_LEVEL, wdm/PowerInformationLevelMaximum, PlatformInformation, wdm/PowerSettingNotificationName, wdm/SystemVideoState, wdm/SystemHiberFileInformation, wdm/VerifyProcessorPowerPolicyDc, SystemHiberbootState, ProcessorIdleStates
