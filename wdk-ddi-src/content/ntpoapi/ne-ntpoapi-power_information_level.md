...
ms.date: 2/16/2018
ms.keywords: wdm/PlatformIdleVeto, ScreenOff, wdm/RegisterSpmPowerSettings, ProcessorIdleStatesHv, wdm/SessionPowerInit, SystemHiberFileInformation, VerifyProcessorPowerPolicyAc, TraceServicePowerMessage, PowerSettingNotificationName, ProcessorStateHandler2, ProcessorPerfCapHv, ProcessorIdleDomains, wdm/CsDeviceNotification, wdm/GroupPark, wdm/SystemPowerStateHandler, LastSleepTime, UserPresence, wdm/SystemBatteryState, wdm/VerifySystemPolicyDc, SetShutdownSelectedTime, RegisterSpmPowerSettings, LogicalProcessorIdling, wdm/ProcessorPerfStates, wdm/SystemPowerLoggingEntry, POWER_INFORMATION_LEVEL enumeration [Kernel-Mode Driver Architecture], SystemBatteryStatePrecise, PlatformIdleVeto, SystemMonitorHiberBootPowerOff, wdm/ProcessorLoad, ThermalStandby, wdm/IdleResiliency, wdm/LastSleepTime, SystemPowerLoggingEntry, wdm/TraceServicePowerMessage, POWER_INFORMATION_LEVEL, wdm/ProcessorSetIdle, ProcessorLoad, SuspendResumeInvocation, EnergyTrackerQuery, TraceApplicationPowerMessage, ProcessorInformationEx, SystemHiberFileSize, wdm/ProcessorIdleVeto, ProcessorPowerPolicyDc, wdm/SuspendResumeInvocation, ProcessorPerfStatesHv, PlmPowerRequestCreate, SessionDisplayState, wdm/ProcessorInformationEx, wdm/SystemHiberFileSize, ProcessorSetIdle, wdm/LastResumePerformance, wdm/PowerRequestActionInternal, PowerInformationLevelUnused0, SessionRITState, wdm/TraceApplicationPowerMessageEnd, VerifySystemPolicyDc, SystemPowerPolicyAc, wdm/ProcessorIdleDomains, wdm/UpdateBlackBoxRecorder, wdm/ProcessorPowerPolicyDc, wdm/PdcInvocation, ProcessorPowerPolicyCurrent, PowerInformationInternal, GetPowerSettingValue, wdm/AdministratorPowerPolicy, SystemPowerStateNotifyHandler, wdm/VerifySystemPolicyAc, wdm/SetPowerSettingValue, SystemReserveHiberFile, wdm/LogicalProcessorIdling, wdm/PowerShutdownNotification, wdm/PowerSettingNotificationName, wdm/PowerInformationLevelUnused0, wdm/WakeTimerList, VerifyProcessorPowerPolicyDc, wdm/ProcessorCap, CsDeviceNotification, wdm/SystemExecutionState, wdm/UserPresence, SystemHiberbootState, MonitorCapabilities, DisplayBurst, wdm/SystemHiberFileType, SystemBatteryState, wdm/MonitorCapabilities, wdm/SystemHiberbootState, LastWakeTime, SystemHiberFileType, ProcessorStateHandler, SystemPowerInformation, wdm/SystemPowerPolicyAc, SessionConnectNotification, PowerRequestCreate, PowerRequestActionInternal, wdm/SystemPowerInformation, wdm/PlatformIdleStates, PowerShutdownNotification, wdm/SystemVideoState, wdm/PowerInformationInternal, wdm/PhysicalPowerButtonPress, wdm/GetPowerSettingValue, wdm/SessionDisplayState, wdm/ProcessorStateHandler2, SessionLockState, ProcessorIdleStates, wdm/FirmwareTableInformationRegistered, PhysicalPowerButtonPress, wdm/EnergyTrackerCreate, wdm/ThermalStandby, PowerRequestAction, ThermalEvent, AdministratorPowerPolicy, wdm/SystemPowerPolicyDc, WakeTimerList, wdm/ThermalEvent, QueryPotentialDripsConstraint, wdm/DisplayBurst, ProcessorInformation, wdm/PowerRequestAction, wdm/SetShutdownSelectedTime, wdm/PowerRequestCreate, BatteryDeviceState, ProcessorCap, wdm/SessionConnectNotification, wdm/QueryPotentialDripsConstraint, PlatformIdleStates, ProcessorPowerPolicyAc, wdm/MonitorInvocation, UpdateBlackBoxRecorder, wdm/ProcessorInformation, wdm/SystemHiberFileInformation, MonitorInvocation, wdm/SessionRITState, wdm/SystemPowerCapabilities, wdm/PowerInformationLevelMaximum, wdm/ProcessorPerfStatesHv, wdm/ProcessorStateHandler, SystemPowerStateLogging, wdm/NotifyUserPowerSetting, PlatformRole, wdm/PlatformRole, wdm/BatteryDeviceState, PdcInvocation, LastResumePerformance, wdm/SystemMonitorHiberBootPowerOff, NotifyUserModeLegacyPowerEvent, wdm/TraceApplicationPowerMessage, wdm/SystemPowerStateLogging, SystemExecutionState, SystemPowerStateHandler, PowerInformationLevelMaximum, wdm/VerifyProcessorPowerPolicyDc, wdm/ProcessorPowerPolicyAc, FirmwareTableInformationRegistered, ProcessorIdleVeto, SystemPowerPolicyCurrent, SystemWakeSource, wdm/GetPowerRequestList, wdm/PlmPowerRequestCreate, wdm/NotifyUserModeLegacyPowerEvent, wdm/ProcessorPerfCapHv, wdm/SystemPowerPolicyCurrent, SystemPowerCapabilities, wdm/SessionPowerCleanup, wdm/SessionLockState, wdm/LastWakeTime, wdm/SystemBatteryStatePrecise, wdm/SystemReserveHiberFile, SystemPowerPolicyDc, TraceApplicationPowerMessageEnd, GetPowerRequestList, SessionPowerCleanup, wdm/EnergyTrackerQuery, wdm/POWER_INFORMATION_LEVEL, VerifySystemPolicyAc, NotifyUserPowerSetting, SessionPowerInit, wdm/VerifyProcessorPowerPolicyAc, SystemVideoState, IdleResiliency, PlatformInformation, ExitLatencySamplingPercentage, EnergyTrackerCreate, wdm/ExitLatencySamplingPercentage, wdm/ProcessorPowerPolicyCurrent, ProcessorPerfStates, wdm/PlatformInformation, wdm/SystemWakeSource, kernel.power_information_level, wdm/SystemPowerStateNotifyHandler, wdm/ProcessorIdleStates, wdm/ScreenOff, SetPowerSettingValue, wdm/ProcessorIdleStatesHv, GroupPark
