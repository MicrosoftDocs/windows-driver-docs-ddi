...
The callout could not be registered with the filter engine. A callout is already registered in
       ...
       <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/fwpsk/ns-fwpsk-fwps_callout0_">FWPS_CALLOUT0</a> structure pointed to by the 
