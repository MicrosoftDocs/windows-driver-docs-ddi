...
ms.date: 2/16/2018
ms.keywords: fwpsk/FWPS_FIELD_RPC_PROXY_IF_IF_UUID, fwpsk/FWPS_FIELDS_RPC_PROXY_IF_IF, FWPS_FIELD_RPC_PROXY_IF_CLIENT_CERT_OID, FWPS_FIELD_RPC_PROXY_IF_PROXY_AUTH_TYPE, FWPS_FIELDS_RPC_PROXY_IF_IF, FWPS_FIELD_RPC_PROXY_IF_SERVER_PORT, FWPS_FIELD_RPC_PROXY_IF_CLIENT_TOKEN, FWPS_FIELD_RPC_PROXY_IF_IF_UUID, fwpsk/FWPS_FIELD_RPC_PROXY_IF_SERVER_NAME, fwpsk/FWPS_FIELD_RPC_PROXY_IF_CLIENT_TOKEN, fwpsk/FWPS_FIELD_RPC_PROXY_IF_CLIENT_CERT_KEY_LENGTH, fwpsk/FWPS_FIELD_RPC_PROXY_IF_PROXY_AUTH_TYPE, fwpsk/FWPS_FIELD_RPC_PROXY_IF_CLIENT_CERT_OID, FWPS_FIELDS_RPC_PROXY_IF_IF enumeration [Network Drivers Starting with Windows Vista], FWPS_FIELD_RPC_PROXY_IF_SERVER_NAME, FWPS_FIELD_RPC_PROXY_IF_IF_VERSION, FWPS_FIELD_RPC_PROXY_IF_CLIENT_CERT_KEY_LENGTH, fwpsk/FWPS_FIELD_RPC_PROXY_IF_SERVER_PORT, FWPS_FIELD_RPC_PROXY_IF_MAX, fwpsk/FWPS_FIELD_RPC_PROXY_IF_MAX, fwpsk/FWPS_FIELD_RPC_PROXY_IF_IF_VERSION, FWPS_FIELDS_RPC_PROXY_IF_, wfp_ref_5_const_3_data_fields_666debd4-c19e-4dcd-91d9-024f298b342f.xml, netvista.fwps_fields_rpc_proxy_if_if
