...
ms.date: 1/9/2018
ms.keywords: stream.bda_tuner_diagnostics, PBDA_TUNER_DIAGNOSTICS structure pointer [Streaming Media Devices], *PBDA_TUNER_DIAGNOSTICS, _BDA_TUNER_DIAGNOSTICS, BDA_TUNER_DIAGNOSTICS structure [Streaming Media Devices], bdatypes/PBDA_TUNER_DIAGNOSTICS, BDA_TUNER_DIAGNOSTICS, PBDA_TUNER_DIAGNOSTICS, bdatypes/BDA_TUNER_DIAGNOSTICS
