...
ms.date: 1/9/2018
ms.keywords: BDA_STRING structure [Streaming Media Devices], *PBDA_STRING, bdatypes/BDA_STRING, PBDA_STRING, bdatypes/PBDA_STRING, stream.bda_string, BDA_STRING, PBDA_STRING structure pointer [Streaming Media Devices], _BDA_STRING
