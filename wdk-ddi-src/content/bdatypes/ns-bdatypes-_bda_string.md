...
ms.date: 2/22/2018
ms.keywords: BDA_STRING structure [Streaming Media Devices], PBDA_STRING, BDA_STRING, stream.bda_string, PBDA_STRING structure pointer [Streaming Media Devices], _BDA_STRING, bdatypes/BDA_STRING, bdatypes/PBDA_STRING, *PBDA_STRING
