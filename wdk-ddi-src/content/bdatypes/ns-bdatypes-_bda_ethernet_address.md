...
ms.date: 1/9/2018
ms.keywords: bdatypes/PBDA_ETHERNET_ADDRESS, bdatypes/BDA_ETHERNET_ADDRESS, PBDA_ETHERNET_ADDRESS, *PBDA_ETHERNET_ADDRESS, BDA_ETHERNET_ADDRESS structure [Streaming Media Devices], stream.bda_ethernet_address, BDA_ETHERNET_ADDRESS, _BDA_ETHERNET_ADDRESS, PBDA_ETHERNET_ADDRESS structure pointer [Streaming Media Devices]
