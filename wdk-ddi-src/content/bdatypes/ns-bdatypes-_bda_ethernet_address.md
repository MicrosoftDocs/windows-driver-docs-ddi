...
ms.date: 1/9/2018
ms.keywords: stream.bda_ethernet_address, bdatypes/PBDA_ETHERNET_ADDRESS, *PBDA_ETHERNET_ADDRESS, PBDA_ETHERNET_ADDRESS structure pointer [Streaming Media Devices], _BDA_ETHERNET_ADDRESS, BDA_ETHERNET_ADDRESS structure [Streaming Media Devices], PBDA_ETHERNET_ADDRESS, bdatypes/BDA_ETHERNET_ADDRESS, BDA_ETHERNET_ADDRESS
