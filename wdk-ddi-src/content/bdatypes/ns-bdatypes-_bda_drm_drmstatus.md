...
ms.date: 2/22/2018
ms.keywords: bdatypes/BDA_DRM_DRMSTATUS, PBDA_DRM_DRMSTATUS structure pointer [Streaming Media Devices], bdatypes/PBDA_DRM_DRMSTATUS, PBDA_DRM_DRMSTATUS, BDA_DRM_DRMSTATUS structure [Streaming Media Devices], _BDA_DRM_DRMSTATUS, BDA_DRM_DRMSTATUS, stream.bda_drm_drmstatus, *PBDA_DRM_DRMSTATUS
