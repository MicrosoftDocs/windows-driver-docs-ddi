...
ms.date: 1/9/2018
ms.keywords: stream.bda_gdds_datatype, BDA_GDDS_DATATYPE, P_BDA_GDDS_DATATYPE, BDA_GDDS_DATATYPE structure [Streaming Media Devices], P_BDA_GDDS_DATATYPE structure pointer [Streaming Media Devices], bdatypes/BDA_GDDS_DATATYPE, _BDA_GDDS_DATATYPE, *P_BDA_GDDS_DATATYPE, bdatypes/P_BDA_GDDS_DATATYPE
