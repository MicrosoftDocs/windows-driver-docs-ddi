...
ms.date: 1/9/2018
ms.keywords: P_BDA_GDDS_DATA structure pointer [Streaming Media Devices], _BDA_GDDS_DATA, BDA_GDDS_DATA structure [Streaming Media Devices], P_BDA_GDDS_DATA, BDA_GDDS_DATA, *P_BDA_GDDS_DATA, bdatypes/P_BDA_GDDS_DATA, stream.bda_gdds_data, bdatypes/BDA_GDDS_DATA
