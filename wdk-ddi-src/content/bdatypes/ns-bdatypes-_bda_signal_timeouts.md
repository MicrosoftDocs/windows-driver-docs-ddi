...
ms.date: 1/9/2018
ms.keywords: stream.bda_signal_timeouts, PBDA_SIGNAL_TIMEOUTS structure pointer [Streaming Media Devices], BDA_SIGNAL_TIMEOUTS structure [Streaming Media Devices], bdatypes/BDA_SIGNAL_TIMEOUTS, PBDA_SIGNAL_TIMEOUTS, BDA_SIGNAL_TIMEOUTS, *PBDA_SIGNAL_TIMEOUTS, _BDA_SIGNAL_TIMEOUTS, bdatypes/PBDA_SIGNAL_TIMEOUTS
