...
ms.date: 1/9/2018
ms.keywords: P_BDA_USERACTIVITY_INTERVAL structure pointer [Streaming Media Devices], *P_BDA_USERACTIVITY_INTERVAL, P_BDA_USERACTIVITY_INTERVAL, BDA_USERACTIVITY_INTERVAL, stream.bda_useractivity_interval, _BDA_USERACTIVITY_INTERVAL, bdatypes/P_BDA_USERACTIVITY_INTERVAL, bdatypes/BDA_USERACTIVITY_INTERVAL, BDA_USERACTIVITY_INTERVAL structure [Streaming Media Devices]
