...
ms.date: 2/22/2018
ms.keywords: bdatypes/PBDA_TS_SELECTORINFO, PBDA_TS_SELECTORINFO, bdatypes/BDA_TS_SELECTORINFO, _BDA_TS_SELECTORINFO, BDA_TS_SELECTORINFO, stream.bda_ts_selectorinfo, PBDA_TS_SELECTORINFO structure pointer [Streaming Media Devices], *PBDA_TS_SELECTORINFO, BDA_TS_SELECTORINFO structure [Streaming Media Devices]
