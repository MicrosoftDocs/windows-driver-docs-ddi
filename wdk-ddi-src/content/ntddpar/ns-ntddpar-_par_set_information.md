...
ms.date: 12/14/2017
ms.keywords: PAR_SET_INFORMATION, *PPAR_SET_INFORMATION, cisspd_8390a7d0-a4b2-4970-94f8-fd270f2d8256.xml, ntddpar/PAR_SET_INFORMATION, ntddpar/PPAR_SET_INFORMATION, PAR_SET_INFORMATION structure [Parallel Ports], parports.par_set_information, PPAR_SET_INFORMATION, _PAR_SET_INFORMATION, PPAR_SET_INFORMATION structure pointer [Parallel Ports]
