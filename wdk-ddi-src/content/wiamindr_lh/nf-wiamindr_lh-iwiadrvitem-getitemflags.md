...
ms.date: 2/22/2018
ms.keywords: IWiaDrvItem, IWiaDrvItem interface [Imaging Devices], GetItemFlags method, DrvItem_6fcac1f5-c754-4158-a1a0-61efe0d3913c.xml, wiamindr_lh/IWiaDrvItem::GetItemFlags, GetItemFlags, GetItemFlags method [Imaging Devices], image.iwiadrvitem_getitemflags, GetItemFlags method [Imaging Devices], IWiaDrvItem interface, IWiaDrvItem::GetItemFlags
