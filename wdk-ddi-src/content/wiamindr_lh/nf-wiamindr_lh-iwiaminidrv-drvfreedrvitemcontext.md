...
ms.date: 2/22/2018
ms.keywords: image.iwiaminidrv_drvfreedrvitemcontext, IWiaMiniDrv interface [Imaging Devices], drvFreeDrvItemContext method, wiamindr_lh/IWiaMiniDrv::drvFreeDrvItemContext, drvFreeDrvItemContext method [Imaging Devices], drvFreeDrvItemContext, drvFreeDrvItemContext method [Imaging Devices], IWiaMiniDrv interface, MiniDrv_59a7d220-cd1d-4cc2-870a-3260feaba7e9.xml, IWiaMiniDrv, IWiaMiniDrv::drvFreeDrvItemContext
