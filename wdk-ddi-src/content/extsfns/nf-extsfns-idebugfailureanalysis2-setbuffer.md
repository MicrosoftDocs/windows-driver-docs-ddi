...
ms.date: 1/19/2018
ms.keywords: SetBuffer method [Windows Debugging], IDebugFailureAnalysis2, IDebugFailureAnalysis2::SetBuffer, SetBuffer, IDebugFailureAnalysis2 interface [Windows Debugging], SetBuffer method, extsfns/IDebugFailureAnalysis2::SetBuffer, SetBuffer method [Windows Debugging], IDebugFailureAnalysis2 interface, debugger.idebugfailureanalysis2_setbuffer
