...
ms.date: 1/19/2018
ms.keywords: GetType, IDebugFAEntryTags::GetType, extsfns/IDebugFAEntryTags::GetType, GetType method [Windows Debugging], IDebugFAEntryTags interface, IDebugFAEntryTags, IDebugFAEntryTags interface [Windows Debugging], GetType method, GetType method [Windows Debugging], debugger.idebugfaentrytags_gettype
