...
ms.date: 1/19/2018
ms.keywords: IDebugFAEntryTags::SetType, extsfns/IDebugFAEntryTags::SetType, SetType, debugger.idebugfaentrytags_settype, IDebugFAEntryTags interface [Windows Debugging], SetType method, IDebugFAEntryTags, SetType method [Windows Debugging], SetType method [Windows Debugging], IDebugFAEntryTags interface
