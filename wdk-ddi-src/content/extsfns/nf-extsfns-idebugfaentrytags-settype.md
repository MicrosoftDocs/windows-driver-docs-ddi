...
ms.date: 1/19/2018
ms.keywords: SetType, IDebugFAEntryTags interface [Windows Debugging], SetType method, SetType method [Windows Debugging], IDebugFAEntryTags, IDebugFAEntryTags::SetType, debugger.idebugfaentrytags_settype, SetType method [Windows Debugging], IDebugFAEntryTags interface, extsfns/IDebugFAEntryTags::SetType
