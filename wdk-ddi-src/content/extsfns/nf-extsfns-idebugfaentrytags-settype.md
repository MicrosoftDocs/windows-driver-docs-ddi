...
ms.date: 1/19/2018
ms.keywords: debugger.idebugfaentrytags_settype, extsfns/IDebugFAEntryTags::SetType, IDebugFAEntryTags, SetType, IDebugFAEntryTags::SetType, IDebugFAEntryTags interface [Windows Debugging], SetType method, SetType method [Windows Debugging], IDebugFAEntryTags interface, SetType method [Windows Debugging]
