...
ms.date: 1/19/2018
ms.keywords: GetTagByName method [Windows Debugging], IDebugFAEntryTags interface, IDebugFAEntryTags interface [Windows Debugging], GetTagByName method, IDebugFAEntryTags::GetTagByName, debugger.idebugfaentrytags_gettagbyname, IDebugFAEntryTags, GetTagByName, extsfns/IDebugFAEntryTags::GetTagByName, GetTagByName method [Windows Debugging]
