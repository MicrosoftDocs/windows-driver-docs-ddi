...
ms.date: 2/22/2018
ms.keywords: extsfns/IDebugFailureAnalysis2::GetFailureClass, GetFailureClass, debugger.idebugfailureanalysis2_getfailureclass, GetFailureClass method [Windows Debugging], IDebugFailureAnalysis2 interface, GetFailureClass method [Windows Debugging], IDebugFailureAnalysis2::GetFailureClass, IDebugFailureAnalysis2 interface [Windows Debugging], GetFailureClass method, IDebugFailureAnalysis2
