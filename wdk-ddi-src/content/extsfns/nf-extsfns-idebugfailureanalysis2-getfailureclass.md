...
ms.date: 1/19/2018
ms.keywords: GetFailureClass method [Windows Debugging], IDebugFailureAnalysis2 interface, IDebugFailureAnalysis2, extsfns/IDebugFailureAnalysis2::GetFailureClass, IDebugFailureAnalysis2::GetFailureClass, debugger.idebugfailureanalysis2_getfailureclass, GetFailureClass method [Windows Debugging], IDebugFailureAnalysis2 interface [Windows Debugging], GetFailureClass method, GetFailureClass
