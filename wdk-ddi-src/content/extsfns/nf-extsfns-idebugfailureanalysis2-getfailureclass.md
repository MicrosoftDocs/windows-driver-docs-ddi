...
ms.date: 1/19/2018
ms.keywords: GetFailureClass, IDebugFailureAnalysis2 interface [Windows Debugging], GetFailureClass method, debugger.idebugfailureanalysis2_getfailureclass, extsfns/IDebugFailureAnalysis2::GetFailureClass, GetFailureClass method [Windows Debugging], IDebugFailureAnalysis2 interface, IDebugFailureAnalysis2, GetFailureClass method [Windows Debugging], IDebugFailureAnalysis2::GetFailureClass
