...
ms.date: 1/19/2018
ms.keywords: IDebugFailureAnalysis2, extsfns/IDebugFailureAnalysis2::GetFailureClass, debugger.idebugfailureanalysis2_getfailureclass, GetFailureClass method [Windows Debugging], GetFailureClass, GetFailureClass method [Windows Debugging], IDebugFailureAnalysis2 interface, IDebugFailureAnalysis2 interface [Windows Debugging], GetFailureClass method, IDebugFailureAnalysis2::GetFailureClass
