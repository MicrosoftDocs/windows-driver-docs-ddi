...
ms.date: 1/19/2018
ms.keywords: extsfns/IDebugFAEntryTags::SetProperties, debugger.idebugfaentrytags_setproperties, IDebugFAEntryTags::SetProperties, IDebugFAEntryTags, SetProperties method [Windows Debugging], IDebugFAEntryTags interface [Windows Debugging], SetProperties method, SetProperties method [Windows Debugging], IDebugFAEntryTags interface, SetProperties
