...
ms.date: 1/19/2018
ms.keywords: IDebugFailureAnalysis2::GetUlong, debugger.idebugfailureanalysis2_getstring, IDebugFailureAnalysis2 interface [Windows Debugging], GetUlong method, IDebugFailureAnalysis2::GetString, IDebugFailureAnalysis2, extsfns/IDebugFailureAnalysis2::GetUlong, GetUlong method [Windows Debugging], IDebugFailureAnalysis2 interface, GetUlong method [Windows Debugging], GetString
