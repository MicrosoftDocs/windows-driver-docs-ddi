...
ms.date: 1/19/2018
ms.keywords: GetProperties method [Windows Debugging], IDebugFAEntryTags interface, GetProperties, debugger.idebugfaentrytags_getproperties, IDebugFAEntryTags, extsfns/IDebugFAEntryTags::GetProperties, GetProperties method [Windows Debugging], IDebugFAEntryTags::GetProperties, IDebugFAEntryTags interface [Windows Debugging], GetProperties method
