...
ms.date: 1/19/2018
ms.keywords: FA_EXTENSION_PLUGIN_PHASE, FA_PLUGIN_INITILIZATION, FA_PLUGIN_PRE_BUCKETING, _FA_EXTENSION_PLUGIN_PHASE, FA_EXTENSION_PLUGIN_PHASE enumeration [Windows Debugging], FA_PLUGIN_STACK_ANALYSIS, extsfns/FA_PLUGIN_POST_BUCKETING, extsfns/FA_PLUGIN_PRE_BUCKETING, extsfns/FA_PLUGIN_INITILIZATION, debugger.fa_extension_plugin_phase, extsfns/FA_EXTENSION_PLUGIN_PHASE, extsfns/FA_PLUGIN_STACK_ANALYSIS, FA_PLUGIN_POST_BUCKETING
