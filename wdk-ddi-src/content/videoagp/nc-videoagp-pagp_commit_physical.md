...
tech.root: display
ms.date: 05/10/2018
keywords: ["PAGP_COMMIT_PHYSICAL callback function"]
...
[in]
Identifies a reserved physical address range. The context handle is obtained from <a href="/windows-hardware/drivers/ddi/videoagp/nc-videoagp-pagp_reserve_physical">AgpReservePhysical</a>.
...
A video miniport driver must first reserve physical addresses by calling <a href="/windows-hardware/drivers/ddi/videoagp/nc-videoagp-pagp_reserve_physical">AgpReservePhysical</a> before it calls this function.
