...
ms.date: 1/11/2018
ms.keywords: GetDeviceIoControlParameters method, IWDFIoRequest interface, UMDFRequestObjectRef_8a0fa5cd-af16-4599-8282-4ca0a81591ac.xml, umdf.iwdfiorequest_getdeviceiocontrolparameters, IWDFIoRequest, IWDFIoRequest interface, GetDeviceIoControlParameters method, wdf.iwdfiorequest_getdeviceiocontrolparameters, wudfddi/IWDFIoRequest::GetDeviceIoControlParameters, GetDeviceIoControlParameters method, IWDFIoRequest::GetDeviceIoControlParameters, GetDeviceIoControlParameters
