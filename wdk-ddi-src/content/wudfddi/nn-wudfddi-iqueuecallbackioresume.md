...
The <b>IQueueCallbackIoResume</b> interface inherits from the <a href="/windows/win32/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface. <b>IQueueCallbackIoResume</b> also has these types of members:
<ul>
<li>Methods</li>
</ul>
