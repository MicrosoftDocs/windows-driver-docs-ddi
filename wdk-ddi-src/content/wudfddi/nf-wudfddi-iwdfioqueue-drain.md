...
For example, if the driver previously called <b>Drain</b>, it should wait for notification from the method of the interface that the <i>pDrainComplete</i> parameter points to before the driver calls either <a href="/windows-hardware/test/wpt/stop-icontrolmanager">Stop</a> or <a href="/windows-hardware/drivers/ddi/wudfddi/nf-wudfddi-iwdfioqueue-purge">Purge</a>. Violating this rule results in termination of the host process.
