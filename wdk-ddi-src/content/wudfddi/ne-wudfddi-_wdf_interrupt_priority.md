...
description: Learn how the WDF_INTERRUPT_PRIORITY enumeration type identifies relative priorities for device interrupts.
...
f1_keywords:
 ...
 - wudfddi/_WDF_INTERRUPT_PRIORITY
 - PWDF_INTERRUPT_PRIORITY
 - wudfddi/PWDF_INTERRUPT_PRIORITY
