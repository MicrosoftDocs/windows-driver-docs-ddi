...
<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wudfddi/nf-wudfddi-iwdfdevice-postevent">PostEvent</a> could not allocate memory that was required for it to complete.
