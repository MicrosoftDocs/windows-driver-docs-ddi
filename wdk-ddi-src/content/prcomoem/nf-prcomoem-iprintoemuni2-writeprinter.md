...
ms.date: 1/18/2018
ms.keywords: WritePrinter method [Print Devices], IPrintOemUni2 interface [Print Devices], WritePrinter method, WritePrinter method [Print Devices], IPrintOemUni2 interface, IPrintOemUni2::WritePrinter, prcomoem/IPrintOemUni2::WritePrinter, print_unidrv-pscript_rendering_8dfd9075-d0a9-451b-bb31-9e1a55c16c1c.xml, IPrintOemUni2, print.iprintoemuni2_writeprinter, WritePrinter
