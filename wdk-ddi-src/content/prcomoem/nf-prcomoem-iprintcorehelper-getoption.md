...
ms.date: 1/18/2018
ms.keywords: print.iprintcorehelper_getoption, GetOption method [Print Devices], IPrintCoreHelper interface, IPrintCoreHelper, IPrintCoreHelper::GetOption, prcomoem/IPrintCoreHelper::GetOption, IPrintCoreHelper interface [Print Devices], GetOption method, GetOption method [Print Devices], print_unidrv-pscript_allplugins_38a01e42-9d70-47d1-9d3d-2b488af4c3f3.xml, GetOption
