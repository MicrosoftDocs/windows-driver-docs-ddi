...
ms.date: 2/22/2018
ms.keywords: IPrintOemPS::DisablePDEV, IPrintOemPS interface [Print Devices], DisablePDEV method, print.iprintoemps_disablepdev, DisablePDEV, DisablePDEV method [Print Devices], IPrintOemPS, print_unidrv-pscript_rendering_7adde157-af87-49c1-80b0-e419c84a12a4.xml, prcomoem/IPrintOemPS::DisablePDEV, DisablePDEV method [Print Devices], IPrintOemPS interface
