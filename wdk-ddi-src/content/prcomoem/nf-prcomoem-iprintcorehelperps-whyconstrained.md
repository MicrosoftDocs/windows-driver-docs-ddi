...
If the specified feature-option pair is not constrained, <b>IPrintCoreHelperPS::WhyConstrained</b> will return S_OK but will return with **pdwFOPairs* set to 0 and with **ppFOConstraints*[0] set to <b>NULL</b>.
