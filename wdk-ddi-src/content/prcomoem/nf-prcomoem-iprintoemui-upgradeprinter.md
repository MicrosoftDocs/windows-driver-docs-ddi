...
ms.date: 2/22/2018
ms.keywords: UpgradePrinter method [Print Devices], IPrintOemUI interface, IPrintOemUI::UpgradePrinter, UpgradePrinter method [Print Devices], IPrintOemUI interface [Print Devices], UpgradePrinter method, UpgradePrinter, IPrintOemUI, print.iprintoemui_upgradeprinter, prcomoem/IPrintOemUI::UpgradePrinter, print_unidrv-pscript_ui_18087d8a-d7b4-485f-84fb-277e194bb4e8.xml
