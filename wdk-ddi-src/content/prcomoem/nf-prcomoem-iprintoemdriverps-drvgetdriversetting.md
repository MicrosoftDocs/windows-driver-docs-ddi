...
ms.date: 2/21/2018
ms.keywords: print.iprintoemdriverps_drvgetdriversetting, DrvGetDriverSetting method [Print Devices], IPrintOemDriverPS::DrvGetDriverSetting, prcomoem/IPrintOemDriverPS::DrvGetDriverSetting, IPrintOemDriverPS, IPrintOemDriverPS interface [Print Devices], DrvGetDriverSetting method, DrvGetDriverSetting, print_unidrv-pscript_rendering_eb83bce7-ee89-4a4b-a72d-214d2d8054ee.xml, DrvGetDriverSetting method [Print Devices], IPrintOemDriverPS interface
