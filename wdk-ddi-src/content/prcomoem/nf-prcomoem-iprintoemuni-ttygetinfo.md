...
ms.date: 1/18/2018
ms.keywords: TTYGetInfo, prcomoem/IPrintOemUni::TTYGetInfo, print.iprintoemuni_ttygetinfo, TTYGetInfo method [Print Devices], IPrintOemUni interface, IPrintOemUni, IPrintOemUni::TTYGetInfo, TTYGetInfo method [Print Devices], IPrintOemUni interface [Print Devices], TTYGetInfo method, print_unidrv-pscript_rendering_d98708b3-8e01-4037-a545-aee0e32a46c6.xml
