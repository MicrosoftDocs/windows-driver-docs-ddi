...
ms.date: 1/18/2018
ms.keywords: prcomoem/IPrintOemUI::CommonUIProp, CommonUIProp method [Print Devices], IPrintOemUI interface [Print Devices], CommonUIProp method, print.iprintoemui_commonuiprop, IPrintOemUI::CommonUIProp, CommonUIProp method [Print Devices], IPrintOemUI interface, CommonUIProp, IPrintOemUI, print_unidrv-pscript_ui_dd201198-0df4-479d-9c48-0fa934fb0b56.xml
