...
ms.date: 1/18/2018
ms.keywords: print.iprintcorehelperps_setfontsubstitution, SetFontSubstitution method [Print Devices], IPrintCoreHelperPS interface, IPrintCoreHelperPS interface [Print Devices], SetFontSubstitution method, print_unidrv-pscript_allplugins_53cc5ca8-5c27-4fd8-b316-58753a996bda.xml, IPrintCoreHelperPS, SetFontSubstitution, SetFontSubstitution method [Print Devices], prcomoem/IPrintCoreHelperPS::SetFontSubstitution, IPrintCoreHelperPS::SetFontSubstitution
