...
ms.date: 2/2/2018
ms.keywords: print.iprintcorehelperuni_setoptions, IPrintCoreHelperUni interface [Print Devices], SetOptions method, SetOptions, IPrintCoreHelperUni::SetOptions, SetOptions method [Print Devices], IPrintCoreHelperUni, print_unidrv-pscript_allplugins_3178bdef-a7fd-48ba-9b2e-cafda9fb0802.xml, SetOptions method [Print Devices], IPrintCoreHelperUni interface, prcomoem/IPrintCoreHelperUni::SetOptions
