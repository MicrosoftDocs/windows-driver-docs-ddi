...
ms.date: 12/16/2022
targetos: Windows
description: The AcxObjectBagRetrieveI1 function retrieves an int one byte (CHAR) I1 value from an existing, initialized AcxObjectBag that contains values.
prerelease: false
req.assembly: 
