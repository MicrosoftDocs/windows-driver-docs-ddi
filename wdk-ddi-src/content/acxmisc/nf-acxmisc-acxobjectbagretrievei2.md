...
ms.date: 12/16/2022
targetos: Windows
description: The AcxObjectBagRetrieveI2 function retrieves an int two byte I2 (SHORT) value from an existing, initialized AcxObjectBag that contains values.
prerelease: false
req.assembly: 
