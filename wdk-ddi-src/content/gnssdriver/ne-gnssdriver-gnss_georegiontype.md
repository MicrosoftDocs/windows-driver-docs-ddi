...
ms.date: 12/14/2017
ms.keywords: GNSS_GEOREGIONTYPE, gnssdriver/GNSS_GEOREGIONTYPE, GNSS_GeoRegion_Circle, sensors.gnss_georegiontype, GNSS_GEOREGIONTYPE enumeration [Sensor Devices], gnssdriver/GNSS_GeoRegion_Circle
