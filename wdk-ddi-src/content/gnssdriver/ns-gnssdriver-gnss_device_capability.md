...
ms.date: 2/22/2018
ms.keywords: "*PGNSS_DEVICE_CAPABILITY, gnssdriver/GNSS_DEVICE_CAPABILITY, GNSS_DEVICE_CAPABILITY, sensors.gnss_device_capability, gnssdriver/PGNSS_DEVICE_CAPABILITY, PGNSS_DEVICE_CAPABILITY, GNSS_DEVICE_CAPABILITY structure [Sensor Devices], PGNSS_DEVICE_CAPABILITY structure pointer [Sensor Devices]"
