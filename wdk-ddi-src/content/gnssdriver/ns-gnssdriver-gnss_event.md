...
ms.date: 2/22/2018
ms.keywords: ",  , *, *PGNSS_EVENT, ,, E, G, GNSS_EVENT, GNSS_EVENT structure [Sensor Devices], N, P, PGNSS_EVENT, PGNSS_EVENT structure pointer [Sensor Devices], S, T, V, _, gnssdriver/GNSS_EVENT, gnssdriver/PGNSS_EVENT, sensors.gnss_event"
