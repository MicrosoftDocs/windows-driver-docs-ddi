...
ms.date: 2/22/2018
ms.keywords: gnssdriver/PGNSS_GEOFENCE_ALERT_DATA, GNSS_GEOFENCE_ALERT_DATA, GNSS_GEOFENCE_ALERT_DATA structure [Sensor Devices], PGNSS_GEOFENCE_ALERT_DATA, *PGNSS_GEOFENCE_ALERT_DATA, gnssdriver/GNSS_GEOFENCE_ALERT_DATA, sensors.gnss_geofence_alert_data, PGNSS_GEOFENCE_ALERT_DATA structure pointer [Sensor Devices]
