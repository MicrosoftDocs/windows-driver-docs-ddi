...
ms.date: 12/14/2017
ms.keywords: GNSS_NMEA_DATA, GNSS_NMEA_DATA structure [Sensor Devices], *PGNSS_NMEA_DATA, PGNSS_NMEA_DATA, sensors.gnss_nmea_data, gnssdriver/GNSS_NMEA_DATA, PGNSS_NMEA_DATA structure pointer [Sensor Devices], gnssdriver/PGNSS_NMEA_DATA
