...
ms.date: 2/22/2018
ms.keywords: sensors.gnss_nmea_data, PGNSS_NMEA_DATA, gnssdriver/GNSS_NMEA_DATA, *PGNSS_NMEA_DATA, PGNSS_NMEA_DATA structure pointer [Sensor Devices], GNSS_NMEA_DATA structure [Sensor Devices], GNSS_NMEA_DATA, gnssdriver/PGNSS_NMEA_DATA
