...
ms.date: 12/14/2017
ms.keywords: GNSS_FixSession_SingleShot, GNSS_FixSession_DistanceTracking, GNSS_FIXSESSIONTYPE, gnssdriver/GNSS_FixSession_SingleShot, GNSS_FixSession_LKG, gnssdriver/GNSS_FIXSESSIONTYPE, gnssdriver/GNSS_FixSession_ContinuousTracking, gnssdriver/GNSS_FixSession_LKG, sensors.gnss_fixsessiontype, gnssdriver/GNSS_FixSession_DistanceTracking, GNSS_FIXSESSIONTYPE enumeration [Sensor Devices], GNSS_FixSession_ContinuousTracking
