...
ms.date: 12/14/2017
ms.keywords: gnssdriver/GNSS_ResetGeofencesTracking, GNSS_CustomCommand, gnssdriver/GNSS_ClearAgnssData, GNSS_DRIVERCOMMAND_TYPE enumeration [Sensor Devices], gnssdriver/GNSS_SetSuplVersion, gnssdriver/GNSS_CustomCommand, GNSS_DRIVERCOMMAND_TYPE, GNSS_SetSuplVersion, GNSS_ForceSatelliteSystem, gnssdriver/GNSS_SetNiTimeoutInterval, GNSS_ResetEngine, gnssdriver/GNSS_SetLocationServiceEnabled, gnssdriver/GNSS_SetLocationNIRequestAllowed, GNSS_ForceOperationMode, GNSS_SetLocationNIRequestAllowed, gnssdriver/GNSS_ForceOperationMode, GNSS_SetNMEALogging, gnssdriver/GNSS_SetUplServerAccessInterval, GNSS_ResetGeofencesTracking, gnssdriver/GNSS_SetNMEALogging, GNSS_SetNiTimeoutInterval, gnssdriver/GNSS_DRIVERCOMMAND_TYPE, gnssdriver/GNSS_ResetEngine, sensors.gnss_drivercommand_type, GNSS_ClearAgnssData, GNSS_SetUplServerAccessInterval, gnssdriver/GNSS_ForceSatelliteSystem, GNSS_SetLocationServiceEnabled
