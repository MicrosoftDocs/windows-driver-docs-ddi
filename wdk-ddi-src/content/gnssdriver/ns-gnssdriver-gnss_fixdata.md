...
ms.date: 2/22/2018
ms.keywords: GNSS_FIXDATA, sensors.gnss_fixdata, PGNSS_FIXDATA, GNSS_FIXDATA structure [Sensor Devices], gnssdriver/GNSS_FIXDATA, PGNSS_FIXDATA structure pointer [Sensor Devices], *PGNSS_FIXDATA, gnssdriver/PGNSS_FIXDATA
