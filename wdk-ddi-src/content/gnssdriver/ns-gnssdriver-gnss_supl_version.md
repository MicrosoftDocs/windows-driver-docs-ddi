...
ms.date: 12/14/2017
ms.keywords: PGNSS_SUPL_VERSION, *PGNSS_SUPL_VERSION, GNSS_SUPL_VERSION, gnssdriver/GNSS_SUPL_VERSION, PGNSS_SUPL_VERSION structure pointer [Sensor Devices], gnssdriver/PGNSS_SUPL_VERSION, GNSS_SUPL_VERSION structure [Sensor Devices], sensors.gnss_supl_version
