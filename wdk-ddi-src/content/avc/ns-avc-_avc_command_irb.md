...
ms.date: 1/9/2018
ms.keywords: avc/AVC_COMMAND_IRB, _AVC_COMMAND_IRB, stream.avc_command_irb, avcref_1f88c208-64b9-40d1-9048-d10b105b5569.xml, AVC_COMMAND_IRB structure [Streaming Media Devices], *PAVC_COMMAND_IRB, PAVC_COMMAND_IRB structure pointer [Streaming Media Devices], PAVC_COMMAND_IRB, AVC_COMMAND_IRB, avc/PAVC_COMMAND_IRB
