...
ms.date: 1/9/2018
ms.keywords: AVC_PIN_DESCRIPTOR, AVC_PIN_DESCRIPTOR structure [Streaming Media Devices], avc/AVC_PIN_DESCRIPTOR, stream.avc_pin_descriptor, *PAVC_PIN_DESCRIPTOR, avcref_4207f0d3-ba1e-47ae-abdd-4eebccf094b9.xml, PAVC_PIN_DESCRIPTOR, _AVC_PIN_DESCRIPTOR, PAVC_PIN_DESCRIPTOR structure pointer [Streaming Media Devices], avc/PAVC_PIN_DESCRIPTOR
