...
ms.date: 2/22/2018
ms.keywords: KSPIN_FLAG_AVC, avcref_9fab0898-b113-4d2f-ae4a-8cc6b01217d9.xml, avc/KSPIN_FLAG_AVCMASK, _KSPIN_FLAG_AVC, KSPIN_FLAG_AVCMASK, KSPIN_FLAG_AVC_PERMANENT, KSPIN_FLAG_AVC_FIXEDPCR, KSPIN_FLAG_AVC enumeration [Streaming Media Devices], stream.kspin_flag_avc, avc/KSPIN_FLAG_AVC, KSPIN_FLAG_AVC_CONNECTED, avc/KSPIN_FLAG_AVC_CONNECTED, KSPIN_FLAG_AVC_PCRONLY, avc/KSPIN_FLAG_AVC_PCRONLY, avc/KSPIN_FLAG_AVC_PERMANENT, avc/KSPIN_FLAG_AVC_FIXEDPCR
