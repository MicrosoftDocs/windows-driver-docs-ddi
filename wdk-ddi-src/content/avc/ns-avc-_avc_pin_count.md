...
ms.date: 1/9/2018
ms.keywords: AVC_PIN_COUNT, AVC_PIN_COUNT structure [Streaming Media Devices], PAVC_PIN_COUNT structure pointer [Streaming Media Devices], avc/PAVC_PIN_COUNT, avc/AVC_PIN_COUNT, stream.avc_pin_count, avcref_693c28a9-c746-4116-aee7-0de54ce08565.xml, *PAVC_PIN_COUNT, PAVC_PIN_COUNT, _AVC_PIN_COUNT
