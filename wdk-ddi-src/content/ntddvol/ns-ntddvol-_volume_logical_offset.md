...
ms.date: 1/10/2018
ms.keywords: VOLUME_LOGICAL_OFFSET structure [Storage Devices], structs-volumemgr_97756e49-7151-4d3a-abbe-aa90a472c284.xml, VOLUME_LOGICAL_OFFSET, *PVOLUME_LOGICAL_OFFSET, ntddvol/VOLUME_LOGICAL_OFFSET, ntddvol/PVOLUME_LOGICAL_OFFSET, storage.volume_logical_offset, _VOLUME_LOGICAL_OFFSET, PVOLUME_LOGICAL_OFFSET structure pointer [Storage Devices], PVOLUME_LOGICAL_OFFSET
