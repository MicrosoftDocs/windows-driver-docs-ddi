...
> [!NOTE]
> Callback functions that are called at PASSIVE_LEVEL cannot delete timer objects. For more info, see [*EVT_WDF_TIMER* callback function](/windows-hardware/drivers/ddi/wdftimer/nc-wdftimer-evt_wdf_timer#remarks).
