...
ms.date: 2/15/2018
ms.keywords: gpioclx/PGPIO_READ_PINS_PARAMETERS, GPIO_READ_PINS_PARAMETERS, PGPIO_READ_PINS_PARAMETERS structure pointer [Parallel Ports], _GPIO_READ_PINS_PARAMETERS, GPIO.gpio_read_pins_parameters, *PGPIO_READ_PINS_PARAMETERS, PGPIO_READ_PINS_PARAMETERS, gpioclx/GPIO_READ_PINS_PARAMETERS, GPIO_READ_PINS_PARAMETERS structure [Parallel Ports]
