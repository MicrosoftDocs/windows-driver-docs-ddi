...
f1_keywords:
 ...
 - gpioclx/_GPIO_READ_PINS_MASK_PARAMETERS
 - PGPIO_READ_PINS_MASK_PARAMETERS
 - gpioclx/PGPIO_READ_PINS_MASK_PARAMETERS
...
The <i>ReadParameters</i> parameter of the <a href="/windows-hardware/drivers/ddi/gpioclx/nc-gpioclx-gpio_client_read_pins_mask">CLIENT_ReadGpioPinsUsingMask</a> event callback function is a pointer to a caller-allocated <b>GPIO_READ_PINS_MASK_PARAMETERS</b> structure.
