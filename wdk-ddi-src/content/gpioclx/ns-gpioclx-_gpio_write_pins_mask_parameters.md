...
f1_keywords:
 - _GPIO_WRITE_PINS_MASK_PARAMETERS
 - gpioclx/_GPIO_WRITE_PINS_MASK_PARAMETERS
 - PGPIO_WRITE_PINS_MASK_PARAMETERS
...
# GPIO_WRITE_PINS_MASK_PARAMETERS structure (gpioclx.h)
...
The <i>WriteParameters</i> parameter of the <a href="/windows-hardware/drivers/ddi/gpioclx/nc-gpioclx-gpio_client_write_pins_mask">CLIENT_WriteGpioPinsUsingMask</a> event callback function is a pointer to a caller-allocated <b>GPIO_WRITE_PINS_MASK_PARAMETERS</b> structure.
