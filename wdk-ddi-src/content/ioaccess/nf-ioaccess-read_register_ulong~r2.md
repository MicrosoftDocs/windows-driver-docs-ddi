...
description: The READ_REGISTER_ULONG function (ioaccess.h) returns a ULONG value read from the specified register address in resident, mapped device memory.
...
# READ_REGISTER_ULONG function (ioaccess.h)
