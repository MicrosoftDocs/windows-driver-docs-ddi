...
description: The READ_PORT_ULONG function (ioaccess.h) returns a ULONG value that is read from the specified port address in resident, mapped device memory.
