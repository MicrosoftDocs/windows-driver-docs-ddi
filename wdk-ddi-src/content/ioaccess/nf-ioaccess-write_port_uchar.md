...
title: WRITE_PORT_UCHAR function (ioaccess.h)
description: The WRITE_PORT_UCHAR function (ioaccess.h) writes a byte to the specified port address in resident, mapped device memory.
