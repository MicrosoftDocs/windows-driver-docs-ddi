...
A buffer containing a <a href="/windows-hardware/drivers/ddi/sidebandaudio/ns-sidebandaudio-_sidebandaudio_device_descriptor">SIDEBANDAUDIO_DEVICE_DESCRIPTOR</a> structure.
...
The audio driver can then iteratively determine each endpoints capability with the IOCTL <a href="/windows-hardware/drivers/ddi/sidebandaudio/ni-sidebandaudio-ioctl_sbaud_get_endpoint_descriptor">IOCTL_SBAUD_GET_ENDPOINT_DESCRIPTOR</a>.
