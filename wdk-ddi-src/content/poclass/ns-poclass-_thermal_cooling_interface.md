...
ms.date: 1/4/2018
ms.keywords: THERMAL_COOLING_INTERFACE structure [Kernel-Mode Driver Architecture], THERMAL_COOLING_INTERFACE, PTHERMAL_COOLING_INTERFACE structure pointer [Kernel-Mode Driver Architecture], poclass/THERMAL_COOLING_INTERFACE, poclass/PTHERMAL_COOLING_INTERFACE, *PTHERMAL_DEVICE_INTERFACE, THERMAL_DEVICE_INTERFACE, PTHERMAL_COOLING_INTERFACE, *PTHERMAL_COOLING_INTERFACE, kernel.thermal_cooling_interface, _THERMAL_COOLING_INTERFACE
