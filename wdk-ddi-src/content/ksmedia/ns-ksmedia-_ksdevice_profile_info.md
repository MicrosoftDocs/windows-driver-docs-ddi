...
ms.date: 2/22/2018
ms.keywords: PKSDEVICE_PROFILE_INFO structure pointer [Streaming Media Devices], KSDEVICE_PROFILE_INFO structure [Streaming Media Devices], ksmedia/KSDEVICE_PROFILE_INFO, PKSDEVICE_PROFILE_INFO, ksmedia/PKSDEVICE_PROFILE_INFO, _KSDEVICE_PROFILE_INFO, *PKSDEVICE_PROFILE_INFO, stream.ksdevice_profile_info, KSDEVICE_PROFILE_INFO
