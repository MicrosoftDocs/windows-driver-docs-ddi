...
tech.root: stream
ms.date: 04/23/2018
keywords: ["tagKSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER structure"]
...
f1_keywords:
 ...
 - ksmedia/tagKSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER
 - PKSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER
 - ksmedia/PKSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER
...
# tagKSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPSHEADER structure (ksmedia.h)
...
The size of this header and all <a href="/windows-hardware/drivers/ddi/ksmedia/ns-ksmedia-tagkscamera_extendedprop_roi_configcaps">KSCAMERA_EXTENDEDPROP_ROI_CONFIGCAPS</a> structures that follow.
