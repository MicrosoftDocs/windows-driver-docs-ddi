...
ms.date: 2/21/2018
ms.keywords: audio.ksjack_sink_information, PKSJACK_SINK_INFORMATION, PKSJACK_SINK_INFORMATION structure pointer [Audio Devices], aud-prop_e9bbfa8a-d002-400c-a35d-3da0a8026cd6.xml, KSJACK_SINK_INFORMATION, ksmedia/PKSJACK_SINK_INFORMATION, ksmedia/KSJACK_SINK_INFORMATION, KSJACK_SINK_INFORMATION structure [Audio Devices], _tagKSJACK_SINK_INFORMATION, *PKSJACK_SINK_INFORMATION
