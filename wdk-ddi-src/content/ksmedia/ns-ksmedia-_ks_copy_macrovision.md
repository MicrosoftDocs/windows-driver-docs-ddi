...
ms.date: 1/9/2018
ms.keywords: KS_COPY_MACROVISION, ksmedia/KS_COPY_MACROVISION, *PKS_COPY_MACROVISION, KS_COPY_MACROVISION structure [Streaming Media Devices], dvdref_42184498-7ac6-48d2-9f26-5bf69ececabb.xml, ksmedia/PKS_COPY_MACROVISION, stream.ks_copy_macrovision, _KS_COPY_MACROVISION, PKS_COPY_MACROVISION structure pointer [Streaming Media Devices], PKS_COPY_MACROVISION
