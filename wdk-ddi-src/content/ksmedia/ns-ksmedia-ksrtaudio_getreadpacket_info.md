...
ms.date: 12/14/2017
ms.keywords: audio.ksrtaudio_getreadpacket_info, ksmedia/PKSRTAUDIO_GETREADPACKET_INFO, KSRTAUDIO_GETREADPACKET_INFO, ksmedia/KSRTAUDIO_GETREADPACKET_INFO, *PKSRTAUDIO_GETREADPACKET_INFO, KSRTAUDIO_GETREADPACKET_INFO structure [Audio Devices], PKSRTAUDIO_GETREADPACKET_INFO structure pointer [Audio Devices], PKSRTAUDIO_GETREADPACKET_INFO
