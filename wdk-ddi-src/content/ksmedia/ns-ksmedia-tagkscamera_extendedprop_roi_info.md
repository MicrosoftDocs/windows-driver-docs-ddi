...
ms.date: 2/22/2018
ms.keywords: stream.kscamera_extendedprop_roi_info, KSCAMERA_EXTENDEDPROP_ROI_INFO structure [Streaming Media Devices], PKSCAMERA_EXTENDEDPROP_ROI_INFO structure pointer [Streaming Media Devices], *PKSCAMERA_EXTENDEDPROP_ROI_INFO, ksmedia/PKSCAMERA_EXTENDEDPROP_ROI_INFO, tagKSCAMERA_EXTENDEDPROP_ROI_INFO, ksmedia/KSCAMERA_EXTENDEDPROP_ROI_INFO, KSCAMERA_EXTENDEDPROP_ROI_INFO, PKSCAMERA_EXTENDEDPROP_ROI_INFO
