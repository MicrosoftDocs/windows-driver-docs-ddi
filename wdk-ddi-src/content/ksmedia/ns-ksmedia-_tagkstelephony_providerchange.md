...
f1_keywords:
 - _tagKSTELEPHONY_PROVIDERCHANGE
 - ksmedia/_tagKSTELEPHONY_PROVIDERCHANGE
...
The <b>KSTELEPHONY_PROVIDERCHANGE</b> structure specifies the phone call type and provider change operation to use for the <a href="/windows-hardware/drivers/audio/ksproperty-telephony-providerchange">KSPROPERTY_TELEPHONY_PROVIDERCHANGE</a> property.
