...
ms.date: 1/9/2018
ms.keywords: ksmedia/KS_FRAME_INFO, PKS_FRAME_INFO structure pointer [Streaming Media Devices], ksmedia/PKS_FRAME_INFO, tagKS_FRAME_INFO, vidcapstruct_1ce3f0b4-3032-4956-83a3-2a92039eb7a0.xml, *PKS_FRAME_INFO, stream.ks_frame_info, KS_FRAME_INFO structure [Streaming Media Devices], KS_FRAME_INFO, PKS_FRAME_INFO
