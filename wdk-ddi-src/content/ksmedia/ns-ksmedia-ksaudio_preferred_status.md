...
ms.date: 12/14/2017
ms.keywords: PKSAUDIO_PREFERRED_STATUS structure pointer [Audio Devices], ksmedia/PKSAUDIO_PREFERRED_STATUS, KSAUDIO_PREFERRED_STATUS structure [Audio Devices], PKSAUDIO_PREFERRED_STATUS, *PKSAUDIO_PREFERRED_STATUS, aud-prop_a1287dc0-98ad-4071-be11-41e51b6b4846.xml, ksmedia/KSAUDIO_PREFERRED_STATUS, KSAUDIO_PREFERRED_STATUS, audio.ksaudio_preferred_status
