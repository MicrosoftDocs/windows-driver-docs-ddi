...
ms.date: 12/14/2017
ms.keywords: ksmedia/TELEPHONY_CALLSTATE, TELEPHONY_CALLSTATE, ksmedia/TELEPHONY_CALLSTATE_ENABLED, TELEPHONY_CALLSTATE_PROVIDERTRANSITION, ksmedia/TELEPHONY_CALLSTATE_HOLD, audio.telephony_callstate, TELEPHONY_CALLSTATE_DISABLED, ksmedia/TELEPHONY_CALLSTATE_PROVIDERTRANSITION, TELEPHONY_CALLSTATE_ENABLED, TELEPHONY_CALLSTATE enumeration [Audio Devices], TELEPHONY_CALLSTATE_HOLD, ksmedia/TELEPHONY_CALLSTATE_DISABLED
