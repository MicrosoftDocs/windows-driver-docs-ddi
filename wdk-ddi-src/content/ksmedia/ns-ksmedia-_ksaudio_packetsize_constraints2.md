...
ms.date: 2/22/2018
ms.keywords: FILE_OCTA_ALIGNMENT, _KSAUDIO_PACKETSIZE_CONSTRAINTS2, FILE_WORD_ALIGNMENT, audio.ksaudio_packetsize_constraints2, ksmedia/KSAUDIO_PACKETSIZE_CONSTRAINTS2, PKSAUDIO_PACKETSIZE_CONSTRAINTS2, ksmedia/PKSAUDIO_PACKETSIZE_CONSTRAINTS2, FILE_QUAD_ALIGNMENT, PKSAUDIO_PACKETSIZE_CONSTRAINTS2 structure pointer [Audio Devices], FILE_256_BYTE_ALIGNMENT, FILE_BYTE_ALIGNMENT, FILE_128_BYTE_ALIGNMENT, FILE_64_BYTE_ALIGNMENT, FILE_512_BYTE_ALIGNMENT, FILE_LONG_ALIGNMENT, KSAUDIO_PACKETSIZE_CONSTRAINTS2, KSAUDIO_PACKETSIZE_CONSTRAINTS2 structure [Audio Devices], FILE_32_BYTE_ALIGNMENT
