...
ms.date: 2/22/2018
ms.keywords: FILE_OCTA_ALIGNMENT, _KSAUDIO_PACKETSIZE_CONSTRAINTS, KSAUDIO_PACKETSIZE_CONSTRAINTS, PKSAUDIO_PACKETSIZE_CONSTRAINTS structure pointer [Audio Devices], ksmedia/KSAUDIO_PACKETSIZE_CONSTRAINTS, FILE_WORD_ALIGNMENT, FILE_256_BYTE_ALIGNMENT, KSAUDIO_PACKETSIZE_CONSTRAINTS structure [Audio Devices], ksmedia/PKSAUDIO_PACKETSIZE_CONSTRAINTS, PKSAUDIO_PACKETSIZE_CONSTRAINTS, FILE_BYTE_ALIGNMENT, FILE_64_BYTE_ALIGNMENT, FILE_128_BYTE_ALIGNMENT, audio.ksaudio_packetsize_constraints, FILE_LONG_ALIGNMENT, FILE_QUAD_ALIGNMENT, FILE_512_BYTE_ALIGNMENT, FILE_32_BYTE_ALIGNMENT
