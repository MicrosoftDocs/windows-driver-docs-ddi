...
ms.date: 1/9/2018
ms.keywords: PKSCAMERA_PROFILE_INFO structure pointer [Streaming Media Devices], _KSCAMERA_PROFILE_INFO, ksmedia/KSCAMERA_PROFILE_INFO, PKSCAMERA_PROFILE_INFO, KSCAMERA_PROFILE_INFO structure [Streaming Media Devices], KSCAMERA_PROFILE_INFO, ksmedia/PKSCAMERA_PROFILE_INFO, *PKSCAMERA_PROFILE_INFO, stream.kscamera_profile_info
