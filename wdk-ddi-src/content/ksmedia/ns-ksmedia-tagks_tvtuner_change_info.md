...
ms.date: 2/20/2018
ms.keywords: PKS_TVTUNER_CHANGE_INFO structure pointer [Streaming Media Devices], PKS_TVTUNER_CHANGE_INFO, KS_TVTUNER_CHANGE_INFO, ksmedia/KS_TVTUNER_CHANGE_INFO, tagKS_TVTUNER_CHANGE_INFO, KS_TVTUNER_CHANGE_INFO structure [Streaming Media Devices], vidcapstruct_225fdabf-bdaf-49df-a2e3-ace62a0a17e2.xml, stream.ks_tvtuner_change_info, ksmedia/PKS_TVTUNER_CHANGE_INFO, *PKS_TVTUNER_CHANGE_INFO
