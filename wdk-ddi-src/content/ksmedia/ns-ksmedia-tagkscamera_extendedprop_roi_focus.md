...
ms.date: 2/22/2018
ms.keywords: ksmedia/PKSCAMERA_EXTENDEDPROP_ROI_FOCUS, ksmedia/KSCAMERA_EXTENDEDPROP_ROI_FOCUS, PKSCAMERA_EXTENDEDPROP_ROI_FOCUS, KSCAMERA_EXTENDEDPROP_ROI_FOCUS structure [Streaming Media Devices], KSCAMERA_EXTENDEDPROP_ROI_FOCUS, PKSCAMERA_EXTENDEDPROP_ROI_FOCUS structure pointer [Streaming Media Devices], *PKSCAMERA_EXTENDEDPROP_ROI_FOCUS, stream.kscamera_extendedprop_roi_focus, tagKSCAMERA_EXTENDEDPROP_ROI_FOCUS
