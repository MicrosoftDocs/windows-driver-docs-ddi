...
ms.date: 1/9/2018
ms.keywords: PKSPROPERTY_TUNER_MODE_S, KSPROPERTY_TUNER_MODE_S structure [Streaming Media Devices], ksmedia/KSPROPERTY_TUNER_MODE_S, ksmedia/PKSPROPERTY_TUNER_MODE_S, KSPROPERTY_TUNER_MODE_S, stream.ksproperty_tuner_mode_s, vidcapstruct_fe1fe8d4-8abd-4db3-8438-ef7dddadfa5c.xml, PKSPROPERTY_TUNER_MODE_S structure pointer [Streaming Media Devices], *PKSPROPERTY_TUNER_MODE_S
