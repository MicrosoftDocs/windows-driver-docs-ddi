...
ms.date: 2/22/2018
ms.keywords: ksmedia/PKSAUDIOENGINE_DESCRIPTOR, audio.ksaudioengine_descriptor, KSAUDIOENGINE_DESCRIPTOR, ksmedia/KSAUDIOENGINE_DESCRIPTOR, PKSAUDIOENGINE_DESCRIPTOR, *PKSAUDIOENGINE_DESCRIPTOR, PKSAUDIOENGINE_DESCRIPTOR structure pointer [Audio Devices], KSAUDIOENGINE_DESCRIPTOR structure [Audio Devices], _tagKSAUDIOENGINE_DESCRIPTOR
