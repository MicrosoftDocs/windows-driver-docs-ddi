...
ms.date: 1/9/2018
ms.keywords: stream.ks_datarange_video_palette, PKS_DATARANGE_VIDEO_PALETTE structure pointer [Streaming Media Devices], PKS_DATARANGE_VIDEO_PALETTE, vidcapstruct_8bba39d4-8ffb-41df-b314-f63fe26d66fa.xml, KS_DATARANGE_VIDEO_PALETTE, ksmedia/KS_DATARANGE_VIDEO_PALETTE, KS_DATARANGE_VIDEO_PALETTE structure [Streaming Media Devices], *PKS_DATARANGE_VIDEO_PALETTE, tagKS_DATARANGE_VIDEO_PALETTE, ksmedia/PKS_DATARANGE_VIDEO_PALETTE
