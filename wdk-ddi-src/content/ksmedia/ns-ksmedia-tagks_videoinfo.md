...
# tagKS_VIDEOINFO structure (ksmedia.h)
...
<a href="/windows-hardware/drivers/ddi/ksmedia/ns-ksmedia-tag_ks_truecolorinfo">KS_TRUECOLORINFO</a> structure that contains both a color palette and an array of color bitmasks.
