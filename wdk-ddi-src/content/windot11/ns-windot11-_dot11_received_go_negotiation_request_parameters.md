...
tech.root: netvista
ms.date: 02/16/2018
keywords: ["DOT11_RECEIVED_GO_NEGOTIATION_REQUEST_PARAMETERS structure"]
...
f1_keywords:
 - _DOT11_RECEIVED_GO_NEGOTIATION_REQUEST_PARAMETERS
 - windot11/_DOT11_RECEIVED_GO_NEGOTIATION_REQUEST_PARAMETERS
...
# DOT11_RECEIVED_GO_NEGOTIATION_REQUEST_PARAMETERS structure (windot11.h)
...
The parameters for a received Group Owner (GO) negotiation request are specified in a <b>DOT11_RECEIVED_GO_NEGOTIATION_REQUEST_PARAMETERS</b> structure. This structure is sent with an <a href="/windows-hardware/drivers/network/ndis-status-dot11-wfd-received-go-negotiation-request">NDIS_STATUS_DOT11_WFD_RECEIVED_GO_NEGOTIATION_REQUEST</a> indication.
...
The context data from the miniport driver. The system sends this context with the <a href="/windows-hardware/drivers/network/oid-dot11-wfd-send-go-negotiation-response">OID_DOT11_WFD_SEND_GO_NEGOTIATION_RESPONSE</a> request.
