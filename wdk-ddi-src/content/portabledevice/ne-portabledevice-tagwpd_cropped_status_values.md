...
Indicates the cropped status of an image. This enumeration is used by the [**WPD_IMAGE_CROPPED_STATUS**](https://docs.microsoft.com/windows/win32/wpd_sdk/image-properties) property.
