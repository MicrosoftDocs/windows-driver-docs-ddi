...
ms.date: 2/20/2018
ms.keywords: RECORDER_CONFIGURE_PARAMS, RECORDER_CONFIGURE_PARAMS structure [Driver Development Tools], wpprecorder/RECORDER_CONFIGURE_PARAMS, PRECORDER_CONFIGURE_PARAMS structure pointer [Driver Development Tools], _RECORDER_CONFIGURE_PARAMS, *PRECORDER_CONFIGURE_PARAMS, wpprecorder/PRECORDER_CONFIGURE_PARAMS, PRECORDER_CONFIGURE_PARAMS, devtest.recorder_configure_params
...
product: Windows
targetos: Windows
req.typenames: "*PRECORDER_CONFIGURE_PARAMS, RECORDER_CONFIGURE_PARAMS"
