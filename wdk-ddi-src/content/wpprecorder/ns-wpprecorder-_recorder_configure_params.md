...
ms.date: 2/20/2018
ms.keywords: PRECORDER_CONFIGURE_PARAMS structure pointer [Driver Development Tools], RECORDER_CONFIGURE_PARAMS, _RECORDER_CONFIGURE_PARAMS, PRECORDER_CONFIGURE_PARAMS, devtest.recorder_configure_params, wpprecorder/PRECORDER_CONFIGURE_PARAMS, *PRECORDER_CONFIGURE_PARAMS, RECORDER_CONFIGURE_PARAMS structure [Driver Development Tools], wpprecorder/RECORDER_CONFIGURE_PARAMS
