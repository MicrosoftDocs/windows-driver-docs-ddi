...
ms.date: 2/15/2018
ms.keywords: SECURE_ELEMENT_TYPE, *PSECURE_ELEMENT_TYPE enumeration [Near-Field Proximity Drivers], nfcsedev/Integrated, nfcsedev/External, _SECURE_ELEMENT_TYPE, SECURE_ELEMENT_TYPE, *PSECURE_ELEMENT_TYPE, Integrated, nfcsedev/DeviceHost, External, SECURE_ELEMENT_TYPE, nfpdrivers._secure_element_type, nfcsedev/_SECURE_ELEMENT_TYPE, DeviceHost, _SECURE_ELEMENT_TYPE enumeration [Near-Field Proximity Drivers], *PSECURE_ELEMENT_TYPE
