...
ms.date: 12/18/2017
ms.keywords: P_SECURE_ELEMENT_TECH_ROUTING_INFO structure pointer [Near-Field Proximity Drivers], nfcsedev/_SECURE_ELEMENT_TECH_ROUTING_INFO, *PSECURE_ELEMENT_TECH_ROUTING_INFO, P_SECURE_ELEMENT_TECH_ROUTING_INFO, SECURE_ELEMENT_TECH_ROUTING_INFO, nfpdrivers._secure_element_tech_routing_info, nfcsedev/P_SECURE_ELEMENT_TECH_ROUTING_INFO, SECURE_ELEMENT_TECH_ROUTING_INFO structure [Near-Field Proximity Drivers], _SECURE_ELEMENT_TECH_ROUTING_INFO
