...
Stores the information about a system environment variable using
    SysEnv device. This structure is used in the <a href="/windows-hardware/drivers/ddi/ntddsysenv/ni-ntddsysenv-ioctl_sysenv_query_variable_info">IOCTL_SYSENV_QUERY_VARIABLE_INFO</a> request.
