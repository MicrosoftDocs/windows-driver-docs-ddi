...
description: The _TAPE_GET_POSITION structure (ntddtape.h) contains the current absolute, logical, or pseudo logical partition and offset position on the tape.
...
# TAPE_GET_POSITION structure (ntddtape.h)
