...
ms.date: 12/14/2017
ms.keywords: IAllocatorMXF, dmusicks/IAllocatorMXF::GetBuffer, GetBuffer, GetBuffer method [Audio Devices], IAllocatorMXF interface, audio.iallocatormxf_getbuffer, IAllocatorMXF::GetBuffer, GetBuffer method [Audio Devices], IAllocatorMXF interface [Audio Devices], GetBuffer method, audmp-routines_5abb78f4-de92-4342-877f-e7f1c15f8d8e.xml
