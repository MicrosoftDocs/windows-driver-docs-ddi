...
ms.date: 12/14/2017
ms.keywords: IPortDMus interface [Audio Devices], Notify method, dmusicks/IPortDMus::Notify, audio.iportdmus_notify, IPortDMus::Notify, audmp-routines_cc818dda-ae0e-435e-8d94-f1632a4c4319.xml, Notify, Notify method [Audio Devices], IPortDMus interface, IPortDMus, Notify method [Audio Devices]
