...
ms.date: 2/22/2018
ms.keywords: audmp-routines_8c8379c0-db14-4275-adfc-2dd595879feb.xml, ISynthSinkDMus interface [Audio Devices], RefTimeToSample method, audio.isynthsinkdmus_reftimetosample, ISynthSinkDMus::RefTimeToSample, RefTimeToSample method [Audio Devices], RefTimeToSample, RefTimeToSample method [Audio Devices], ISynthSinkDMus interface, ISynthSinkDMus, dmusicks/ISynthSinkDMus::RefTimeToSample
