...
ms.date: 2/22/2018
ms.keywords: dmusicks/DMUS_KERNEL_EVENT, PDMUS_KERNEL_EVENT structure pointer [Audio Devices], *PDMUS_KERNEL_EVENT, dmusicks/PDMUS_KERNEL_EVENT, PDMUS_KERNEL_EVENT, _DMUS_KERNEL_EVENT, DMUS_KERNEL_EVENT, aud-prop_b0db54b3-fff3-46f2-abd7-beb4fe189f8f.xml, audio.dmus_kernel_event, DMUS_KERNEL_EVENT structure [Audio Devices]
