...
ms.date: 12/14/2017
ms.keywords: IMiniportDMus interface [Audio Devices], Init method, Init method [Audio Devices], Init, audio.iminiportdmus_init, audmp-routines_016b2aed-13f3-4d9a-86c0-fbdbcbf55341.xml, IMiniportDMus::Init, IMiniportDMus, Init method [Audio Devices], IMiniportDMus interface, dmusicks/IMiniportDMus::Init
