...
ms.date: 2/22/2018
ms.keywords: DMUS_STREAM_MIDI_INVALID, dmusicks/DMUS_STREAM_TYPE, DMUS_STREAM_MIDI_RENDER, dmusicks/DMUS_STREAM_MIDI_CAPTURE, DMUS_STREAM_WAVE_SINK, dmusicks/DMUS_STREAM_MIDI_INVALID, audio.dmus_stream_type, dmusicks/DMUS_STREAM_MIDI_RENDER, dmusicks/DMUS_STREAM_WAVE_SINK, DMUS_STREAM_TYPE enumeration [Audio Devices], DMUS_STREAM_TYPE, DMUS_STREAM_MIDI_CAPTURE
