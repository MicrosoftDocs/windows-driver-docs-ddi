...
# EVT_ACX_OBJECT_PROCESS_EVENT_REQUEST function (acxrequest.h)
...
A verb from the [ACX_EVENT_VERB](ne-acxrequest-acx_event_verb.md) enumeration that describes the type of operation.
