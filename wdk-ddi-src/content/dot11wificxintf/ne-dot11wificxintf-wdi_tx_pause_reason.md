---
UID: NE:dot11wificxintf._WDI_TX_PAUSE_REASON
tech.root: netvista
title: WDI_TX_PAUSE_REASON
ms.date: 04/30/2021
ms.topic: language-reference
targetos: Windows
description: "Microsoft reserves the WDI_TX_PAUSE_REASON enumeration for internal use only. Don't use this enumeration in your code."
...
f1_keywords:
 - _WDI_TX_PAUSE_REASON
 - dot11wificxintf/_WDI_TX_PAUSE_REASON
 - WDI_TX_PAUSE_REASON
 - dot11wificxintf/WDI_TX_PAUSE_REASON
dev_langs:
 - c++
---
