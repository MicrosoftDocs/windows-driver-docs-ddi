---
UID: NC:dot11wificxintf.MINIPORT_WDI_TX_SUSPECT_FRAME_LIST_ABORT
tech.root: netvista
title: MINIPORT_WDI_TX_SUSPECT_FRAME_LIST_ABORT
ms.date: 04/30/2021
targetos: Windows
description: "Microsoft reserves the MINIPORT_WDI_TX_SUSPECT_FRAME_LIST_ABORT callback function for internal use only. Don't use this callback function in your code."
req.assembly: 
...
f1_keywords:
 - MINIPORT_WDI_TX_SUSPECT_FRAME_LIST_ABORT
 - dot11wificxintf/MINIPORT_WDI_TX_SUSPECT_FRAME_LIST_ABORT
dev_langs:
 - c++
---
