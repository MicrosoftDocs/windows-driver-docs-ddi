...
ms.date: 04/30/2021
targetos: Windows
description: "Microsoft reserves the WDI_RX_INDICATION_LEVEL enumeration for internal use only. Don't use this enumeration in your code."
...
# WDI_RX_INDICATION_LEVEL enumeration (dot11wificxintf.h)
