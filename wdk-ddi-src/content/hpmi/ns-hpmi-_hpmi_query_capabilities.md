...
ms.date: 12/14/2017
ms.keywords: PHPMI_QUERY_CAPABILITIES, PHPMI_QUERY_CAPABILITIES structure pointer [Power Metering and Budgeting Devices], _HPMI_QUERY_CAPABILITIES, HPMI_QUERY_CAPABILITIES structure [Power Metering and Budgeting Devices], HPMI_QUERY_CAPABILITIES, powermeter.hpmi_query_capabilities, hpmi/PHPMI_QUERY_CAPABILITIES, *PHPMI_QUERY_CAPABILITIES, hpmi/HPMI_QUERY_CAPABILITIES
