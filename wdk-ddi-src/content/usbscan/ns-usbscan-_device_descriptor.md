...
ms.date: 1/18/2018
ms.keywords: stifnc_1b07d50b-5530-47d4-a212-54305a0fef7a.xml, PDEVICE_DESCRIPTOR structure pointer [Imaging Devices], *PDEVICE_DESCRIPTOR, _DEVICE_DESCRIPTOR, usbscan/PDEVICE_DESCRIPTOR, DEVICE_DESCRIPTOR, image.device_descriptor, DEVICE_DESCRIPTOR structure [Imaging Devices], usbscan/DEVICE_DESCRIPTOR, PDEVICE_DESCRIPTOR
