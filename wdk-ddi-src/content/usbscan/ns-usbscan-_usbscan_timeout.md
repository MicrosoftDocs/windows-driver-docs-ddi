...
ms.date: 2/22/2018
ms.keywords: stifnc_ebdd7bda-2eb0-446c-a52c-e9a80f6478da.xml, USBSCAN_TIMEOUT structure [Imaging Devices], image.usbscan_timeout, *PUSBSCAN_TIMEOUT, PUSBSCAN_TIMEOUT structure pointer [Imaging Devices], USBSCAN_TIMEOUT, PUSBSCAN_TIMEOUT, usbscan/PUSBSCAN_TIMEOUT, usbscan/USBSCAN_TIMEOUT, _USBSCAN_TIMEOUT
