...
<dd>
Device handle, obtained by calling <a href="/windows/win32/api/fileapi/nf-fileapi-createfilea">CreateFile</a>.
...
When the <b>DeviceloControl</b> function is called with the IOCTL_CANCEL_IO I/O control code, the caller must specify one of the <a href="/windows-hardware/drivers/ddi/usbscan/ne-usbscan-pipe_type">PIPE_TYPE</a>-typed values as the function's <i>lpInBuffer</i> parameter. This value indicates on which of the transfer pipes (interrupt, bulk IN, bulk OUT) the operation should be performed. For more information, see <a href="/windows-hardware/drivers/image/accessing-kernel-mode-drivers-for-still-image-devices">Accessing Kernel-Mode Drivers for Still Image Devices</a>.