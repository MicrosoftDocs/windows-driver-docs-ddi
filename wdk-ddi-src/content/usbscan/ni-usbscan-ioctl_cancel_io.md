...
Pointer to a location containing a value of type <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/usbscan/ne-usbscan-pipe_type">PIPE_TYPE</a>.
