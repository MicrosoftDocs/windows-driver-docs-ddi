...
<b>D3DKMT_EVICT</b> is used with <a href="/windows-hardware/drivers/ddi/d3dkmthk/nf-d3dkmthk-d3dkmtevict">D3DKMTEvict</a> to subtract one from the residency reference count.
