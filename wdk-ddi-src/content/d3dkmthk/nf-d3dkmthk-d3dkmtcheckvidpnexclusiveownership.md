...
description: The D3DKMTCheckVidPnExclusiveOwnership function determines the video present source with exclusive ownership of a video present network (VidPN).
...
A pointer to a [D3DKMT_CHECKVIDPNEXCLUSIVEOWNERSHIP](ns-d3dkmthk-_d3dkmt_checkvidpnexclusiveownership.md) structure that describes the parameters to determine exclusive VidPN ownership.
...
[D3DKMT_CHECKVIDPNEXCLUSIVEOWNERSHIP](ns-d3dkmthk-_d3dkmt_checkvidpnexclusiveownership.md)
