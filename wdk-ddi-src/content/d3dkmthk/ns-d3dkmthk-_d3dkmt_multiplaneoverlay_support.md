...
req.unicode-ansi: 
req.max-support: 
req.typenames: D3DKMT_MULTIPLANEOVERLAY_SUPPORT
targetos: Windows
ms.custom: RS5
tech.root: display
f1_keywords:
 - _D3DKMT_MULTIPLANEOVERLAY_SUPPORT
 - d3dkmthk/_D3DKMT_MULTIPLANEOVERLAY_SUPPORT
 - D3DKMT_MULTIPLANEOVERLAY_SUPPORT
 - d3dkmthk/D3DKMT_MULTIPLANEOVERLAY_SUPPORT
topic_type:
 - apiref
api_type:
 - HeaderDef
...
# D3DKMT_MULTIPLANEOVERLAY_SUPPORT structure (d3dkmthk.h)
