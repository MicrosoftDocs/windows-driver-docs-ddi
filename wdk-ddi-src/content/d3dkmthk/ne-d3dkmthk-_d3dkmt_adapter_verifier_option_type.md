...
description: The _D3DKMT_ADAPTER_VERIFIER_OPTION_TYPE enumeration contains values that indicate the type of adapter verifier options.
ms.date: 10/19/2018
...
# D3DKMT_ADAPTER_VERIFIER_OPTION_TYPE enumeration (d3dkmthk.h)
