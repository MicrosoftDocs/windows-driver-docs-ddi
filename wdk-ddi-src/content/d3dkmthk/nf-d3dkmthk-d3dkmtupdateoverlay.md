...
A pointer to a <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/d3dkmthk/ns-d3dkmthk-_d3dkmt_updateoverlay">D3DKMT_UPDATEOVERLAY</a> structure that describes how to modify the overlay.
...
| **STATUS_NO_MEMORY** | [D3DKMTUpdateOverlay](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/d3dkmthk/nf-d3dkmthk-d3dkmtupdateoverlay)  could not complete because of insufficient memory. | 

This function might also return other NTSTATUS values.

## -see-also

<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/d3dkmthk/ns-d3dkmthk-_d3dkmt_updateoverlay">D3DKMT_UPDATEOVERLAY</a>
 
