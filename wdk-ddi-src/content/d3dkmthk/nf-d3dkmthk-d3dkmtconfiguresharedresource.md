...
A pointer to a [D3DKMT_CONFIGURESHAREDRESOURCE](ns-d3dkmthk-_d3dkmt_configuresharedresource.md) structure that specifies parameters to configure the shared resource.
...
[D3DKMT_CONFIGURESHAREDRESOURCE](ns-d3dkmthk-_d3dkmt_configuresharedresource.md)
