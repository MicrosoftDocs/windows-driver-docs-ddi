...
| **STATUS_NO_MEMORY** | [D3DKMTCreateSynchronizationObject2](https://msdn.microsoft.com/library/windows/hardware/ff546879) could not complete because of insufficient memory. | 
