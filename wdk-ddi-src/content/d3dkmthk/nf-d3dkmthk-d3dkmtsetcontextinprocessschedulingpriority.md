...
A pointer to a [D3DKMT_SETCONTEXTINPROCESSSCHEDULINGPRIORITY](ns-d3dkmthk-_d3dkmt_setcontextinprocessschedulingpriority.md) structure that describes parameters for setting the scheduling priority for a device context.
...
[D3DKMTGetContextInProcessSchedulingPriority](nf-d3dkmthk-d3dkmtgetcontextinprocessschedulingpriority.md)

[D3DKMT_SETCONTEXTINPROCESSSCHEDULINGPRIORITY](ns-d3dkmthk-_d3dkmt_setcontextinprocessschedulingpriority.md)
