...
The number of dirty regions in the array that the <b>Rects</b> member specifies.

### -field Rects [in]

An array of <a href="/windows/win32/api/windef/ns-windef-rect">RECT</a> structures that specifies the dirty regions of a surface.
