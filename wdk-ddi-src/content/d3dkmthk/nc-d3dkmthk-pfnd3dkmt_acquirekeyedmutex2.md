...
| **STATUS_NO_MEMORY** | [D3DKMTAcquireKeyedMutex2](https://msdn.microsoft.com/library/windows/hardware/hh439340)  could not complete because of insufficient memory. | 
