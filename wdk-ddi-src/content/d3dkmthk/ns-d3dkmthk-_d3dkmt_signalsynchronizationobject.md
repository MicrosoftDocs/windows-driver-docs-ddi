...
f1_keywords:
 - _D3DKMT_SIGNALSYNCHRONIZATIONOBJECT
 - d3dkmthk/_D3DKMT_SIGNALSYNCHRONIZATIONOBJECT
...
The D3DKMT_SIGNALSYNCHRONIZATIONOBJECT structure contains information about the synchronization events that the <a href="/windows-hardware/drivers/ddi/d3dkmthk/nf-d3dkmthk-d3dkmtsignalsynchronizationobject">D3DKMTSignalSynchronizationObject</a> function signals.
