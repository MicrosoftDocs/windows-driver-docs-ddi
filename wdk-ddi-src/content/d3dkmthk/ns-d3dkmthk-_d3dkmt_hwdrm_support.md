...
title: D3DKMT_HWDRM_SUPPORT (d3dkmthk.h)
description: Learn more about the D3DKMT_HWDRM_SUPPORT structure.
ms.date: 02/06/2025
...
# D3DKMT_HWDRM_SUPPORT structure (d3dkmthk.h)
...
Boolean value that indicates whether hardware DRM is supported.
