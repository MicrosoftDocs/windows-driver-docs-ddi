...
Submits a present command from the [Desktop Duplication API](/windows/desktop/direct3ddxgi/desktop-dup-api) swapchain of the Desktop Window Manager (DWM) to the Microsoft DirectX graphics kernel subsystem (Dxgkrnl.sys).

## -parameters

### -param unnamedParam1 [in]

A pointer to a [D3DKMT_OUTPUTDUPLPRESENT](ns-d3dkmthk-_d3dkmt_outputduplpresent.md) structure that describes parameters for the present operation.
...
[D3DKMT_OUTPUTDUPLPRESENT](ns-d3dkmthk-_d3dkmt_outputduplpresent.md)
