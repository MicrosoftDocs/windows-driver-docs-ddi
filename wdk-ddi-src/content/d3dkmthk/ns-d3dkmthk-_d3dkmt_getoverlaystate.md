...
The D3DKMT_GETOVERLAYSTATE structure describes parameters that the <a href="/windows-hardware/drivers/ddi/d3dkmthk/nf-d3dkmthk-d3dkmtgetoverlaystate">D3DKMTGetOverlayState</a> function uses to retrieve status about an overlay.
