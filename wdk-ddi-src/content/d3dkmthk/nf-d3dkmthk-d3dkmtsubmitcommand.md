...
This function replaces the old [Render](../d3dkmddi/nc-d3dkmddi-dxgkddi_renderkm.md) function for such contexts and must be used in its place. Contexts that operate in legacy patch mode must continue to use the old **Render** function.
...
A pointer to a [D3DKMT_SUBMITCOMMAND](ns-d3dkmthk-_d3dkmt_submitcommand.md) structure that describes the operation.
...
[D3DKMT_SUBMITCOMMAND](ns-d3dkmthk-_d3dkmt_submitcommand.md)
