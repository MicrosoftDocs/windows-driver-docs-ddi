...
description: "ExAllocatePoolWithQuota allocates pool memory, but is obsolete. It's exported for existing driver binaries only. Use ExAllocatePoolWithQuotaTag instead."
