...
description: The ExAllocatePool routine is obsolete, and is exported for existing binaries only. Use ExAllocatePoolWithTag instead. ExAllocatePool allocates pool memory.
