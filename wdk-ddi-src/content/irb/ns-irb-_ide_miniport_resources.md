...
ms.date: 1/10/2018
ms.keywords: "*PIDE_MINIPORT_RESOURCES, irb/IDE_MINIPORT_RESOURCES, storage.ide_miniport_resources, PIDE_MINIPORT_RESOURCES, IDE_MINIPORT_RESOURCES structure [Storage Devices], _IDE_MINIPORT_RESOURCES, IDE_MINIPORT_RESOURCES, irb/PIDE_MINIPORT_RESOURCES, structs-ATA_28df7197-d4b0-4279-a4db-e9b1269f6ba7.xml, PIDE_MINIPORT_RESOURCES structure pointer [Storage Devices]"
