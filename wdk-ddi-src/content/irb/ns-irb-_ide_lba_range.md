...
ms.date: 1/10/2018
ms.keywords: irb/PIDE_LBA_RANGE, irb/IDE_LBA_RANGE, PIDE_LBA_RANGE, _IDE_LBA_RANGE, IDE_LBA_RANGE, PIDE_LBA_RANGE structure pointer [Storage Devices], structs-ATA_0abd91d5-18f0-49c9-b5de-ac442718da3f.xml, *PIDE_LBA_RANGE, IDE_LBA_RANGE structure [Storage Devices], storage.ide_lba_range
