...
The miniport driver sends an event only if it has been previously enabled by the miniport driver's <a href="/windows-hardware/drivers/ddi/scsiwmi/nc-scsiwmi-pscsiwmi_function_control">HwScsiWmiFunctionControl</a> routine. 
