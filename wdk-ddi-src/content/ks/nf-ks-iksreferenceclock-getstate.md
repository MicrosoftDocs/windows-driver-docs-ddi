...
Points to a <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ks/ne-ks-ksstate">KSSTATE</a> structure that indicates the streaming state of the underlying clock.
