...
This macro returns a pointer to the [KSMETHOD_SET](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ks/ns-ks-ksmethod_set) in which the method is located.
