...
Returns STATUS_SUCCESS if the requested count(s) have been retrieved. A unsuccessful return status indicates that <i>Pin</i> does not have an associated queue.
