...
ms.date: 1/9/2018
ms.keywords: IKsReferenceClock, ks/IKsReferenceClock::GetCorrelatedTime, GetCorrelatedTime method [Streaming Media Devices], IKsReferenceClock interface, avintfc_9bb8180e-a8e6-4b89-a615-0516470a7dd8.xml, GetCorrelatedTime, GetCorrelatedTime method [Streaming Media Devices], IKsReferenceClock interface [Streaming Media Devices], GetCorrelatedTime method, IKsReferenceClock::GetCorrelatedTime, stream.iksreferenceclock_getcorrelatedtime
