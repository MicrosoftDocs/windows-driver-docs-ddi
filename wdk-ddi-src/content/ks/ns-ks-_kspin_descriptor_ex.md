...
ms.date: 1/9/2018
ms.keywords: PKSPIN_DESCRIPTOR_EX structure pointer [Streaming Media Devices], KSPIN_FLAG_PROCESS_IF_ANY_IN_RUN_STATE, KSPIN_FLAG_DO_NOT_USE_STANDARD_TRANSPORT, KSPIN_FLAG_IMPLEMENT_CLOCK, KSPIN_FLAG_DO_NOT_INITIATE_PROCESSING, stream.kspin_descriptor_ex, KSPIN_FLAG_INITIATE_PROCESSING_ON_EVERY_ARRIVAL, KSPIN_FLAG_HYPERCRITICAL_PROCESSING, KSPIN_DESCRIPTOR_EX, KSPIN_FLAG_USE_STANDARD_TRANSPORT, KSPIN_FLAG_FIXED_FORMAT, KSPIN_FLAG_GENERATE_MAPPINGS, KSPIN_FLAG_PROCESS_IN_RUN_STATE_ONLY, ks/KSPIN_DESCRIPTOR_EX, KSPIN_FLAG_FRAMES_NOT_REQUIRED_FOR_PROCESSING, KSPIN_FLAG_DISTINCT_TRAILING_EDGE, KSPIN_FLAG_SOME_FRAMES_REQUIRED_FOR_PROCESSING, KSPIN_FLAG_SPLITTER, KSPIN_FLAG_DENY_USERMODE_ACCESS, *PKSPIN_DESCRIPTOR_EX, KSPIN_FLAG_ASYNCHRONOUS_PROCESSING, KSPIN_FLAG_CRITICAL_PROCESSING, avstruct_6a73afe1-d131-47fc-877b-1abff4a75833.xml, KSPIN_DESCRIPTOR_EX structure [Streaming Media Devices], KSPIN_FLAG_DISPATCH_LEVEL_PROCESSING, _KSPIN_DESCRIPTOR_EX, KSPIN_FLAG_GENERATE_EOS_EVENTS, KSPIN_FLAG_ENFORCE_FIFO, PKSPIN_DESCRIPTOR_EX, KSPIN_FLAG_RENDERER, ks/PKSPIN_DESCRIPTOR_EX
