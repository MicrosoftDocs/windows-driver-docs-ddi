...
ms.date: 2/22/2018
ms.keywords: stream.ksstream_metadata_info, KSSTREAM_METADATA_INFO, *PKSSTREAM_METADATA_INFO, ks/PKSSTREAM_METADATA_INFO, PKSSTREAM_METADATA_INFO, KSSTREAM_METADATA_INFO structure [Streaming Media Devices], ks/KSSTREAM_METADATA_INFO, PKSSTREAM_METADATA_INFO structure pointer [Streaming Media Devices]
