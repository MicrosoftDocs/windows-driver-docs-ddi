...
ms.date: 1/9/2018
ms.keywords: PKSOBJECT_CREATE, ks/PKSOBJECT_CREATE, KSOBJECT_CREATE, *PKSOBJECT_CREATE, ks-struct_885122dd-299b-47d0-b161-2d3ffac610f6.xml, PKSOBJECT_CREATE structure pointer [Streaming Media Devices], stream.ksobject_create, KSOBJECT_CREATE structure [Streaming Media Devices], ks/KSOBJECT_CREATE
