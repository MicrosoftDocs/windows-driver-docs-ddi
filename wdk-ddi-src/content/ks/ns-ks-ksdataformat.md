...
ms.date: 2/22/2018
ms.keywords: KSDATAFORMAT structure [Streaming Media Devices], ks-struct_787a73ee-98dd-4e97-b7ea-2ed38ff564c7.xml, ks/KSDATARANGE, ks/KSDATAFORMAT, KSDATARANGE, ks/PKSDATARANGE, PKSDATARANGE, *PKSDATARANGE, PKSDATAFORMAT structure pointer [Streaming Media Devices], KSDATARANGE structure [Streaming Media Devices], ks/PKSDATAFORMAT, PKSDATAFORMAT, stream.ksdataformat, *PKSDATAFORMAT, PKSDATARANGE structure pointer [Streaming Media Devices], KSDATAFORMAT
