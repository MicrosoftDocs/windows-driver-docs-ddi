...
ms.date: 2/22/2018
ms.keywords: PMF_MDL_SHARED_PAYLOAD_KEY, ks/PMF_MDL_SHARED_PAYLOAD_KEY, MF_MDL_SHARED_PAYLOAD_KEY, MF_MDL_SHARED_PAYLOAD_KEY union [Streaming Media Devices], stream.mf_mdl_shared_payload_key, PMF_MDL_SHARED_PAYLOAD_KEY union [Streaming Media Devices], ks/MF_MDL_SHARED_PAYLOAD_KEY, _MF_MDL_SHARED_PAYLOAD_KEY, *PMF_MDL_SHARED_PAYLOAD_KEY
