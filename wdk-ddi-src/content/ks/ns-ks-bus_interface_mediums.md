...
ms.date: 2/22/2018
ms.keywords: PBUS_INTERFACE_MEDIUMS structure pointer [Streaming Media Devices], BUS_INTERFACE_MEDIUMS structure [Streaming Media Devices], *PBUS_INTERFACE_MEDIUMS, ks/PBUS_INTERFACE_MEDIUMS, stream.bus_interface_mediums, ks/BUS_INTERFACE_MEDIUMS, PBUS_INTERFACE_MEDIUMS, BUS_INTERFACE_MEDIUMS
