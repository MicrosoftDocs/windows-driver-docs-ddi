...
ms.date: 2/22/2018
ms.keywords: PBUS_INTERFACE_REFERENCE, ks-struct_815b7147-1ae1-48d2-bae3-3efce2613b53.xml, BUS_INTERFACE_REFERENCE structure [Streaming Media Devices], PBUS_INTERFACE_REFERENCE structure pointer [Streaming Media Devices], *PBUS_INTERFACE_REFERENCE, stream.bus_interface_reference, ks/BUS_INTERFACE_REFERENCE, BUS_INTERFACE_REFERENCE, ks/PBUS_INTERFACE_REFERENCE
