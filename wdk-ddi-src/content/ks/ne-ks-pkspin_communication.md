...
ms.date: 2/22/2018
ms.keywords: ks/KSPIN_COMMUNICATION, ks/KSPIN_COMMUNICATION_NONE, KSPIN_COMMUNICATION_SOURCE, KSPIN_COMMUNICATION_BOTH, *PKSPIN_COMMUNICATION, KSPIN_COMMUNICATION, ks/PKSPIN_COMMUNICATION, KSPIN_COMMUNICATION_BRIDGE, ks/KSPIN_COMMUNICATION_SINK, KSPIN_COMMUNICATION_SINK, ks/KSPIN_COMMUNICATION_SOURCE, PKSPIN_COMMUNICATION enumeration pointer [Streaming Media Devices], ks/KSPIN_COMMUNICATION_BOTH, PKSPIN_COMMUNICATION, ks/KSPIN_COMMUNICATION_BRIDGE, KSPIN_COMMUNICATION enumeration [Streaming Media Devices], KSPIN_COMMUNICATION_NONE, stream.kspin_communication
