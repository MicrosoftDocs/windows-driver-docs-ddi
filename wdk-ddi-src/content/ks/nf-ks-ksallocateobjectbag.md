...
ms.date: 1/9/2018
ms.keywords: KsAllocateObjectBag function [Streaming Media Devices], stream.ksallocateobjectbag, ks/KsAllocateObjectBag, avfunc_a76be7a0-6dfa-4428-8317-4a8df31dec6e.xml, KsAllocateObjectBag
