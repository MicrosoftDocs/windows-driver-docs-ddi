...
ms.date: 2/22/2018
ms.keywords: ks/KSPROPERTY_GRAPHMANAGER_INTERFACE, *PKSPROPERTY_GRAPHMANAGER_INTERFACE, PKSPROPERTY_GRAPHMANAGER_INTERFACE structure pointer [Streaming Media Devices], KSPROPERTY_GRAPHMANAGER_INTERFACE structure [Streaming Media Devices], stream.ksproperty_graphmanager_interface, ks/PKSPROPERTY_GRAPHMANAGER_INTERFACE, _KSPROPERTY_GRAPHMANAGER_INTERFACE, PKSPROPERTY_GRAPHMANAGER_INTERFACE, KSPROPERTY_GRAPHMANAGER_INTERFACE
