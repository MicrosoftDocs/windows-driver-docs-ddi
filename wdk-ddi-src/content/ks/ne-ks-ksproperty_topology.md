...
ms.date: 2/20/2018
ms.keywords: KSPROPERTY_TOPOLOGY, KSPROPERTY_TOPOLOGY_NAME, ks/KSPROPERTY_TOPOLOGY_NAME, KSPROPERTY_TOPOLOGY_CATEGORIES, ks/KSPROPERTY_TOPOLOGY_CATEGORIES, KSPROPERTY_TOPOLOGY_CONNECTIONS, KSPROPERTY_TOPOLOGY enumeration [Streaming Media Devices], ks/KSPROPERTY_TOPOLOGY, KSPROPERTY_TOPOLOGY_NODES, ks/KSPROPERTY_TOPOLOGY_NODES, ks/KSPROPERTY_TOPOLOGY_CONNECTIONS, stream.ksproperty_topology
