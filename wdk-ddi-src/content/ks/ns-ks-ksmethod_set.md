...
Points to an array of <a href="/windows-hardware/drivers/ddi/ks/ns-ks-ksmethod_item">KSMETHOD_ITEM</a> structures. Each structure describes one method of the method set.
