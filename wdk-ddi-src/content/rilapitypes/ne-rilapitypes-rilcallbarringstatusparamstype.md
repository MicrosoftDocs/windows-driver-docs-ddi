...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RILCALLBARRINGSTATUSPARAMSTYPE, RIL_BARRTYPE_INCOMINGROAMING, rilapitypes/RIL_BARRTYPE_OUTGOINGINTEXTOHOME, rilapitypes/RIL_BARRTYPE_ALLBARRING, rilapitypes/RIL_BARRTYPE_INCOMINGNOTINUICC, RILCALLBARRINGSTATUSPARAMSTYPE, rilapitypes/RIL_BARRTYPE_ALLINCOMINGBARRING, RIL_BARRTYPE_ALL, RIL_BARRTYPE_OUTGOINGINT, rilapitypes/RIL_BARRTYPE_OUTGOINGINT, RIL_BARRTYPE_ALLINCOMING, RIL_BARRTYPE_INCOMINGNOTINUICC, rilapitypes/RIL_BARRTYPE_INCOMINGROAMING, RIL_BARRTYPE_ALLINCOMINGBARRING, rilapitypes/RIL_BARRTYPE_ALLINCOMING, rilapitypes/RIL_BARRTYPE_ALLOUTGOINGBARRING, RIL_BARRTYPE_ALLBARRING, RILCALLBARRINGSTATUSPARAMSTYPE enumeration [Network Drivers Starting with Windows Vista], RIL_BARRTYPE_ALLOUTGOINGBARRING, netvista.rilcallbarringstatusparamstype_2, rilapitypes/RIL_BARRTYPE_ALL, RIL_BARRTYPE_OUTGOINGINTEXTOHOME
