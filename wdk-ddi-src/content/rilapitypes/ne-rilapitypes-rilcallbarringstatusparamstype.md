...
ms.date: 2/16/2018
ms.keywords: netvista.rilcallbarringstatusparamstype_2, RILCALLBARRINGSTATUSPARAMSTYPE enumeration [Network Drivers Starting with Windows Vista], RIL_BARRTYPE_INCOMINGROAMING, rilapitypes/RIL_BARRTYPE_ALLINCOMING, rilapitypes/RIL_BARRTYPE_INCOMINGNOTINUICC, RIL_BARRTYPE_INCOMINGNOTINUICC, rilapitypes/RIL_BARRTYPE_OUTGOINGINT, RIL_BARRTYPE_ALLINCOMINGBARRING, rilapitypes/RIL_BARRTYPE_ALLBARRING, RIL_BARRTYPE_ALLINCOMING, rilapitypes/RILCALLBARRINGSTATUSPARAMSTYPE, RIL_BARRTYPE_ALLBARRING, rilapitypes/RIL_BARRTYPE_ALLINCOMINGBARRING, RILCALLBARRINGSTATUSPARAMSTYPE, RIL_BARRTYPE_ALL, RIL_BARRTYPE_OUTGOINGINTEXTOHOME, rilapitypes/RIL_BARRTYPE_INCOMINGROAMING, rilapitypes/RIL_BARRTYPE_ALL, RIL_BARRTYPE_OUTGOINGINT, rilapitypes/RIL_BARRTYPE_OUTGOINGINTEXTOHOME, RIL_BARRTYPE_ALLOUTGOINGBARRING, rilapitypes/RIL_BARRTYPE_ALLOUTGOINGBARRING
