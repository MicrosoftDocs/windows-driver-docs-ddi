...
ms.date: 1/18/2018
ms.keywords: RIL_BARRTYPE_OUTGOINGINT, RIL_BARRTYPE_INCOMINGNOTINUICC, RIL_BARRTYPE_INCOMINGROAMING, rilapitypes/RIL_BARRTYPE_ALLBARRING, RIL_BARRTYPE_ALLINCOMINGBARRING, rilapitypes/RIL_BARRTYPE_OUTGOINGINTEXTOHOME, RIL_BARRTYPE_ALLBARRING, rilapitypes/RIL_BARRTYPE_INCOMINGNOTINUICC, rilapitypes/RIL_BARRTYPE_ALLINCOMINGBARRING, rilapitypes/RIL_BARRTYPE_ALLINCOMING, netvista.rilcallbarringstatusparamstype_2, rilapitypes/RIL_BARRTYPE_OUTGOINGINT, RIL_BARRTYPE_OUTGOINGINTEXTOHOME, RIL_BARRTYPE_ALL, RIL_BARRTYPE_ALLOUTGOINGBARRING, RILCALLBARRINGSTATUSPARAMSTYPE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RILCALLBARRINGSTATUSPARAMSTYPE, rilapitypes/RIL_BARRTYPE_ALLOUTGOINGBARRING, rilapitypes/RIL_BARRTYPE_INCOMINGROAMING, RILCALLBARRINGSTATUSPARAMSTYPE, RIL_BARRTYPE_ALLINCOMING, rilapitypes/RIL_BARRTYPE_ALL
