...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_BARRTYPE_ALL, RIL_BARRTYPE_ALLOUTGOINGBARRING, RILCALLBARRINGSTATUSPARAMSTYPE, RIL_BARRTYPE_OUTGOINGINTEXTOHOME, RIL_BARRTYPE_ALL, rilapitypes/RIL_BARRTYPE_ALLOUTGOINGBARRING, RIL_BARRTYPE_INCOMINGROAMING, rilapitypes/RIL_BARRTYPE_ALLINCOMING, rilapitypes/RIL_BARRTYPE_OUTGOINGINT, RIL_BARRTYPE_INCOMINGNOTINUICC, rilapitypes/RIL_BARRTYPE_INCOMINGROAMING, rilapitypes/RIL_BARRTYPE_OUTGOINGINTEXTOHOME, RIL_BARRTYPE_ALLINCOMINGBARRING, rilapitypes/RILCALLBARRINGSTATUSPARAMSTYPE, RILCALLBARRINGSTATUSPARAMSTYPE enumeration [Network Drivers Starting with Windows Vista], RIL_BARRTYPE_OUTGOINGINT, rilapitypes/RIL_BARRTYPE_ALLBARRING, RIL_BARRTYPE_ALLINCOMING, netvista.rilcallbarringstatusparamstype_2, RIL_BARRTYPE_ALLBARRING, rilapitypes/RIL_BARRTYPE_INCOMINGNOTINUICC, rilapitypes/RIL_BARRTYPE_ALLINCOMINGBARRING
