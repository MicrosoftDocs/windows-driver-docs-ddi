...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_BARRTYPE_ALLINCOMINGBARRING, rilapitypes/RIL_BARRTYPE_OUTGOINGINTEXTOHOME, rilapitypes/RILCALLBARRINGSTATUSPARAMSTYPE, RILCALLBARRINGSTATUSPARAMSTYPE, RIL_BARRTYPE_ALLINCOMING, RIL_BARRTYPE_ALLOUTGOINGBARRING, rilapitypes/RIL_BARRTYPE_INCOMINGROAMING, rilapitypes/RIL_BARRTYPE_OUTGOINGINT, netvista.rilcallbarringstatusparamstype_2, rilapitypes/RIL_BARRTYPE_ALLOUTGOINGBARRING, RIL_BARRTYPE_ALLBARRING, RIL_BARRTYPE_ALL, rilapitypes/RIL_BARRTYPE_ALLINCOMING, RIL_BARRTYPE_INCOMINGNOTINUICC, RIL_BARRTYPE_OUTGOINGINT, rilapitypes/RIL_BARRTYPE_ALLBARRING, rilapitypes/RIL_BARRTYPE_ALL, RIL_BARRTYPE_OUTGOINGINTEXTOHOME, rilapitypes/RIL_BARRTYPE_INCOMINGNOTINUICC, RIL_BARRTYPE_INCOMINGROAMING, RILCALLBARRINGSTATUSPARAMSTYPE enumeration [Network Drivers Starting with Windows Vista], RIL_BARRTYPE_ALLINCOMINGBARRING
