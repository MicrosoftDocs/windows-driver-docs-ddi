...
ms.date: 2/16/2018
ms.keywords: netvista.rilsubscriberinfo, RILSUBSCRIBERINFO structure [Network Drivers Starting with Windows Vista], rilapitypes/RILSUBSCRIBERINFO, RILSUBSCRIBERINFO, *LPRILSUBSCRIBERINFO
