...
title: RILCALLRTT (rilapitypes.h)
description: "Microsoft reserves the RILCALLRTT structure for internal use only. Don't use this structure in your code."
...
# RILCALLRTT structure (rilapitypes.h)
