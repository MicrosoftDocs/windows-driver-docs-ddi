...
title: RILMSGSERVICEINFOPARAMMASK (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILMSGSERVICEINFOPARAMMASK enumeration for internal use only."
...
f1_keywords:
 ...
 - rilapitypes/RILMSGSERVICEINFOPARAMMASK
topic_type:
 - APIRef
 - kbSyntax
api_type:
