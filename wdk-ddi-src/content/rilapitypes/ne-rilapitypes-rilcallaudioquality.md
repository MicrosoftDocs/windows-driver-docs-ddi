...
title: RILCALLAUDIOQUALITY (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILCALLAUDIOQUALITY enumeration for internal use only. "
...
f1_keywords:
 - RILCALLAUDIOQUALITY
 - rilapitypes/RILCALLAUDIOQUALITY
topic_type:
 - APIRef
 - kbSyntax
api_type:
