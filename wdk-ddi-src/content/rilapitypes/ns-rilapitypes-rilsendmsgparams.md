...
description: "Don't use this structure in your code. Microsoft reserves the RILSENDMSGPARAMS structure for internal use only."
...
f1_keywords:
 ...
 - LPRILSENDMSGPARAMS
 - rilapitypes/LPRILSENDMSGPARAMS
topic_type:
 - APIRef
 - kbSyntax
api_type:
