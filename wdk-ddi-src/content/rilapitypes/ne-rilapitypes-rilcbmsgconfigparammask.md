...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_PARAM_CBMC_CDMASIZE, RILCBMSGCONFIGPARAMMASK, rilapitypes/RIL_PARAM_CBMC_GWLINFO, rilapitypes/RILCBMSGCONFIGPARAMMASK, RIL_PARAM_CBMC_CDMAINFO, RIL_PARAM_CBMC_GWLINFO, rilapitypes/RIL_PARAM_CBMC_CDMAINFO, RIL_PARAM_CBMC_CDMASIZE, rilapitypes/RIL_PARAM_CBMC_ALL, RILCBMSGCONFIGPARAMMASK enumeration [Network Drivers Starting with Windows Vista], netvista.rilcbmsgconfigparammask_2, RIL_PARAM_CBMC_ALL
