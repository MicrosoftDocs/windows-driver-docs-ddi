...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_PARAM_CBMC_CDMASIZE, netvista.rilcbmsgconfigparammask_2, rilapitypes/RIL_PARAM_CBMC_CDMAINFO, RIL_PARAM_CBMC_ALL, rilapitypes/RILCBMSGCONFIGPARAMMASK, rilapitypes/RIL_PARAM_CBMC_GWLINFO, rilapitypes/RIL_PARAM_CBMC_ALL, RILCBMSGCONFIGPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_CBMC_GWLINFO, RIL_PARAM_CBMC_CDMAINFO, RIL_PARAM_CBMC_CDMASIZE, RILCBMSGCONFIGPARAMMASK
