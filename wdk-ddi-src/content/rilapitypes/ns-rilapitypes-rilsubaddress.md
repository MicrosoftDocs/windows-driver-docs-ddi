...
ms.date: 1/18/2018
ms.keywords: RILSUBADDRESS structure [Network Drivers Starting with Windows Vista], *LPRILSUBADDRESS, RILSUBADDRESS, rilapitypes/RILSUBADDRESS, netvista.rilsubaddress_2
