...
ms.date: 2/16/2018
ms.keywords: netvista.rilmsgcdmalanguage_2, RIL_MSGCDMALANG_ENGLISH, rilapitypes/RIL_MSGCDMALANG_ENGLISH, rilapitypes/RIL_MSGCDMALANG_HEBREW, RILMSGCDMALANGUAGE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RILMSGCDMALANGUAGE, RIL_MSGCDMALANG_HEBREW, RIL_MSGCDMALANG_FRENCH, RILMSGCDMALANGUAGE, rilapitypes/RIL_MSGCDMALANG_FRENCH, rilapitypes/RIL_MSGCDMALANG_SPANISH, RIL_MSGCDMALANG_KOREAN, rilapitypes/RIL_MSGCDMALANG_KOREAN, RIL_MSGCDMALANG_SPANISH, RIL_MSGCDMALANG_CHINESE, rilapitypes/RIL_MSGCDMALANG_CHINESE, rilapitypes/RIL_MSGCDMALANG_MAX, rilapitypes/RIL_MSGCDMALANG_JAPANESE, RIL_MSGCDMALANG_JAPANESE, RIL_MSGCDMALANG_MAX
