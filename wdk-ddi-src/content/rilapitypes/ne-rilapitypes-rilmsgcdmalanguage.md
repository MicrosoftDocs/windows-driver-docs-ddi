...
ms.date: 1/18/2018
ms.keywords: netvista.rilmsgcdmalanguage_2, RILMSGCDMALANGUAGE, rilapitypes/RIL_MSGCDMALANG_ENGLISH, RIL_MSGCDMALANG_FRENCH, rilapitypes/RILMSGCDMALANGUAGE, rilapitypes/RIL_MSGCDMALANG_FRENCH, RIL_MSGCDMALANG_KOREAN, RILMSGCDMALANGUAGE enumeration [Network Drivers Starting with Windows Vista], RIL_MSGCDMALANG_ENGLISH, rilapitypes/RIL_MSGCDMALANG_KOREAN, rilapitypes/RIL_MSGCDMALANG_JAPANESE, RIL_MSGCDMALANG_SPANISH, RIL_MSGCDMALANG_CHINESE, RIL_MSGCDMALANG_HEBREW, rilapitypes/RIL_MSGCDMALANG_HEBREW, rilapitypes/RIL_MSGCDMALANG_SPANISH, rilapitypes/RIL_MSGCDMALANG_MAX, rilapitypes/RIL_MSGCDMALANG_CHINESE, RIL_MSGCDMALANG_MAX, RIL_MSGCDMALANG_JAPANESE
