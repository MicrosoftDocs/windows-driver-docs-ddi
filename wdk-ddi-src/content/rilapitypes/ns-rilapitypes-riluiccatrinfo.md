...
ms.date: 1/18/2018
ms.keywords: RILUICCATRINFO structure [Network Drivers Starting with Windows Vista], rilapitypes/RILUICCATRINFO, *LPRILUICCATRINFO, netvista.riluiccatrinfo_2, RILUICCATRINFO
