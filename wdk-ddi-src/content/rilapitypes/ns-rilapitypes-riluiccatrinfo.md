...
ms.date: 1/18/2018
ms.keywords: RILUICCATRINFO structure [Network Drivers Starting with Windows Vista], netvista.riluiccatrinfo_2, *LPRILUICCATRINFO, RILUICCATRINFO, rilapitypes/RILUICCATRINFO
