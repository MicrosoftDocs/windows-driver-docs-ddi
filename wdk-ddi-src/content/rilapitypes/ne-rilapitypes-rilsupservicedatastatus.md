...
ms.date: 1/18/2018
ms.keywords: RILSUPSERVICEDATASTATUS enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_SUPSVCDATASTATUS_MAX, RIL_SUPSVCDATASTATUS_TIMEOUT, RIL_SUPSVCDATASTATUS_MAX, netvista.rilsupservicedatastatus_2, rilapitypes/RILSUPSERVICEDATASTATUS, RILSUPSERVICEDATASTATUS, rilapitypes/RIL_SUPSVCDATASTATUS_TIMEOUT, rilapitypes/RIL_SUPSVCDATASTATUS_FURTHERINFOREQUIRED, RIL_SUPSVCDATASTATUS_FURTHERINFOREQUIRED, RIL_SUPSVCDATASTATUS_ERROR, rilapitypes/RIL_SUPSVCDATASTATUS_ERROR
