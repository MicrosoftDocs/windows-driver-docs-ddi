...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_PARAM_NITZ_SYSTEMTIME, RIL_PARAM_NITZ_TIMEZONEOFFSET, RIL_PARAM_NITZ_DAYLIGHTSAVINGOFFSET, rilapitypes/RIL_PARAM_NITZ_SYSTEMTYPE, netvista.rilnitzinfoparammask_2, rilapitypes/RIL_PARAM_NITZ_DAYLIGHTSAVINGOFFSET, rilapitypes/RIL_PARAM_NITZ_ALL, rilapitypes/RILNITZINFOPARAMMASK, RIL_PARAM_NITZ_SYSTEMTIME, RIL_PARAM_NITZ_SYSTEMTYPE, RILNITZINFOPARAMMASK, RILNITZINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_NITZ_TIMEZONEOFFSET, RIL_PARAM_NITZ_ALL
