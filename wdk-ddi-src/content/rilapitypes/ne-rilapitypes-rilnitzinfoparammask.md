...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RILNITZINFOPARAMMASK, RILNITZINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_NITZ_TIMEZONEOFFSET, RIL_PARAM_NITZ_SYSTEMTYPE, netvista.rilnitzinfoparammask_2, rilapitypes/RIL_PARAM_NITZ_SYSTEMTYPE, RILNITZINFOPARAMMASK, RIL_PARAM_NITZ_DAYLIGHTSAVINGOFFSET, rilapitypes/RIL_PARAM_NITZ_TIMEZONEOFFSET, rilapitypes/RIL_PARAM_NITZ_ALL, rilapitypes/RIL_PARAM_NITZ_DAYLIGHTSAVINGOFFSET, rilapitypes/RIL_PARAM_NITZ_SYSTEMTIME, RIL_PARAM_NITZ_ALL, RIL_PARAM_NITZ_SYSTEMTIME
