...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_PARAM_NITZ_SYSTEMTIME, rilapitypes/RIL_PARAM_NITZ_TIMEZONEOFFSET, RIL_PARAM_NITZ_SYSTEMTYPE, RILNITZINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_NITZ_SYSTEMTYPE, rilapitypes/RIL_PARAM_NITZ_ALL, RIL_PARAM_NITZ_DAYLIGHTSAVINGOFFSET, rilapitypes/RILNITZINFOPARAMMASK, RIL_PARAM_NITZ_ALL, RIL_PARAM_NITZ_SYSTEMTIME, RILNITZINFOPARAMMASK, rilapitypes/RIL_PARAM_NITZ_DAYLIGHTSAVINGOFFSET, RIL_PARAM_NITZ_TIMEZONEOFFSET, netvista.rilnitzinfoparammask_2
