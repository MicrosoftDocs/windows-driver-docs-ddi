...
ms.date: 1/18/2018
ms.keywords: RIL_PARAM_NITZ_SYSTEMTIME, rilapitypes/RIL_PARAM_NITZ_SYSTEMTYPE, rilapitypes/RILNITZINFOPARAMMASK, rilapitypes/RIL_PARAM_NITZ_SYSTEMTIME, rilapitypes/RIL_PARAM_NITZ_TIMEZONEOFFSET, RILNITZINFOPARAMMASK, RILNITZINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_NITZ_ALL, netvista.rilnitzinfoparammask_2, RIL_PARAM_NITZ_SYSTEMTYPE, RIL_PARAM_NITZ_TIMEZONEOFFSET, rilapitypes/RIL_PARAM_NITZ_DAYLIGHTSAVINGOFFSET, RIL_PARAM_NITZ_DAYLIGHTSAVINGOFFSET, RIL_PARAM_NITZ_ALL
