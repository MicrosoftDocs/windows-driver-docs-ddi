...
ms.date: 1/18/2018
ms.keywords: RILRADIOSTATEITEMS, RILRADIOSTATEITEMS structure [Network Drivers Starting with Windows Vista], rilapitypes/RILRADIOSTATEITEMS, *LPRILRADIOSTATEITEMS, netvista.rilradiostateitems_2
