...
title: RILRADIOSTATEITEMS (rilapitypes.h)
description: "Don't use this structure in your code. Microsoft reserves the RILRADIOSTATEITEMS structure for internal use only."
...
# RILRADIOSTATEITEMS structure (rilapitypes.h)
