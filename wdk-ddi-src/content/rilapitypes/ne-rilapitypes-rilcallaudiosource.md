...
title: RILCALLAUDIOSOURCE (rilapitypes.h)
description: "Microsoft reserves the RILCALLAUDIOSOURCE enumeration for internal use only. Don't use this enumeration in your code."
