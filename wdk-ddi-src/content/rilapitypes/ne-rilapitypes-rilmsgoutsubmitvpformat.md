...
title: RILMSGOUTSUBMITVPFORMAT (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILMSGOUTSUBMITVPFORMAT enumeration for internal use only."
old-location: netvista\rilmsgoutsubmitvpformat.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILMSGOUTSUBMITVPFORMAT enumeration"]
...
f1_keywords:
 ...
 - rilapitypes/RILMSGOUTSUBMITVPFORMAT
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# RILMSGOUTSUBMITVPFORMAT enumeration (rilapitypes.h)
