...
title: RILMSGPROTOCOLID (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILMSGPROTOCOLID enumeration for internal use only."
