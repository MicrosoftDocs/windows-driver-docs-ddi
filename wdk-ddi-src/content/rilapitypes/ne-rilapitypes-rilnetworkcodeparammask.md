...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_PARAM_NETWORKCODE_SID, rilapitypes/RIL_PARAM_NETWORKCODE_NID, RIL_PARAM_NETWORKCODE_EXECUTOR, RIL_PARAM_NETWORKCODE_MCC, RILNETWORKCODEPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_NETWORKCODE_MNC, RIL_PARAM_NETWORKCODE_NID, RIL_PARAM_NETWORKCODE_RI, rilapitypes/RIL_PARAM_NETWORKCODE_RI, RIL_PARAM_NETWORKCODE_ALL, netvista.rilnetworkcodeparammask, rilapitypes/RILNETWORKCODEPARAMMASK, rilapitypes/RIL_PARAM_NETWORKCODE_EXECUTOR, rilapitypes/RIL_PARAM_NETWORKCODE_MCC, rilapitypes/RIL_PARAM_NETWORKCODE_MNC, rilapitypes/RIL_PARAM_NETWORKCODE_ALL, RILNETWORKCODEPARAMMASK, RIL_PARAM_NETWORKCODE_SID
