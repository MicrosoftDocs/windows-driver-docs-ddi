...
ms.date: 2/16/2018
ms.keywords: RILNETWORKCODEPARAMMASK, RIL_PARAM_NETWORKCODE_MCC, RIL_PARAM_NETWORKCODE_RI, RIL_PARAM_NETWORKCODE_EXECUTOR, RIL_PARAM_NETWORKCODE_SID, rilapitypes/RIL_PARAM_NETWORKCODE_NID, rilapitypes/RIL_PARAM_NETWORKCODE_EXECUTOR, rilapitypes/RIL_PARAM_NETWORKCODE_RI, RIL_PARAM_NETWORKCODE_ALL, netvista.rilnetworkcodeparammask, rilapitypes/RIL_PARAM_NETWORKCODE_MNC, RIL_PARAM_NETWORKCODE_MNC, RIL_PARAM_NETWORKCODE_NID, rilapitypes/RIL_PARAM_NETWORKCODE_ALL, rilapitypes/RIL_PARAM_NETWORKCODE_MCC, RILNETWORKCODEPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RILNETWORKCODEPARAMMASK, rilapitypes/RIL_PARAM_NETWORKCODE_SID
