...
description: "Don't use this enumeration in your code. Microsoft reserves the RILEMERGENCYMODECONTROLPARAMSCONTROL enumeration for internal use only."
...
# RILEMERGENCYMODECONTROLPARAMSCONTROL enumeration (rilapitypes.h)
