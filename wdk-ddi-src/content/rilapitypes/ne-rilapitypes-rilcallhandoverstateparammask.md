...
ms.date: 1/18/2018
ms.keywords: RIL_PARAM_HANDOVER_ALL, RILCALLHANDOVERSTATEPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_HANDOVER_OLD_TYPE, netvista.rilcallhandoverstateparammask_2, RILCALLHANDOVERSTATEPARAMMASK, rilapitypes/RIL_PARAM_HANDOVER_OLD_TYPE, rilapitypes/RIL_PARAM_HANDOVER_NEW_TYPE, RIL_PARAM_HANDOVER_NEW_TYPE, rilapitypes/RILCALLHANDOVERSTATEPARAMMASK, rilapitypes/RIL_PARAM_HANDOVER_ALL, rilapitypes/RIL_PARAM_HANDOVER_3GPPCAUSE, RIL_PARAM_HANDOVER_3GPPCAUSE
