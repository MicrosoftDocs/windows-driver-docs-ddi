...
ms.date: 1/18/2018
ms.keywords: netvista.rilsystemtype, rilapitypes/RIL_SYSTEMTYPE_ALL, RIL_SYSTEMTYPE_LTE, rilapitypes/RIL_SYSTEMTYPE_UMTS, rilapitypes/RIL_SYSTEMTYPE_EVDO, rilapitypes/RIL_SYSTEMTYPE_GSMUMTS, rilapitypes/RIL_SYSTEMTYPE_1XRTT, rilapitypes/RIL_SYSTEMTYPE_GSM, RIL_SYSTEMTYPE_EVDO, RILSYSTEMTYPE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_SYSTEMTYPE_LTE, RILSYSTEMTYPE, rilapitypes/RIL_SYSTEMTYPE_TDSCDMA, rilapitypes/RIL_SYSTEMTYPE_CDMA, rilapitypes/RILSYSTEMTYPE, rilapitypes/RIL_SYSTEMTYPE_NONE, RIL_SYSTEMTYPE_1XRTT, RIL_SYSTEMTYPE_GSM, RIL_SYSTEMTYPE_UMTS, RIL_SYSTEMTYPE_CDMA, RIL_SYSTEMTYPE_NONE, RIL_SYSTEMTYPE_GSMUMTS, RIL_SYSTEMTYPE_TDSCDMA, RIL_SYSTEMTYPE_ALL
