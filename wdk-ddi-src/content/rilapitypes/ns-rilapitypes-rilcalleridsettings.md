...
ms.date: 1/18/2018
ms.keywords: RILCALLERIDSETTINGS structure [Network Drivers Starting with Windows Vista], rilapitypes/RILCALLERIDSETTINGS, netvista.rilcalleridsettings_2, RILCALLERIDSETTINGS, *LPRILCALLERIDSETTINGS
