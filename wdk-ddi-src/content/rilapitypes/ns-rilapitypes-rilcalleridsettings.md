...
ms.date: 1/18/2018
ms.keywords: RILCALLERIDSETTINGS, rilapitypes/RILCALLERIDSETTINGS, RILCALLERIDSETTINGS structure [Network Drivers Starting with Windows Vista], netvista.rilcalleridsettings_2, *LPRILCALLERIDSETTINGS
