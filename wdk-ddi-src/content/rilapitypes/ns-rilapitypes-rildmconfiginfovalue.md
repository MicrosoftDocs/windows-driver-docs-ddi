...
ms.date: 2/16/2018
ms.keywords: netvista.rildmconfiginfovalue_2, RILDMCONFIGINFOVALUE structure [Network Drivers Starting with Windows Vista], RILDMCONFIGINFOVALUE, *LPRILDMCONFIGINFOVALUE, rilapitypes/RILDMCONFIGINFOVALUE
