...
ms.date: 2/16/2018
ms.keywords: RIL_DEPERSOSTATE_PUK_BLOCKED, rilapitypes/RILPERSODEACTIVATIONSTATEDEPERSOSTATE, RILPERSODEACTIVATIONSTATEDEPERSOSTATE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_DEPERSOSTATE_MAX, RIL_DEPERSOSTATE_PUK_REQUIRED, rilapitypes/RIL_DEPERSOSTATE_CK_REQUIRED, rilapitypes/RIL_DEPERSOSTATE_PUK_BLOCKED, RIL_DEPERSOSTATE_CK_REQUIRED, RIL_DEPERSOSTATE_MAX, netvista.rilpersodeactivationstatedepersostate_2, rilapitypes/RIL_DEPERSOSTATE_PUK_REQUIRED, RILPERSODEACTIVATIONSTATEDEPERSOSTATE
