...
title: RILPERSODEACTIVATIONSTATEDEPERSOSTATE (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILPERSODEACTIVATIONSTATEDEPERSOSTATE enumeration for internal use only."
...
f1_keywords:
 ...
 - rilapitypes/RILPERSODEACTIVATIONSTATEDEPERSOSTATE
topic_type:
 - APIRef
 - kbSyntax
api_type:
