...
ms.date: 2/16/2018
ms.keywords: netvista.rilrequestgeolocationdata_2, *LPRILREQUESTGEOLOCATIONDATA, RILREQUESTGEOLOCATIONDATA structure [Network Drivers Starting with Windows Vista], rilapitypes/RILREQUESTGEOLOCATIONDATA, RILREQUESTGEOLOCATIONDATA
