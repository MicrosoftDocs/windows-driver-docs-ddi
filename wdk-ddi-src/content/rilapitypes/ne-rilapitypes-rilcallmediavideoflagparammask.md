...
ms.date: 1/18/2018
ms.keywords: RIL_CALLMEDIAVIDEOFLAG_ALL, rilapitypes/RIL_CALLMEDIAVIDEOFLAG_CAPABILITY_UNKNOWN, rilapitypes/RIL_CALLMEDIAVIDEOFLAG_TEMPORARILY_UNAVAILABLE, rilapitypes/RIL_CALLMEDIAVIDEOFLAG_PAUSE, netvista.rilcallmediavideoflagparammask_2, RILCALLMEDIAVIDEOFLAGPARAMMASK, RIL_CALLMEDIAVIDEOFLAG_CAPABILITY_UNKNOWN, RIL_CALLMEDIAVIDEOFLAG_TEMPORARILY_UNAVAILABLE, RILCALLMEDIAVIDEOFLAGPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_CALLMEDIAVIDEOFLAG_PAUSE, rilapitypes/RILCALLMEDIAVIDEOFLAGPARAMMASK, rilapitypes/RIL_CALLMEDIAVIDEOFLAG_ALL
