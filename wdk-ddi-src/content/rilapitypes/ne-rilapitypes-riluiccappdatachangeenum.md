...
ms.date: 1/18/2018
ms.keywords: RILUICCAPPDATACHANGEENUM, rilapitypes/RIL_UICCAPP_DATACHANGE_ESNME, rilapitypes/RIL_UICCAPP_DATACHANGE_EF_CSP_PLMN_SET, rilapitypes/RILUICCAPPDATACHANGEENUM, RIL_UICCAPP_DATACHANGE_MAX, RIL_UICCAPP_DATACHANGE_ESNME, RIL_UICCAPP_DATACHANGE_EF_CSP_PLMN_UNSET, netvista.riluiccappdatachangeenum_2, rilapitypes/RIL_UICCAPP_DATACHANGE_MAX, RILUICCAPPDATACHANGEENUM enumeration [Network Drivers Starting with Windows Vista], RIL_UICCAPP_DATACHANGE_MBDN, RIL_UICCAPP_DATACHANGE_EF_CSP_PLMN_SET, rilapitypes/RIL_UICCAPP_DATACHANGE_EF_CSP_PLMN_UNSET, rilapitypes/RIL_UICCAPP_DATACHANGE_MBDN
