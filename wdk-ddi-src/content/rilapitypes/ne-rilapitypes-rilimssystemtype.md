...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RILIMSSYSTEMTYPE, RIL_IMSSYSTEMTYPE_UNKNOWN, rilapitypes/RIL_IMSSYSTEMTYPE_UNKNOWN, netvista.rilimssystemtype, RIL_IMSSYSTEMTYPE_LTE, rilapitypes/RIL_IMSSYSTEMTYPE_MAX, RILIMSSYSTEMTYPE, RIL_IMSSYSTEMTYPE_MAX, rilapitypes/RIL_IMSSYSTEMTYPE_LTE, RILIMSSYSTEMTYPE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_IMSSYSTEMTYPE_WIFI, RIL_IMSSYSTEMTYPE_WIFI
