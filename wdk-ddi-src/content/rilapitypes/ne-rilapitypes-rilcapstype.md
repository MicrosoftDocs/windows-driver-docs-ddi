...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_CAPSTYPE_RADIOCONFIGURATIONS, rilapitypes/RIL_CAPSTYPE_NITZNOTIFICATION, rilapitypes/RIL_CAPSTYPE_CALLSUPPORT, rilapitypes/RIL_CAPSTYPE_ARG_SMALLEST, rilapitypes/RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, rilapitypes/RILCAPSTYPE, rilapitypes/RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, RIL_CAPSTYPE_MAX, RILCAPSTYPE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_CAPSTYPE_PBMAXREAD, RIL_CAPSTYPE_PBSTORELOCATIONS, RILCAPSTYPE, RIL_CAPSTYPE_SMSSUPPORT, RIL_CAPSTYPE_NITZNOTIFICATION, RIL_CAPSTYPE_ARG_LARGEST, RIL_CAPSTYPE_RADIOCONFIGURATIONS, rilapitypes/RIL_CAPSTYPE_MAX, netvista.rilcapstype_2, RIL_CAPSTYPE_ARG_SMALLEST, RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, rilapitypes/RIL_CAPSTYPE_PBSTORELOCATIONS, RIL_CAPSTYPE_CALLSUPPORT, rilapitypes/RIL_CAPSTYPE_ARG_LARGEST, rilapitypes/RIL_CAPSTYPE_SMSSUPPORT, RIL_CAPSTYPE_PBMAXREAD
