...
ms.date: 1/18/2018
ms.keywords: RIL_CAPSTYPE_ARG_LARGEST, RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, RILCAPSTYPE, RIL_CAPSTYPE_RADIOCONFIGURATIONS, RIL_CAPSTYPE_PBMAXREAD, RIL_CAPSTYPE_ARG_SMALLEST, RIL_CAPSTYPE_CALLSUPPORT, rilapitypes/RIL_CAPSTYPE_PBMAXREAD, RIL_CAPSTYPE_PBSTORELOCATIONS, rilapitypes/RIL_CAPSTYPE_MAX, netvista.rilcapstype_2, rilapitypes/RIL_CAPSTYPE_CALLSUPPORT, rilapitypes/RIL_CAPSTYPE_ARG_SMALLEST, RIL_CAPSTYPE_MAX, RIL_CAPSTYPE_NITZNOTIFICATION, rilapitypes/RIL_CAPSTYPE_SMSSUPPORT, RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, rilapitypes/RIL_CAPSTYPE_PBSTORELOCATIONS, rilapitypes/RIL_CAPSTYPE_RADIOCONFIGURATIONS, RILCAPSTYPE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, rilapitypes/RIL_CAPSTYPE_ARG_LARGEST, RIL_CAPSTYPE_SMSSUPPORT, rilapitypes/RILCAPSTYPE, rilapitypes/RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, rilapitypes/RIL_CAPSTYPE_NITZNOTIFICATION
