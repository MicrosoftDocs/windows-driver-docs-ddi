...
ms.date: 2/16/2018
ms.keywords: RIL_CAPSTYPE_PBMAXREAD, rilapitypes/RIL_CAPSTYPE_PBMAXREAD, RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, RILCAPSTYPE, RIL_CAPSTYPE_NITZNOTIFICATION, RIL_CAPSTYPE_PBSTORELOCATIONS, rilapitypes/RIL_CAPSTYPE_PBSTORELOCATIONS, rilapitypes/RIL_CAPSTYPE_SMSSUPPORT, rilapitypes/RIL_CAPSTYPE_RADIOCONFIGURATIONS, RIL_CAPSTYPE_ARG_LARGEST, rilapitypes/RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, rilapitypes/RIL_CAPSTYPE_CALLSUPPORT, RIL_CAPSTYPE_CALLSUPPORT, rilapitypes/RIL_CAPSTYPE_NITZNOTIFICATION, RIL_CAPSTYPE_RADIOCONFIGURATIONS, RIL_CAPSTYPE_MAX, RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, RILCAPSTYPE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RILCAPSTYPE, rilapitypes/RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, RIL_CAPSTYPE_ARG_SMALLEST, RIL_CAPSTYPE_SMSSUPPORT, rilapitypes/RIL_CAPSTYPE_ARG_SMALLEST, rilapitypes/RIL_CAPSTYPE_MAX, netvista.rilcapstype_2, rilapitypes/RIL_CAPSTYPE_ARG_LARGEST
