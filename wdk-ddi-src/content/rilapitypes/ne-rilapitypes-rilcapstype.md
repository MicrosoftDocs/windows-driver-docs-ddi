...
ms.date: 2/16/2018
ms.keywords: RIL_CAPSTYPE_ARG_LARGEST, rilapitypes/RIL_CAPSTYPE_NITZNOTIFICATION, rilapitypes/RIL_CAPSTYPE_MAX, rilapitypes/RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, rilapitypes/RIL_CAPSTYPE_CALLSUPPORT, rilapitypes/RIL_CAPSTYPE_ARG_LARGEST, rilapitypes/RIL_CAPSTYPE_PBMAXREAD, RIL_CAPSTYPE_SMSSUPPORT, rilapitypes/RIL_CAPSTYPE_ARG_SMALLEST, RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, rilapitypes/RIL_CAPSTYPE_RADIOCONFIGURATIONS, rilapitypes/RIL_CAPSTYPE_PBSTORELOCATIONS, rilapitypes/RILCAPSTYPE, RILCAPSTYPE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_CAPSTYPE_SMSSUPPORT, RILCAPSTYPE, RIL_CAPSTYPE_RADIOCONFIGURATIONS, RIL_CAPSTYPE_NITZNOTIFICATION, RIL_CAPSTYPE_PBSTORELOCATIONS, RIL_CAPSTYPE_CALLSUPPORT, rilapitypes/RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, RIL_CAPSTYPE_PBMAXREAD, RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, netvista.rilcapstype_2, RIL_CAPSTYPE_MAX, RIL_CAPSTYPE_ARG_SMALLEST
