...
ms.date: 2/16/2018
ms.keywords: RIL_CALLMEDIAOFFERACTION_CANCEL, netvista.rilcallmediaofferaction_2, RILCALLMEDIAOFFERACTION enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_CALLMEDIAOFFERACTION_ASK, RIL_CALLMEDIAOFFERACTION_ACCEPT, RIL_CALLMEDIAOFFERACTION_REJECT, rilapitypes/RIL_CALLMEDIAOFFERACTION_REJECT, rilapitypes/RILCALLMEDIAOFFERACTION, RIL_CALLMEDIAOFFERACTION_ASK, rilapitypes/RIL_CALLMEDIAOFFERACTION_ACCEPT, RILCALLMEDIAOFFERACTION, rilapitypes/RIL_CALLMEDIAOFFERACTION_ERROR, rilapitypes/RIL_CALLMEDIAOFFERACTION_CANCEL, rilapitypes/RIL_CALLMEDIAOFFERACTION_MAX, RIL_CALLMEDIAOFFERACTION_MAX, RIL_CALLMEDIAOFFERACTION_ERROR
