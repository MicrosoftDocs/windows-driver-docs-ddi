...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RILDEVICEINFORMATION, rilapitypes/RIL_DEVICEINFO_SERIALNUMBER_GW, RILDEVICEINFORMATION, RIL_DEVICEINFO_SERIALNUMBER_GW, rilapitypes/RIL_DEVICEINFO_SERIALNUMBER_CDMA, RILDEVICEINFORMATION enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_DEVICEINFO_MANUFACTURER, RIL_DEVICEINFO_MODEL, netvista.rildeviceinformation, RIL_DEVICEINFO_MANUFACTURER, RIL_DEVICEINFO_SERIALNUMBER_CDMA, RIL_DEVICEINFO_ARG_SMALLEST, rilapitypes/RIL_DEVICEINFO_ARG_SMALLEST, RIL_DEVICEINFO_ARG_LARGEST, rilapitypes/RIL_DEVICEINFO_ARG_LARGEST, RIL_DEVICEINFO_REVISION, rilapitypes/RIL_DEVICEINFO_MODEL, rilapitypes/RIL_DEVICEINFO_REVISION
