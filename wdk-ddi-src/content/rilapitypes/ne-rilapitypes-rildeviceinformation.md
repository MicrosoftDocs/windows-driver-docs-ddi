...
ms.date: 2/16/2018
ms.keywords: RILDEVICEINFORMATION, rilapitypes/RIL_DEVICEINFO_MODEL, RIL_DEVICEINFO_REVISION, rilapitypes/RILDEVICEINFORMATION, RIL_DEVICEINFO_MANUFACTURER, RIL_DEVICEINFO_ARG_SMALLEST, netvista.rildeviceinformation, RILDEVICEINFORMATION enumeration [Network Drivers Starting with Windows Vista], RIL_DEVICEINFO_MODEL, rilapitypes/RIL_DEVICEINFO_REVISION, RIL_DEVICEINFO_SERIALNUMBER_CDMA, rilapitypes/RIL_DEVICEINFO_SERIALNUMBER_CDMA, RIL_DEVICEINFO_SERIALNUMBER_GW, rilapitypes/RIL_DEVICEINFO_ARG_SMALLEST, RIL_DEVICEINFO_ARG_LARGEST, rilapitypes/RIL_DEVICEINFO_SERIALNUMBER_GW, rilapitypes/RIL_DEVICEINFO_ARG_LARGEST, rilapitypes/RIL_DEVICEINFO_MANUFACTURER
