...
description: "Microsoft reserves the RILTDSCDMAKIND enumeration for internal use only. Don't use this enumeration in your code."
...
# RILTDSCDMAKIND enumeration (rilapitypes.h)
