...
description: "Don't use this structure in your code. Microsoft reserves the RILOSGEOLOCATIONINFO structure for internal use only."
...
f1_keywords:
 ...
 - rilapitypes/LPRILOSGEOLOCATIONINFO
topic_type:
 - APIRef
 - kbSyntax
api_type:
