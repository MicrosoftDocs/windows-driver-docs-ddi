...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_PARAM_EUTRAMRL_RSRP, RIL_PARAM_EUTRAMRL_EARFCN, rilapitypes/RIL_PARAM_EUTRAMRL_MNC, rilapitypes/RIL_PARAM_EUTRAMRL_TAC, RIL_PARAM_EUTRAMRL_PHYSCELLID, RILEUTRAMRLPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_EUTRAMRL_PHYSCELLID, RILEUTRAMRLPARAMMASK, rilapitypes/RIL_PARAM_EUTRAMRL_ALL, rilapitypes/RIL_PARAM_EUTRAMRL_RSRQ, RIL_PARAM_EUTRAMRL_MCC, rilapitypes/RIL_PARAM_EUTRAMRL_CELLID, rilapitypes/RIL_PARAM_EUTRAMRL_MCC, RIL_PARAM_EUTRAMRL_MNC, netvista.rileutramrlparammask, rilapitypes/RIL_PARAM_EUTRAMRL_EARFCN, RIL_PARAM_EUTRAMRL_CELLID, rilapitypes/RILEUTRAMRLPARAMMASK, RIL_PARAM_EUTRAMRL_RSRQ, RIL_PARAM_EUTRAMRL_TAC, RIL_PARAM_EUTRAMRL_ALL, RIL_PARAM_EUTRAMRL_RSRP
