...
ms.date: 2/16/2018
ms.keywords: RIL_PARAM_EUTRAMRL_RSRP, RIL_PARAM_EUTRAMRL_MNC, RIL_PARAM_EUTRAMRL_ALL, rilapitypes/RIL_PARAM_EUTRAMRL_MCC, rilapitypes/RILEUTRAMRLPARAMMASK, rilapitypes/RIL_PARAM_EUTRAMRL_TAC, rilapitypes/RIL_PARAM_EUTRAMRL_PHYSCELLID, RIL_PARAM_EUTRAMRL_CELLID, rilapitypes/RIL_PARAM_EUTRAMRL_RSRP, rilapitypes/RIL_PARAM_EUTRAMRL_RSRQ, rilapitypes/RIL_PARAM_EUTRAMRL_MNC, RIL_PARAM_EUTRAMRL_TAC, RIL_PARAM_EUTRAMRL_PHYSCELLID, netvista.rileutramrlparammask, RILEUTRAMRLPARAMMASK, RIL_PARAM_EUTRAMRL_EARFCN, RIL_PARAM_EUTRAMRL_MCC, rilapitypes/RIL_PARAM_EUTRAMRL_EARFCN, RIL_PARAM_EUTRAMRL_RSRQ, rilapitypes/RIL_PARAM_EUTRAMRL_CELLID, rilapitypes/RIL_PARAM_EUTRAMRL_ALL, RILEUTRAMRLPARAMMASK enumeration [Network Drivers Starting with Windows Vista]
