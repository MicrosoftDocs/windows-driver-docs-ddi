...
ms.date: 1/18/2018
ms.keywords: RIL_PARAM_EUTRAMRL_RSRP, RIL_PARAM_EUTRAMRL_ALL, RILEUTRAMRLPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_EUTRAMRL_ALL, rilapitypes/RIL_PARAM_EUTRAMRL_MNC, RIL_PARAM_EUTRAMRL_PHYSCELLID, RIL_PARAM_EUTRAMRL_MCC, rilapitypes/RIL_PARAM_EUTRAMRL_RSRP, rilapitypes/RILEUTRAMRLPARAMMASK, rilapitypes/RIL_PARAM_EUTRAMRL_EARFCN, rilapitypes/RIL_PARAM_EUTRAMRL_MCC, RIL_PARAM_EUTRAMRL_RSRQ, RIL_PARAM_EUTRAMRL_MNC, RIL_PARAM_EUTRAMRL_EARFCN, rilapitypes/RIL_PARAM_EUTRAMRL_CELLID, RIL_PARAM_EUTRAMRL_TAC, rilapitypes/RIL_PARAM_EUTRAMRL_RSRQ, netvista.rileutramrlparammask, rilapitypes/RIL_PARAM_EUTRAMRL_PHYSCELLID, RIL_PARAM_EUTRAMRL_CELLID, rilapitypes/RIL_PARAM_EUTRAMRL_TAC, RILEUTRAMRLPARAMMASK
