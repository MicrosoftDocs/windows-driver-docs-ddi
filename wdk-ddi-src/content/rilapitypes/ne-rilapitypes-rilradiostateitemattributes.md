...
ms.date: 1/18/2018
ms.keywords: RIL_RADIOSTATE_ITEM_ATTRIBUTE_ISDIRTY, RILRADIOSTATEITEMATTRIBUTES enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_RADIOSTATE_ITEM_ATTRIBUTE_ISDIRTY, RILRADIOSTATEITEMATTRIBUTES, rilapitypes/RIL_RADIOSTATE_ITEM_ATTRIBUTE_ISWRITABLE, rilapitypes/RIL_RADIOSTATE_ITEM_ATTRIBUTE_HAVEOPTIONS, RIL_RADIOSTATE_ITEM_ATTRIBUTE_ALL, rilapitypes/RILRADIOSTATEITEMATTRIBUTES, RIL_RADIOSTATE_ITEM_ATTRIBUTE_HAVEOPTIONS, rilapitypes/RIL_RADIOSTATE_ITEM_ATTRIBUTE_ALL, netvista.rilradiostateitemattributes_2, RIL_RADIOSTATE_ITEM_ATTRIBUTE_ISWRITABLE
