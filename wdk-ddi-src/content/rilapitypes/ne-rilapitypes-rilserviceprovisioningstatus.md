...
ms.date: 1/18/2018
ms.keywords: netvista.rilserviceprovisioningstatus_2, rilapitypes/RILSERVICEPROVISIONINGSTATUS, rilapitypes/RIL_SVCPROV_TEMPMODEALLOWED, rilapitypes/RIL_SVCPROV_PROVISIONED, rilapitypes/RIL_SVCPROV_NOTPROVISIONED, RILSERVICEPROVISIONINGSTATUS enumeration [Network Drivers Starting with Windows Vista], RIL_SVCPROV_TEMPMODERESTRICTED, RIL_SVCPROV_MAX, RIL_SVCPROV_TEMPMODEALLOWED, rilapitypes/RIL_SVCPROV_MAX, rilapitypes/RIL_SVCPROV_TEMPMODERESTRICTED, RIL_SVCPROV_PROVISIONED, RILSERVICEPROVISIONINGSTATUS, RIL_SVCPROV_NOTPROVISIONED
