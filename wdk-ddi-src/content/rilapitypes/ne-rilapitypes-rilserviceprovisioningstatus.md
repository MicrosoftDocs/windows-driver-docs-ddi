...
ms.date: 1/18/2018
ms.keywords: RILSERVICEPROVISIONINGSTATUS, RIL_SVCPROV_PROVISIONED, rilapitypes/RIL_SVCPROV_MAX, rilapitypes/RILSERVICEPROVISIONINGSTATUS, rilapitypes/RIL_SVCPROV_NOTPROVISIONED, rilapitypes/RIL_SVCPROV_TEMPMODEALLOWED, netvista.rilserviceprovisioningstatus_2, RIL_SVCPROV_TEMPMODEALLOWED, RIL_SVCPROV_TEMPMODERESTRICTED, RIL_SVCPROV_MAX, rilapitypes/RIL_SVCPROV_TEMPMODERESTRICTED, RILSERVICEPROVISIONINGSTATUS enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_SVCPROV_PROVISIONED, RIL_SVCPROV_NOTPROVISIONED
