...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_SVCPROV_NOTPROVISIONED, netvista.rilserviceprovisioningstatus_2, RIL_SVCPROV_PROVISIONED, RIL_SVCPROV_TEMPMODEALLOWED, rilapitypes/RILSERVICEPROVISIONINGSTATUS, rilapitypes/RIL_SVCPROV_PROVISIONED, rilapitypes/RIL_SVCPROV_TEMPMODERESTRICTED, rilapitypes/RIL_SVCPROV_MAX, RILSERVICEPROVISIONINGSTATUS enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_SVCPROV_TEMPMODEALLOWED, RIL_SVCPROV_NOTPROVISIONED, RIL_SVCPROV_MAX, RIL_SVCPROV_TEMPMODERESTRICTED, RILSERVICEPROVISIONINGSTATUS
