...
description: "Don't use this enumeration in your code. Microsoft reserves the RILCALLINFOPARAMMASK enumeration for internal use only."
...
f1_keywords:
 ...
 - rilapitypes/RILCALLINFOPARAMMASK
topic_type:
 - APIRef
 - kbSyntax
api_type:
