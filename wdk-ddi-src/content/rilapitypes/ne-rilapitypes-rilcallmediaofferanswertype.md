...
title: RILCALLMEDIAOFFERANSWERTYPE (rilapitypes.h)
description: "Microsoft reserves the RILCALLMEDIAOFFERANSWERTYPE enumeration for internal use only. Don't use this enumeration in your code."
