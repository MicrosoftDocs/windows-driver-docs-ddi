...
ms.date: 1/18/2018
ms.keywords: netvista.rilterminalcapabilityinfo_2, *LPRILTERMINALCAPABILITYINFO, RILTERMINALCAPABILITYINFO structure [Network Drivers Starting with Windows Vista], RILTERMINALCAPABILITYINFO, rilapitypes/RILTERMINALCAPABILITYINFO
