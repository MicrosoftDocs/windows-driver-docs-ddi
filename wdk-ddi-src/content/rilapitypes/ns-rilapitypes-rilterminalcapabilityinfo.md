...
ms.date: 1/18/2018
ms.keywords: "*LPRILTERMINALCAPABILITYINFO, RILTERMINALCAPABILITYINFO, RILTERMINALCAPABILITYINFO structure [Network Drivers Starting with Windows Vista], rilapitypes/RILTERMINALCAPABILITYINFO, netvista.rilterminalcapabilityinfo_2"
