...
ms.date: 1/18/2018
ms.keywords: RIL_PARAM_IMSFAILURE_ERRORCODE, netvista.rilimsfailureparammask_2, RIL_PARAM_IMSFAILURE_ERRORSTRING, rilapitypes/RIL_PARAM_IMSFAILURE_ALL, RILIMSFAILUREPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_IMSFAILURE_ERRORCODE, rilapitypes/RIL_PARAM_IMSFAILURE_ERRORSTRING, RIL_PARAM_IMSFAILURE_MESSAGESUBTYPE, RIL_PARAM_IMSFAILURE_MESSAGETYPE, RIL_PARAM_IMSFAILURE_ALL, rilapitypes/RIL_PARAM_IMSFAILURE_MESSAGESUBTYPE, RILIMSFAILUREPARAMMASK, rilapitypes/RILIMSFAILUREPARAMMASK, rilapitypes/RIL_PARAM_IMSFAILURE_MESSAGETYPE
