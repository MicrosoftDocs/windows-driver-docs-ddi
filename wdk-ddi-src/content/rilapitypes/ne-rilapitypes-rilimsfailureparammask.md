...
title: RILIMSFAILUREPARAMMASK (rilapitypes.h)
description: "Microsoft reserves the RILIMSFAILUREPARAMMASK enumeration for internal use only. Don't use this enumeration in your code."
