...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_PARAM_IMSFAILURE_MESSAGETYPE, RIL_PARAM_IMSFAILURE_MESSAGETYPE, netvista.rilimsfailureparammask_2, RILIMSFAILUREPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RILIMSFAILUREPARAMMASK, RILIMSFAILUREPARAMMASK, rilapitypes/RIL_PARAM_IMSFAILURE_ERRORCODE, RIL_PARAM_IMSFAILURE_ERRORSTRING, RIL_PARAM_IMSFAILURE_ERRORCODE, RIL_PARAM_IMSFAILURE_ALL, rilapitypes/RIL_PARAM_IMSFAILURE_ERRORSTRING, rilapitypes/RIL_PARAM_IMSFAILURE_ALL, rilapitypes/RIL_PARAM_IMSFAILURE_MESSAGESUBTYPE, RIL_PARAM_IMSFAILURE_MESSAGESUBTYPE
