...
ms.date: 1/18/2018
ms.keywords: RILCALLHANDOVERPHASE, rilapitypes/RIL_CALLHANDOVERPHASE_FAILED, RIL_CALLHANDOVERPHASE_COMPLETED, rilapitypes/RIL_CALLHANDOVERPHASE_MAX, rilapitypes/RIL_CALLHANDOVERPHASE_CANCELLED, RIL_CALLHANDOVERPHASE_MAX, rilapitypes/RILCALLHANDOVERPHASE, RIL_CALLHANDOVERPHASE_CANCELLED, RIL_CALLHANDOVERPHASE_FAILED, rilapitypes/RIL_CALLHANDOVERPHASE_COMPLETED, RILCALLHANDOVERPHASE enumeration [Network Drivers Starting with Windows Vista], netvista.rilcallhandoverphase_2
