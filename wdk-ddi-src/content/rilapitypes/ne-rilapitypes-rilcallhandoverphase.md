...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_CALLHANDOVERPHASE_COMPLETED, RILCALLHANDOVERPHASE, rilapitypes/RIL_CALLHANDOVERPHASE_MAX, rilapitypes/RIL_CALLHANDOVERPHASE_FAILED, rilapitypes/RIL_CALLHANDOVERPHASE_CANCELLED, RIL_CALLHANDOVERPHASE_MAX, netvista.rilcallhandoverphase_2, RILCALLHANDOVERPHASE enumeration [Network Drivers Starting with Windows Vista], RIL_CALLHANDOVERPHASE_FAILED, RIL_CALLHANDOVERPHASE_COMPLETED, RIL_CALLHANDOVERPHASE_CANCELLED, rilapitypes/RILCALLHANDOVERPHASE
