...
description: "Don't use this enumeration in your code. Microsoft reserves the RILUMTSKIND enumeration for internal use only."
...
# RILUMTSKIND enumeration (rilapitypes.h)
