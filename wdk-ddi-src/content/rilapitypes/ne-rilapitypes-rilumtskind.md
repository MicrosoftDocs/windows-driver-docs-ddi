...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_UMTSKIND_DC_HSPAPLUS, rilapitypes/RIL_UMTSKIND_MAX, RIL_UMTSKIND_DC_HSPAPLUS, rilapitypes/RIL_UMTSKIND_HSDPA, rilapitypes/RIL_UMTSKIND_HSUPA, RIL_UMTSKIND_HSPAPLUS, rilapitypes/RIL_UMTSKIND_HSPAPLUS_64QAM, netvista.rilumtskind_2, RILUMTSKIND enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RILUMTSKIND, RIL_UMTSKIND_HSPAPLUS_64QAM, RILUMTSKIND, rilapitypes/RIL_UMTSKIND_HSPAPLUS, RIL_UMTSKIND_MAX, RIL_UMTSKIND_HSUPA, RIL_UMTSKIND_HSDPA
