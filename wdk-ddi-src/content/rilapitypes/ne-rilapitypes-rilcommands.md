...
title: RILCOMMANDS (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILCOMMANDS enumeration for internal use only."
...
# RILCOMMANDS enumeration (rilapitypes.h)
