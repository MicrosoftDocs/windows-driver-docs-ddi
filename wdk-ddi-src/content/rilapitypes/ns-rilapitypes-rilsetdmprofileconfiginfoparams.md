...
title: RILSETDMPROFILECONFIGINFOPARAMS (rilapitypes.h)
description: "Don't use this structure in your code. Microsoft reserves the RILSETDMPROFILECONFIGINFOPARAMS structure for internal use only."
old-location: netvista\rilsetdmprofileconfiginfoparams.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILSETDMPROFILECONFIGINFOPARAMS structure"]
...
f1_keywords:
 ...
 - LPRILSETDMPROFILECONFIGINFOPARAMS
 - rilapitypes/LPRILSETDMPROFILECONFIGINFOPARAMS
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# RILSETDMPROFILECONFIGINFOPARAMS structure (rilapitypes.h)
