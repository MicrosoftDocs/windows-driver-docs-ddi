...
title: RILSETEXECUTORRFSTATEPARAMS (rilapitypes.h)
description: "Microsoft reserves the RILSETEXECUTORRFSTATEPARAMS structure for internal use only. Don't use this structure in your code."
