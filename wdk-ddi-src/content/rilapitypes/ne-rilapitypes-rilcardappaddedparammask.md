...
description: "Don't use this enumeration in your code. Microsoft reserves the RILCARDAPPADDEDPARAMMASK enumeration for internal use only."
...
# RILCARDAPPADDEDPARAMMASK enumeration (rilapitypes.h)
