...
title: RILPROVISIONSTATUSPROVISIONSTATUS (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILPROVISIONSTATUSPROVISIONSTATUS enumeration for internal use only."
