...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_PROVISIONSTAT_SUCCESS, RIL_PROVISIONSTAT_BIP_SUCCESS, netvista.rilprovisionstatusprovisionstatus_2, rilapitypes/RIL_PROVISIONSTAT_BIP_STARTED, RIL_PROVISIONSTAT_MAX, rilapitypes/RIL_PROVISIONSTAT_FAILURE_RETRY, RILPROVISIONSTATUSPROVISIONSTATUS, RIL_PROVISIONSTAT_NEEDED, RIL_PROVISIONSTAT_BIP_STARTED, RIL_PROVISIONSTAT_FAILURE_RETRY, rilapitypes/RIL_PROVISIONSTAT_BIP_SUCCESS, RIL_PROVISIONSTAT_SUCCESS, rilapitypes/RILPROVISIONSTATUSPROVISIONSTATUS, rilapitypes/RIL_PROVISIONSTAT_MAX, RILPROVISIONSTATUSPROVISIONSTATUS enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PROVISIONSTAT_FAILURE_END, rilapitypes/RIL_PROVISIONSTAT_NEEDED, RIL_PROVISIONSTAT_FAILURE_END
