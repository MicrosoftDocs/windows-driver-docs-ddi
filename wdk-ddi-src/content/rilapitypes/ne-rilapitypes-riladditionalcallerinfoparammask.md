...
ms.date: 2/16/2018
ms.keywords: RILADDITIONALCALLERINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_ADDTLCI_CALLERINFOLENGTH, RIL_PARAM_ADDTLCI_CALLERINFO, rilapitypes/RIL_PARAM_ADDTLCI_CALLID, RILADDITIONALCALLERINFOPARAMMASK, rilapitypes/RILADDITIONALCALLERINFOPARAMMASK, RIL_PARAM_ADDTLCI_ALL, RIL_PARAM_ADDTLCI_CALLID, rilapitypes/RIL_PARAM_ADDTLCI_ALL, rilapitypes/RIL_PARAM_ADDTLCI_CALLERINFO, netvista.riladditionalcallerinfoparammask_2, rilapitypes/RIL_PARAM_ADDTLCI_CALLERINFOLENGTH
