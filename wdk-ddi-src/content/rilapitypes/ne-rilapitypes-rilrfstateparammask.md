...
title: RILRFSTATEPARAMMASK (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILRFSTATEPARAMMASK enumeration for internal use only."
...
f1_keywords:
 - RILRFSTATEPARAMMASK
 - rilapitypes/RILRFSTATEPARAMMASK
topic_type:
 - APIRef
 - kbSyntax
api_type:
