...
ms.date: 1/18/2018
ms.keywords: RILUICCRECORDTYPE, RIL_UICCRECORDTYPE_LINEAR, rilapitypes/RILUICCRECORDTYPE, rilapitypes/RIL_UICCRECORDTYPE_CYCLIC, RILUICCRECORDTYPE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_UICCRECORDTYPE_BERTLV, RIL_UICCRECORDTYPE_MASTER, rilapitypes/RIL_UICCRECORDTYPE_TRANSPARENT, RIL_UICCRECORDTYPE_CYCLIC, rilapitypes/RIL_UICCRECORDTYPE_UNKNOWN, rilapitypes/RIL_UICCRECORDTYPE_MASTER, rilapitypes/RIL_UICCRECORDTYPE_LINEAR, RIL_UICCRECORDTYPE_UNKNOWN, RIL_UICCRECORDTYPE_TRANSPARENT, RIL_UICCRECORDTYPE_BERTLV, netvista.riluiccrecordtype
