...
description: "Don't use this enumeration in your code. Microsoft reserves the RILCALLRTTMODE enumeration for internal use only."
...
# RILCALLRTTMODE enumeration (rilapitypes.h)
