...
description: "Don't use this enumeration in your code. Microsoft reserves the RILIMSFAILUREMESSAGETYPE enumeration for internal use only."
...
# RILIMSFAILUREMESSAGETYPE enumeration (rilapitypes.h)
