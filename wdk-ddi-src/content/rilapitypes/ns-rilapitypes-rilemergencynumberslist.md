...
title: RILEMERGENCYNUMBERSLIST (rilapitypes.h)
description: "Microsoft reserves the RILEMERGENCYNUMBERSLIST structure for internal use only. Don't use this structure in your code."
...
f1_keywords:
 ...
 - rilapitypes/RILEMERGENCYNUMBERSLIST
 - LPRILEMERGENCYNUMBERSLIST
 - rilapitypes/LPRILEMERGENCYNUMBERSLIST
topic_type:
 - APIRef
 - kbSyntax
api_type:
