...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_PARAM_CARDINFO_APPINFO, RIL_PARAM_CARDINFO_NUMAPPS, rilapitypes/RIL_PARAM_CARDINFO_ALL, rilapitypes/RIL_PARAM_CARDINFO_NUMAPPS, RIL_PARAM_CARDINFO_ALL, RIL_PARAM_CARDINFO_ICCID, RIL_PARAM_CARDINFO_APPINFO, rilapitypes/RIL_PARAM_CARDINFO_ICCID, RILUICCCARDINFOPARAMMASK, RILUICCCARDINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RILUICCCARDINFOPARAMMASK, netvista.riluicccardinfoparammask_2
