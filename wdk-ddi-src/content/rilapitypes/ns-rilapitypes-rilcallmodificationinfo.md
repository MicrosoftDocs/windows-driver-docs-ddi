...
title: RILCALLMODIFICATIONINFO (rilapitypes.h)
description: "Don't use this structure in your code. Microsoft reserves the RILCALLMODIFICATIONINFO structure for internal use only."
...
f1_keywords:
 ...
 - rilapitypes/LPRILCALLMODIFICATIONINFO
topic_type:
 - APIRef
 - kbSyntax
api_type:
