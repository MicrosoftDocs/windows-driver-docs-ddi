...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_PARAM_SR_RESPONSE, RILUICCRESPONSEPARAMMASK, rilapitypes/RILUICCRESPONSEPARAMMASK, netvista.riluiccresponseparammask_2, rilapitypes/RIL_PARAM_SR_STATUSWORD2, RIL_PARAM_SR_STATUSWORD2, RILUICCRESPONSEPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_SR_RESPONSESIZE, RIL_PARAM_SR_ALL, rilapitypes/RIL_PARAM_SR_RESPONSESIZE, rilapitypes/RIL_PARAM_SR_ALL, RIL_PARAM_SR_RESPONSE
