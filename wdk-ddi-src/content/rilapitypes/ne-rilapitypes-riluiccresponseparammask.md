...
ms.date: 2/16/2018
ms.keywords: RIL_PARAM_SR_RESPONSESIZE, RILUICCRESPONSEPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_SR_RESPONSE, RIL_PARAM_SR_ALL, RIL_PARAM_SR_STATUSWORD2, netvista.riluiccresponseparammask_2, rilapitypes/RIL_PARAM_SR_ALL, rilapitypes/RIL_PARAM_SR_RESPONSESIZE, RIL_PARAM_SR_RESPONSE, RILUICCRESPONSEPARAMMASK, rilapitypes/RIL_PARAM_SR_STATUSWORD2, rilapitypes/RILUICCRESPONSEPARAMMASK
