...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RILRADIOSTATEGROUP, RILRADIOSTATEGROUP structure [Network Drivers Starting with Windows Vista], *LPRILRADIOSTATEGROUP, RILRADIOSTATEGROUP, netvista.rilradiostategroup_2
