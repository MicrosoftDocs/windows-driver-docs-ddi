...
ms.date: 1/18/2018
ms.keywords: RILRADIOSTATEGROUP, rilapitypes/RILRADIOSTATEGROUP, RILRADIOSTATEGROUP structure [Network Drivers Starting with Windows Vista], netvista.rilradiostategroup_2, *LPRILRADIOSTATEGROUP
