...
ms.date: 1/18/2018
ms.keywords: RILRADIOSTATEGROUP, RILRADIOSTATEGROUP structure [Network Drivers Starting with Windows Vista], *LPRILRADIOSTATEGROUP, rilapitypes/RILRADIOSTATEGROUP, netvista.rilradiostategroup_2
