...
ms.date: 1/18/2018
ms.keywords: netvista.rilradiostategroup_2, RILRADIOSTATEGROUP structure [Network Drivers Starting with Windows Vista], rilapitypes/RILRADIOSTATEGROUP, *LPRILRADIOSTATEGROUP, RILRADIOSTATEGROUP
