...
ms.date: 2/16/2018
ms.keywords: RIL_PARAM_CMI_ID, RIL_PARAM_CMI_NEWCALLTYPE, rilapitypes/RIL_PARAM_CMI_ID, rilapitypes/RIL_PARAM_CMI_ALPHAIDENTIFIER, rilapitypes/RILCALLMODIFICATIONINFOPARAMMASK, RIL_PARAM_CMI_ALPHAIDENTIFIER, RIL_PARAM_CMI_ALL, netvista.rilcallmodificationinfoparammask_2, RILCALLMODIFICATIONINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RILCALLMODIFICATIONINFOPARAMMASK, rilapitypes/RIL_PARAM_CMI_OLDCALLTYPE, RIL_PARAM_CMI_MODIFICATIONTYPE, RIL_PARAM_CMI_ADDRESS, rilapitypes/RIL_PARAM_CMI_ADDRESS, RIL_PARAM_CMI_OLDCALLTYPE, rilapitypes/RIL_PARAM_CMI_ALL, rilapitypes/RIL_PARAM_CMI_NEWCALLTYPE, rilapitypes/RIL_PARAM_CMI_MODIFICATIONTYPE
