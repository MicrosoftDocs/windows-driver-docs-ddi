...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_PARAM_REGSI_SYSTEMCAPS, rilapitypes/RIL_PARAM_REGSI_ALL, RIL_PARAM_REGSI_NETWORKCODE, rilapitypes/RIL_PARAM_REGSI_CURRENTOPERATOR, RIL_PARAM_REGSI_ACCESSTECHNOLOGY, rilapitypes/RIL_PARAM_REGSI_NETWORKCODE, RIL_PARAM_REGSI_HUICCAPP, RIL_PARAM_REGSI_REGSTATUS, rilapitypes/RIL_PARAM_REGSI_REGREJECTREASON, RILREGSTATUSINFOPARAMMASK, netvista.rilregstatusinfoparammask_2, rilapitypes/RIL_PARAM_REGSI_VOICEDOMAIN, RIL_PARAM_REGSI_REGREJECTREASON, RIL_PARAM_REGSI_ALL, RIL_PARAM_REGSI_VOICEDOMAIN, rilapitypes/RIL_PARAM_REGSI_ACCESSTECHNOLOGY, rilapitypes/RILREGSTATUSINFOPARAMMASK, RIL_PARAM_REGSI_SYSTEMCAPS, rilapitypes/RIL_PARAM_REGSI_HUICCAPP, rilapitypes/RIL_PARAM_REGSI_REGSTATUS, RIL_PARAM_REGSI_CURRENTOPERATOR, RILREGSTATUSINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista]
