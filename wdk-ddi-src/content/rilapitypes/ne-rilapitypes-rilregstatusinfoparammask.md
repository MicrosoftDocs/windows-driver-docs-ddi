...
ms.date: 1/18/2018
ms.keywords: netvista.rilregstatusinfoparammask_2, rilapitypes/RIL_PARAM_REGSI_ALL, rilapitypes/RIL_PARAM_REGSI_REGREJECTREASON, rilapitypes/RILREGSTATUSINFOPARAMMASK, RIL_PARAM_REGSI_NETWORKCODE, rilapitypes/RIL_PARAM_REGSI_SYSTEMCAPS, rilapitypes/RIL_PARAM_REGSI_ACCESSTECHNOLOGY, RIL_PARAM_REGSI_REGSTATUS, RIL_PARAM_REGSI_VOICEDOMAIN, RIL_PARAM_REGSI_ACCESSTECHNOLOGY, RIL_PARAM_REGSI_ALL, RIL_PARAM_REGSI_REGREJECTREASON, RILREGSTATUSINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_REGSI_CURRENTOPERATOR, rilapitypes/RIL_PARAM_REGSI_CURRENTOPERATOR, RILREGSTATUSINFOPARAMMASK, rilapitypes/RIL_PARAM_REGSI_NETWORKCODE, rilapitypes/RIL_PARAM_REGSI_HUICCAPP, RIL_PARAM_REGSI_HUICCAPP, rilapitypes/RIL_PARAM_REGSI_VOICEDOMAIN, rilapitypes/RIL_PARAM_REGSI_REGSTATUS, RIL_PARAM_REGSI_SYSTEMCAPS
