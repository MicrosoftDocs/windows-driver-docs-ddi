...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RILSYSTEMSELECTIONPREFSPARAMMASK, RIL_PARAM_SSP_MODE, RIL_PARAM_SSP_ACQUISITIONORDER, rilapitypes/RIL_PARAM_SSP_ACQUISITIONORDER, RILSYSTEMSELECTIONPREFSPARAMMASK, RIL_PARAM_SSP_ROAMINGMODE, RILSYSTEMSELECTIONPREFSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_SSP_MODE, RIL_PARAM_SSP_ALL, rilapitypes/RIL_PARAM_SSP_ALL, rilapitypes/RIL_PARAM_SSP_PLMNINFO, RIL_PARAM_SSP_SYSTEMTYPES, rilapitypes/RIL_PARAM_SSP_SYSTEMTYPES, RIL_PARAM_SSP_ACQUISITIONORDERSIZE, netvista.rilsystemselectionprefsparammask_2, rilapitypes/RIL_PARAM_SSP_ROAMINGMODE, RIL_PARAM_SSP_PLMNINFO, rilapitypes/RIL_PARAM_SSP_ACQUISITIONORDERSIZE
