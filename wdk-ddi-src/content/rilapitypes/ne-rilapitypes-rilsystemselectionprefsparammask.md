...
ms.date: 2/16/2018
ms.keywords: RIL_PARAM_SSP_ROAMINGMODE, RIL_PARAM_SSP_ACQUISITIONORDER, RIL_PARAM_SSP_ACQUISITIONORDERSIZE, rilapitypes/RIL_PARAM_SSP_ACQUISITIONORDER, netvista.rilsystemselectionprefsparammask_2, rilapitypes/RIL_PARAM_SSP_MODE, rilapitypes/RILSYSTEMSELECTIONPREFSPARAMMASK, RIL_PARAM_SSP_SYSTEMTYPES, rilapitypes/RIL_PARAM_SSP_ACQUISITIONORDERSIZE, RILSYSTEMSELECTIONPREFSPARAMMASK, RIL_PARAM_SSP_ALL, RILSYSTEMSELECTIONPREFSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_SSP_SYSTEMTYPES, rilapitypes/RIL_PARAM_SSP_ROAMINGMODE, rilapitypes/RIL_PARAM_SSP_ALL, RIL_PARAM_SSP_MODE, RIL_PARAM_SSP_PLMNINFO, rilapitypes/RIL_PARAM_SSP_PLMNINFO
