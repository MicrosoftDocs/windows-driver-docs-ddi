...
ms.date: 1/18/2018
ms.keywords: RILSYSTEMSELECTIONPREFSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_SSP_SYSTEMTYPES, rilapitypes/RIL_PARAM_SSP_MODE, RIL_PARAM_SSP_ACQUISITIONORDER, RIL_PARAM_SSP_SYSTEMTYPES, RILSYSTEMSELECTIONPREFSPARAMMASK, RIL_PARAM_SSP_ROAMINGMODE, RIL_PARAM_SSP_ALL, rilapitypes/RIL_PARAM_SSP_ALL, RIL_PARAM_SSP_PLMNINFO, rilapitypes/RIL_PARAM_SSP_PLMNINFO, rilapitypes/RIL_PARAM_SSP_ACQUISITIONORDER, RIL_PARAM_SSP_ACQUISITIONORDERSIZE, RIL_PARAM_SSP_MODE, rilapitypes/RIL_PARAM_SSP_ACQUISITIONORDERSIZE, rilapitypes/RIL_PARAM_SSP_ROAMINGMODE, netvista.rilsystemselectionprefsparammask_2, rilapitypes/RILSYSTEMSELECTIONPREFSPARAMMASK
