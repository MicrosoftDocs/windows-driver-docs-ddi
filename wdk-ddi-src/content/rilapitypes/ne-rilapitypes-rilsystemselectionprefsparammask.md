...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_PARAM_SSP_ACQUISITIONORDER, RIL_PARAM_SSP_SYSTEMTYPES, RIL_PARAM_SSP_ACQUISITIONORDER, rilapitypes/RIL_PARAM_SSP_ROAMINGMODE, RIL_PARAM_SSP_MODE, RIL_PARAM_SSP_ROAMINGMODE, rilapitypes/RIL_PARAM_SSP_SYSTEMTYPES, rilapitypes/RIL_PARAM_SSP_MODE, RIL_PARAM_SSP_ACQUISITIONORDERSIZE, RIL_PARAM_SSP_ALL, rilapitypes/RIL_PARAM_SSP_ALL, RILSYSTEMSELECTIONPREFSPARAMMASK, rilapitypes/RILSYSTEMSELECTIONPREFSPARAMMASK, RILSYSTEMSELECTIONPREFSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_SSP_ACQUISITIONORDERSIZE, RIL_PARAM_SSP_PLMNINFO, rilapitypes/RIL_PARAM_SSP_PLMNINFO, netvista.rilsystemselectionprefsparammask_2
