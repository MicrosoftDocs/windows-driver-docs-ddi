...
title: RILSYSTEMSELECTIONPREFSPARAMMASK (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILSYSTEMSELECTIONPREFSPARAMMASK enumeration for internal use only."
