...
description: "Don't use this enumeration in your code. Microsoft reserves the RILEMERGENCYNUMBERPARAMMASK enumeration for internal use only."
old-location: netvista\rilemergencynumberparammask.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILEMERGENCYNUMBERPARAMMASK enumeration"]
...
# RILEMERGENCYNUMBERPARAMMASK enumeration (rilapitypes.h)
