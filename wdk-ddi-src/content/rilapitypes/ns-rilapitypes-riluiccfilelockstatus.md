...
ms.date: 2/16/2018
ms.keywords: RILUICCFILELOCKSTATUS, rilapitypes/RILUICCFILELOCKSTATUS, netvista.riluiccfilelockstatus, RILUICCFILELOCKSTATUS structure [Network Drivers Starting with Windows Vista], *LPRILUICCFILELOCKSTATUS
