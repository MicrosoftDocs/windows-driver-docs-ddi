...
description: "Microsoft reserves the RILALPHAIDENTIFIERPARAMMASK enumeration for internal use only. Don't use this enumeration in your code."
...
# RILALPHAIDENTIFIERPARAMMASK enumeration (rilapitypes.h)
