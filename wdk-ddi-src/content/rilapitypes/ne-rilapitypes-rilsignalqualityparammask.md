...
description: "Microsoft reserves the RILSIGNALQUALITYPARAMMASK enumeration for internal use only. Don't use this enumeration in your code."
old-location: netvista\rilsignalqualityparammask.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILSIGNALQUALITYPARAMMASK enumeration"]
...
f1_keywords:
 - RILSIGNALQUALITYPARAMMASK
 - rilapitypes/RILSIGNALQUALITYPARAMMASK
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# RILSIGNALQUALITYPARAMMASK enumeration (rilapitypes.h)
