...
description: "Don't use this enumeration in your code. Microsoft reserves the RILSMSMSGINFLAGS enumeration for internal use only."
...
# RILSMSMSGINFLAGS enumeration (rilapitypes.h)
