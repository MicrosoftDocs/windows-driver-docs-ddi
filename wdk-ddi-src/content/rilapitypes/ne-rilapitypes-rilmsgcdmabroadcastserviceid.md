...
title: RILMSGCDMABROADCASTSERVICEID (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILMSGCDMABROADCASTSERVICEID enumeration for internal use only."
