...
description: "Microsoft reserves the RILDIALPARAMSOPTIONS enumeration for internal use only. Don't use this enumeration in your code."
...
# RILDIALPARAMSOPTIONS enumeration (rilapitypes.h)
