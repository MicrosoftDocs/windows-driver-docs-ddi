...
title: RILCALLINFODIRECTION (rilapitypes.h)
description: "Microsoft reserves the RILCALLINFODIRECTION enumeration for internal use only. Don't use this enumeration in your code."
...
f1_keywords:
 ...
 - rilapitypes/RILCALLINFODIRECTION
topic_type:
 - APIRef
 - kbSyntax
api_type:
