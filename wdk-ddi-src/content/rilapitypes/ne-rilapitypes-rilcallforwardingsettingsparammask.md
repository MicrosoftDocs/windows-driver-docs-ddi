...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_PARAM_CFS_INFOCLASSES, netvista.rilcallforwardingsettingsparammask_2, RIL_PARAM_CFS_SUBADDRESS, RIL_PARAM_CFS_ADDRESS, rilapitypes/RILCALLFORWARDINGSETTINGSPARAMMASK, RILCALLFORWARDINGSETTINGSPARAMMASK, RIL_PARAM_CFS_INFOCLASSES, rilapitypes/RIL_PARAM_CFS_ADDRESS, rilapitypes/RIL_PARAM_CFS_SUBADDRESS, rilapitypes/RIL_PARAM_CFS_ALL, RIL_PARAM_CFS_ALL, rilapitypes/RIL_PARAM_CFS_DELAYTIME, RIL_PARAM_CFS_DELAYTIME, RILCALLFORWARDINGSETTINGSPARAMMASK enumeration [Network Drivers Starting with Windows Vista]
