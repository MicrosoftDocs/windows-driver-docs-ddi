...
title: RILCALLFORWARDINGSETTINGSPARAMMASK (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILCALLFORWARDINGSETTINGSPARAMMASK enumeration for internal use only. "
...
f1_keywords:
 ...
 - rilapitypes/RILCALLFORWARDINGSETTINGSPARAMMASK
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# RILCALLFORWARDINGSETTINGSPARAMMASK enumeration (rilapitypes.h)
