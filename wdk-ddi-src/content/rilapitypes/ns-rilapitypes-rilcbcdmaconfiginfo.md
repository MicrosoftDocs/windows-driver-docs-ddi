...
ms.date: 1/18/2018
ms.keywords: RILCBCDMACONFIGINFO, RILCBCDMACONFIGINFO structure [Network Drivers Starting with Windows Vista], netvista.rilcbcdmaconfiginfo_2, rilapitypes/RILCBCDMACONFIGINFO, *LPRILCBCDMACONFIGINFO
