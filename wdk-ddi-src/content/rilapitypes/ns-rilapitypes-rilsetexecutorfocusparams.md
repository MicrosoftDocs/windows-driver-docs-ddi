...
ms.date: 1/18/2018
ms.keywords: netvista.rilsetexecutorfocusparams_2, *LPRILSETEXECUTORFOCUSPARAMS, RILSETEXECUTORFOCUSPARAMS structure [Network Drivers Starting with Windows Vista], rilapitypes/RILSETEXECUTORFOCUSPARAMS, RILSETEXECUTORFOCUSPARAMS
