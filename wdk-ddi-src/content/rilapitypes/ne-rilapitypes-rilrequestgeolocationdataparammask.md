...
ms.date: 2/16/2018
ms.keywords: RIL_PARAM_REQUESTGEOLOCATIONDATA_REQUESTINFORMATION, rilapitypes/RIL_PARAM_REQUESTGEOLOCATIONDATA_REQUESTINFORMATION, RIL_PARAM_REQUESTGEOLOCATIONDATA_ALL, rilapitypes/RIL_PARAM_REQUESTGEOLOCATIONDATA_MASK, RIL_PARAM_REQUESTGEOLOCATIONDATA_SIZE, rilapitypes/RILREQUESTGEOLOCATIONDATAPARAMMASK, rilapitypes/RIL_PARAM_REQUESTGEOLOCATIONDATA_EXECUTOR, rilapitypes/RIL_PARAM_REQUESTGEOLOCATIONDATA_ALL, RIL_PARAM_REQUESTGEOLOCATIONDATA_REQUESTACCCURACY, netvista.rilrequestgeolocationdataparammask_2, RILREQUESTGEOLOCATIONDATAPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_REQUESTGEOLOCATIONDATA_EXECUTOR, RILREQUESTGEOLOCATIONDATAPARAMMASK, rilapitypes/RIL_PARAM_REQUESTGEOLOCATIONDATA_REQUESTACCCURACY, rilapitypes/RIL_PARAM_REQUESTGEOLOCATIONDATA_SIZE, RIL_PARAM_REQUESTGEOLOCATIONDATA_MASK
