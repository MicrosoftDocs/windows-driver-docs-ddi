...
ms.date: 1/18/2018
ms.keywords: RIL_PARAM_REQUESTGEOLOCATIONDATA_SIZE, rilapitypes/RIL_PARAM_REQUESTGEOLOCATIONDATA_ALL, netvista.rilrequestgeolocationdataparammask_2, rilapitypes/RIL_PARAM_REQUESTGEOLOCATIONDATA_SIZE, rilapitypes/RIL_PARAM_REQUESTGEOLOCATIONDATA_REQUESTACCCURACY, RILREQUESTGEOLOCATIONDATAPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_REQUESTGEOLOCATIONDATA_REQUESTACCCURACY, RIL_PARAM_REQUESTGEOLOCATIONDATA_ALL, rilapitypes/RIL_PARAM_REQUESTGEOLOCATIONDATA_EXECUTOR, rilapitypes/RILREQUESTGEOLOCATIONDATAPARAMMASK, RIL_PARAM_REQUESTGEOLOCATIONDATA_REQUESTINFORMATION, RIL_PARAM_REQUESTGEOLOCATIONDATA_EXECUTOR, rilapitypes/RIL_PARAM_REQUESTGEOLOCATIONDATA_MASK, rilapitypes/RIL_PARAM_REQUESTGEOLOCATIONDATA_REQUESTINFORMATION, RIL_PARAM_REQUESTGEOLOCATIONDATA_MASK, RILREQUESTGEOLOCATIONDATAPARAMMASK
