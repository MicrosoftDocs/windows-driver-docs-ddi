...
ms.date: 2/16/2018
ms.keywords: RIL_MSGFLAG_HEADER, rilapitypes/RIL_MSGFLAG_HEADER, netvista.rilmessageflags_2, RILMESSAGEFLAGS enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RILMESSAGEFLAGS, rilapitypes/RIL_MSGFLAG_CAUSEDBYCOMMAND, RIL_MSGFLAG_ALL, RIL_MSGFLAG_MORETOSEND, RIL_MSGFLAG_REPLYPATH, RIL_MSGFLAG_REJECTDUPS, RIL_MSGFLAG_STATUSREPORTRETURNED, RIL_MSGFLAG_STATUSREPORTREQUESTED, rilapitypes/RIL_MSGFLAG_STATUSREPORTREQUESTED, RIL_MSGFLAG_CAUSEDBYCOMMAND, rilapitypes/RIL_MSGFLAG_MORETOSEND, rilapitypes/RIL_MSGFLAG_ALL, rilapitypes/RIL_MSGFLAG_STATUSREPORTRETURNED, rilapitypes/RIL_MSGFLAG_REPLYPATH, RILMESSAGEFLAGS, rilapitypes/RIL_MSGFLAG_REJECTDUPS
