...
ms.date: 1/18/2018
ms.keywords: RIL_MSGFLAG_MORETOSEND, rilapitypes/RIL_MSGFLAG_STATUSREPORTREQUESTED, RIL_MSGFLAG_STATUSREPORTREQUESTED, RILMESSAGEFLAGS, netvista.rilmessageflags_2, rilapitypes/RILMESSAGEFLAGS, RIL_MSGFLAG_REJECTDUPS, RIL_MSGFLAG_STATUSREPORTRETURNED, rilapitypes/RIL_MSGFLAG_STATUSREPORTRETURNED, rilapitypes/RIL_MSGFLAG_REJECTDUPS, RIL_MSGFLAG_ALL, RIL_MSGFLAG_HEADER, RILMESSAGEFLAGS enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_MSGFLAG_MORETOSEND, rilapitypes/RIL_MSGFLAG_ALL, RIL_MSGFLAG_CAUSEDBYCOMMAND, rilapitypes/RIL_MSGFLAG_HEADER, RIL_MSGFLAG_REPLYPATH, rilapitypes/RIL_MSGFLAG_CAUSEDBYCOMMAND, rilapitypes/RIL_MSGFLAG_REPLYPATH
