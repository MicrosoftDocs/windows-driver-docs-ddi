...
ms.date: 2/16/2018
ms.keywords: RIL_MSGFLAG_MORETOSEND, rilapitypes/RIL_MSGFLAG_MORETOSEND, netvista.rilmessageflags_2, RIL_MSGFLAG_REPLYPATH, rilapitypes/RIL_MSGFLAG_HEADER, RILMESSAGEFLAGS, rilapitypes/RIL_MSGFLAG_REJECTDUPS, RIL_MSGFLAG_CAUSEDBYCOMMAND, rilapitypes/RIL_MSGFLAG_CAUSEDBYCOMMAND, rilapitypes/RIL_MSGFLAG_ALL, RIL_MSGFLAG_REJECTDUPS, rilapitypes/RIL_MSGFLAG_STATUSREPORTRETURNED, rilapitypes/RIL_MSGFLAG_STATUSREPORTREQUESTED, RIL_MSGFLAG_ALL, rilapitypes/RILMESSAGEFLAGS, RILMESSAGEFLAGS enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_MSGFLAG_REPLYPATH, RIL_MSGFLAG_STATUSREPORTRETURNED, RIL_MSGFLAG_STATUSREPORTREQUESTED, RIL_MSGFLAG_HEADER
