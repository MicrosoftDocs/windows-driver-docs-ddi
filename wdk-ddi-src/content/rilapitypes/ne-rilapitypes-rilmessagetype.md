...
title: RILMESSAGETYPE (rilapitypes.h)
description: "Microsoft reserves the RILMESSAGETYPE enumeration for internal use only. Don't use this enumeration in your code."
