...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_MSGTYPE_IN_IS637STATUS, RIL_MSGTYPE_OUT_CDMASUBMIT, RILMESSAGETYPE, rilapitypes/RIL_MSGTYPE_OUT_SUBMIT, rilapitypes/RIL_MSGTYPE_OUT_CDMASUBMIT, rilapitypes/RIL_MSGTYPE_IN_STATUS, RIL_MSGTYPE_OUT_SUBMIT, RIL_MSGTYPE_BC_GENERAL, rilapitypes/RIL_MSGTYPE_IN_CDMADELIVER, RIL_MSGTYPE_IN_CDMADELIVER, RILMESSAGETYPE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RILMESSAGETYPE, RIL_MSGTYPE_IN_IS637STATUS, rilapitypes/RIL_MSGTYPE_BC_GENERAL, RIL_MSGTYPE_IN_STATUS, netvista.rilmessagetype_2
