...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_MSGTYPE_IN_CDMADELIVER, RIL_MSGTYPE_OUT_CDMASUBMIT, RIL_MSGTYPE_OUT_SUBMIT, RILMESSAGETYPE, rilapitypes/RIL_MSGTYPE_OUT_SUBMIT, rilapitypes/RIL_MSGTYPE_OUT_CDMASUBMIT, RIL_MSGTYPE_BC_GENERAL, netvista.rilmessagetype_2, RIL_MSGTYPE_IN_STATUS, rilapitypes/RIL_MSGTYPE_IN_STATUS, rilapitypes/RIL_MSGTYPE_IN_IS637STATUS, RIL_MSGTYPE_IN_IS637STATUS, RILMESSAGETYPE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_MSGTYPE_BC_GENERAL, RIL_MSGTYPE_IN_CDMADELIVER, rilapitypes/RILMESSAGETYPE
