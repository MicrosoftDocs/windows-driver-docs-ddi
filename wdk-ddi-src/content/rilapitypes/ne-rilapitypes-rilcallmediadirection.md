...
title: RILCALLMEDIADIRECTION (rilapitypes.h)
description: "Microsoft reserves the RILCALLMEDIADIRECTION enumeration for internal use only. Don't use this enumeration in your code."
