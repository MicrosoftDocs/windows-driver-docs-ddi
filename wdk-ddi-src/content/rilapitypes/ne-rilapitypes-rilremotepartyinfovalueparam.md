...
description: "Microsoft reserves the RILREMOTEPARTYINFOVALUEPARAM enumeration for internal use only. Don't use this enumeration in your code."
...
# RILREMOTEPARTYINFOVALUEPARAM enumeration (rilapitypes.h)
