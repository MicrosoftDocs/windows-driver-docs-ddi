...
ms.date: 1/18/2018
ms.keywords: RILREMOTEPARTYINFOVALUEPARAM, rilapitypes/RIL_PARAM_RPI_ADDRESS, rilapitypes/RIL_PARAM_RPI_NAME_PRES_IND, RILREMOTEPARTYINFOPARAM, RIL_PARAM_RPI_ADDRESS, RIL_PARAM_RPI_NUM_PRES_IND, RIL_PARAM_RPI_DESCRIPTION, RIL_PARAM_RPI_SUBADDRESS, RIL_PARAM_RPI_ID, rilapitypes/RIL_PARAM_RPI_NUM_PRES_IND, rilapitypes/RIL_PARAM_RPI_ID, rilapitypes/RIL_PARAM_RPI_SUBADDRESS, RIL_PARAM_RPI_NAME_PRES_IND, netvista.rilremotepartyinfovalueparam_2, RIL_PARAM_RPI_ALL, rilapitypes/RIL_PARAM_RPI_ALL, rilapitypes/RILREMOTEPARTYINFOVALUEPARAM, rilapitypes/RIL_PARAM_RPI_DESCRIPTION, RILREMOTEPARTYINFOVALUEPARAM enumeration [Network Drivers Starting with Windows Vista]
