...
ms.date: 1/18/2018
ms.keywords: RIL_MSGPRIVACYCLASS_RESTRICTED, rilapitypes/RIL_MSGPRIVACYCLASS_CONFIDENTIAL, netvista.rilmsgcdmamsgprivacy_2, rilapitypes/RILMSGCDMAMSGPRIVACY, RILMSGCDMAMSGPRIVACY, RIL_MSGPRIVACYCLASS_SECRET, RILMSGCDMAMSGPRIVACY enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_MSGPRIVACYCLASS_SECRET, rilapitypes/RIL_MSGPRIVACYCLASS_RESTRICTED, RIL_MSGPRIVACYCLASS_CONFIDENTIAL, RIL_MSGPRIVACYCLASS_MAX, rilapitypes/RIL_MSGPRIVACYCLASS_MAX
