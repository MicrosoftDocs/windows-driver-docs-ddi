...
description: "Don't use this enumeration in your code. Microsoft reserves the RILMSGCDMAMSGPRIVACY enumeration for internal use only."
old-location: netvista\rilmsgcdmamsgprivacy.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILMSGCDMAMSGPRIVACY enumeration"]
...
f1_keywords:
 ...
 - rilapitypes/RILMSGCDMAMSGPRIVACY
topic_type:
 - APIRef
 - kbSyntax
api_type:
