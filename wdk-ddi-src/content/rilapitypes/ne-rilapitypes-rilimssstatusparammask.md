...
ms.date: 1/18/2018
ms.keywords: RILIMSSSTATUSPARAMMASK, RIL_PARAM_IMSSTATUS_SYSTEMTYPE, netvista.rilimssstatusparammask_2, RIL_PARAM_IMSSTATUS_SERVINGDOMAIN, rilapitypes/RIL_PARAM_IMSSTATUS_HUICCAPP, rilapitypes/RIL_PARAM_IMSSTATUS_SMSSUPPORTEDFORMAT, rilapitypes/RILIMSSSTATUSPARAMMASK, rilapitypes/RIL_PARAM_IMSSTATUS_SERVINGDOMAIN, RIL_PARAM_IMSSTATUS_SMSSUPPORTEDFORMAT, RIL_PARAM_IMSSTATUS_HUICCAPP, RIL_PARAM_IMSSTATUS_ALL, RILIMSSSTATUSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_IMSSTATUS_ALL, rilapitypes/RIL_PARAM_IMSSTATUS_AVAILABLESERVICES, rilapitypes/RIL_PARAM_IMSSTATUS_SYSTEMTYPE, RIL_PARAM_IMSSTATUS_AVAILABLESERVICES
