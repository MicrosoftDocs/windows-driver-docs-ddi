...
ms.date: 2/16/2018
ms.keywords: RILIMSSSTATUSPARAMMASK, RIL_PARAM_IMSSTATUS_AVAILABLESERVICES, RIL_PARAM_IMSSTATUS_ALL, rilapitypes/RIL_PARAM_IMSSTATUS_SMSSUPPORTEDFORMAT, RIL_PARAM_IMSSTATUS_HUICCAPP, rilapitypes/RIL_PARAM_IMSSTATUS_HUICCAPP, RIL_PARAM_IMSSTATUS_SERVINGDOMAIN, RIL_PARAM_IMSSTATUS_SMSSUPPORTEDFORMAT, rilapitypes/RIL_PARAM_IMSSTATUS_ALL, RILIMSSSTATUSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RILIMSSSTATUSPARAMMASK, netvista.rilimssstatusparammask_2, rilapitypes/RIL_PARAM_IMSSTATUS_SERVINGDOMAIN, rilapitypes/RIL_PARAM_IMSSTATUS_SYSTEMTYPE, rilapitypes/RIL_PARAM_IMSSTATUS_AVAILABLESERVICES, RIL_PARAM_IMSSTATUS_SYSTEMTYPE
