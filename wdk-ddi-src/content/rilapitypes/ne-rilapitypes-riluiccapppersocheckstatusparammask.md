...
description: "Don't use this enumeration in your code. Microsoft reserves the RILUICCAPPPERSOCHECKSTATUSPARAMMASK enumeration for internal use only."
...
# RILUICCAPPPERSOCHECKSTATUSPARAMMASK enumeration (rilapitypes.h)
