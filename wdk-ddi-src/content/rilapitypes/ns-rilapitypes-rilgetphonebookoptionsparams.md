...
description: "Don't use this structure in your code. Microsoft reserves the RILGETPHONEBOOKOPTIONSPARAMS structure for internal use only."
...
# RILGETPHONEBOOKOPTIONSPARAMS structure (rilapitypes.h)
