...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_PARAM_UNSSS_CUGINDEX, rilapitypes/RIL_PARAM_UNSSS_HISTLENGTH, rilapitypes/RIL_PARAM_UNSSS_HISTINFO, RIL_PARAM_UNSSS_ALL, RIL_PARAM_UNSSS_HISTINFO, netvista.rilunsolicitedssinfoparammask_2, RILUNSOLICITEDSSINFOPARAMMASK, rilapitypes/RIL_PARAM_UNSSS_SUBADDR, RILUNSOLICITEDSSINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_UNSSS_NOTIFICATIONCODE, RIL_PARAM_UNSSS_ADDRESS, RIL_PARAM_UNSSS_HISTLENGTH, rilapitypes/RILUNSOLICITEDSSINFOPARAMMASK, RIL_PARAM_UNSSS_ID, rilapitypes/RIL_PARAM_UNSSS_NOTIFICATIONCODE, RIL_PARAM_UNSSS_CUGINDEX, RIL_PARAM_UNSSS_SUBADDR, rilapitypes/RIL_PARAM_UNSSS_ID, rilapitypes/RIL_PARAM_UNSSS_ADDRESS, rilapitypes/RIL_PARAM_UNSSS_ALL
