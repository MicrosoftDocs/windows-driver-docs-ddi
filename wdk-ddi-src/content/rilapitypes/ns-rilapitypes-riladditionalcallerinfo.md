...
title: RILADDITIONALCALLERINFO (rilapitypes.h)
description: "Microsoft reserves the RILADDITIONALCALLERINFO structure for internal use only. Don't use this structure in your code."
...
f1_keywords:
 ...
 - rilapitypes/RILADDITIONALCALLERINFO
 - LPRILADDITIONALCALLERINFO
 - rilapitypes/LPRILADDITIONALCALLERINFO
topic_type:
 - APIRef
 - kbSyntax
api_type:
