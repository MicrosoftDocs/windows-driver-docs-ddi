...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RILSENDDTMFPARAMS, RILSENDDTMFPARAMS structure [Network Drivers Starting with Windows Vista], RILSENDDTMFPARAMS, netvista.rilsenddtmfparams_2, *LPRILSENDDTMFPARAMS
