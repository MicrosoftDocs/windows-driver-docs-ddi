...
ms.date: 1/18/2018
ms.keywords: RILSENDDTMFPARAMS, *LPRILSENDDTMFPARAMS, netvista.rilsenddtmfparams_2, RILSENDDTMFPARAMS structure [Network Drivers Starting with Windows Vista], rilapitypes/RILSENDDTMFPARAMS
