...
description: "Microsoft reserves the RILCALLMEDIAOFFERANSWERSET structure for internal use only. Don't use this structure in your code."
...
# RILCALLMEDIAOFFERANSWERSET structure (rilapitypes.h)
