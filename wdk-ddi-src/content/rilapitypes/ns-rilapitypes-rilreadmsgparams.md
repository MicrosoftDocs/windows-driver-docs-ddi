...
ms.date: 1/18/2018
ms.keywords: RILREADMSGPARAMS structure [Network Drivers Starting with Windows Vista], *LPRILREADMSGPARAMS, RILREADMSGPARAMS, rilapitypes/RILREADMSGPARAMS, netvista.rilreadmsgparams_2
