...
description: "Don't use this enumeration in your code. Microsoft reserves the RILCALLERIDSETTINGSPARAMMASK enumeration for internal use only. "
...
# RILCALLERIDSETTINGSPARAMMASK enumeration (rilapitypes.h)
