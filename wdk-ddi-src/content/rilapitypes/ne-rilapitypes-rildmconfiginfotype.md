...
ms.date: 2/16/2018
ms.keywords: RIL_DMCV_TYPE_DWORD, RIL_DMCV_TYPE_MAX, rilapitypes/RIL_DMCV_TYPE_MAX, RIL_DMCV_TYPE_BOOLEAN, RILDMCONFIGINFOTYPE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_DMCV_TYPE_DWORD, RIL_DMCV_TYPE_STRING, rilapitypes/RIL_DMCV_TYPE_BOOLEAN, RILDMCONFIGINFOTYPE, rilapitypes/RIL_DMCV_TYPE_STRING, netvista.rildmconfiginfotype_2, rilapitypes/RILDMCONFIGINFOTYPE
