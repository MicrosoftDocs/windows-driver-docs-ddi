...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_RADIOSTATE_ITEMFLAG_USE_INTARRAY, RIL_RADIOSTATE_ITEMFLAG_USE_BYTEARRAY, netvista.rilradiostateitemflag_2, RIL_RADIOSTATE_ITEMFLAG_USE_UINTVAL, RILRADIOSTATEITEMFLAG, RIL_RADIOSTATE_ITEMFLAG_USE_UINTARRAY, rilapitypes/RIL_RADIOSTATE_ITEMFLAG_USE_UINTARRAY, RIL_RADIOSTATE_ITEMFLAG_USE_MAX, RILRADIOSTATEITEMFLAG enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_RADIOSTATE_ITEMFLAG_USE_WSZVAL, RIL_RADIOSTATE_ITEMFLAG_USE_INTARRAY, RIL_RADIOSTATE_ITEMFLAG_USE_WSZVAL, rilapitypes/RIL_RADIOSTATE_ITEMFLAG_USE_UINTVAL, rilapitypes/RIL_RADIOSTATE_ITEMFLAG_USE_BYTEARRAY, rilapitypes/RILRADIOSTATEITEMFLAG, rilapitypes/RIL_RADIOSTATE_ITEMFLAG_USE_MAX
