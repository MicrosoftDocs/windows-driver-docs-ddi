...
title: RILUNSOLICITEDSSINFONOTIFICATIONCODE (rilapitypes.h)
description: "Microsoft reserves the RILUNSOLICITEDSSINFONOTIFICATIONCODE enumeration for internal use only. Don't use this enumeration in your code."
