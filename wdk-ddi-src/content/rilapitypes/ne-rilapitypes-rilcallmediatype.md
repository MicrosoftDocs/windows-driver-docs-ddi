...
title: RILCALLMEDIATYPE (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILCALLMEDIATYPE enumeration for internal use only."
