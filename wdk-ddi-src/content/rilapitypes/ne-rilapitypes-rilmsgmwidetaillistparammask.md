...
description: "Don't use this enumeration in your code. Microsoft reserves the RILMSGMWIDETAILLISTPARAMMASK enumeration for internal use only."
...
# RILMSGMWIDETAILLISTPARAMMASK enumeration (rilapitypes.h)
