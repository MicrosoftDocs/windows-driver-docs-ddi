...
title: RILUICCCHANNELGROUP (rilapitypes.h)
description: "Microsoft reserves the RILUICCCHANNELGROUP enumeration for internal use only. Don't use this enumeration in your code."
...
# RILUICCCHANNELGROUP enumeration (rilapitypes.h)
