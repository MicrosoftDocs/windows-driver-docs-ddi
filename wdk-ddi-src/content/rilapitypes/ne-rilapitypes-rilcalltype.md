...
description: "Microsoft reserves the RILCALLTYPE enumeration for internal use only. Don't use this enumeration in your code."
old-location: netvista\rilcalltype.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILCALLTYPE enumeration"]
