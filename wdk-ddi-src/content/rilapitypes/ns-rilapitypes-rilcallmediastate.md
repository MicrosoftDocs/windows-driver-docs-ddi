...
ms.date: 1/18/2018
ms.keywords: netvista.rilcallmediastate_2, RILCALLMEDIASTATE structure [Network Drivers Starting with Windows Vista], *LPRILCALLMEDIASTATE, rilapitypes/RILCALLMEDIASTATE, RILCALLMEDIASTATE
