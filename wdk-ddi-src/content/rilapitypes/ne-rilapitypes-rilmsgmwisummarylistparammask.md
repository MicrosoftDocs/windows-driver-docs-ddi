...
ms.date: 1/18/2018
ms.keywords: RIL_PARAM_MWISUMMARY_TOTALNUMDETAILITEMS, RIL_PARAM_MWISUMMARY_NUMSUMMARYITEMS, RILMSGMWISUMMARYLISTPARAMMASK, rilapitypes/RIL_PARAM_MWISUMMARY_ACCTADDR, rilapitypes/RILMSGMWISUMMARYLISTPARAMMASK, netvista.rilmsgmwisummarylistparammask_2, rilapitypes/RIL_PARAM_MWISUMMARY_NUMSUMMARYITEMS, RIL_PARAM_MWISUMMARY_ALL, rilapitypes/RIL_PARAM_MWISUMMARY_REFNUM, rilapitypes/RIL_PARAM_MWISUMMARY_ALL, RIL_PARAM_MWISUMMARY_SUMMARYITEMS, RILMSGMWISUMMARYLISTPARAMMASK enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_PARAM_MWISUMMARY_SUMMARYITEMS, rilapitypes/RIL_PARAM_MWISUMMARY_TOTALNUMDETAILITEMS, RIL_PARAM_MWISUMMARY_REFNUM, RIL_PARAM_MWISUMMARY_ACCTADDR
