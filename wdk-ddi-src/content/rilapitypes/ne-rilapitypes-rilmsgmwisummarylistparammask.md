...
ms.date: 2/16/2018
ms.keywords: RIL_PARAM_MWISUMMARY_NUMSUMMARYITEMS, RILMSGMWISUMMARYLISTPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_MWISUMMARY_ACCTADDR, RIL_PARAM_MWISUMMARY_REFNUM, RIL_PARAM_MWISUMMARY_TOTALNUMDETAILITEMS, rilapitypes/RIL_PARAM_MWISUMMARY_ALL, RIL_PARAM_MWISUMMARY_SUMMARYITEMS, rilapitypes/RIL_PARAM_MWISUMMARY_SUMMARYITEMS, rilapitypes/RIL_PARAM_MWISUMMARY_ACCTADDR, RIL_PARAM_MWISUMMARY_ALL, RILMSGMWISUMMARYLISTPARAMMASK, netvista.rilmsgmwisummarylistparammask_2, rilapitypes/RIL_PARAM_MWISUMMARY_TOTALNUMDETAILITEMS, rilapitypes/RILMSGMWISUMMARYLISTPARAMMASK, rilapitypes/RIL_PARAM_MWISUMMARY_NUMSUMMARYITEMS, rilapitypes/RIL_PARAM_MWISUMMARY_REFNUM
