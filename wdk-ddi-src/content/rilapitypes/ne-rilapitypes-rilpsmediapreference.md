...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_PSMPREF_WIFIPREFERRED, RILPSMEDIAPREFERENCE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RILPSMEDIAPREFERENCE, rilapitypes/RIL_PSMPREF_WIFIONLY, rilapitypes/RIL_PSMPREF_NUMBER_OF_VALUES, RILPSMEDIAPREFERENCE, rilapitypes/RIL_PSMPREF_CELLPREFERRED, RIL_PSMPREF_NUMBER_OF_VALUES, RIL_PSMPREF_CELLPREFERRED, netvista.rilpsmediapreference_2, RIL_PSMPREF_WIFIPREFERRED, rilapitypes/RIL_PSMPREF_CELLONLY, RIL_PSMPREF_CELLONLY, RIL_PSMPREF_WIFIONLY
