...
ms.date: 2/16/2018
ms.keywords: RILOPERATORINFOSTATUS enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_OPSTATUS_AVAILABLE, rilapitypes/RILOPERATORINFOSTATUS, RIL_OPSTATUS_AVAILABLE, netvista.riloperatorinfostatus_2, rilapitypes/RIL_OPSTATUS_FORBIDDEN, rilapitypes/RIL_OPSTATUS_MAX, RIL_OPSTATUS_FORBIDDEN, rilapitypes/RIL_OPSTATUS_CURRENT, RIL_OPSTATUS_CURRENT, RILOPERATORINFOSTATUS, RIL_OPSTATUS_MAX
