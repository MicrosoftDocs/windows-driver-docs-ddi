...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RILCALLSUPPORTCAPS, rilapitypes/RIL_CAPS_CALLSUPPORT_USS, rilapitypes/RIL_CAPS_CALLSUPPORT_CUG, RILCALLSUPPORTCAPS, RIL_CAPS_CALLSUPPORT_EMLPP, rilapitypes/RIL_CAPS_CALLSUPPORT_USSD_PHASE2, RILCALLSUPPORTCAPS enumeration [Network Drivers Starting with Windows Vista], RIL_CAPS_CALLSUPPORT_USSD_PHASE2, rilapitypes/RIL_CAPS_CALLSUPPORT_MSP, RIL_CAPS_CALLSUPPORT_CD, RIL_CAPS_CALLSUPPORT_FM, RIL_CAPS_CALLSUPPORT_USS, rilapitypes/RIL_CAPS_CALLSUPPORT_CD, rilapitypes/RIL_CAPS_CALLSUPPORT_EMLPP, rilapitypes/RIL_CAPS_CALLSUPPORT_FM, rilapitypes/RIL_CAPS_CALLSUPPORT_CNAP, netvista.rilcallsupportcaps_2, RIL_CAPS_CALLSUPPORT_ALL, rilapitypes/RIL_CAPS_CALLSUPPORT_ALL, RIL_CAPS_CALLSUPPORT_CNAP, RIL_CAPS_CALLSUPPORT_CUG, RIL_CAPS_CALLSUPPORT_MSP
