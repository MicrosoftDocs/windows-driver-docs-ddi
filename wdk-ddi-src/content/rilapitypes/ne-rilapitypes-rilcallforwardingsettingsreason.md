...
ms.date: 2/16/2018
ms.keywords: RIL_FWDREASON_ALLCONDITIONAL, RIL_FWDREASON_MAX, RILCALLFORWARDINGSETTINGSREASON, rilapitypes/RIL_FWDREASON_UNREACHABLE, RIL_FWDREASON_UNREACHABLE, RIL_FWDREASON_ALLFORWARDING, RIL_FWDREASON_NOREPLY, rilapitypes/RIL_FWDREASON_ALLCONDITIONAL, rilapitypes/RILCALLFORWARDINGSETTINGSREASON, rilapitypes/RIL_FWDREASON_ALLFORWARDING, rilapitypes/RIL_FWDREASON_NOREPLY, rilapitypes/RIL_FWDREASON_MAX, RIL_FWDREASON_MOBILEBUSY, netvista.rilcallforwardingsettingsreason_2, RILCALLFORWARDINGSETTINGSREASON enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_FWDREASON_MOBILEBUSY
