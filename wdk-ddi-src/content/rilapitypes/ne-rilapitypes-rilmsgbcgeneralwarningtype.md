...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_WARNINGTYPE_TEST, RILMSGBCGENERALWARNINGTYPE enumeration [Network Drivers Starting with Windows Vista], RIL_WARNINGTYPE_RESERVED, RIL_WARNINGTYPE_MAX, RIL_WARNINGTYPE_EARTHQUAKETSUNAMI, rilapitypes/RIL_WARNINGTYPE_EARTHQUAKETSUNAMI, netvista.rilmsgbcgeneralwarningtype_2, RILMSGBCGENERALWARNINGTYPE, rilapitypes/RIL_WARNINGTYPE_MAX, rilapitypes/RILMSGBCGENERALWARNINGTYPE, RIL_WARNINGTYPE_TSUNAMI, RIL_WARNINGTYPE_OTHER, rilapitypes/RIL_WARNINGTYPE_TSUNAMI, RIL_WARNINGTYPE_TEST, rilapitypes/RIL_WARNINGTYPE_OTHER, rilapitypes/RIL_WARNINGTYPE_RESERVED
