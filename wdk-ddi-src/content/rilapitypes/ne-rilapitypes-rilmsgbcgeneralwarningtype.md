...
ms.date: 1/18/2018
ms.keywords: RIL_WARNINGTYPE_TSUNAMI, RILMSGBCGENERALWARNINGTYPE enumeration [Network Drivers Starting with Windows Vista], RIL_WARNINGTYPE_OTHER, netvista.rilmsgbcgeneralwarningtype_2, RIL_WARNINGTYPE_MAX, RIL_WARNINGTYPE_EARTHQUAKETSUNAMI, RIL_WARNINGTYPE_TEST, rilapitypes/RIL_WARNINGTYPE_RESERVED, rilapitypes/RIL_WARNINGTYPE_OTHER, rilapitypes/RILMSGBCGENERALWARNINGTYPE, rilapitypes/RIL_WARNINGTYPE_MAX, RIL_WARNINGTYPE_RESERVED, rilapitypes/RIL_WARNINGTYPE_TEST, rilapitypes/RIL_WARNINGTYPE_EARTHQUAKETSUNAMI, rilapitypes/RIL_WARNINGTYPE_TSUNAMI, RILMSGBCGENERALWARNINGTYPE
