...
title: RILMSGBCGENERALWARNINGTYPE (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILMSGBCGENERALWARNINGTYPE enumeration for internal use only."
...
f1_keywords:
 ...
 - rilapitypes/RILMSGBCGENERALWARNINGTYPE
topic_type:
 - APIRef
 - kbSyntax
api_type:
