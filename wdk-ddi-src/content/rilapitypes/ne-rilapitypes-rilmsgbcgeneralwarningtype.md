...
ms.date: 2/16/2018
ms.keywords: ",  , ,, A, B, C, E, G, I, L, M, N, P, R, RILMSGBCGENERALWARNINGTYPE, RILMSGBCGENERALWARNINGTYPE enumeration [Network Drivers Starting with Windows Vista], RIL_WARNINGTYPE_EARTHQUAKETSUNAMI, RIL_WARNINGTYPE_MAX, RIL_WARNINGTYPE_OTHER, RIL_WARNINGTYPE_RESERVED, RIL_WARNINGTYPE_TEST, RIL_WARNINGTYPE_TSUNAMI, S, T, W, Y, netvista.rilmsgbcgeneralwarningtype_2, rilapitypes/RILMSGBCGENERALWARNINGTYPE, rilapitypes/RIL_WARNINGTYPE_EARTHQUAKETSUNAMI, rilapitypes/RIL_WARNINGTYPE_MAX, rilapitypes/RIL_WARNINGTYPE_OTHER, rilapitypes/RIL_WARNINGTYPE_RESERVED, rilapitypes/RIL_WARNINGTYPE_TEST, rilapitypes/RIL_WARNINGTYPE_TSUNAMI"
