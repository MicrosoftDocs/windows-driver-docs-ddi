...
title: RILUICCFILEPATH (rilapitypes.h)
description: "Don't use this structure in your code. Microsoft reserves the RILUICCFILEPATH structure for internal use only."
...
f1_keywords:
 - RILUICCFILEPATH
 - rilapitypes/RILUICCFILEPATH
 - LPRILUICCFILEPATH
 - rilapitypes/LPRILUICCFILEPATH
topic_type:
 - APIRef
 - kbSyntax
api_type:
