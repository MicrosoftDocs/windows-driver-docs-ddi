...
title: RILCONFPARTICIPANTSTATUS (rilapitypes.h)
description: "Microsoft reserves the RILCONFPARTICIPANTSTATUS structure for internal use only. Don't use this structure in your code."
