...
title: RILIMSNWENABLEDFLAGS (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILIMSNWENABLEDFLAGS enumeration for internal use only."
...
# RILIMSNWENABLEDFLAGS enumeration (rilapitypes.h)
