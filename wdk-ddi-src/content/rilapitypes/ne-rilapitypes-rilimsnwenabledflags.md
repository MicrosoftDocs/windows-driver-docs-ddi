...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_IMS_NW_ENABLED_FLAG_VOICE, RIL_IMS_NW_ENABLED_FLAG_VOICE, RIL_IMS_NW_ENABLED_FLAG_PROVISION, rilapitypes/RIL_IMS_NW_ENABLED_FLAG_PROVISION, RIL_IMS_NW_ENABLED_FLAG_EAB, netvista.rilimsnwenabledflags_2, RIL_IMS_NW_ENABLED_FLAG_ALL, RILIMSNWENABLEDFLAGS, rilapitypes/RILIMSNWENABLEDFLAGS, rilapitypes/RIL_IMS_NW_ENABLED_FLAG_VIDEO, rilapitypes/RIL_IMS_NW_ENABLED_FLAG_ALL, RIL_IMS_NW_ENABLED_FLAG_VIDEO, RILIMSNWENABLEDFLAGS enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_IMS_NW_ENABLED_FLAG_EAB
