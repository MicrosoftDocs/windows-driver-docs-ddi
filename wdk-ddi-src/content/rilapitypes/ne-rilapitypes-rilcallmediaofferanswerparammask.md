...
title: RILCALLMEDIAOFFERANSWERPARAMMASK (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILCALLMEDIAOFFERANSWERPARAMMASK enumeration for internal use only."
