...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_ENUM_MANUAL_ECALL, rilapitypes/RIL_ENUM_ALL, RIL_ENUM_ALL, RIL_ENUM_MANUAL_ECALL, RILEMERGENCYNUMBERCATEGORY, rilapitypes/RIL_ENUM_AMBULANCE, rilapitypes/RIL_ENUM_MARINE_GUARD, RIL_ENUM_FIRE_BRIGADE, RIL_ENUM_MOUNTAIN_RESCUE, RIL_ENUM_AMBULANCE, rilapitypes/RIL_ENUM_AUTO_ECALL, RILEMERGENCYNUMBERCATEGORY enumeration [Network Drivers Starting with Windows Vista], netvista.rilemergencynumbercategory_2, rilapitypes/RILEMERGENCYNUMBERCATEGORY, rilapitypes/RIL_ENUM_MOUNTAIN_RESCUE, RIL_ENUM_AUTO_ECALL, RIL_ENUM_MARINE_GUARD, rilapitypes/RIL_ENUM_FIRE_BRIGADE
