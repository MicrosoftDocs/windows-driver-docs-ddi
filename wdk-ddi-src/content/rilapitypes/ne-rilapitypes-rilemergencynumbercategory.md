...
title: RILEMERGENCYNUMBERCATEGORY (rilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILEMERGENCYNUMBERCATEGORY enumeration for internal use only."
