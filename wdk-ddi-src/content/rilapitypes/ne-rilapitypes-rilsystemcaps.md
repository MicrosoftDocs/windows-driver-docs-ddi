...
ms.date: 2/16/2018
ms.keywords: ",  , ,, A, C, E, I, L, M, P, R, RILSYSTEMCAPS, RILSYSTEMCAPS enumeration [Network Drivers Starting with Windows Vista], RIL_SYSTEMCAPS_ALL, RIL_SYSTEMCAPS_VOICEDATA, S, T, Y, netvista.rilsystemcaps_2, rilapitypes/RILSYSTEMCAPS, rilapitypes/RIL_SYSTEMCAPS_ALL, rilapitypes/RIL_SYSTEMCAPS_VOICEDATA"
