...
description: "Microsoft reserves the RILWRITEADDITIONALNUMBERSTRINGPARAMS structure for internal use only. Don't use this structure in your code."
...
f1_keywords:
 ...
 - rilapitypes/LPRILWRITEADDITIONALNUMBERSTRINGPARAMS
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# RILWRITEADDITIONALNUMBERSTRINGPARAMS structure (rilapitypes.h)
