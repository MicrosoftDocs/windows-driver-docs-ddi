...
ms.date: 2/16/2018
ms.keywords: rilapitypes/RIL_DISCREASON_EMERGENCYFAILOVER, RILCALLINFODISCONNECTREASON enumeration [Network Drivers Starting with Windows Vista], RIL_DISCREASON_EMERGENCYONLY, rilapitypes/RIL_DISCREASON_BUSY, rilapitypes/RIL_DISCREASON_NOSERVICE, RIL_DISCREASON_EMERGENCYFAILOVER, rilapitypes/RIL_DISCREASON_RADIOFADE, rilapitypes/RIL_DISCREASON_CONGESTION, RIL_DISCREASON_NETWORKERROR, RILCALLINFODISCONNECTREASON, rilapitypes/RIL_DISCREASON_EMERGENCYONLY, rilapitypes/RIL_DISCREASON_HANDOVER_MERGE, RIL_DISCREASON_BUSY, netvista.rilcallinfodisconnectreason_2, RIL_DISCREASON_OTHEREXECUTORBUSY, RIL_DISCREASON_HANDOVER_MERGE, RIL_DISCREASON_RADIOFADE, rilapitypes/RIL_DISCREASON_NETWORKERROR, rilapitypes/RIL_DISCREASON_MAX, RIL_DISCREASON_MAX, RIL_DISCREASON_CONGESTION, RIL_DISCREASON_NOSERVICE, rilapitypes/RIL_DISCREASON_OTHEREXECUTORBUSY, rilapitypes/RILCALLINFODISCONNECTREASON
