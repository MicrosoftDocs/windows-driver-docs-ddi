...
ms.date: 1/18/2018
ms.keywords: RILCALLINFODISCONNECTREASON, rilapitypes/RIL_DISCREASON_EMERGENCYFAILOVER, rilapitypes/RIL_DISCREASON_NETWORKERROR, RIL_DISCREASON_NETWORKERROR, RIL_DISCREASON_OTHEREXECUTORBUSY, rilapitypes/RIL_DISCREASON_EMERGENCYONLY, RIL_DISCREASON_CONGESTION, rilapitypes/RIL_DISCREASON_BUSY, rilapitypes/RIL_DISCREASON_MAX, rilapitypes/RILCALLINFODISCONNECTREASON, RILCALLINFODISCONNECTREASON enumeration [Network Drivers Starting with Windows Vista], RIL_DISCREASON_EMERGENCYONLY, rilapitypes/RIL_DISCREASON_CONGESTION, RIL_DISCREASON_RADIOFADE, rilapitypes/RIL_DISCREASON_OTHEREXECUTORBUSY, rilapitypes/RIL_DISCREASON_RADIOFADE, RIL_DISCREASON_EMERGENCYFAILOVER, netvista.rilcallinfodisconnectreason_2, RIL_DISCREASON_MAX, rilapitypes/RIL_DISCREASON_NOSERVICE, RIL_DISCREASON_HANDOVER_MERGE, rilapitypes/RIL_DISCREASON_HANDOVER_MERGE, RIL_DISCREASON_NOSERVICE, RIL_DISCREASON_BUSY
