...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_DISCREASON_HANDOVER_MERGE, rilapitypes/RIL_DISCREASON_EMERGENCYONLY, rilapitypes/RIL_DISCREASON_RADIOFADE, RIL_DISCREASON_EMERGENCYFAILOVER, RIL_DISCREASON_BUSY, RIL_DISCREASON_OTHEREXECUTORBUSY, RIL_DISCREASON_NETWORKERROR, RIL_DISCREASON_CONGESTION, rilapitypes/RIL_DISCREASON_OTHEREXECUTORBUSY, rilapitypes/RIL_DISCREASON_MAX, netvista.rilcallinfodisconnectreason_2, rilapitypes/RIL_DISCREASON_EMERGENCYFAILOVER, rilapitypes/RIL_DISCREASON_CONGESTION, RIL_DISCREASON_EMERGENCYONLY, RIL_DISCREASON_RADIOFADE, RIL_DISCREASON_HANDOVER_MERGE, RILCALLINFODISCONNECTREASON enumeration [Network Drivers Starting with Windows Vista], RILCALLINFODISCONNECTREASON, rilapitypes/RIL_DISCREASON_NETWORKERROR, RIL_DISCREASON_NOSERVICE, RIL_DISCREASON_MAX, rilapitypes/RILCALLINFODISCONNECTREASON, rilapitypes/RIL_DISCREASON_BUSY, rilapitypes/RIL_DISCREASON_NOSERVICE
