...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_DISCREASON_OTHEREXECUTORBUSY, RIL_DISCREASON_BUSY, RIL_DISCREASON_MAX, RIL_DISCREASON_RADIOFADE, rilapitypes/RIL_DISCREASON_MAX, RIL_DISCREASON_HANDOVER_MERGE, RIL_DISCREASON_NETWORKERROR, rilapitypes/RIL_DISCREASON_RADIOFADE, RIL_DISCREASON_OTHEREXECUTORBUSY, RILCALLINFODISCONNECTREASON, rilapitypes/RILCALLINFODISCONNECTREASON, RIL_DISCREASON_NOSERVICE, netvista.rilcallinfodisconnectreason_2, RILCALLINFODISCONNECTREASON enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_DISCREASON_NETWORKERROR, rilapitypes/RIL_DISCREASON_CONGESTION, rilapitypes/RIL_DISCREASON_EMERGENCYFAILOVER, RIL_DISCREASON_EMERGENCYFAILOVER, rilapitypes/RIL_DISCREASON_BUSY, rilapitypes/RIL_DISCREASON_NOSERVICE, rilapitypes/RIL_DISCREASON_HANDOVER_MERGE, RIL_DISCREASON_CONGESTION, rilapitypes/RIL_DISCREASON_EMERGENCYONLY, RIL_DISCREASON_EMERGENCYONLY
