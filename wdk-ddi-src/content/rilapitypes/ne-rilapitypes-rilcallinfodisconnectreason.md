...
ms.date: 1/18/2018
ms.keywords: RILCALLINFODISCONNECTREASON, rilapitypes/RIL_DISCREASON_MAX, rilapitypes/RIL_DISCREASON_HANDOVER_MERGE, rilapitypes/RIL_DISCREASON_OTHEREXECUTORBUSY, RIL_DISCREASON_CONGESTION, RIL_DISCREASON_EMERGENCYFAILOVER, rilapitypes/RIL_DISCREASON_EMERGENCYONLY, rilapitypes/RILCALLINFODISCONNECTREASON, rilapitypes/RIL_DISCREASON_BUSY, rilapitypes/RIL_DISCREASON_RADIOFADE, netvista.rilcallinfodisconnectreason_2, RIL_DISCREASON_OTHEREXECUTORBUSY, RIL_DISCREASON_BUSY, RILCALLINFODISCONNECTREASON enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_DISCREASON_NOSERVICE, rilapitypes/RIL_DISCREASON_CONGESTION, rilapitypes/RIL_DISCREASON_EMERGENCYFAILOVER, RIL_DISCREASON_MAX, RIL_DISCREASON_HANDOVER_MERGE, RIL_DISCREASON_EMERGENCYONLY, RIL_DISCREASON_NOSERVICE, RIL_DISCREASON_RADIOFADE, rilapitypes/RIL_DISCREASON_NETWORKERROR, RIL_DISCREASON_NETWORKERROR
