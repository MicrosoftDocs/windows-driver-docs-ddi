...
ms.date: 1/18/2018
ms.keywords: RIL_DISCREASON_HANDOVER_MERGE, RIL_DISCREASON_EMERGENCYFAILOVER, rilapitypes/RILCALLINFODISCONNECTREASON, RIL_DISCREASON_RADIOFADE, rilapitypes/RIL_DISCREASON_NOSERVICE, RIL_DISCREASON_NETWORKERROR, rilapitypes/RIL_DISCREASON_MAX, RIL_DISCREASON_CONGESTION, RIL_DISCREASON_OTHEREXECUTORBUSY, rilapitypes/RIL_DISCREASON_EMERGENCYFAILOVER, rilapitypes/RIL_DISCREASON_NETWORKERROR, rilapitypes/RIL_DISCREASON_HANDOVER_MERGE, rilapitypes/RIL_DISCREASON_RADIOFADE, RILCALLINFODISCONNECTREASON, rilapitypes/RIL_DISCREASON_OTHEREXECUTORBUSY, RIL_DISCREASON_EMERGENCYONLY, RIL_DISCREASON_MAX, RIL_DISCREASON_NOSERVICE, RILCALLINFODISCONNECTREASON enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_DISCREASON_CONGESTION, rilapitypes/RIL_DISCREASON_BUSY, rilapitypes/RIL_DISCREASON_EMERGENCYONLY, RIL_DISCREASON_BUSY, netvista.rilcallinfodisconnectreason_2
