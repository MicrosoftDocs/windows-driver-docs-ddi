...
ms.date: 1/18/2018
ms.keywords: netvista.rilcallrttcap_2, RILCALLRTTCAP, *LPRILCALLRTTCAP, RILCALLRTTCAP structure [Network Drivers Starting with Windows Vista], rilapitypes/RILCALLRTTCAP
