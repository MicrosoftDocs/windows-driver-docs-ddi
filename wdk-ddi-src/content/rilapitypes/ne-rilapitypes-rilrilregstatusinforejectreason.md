...
ms.date: 1/18/2018
ms.keywords: rilapitypes/RIL_REGREJECTREASON_SVCOPT_OUTOFORDER, RIL_REGREJECTREASON_CSG_NOTAUTHORIZED, RIL_REGREJECTREASON_ILLEGAL_MS, rilapitypes/RIL_REGREJECTREASON_GSMAUTH_NOTACCEPTED, rilapitypes/RIL_REGREJECTREASON_IMSI_NOTACCEPTED, RIL_REGREJECTREASON_ILLEGAL_ME, RIL_REGREJECTREASON_IMSIUNK_VLR, RILRILREGSTATUSINFOREJECTREASON, netvista.rilrilregstatusinforejectreason_2, RIL_REGREJECTREASON_PLMN_NOTALLOWED, rilapitypes/RIL_REGREJECTREASON_LOCAREA_NOTALLOWED, RIL_REGREJECTREASON_CONGESTION, rilapitypes/RIL_REGREJECTREASON_CSG_NOTAUTHORIZED, RIL_REGREJECTREASON_REQSVCOPT_NOTSUBSCRIBED, RIL_REGREJECTREASON_SYNCHFAILURE, rilapitypes/RIL_REGREJECTREASON_SYNCHFAILURE, RIL_REGREJECTREASON_MACFAILURE, rilapitypes/RIL_REGREJECTREASON_NOSUITABLECELL, RIL_REGREJECTREASON_LOCAREA_NOTALLOWED, RIL_REGREJECTREASON_SVCOPT_NOTSUPPORTED, rilapitypes/RIL_REGREJECTREASON_ROAMING_NOTALLOWED, RIL_REGREJECTREASON_NOSUITABLECELL, rilapitypes/RILRILREGSTATUSINFOREJECTREASON, RIL_REGREJECTREASON_GSMAUTH_NOTACCEPTED, RIL_REGREJECTREASON_IMSI_NOTACCEPTED, rilapitypes/RIL_REGREJECTREASON_ILLEGAL_MS, rilapitypes/RIL_REGREJECTREASON_REQSVCOPT_NOTSUBSCRIBED, rilapitypes/RIL_REGREJECTREASON_MACFAILURE, rilapitypes/RIL_REGREJECTREASON_SVCOPT_NOTSUPPORTED, RIL_REGREJECTREASON_IMSIUNK_HLR, RIL_REGREJECTREASON_NETWORKFAILURE, rilapitypes/RIL_REGREJECTREASON_CONGESTION, rilapitypes/RIL_REGREJECTREASON_PLMN_NOTALLOWED, rilapitypes/RIL_REGREJECTREASON_IMSIUNK_VLR, RIL_REGREJECTREASON_ROAMING_NOTALLOWED, RIL_REGREJECTREASON_SVCOPT_OUTOFORDER, RILRILREGSTATUSINFOREJECTREASON enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_REGREJECTREASON_IMSIUNK_HLR, rilapitypes/RIL_REGREJECTREASON_ILLEGAL_ME, rilapitypes/RIL_REGREJECTREASON_NETWORKFAILURE
