...
ms.date: 12/14/2017
ms.keywords: IKeywordDetectorOemAdapter::BuildArmingPatternData, BuildArmingPatternData method [Audio Devices], BuildArmingPatternData, IKeywordDetectorOemAdapter, audio.ikeyworddetectoroemadapter_buildarmingpatterndata, BuildArmingPatternData method [Audio Devices], IKeywordDetectorOemAdapter interface, IKeywordDetectorOemAdapter interface [Audio Devices], BuildArmingPatternData method, keyworddetectoroemadapter/IKeywordDetectorOemAdapter::BuildArmingPatternData
