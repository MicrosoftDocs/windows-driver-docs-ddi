...
in Windows 10 and later versions of Windows.
 ...
 compute or parse the opaque data that is written and read to the audio driver through <a href="/windows-hardware/drivers/audio/ksproperty-sounddetector-patterns">KSPROPERTY_SOUNDDETECTOR_PATTERNS</a> and
...
returned by the <a href="/windows-hardware/drivers/audio/ksproperty-sounddetector-supportedpatterns">KSPROPERTY_SOUNDDETECTOR_SUPPORTEDPATTERNS</a>. The operating system calls <a href="/windows/win32/api/combaseapi/nf-combaseapi-cocreateinstance">CoCreateInstance</a> passing the pattern type GUID to instantiate the appropriate COM object that is compatible with keyword pattern type and calls methods on the object’s <b>IKeywordDetectorOemAdapter</b> interface.
