...
ms.date: 12/14/2017
ms.keywords: GetCapabilities method [Audio Devices], IKeywordDetectorOemAdapter interface, keyworddetectoroemadapter/IKeywordDetectorOemAdapter::GetCapabilities, IKeywordDetectorOemAdapter, IKeywordDetectorOemAdapter interface [Audio Devices], GetCapabilities method, GetCapabilities, audio.ikeyworddetectoroemadapter_getcapabilities, IKeywordDetectorOemAdapter::GetCapabilities, GetCapabilities method [Audio Devices]
