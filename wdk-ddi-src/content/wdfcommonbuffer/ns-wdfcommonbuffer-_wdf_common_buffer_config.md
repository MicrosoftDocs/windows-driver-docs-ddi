...
tech.root: wdf
ms.date: 02/26/2018
keywords: ["WDF_COMMON_BUFFER_CONFIG structure"]
...
f1_keywords:
 ...
 - wdfcommonbuffer/_WDF_COMMON_BUFFER_CONFIG
 - PWDF_COMMON_BUFFER_CONFIG
 - wdfcommonbuffer/PWDF_COMMON_BUFFER_CONFIG
 - WDF_COMMON_BUFFER_CONFIG
...
The <b>WDF_COMMON_BUFFER_CONFIG</b> structure is used as input to the <a href="/windows-hardware/drivers/ddi/wdfcommonbuffer/nf-wdfcommonbuffer-wdfcommonbuffercreatewithconfig">WdfCommonBufferCreateWithConfig</a> method.
...
For more information about specifying alignment requirements, see <a href="/windows-hardware/drivers/wdf/enabling-dma-transactions">Enabling DMA Transactions</a> and <a href="/windows-hardware/drivers/wdf/using-common-buffers">Using Common Buffers</a>.
