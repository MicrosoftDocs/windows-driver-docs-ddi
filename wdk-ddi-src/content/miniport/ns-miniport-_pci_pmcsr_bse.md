...
description: The _PCI_PMCSR_BSE structure (miniport.h) describes the contents of the power management control status register for PCI bridge support extensions.
...
f1_keywords:
 - _PCI_PMCSR_BSE
 - miniport/_PCI_PMCSR_BSE
 - PPCI_PMCSR_BSE
 - miniport/PPCI_PMCSR_BSE
 - PCI_PMCSR_BSE
 - miniport/PCI_PMCSR_BSE
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# PCI_PMCSR_BSE structure (miniport.h)
