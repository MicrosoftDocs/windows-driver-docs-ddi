...
title: _PCI_EXPRESS_CORRECTABLE_ERROR_STATUS (miniport.h)
description: The _PCI_EXPRESS_CORRECTABLE_ERROR_STATUS structure (miniport.h) describes a PCI Express (PCIe) correctable error status register for advanced error reporting.
...
# _PCI_EXPRESS_CORRECTABLE_ERROR_STATUS structure (miniport.h)
