...
description: The WRITE_PORT_BUFFER_USHORT function (miniport.h) writes a number of USHORT values from a buffer to the specified port address.
...
f1_keywords:
 ...
 - miniport/WRITE_PORT_BUFFER_USHORT
topic_type:
 - APIRef
 - kbSyntax
api_type:
