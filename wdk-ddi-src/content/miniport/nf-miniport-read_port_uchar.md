...
title: READ_PORT_UCHAR function (miniport.h)
description: The READ_PORT_UCHAR function (miniport.h) returns a byte that is read from the specified port address in resident, mapped device memory.
