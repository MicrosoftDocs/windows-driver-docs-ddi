...
ms.date: 2/16/2018
ms.keywords: READ_PORT_BUFFER_UCHAR routine [Kernel-Mode Driver Architecture], kernel.read_port_buffer_uchar, wdm/READ_PORT_BUFFER_UCHAR, READ_PORT_BUFFER_UCHAR, k103_020afa73-5210-42d8-a2a5-dc9ac663af2c.xml
