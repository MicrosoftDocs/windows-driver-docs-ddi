...
title: WRITE_REGISTER_BUFFER_USHORT function (miniport.h)
description: The WRITE_REGISTER_BUFFER_USHORT function (miniport.h) writes a number of USHORT values from a buffer to the specified register.
