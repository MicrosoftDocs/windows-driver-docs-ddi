...
description: The _PCI_EXPRESS_SEC_UNCORRECTABLE_ERROR_STATUS structure (miniport.h) describes a PCI Express (PCIe) secondary uncorrectable error status register.
