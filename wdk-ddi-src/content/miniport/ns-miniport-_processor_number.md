...
description: The _PROCESSOR_NUMBER structure (miniport.h) identifies a processor by its group number and group-relative processor number.
...
# PROCESSOR_NUMBER structure (miniport.h)
