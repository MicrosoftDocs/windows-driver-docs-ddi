...
description: The READ_REGISTER_BUFFER_ULONG function (miniport.h) reads a number of ULONG values from the specified register address into a buffer.
...
f1_keywords:
 ...
 - miniport/READ_REGISTER_BUFFER_ULONG
topic_type:
 - APIRef
 - kbSyntax
api_type:
