...
title: PCI_EXPRESS_AER_CAPABILITY (miniport.h)
description: The _PCI_EXPRESS_AER_CAPABILITY structure (miniport.h) describes a PCI Express (PCIe) advanced error reporting capability structure.
...
# PCI_EXPRESS_AER_CAPABILITY structure (miniport.h)
...
PCIe bridge devices use the [**PCI_EXPRESS_BRIDGE_AER_CAPABILITY**](../wdm/ns-wdm-_pci_express_bridge_aer_capability.md) structure instead of the PCI_EXPRESS_AER_CAPABILITY structure to describe the PCIe advanced error reporting capability structure.

Root ports and root complex event collectors use the [**PCI_EXPRESS_ROOTPORT_AER_CAPABILITY**](../wdm/ns-wdm-_pci_express_rootport_aer_capability.md) structure instead of the PCI_EXPRESS_AER_CAPABILITY structure to describe the PCIe advanced error reporting capability structure.
