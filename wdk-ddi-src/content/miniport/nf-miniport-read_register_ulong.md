...
title: READ_REGISTER_ULONG function (miniport.h)
description: The READ_REGISTER_ULONG function (miniport.h) returns a ULONG value read from the specified register address in resident, mapped device memory.
