...
A pointer to a PVOID value. If (**Destination*) = <i>Comparand</i>, then the routine sets (**Destination*) to <i>Exchange</i>.
...
<p>Specifies the PVOID value to compare with (**Destination*).</p>
