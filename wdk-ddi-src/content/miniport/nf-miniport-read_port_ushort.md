...
description: The READ_PORT_USHORT function (miniport.h) returns a USHORT value that is read from the specified port address in resident, mapped device memory.
