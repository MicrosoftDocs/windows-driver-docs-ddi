...
description: The _PCI_EXPRESS_LINK_CONTROL_REGISTER structure (miniport.h) describes a PCI Express (PCIe) link control register of a PCIe capability structure.
...
# _PCI_EXPRESS_LINK_CONTROL_REGISTER structure (miniport.h)
