...
description: The _INTERFACE_TYPE enumeration (miniport.h) defines values that indicate the type of bus driver that published the interface.
old-location: kernel\interface_type.htm
tech.root: kernel
ms.date: 04/30/2018
keywords: ["INTERFACE_TYPE enumeration"]
...
f1_keywords:
 - _INTERFACE_TYPE
 - miniport/_INTERFACE_TYPE
 - PINTERFACE_TYPE
 - miniport/PINTERFACE_TYPE
 - INTERFACE_TYPE
 - miniport/INTERFACE_TYPE
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# INTERFACE_TYPE enumeration (miniport.h)
...
<a href="/windows-hardware/drivers/ddi/strmini/ns-strmini-_port_configuration_information">PORT_CONFIGURATION_INFORMATION</a>
