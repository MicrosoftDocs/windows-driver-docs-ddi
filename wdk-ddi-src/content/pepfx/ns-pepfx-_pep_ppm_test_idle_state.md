...
ms.date: 1/4/2018
ms.keywords: PPEP_PPM_TEST_IDLE_STATE, kernel.pep_ppm_test_idle_state, PPEP_PPM_TEST_IDLE_STATE structure pointer [Kernel-Mode Driver Architecture], PEP_PPM_TEST_IDLE_STATE, _PEP_PPM_TEST_IDLE_STATE, pepfx/PPEP_PPM_TEST_IDLE_STATE, PEP_PPM_TEST_IDLE_STATE structure [Kernel-Mode Driver Architecture], pepfx/PEP_PPM_TEST_IDLE_STATE, *PPEP_PPM_TEST_IDLE_STATE
