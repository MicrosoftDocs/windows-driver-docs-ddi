...
ms.date: 2/16/2018
ms.keywords: PPEP_DEVICE_STARTED structure pointer [Kernel-Mode Driver Architecture], *PPEP_DEVICE_STARTED, pepfx/PPEP_DEVICE_STARTED, _PEP_DEVICE_STARTED, pepfx/PEP_DEVICE_STARTED, PPEP_DEVICE_STARTED, PEP_DEVICE_STARTED, PEP_DEVICE_STARTED structure [Kernel-Mode Driver Architecture], kernel.pep_device_started
