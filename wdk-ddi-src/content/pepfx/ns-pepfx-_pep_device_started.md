...
ms.date: 2/16/2018
ms.keywords: pepfx/PPEP_DEVICE_STARTED, _PEP_DEVICE_STARTED, *PPEP_DEVICE_STARTED, PEP_DEVICE_STARTED structure [Kernel-Mode Driver Architecture], pepfx/PEP_DEVICE_STARTED, kernel.pep_device_started, PPEP_DEVICE_STARTED structure pointer [Kernel-Mode Driver Architecture], PEP_DEVICE_STARTED, PPEP_DEVICE_STARTED
