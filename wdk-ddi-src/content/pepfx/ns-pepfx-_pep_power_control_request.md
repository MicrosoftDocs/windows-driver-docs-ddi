...
ms.date: 2/16/2018
ms.keywords: kernel.pep_power_control_request, PPEP_POWER_CONTROL_REQUEST, _PEP_POWER_CONTROL_REQUEST, *PPEP_POWER_CONTROL_REQUEST, pepfx/PPEP_POWER_CONTROL_REQUEST, PPEP_POWER_CONTROL_REQUEST structure pointer [Kernel-Mode Driver Architecture], pepfx/PEP_POWER_CONTROL_REQUEST, PEP_POWER_CONTROL_REQUEST structure [Kernel-Mode Driver Architecture], PEP_POWER_CONTROL_REQUEST
