...
ms.date: 2/16/2018
ms.keywords: PEP_PREPARE_DEVICE structure [Kernel-Mode Driver Architecture], PPEP_PREPARE_DEVICE structure pointer [Kernel-Mode Driver Architecture], *PPEP_PREPARE_DEVICE, PEP_PREPARE_DEVICE, kernel.pep_prepare_device, _PEP_PREPARE_DEVICE, pepfx/PPEP_PREPARE_DEVICE, PPEP_PREPARE_DEVICE, pepfx/PEP_PREPARE_DEVICE
