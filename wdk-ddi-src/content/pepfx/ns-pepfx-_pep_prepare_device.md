...
ms.date: 1/4/2018
ms.keywords: PEP_PREPARE_DEVICE structure [Kernel-Mode Driver Architecture], pepfx/PEP_PREPARE_DEVICE, pepfx/PPEP_PREPARE_DEVICE, PPEP_PREPARE_DEVICE structure pointer [Kernel-Mode Driver Architecture], *PPEP_PREPARE_DEVICE, _PEP_PREPARE_DEVICE, PPEP_PREPARE_DEVICE, PEP_PREPARE_DEVICE, kernel.pep_prepare_device
