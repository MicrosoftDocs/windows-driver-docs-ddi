...
ms.date: 1/4/2018
ms.keywords: PERFORMANCE_LIMIT_THERMAL, PEP_PPM_PERF_CONSTRAINTS, PEP_PPM_PERF_CONSTRAINTS structure [Kernel-Mode Driver Architecture], PERFORMANCE_LIMIT_POWER, kernel.pep_ppm_perf_constraints, _PEP_PPM_QUERY_PERF_CONSTRAINTS, *PPEP_PPM_PERF_CONSTRAINTS, PPEP_PPM_PERF_CONSTRAINTS structure pointer [Kernel-Mode Driver Architecture], pepfx/PPEP_PPM_PERF_CONSTRAINTS, PERFORMANCE_LIMIT_DOMAIN_DEPENDENCY, PPEP_PPM_PERF_CONSTRAINTS, pepfx/PEP_PPM_PERF_CONSTRAINTS
