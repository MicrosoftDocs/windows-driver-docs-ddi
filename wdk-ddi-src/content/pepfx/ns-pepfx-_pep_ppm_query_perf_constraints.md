...
ms.date: 2/16/2018
ms.keywords: "_PEP_PPM_QUERY_PERF_CONSTRAINTS, kernel.pep_ppm_perf_constraints, PPEP_PPM_PERF_CONSTRAINTS structure pointer [Kernel-Mode Driver Architecture], pepfx/PEP_PPM_PERF_CONSTRAINTS, PERFORMANCE_LIMIT_THERMAL, pepfx/PPEP_PPM_PERF_CONSTRAINTS, PERFORMANCE_LIMIT_POWER, PEP_PPM_PERF_CONSTRAINTS, *PPEP_PPM_PERF_CONSTRAINTS, PERFORMANCE_LIMIT_DOMAIN_DEPENDENCY, PPEP_PPM_PERF_CONSTRAINTS, PEP_PPM_PERF_CONSTRAINTS structure [Kernel-Mode Driver Architecture]"
