...
ms.date: 2/16/2018
ms.keywords: PPEP_DEVICE_REGISTER_V2, PPEP_DEVICE_REGISTER_V2 structure pointer [Kernel-Mode Driver Architecture], pepfx/PPEP_DEVICE_REGISTER_V2, _PEP_DEVICE_REGISTER_V2, *PPEP_DEVICE_REGISTER, *PPEP_DEVICE_REGISTER_V2, PEP_DEVICE_REGISTER, pepfx/PEP_DEVICE_REGISTER_V2, PEP_DEVICE_REGISTER_V2, PEP_DEVICE_REGISTER_V2 structure [Kernel-Mode Driver Architecture], kernel.pep_device_register_v2
