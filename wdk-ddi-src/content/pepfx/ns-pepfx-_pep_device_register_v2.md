...
ms.date: 1/4/2018
ms.keywords: PPEP_DEVICE_REGISTER_V2, *PPEP_DEVICE_REGISTER, pepfx/PPEP_DEVICE_REGISTER_V2, kernel.pep_device_register_v2, PPEP_DEVICE_REGISTER_V2 structure pointer [Kernel-Mode Driver Architecture], _PEP_DEVICE_REGISTER_V2, PEP_DEVICE_REGISTER_V2, PEP_DEVICE_REGISTER, PEP_DEVICE_REGISTER_V2 structure [Kernel-Mode Driver Architecture], pepfx/PEP_DEVICE_REGISTER_V2, *PPEP_DEVICE_REGISTER_V2
