...
ms.date: 1/4/2018
ms.keywords: pepfx/PEP_ACPI_RESOURCE, kernel.pep_acpi_resource, PPEP_ACPI_RESOURCE union pointer [Kernel-Mode Driver Architecture], PEP_ACPI_RESOURCE union [Kernel-Mode Driver Architecture], pepfx/PPEP_ACPI_RESOURCE, PEP_ACPI_RESOURCE, _PEP_ACPI_RESOURCE, *PPEP_ACPI_RESOURCE, PPEP_ACPI_RESOURCE
