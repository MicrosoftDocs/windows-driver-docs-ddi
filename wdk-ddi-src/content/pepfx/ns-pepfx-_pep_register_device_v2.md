...
ms.date: 2/16/2018
ms.keywords: PEP_REGISTER_DEVICE_V2 structure [Kernel-Mode Driver Architecture], PPEP_REGISTER_DEVICE_V2 structure pointer [Kernel-Mode Driver Architecture], _PEP_REGISTER_DEVICE_V2, pepfx/PPEP_REGISTER_DEVICE_V2, *PPEP_REGISTER_DEVICE, kernel.pep_register_device_v2, *PPEP_REGISTER_DEVICE_V2, PEP_REGISTER_DEVICE_V2, PEP_REGISTER_DEVICE, PPEP_REGISTER_DEVICE_V2, pepfx/PEP_REGISTER_DEVICE_V2
