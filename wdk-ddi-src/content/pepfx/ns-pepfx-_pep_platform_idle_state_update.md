...
ms.date: 1/4/2018
ms.keywords: PPEP_PLATFORM_IDLE_STATE_UPDATE structure pointer [Kernel-Mode Driver Architecture], PPEP_PLATFORM_IDLE_STATE_UPDATE, pepfx/PEP_PLATFORM_IDLE_STATE_UPDATE, pepfx/PPEP_PLATFORM_IDLE_STATE_UPDATE, kernel.pep_platform_idle_state_update, PEP_PLATFORM_IDLE_STATE_UPDATE, PEP_PLATFORM_IDLE_STATE_UPDATE structure [Kernel-Mode Driver Architecture], *PPEP_PLATFORM_IDLE_STATE_UPDATE, _PEP_PLATFORM_IDLE_STATE_UPDATE
