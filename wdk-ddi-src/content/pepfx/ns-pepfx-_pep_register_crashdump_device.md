...
ms.date: 1/4/2018
ms.keywords: pepfx/PPEP_REGISTER_CRASHDUMP_DEVICE, _PEP_REGISTER_CRASHDUMP_DEVICE, PPEP_REGISTER_CRASHDUMP_DEVICE structure pointer [Kernel-Mode Driver Architecture], *PPEP_REGISTER_CRASHDUMP_DEVICE, pepfx/PEP_REGISTER_CRASHDUMP_DEVICE, kernel.pep_register_crashdump_device, PPEP_REGISTER_CRASHDUMP_DEVICE, PEP_REGISTER_CRASHDUMP_DEVICE structure [Kernel-Mode Driver Architecture], PEP_REGISTER_CRASHDUMP_DEVICE
