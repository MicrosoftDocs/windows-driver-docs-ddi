...
ms.date: 1/4/2018
ms.keywords: "*PPEP_PPM_IDLE_EXECUTE, _PEP_PPM_IDLE_EXECUTE, pepfx/PPEP_PPM_IDLE_EXECUTE, PPEP_PPM_IDLE_EXECUTE, PEP_PPM_IDLE_EXECUTE structure [Kernel-Mode Driver Architecture], PPEP_PPM_IDLE_EXECUTE structure pointer [Kernel-Mode Driver Architecture], kernel.pep_ppm_idle_execute, pepfx/PEP_PPM_IDLE_EXECUTE, PEP_PPM_IDLE_EXECUTE"
