...
ms.date: 1/4/2018
ms.keywords: PEP_PROCESSOR_PARK_STATE structure [Kernel-Mode Driver Architecture], *PPEP_PROCESSOR_PARK_STATE, PEP_PROCESSOR_PARK_STATE, pepfx/PPEP_PROCESSOR_PARK_STATE, _PEP_PROCESSOR_PARK_STATE, PPEP_PROCESSOR_PARK_STATE structure pointer [Kernel-Mode Driver Architecture], PPEP_PROCESSOR_PARK_STATE, pepfx/PEP_PROCESSOR_PARK_STATE, kernel.pep_processor_park_state
