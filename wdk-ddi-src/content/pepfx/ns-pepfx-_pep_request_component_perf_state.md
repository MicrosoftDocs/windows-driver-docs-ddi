...
A pointer to an array of [PEP_COMPONENT_PERF_STATE_REQUEST](./ns-pepfx-_pep_component_perf_state_request.md) structures. Each element in the array specifies a new performance level to assign to a P-state set. The number of array elements is specified by the **PerfRequestsCount** member.
