...
ms.date: 2/16/2018
ms.keywords: PEP_COMPONENT_PERF_SET, pepfx/PPEP_COMPONENT_PERF_SET, _PEP_COMPONENT_PERF_SET, pepfx/PEP_COMPONENT_PERF_SET, PPEP_COMPONENT_PERF_SET, *PPEP_COMPONENT_PERF_SET, PPEP_COMPONENT_PERF_SET structure pointer [Kernel-Mode Driver Architecture], kernel.pep_component_perf_set, PEP_COMPONENT_PERF_SET structure [Kernel-Mode Driver Architecture]
