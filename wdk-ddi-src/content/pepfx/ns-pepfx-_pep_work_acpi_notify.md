...
ms.date: 2/16/2018
ms.keywords: PEP_WORK_ACPI_NOTIFY, _PEP_WORK_ACPI_NOTIFY, PPEP_WORK_ACPI_NOTIFY, *PPEP_WORK_ACPI_NOTIFY, kernel.pep_work_acpi_notify, PPEP_WORK_ACPI_NOTIFY structure pointer [Kernel-Mode Driver Architecture], pepfx/PEP_WORK_ACPI_NOTIFY, PEP_WORK_ACPI_NOTIFY structure [Kernel-Mode Driver Architecture], pepfx/PPEP_WORK_ACPI_NOTIFY
