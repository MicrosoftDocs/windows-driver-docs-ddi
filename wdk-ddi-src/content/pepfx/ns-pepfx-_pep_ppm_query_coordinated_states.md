...
ms.date: 1/4/2018
ms.keywords: _PEP_PPM_QUERY_COORDINATED_STATES, *PPEP_PPM_QUERY_COORDINATED_STATES, PEP_PPM_QUERY_COORDINATED_STATES
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: PEP_PPM_QUERY_COORDINATED_STATES
req.alt-loc: pepfx.h
req.ddi-compliance: 
req.unicode-ansi: 
req.idl: 
