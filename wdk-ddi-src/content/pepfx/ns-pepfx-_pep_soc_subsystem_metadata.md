...
ms.date: 2/16/2018
ms.keywords: pepfx/PEP_SOC_SUBSYSTEM_METADATA, *PPEP_SOC_SUBSYSTEM_METADATA, PEP_SOC_SUBSYSTEM_METADATA, kernel.pep_soc_subsystem_metadata, PEP_SOC_SUBSYSTEM_METADATA structure [Kernel-Mode Driver Architecture], pepfx/PPEP_SOC_SUBSYSTEM_METADATA, _PEP_SOC_SUBSYSTEM_METADATA, PPEP_SOC_SUBSYSTEM_METADATA structure pointer [Kernel-Mode Driver Architecture], PPEP_SOC_SUBSYSTEM_METADATA
