---
UID: NF:dbgmodel.IDebugHostModule3.GetBaseLocation
tech.root: debugger
title: IDebugHostModule3::GetBaseLocation
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostModule3::GetBaseLocation method, when called on a module, gets the base loading address of the module as a location structure.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostModule3::GetBaseLocation
 - dbgmodel/IDebugHostModule3::GetBaseLocation
dev_langs:
 - c++
helpviewer_keywords:
 - GetBaseLocation
