...
title: IDebugHostSymbol2::GetType (dbgmodel.h)
description: "The IDebugHostSymbol2::GetType method, when called on a symbol, gets the type of symbol, such as int *."
ms.date: 09/21/2018
keywords: ["IDebugHostSymbol2::GetType"]
...
f1_keywords:
 ...
 - dbgmodel/IDebugHostSymbol2::GetType
topic_type:
 - apiref
api_type:
 - COM
