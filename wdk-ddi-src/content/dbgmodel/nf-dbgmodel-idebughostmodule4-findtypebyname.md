---
UID: NF:dbgmodel.IDebugHostModule4.FindTypeByName
tech.root: debugger
title: IDebugHostModule4::FindTypeByName
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostModule4::FindTypeByName method, when called on a module, finds a type by type name from within the module and retrieves a type symbol for it.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostModule4::FindTypeByName
 - dbgmodel/IDebugHostModule4::FindTypeByName
dev_langs:
 - c++
helpviewer_keywords:
 - FindTypeByName
...
# IDebugHostModule4::FindTypeByName function (dbgmodel.h)
