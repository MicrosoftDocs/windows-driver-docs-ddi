...
title: IDebugHostModule::GetContext (dbgmodel.h)
description: "The IDebugHostModule::GetContext method, when called on a symbol, gets the host context in which the symbol is located."
ms.date: 09/18/2018
