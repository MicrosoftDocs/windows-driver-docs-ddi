---
UID: NF:dbgmodel.IDebugHostModule5.GetImageName
tech.root: debugger
title: IDebugHostModule5::GetImageName
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostModule5::GetImageName method gets the image name or full path of the module as an allocated string.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostModule5::GetImageName
 - dbgmodel/IDebugHostModule5::GetImageName
dev_langs:
 - c++
helpviewer_keywords:
 - GetImageName
...
# IDebugHostModule5::GetImageName function (dbgmodel.h)
