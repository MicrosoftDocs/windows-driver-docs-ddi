---
UID: NF:dbgmodel.IDebugHostMemory5.WriteBytes
tech.root: debugger
title: IDebugHostMemory5::WriteBytes
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostMemory5::WriteBytes method writes a number of bytes to the address space of the target for a given context and location.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostMemory5::WriteBytes
 - dbgmodel/IDebugHostMemory5::WriteBytes
dev_langs:
 - c++
helpviewer_keywords:
 - WriteBytes
...
# IDebugHostMemory5::WriteBytes function (dbgmodel.h)
