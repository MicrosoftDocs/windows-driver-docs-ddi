...
description: "The IDebugHostField::GetContext method, when called on a symbol, gets the host context in which the symbol is located."
ms.date: 09/12/2018
keywords: ["IDebugHostField::GetContext"]
...
f1_keywords:
 ...
 - dbgmodel/IDebugHostField::GetContext
topic_type:
 - apiref
api_type:
 - COM
