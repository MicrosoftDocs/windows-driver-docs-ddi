---
UID: NF:dbgmodel.IDebugHostMemory4.WriteBytes
tech.root: debugger
title: IDebugHostMemory4::WriteBytes
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostMemory4::WriteBytes method writes a number of bytes to the address space of the target for a given context and location.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostMemory4::WriteBytes
 - dbgmodel/IDebugHostMemory4::WriteBytes
dev_langs:
 - c++
helpviewer_keywords:
 - WriteBytes
