---
UID: NF:dbgmodel.IDebugHostModule3.FindSymbolByName
tech.root: debugger
title: IDebugHostModule3::FindSymbolByName
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostModule3::FindSymbolByName method, when called on a module, retrieves a global symbol by name from within the module.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostModule3::FindSymbolByName
 - dbgmodel/IDebugHostModule3::FindSymbolByName
dev_langs:
 - c++
helpviewer_keywords:
 - FindSymbolByName
...
# IDebugHostModule3::FindSymbolByName function (dbgmodel.h)
