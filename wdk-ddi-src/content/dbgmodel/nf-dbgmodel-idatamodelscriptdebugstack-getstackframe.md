...
### -param frameNumber
The index of the stack frame within this stack segment to retrieve. This index is zero based. The top frame representing the current point where the debugger broke is frame 0. It's caller is frame 1 (and so forth).
