---
UID: NF:dbgmodel.IDebugHostModule3.EnumerateChildren
tech.root: debugger
title: IDebugHostModule3::EnumerateChildren
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostModule3::EnumerateChildren method gets an enumerator capable of enumerating all children of a given symbol.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostModule3::EnumerateChildren
 - dbgmodel/IDebugHostModule3::EnumerateChildren
dev_langs:
 - c++
helpviewer_keywords:
 - EnumerateChildren
...
# IDebugHostModule3::EnumerateChildren function (dbgmodel.h)
