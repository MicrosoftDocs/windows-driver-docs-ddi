---
UID: NF:dbgmodel.IDebugHostModule5.FindSymbolByRVA
tech.root: debugger
title: IDebugHostModule5::FindSymbolByRVA
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostModule5::FindSymbolByRVA method, when called on a module, retrieves a symbol at a given relative virtual address within the module.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostModule5::FindSymbolByRVA
 - dbgmodel/IDebugHostModule5::FindSymbolByRVA
dev_langs:
 - c++
helpviewer_keywords:
 - FindSymbolByRVA
...
# IDebugHostModule5::FindSymbolByRVA function (dbgmodel.h)
