...
title: IDataModelScriptDebugBreakpointEnumerator::Release (dbgmodel.h)
description: "The IDataModelScriptDebugBreakpointEnumerator::Release method decrements the reference count for an interface on an object."
ms.date: 09/10/2018
