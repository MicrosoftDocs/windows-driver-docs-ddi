---
UID: NF:dbgmodel.IDebugHostMemory3.WritePointers
tech.root: debugger
title: IDebugHostMemory3::WritePointers
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostMemory3::WritePointers method writes a number of pointers into the address space of the target.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostMemory3::WritePointers
 - dbgmodel/IDebugHostMemory3::WritePointers
dev_langs:
 - c++
helpviewer_keywords:
 - WritePointers
...
# IDebugHostMemory3::WritePointers function (dbgmodel.h)
