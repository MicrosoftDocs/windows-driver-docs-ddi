---
UID: NF:dbgmodel.IDebugHostModule3.FindSymbolByRVA
tech.root: debugger
title: IDebugHostModule3::FindSymbolByRVA
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostModule3::FindSymbolByRVA method, when called on a module, retrieves a symbol at a given relative virtual address within the module.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostModule3::FindSymbolByRVA
 - dbgmodel/IDebugHostModule3::FindSymbolByRVA
dev_langs:
 - c++
helpviewer_keywords:
 - FindSymbolByRVA
...
# IDebugHostModule3::FindSymbolByRVA function (dbgmodel.h)
