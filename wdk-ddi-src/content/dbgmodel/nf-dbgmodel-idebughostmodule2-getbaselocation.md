...
title: IDebugHostModule2::GetBaseLocation (dbgmodel.h)
description: "The IDebugHostModule2::GetBaseLocation method, when called on a module, gets the base loading address of the module as a location structure."
ms.date: 09/18/2018
