---
UID: NF:dbgmodel.IDebugHostMemory4.WritePointers
tech.root: debugger
title: IDebugHostMemory4::WritePointers
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostMemory4::WritePointers method writes a number of pointers into the address space of the target.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostMemory4::WritePointers
 - dbgmodel/IDebugHostMemory4::WritePointers
dev_langs:
 - c++
helpviewer_keywords:
 - WritePointers
