---
UID: NF:dbgmodel.IDebugHostType3.GetBitField
tech.root: debugger
title: IDebugHostType3::GetBitField
ms.date: 01/26/2025
targetos: Windows
description: The GetBitField method, when called on a type for a bitmap, gets information about the bitmap structure.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostType3::GetBitField
 - dbgmodel/IDebugHostType3::GetBitField
dev_langs:
 - c++
helpviewer_keywords:
 - GetBitField
