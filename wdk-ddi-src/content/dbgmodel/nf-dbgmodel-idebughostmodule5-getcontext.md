---
UID: NF:dbgmodel.IDebugHostModule5.GetContext
tech.root: debugger
title: IDebugHostModule5::GetContext
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostModule5::GetContext method, when called on a symbol, gets the host context in which the symbol is located.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostModule5::GetContext
 - dbgmodel/IDebugHostModule5::GetContext
dev_langs:
 - c++
helpviewer_keywords:
 - GetContext
...
# IDebugHostModule5::GetContext function (dbgmodel.h)
