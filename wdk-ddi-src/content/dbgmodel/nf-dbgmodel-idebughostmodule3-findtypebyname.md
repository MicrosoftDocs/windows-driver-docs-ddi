---
UID: NF:dbgmodel.IDebugHostModule3.FindTypeByName
tech.root: debugger
title: IDebugHostModule3::FindTypeByName
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostModule3::FindTypeByName method, when called on a module, finds a type by type name from within the module and retrieves a type symbol for it.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostModule3::FindTypeByName
 - dbgmodel/IDebugHostModule3::FindTypeByName
dev_langs:
 - c++
helpviewer_keywords:
 - FindTypeByName
...
# IDebugHostModule3::FindTypeByName function (dbgmodel.h)
