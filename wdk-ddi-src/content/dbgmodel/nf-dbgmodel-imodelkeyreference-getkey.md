...
description: "The IModelKeyReference::GetKey method, when called on a key reference, gets the value of the underlying key and any metadata associated with the key."
ms.date: 08/14/2018
keywords: ["IModelKeyReference::GetKey"]
