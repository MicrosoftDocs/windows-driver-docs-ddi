---
UID: NF:dbgmodel.IDebugHostModule4.GetContext
tech.root: debugger
title: IDebugHostModule4::GetContext
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostModule4::GetContext method, when called on a symbol, gets the host context in which the symbol is located.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostModule4::GetContext
 - dbgmodel/IDebugHostModule4::GetContext
dev_langs:
 - c++
helpviewer_keywords:
 - GetContext
...
# IDebugHostModule4::GetContext function (dbgmodel.h)
