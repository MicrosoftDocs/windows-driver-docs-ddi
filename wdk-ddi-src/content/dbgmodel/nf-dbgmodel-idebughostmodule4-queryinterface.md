---
UID: NF:dbgmodel.IDebugHostModule4.QueryInterface
tech.root: debugger
title: IDebugHostModule4::QueryInterface
ms.date: 02/24/2025
targetos: Windows
description: The QueryInterface method retrieves a pointer to the specified interface on an object.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostModule4::QueryInterface
 - dbgmodel/IDebugHostModule4::QueryInterface
dev_langs:
 - c++
helpviewer_keywords:
 - QueryInterface
