---
UID: NF:dbgmodel.IDebugHostModule5.EnumerateChildren
tech.root: debugger
title: IDebugHostModule5::EnumerateChildren
ms.date: 02/24/2025
targetos: Windows
description: The IDebugHostModule5::EnumerateChildren method gets an enumerator capable of enumerating all children of a given symbol.
prerelease: false
req.assembly: 
...
f1_keywords:
 - IDebugHostModule5::EnumerateChildren
 - dbgmodel/IDebugHostModule5::EnumerateChildren
dev_langs:
 - c++
helpviewer_keywords:
 - EnumerateChildren
...
# IDebugHostModule5::EnumerateChildren function (dbgmodel.h)
