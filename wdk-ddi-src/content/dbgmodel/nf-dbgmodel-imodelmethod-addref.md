...
title: IModelMethod::AddRef (dbgmodel.h)
description: "The IModelMethod::AddRef method increments the reference count for an interface on an object."
ms.date: 08/13/2018
keywords: ["IModelMethod::AddRef"]
