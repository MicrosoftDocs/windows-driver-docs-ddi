---
UID: NF:dbgmodel.IDebugHostMemory4.IsPhysicalAddressLocation
tech.root: debugger
title: IDebugHostMemory4::IsPhysicalAddressLocation
ms.date: 02/24/2025
targetos: Windows
...
f1_keywords:
 - IDebugHostMemory4::IsPhysicalAddressLocation
 - dbgmodel/IDebugHostMemory4::IsPhysicalAddressLocation
dev_langs:
 - c++
helpviewer_keywords:
...
# IDebugHostMemory4::IsPhysicalAddressLocation function (dbgmodel.h)
