...
title: IDataModelNameBinder::AddRef (dbgmodel.h)
description: "The IDataModelNameBinder::AddRef method increments the reference count for an interface on an object."
ms.date: 09/21/2018
