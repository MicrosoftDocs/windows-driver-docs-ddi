...
req.alt-api:
req.alt-loc:
req.typenames: *PNET_REQUEST_QUEUE_METHOD_HANDLER, NET_REQUEST_QUEUE_METHOD_HANDLER
topictype: 
-	apiref
apitype: 
-	HeaderDef
...
## -remarks
The minimum NetAdapterCx version for **NET_REQUEST_QUEUE_METHOD_HANDLER** is 1.0.
