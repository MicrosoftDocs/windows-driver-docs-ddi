...
req.alt-api:
req.alt-loc:
req.typenames: *PNET_REQUEST_QUEUE_SET_DATA_HANDLER, NET_REQUEST_QUEUE_SET_DATA_HANDLER
topictype: 
-	apiref
apitype: 
-	HeaderDef
...
## -remarks
The minimum NetAdapterCx version for **NET_REQUEST_QUEUE_SET_DATA_HANDLER** is 1.0.
