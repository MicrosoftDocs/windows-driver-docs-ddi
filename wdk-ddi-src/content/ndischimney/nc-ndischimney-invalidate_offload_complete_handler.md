...
f1_keywords:
 ...
 - ndischimney/INVALIDATE_OFFLOAD_COMPLETE_HANDLER
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
NDIS calls a protocol driver's or intermediate driver's 
  ...
  <a href="/windows-hardware/drivers/ddi/ndischimney/nf-ndischimney-ndisinvalidateoffload">NdisInvalidateOffload</a> function.
