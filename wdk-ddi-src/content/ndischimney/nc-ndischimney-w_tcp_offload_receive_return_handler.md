...
ms.topic: callback
f1_keywords:
 - "ndischimney/MiniportTcpOffloadReceiveReturn"
...
NDIS calls the 
  ...
  <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/ndis/ns-ndis-_net_buffer_list">NET_BUFFER_LIST</a> and associated structures to
  an offload target.
