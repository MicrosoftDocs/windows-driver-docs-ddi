...
f1_keywords:
 - _SERIAL_CHARS
 - ntddser/_SERIAL_CHARS
 - PSERIAL_CHARS
 - ntddser/PSERIAL_CHARS
 - SERIAL_CHARS
...
This structure is used by the <a href="/windows-hardware/drivers/ddi/ntddser/ni-ntddser-ioctl_serial_set_chars">IOCTL_SERIAL_SET_CHARS</a> and <a href="/windows-hardware/drivers/ddi/ntddser/ni-ntddser-ioctl_serial_get_chars">IOCTL_SERIAL_GET_CHARS</a> requests.
