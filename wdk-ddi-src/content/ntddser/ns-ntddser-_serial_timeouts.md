...
ms.date: 12/14/2017
ms.keywords: PSERIAL_TIMEOUTS, SERIAL_TIMEOUTS, serports.serial_timeouts, *PSERIAL_TIMEOUTS, _SERIAL_TIMEOUTS, ntddser/SERIAL_TIMEOUTS, PSERIAL_TIMEOUTS structure pointer [Serial Ports], SERIAL_TIMEOUTS structure [Serial Ports], ntddser/PSERIAL_TIMEOUTS
