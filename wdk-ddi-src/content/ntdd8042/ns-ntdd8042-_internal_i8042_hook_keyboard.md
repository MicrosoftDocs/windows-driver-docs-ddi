...
ms.date: 04/30/2018
keywords: ["INTERNAL_I8042_HOOK_KEYBOARD structure"]
...
f1_keywords:
 - _INTERNAL_I8042_HOOK_KEYBOARD
 - ntdd8042/_INTERNAL_I8042_HOOK_KEYBOARD
 - PINTERNAL_I8042_HOOK_KEYBOARD
 - ntdd8042/PINTERNAL_I8042_HOOK_KEYBOARD
...
Pointer, if non-<b>NULL</b>, to an optional <a href="/windows-hardware/drivers/ddi/ntdd8042/nc-ntdd8042-pi8042_keyboard_initialization_routine">PI8042_KEYBOARD_INITIALIZATION_ROUTINE</a>callback. I8042prt uses this callback to initialize a device after the device is reset. Otherwise, <b>IntializatonRoutine</b> is <b>NULL</b>.

### -field IsrRoutine

Pointer, if non-<b>NULL</b>, to an optional <a href="/windows-hardware/drivers/ddi/ntdd8042/nc-ntdd8042-pi8042_keyboard_isr">PI8042_KEYBOARD_ISR</a> callback that customizes the operation of the I8042prt keyboard ISR. Otherwise, <b>IsrRoutine </b>is <b>NULL</b>.

### -field IsrWritePort

Pointer to the system-supplied <a href="/windows-hardware/drivers/ddi/ntdd8042/nc-ntdd8042-pi8042_isr_write_port">PI8042_ISR_WRITE_PORT</a> callback, which writes data to a keyboard.

### -field QueueKeyboardPacket

Pointer to the system-supplied <a href="/windows-hardware/drivers/ddi/ntdd8042/nc-ntdd8042-pi8042_queue_packet">PI8042_QUEUE_PACKET</a> callback, which queues a keyboard input data packet for processing by the keyboard's ISR deferred procedure call.
...
This structure is only used with an <a href="/windows-hardware/drivers/ddi/ntdd8042/ni-ntdd8042-ioctl_internal_i8042_hook_keyboard">IOCTL_INTERNAL_I8042_HOOK_KEYBOARD</a> request. 
...
<a href="/previous-versions/ff542293(v=vs.85)">KbFilter_InitializationRoutine</a>
