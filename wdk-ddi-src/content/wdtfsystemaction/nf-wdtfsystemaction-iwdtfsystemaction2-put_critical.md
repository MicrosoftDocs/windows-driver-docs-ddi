...
description: Sets or gets a value that indicates whether the system power state is critical.
old-location: dtf\iwdtfsystemaction2_critical.htm
tech.root: dtf
ms.date: 04/04/2018
keywords: ["IWDTFSystemAction2::put_Critical"]
...
f1_keywords:
 ...
 - wdtfsystemaction/IWDTFSystemAction2::put_Critical
topic_type:
 - APIRef
 - kbSyntax
api_type:
