...
ms.date: 1/10/2018
ms.keywords: ntddcdrm/PCDROM_WRITE_SPEED_REQUEST, PCDROM_WRITE_SPEED_REQUEST structure pointer [Storage Devices], CDROM_WRITE_SPEED_REQUEST, ntddcdrm/CDROM_WRITE_SPEED_REQUEST, _CDROM_WRITE_SPEED_REQUEST, storage.cdrom_write_speed_request, CDROM_WRITE_SPEED_REQUEST structure [Storage Devices], *PCDROM_WRITE_SPEED_REQUEST, PCDROM_WRITE_SPEED_REQUEST
