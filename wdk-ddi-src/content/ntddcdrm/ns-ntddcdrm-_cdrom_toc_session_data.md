...
Device control IRPs with a control code of <a href="/windows-hardware/drivers/ddi/ntddcdrm/ni-ntddcdrm-ioctl_cdrom_read_toc_ex">IOCTL_CDROM_READ_TOC_EX</a> and a format of CDROM_READ_TOC_EX_FORMAT_SESSION return their output data in this structure followed by a series of <a href="/windows-hardware/drivers/ddi/ntddcdrm/ns-ntddcdrm-_track_data">TRACK_DATA</a> structures.
