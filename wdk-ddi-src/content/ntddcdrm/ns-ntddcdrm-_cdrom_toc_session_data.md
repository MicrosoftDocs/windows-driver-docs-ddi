...
ms.date: 1/10/2018
ms.keywords: PCDROM_TOC_SESSION_DATA, CDROM_TOC_SESSION_DATA structure [Storage Devices], _CDROM_TOC_SESSION_DATA, CDROM_TOC_SESSION_DATA, storage.cdrom_toc_session_data, PCDROM_TOC_SESSION_DATA structure pointer [Storage Devices], *PCDROM_TOC_SESSION_DATA, ntddcdrm/CDROM_TOC_SESSION_DATA, structs-CD-ROM_b3bb7380-ca50-4340-bf90-4b6e231bcdbc.xml, ntddcdrm/PCDROM_TOC_SESSION_DATA
...
<a href="mailto:wsddocfb@microsoft.com?subject=Documentation%20feedback [storage\storage]:%20CDROM_TOC_SESSION_DATA structure%20 RELEASE:%20(1/10/2018)&amp;body=%0A%0APRIVACY STATEMENT%0A%0AWe use your feedback to improve the documentation. We don't use your email address for any other purpose, and we'll remove your email address from our system after the issue that you're reporting is fixed. While we're working to fix this issue, we might send you an email message to ask for more info. Later, we might also send you an email message to let you know that we've addressed your feedback.%0A%0AFor more info about Microsoft's privacy policy, see http://privacy.microsoft.com/en-us/default.aspx." title="Send comments about this topic to Microsoft">Send comments about this topic to Microsoft</a>
