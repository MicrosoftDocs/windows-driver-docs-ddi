...
f1_keywords:
 ...
 - ntddcdrm/_CDROM_STREAMING_CONTROL
...
The <b>CDROM_STREAMING_CONTROL</b> structure is used as an input parameter to the <a href="/windows-hardware/drivers/ddi/ntddcdrm/ni-ntddcdrm-ioctl_cdrom_enable_streaming">IOCTL_CDROM_ENABLE_STREAMING</a> IOCTL.

## -struct-fields

### -field RequestType

The <a href="/windows-hardware/drivers/ddi/ntddcdrm/ne-ntddcdrm-_streaming_control_request_type">STREAMING_CONTROL_REQUEST_TYPE</a>   enumeration specifies the type of request.
