...
tech.root: storage
ms.date: 03/29/2018
keywords: ["STREAMING_CONTROL_REQUEST_TYPE enumeration"]
...
f1_keywords:
 ...
 - ntddcdrm/_STREAMING_CONTROL_REQUEST_TYPE
 - PSTREAMING_CONTROL_REQUEST_TYPE
 - ntddcdrm/PSTREAMING_CONTROL_REQUEST_TYPE
...
The STREAMING_CONTROL_REQUEST_TYPE enumeration defines the CDROM streaming modes. This enumeration is a member of the <a href="/windows-hardware/drivers/ddi/ntddcdrm/ns-ntddcdrm-_cdrom_streaming_control">CDROM_STREAMING_CONTROL</a> structure, the input parameter to the <a href="/windows-hardware/drivers/ddi/ntddcdrm/ni-ntddcdrm-ioctl_cdrom_enable_streaming">IOCTL_CDROM_ENABLE_STREAMING</a> I/O control code, which is used to enable or disable CDROM streaming.
