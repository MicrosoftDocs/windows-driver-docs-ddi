...
ms.date: 12/14/2017
ms.keywords: SPB_TRANSFER_LIST_ENTRY_INIT_MDL, spb/SPB_TRANSFER_LIST_ENTRY_INIT_MDL, SPB_TRANSFER_LIST_ENTRY_INIT_MDL function [Buses], SPB.spb_transfer_list_entry_init_mdl
