...
# SPB_MULTI_SPI_WRITE_TRANSFER_INIT function (spb.h)

## -description

The **SPB_MULTI_SPI_WRITE_TRANSFER_INIT** function initializes an [SPB_MULTI_SPI_WRITE_TRANSFER](./ns-spb-spb_multi_spi_write_transfer.md) structure.
