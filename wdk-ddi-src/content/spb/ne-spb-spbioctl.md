...
ms.date: 2/15/2018
ms.keywords: spb/IOCTL_SPB_LOCK_CONNECTION, IOCTL_SPB_LOCK_CONTROLLER, *PSpbIoctl, SPB.spbioctl, IOCTL_SPB_UNLOCK_CONTROLLER, IOCTL_SPB_UNLOCK_CONNECTION, spb/*PSpbIoctl, IOCTL_SPB_EXECUTE_SEQUENCE, SpbIoctl enumeration [Buses], spb/IOCTL_SPB_UNLOCK_CONNECTION, *PSpbIoctl enumeration [Buses], spb/IOCTL_SPB_FULL_DUPLEX, IOCTL_SPB_FULL_DUPLEX, SpbIoctl, spb/SpbIoctl, spb/IOCTL_SPB_LOCK_CONTROLLER, spb/IOCTL_SPB_EXECUTE_SEQUENCE, IOCTL_SPB_LOCK_CONNECTION, spb/IOCTL_SPB_UNLOCK_CONTROLLER
