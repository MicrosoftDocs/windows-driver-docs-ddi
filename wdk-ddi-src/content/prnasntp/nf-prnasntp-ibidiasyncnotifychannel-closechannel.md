...
ms.date: 2/21/2018
ms.keywords: CloseChannel method [Print Devices], CloseChannel method [Print Devices], IBidiAsyncNotifyChannel interface, IBidiAsyncNotifyChannel interface [Print Devices], CloseChannel method, print.ibidiasyncnotifychannel_closechannel, CloseChannel, IBidiAsyncNotifyChannel::CloseChannel, IBidiAsyncNotifyChannel, prnasntp/IBidiAsyncNotifyChannel::CloseChannel
