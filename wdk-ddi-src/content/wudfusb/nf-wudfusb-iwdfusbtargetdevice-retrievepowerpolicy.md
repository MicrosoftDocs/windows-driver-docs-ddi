...
For information about valid policy types that a UMDF driver can pass for the <i>PolicyType</i> parameter and values that the framework returns, see the <a href="https://docs.microsoft.com/windows/win32/api/winusb/nf-winusb-winusb_getpowerpolicy">WinUsb_GetPowerPolicy</a> function.
...
<a href="https://docs.microsoft.com/windows/win32/api/winusb/nf-winusb-winusb_getpowerpolicy">WinUsb_GetPowerPolicy</a>
