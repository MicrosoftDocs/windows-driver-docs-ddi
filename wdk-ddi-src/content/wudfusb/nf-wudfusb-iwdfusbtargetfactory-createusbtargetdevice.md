...
</dl>This value corresponds to the error code that the <a href="https://msdn.microsoft.com/library/windows/hardware/ff540277">WinUsb_Initialize</a> function returned.
