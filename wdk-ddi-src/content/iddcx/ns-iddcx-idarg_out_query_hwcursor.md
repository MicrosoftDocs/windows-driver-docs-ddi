...
ms.date: 12/29/2017
ms.keywords: IDARG_OUT_QUERY_HWCURSOR structure [Display Devices], display.idarg_out_query_hwcursor, IDARG_OUT_QUERY_HWCURSOR, iddcx/IDARG_OUT_QUERY_HWCURSOR
