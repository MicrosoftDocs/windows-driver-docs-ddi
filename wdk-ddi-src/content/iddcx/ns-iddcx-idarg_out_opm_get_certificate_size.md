...
ms.date: 2/22/2018
ms.keywords: ",  , A, C, D, E, F, G, I, IDARG_OUT_OPM_GET_CERTIFICATE_SIZE, IDARG_OUT_OPM_GET_CERTIFICATE_SIZE structure [Display Devices], M, O, P, R, S, T, U, Z, _, display.idarg_out_opm_get_certificate_size, iddcx/IDARG_OUT_OPM_GET_CERTIFICATE_SIZE"
