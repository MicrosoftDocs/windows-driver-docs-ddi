...
ms.date: 2/20/2018
ms.keywords: IDARG_OUT_OPM_GET_CERTIFICATE_SIZE, IDARG_OUT_OPM_GET_CERTIFICATE_SIZE structure [Display Devices], iddcx/IDARG_OUT_OPM_GET_CERTIFICATE_SIZE, display.idarg_out_opm_get_certificate_size
