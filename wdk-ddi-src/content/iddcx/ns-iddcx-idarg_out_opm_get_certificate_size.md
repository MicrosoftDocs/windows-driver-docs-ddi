...
ms.date: 2/22/2018
ms.keywords: IDARG_OUT_OPM_GET_CERTIFICATE_SIZE structure [Display Devices], display.idarg_out_opm_get_certificate_size, IDARG_OUT_OPM_GET_CERTIFICATE_SIZE, iddcx/IDARG_OUT_OPM_GET_CERTIFICATE_SIZE
