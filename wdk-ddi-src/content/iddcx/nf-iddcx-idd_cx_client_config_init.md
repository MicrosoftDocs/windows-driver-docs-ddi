...
ms.date: 2/24/2018
ms.keywords: ",  , C, D, E, F, G, I, IDD_CX_CLIENT_CONFIG_INIT, IDD_CX_CLIENT_CONFIG_INIT method [Display Devices], L, N, O, T, X, _, display.idd_cx_client_config_init, iddcx/IDD_CX_CLIENT_CONFIG_INIT"
