...
ms.date: 12/29/2017
ms.keywords: IDDCX_ADAPTER_FLAGS, display.iddcx_adapter_flags, IDDCX_ADAPTER_FLAGS_CAN_USE_MOVE_REGIONS, IDDCX_ADAPTER_FLAGS enumeration [Display Devices], iddcx/IDDCX_ADAPTER_FLAGS_NONE, iddcx/IDDCX_ADAPTER_FLAGS_CAN_USE_MOVE_REGIONS, IDDCX_ADAPTER_FLAGS_NONE, iddcx/IDDCX_ADAPTER_FLAGS, iddcx/IDDCX_ADAPTER_FLAGS_USE_SMALLEST_MODE, IDDCX_ADAPTER_FLAGS_USE_SMALLEST_MODE
