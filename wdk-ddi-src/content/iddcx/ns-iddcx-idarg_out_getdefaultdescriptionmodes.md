...
ms.date: 12/29/2017
ms.keywords: iddcx/IDARG_OUT_GETDEFAULTDESCRIPTIONMODES, display.idarg_out_getdefaultdescriptionmodes, IDARG_OUT_GETDEFAULTDESCRIPTIONMODES, IDARG_OUT_GETDEFAULTDESCRIPTIONMODES structure [Display Devices]
