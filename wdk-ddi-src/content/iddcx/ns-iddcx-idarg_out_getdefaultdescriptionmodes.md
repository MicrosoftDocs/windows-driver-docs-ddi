...
### -field DefaultMonitorModeBufferOutputCount
                     ...
                     [out] If the <a href="/windows-hardware/drivers/ddi/iddcx/ns-iddcx-idarg_in_parsemonitordescription">IDARG_IN_PARSEMONITORDESCRIPTION</a> value <b>pDefaultMonitorModes</b> was NULL, then the driver should set this to the number of monitor modes the driver would generate for the specified monitor description.

 If the <a href="/windows-hardware/drivers/ddi/iddcx/ns-iddcx-idarg_in_parsemonitordescription">IDARG_IN_PARSEMONITORDESCRIPTION</a> value <b>pDefaultMonitorModes</b> was non-NULL, then this is the count of the monitor modes that the driver copied to that buffer.
...
<a href="/windows-hardware/drivers/ddi/iddcx/ns-iddcx-idarg_in_parsemonitordescription">IDARG_IN_PARSEMONITORDESCRIPTION</a>