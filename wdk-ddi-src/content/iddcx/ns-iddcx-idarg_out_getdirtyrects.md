...
ms.date: 2/22/2018
ms.keywords: ",  , A, C, D, E, G, I, IDARG_OUT_GETDIRTYRECTS, IDARG_OUT_GETDIRTYRECTS structure [Display Devices], O, R, S, T, U, Y, _, display.idarg_out_getdirtyrects, iddcx/IDARG_OUT_GETDIRTYRECTS"
