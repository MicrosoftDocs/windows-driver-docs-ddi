...
ms.date: 12/29/2017
ms.keywords: IDDCX_OPM_GET_INFO_PARAMETERS, display.iddcx_opm_get_info_parameters, IDDCX_OPM_GET_INFO_PARAMETERS structure [Display Devices], iddcx/IDDCX_OPM_GET_INFO_PARAMETERS
