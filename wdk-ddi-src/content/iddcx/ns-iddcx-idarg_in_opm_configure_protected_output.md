...
ms.date: 2/22/2018
ms.keywords: IDARG_IN_OPM_CONFIGURE_PROTECTED_OUTPUT structure [Display Devices], IDARG_IN_OPM_CONFIGURE_PROTECTED_OUTPUT, display.idarg_in_opm_configure_protected_output, iddcx/IDARG_IN_OPM_CONFIGURE_PROTECTED_OUTPUT
