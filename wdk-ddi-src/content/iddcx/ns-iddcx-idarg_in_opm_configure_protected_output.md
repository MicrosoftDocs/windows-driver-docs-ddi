...
ms.date: 12/29/2017
ms.keywords: IDARG_IN_OPM_CONFIGURE_PROTECTED_OUTPUT structure [Display Devices], iddcx/IDARG_IN_OPM_CONFIGURE_PROTECTED_OUTPUT, display.idarg_in_opm_configure_protected_output, IDARG_IN_OPM_CONFIGURE_PROTECTED_OUTPUT
