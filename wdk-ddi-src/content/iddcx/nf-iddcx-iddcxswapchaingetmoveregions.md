...
ms.date: 12/29/2017
ms.keywords: display.iddcxswapchaingetmoveregions, IddCxSwapChainGetMoveRegions method [Display Devices], iddcx/IddCxSwapChainGetMoveRegions, IddCxSwapChainGetMoveRegions
