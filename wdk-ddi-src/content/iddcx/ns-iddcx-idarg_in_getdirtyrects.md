...
ms.date: 2/24/2018
ms.keywords: ",  , A, C, D, E, G, I, IDARG_IN_GETDIRTYRECTS, IDARG_IN_GETDIRTYRECTS structure [Display Devices], N, R, S, T, Y, _, display.idarg_in_getdirtyrects, iddcx/IDARG_IN_GETDIRTYRECTS"
