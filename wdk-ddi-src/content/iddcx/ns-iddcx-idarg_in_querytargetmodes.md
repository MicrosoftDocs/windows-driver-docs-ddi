...
ms.date: 12/29/2017
ms.keywords: iddcx/IDARG_IN_QUERYTARGETMODES, IDARG_IN_QUERYTARGETMODES, display.idarg_in_querytargetmodes, IDARG_IN_QUERYTARGETMODES structure [Display Devices]
