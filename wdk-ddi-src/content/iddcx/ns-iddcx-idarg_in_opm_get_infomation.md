...
ms.date: 12/29/2017
ms.keywords: display.idarg_in_opm_get_infomation, IDARG_IN_OPM_GET_INFOMATION structure [Display Devices], IDARG_IN_OPM_GET_INFOMATION, iddcx/IDARG_IN_OPM_GET_INFOMATION
