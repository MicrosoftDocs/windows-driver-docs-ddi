...
ms.date: 2/22/2018
ms.keywords: ",  , A, C, D, E, F, G, I, IDARG_IN_OPM_GET_CERTIFICATE, IDARG_IN_OPM_GET_CERTIFICATE structure [Display Devices], M, N, O, P, R, T, _, display.idarg_in_opm_get_certificate, iddcx/IDARG_IN_OPM_GET_CERTIFICATE"
