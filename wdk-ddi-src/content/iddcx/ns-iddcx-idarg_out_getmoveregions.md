...
ms.date: 2/22/2018
ms.keywords: ",  , A, D, E, G, I, IDARG_OUT_GETMOVEREGIONS, IDARG_OUT_GETMOVEREGIONS structure [Display Devices], M, N, O, R, S, T, U, V, _, display.idarg_out_getmoveregions, iddcx/IDARG_OUT_GETMOVEREGIONS"
