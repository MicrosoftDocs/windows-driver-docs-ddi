...
ms.date: 12/29/2017
ms.keywords: iddcx/IDARG_OUT_GETMOVEREGIONS, display.idarg_out_getmoveregions, IDARG_OUT_GETMOVEREGIONS structure [Display Devices], IDARG_OUT_GETMOVEREGIONS
