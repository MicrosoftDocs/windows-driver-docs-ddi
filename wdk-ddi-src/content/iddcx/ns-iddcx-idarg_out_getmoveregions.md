...
ms.date: 2/22/2018
ms.keywords: IDARG_OUT_GETMOVEREGIONS, iddcx/IDARG_OUT_GETMOVEREGIONS, IDARG_OUT_GETMOVEREGIONS structure [Display Devices], display.idarg_out_getmoveregions
