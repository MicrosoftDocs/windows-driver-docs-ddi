...
ms.date: 2/20/2018
ms.keywords: IDARG_OUT_GETMOVEREGIONS, display.idarg_out_getmoveregions, IDARG_OUT_GETMOVEREGIONS structure [Display Devices], iddcx/IDARG_OUT_GETMOVEREGIONS
