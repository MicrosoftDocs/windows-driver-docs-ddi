...
ms.date: 12/29/2017
ms.keywords: display.idarg_out_getmoveregions, iddcx/IDARG_OUT_GETMOVEREGIONS, IDARG_OUT_GETMOVEREGIONS structure [Display Devices], IDARG_OUT_GETMOVEREGIONS
