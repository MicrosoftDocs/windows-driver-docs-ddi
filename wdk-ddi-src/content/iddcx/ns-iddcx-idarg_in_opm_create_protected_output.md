...
ms.date: 2/24/2018
ms.keywords: ",  , A, C, D, E, G, I, IDARG_IN_OPM_CREATE_PROTECTED_OUTPUT, IDARG_IN_OPM_CREATE_PROTECTED_OUTPUT structure [Display Devices], M, N, O, P, R, T, U, _, display.idarg_in_opm_create_protected_output, iddcx/IDARG_IN_OPM_CREATE_PROTECTED_OUTPUT"
