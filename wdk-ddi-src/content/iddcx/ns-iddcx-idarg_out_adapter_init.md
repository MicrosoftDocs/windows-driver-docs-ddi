...
ms.date: 2/22/2018
ms.keywords: ",  , A, D, E, G, I, IDARG_OUT_ADAPTER_INIT, IDARG_OUT_ADAPTER_INIT structure [Display Devices], N, O, P, R, T, U, _, display.idarg_out_adapter_init, iddcx/IDARG_OUT_ADAPTER_INIT"
