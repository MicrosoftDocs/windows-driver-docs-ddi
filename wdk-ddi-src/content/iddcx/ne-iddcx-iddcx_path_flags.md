...
ms.date: 12/29/2017
ms.keywords: IDDCX_PATH_FLAGS enumeration [Display Devices], IDDCX_PATH_FLAGS_ACTIVE, iddcx/IDDCX_PATH_FLAGS_ACTIVE, IDDCX_PATH_FLAGS_CHANGED, IDDCX_PATH_FLAGS_NONE, iddcx/IDDCX_PATH_FLAGS, iddcx/IDDCX_PATH_FLAGS_CHANGED, iddcx/IDDCX_PATH_FLAGS_NONE, IDDCX_PATH_FLAGS, display.iddcx_path_flags
