...
ms.date: 12/29/2017
ms.keywords: iddcx/IDARG_OUT_OPM_GET_RANDOM_NUMBER, IDARG_OUT_OPM_GET_RANDOM_NUMBER structure [Display Devices], IDARG_OUT_OPM_GET_RANDOM_NUMBER, display.idarg_out_opm_get_random_number
