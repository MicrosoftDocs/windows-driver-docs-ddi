...
ms.date: 2/22/2018
ms.keywords: iddcx/IDARG_OUT_QUERYTARGETMODES, display.idarg_out_querytargetmodes, IDARG_OUT_QUERYTARGETMODES structure [Display Devices], IDARG_OUT_QUERYTARGETMODES
