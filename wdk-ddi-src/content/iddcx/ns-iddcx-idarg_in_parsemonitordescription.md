...
ms.date: 2/22/2018
ms.keywords: display.idarg_in_parsemonitordescription, IDARG_IN_PARSEMONITORDESCRIPTION structure [Display Devices], IDARG_IN_PARSEMONITORDESCRIPTION, iddcx/IDARG_IN_PARSEMONITORDESCRIPTION
