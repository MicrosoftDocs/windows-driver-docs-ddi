...
ms.date: 2/22/2018
ms.keywords: display.iddcx_metadata, IDDCX_METADATA structure, IDDCX_METADATA structure [Display Devices], IDDCX_METADATA structure pointer [Display Devices], iddcx/IDDCX_METADATA, IDDCX_METADATA, IDDCX_METADATA structure structure [Display Devices]
