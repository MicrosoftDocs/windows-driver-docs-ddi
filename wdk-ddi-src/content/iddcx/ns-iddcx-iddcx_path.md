...
ms.date: 2/22/2018
ms.keywords: IDDCX_PATH, IDDCX_PATH structure structure [Display Devices], display.iddcx_path, IDDCX_PATH structure, IDDCX_PATH structure [Display Devices], IDDCX_PATH structure pointer [Display Devices], iddcx/IDDCX_PATH
