...
ms.date: 12/29/2017
ms.keywords: IDARG_OUT_OPM_GET_INFOMATION structure [Display Devices], iddcx/IDARG_OUT_OPM_GET_INFOMATION, IDARG_OUT_OPM_GET_INFOMATION, display.idarg_out_opm_get_infomation
