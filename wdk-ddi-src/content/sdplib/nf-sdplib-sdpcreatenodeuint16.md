...
# SdpCreateNodeUInt16 function (sdplib.h)
...
The Bluetooth 
  ...
  <a href="/windows-hardware/drivers/ddi/sdpnode/ns-sdpnode-_sdp_node">SDP_NODE</a> structure to an unsigned 16-bit integer
  type.
