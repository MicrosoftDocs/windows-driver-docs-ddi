...
IOCTL_VIDEO_SET_CHILD_STATE_CONFIGURATION is synchronous. After this IOCTL is sent, <a href="/windows-hardware/drivers/ddi/ntddvdeo/ni-ntddvdeo-ioctl_video_get_child_state">IOCTL_VIDEO_GET_CHILD_STATE</a> should reflect the new state. 
...
<a href="/windows-hardware/drivers/ddi/ntddvdeo/ni-ntddvdeo-ioctl_video_get_child_state">IOCTL_VIDEO_GET_CHILD_STATE</a>
