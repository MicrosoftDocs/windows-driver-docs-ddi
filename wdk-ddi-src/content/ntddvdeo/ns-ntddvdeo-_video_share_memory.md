...
ms.date: 12/29/2017
ms.keywords: display.video_share_memory, _VIDEO_SHARE_MEMORY, ntddvdeo/VIDEO_SHARE_MEMORY, *PVIDEO_SHARE_MEMORY, Video_Structs_11e49bfc-ee25-48cd-9327-f09c6218ed72.xml, PVIDEO_SHARE_MEMORY structure pointer [Display Devices], VIDEO_SHARE_MEMORY, VIDEO_SHARE_MEMORY structure [Display Devices], ntddvdeo/PVIDEO_SHARE_MEMORY, PVIDEO_SHARE_MEMORY
