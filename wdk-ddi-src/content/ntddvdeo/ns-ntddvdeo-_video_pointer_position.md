...
ms.date: 12/29/2017
ms.keywords: VIDEO_POINTER_POSITION, ntddvdeo/PVIDEO_POINTER_POSITION, ntddvdeo/VIDEO_POINTER_POSITION, _VIDEO_POINTER_POSITION, PVIDEO_POINTER_POSITION structure pointer [Display Devices], PVIDEO_POINTER_POSITION, Video_Structs_72aeeda6-58eb-419e-95d2-35c1b66adf36.xml, VIDEO_POINTER_POSITION structure [Display Devices], *PVIDEO_POINTER_POSITION, display.video_pointer_position
