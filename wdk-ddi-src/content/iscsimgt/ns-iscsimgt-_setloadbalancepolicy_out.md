...
ms.date: 1/10/2018
ms.keywords: PSetLoadBalancePolicy_OUT, storage.setloadbalancepolicy_out, structs-iSCSI_32a19db4-8102-4e39-b9be-30a8a03d2732.xml, PSetLoadBalancePolicy_OUT structure pointer [Storage Devices], iscsimgt/PSetLoadBalancePolicy_OUT, SetLoadBalancePolicy_OUT structure [Storage Devices], iscsimgt/SetLoadBalancePolicy_OUT, _SetLoadBalancePolicy_OUT, *PSetLoadBalancePolicy_OUT, SetLoadBalancePolicy_OUT
