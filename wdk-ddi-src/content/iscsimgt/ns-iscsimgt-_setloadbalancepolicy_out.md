...
ms.date: 2/16/2018
ms.keywords: "_SetLoadBalancePolicy_OUT, SetLoadBalancePolicy_OUT, *PSetLoadBalancePolicy_OUT, PSetLoadBalancePolicy_OUT structure pointer [Storage Devices], iscsimgt/SetLoadBalancePolicy_OUT, iscsimgt/PSetLoadBalancePolicy_OUT, PSetLoadBalancePolicy_OUT, SetLoadBalancePolicy_OUT structure [Storage Devices], structs-iSCSI_32a19db4-8102-4e39-b9be-30a8a03d2732.xml, storage.setloadbalancepolicy_out"
