...
ms.date: 12/29/2017
ms.keywords: d3dkmdt/DXGK_BRIGHTNESS_CAPS, _DXGK_BRIGHTNESS_CAPS, DXGK_BRIGHTNESS_CAPS structure [Display Devices], display.dxgk_brightness_caps, DXGK_BRIGHTNESS_CAPS
