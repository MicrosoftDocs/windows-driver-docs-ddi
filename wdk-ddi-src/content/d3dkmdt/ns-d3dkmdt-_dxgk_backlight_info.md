...
ms.date: 2/24/2018
ms.keywords: ",  , ,, A, B, C, D, DXGK_BACKLIGHT_INFO, DXGK_BACKLIGHT_INFO structure [Display Devices], F, G, H, I, K, L, N, O, T, X, _, _DXGK_BACKLIGHT_INFO, d3dkmdt/DXGK_BACKLIGHT_INFO, display.dxgk_backlight_info"
