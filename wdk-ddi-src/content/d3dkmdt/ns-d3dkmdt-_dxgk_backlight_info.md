...
ms.date: 2/22/2018
ms.keywords: DXGK_BACKLIGHT_INFO structure [Display Devices], display.dxgk_backlight_info, d3dkmdt/DXGK_BACKLIGHT_INFO, _DXGK_BACKLIGHT_INFO, DXGK_BACKLIGHT_INFO
