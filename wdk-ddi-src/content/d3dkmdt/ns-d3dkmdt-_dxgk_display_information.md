...
ms.date: 12/29/2017
ms.keywords: display.dxgk_display_information, DXGK_DISPLAY_INFORMATION structure [Display Devices], DXGK_DISPLAY_INFORMATION, d3dkmdt/PDXGK_DISPLAY_INFORMATION, PDXGK_DISPLAY_INFORMATION, d3dkmdt/DXGK_DISPLAY_INFORMATION, _DXGK_DISPLAY_INFORMATION, PDXGK_DISPLAY_INFORMATION structure pointer [Display Devices], *PDXGK_DISPLAY_INFORMATION
