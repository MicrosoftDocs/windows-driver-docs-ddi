...
ms.date: 05/10/2018
keywords: ["_DXGKMDT_OPM_ACTUAL_OUTPUT_FORMAT structure"]
...
A <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dkmdt/ne-d3dkmdt-_dxgkmdt_opm_interleave_format">DXGKMDT_OPM_INTERLEAVE_FORMAT</a>-typed value that specifies how the scan lines in a video frame are ordered.


### -field d3dFormat

A <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dukmdt/ne-d3dukmdt-_d3dddiformat">D3DDDIFORMAT</a>-typed value that identifies the Direct3D surface format of the signal.
...
<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dkmdt/ne-d3dkmdt-_dxgkmdt_opm_interleave_format">DXGKMDT_OPM_INTERLEAVE_FORMAT</a>
