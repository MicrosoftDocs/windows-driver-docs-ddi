...
On output, a value between 1 and 4, inclusive, that corresponds to the <b>OFFSET</b> portion of the <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dkmdt/ne-d3dkmdt-_d3dkmdt_vidpn_present_path_rotation">D3DKMDT_VIDPN_PRESENT_PATH_ROTATION</a> constant values. An output value of 1 (identity) represents 0 degrees of total rotation, 2 represents 90 degrees, and so on. An output value of 0 indicates that the VidPN path is not initialized.

The output value of <i>Rotation</i> is the sum of the output values from the <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dkmdt/nf-d3dkmdt-d3dkmdt_vppr_get_content_rotation_part">D3DKMDT_VPPR_GET_CONTENT_ROTATION_PART</a> and <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dkmdt/nf-d3dkmdt-d3dkmdt_vppr_get_offset_rotation">D3DKMDT_VPPR_GET_OFFSET_ROTATION</a> functions minus 1.
...
<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dkmdt/nf-d3dkmdt-d3dkmdt_vppr_get_content_rotation_part">D3DKMDT_VPPR_GET_CONTENT_ROTATION_PART</a>



<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dkmdt/nf-d3dkmdt-d3dkmdt_vppr_get_offset_rotation">D3DKMDT_VPPR_GET_OFFSET_ROTATION</a>
