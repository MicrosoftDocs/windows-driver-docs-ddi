...
ms.date: 2/22/2018
ms.keywords: d3dkmdt/DXGK_ENGINE_TYPE_SCENE_ASSEMBLY, DXGK_ENGINE_TYPE_VIDEO_PROCESSING, d3dkmdt/DXGK_ENGINE_TYPE_VIDEO_DECODE, DXGK_ENGINE_TYPE_COPY, DXGK_ENGINE_TYPE_OVERLAY, d3dkmdt/DXGK_ENGINE_TYPE, display.dxgk_engine_type, DXGK_ENGINE_TYPE_VIDEO_ENCODE, d3dkmdt/DXGK_ENGINE_TYPE_VIDEO_ENCODE, d3dkmdt/DXGK_ENGINE_TYPE_COPY, d3dkmdt/DXGK_ENGINE_TYPE_OTHER, DXGK_ENGINE_TYPE, DXGK_ENGINE_TYPE_VIDEO_DECODE, DXGK_ENGINE_TYPE_SCENE_ASSEMBLY, d3dkmdt/DXGK_ENGINE_TYPE_VIDEO_PROCESSING, d3dkmdt/DXGK_ENGINE_TYPE_3D, d3dkmdt/DXGK_ENGINE_TYPE_OVERLAY, DXGK_ENGINE_TYPE_3D, DXGK_ENGINE_TYPE_OTHER, DXGK_ENGINE_TYPE enumeration [Display Devices]
