...
A <a href="/windows/win32/api/windef/ns-windef-point">POINT</a> structure that describes the source (<i>x, y</i>) point where the source rectangle is copied from.

### -field DestRect

A <a href="/windows/win32/api/windef/ns-windef-rect">RECT</a> structure that contains the destination rectangle where the dirty rectangle is copied to.
