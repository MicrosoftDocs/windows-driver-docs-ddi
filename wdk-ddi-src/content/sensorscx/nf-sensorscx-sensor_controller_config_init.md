...
ms.date: 2/22/2018
ms.keywords: ",  , C, E, F, G, I, L, N, O, R, S, SENSOR_CONTROLLER_CONFIG_INIT, SENSOR_CONTROLLER_CONFIG_INIT function [Sensor Devices], T, _, sensors.sensor_controller_config_init, sensorscx/SENSOR_CONTROLLER_CONFIG_INIT"
