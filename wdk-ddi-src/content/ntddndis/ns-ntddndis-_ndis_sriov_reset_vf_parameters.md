...
# NDIS_SRIOV_RESET_VF_PARAMETERS structure (ntddndis.h)
...
The type, revision, and size of the <b>NDIS_SRIOV_RESET_VF_PARAMETERS</b> structure. This member is formatted as an <a href="/windows-hardware/drivers/ddi/objectheader/ns-objectheader-ndis_object_header">NDIS_OBJECT_HEADER</a> structure.
...
The <b>NDIS_SRIOV_RESET_VF_PARAMETERS</b> structure is used in OID set requests of <a href="/windows-hardware/drivers/network/oid-sriov-reset-vf">OID_SRIOV_RESET_VF</a>.
