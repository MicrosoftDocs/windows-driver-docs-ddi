...
ms.date: 1/18/2018
ms.keywords: NDIS_ISOLATION_NAME, *PNDIS_ROUTING_DOMAIN_NAME, ntddndis/NDIS_ISOLATION_NAME, *PNDIS_ISOLATION_ID_NAME, netvista.ndis_isolation_name, NDIS_ISOLATION_NAME structure [Network Drivers Starting with Windows Vista], NDIS_ROUTING_DOMAIN_NAME, NDIS_ISOLATION_ID_NAME, _NDIS_ISOLATION_NAME
