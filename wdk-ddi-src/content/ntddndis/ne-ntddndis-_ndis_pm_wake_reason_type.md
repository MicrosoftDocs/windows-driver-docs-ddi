...
ms.date: 2/16/2018
ms.keywords: ntddndis/NdisWakeReasonWwanRegisterState, ntddndis/NdisWakeReasonWwanUSSDReceive, PNDIS_PM_WAKE_REASON_TYPE enumeration pointer [Network Drivers Starting with Windows Vista], ntddndis/NdisWakeReasonWlanGTKHandshakeError, NdisWakeReasonWlanGTKHandshakeError, ntddndis/NdisWakeReasonMediaConnect, NDIS_PM_WAKE_REASON_TYPE enumeration [Network Drivers Starting with Windows Vista], NdisWakeReasonWlanAPAssociationLost, NdisWakeReasonWwanRegisterState, NdisWakeReasonWlan4WayHandshakeRequest, NdisWakeReasonMediaConnect, NDIS_PM_WAKE_REASON_TYPE, ntddndis/NdisWakeReasonWlanAPAssociationLost, ntddndis/NdisWakeReasonWlan4WayHandshakeRequest, ntddndis/PNDIS_PM_WAKE_REASON_TYPE, ntddndis/NDIS_PM_WAKE_REASON_TYPE, netvista.ndis_pm_wake_reason_type, NdisWakeReasonWwanSMSReceive, _NDIS_PM_WAKE_REASON_TYPE, NdisWakeReasonMediaDisconnect, ntddndis/NdisWakeReasonWwanSMSReceive, NdisWakeReasonWwanUSSDReceive, *PNDIS_PM_WAKE_REASON_TYPE, NdisWakeReasonUnspecified, PNDIS_PM_WAKE_REASON_TYPE, NdisWakeReasonWlanNLODiscovery, NdisWakeReasonPacket, ntddndis/NdisWakeReasonUnspecified, ntddndis/NdisWakeReasonMediaDisconnect, ntddndis/NdisWakeReasonWlanNLODiscovery, ntddndis/NdisWakeReasonPacket
