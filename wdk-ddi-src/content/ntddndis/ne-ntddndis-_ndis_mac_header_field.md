...
ms.date: 1/18/2018
ms.keywords: ntddndis/NdisMacHeaderFieldMaximum, NdisMacHeaderFieldSourceAddress, ntddndis/NdisMacHeaderFieldSourceAddress, ntddndis/NdisMacHeaderFieldPriority, PNDIS_MAC_HEADER_FIELD, NdisMacHeaderFieldDestinationAddress, ntddndis/NDIS_MAC_HEADER_FIELD, NdisMacHeaderFieldMaximum, virtual_machine_queue_ref_e521f802-ada1-444a-bf43-63405f40e45a.xml, ntddndis/NdisMacHeaderFieldDestinationAddress, netvista.ndis_mac_header_field, NdisMacHeaderFieldProtocol, ntddndis/NdisMacHeaderFieldPacketType, _NDIS_MAC_HEADER_FIELD, ntddndis/NdisMacHeaderFieldVlanId, NdisMacHeaderFieldPacketType, NdisMacHeaderFieldPriority, *PNDIS_MAC_HEADER_FIELD, ntddndis/PNDIS_MAC_HEADER_FIELD, ntddndis/NdisMacHeaderFieldProtocol, PNDIS_MAC_HEADER_FIELD enumeration pointer [Network Drivers Starting with Windows Vista], NDIS_MAC_HEADER_FIELD enumeration [Network Drivers Starting with Windows Vista], ntddndis/NdisMacHeaderFieldUndefined, NdisMacHeaderFieldUndefined, NDIS_MAC_HEADER_FIELD, NdisMacHeaderFieldVlanId
