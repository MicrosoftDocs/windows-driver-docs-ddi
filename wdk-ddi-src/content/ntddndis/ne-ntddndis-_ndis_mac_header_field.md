...
ms.date: 2/16/2018
ms.keywords: PNDIS_MAC_HEADER_FIELD, ntddndis/NdisMacHeaderFieldSourceAddress, ntddndis/NdisMacHeaderFieldPriority, netvista.ndis_mac_header_field, NdisMacHeaderFieldPacketType, ntddndis/NdisMacHeaderFieldMaximum, ntddndis/PNDIS_MAC_HEADER_FIELD, _NDIS_MAC_HEADER_FIELD, *PNDIS_MAC_HEADER_FIELD, NdisMacHeaderFieldMaximum, ntddndis/NDIS_MAC_HEADER_FIELD, ntddndis/NdisMacHeaderFieldDestinationAddress, ntddndis/NdisMacHeaderFieldPacketType, ntddndis/NdisMacHeaderFieldUndefined, NDIS_MAC_HEADER_FIELD, ntddndis/NdisMacHeaderFieldVlanId, NdisMacHeaderFieldProtocol, PNDIS_MAC_HEADER_FIELD enumeration pointer [Network Drivers Starting with Windows Vista], ntddndis/NdisMacHeaderFieldProtocol, virtual_machine_queue_ref_e521f802-ada1-444a-bf43-63405f40e45a.xml, NdisMacHeaderFieldVlanId, NdisMacHeaderFieldDestinationAddress, NdisMacHeaderFieldUndefined, NdisMacHeaderFieldPriority, NdisMacHeaderFieldSourceAddress, NDIS_MAC_HEADER_FIELD enumeration [Network Drivers Starting with Windows Vista]
