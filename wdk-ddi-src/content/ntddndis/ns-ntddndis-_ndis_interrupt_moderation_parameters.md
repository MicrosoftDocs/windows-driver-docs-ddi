...
##### - InterruptModeration.NdisInterruptModerationDisabled
...
##### - Flags.NDIS_INTERRUPT_MODERATION_CHANGE_NEEDS_REINITIALIZE
...
##### - InterruptModeration.NdisInterruptModerationUnknown
