...
ms.date: 2/16/2018
ms.keywords: ntddndis/NDIS_NDK_CONNECTION_ENTRY, NDIS_NDK_CONNECTION_ENTRY structure [Network Drivers Starting with Windows Vista], PNDIS_NDK_CONNECTION_ENTRY, _NDIS_NDK_CONNECTION_ENTRY, netvista.ndis_ndk_connection_entry, PNDIS_NDK_CONNECTION_ENTRY structure pointer [Network Drivers Starting with Windows Vista], ntddndis/PNDIS_NDK_CONNECTION_ENTRY, NDIS_NDK_CONNECTION_ENTRY
