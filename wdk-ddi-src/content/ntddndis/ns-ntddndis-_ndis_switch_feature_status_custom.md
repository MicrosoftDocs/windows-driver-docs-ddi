...
tech.root: netvista
ms.date: 05/02/2018
keywords: ["NDIS_SWITCH_FEATURE_STATUS_CUSTOM structure"]
...
f1_keywords:
 ...
 - ntddndis/_NDIS_SWITCH_FEATURE_STATUS_CUSTOM
 - PNDIS_SWITCH_FEATURE_STATUS_CUSTOM
 - ntddndis/PNDIS_SWITCH_FEATURE_STATUS_CUSTOM
 - NDIS_SWITCH_FEATURE_STATUS_CUSTOM
 - ntddndis/NDIS_SWITCH_FEATURE_STATUS_CUSTOM
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# NDIS_SWITCH_FEATURE_STATUS_CUSTOM structure (ntddndis.h)
...
The type, revision, and size of the <b>NDIS_SWITCH_FEATURE_STATUS_CUSTOM</b> structure. This member is formatted as an <a href="/windows-hardware/drivers/ddi/objectheader/ns-objectheader-ndis_object_header">NDIS_OBJECT_HEADER</a> structure.
...
</ul> The <b>InformationBuffer</b> member of the <a href="/windows-hardware/drivers/ddi/oidrequest/ns-oidrequest-ndis_oid_request">NDIS_OID_REQUEST</a> structure contains a pointer to this information buffer.
