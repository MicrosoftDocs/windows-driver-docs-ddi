...
ms.date: 1/18/2018
ms.keywords: ntddndis/NDIS_PD_CONFIG, netvista.ndis_pd_config, _NDIS_PD_CONFIG, NDIS_PD_CONFIG structure [Network Drivers Starting with Windows Vista], NDIS_PD_CONFIG
