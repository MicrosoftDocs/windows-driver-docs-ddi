...
<div> </div>
<b>NDIS_DEVICE_POWER_STATE</b> enumeration values are used in the <a href="/windows-hardware/drivers/ddi/ntddndis/ns-ntddndis-_ndis_pm_capabilities">NDIS_PM_CAPABILITIES</a>, <a href="/windows-hardware/drivers/ddi/ntddndis/ns-ntddndis-_ndis_sriov_set_vf_power_state_parameters">NDIS_SRIOV_SET_VF_POWER_STATE_PARAMETERS</a>,  and <a href="/windows-hardware/drivers/ddi/netpnp/ns-netpnp-_net_pnp_event">NET_PNP_EVENT</a> structures, the <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndismidlenotificationconfirm">NdisMIdleNotificationConfirm</a> function, and the <a href="/windows-hardware/drivers/network/oid-pnp-capabilities">OID_PNP_CAPABILITIES</a>, <a href="/windows-hardware/drivers/network/oid-pnp-query-power">OID_PNP_QUERY_POWER</a>, and <a href="/windows-hardware/drivers/network/oid-pnp-set-power">OID_PNP_SET_POWER</a> OID requests.
