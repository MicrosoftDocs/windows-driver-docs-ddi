...
ms.date: 2/16/2018
ms.keywords: "*PNDIS_SRIOV_SET_VF_POWER_STATE_PARAMETERS, NDIS_SRIOV_SET_VF_POWER_STATE_PARAMETERS structure [Network Drivers Starting with Windows Vista], NDIS_SRIOV_SET_VF_POWER_STATE_PARAMETERS, _NDIS_SRIOV_SET_VF_POWER_STATE_PARAMETERS, ntddndis/NDIS_SRIOV_SET_VF_POWER_STATE_PARAMETERS, PNDIS_SRIOV_SET_VF_POWER_STATE_PARAMETERS, PNDIS_SRIOV_SET_VF_POWER_STATE_PARAMETERS structure pointer [Network Drivers Starting with Windows Vista], netvista.ndis_sriov_set_vf_power_state_parameters, ntddndis/PNDIS_SRIOV_SET_VF_POWER_STATE_PARAMETERS"
