...
ms.date: 2/16/2018
ms.keywords: ntddndis/NDIS_NIC_SWITCH_VF_INFO_ARRAY, NDIS_NIC_SWITCH_VF_INFO_ARRAY, PNDIS_NIC_SWITCH_VF_INFO_ARRAY, ntddndis/PNDIS_NIC_SWITCH_VF_INFO_ARRAY, NDIS_NIC_SWITCH_VF_INFO_ARRAY structure [Network Drivers Starting with Windows Vista], netvista.ndis_nic_switch_vf_info_array, PNDIS_NIC_SWITCH_VF_INFO_ARRAY structure pointer [Network Drivers Starting with Windows Vista], *PNDIS_NIC_SWITCH_VF_INFO_ARRAY, _NDIS_NIC_SWITCH_VF_INFO_ARRAY
