...
ms.date: 2/16/2018
ms.keywords: ndis_ports_ref_1bba9fc6-0cd9-40f7-92ad-20979dcaa400.xml, netvista.ndis_port_array, *PNDIS_PORT_ARRAY, ntddndis/PNDIS_PORT_ARRAY, NDIS_PORT_ARRAY structure [Network Drivers Starting with Windows Vista], ntddndis/NDIS_PORT_ARRAY, _NDIS_PORT_ARRAY, PNDIS_PORT_ARRAY structure pointer [Network Drivers Starting with Windows Vista], PNDIS_PORT_ARRAY, NDIS_PORT_ARRAY
