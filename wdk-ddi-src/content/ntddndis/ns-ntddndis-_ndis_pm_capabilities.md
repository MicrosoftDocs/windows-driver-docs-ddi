...
# NDIS_PM_CAPABILITIES structure (ntddndis.h)
...
The type, revision, and size of the <b>NDIS_PM_CAPABILITIES</b> structure. This member is formatted as an <a href="/windows-hardware/drivers/ddi/objectheader/ns-objectheader-ndis_object_header">NDIS_OBJECT_HEADER</a> structure.
...
<ul>
<li>
The miniport driver must be able to indicate the packet by calling <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndismindicatereceivenetbufferlists">NdisMIndicateReceiveNetBufferLists</a>.



</li>
<li>
The miniport driver must be able to issue an <a href="/windows-hardware/drivers/network/ndis-status-pm-wake-reason">NDIS_STATUS_PM_WAKE_REASON</a> status indication and must pass the packet with the indication.
...
For more information about this power management capability, see <a href="/windows-hardware/drivers/ddi/_netvista/">NDIS Selective Suspend</a>.
...
<div> </div>
The device power state is specified as one of the following <a href="/windows-hardware/drivers/ddi/ntddndis/ne-ntddndis-_ndis_device_power_state">NDIS_DEVICE_POWER_STATE</a> values:
...
Specifies the lowest device power state from which a network adapter can signal a wake-up event on receipt of
     ...
     specified as one of the following <a href="/windows-hardware/drivers/ddi/ntddndis/ne-ntddndis-_ndis_device_power_state">NDIS_DEVICE_POWER_STATE</a> values:
...
The power state is specified as one of the
     following <a href="/windows-hardware/drivers/ddi/ntddndis/ne-ntddndis-_ndis_device_power_state">NDIS_DEVICE_POWER_STATE</a> values:
...
The <b>NDIS_PM_CAPABILITIES</b> structure is used in the 
    ...
    the 
    <a href="/windows-hardware/drivers/network/ndis-status-pm-capabilities-change">
...
<a href="/windows-hardware/drivers/network/ndis-status-pm-wake-reason">NDIS_STATUS_PM_WAKE_REASON</a>



<a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndismindicatereceivenetbufferlists">NdisMIndicateReceiveNetBufferLists</a>
