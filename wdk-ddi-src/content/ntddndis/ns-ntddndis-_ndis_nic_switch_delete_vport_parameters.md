...
# NDIS_NIC_SWITCH_DELETE_VPORT_PARAMETERS structure (ntddndis.h)
...
The type, revision, and size of the <b>NDIS_NIC_SWITCH_DELETE_VPORT_PARAMETERS</b> structure. This member is formatted as an <a href="/windows-hardware/drivers/ddi/objectheader/ns-objectheader-ndis_object_header">NDIS_OBJECT_HEADER</a> structure.
...
The NDIS_NIC_SWITCH_DELETE_PORT_PARAMETERS structure is used in OID set requests of <a href="/windows-hardware/drivers/network/oid-nic-switch-delete-vport">OID_NIC_SWITCH_DELETE_VPORT</a>.
