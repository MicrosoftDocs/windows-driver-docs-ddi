...
# NDIS_SRIOV_WRITE_VF_CONFIG_BLOCK_PARAMETERS structure (ntddndis.h)
...
<div class="alert"><b>Note</b>  The VF with the specified NDIS_SRIOV_FUNCTION_ID value must have resources that were previously allocated through an object identifier (OID) method request of <a href="/windows-hardware/drivers/network/oid-nic-switch-allocate-vf">OID_NIC_SWITCH_ALLOCATE_VF</a>.
...
## -remarks
 ...
 The <b>NDIS_SRIOV_WRITE_VF_CONFIG_BLOCK_PARAMETERS</b> structure is used in an OID set request of <a href="/windows-hardware/drivers/network/oid-sriov-write-vf-config-block">OID_SRIOV_WRITE_VF_CONFIG_BLOCK</a>. 
...
<a href="/windows-hardware/drivers/network/oid-sriov-write-vf-config-block">OID_SRIOV_WRITE_VF_CONFIG_BLOCK</a>
