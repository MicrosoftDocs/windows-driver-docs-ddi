...
tech.root: netvista
ms.date: 05/02/2018
keywords: ["NDIS_NIC_SWITCH_TYPE enumeration"]
...
f1_keywords:
 ...
 - ntddndis/_NDIS_NIC_SWITCH_TYPE
 - PNDIS_NIC_SWITCH_TYPE
 - ntddndis/PNDIS_NIC_SWITCH_TYPE
...
# NDIS_NIC_SWITCH_TYPE enumeration (ntddndis.h)
...
The <b>SwitchType</b> member of the <a href="/windows-hardware/drivers/ddi/ntddndis/ns-ntddndis-_ndis_nic_switch_parameters">NDIS_NIC_SWITCH_PARAMETERS</a> and <a href="/windows-hardware/drivers/ddi/ntddndis/ns-ntddndis-_ndis_nic_switch_info">NDIS_NIC_SWITCH_INFO</a> structures is an <b>NDIS_NIC_SWITCH_TYPE</b> enumeration data type. 



For more information about the NIC switch, see <a href="/windows-hardware/drivers/network/sr-iov-architecture">SR-IOV Architecture</a>.
