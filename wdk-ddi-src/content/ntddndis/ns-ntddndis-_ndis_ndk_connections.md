...
ms.date: 2/16/2018
ms.keywords: NDIS_NDK_CONNECTIONS, PNDIS_NDK_CONNECTIONS, ntddndis/PNDIS_NDK_CONNECTIONS, _NDIS_NDK_CONNECTIONS, PNDIS_NDK_CONNECTIONS structure pointer [Network Drivers Starting with Windows Vista], netvista.ndis_ndk_connections, NDIS_NDK_CONNECTIONS structure [Network Drivers Starting with Windows Vista], ntddndis/NDIS_NDK_CONNECTIONS
