...
# NDIS_NDK_CONNECTIONS structure (ntddndis.h)
...
The number of elements in the connection array that is passed in the <b>Connections</b> member. Each element in the array is an <a href="/windows-hardware/drivers/ddi/ntddndis/ns-ntddndis-_ndis_ndk_connection_entry">NDIS_NDK_CONNECTION_ENTRY</a> structure.
...
<a href="/windows-hardware/drivers/ddi/ntddndis/ns-ntddndis-_ndis_ndk_connection_entry">NDIS_NDK_CONNECTION_ENTRY</a>
