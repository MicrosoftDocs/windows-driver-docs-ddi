...
ms.date: 1/18/2018
ms.keywords: ntddndis/NDIS_PM_PROTOCOL_OFFLOAD, *PNDIS_PM_PROTOCOL_OFFLOAD, PNDIS_PM_PROTOCOL_OFFLOAD, ntddndis/PNDIS_PM_PROTOCOL_OFFLOAD, NDIS_PM_PROTOCOL_OFFLOAD, miniport_power_management_ref_f8a5be81-c46e-41cd-ac96-9877e1f9ebec.xml, PNDIS_PM_PROTOCOL_OFFLOAD structure pointer [Network Drivers Starting with Windows Vista], _NDIS_PM_PROTOCOL_OFFLOAD, NDIS_PM_PROTOCOL_OFFLOAD structure [Network Drivers Starting with Windows Vista], netvista.ndis_pm_protocol_offload
...
#### IPv4ARPParameters.Flags

A <b>ULONG</b> value that contains a bitwise <b>OR</b> of flags. This member is reserved for NDIS.


#### IPv4ARPParameters.RemoteIPv4Address
...
#### IPv4ARPParameters.HostIPv4Address
...
#### IPv6NSParameters.SolicitedNodeIPv6Address
...
<div class="alert"><b>Note</b>  When it sends an NA message, the network adapter must always use this MAC address in the
        ...
        address in the MAC header.</div><div> </div>

#### IPv6NSParameters.TargetIPv6Addresses
...
#### Dot11RSNRekeyParameters.Flags

A <b>ULONG</b> value that contains a bitwise OR of flags. This member is reserved for NDIS.


#### Dot11RSNRekeyParameters.KCK

A <b>UCHAR</b> array that contains an IEEE 802.11 key confirmation key (KCK).


#### Dot11RSNRekeyParameters.KEK
