...
ms.date: 1/18/2018
ms.keywords: *PNDIS_SWITCH_PROPERTY_CUSTOM, netvista.ndis_switch_property_custom, PNDIS_SWITCH_PROPERTY_CUSTOM structure pointer [Network Drivers Starting with Windows Vista], ntddndis/PNDIS_SWITCH_PROPERTY_CUSTOM, _NDIS_SWITCH_PROPERTY_CUSTOM, NDIS_SWITCH_PROPERTY_CUSTOM, PNDIS_SWITCH_PROPERTY_CUSTOM, NDIS_SWITCH_PROPERTY_CUSTOM structure [Network Drivers Starting with Windows Vista], ntddndis/NDIS_SWITCH_PROPERTY_CUSTOM
...
product: Windows
targetos: Windows
req.typenames: *PNDIS_SWITCH_PROPERTY_CUSTOM, NDIS_SWITCH_PROPERTY_CUSTOM
---
...
##### - Header.NDIS_SWITCH_PROPERTY_CUSTOM_REVISION_1
