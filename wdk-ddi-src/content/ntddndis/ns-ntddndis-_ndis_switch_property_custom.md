...
ms.date: 2/16/2018
ms.keywords: ",  , *, *PNDIS_SWITCH_PROPERTY_CUSTOM, ,, C, D, E, H, I, M, N, NDIS_SWITCH_PROPERTY_CUSTOM, NDIS_SWITCH_PROPERTY_CUSTOM structure [Network Drivers Starting with Windows Vista], O, P, PNDIS_SWITCH_PROPERTY_CUSTOM, PNDIS_SWITCH_PROPERTY_CUSTOM structure pointer [Network Drivers Starting with Windows Vista], R, S, T, U, W, Y, _, _NDIS_SWITCH_PROPERTY_CUSTOM, netvista.ndis_switch_property_custom, ntddndis/NDIS_SWITCH_PROPERTY_CUSTOM, ntddndis/PNDIS_SWITCH_PROPERTY_CUSTOM"
