...
ms.date: 1/18/2018
ms.keywords: ntddndis/PNDIS_LINK_STATE, NDIS_LINK_STATE structure [Network Drivers Starting with Windows Vista], *PNDIS_LINK_STATE, PNDIS_LINK_STATE structure pointer [Network Drivers Starting with Windows Vista], NDIS_LINK_STATE, ntddndis/NDIS_LINK_STATE, PNDIS_LINK_STATE, _NDIS_LINK_STATE, netvista.ndis_link_state
