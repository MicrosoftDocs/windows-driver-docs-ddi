...
ms.date: 1/18/2018
ms.keywords: IPSEC_OFFLOAD_V2_AND_UDP_CHECKSUM_COEXISTENCE, *PNDIS_OFFLOAD, NDIS_OFFLOAD structure [Network Drivers Starting with Windows Vista], netvista.ndis_offload, PNDIS_OFFLOAD structure pointer [Network Drivers Starting with Windows Vista], NDIS_OFFLOAD, PNDIS_OFFLOAD, ntddndis/PNDIS_OFFLOAD, IPSEC_OFFLOAD_V2_AND_TCP_CHECKSUM_COEXISTENCE, _NDIS_OFFLOAD, tcpip_offload_ref_e5f796e9-714c-43f9-98e4-1d0de0dcc8ee.xml, ntddndis/NDIS_OFFLOAD
