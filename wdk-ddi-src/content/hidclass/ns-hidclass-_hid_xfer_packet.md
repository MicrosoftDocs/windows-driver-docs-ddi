...
description: The HID_XFER_PACKET structure in hidclass.he contains information about a HID report that the HID class driver uses with I/O requests to get or set a report.
