...
The IOCTL_GET_PHYSICAL_DESCRIPTOR request obtains the physical descriptor of a <a href="/windows-hardware/drivers/hid/top-level-collections">top-level collection</a>. For a minidriver, this descriptor is the descriptor of the HIDClass device.
