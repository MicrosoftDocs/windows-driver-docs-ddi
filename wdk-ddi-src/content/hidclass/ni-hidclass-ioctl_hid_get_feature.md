...
The IOCTL_HID_GET_FEATURE request returns a feature report associated with a <a href="/windows-hardware/drivers/hid/top-level-collections">top-level collection</a>.
...
The size of the <a href="/windows-hardware/drivers/ddi/hidclass/ns-hidclass-_hid_xfer_packet">HID_XFER_PACKET</a> structure.
