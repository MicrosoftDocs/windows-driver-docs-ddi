...
The IOCTL_HID_GET_HARDWARE_ID request obtains the Plug and Play hardware ID of a <a href="/windows-hardware/drivers/hid/top-level-collections">top-level collection</a>. 
