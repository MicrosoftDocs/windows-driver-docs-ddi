...
The <b>SetThreadForOperation64</b> function sets the thread to use for the next <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdbgexts/nc-wdbgexts-pwindbg_stacktrace_routine">StackTrace</a> call.
