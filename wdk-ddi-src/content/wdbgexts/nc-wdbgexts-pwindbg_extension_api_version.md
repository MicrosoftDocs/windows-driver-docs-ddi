...
The debugger uses the <b>MajorVersion</b> and <b>MinorVersion</b> fields of the returned <b>EXT_API_VERSION</b> structure when executing commands like <a href="/windows-hardware/drivers/debugger/-chain--list-debugger-extensions-">.chain</a> and <a href="/windows-hardware/drivers/mobilebroadband/version">version</a> that display the extension version number. The debugger does not perform any "version checking" -- the extension DLL will be loaded regardless of what version numbers are present in these fields.
