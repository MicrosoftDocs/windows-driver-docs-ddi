...
This function does not need to be called directly.  The macros <a href="https://docs.microsoft.com/previous-versions/ff550953(v=vs.85)">InitTypeRead</a> and <a href="https://docs.microsoft.com/previous-versions/ff550957(v=vs.85)">InitTypeReadPhysical</a> call this function with <i>StoreAddress</i> non-zero to prepare a structure for reading its members.  The macro <a href="https://docs.microsoft.com/previous-versions/ff553539(v=vs.85)">ReadField</a> calls this function with <i>StoreAddress</i> (and <i>TypeAddress</i>) equal to zero, to read members from the structure.
...
<div> </div>
The <b>ReadField</b> and <b>ReadFieldStr</b> macros read a field whose size is less than 8 bytes from a structure initialized with <a href="https://docs.microsoft.com/previous-versions/ff550953(v=vs.85)">InitTypeRead</a> or <a href="https://docs.microsoft.com/previous-versions/ff550957(v=vs.85)">InitTypeReadPhysical</a>. 
...
The <a href="https://docs.microsoft.com/previous-versions/ff550953(v=vs.85)">InitTypeRead</a> macro initializes a structure so that its members can be read using <a href="https://docs.microsoft.com/previous-versions/ff553539(v=vs.85)">ReadField</a>.
...
The <b>InitTypeReadPhysical</b> and <b>InitTypeStrReadPhysical</b> macros initialize a structure in physical memory so that its members can be read using <a href="https://docs.microsoft.com/previous-versions/ff553539(v=vs.85)">ReadField</a>.
...
<a href="https://docs.microsoft.com/previous-versions/ff550957(v=vs.85)">InitTypeReadPhysical</a>
