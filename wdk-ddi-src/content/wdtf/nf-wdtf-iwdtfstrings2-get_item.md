...
ms.date: 2/20/2018
ms.keywords: Item property [Windows Device Testing Framework], IWDTFDeviceDepot2 interface, get_Item, Microsoft.WDTF.IWDTFDeviceDepot2.Item, IWDTFStrings2, Microsoft::WDTF::IWDTFDeviceDepot2::Item, wdtf/IWDTFDeviceDepot2::get_Item, IWDTFNumbers2::get_Item, IWDTFDeviceDepot2.Item, IWDTFDeviceDepot2, IWDTFDeviceDepot2 interface [Windows Device Testing Framework], Item property, IWDTFActions2, IWDTFDeviceDepot2::get_Item, IWDTFActions2::get_Item, wdtf/IWDTFDeviceDepot2::Item, IWDTFLongNumbers2, dtf.iwdtfdevicedepot2_item, IWDTFStrings2::get_Item, IWDTFLongNumbers2::get_Item, IWDTFNumbers2, Item property [Windows Device Testing Framework]
