...
ms.date: 2/20/2018
ms.keywords: Item property [Windows Device Testing Framework], IWDTFLongNumbers2, Microsoft.WDTF.IWDTFDeviceDepot2.Item, Microsoft::WDTF::IWDTFDeviceDepot2::Item, IWDTFDeviceDepot2, IWDTFDeviceDepot2 interface [Windows Device Testing Framework], Item property, IWDTFNumbers2, IWDTFActions2::get_Item, IWDTFLongNumbers2::get_Item, wdtf/IWDTFDeviceDepot2::get_Item, dtf.iwdtfdevicedepot2_item, IWDTFNumbers2::get_Item, IWDTFDeviceDepot2.Item, wdtf/IWDTFDeviceDepot2::Item, Item property [Windows Device Testing Framework], IWDTFDeviceDepot2 interface, IWDTFActions2, IWDTFDeviceDepot2::get_Item, get_Item
