...
ms.date: 12/14/2017
ms.keywords: IWDTFDeviceDepot2 interface [Windows Device Testing Framework], WDTF property, WDTF property [Windows Device Testing Framework], Microsoft.WDTF.IWDTFDeviceDepot2.WDTF, IWDTFTarget2::get_WDTF, IWDTFDeviceDepot2, IWDTFSystemDepot2, wdtf/IWDTFDeviceDepot2::WDTF, IWDTFSystemDepot2::get_WDTF, IWDTFDeviceDepot2.WDTF, Microsoft::WDTF::IWDTFDeviceDepot2::WDTF, IWDTFTarget2, dtf.iwdtfdevicedepot2_wdtf, IWDTFDeviceDepot2::get_WDTF, wdtf/IWDTFDeviceDepot2::get_WDTF, get_WDTF, WDTF property [Windows Device Testing Framework], IWDTFDeviceDepot2 interface
