...
ms.date: 12/14/2017
ms.keywords: IWDTFActions2::get__NewEnum, IWDTFDeviceDepot2._NewEnum, IWDTFActions2, wdtf/IWDTFDeviceDepot2::get__NewEnum, get__NewEnum, Microsoft::WDTF::IWDTFDeviceDepot2::_NewEnum, Microsoft.WDTF.IWDTFDeviceDepot2._NewEnum, _NewEnum property [Windows Device Testing Framework], wdtf/IWDTFDeviceDepot2::_NewEnum, IWDTFDeviceDepot2::get__NewEnum, _NewEnum property [Windows Device Testing Framework], IWDTFDeviceDepot2 interface, IWDTFDeviceDepot2 interface [Windows Device Testing Framework], _NewEnum property, dtf.iwdtfdevicedepot2__newenum
