...
ms.date: 12/14/2017
ms.keywords: Microsoft.WDTF.IWDTFDeviceDepot2._NewEnum, _NewEnum property [Windows Device Testing Framework], IWDTFActions2::get__NewEnum, IWDTFDeviceDepot2 interface [Windows Device Testing Framework], _NewEnum property, Microsoft::WDTF::IWDTFDeviceDepot2::_NewEnum, wdtf/IWDTFDeviceDepot2::_NewEnum, dtf.iwdtfdevicedepot2__newenum, _NewEnum property [Windows Device Testing Framework], IWDTFDeviceDepot2 interface, get__NewEnum, IWDTFActions2, IWDTFDeviceDepot2._NewEnum, wdtf/IWDTFDeviceDepot2::get__NewEnum, IWDTFDeviceDepot2::get__NewEnum
