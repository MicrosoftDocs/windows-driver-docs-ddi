...
ms.date: 2/20/2018
ms.keywords: IWDTFTarget2::put_Context, ntddk/IWDTFTarget2::put_Context, ntddk/IWDTFTarget2::get_Context, IWDTFTarget2, Microsoft::WDTF::IWDTFTarget2::Context, ntddk/IWDTFTarget2::Context, IWDTFTarget2.Context, Context property [Windows Device Testing Framework], Microsoft.WDTF.IWDTFTarget2.Context, dtf.iwdtftarget2_context, get_Context, IWDTFTarget2::get_Context, IWDTFTarget2 interface [Windows Device Testing Framework], Context property, Context property [Windows Device Testing Framework], IWDTFTarget2 interface
