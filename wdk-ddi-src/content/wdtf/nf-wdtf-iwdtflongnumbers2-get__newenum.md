...
ms.date: 2/20/2018
ms.keywords: wdtf/IWDTFDeviceDepot2::_NewEnum, get__NewEnum, IWDTFDeviceDepot2._NewEnum, IWDTFLongNumbers2, IWDTFLongNumbers2::get__NewEnum, _NewEnum property [Windows Device Testing Framework], IWDTFDeviceDepot2, IWDTFActions2::get__NewEnum, _NewEnum property [Windows Device Testing Framework], IWDTFDeviceDepot2 interface, IWDTFDeviceDepot2 interface [Windows Device Testing Framework], _NewEnum property, dtf.iwdtfdevicedepot2__newenum, wdtf/IWDTFDeviceDepot2::get__NewEnum, Microsoft::WDTF::IWDTFDeviceDepot2::_NewEnum, IWDTFActions2, IWDTFDeviceDepot2::get__NewEnum, Microsoft.WDTF.IWDTFDeviceDepot2._NewEnum
