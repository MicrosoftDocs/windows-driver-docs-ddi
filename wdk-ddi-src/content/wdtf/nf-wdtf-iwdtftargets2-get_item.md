...
ms.date: 2/20/2018
ms.keywords: Item property [Windows Device Testing Framework], IWDTFDeviceDepot2 interface, Microsoft.WDTF.IWDTFDeviceDepot2.Item, IWDTFNumbers2::get_Item, IWDTFDeviceDepot2.Item, IWDTFDeviceDepot2 interface [Windows Device Testing Framework], Item property, wdtf/IWDTFDeviceDepot2::Item, IWDTFTargets2, Item property [Windows Device Testing Framework], Microsoft::WDTF::IWDTFDeviceDepot2::Item, wdtf/IWDTFDeviceDepot2::get_Item, IWDTFActions2, IWDTFDeviceDepot2::get_Item, IWDTFNumbers2, IWDTFStrings2, get_Item, IWDTFDeviceDepot2, IWDTFTargets2::get_Item, dtf.iwdtfdevicedepot2_item, IWDTFLongNumbers2::get_Item, IWDTFActions2::get_Item, IWDTFLongNumbers2, IWDTFStrings2::get_Item
