...
ms.date: 2/22/2018
ms.keywords: ",  , A, B, BTHHFP_AUDIO_DEVICE_CAPABILTIES_INIT, BTHHFP_AUDIO_DEVICE_CAPABILTIES_INIT method [Audio Devices], C, D, E, F, H, I, L, N, O, P, S, T, U, V, _, audio.bthhfp_audio_device_capabilties_init, bthhfpddi/BTHHFP_AUDIO_DEVICE_CAPABILTIES_INIT"
