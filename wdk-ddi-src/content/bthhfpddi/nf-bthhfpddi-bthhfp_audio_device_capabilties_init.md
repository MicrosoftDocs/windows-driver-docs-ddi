...
ms.date: 12/14/2017
ms.keywords: audio.bthhfp_audio_device_capabilties_init, BTHHFP_AUDIO_DEVICE_CAPABILTIES_INIT, BTHHFP_AUDIO_DEVICE_CAPABILTIES_INIT method [Audio Devices], bthhfpddi/BTHHFP_AUDIO_DEVICE_CAPABILTIES_INIT
