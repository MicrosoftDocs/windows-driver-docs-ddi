...
This request initiates the procedure to create a Service Level Connection,  and ends without waiting for the connection procedure to complete. Connection status can be determined using <a href="/windows-hardware/drivers/ddi/bthhfpddi/ni-bthhfpddi-ioctl_bthhfp_device_get_connection_status_update">IOCTL_BTHHFP_DEVICE_GET_CONNECTION_STATUS_UPDATE</a>.

The audio driver sends this request from its handler for the <a href="/windows-hardware/drivers/audio/ksproperty-oneshot-reconnect">KSPROPERTY_ONESHOT_RECONNECT</a> KS property.
...
<a href="/windows-hardware/drivers/audio/ksproperty-oneshot-reconnect">KSPROPERTY_ONESHOT_RECONNECT</a>