...
ms.date: 12/14/2017
ms.keywords: ProcessIoControl method [Sensor Devices], ISensorClassExtension, ProcessIoControl, sensors.isensorclassextension_processiocontrol, ISensorClassExtension::ProcessIoControl
