...
ms.date: 12/14/2017
ms.keywords: ISensorDriver::OnGetSupportedProperties, OnGetSupportedProperties, sensors.isensordriver_ongetsupportedproperties, OnGetSupportedProperties method [Sensor Devices], ISensorDriver
