...
ms.date: 2/15/2018
ms.keywords: ISensorDriver, OnGetSupportedEvents, OnGetSupportedEvents method [Sensor Devices], ISensorDriver::OnGetSupportedEvents, sensors.isensordriver_ongetsupportedevents
