...
ms.date: 2/22/2018
ms.keywords: OnProcessWpdMessage, ISensorDriver::OnProcessWpdMessage, OnProcessWpdMessage method [Sensor Devices], ISensorDriver, sensors.isensordriver_onprocesswpdmessage
