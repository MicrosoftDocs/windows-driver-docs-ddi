...
ms.date: 2/22/2018
ms.keywords: ISensorClassExtension, Initialize, Initialize method [Sensor Devices], sensors.isensorclassextension_initialize, ISensorClassExtension::Initialize
