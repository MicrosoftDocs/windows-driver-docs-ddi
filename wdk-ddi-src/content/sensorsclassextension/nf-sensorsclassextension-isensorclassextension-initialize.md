...
ms.date: 2/8/2018
ms.keywords: sensors.isensorclassextension_initialize, Initialize method [Sensor Devices], ISensorClassExtension::Initialize, Initialize, ISensorClassExtension
