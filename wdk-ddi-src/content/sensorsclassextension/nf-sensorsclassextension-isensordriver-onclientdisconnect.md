...
ms.date: 12/14/2017
ms.keywords: ISensorDriver interface [Sensor Devices], OnClientDisconnect method, ISensorDriver::OnClientDisconnect, ISensorDriver, sensorsclassextension/ISensorDriver::OnClientDisconnect, sensors.isensordriver_onclientdisconnect, OnClientDisconnect, Sensor_IFaces_f5f91a04-84b3-4302-9c26-845281651ed9.xml, OnClientDisconnect method [Sensor Devices], OnClientDisconnect method [Sensor Devices], ISensorDriver interface
