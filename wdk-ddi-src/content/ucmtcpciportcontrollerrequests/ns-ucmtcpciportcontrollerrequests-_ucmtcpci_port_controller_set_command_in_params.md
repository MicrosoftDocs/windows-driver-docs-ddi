...
tech.root: usbref
ms.date: 05/07/2018
keywords: ["UCMTCPCI_PORT_CONTROLLER_SET_COMMAND_IN_PARAMS structure"]
...
f1_keywords:
 - _UCMTCPCI_PORT_CONTROLLER_SET_COMMAND_IN_PARAMS
 - ucmtcpciportcontrollerrequests/_UCMTCPCI_PORT_CONTROLLER_SET_COMMAND_IN_PARAMS
...
# UCMTCPCI_PORT_CONTROLLER_SET_COMMAND_IN_PARAMS structure (ucmtcpciportcontrollerrequests.h)
...
## -description
             ...
             Stores the specified command registers. This structure is used in the <a href="/windows-hardware/drivers/ddi/ucmtcpciportcontrollerrequests/ni-ucmtcpciportcontrollerrequests-ioctl_ucmtcpci_port_controller_set_command">IOCTL_UCMTCPCI_PORT_CONTROLLER_SET_COMMAND</a> request.
...
<a href="/windows-hardware/drivers/ddi/ucmtcpciportcontrollerrequests/ni-ucmtcpciportcontrollerrequests-ioctl_ucmtcpci_port_controller_set_command">IOCTL_UCMTCPCI_PORT_CONTROLLER_SET_COMMAND</a>
