...
description: The HID_XFER_PACKET structure in vhf.h contains information about a HID report that the HID class driver uses with I/O requests to get or set a report.
...
f1_keywords:
 - _HID_XFER_PACKET
 - vhf/_HID_XFER_PACKET
 - PHID_XFER_PACKET
 - vhf/PHID_XFER_PACKET
 - HID_XFER_PACKET
 - vhf/HID_XFER_PACKET
topic_type:
 - APIRef
