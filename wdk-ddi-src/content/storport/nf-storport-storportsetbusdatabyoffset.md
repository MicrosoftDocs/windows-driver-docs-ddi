...
[in]
Specifies the system-assigned number of the I/O bus on which the HBA is connected. The miniport driver's <a href="/windows-hardware/drivers/ddi/storport/nc-storport-hw_find_adapter">HwStorFindAdapter</a> routine obtains this value from the input <b>PORT_CONFIGURATION_INFORMATION</b><b>SystemIoBusNumber</b> member.
...
<a href="/windows-hardware/drivers/ddi/srb/nf-srb-scsiportsetbusdatabyoffset">ScsiPortSetBusDataByOffset</a>