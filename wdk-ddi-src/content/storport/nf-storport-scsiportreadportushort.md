...
description: Learn how the ScsiPortReadPortUshort routine reads a USHORT value from the HBA.Note  The SCSI port driver and SCSI miniport driver models may be altered or unavailable in the future.
...
# ScsiPortReadPortUshort function (storport.h)
