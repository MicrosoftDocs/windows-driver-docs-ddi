...
description: The _SCSI_WMI_REQUEST_BLOCK structure (storport.h) contains information about a SCSI_REQUEST_BLOCK for use with WMI commands.
...
f1_keywords:
 ...
 - storport/_SCSI_WMI_REQUEST_BLOCK
 - PSCSI_WMI_REQUEST_BLOCK
 - storport/PSCSI_WMI_REQUEST_BLOCK
 - SCSI_WMI_REQUEST_BLOCK
 - storport/SCSI_WMI_REQUEST_BLOCK
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# SCSI_WMI_REQUEST_BLOCK structure (storport.h)
