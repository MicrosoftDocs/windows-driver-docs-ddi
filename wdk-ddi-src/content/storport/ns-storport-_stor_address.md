...
description: The _STOR_ADDRESS structure (storport.h) contains general information that describes a storage device address.
...
f1_keywords:
 - _STOR_ADDRESS
 - storport/_STOR_ADDRESS
 - PSTOR_ADDRESS
 - storport/PSTOR_ADDRESS
 - STOR_ADDRESS
...
# STOR_ADDRESS structure (storport.h)
