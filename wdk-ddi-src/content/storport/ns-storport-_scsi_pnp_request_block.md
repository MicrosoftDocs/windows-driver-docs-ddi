...
description: The _SCSI_PNP_REQUEST_BLOCK structure (storport.h) contains information for SCSI plug and play (PNP) requests.
...
# SCSI_PNP_REQUEST_BLOCK structure (storport.h)
