...
| Value | Meaning |
| ----- | ------- |
| SRB_FUNCTION_EXECUTE_SCSI (0x00) | A SCSI device I/O request should be executed on the target logical unit. When **NumSrbExData** > 0, one or more of the following extended request block structures are located at the offsets specified in **SrbExDataOffset**: [SRBEX_DATA_SCSI_CDB16](../srb/ns-srb-_srbex_data_scsi_cdb16.md), [SRBEX_DATA_SCSI_CDB32](../srb/ns-srb-_srbex_data_scsi_cdb32.md), [SRBEX_DATA_SCSI_CDB_VAR](../srb/ns-srb-_srbex_data_scsi_cdb_var.md), [SRBEX_DATA_BIDIRECTIONAL](../srb/ns-srb-_srbex_data_bidirectional.md), [SRBEX_DATA_IO_INFO](../srb/ns-srb-_srbex_data_io_info) |
...
| SRB_FUNCTION_CRYPTO_OPERATION () | Reserved for system use. |
