...
title: ScsiPortReadRegisterBufferUlong macro (storport.h)
description: Learn how the ScsiPortReadRegisterBufferUlong routine transfers a specified number of ULONG values from the HBA to a buffer.Note  The SCSI port driver and SCSI miniport driver models may be altered or unavailable in the future.
old-location: storage\scsiportreadregisterbufferulong.htm
tech.root: storage
ms.date: 03/29/2018
keywords: ["ScsiPortReadRegisterBufferUlong macro"]
...
# ScsiPortReadRegisterBufferUlong function (storport.h)
