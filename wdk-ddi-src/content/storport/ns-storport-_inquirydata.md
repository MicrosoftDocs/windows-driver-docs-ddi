...
title: INQUIRYDATA (storport.h)
description: The _INQUIRYDATA structure (storport.h) contains information about the SCSI inquiry data associated with a tape device.
