...
description: The _SRBEX_DATA_POWER structure (storport.h) contains the request data for an extended power SCSI Request Block (SRB).
...
f1_keywords:
 - _SRBEX_DATA_POWER
 - storport/_SRBEX_DATA_POWER
 - PSRBEX_DATA_POWER
 - storport/PSRBEX_DATA_POWER
 - SRBEX_DATA_POWER
...
# SRBEX_DATA_POWER structure (storport.h)
