...
ms.date: 2/16/2018
ms.keywords: PMEMORY_REGION structure pointer [Storage Devices], PMEMORY_REGION, storport/PMEMORY_REGION, storport/MEMORY_REGION, *PMEMORY_REGION, structs-storport_4ed10515-f1ce-4767-bbdc-239ac00a5cbe.xml, storage.memory_region, MEMORY_REGION, MEMORY_REGION structure [Storage Devices], _MEMORY_REGION
...
The <b>DumpRegion</b> member of the <a href="..\srb\ns-srb-_port_configuration_information.md">PORT_CONFIGURATION_INFORMATION</a> structure holds a MEMORY_REGION structure that describes a region of physically contiguous memory that a miniport driver can use during a crash dump. 
