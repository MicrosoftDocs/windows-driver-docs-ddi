...
ms.date: 1/10/2018
ms.keywords: storport/, *PSTOR_CRYPTO_KEY_SIZE, PSTOR_CRYPTO_KEY_SIZE enumeration pointer [Storage Devices], STOR_CRYPTO_KEY_SIZE, STOR_CRYPTO_KEY_SIZE enumeration [Storage Devices], storport/PSTOR_CRYPTO_KEY_SIZE, PSTOR_CRYPTO_KEY_SIZE, storage.stor_crypto_key_size, storport/STOR_CRYPTO_KEY_SIZE, _STOR_CRYPTO_KEY_SIZE
