...
description: Learn how the ScsiPortWritePortUchar routine transfers an unsigned byte to the HBA.Note  The SCSI port driver and SCSI miniport driver models may be altered or unavailable in the future.
...
# ScsiPortWritePortUchar function (storport.h)
