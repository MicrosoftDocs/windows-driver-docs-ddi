...
A pointer to a storage address structure formatted as <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/scsi/ns-scsi-_stor_addr_btl8">STOR_ADDR_BTL8</a>. On return, the <b>Port</b> member of this structure will contain the port value assigned to the adapter.
