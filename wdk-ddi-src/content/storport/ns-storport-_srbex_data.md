...
ms.date: 1/10/2018
ms.keywords: storage.srbex_data, SrbExDataTypeUnknown, storport/PSRBEX_DATA, SrbExDataTypeScsiCdbVar, SrbExDataTypePower, SrbExDataTypeScsiCdb16, SrbExDataTypeScsiCdb32, SrbExDataTypeWmi, storport/SRBEX_DATA, SrbExDataTypeIoInfo, _SRBEX_DATA, SrbExDataTypeBidirectional, PSRBEX_DATA structure pointer [Storage Devices], *PSRBEX_DATA, SRBEX_DATA, SRBEX_DATA structure [Storage Devices], SrbExDataTypePnp, PSRBEX_DATA
