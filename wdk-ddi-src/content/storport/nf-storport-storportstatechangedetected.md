...
ms.date: 2/16/2018
ms.keywords: ATTRIBUTE_VM_PASSTHROUGH_LUN, STATE_CHANGE_TARGET, StorPortStateChangeDetected routine [Storage Devices], STATE_CHANGE_BUS, storport/StorPortStateChangeDetected, storage.storportstatechangedetected, StorPortStateChangeDetected, STATE_CHANGE_LUN
