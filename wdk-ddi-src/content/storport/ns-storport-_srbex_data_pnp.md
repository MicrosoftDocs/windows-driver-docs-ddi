...
description: The _SRBEX_DATA_PNP structure (storport.h) contains the request data for an extended plug and play (PNP) SCSI Request Block (SRB).
...
f1_keywords:
 - _SRBEX_DATA_PNP
 - storport/_SRBEX_DATA_PNP
 - PSRBEX_DATA_PNP
 - storport/PSRBEX_DATA_PNP
 - SRBEX_DATA_PNP
 - storport/SRBEX_DATA_PNP
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# SRBEX_DATA_PNP structure (storport.h)
