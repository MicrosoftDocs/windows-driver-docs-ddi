...
ms.date: 2/16/2018
ms.keywords: "*PSTOR_DEVICE_CAPABILITIES, PSTOR_DEVICE_CAPABILITIES structure pointer [Storage Devices], PSTOR_DEVICE_CAPABILITIES, storport/PSTOR_DEVICE_CAPABILITIES, STOR_DEVICE_CAPABILITIES structure [Storage Devices], storage.stor_device_capabilities, storport/STOR_DEVICE_CAPABILITIES, STOR_DEVICE_CAPABILITIES, _STOR_DEVICE_CAPABILITIES"
