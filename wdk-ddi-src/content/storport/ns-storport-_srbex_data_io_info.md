...
description: The _SRBEX_DATA_IO_INFO structure (storport.h) contains additional information related to a read or write request in an extended SCSI Request Block (SRB).
