...
title: StorPortLogSystemEvent function (storport.h)
...
[in, out]
A [STOR_LOG_EVENT_DETAILS](./ns-storport-_stor_log_event_details.md) structure that contains information to appear in the system event log entry.
