...
ms.date: 2/16/2018
ms.keywords: STOR_FEATURE_SET_ADAPTER_INTERFACE_TYPE, STOR_FEATURE_FULL_PNP_DEVICE_CAPABILITIES, HW_INITIALIZATION_DATA structure [Storage Devices], STOR_FEATURE_DEVICE_DESCRIPTOR_FROM_ATA_INFO_VPD, storport/PHW_INITIALIZATION_DATA, STOR_FEATURE_ATA_PASS_THROUGH, SRB_TYPE_FLAG_SCSI_REQUEST_BLOCK, STOR_MAP_NON_READ_WRITE_BUFFERS, SRB_TYPE_FLAG_STORAGE_REQUEST_BLOCK, storport/HW_INITIALIZATION_DATA, *PHW_INITIALIZATION_DATA, _HW_INITIALIZATION_DATA structure [Storage Devices], STOR_MAP_ALL_BUFFERS, STOR_MAP_ALL_BUFFERS_INCLUDING_READ_WRITE, _HW_INITIALIZATION_DATA, STOR_MAP_NO_BUFFERS, STOR_FEATURE_DUMP_POINTERS, structs-storport_c3d0ed59-9662-409d-acc3-6c2358837a01.xml, ADDRESS_TYPE_FLAG_BTL8, storage.hw_initialization_data__storport_, STOR_FEATURE_DUMP_RESUME_CAPABLE, STOR_FEATURE_VIRTUAL_MINIPORT, PHW_INITIALIZATION_DATA, HW_INITIALIZATION_DATA, STOR_FEATURE_DEVICE_NAME_NO_SUFFIX, PHW_INITIALIZATION_DATA structure pointer [Storage Devices]
