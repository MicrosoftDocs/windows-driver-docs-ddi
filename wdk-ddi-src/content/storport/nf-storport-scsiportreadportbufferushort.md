...
title: ScsiPortReadPortBufferUshort macro (storport.h)
description: Learn how the ScsiPortReadPortBufferUshort routine transfers a given number of USHORT values from the HBA to a buffer.Note  The SCSI port driver and SCSI miniport driver models may be altered or unavailable in the future.
...
f1_keywords:
 ...
 - storport/ScsiPortReadPortBufferUshort
topic_type:
 - APIRef
 - kbSyntax
api_type:
