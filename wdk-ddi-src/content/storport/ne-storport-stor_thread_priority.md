...
**STOR_THREAD_PRIORITY** specifies the priority for a system thread being created by [**StorPortCreateSystemThread**](nf-storport-storportcreatesystemthread.md).
...
See [Thread Priorities](/windows-hardware/drivers/kernel/thread-priorities) for more information.
