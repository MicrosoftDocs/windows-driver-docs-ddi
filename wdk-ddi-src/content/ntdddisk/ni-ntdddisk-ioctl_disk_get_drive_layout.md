...
The driver returns the <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntdddisk/ns-ntdddisk-_drive_layout_information">DRIVE_LAYOUT_INFORMATION</a> data in the buffer at <b>Irp->AssociatedIrp.SystemBuffer</b>.
