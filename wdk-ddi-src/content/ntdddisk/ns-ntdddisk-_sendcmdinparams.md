...
Contains a <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntdddisk/ns-ntdddisk-_ideregs">IDEREGS</a> structure used to report the contents of the IDE controller registers.
