...
The driver returns the <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/ntdddisk/ns-ntdddisk-_disk_performance">DISK_PERFORMANCE</a> data in the buffer at <b>Irp->AssociatedIrp.SystemBuffer</b>.
