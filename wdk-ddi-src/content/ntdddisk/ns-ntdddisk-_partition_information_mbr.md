...
ms.date: 2/16/2018
ms.keywords: PPARTITION_INFORMATION_MBR, PPARTITION_INFORMATION_MBR structure pointer [Storage Devices], ntdddisk/PARTITION_INFORMATION_MBR, structs-disk_c386ea16-c8d7-4a5e-8e61-d8e8ddead136.xml, PARTITION_INFORMATION_MBR structure [Storage Devices], ntdddisk/PPARTITION_INFORMATION_MBR, *PPARTITION_INFORMATION_MBR, _PARTITION_INFORMATION_MBR, storage.partition_information_mbr, PARTITION_INFORMATION_MBR
