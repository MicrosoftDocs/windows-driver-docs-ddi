...
The driver returns the <a href="/windows-hardware/drivers/ddi/ntdddisk/ns-ntdddisk-_disk_geometry">DISK_GEOMETRY</a> data in the buffer at <b>Irp->AssociatedIrp.SystemBuffer</b>.
