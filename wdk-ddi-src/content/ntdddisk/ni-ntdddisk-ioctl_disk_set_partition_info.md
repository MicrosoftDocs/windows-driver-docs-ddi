...
The buffer at <b>Irp->AssociatedIrp.SystemBuffer</b> contains the <a href="/windows-hardware/drivers/ddi/ntdddisk/ns-ntdddisk-_set_partition_information">SET_PARTITION_INFORMATION</a> to be set.
