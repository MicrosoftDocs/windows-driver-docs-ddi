...
ms.date: 2/16/2018
ms.keywords: netvista.vmbchannelmapgpadl, VMBUS_CHANNEL_GPADL_FLAG_READ_ONLY, vmbuskernelmodeclientlibapi/VmbChannelMapGpadl, VmbChannelMapGpadl function [Network Drivers Starting with Windows Vista], VmbChannelMapGpadl
