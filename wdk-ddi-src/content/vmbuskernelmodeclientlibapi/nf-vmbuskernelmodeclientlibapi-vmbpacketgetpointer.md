...
ms.date: 2/16/2018
ms.keywords: vmbuskernelmodeclientlibapi/VmbPacketGetPointer, VmbPacketGetPointer, VmbPacketGetPointer function [Network Drivers Starting with Windows Vista], netvista.vmbpacketgetpointer
