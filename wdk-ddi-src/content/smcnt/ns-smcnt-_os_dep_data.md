...
ms.date: 2/22/2018
ms.keywords: OS_DEP_DATA, POS_DEP_DATA, OS_DEP_DATA (WDM), *POS_DEP_DATA, smartcrd.os_dep_data__wdm_, smcnt/POS_DEP_DATA, POS_DEP_DATA structure pointer [Smart Card Reader Devices], scstruct_f7288ef8-a011-44c0-ab86-db7cc6d1a985.xml, smcnt/OS_DEP_DATA, OS_DEP_DATA (WDM) structure [Smart Card Reader Devices], _OS_DEP_DATA, OS_DEP_DATA structure [Smart Card Reader Devices]
