...
title: _NDIS_WWAN_SMS_DELETE (ndiswwan.h)
...
A formatted 
     <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wwan/ns-wwan-_wwan_sms_filter">WWAN_SMS_FILTER</a> object that represents the
