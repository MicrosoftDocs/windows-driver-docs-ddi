...
req.target-type: 
req.typenames: NDIS_WWAN_REGISTER_PARAMS_INFO, *PNDIS_WWAN_REGISTER_PARAMS_INFO
req.umdf-ver: 
req.unicode-ansi: 
topic_type:
 - apiref
...
api_location:
 - ndiswwan.h
api_name:
 - _NDIS_WWAN_REGISTER_PARAMS_INFO
 - PNDIS_WWAN_REGISTER_PARAMS_INFO
 - NDIS_WWAN_REGISTER_PARAMS_INFO
f1_keywords:
 - _NDIS_WWAN_REGISTER_PARAMS_INFO
 - ndiswwan/_NDIS_WWAN_REGISTER_PARAMS_INFO
 - PNDIS_WWAN_REGISTER_PARAMS_INFO
 - ndiswwan/PNDIS_WWAN_REGISTER_PARAMS_INFO
 - NDIS_WWAN_REGISTER_PARAMS_INFO
 - ndiswwan/NDIS_WWAN_REGISTER_PARAMS_INFO
dev_langs:
 - c++
---
