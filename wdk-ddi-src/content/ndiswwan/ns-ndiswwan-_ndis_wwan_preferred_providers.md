...
These point to the list of <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wwan/ns-wwan-_wwan_provider2">WWAN_PROVIDER2</a> by using the WWAN_LIST_HEADER structure. 
