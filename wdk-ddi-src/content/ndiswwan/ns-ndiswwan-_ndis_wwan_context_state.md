...
ms.date: 2/16/2018
ms.keywords: NDIS_WWAN_CONTEXT_STATE, WwanRef_87098fc7-4dbd-4331-81a4-53d425cc0bb0.xml, netvista.ndis_wwan_context_state, _NDIS_WWAN_CONTEXT_STATE, ndiswwan/PNDIS_WWAN_CONTEXT_STATE, PNDIS_WWAN_CONTEXT_STATE structure pointer [Network Drivers Starting with Windows Vista], *PNDIS_WWAN_CONTEXT_STATE, NDIS_WWAN_CONTEXT_STATE structure [Network Drivers Starting with Windows Vista], PNDIS_WWAN_CONTEXT_STATE, ndiswwan/NDIS_WWAN_CONTEXT_STATE
