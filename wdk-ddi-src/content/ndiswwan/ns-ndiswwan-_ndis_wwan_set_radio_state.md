...
ms.date: 2/16/2018
ms.keywords: PNDIS_WWAN_SET_RADIO_STATE, *PNDIS_WWAN_SET_RADIO_STATE, ndiswwan/PNDIS_WWAN_SET_RADIO_STATE, NDIS_WWAN_SET_RADIO_STATE structure [Network Drivers Starting with Windows Vista], _NDIS_WWAN_SET_RADIO_STATE, netvista.ndis_wwan_set_radio_state, WwanRef_b5525c3b-fbf3-4423-b691-464ed9a7a65a.xml, PNDIS_WWAN_SET_RADIO_STATE structure pointer [Network Drivers Starting with Windows Vista], ndiswwan/NDIS_WWAN_SET_RADIO_STATE, NDIS_WWAN_SET_RADIO_STATE
