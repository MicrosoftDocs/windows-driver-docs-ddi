...
ms.date: 2/16/2018
ms.keywords: netvista.ndis_wwan_vendor_specific, ndiswwan/PNDIS_WWAN_VENDOR_SPECIFIC, WwanRef_01a97be2-1ce1-484b-b844-654b4171330f.xml, *PNDIS_WWAN_VENDOR_SPECIFIC, ndiswwan/NDIS_WWAN_VENDOR_SPECIFIC, PNDIS_WWAN_VENDOR_SPECIFIC structure pointer [Network Drivers Starting with Windows Vista], NDIS_WWAN_VENDOR_SPECIFIC structure [Network Drivers Starting with Windows Vista], NDIS_WWAN_VENDOR_SPECIFIC, PNDIS_WWAN_VENDOR_SPECIFIC, _NDIS_WWAN_VENDOR_SPECIFIC
