...
A formatted <a href="/windows-hardware/drivers/ddi/wwan/ns-wwan-_wwan_network_idle_hint">WWAN_NETWORK_IDLE_HINT</a> object that contains the network idle hint.
