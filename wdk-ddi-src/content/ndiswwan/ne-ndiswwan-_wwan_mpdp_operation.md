...
description: The WWAN_MPDP_OPERATION enumeration describes the operation for a mobile broadband miniport driver to perform for a multiple multiple packet data protocol (MPDP) interface.
