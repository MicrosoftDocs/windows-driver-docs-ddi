...
ms.date: 2/16/2018
ms.keywords: PNDIS_WWAN_SET_REGISTER_STATE structure pointer [Network Drivers Starting with Windows Vista], WwanRef_272f8215-ddf9-45b0-b47c-13e12a5a22a8.xml, NDIS_WWAN_SET_REGISTER_STATE structure [Network Drivers Starting with Windows Vista], NDIS_WWAN_SET_REGISTER_STATE, _NDIS_WWAN_SET_REGISTER_STATE, PNDIS_WWAN_SET_REGISTER_STATE, *PNDIS_WWAN_SET_REGISTER_STATE, netvista.ndis_wwan_set_register_state, ndiswwan/PNDIS_WWAN_SET_REGISTER_STATE, ndiswwan/NDIS_WWAN_SET_REGISTER_STATE
