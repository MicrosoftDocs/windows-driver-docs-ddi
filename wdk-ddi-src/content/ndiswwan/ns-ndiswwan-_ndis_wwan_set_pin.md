...
f1_keywords:
 - _NDIS_WWAN_SET_PIN
 - ndiswwan/_NDIS_WWAN_SET_PIN
 - PNDIS_WWAN_SET_PIN
 - ndiswwan/PNDIS_WWAN_SET_PIN
 - NDIS_WWAN_SET_PIN
...
# NDIS_WWAN_SET_PIN structure (ndiswwan.h)
...
A formatted 
     <a href="/windows-hardware/drivers/ddi/wwan/ns-wwan-_wwan_pin_action">WWAN_PIN_ACTION</a> object that represents an
