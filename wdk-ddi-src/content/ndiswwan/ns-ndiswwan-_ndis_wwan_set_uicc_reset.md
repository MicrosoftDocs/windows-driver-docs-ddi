...
ms.date: 1/18/2018
ms.keywords: PNDIS_WWAN_SET_UICC_RESET, NDIS_WWAN_SET_UICC_RESET, PNDIS_WWAN_SET_UICC_RESET structure pointer [Network Drivers Starting with Windows Vista], _NDIS_WWAN_SET_UICC_RESET, NDIS_WWAN_SET_UICC_RESET structure [Network Drivers Starting with Windows Vista], netvista.ndis_wwan_set_uicc_reset, ndiswwan/NDIS_WWAN_SET_UICC_RESET, *PNDIS_WWAN_SET_UICC_RESET, ndiswwan/PNDIS_WWAN_SET_UICC_RESET
