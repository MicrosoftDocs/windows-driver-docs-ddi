...
ms.date: 2/16/2018
ms.keywords: NDIS_WWAN_USSD_EVENT, PNDIS_WWAN_USSD_EVENT structure pointer [Network Drivers Starting with Windows Vista], netvista.ndis_wwan_ussd_event, _NDIS_WWAN_USSD_EVENT, NDIS_WWAN_USSD_EVENT structure [Network Drivers Starting with Windows Vista], PNDIS_WWAN_USSD_EVENT, ndiswwan/PNDIS_WWAN_USSD_EVENT, *PNDIS_WWAN_USSD_EVENT, ndiswwan/NDIS_WWAN_USSD_EVENT
