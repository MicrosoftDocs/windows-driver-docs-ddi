...
# BTHX_SCO_SUPPORT enumeration (bthxddi.h)
...
Upon starting, the Bluetooth stack will query the transport driver for its capabilities by sending the <a href="/windows-hardware/drivers/ddi/bthxddi/ni-bthxddi-ioctl_bthx_query_capabilities">IOCTL_BTHX_QUERY_CAPABILITIES</a> IOCTL.

The output buffer of this IOCTL is defined by the <a href="/windows-hardware/drivers/ddi/bthxddi/ns-bthxddi-_bthx_capabilities">BTHX_CAPABILITIES</a> structure which contains the 
