...
ms.date: 1/4/2018
ms.keywords: usbfnbase/PUSBFN_BUS_CONFIGURATION_INFO, PUSBFN_BUS_CONFIGURATION_INFO structure pointer [Buses], buses.usbfn_bus_configuration_info, USBFN_BUS_CONFIGURATION_INFO structure [Buses], USBFN_BUS_CONFIGURATION_INFO, PUSBFN_BUS_CONFIGURATION_INFO, _USBFN_BUS_CONFIGURATION_INFO, usbfnbase/USBFN_BUS_CONFIGURATION_INFO, *PUSBFN_BUS_CONFIGURATION_INFO
