...
tech.root: stream
ms.date: 04/23/2018
keywords: ["PCAM_PROCESS_RAW_FRAME_ROUTINE_EX callback function"]
...
f1_keywords:
 ...
 - usbcamdi/PCAM_PROCESS_RAW_FRAME_ROUTINE_EX
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
This function is not called if either one of the following bits are set in the <i>CamControlFlag</i> argument passed to the <a href="/windows-hardware/drivers/ddi/usbcamdi/nf-usbcamdi-usbcamd_initializenewinterface">USBCAMD_InitializeNewInterface</a> function:
