...
f1_keywords:
 ...
 - usbcamdi/PCAM_PROCESS_RAW_FRAME_ROUTINE
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
<p class="CCE_Message">[CamProcessRawVideoFrame is not supported and may be altered or unavailable in the future. Instead, use <a href="/windows-hardware/drivers/ddi/usbcamdi/nc-usbcamdi-pcam_process_raw_frame_routine_ex">CamProcessRawVideoFrameEx</a>.
]
