...
ms.date: 11/12/2025
targetos: Windows
description: The PKTMON_CLIENT_COMP_ENABLE callback function is invoked by the PktMonClnt provider to enable or disable packet monitoring for a specific component.
