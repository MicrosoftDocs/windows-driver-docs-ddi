...
title: _ACPI_EVAL_INPUT_BUFFER_SIMPLE_STRING_V1 (acpiioct.h)
...
# ACPI_EVAL_INPUT_BUFFER_SIMPLE_STRING_V1 structure (acpiioct.h)
...
The ACPI_EVAL_INPUT_BUFFER_SIMPLE_STRING structure is used as input to an <a href="/windows-hardware/drivers/ddi/acpiioct/ni-acpiioct-ioctl_acpi_eval_method">IOCTL_ACPI_EVAL_METHOD</a> request and to an <a href="/windows-hardware/drivers/ddi/acpiioct/ni-acpiioct-ioctl_acpi_async_eval_method">IOCTL_ACPI_ASYNC_EVAL_METHOD</a> request. The structure supplies the name of a control method and an input argument that is an ASCII string.
