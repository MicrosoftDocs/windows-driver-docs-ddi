...
ms.date: 2/15/2018
ms.keywords: PACPI_ENUM_CHILDREN_INPUT_BUFFER structure pointer [ACPI Devices], acpiioct/PACPI_ENUM_CHILDREN_INPUT_BUFFER, ACPI_ENUM_CHILDREN_INPUT_BUFFER structure [ACPI Devices], ACPI_ENUM_CHILDREN_INPUT_BUFFER, acpiioct/ACPI_ENUM_CHILDREN_INPUT_BUFFER, _ACPI_ENUM_CHILDREN_INPUT_BUFFER, acpi-meth-eval-ref_3d8ce8a3-94f9-4ea0-9a16-f76c08928fc4.xml, *PACPI_ENUM_CHILDREN_INPUT_BUFFER, acpi.acpi_enum_children_input_buffer, PACPI_ENUM_CHILDREN_INPUT_BUFFER
