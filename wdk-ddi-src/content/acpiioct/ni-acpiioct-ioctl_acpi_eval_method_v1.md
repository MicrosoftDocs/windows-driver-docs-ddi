...
# IOCTL_ACPI_EVAL_METHOD_V1 IOCTL (acpiioct.h)
...
The <a href="/windows-hardware/drivers/ddi/acpiioct/ni-acpiioct-ioctl_acpi_async_eval_method_v1">IOCTL_ACPI_EVAL_METHOD_V1</a> control code synchronously evaluates an ACPI control method that is supported by the device.
