...
ms.date: 12/31/2017
ms.keywords: ACPI_GET_DEVICE_SPECIFIC_DATA structure [ACPI Devices], *PACPI_GET_DEVICE_SPECIFIC_DATA, acpiioct/ACPI_GET_DEVICE_SPECIFIC_DATA, ACPI_GET_DEVICE_SPECIFIC_DATA, _ACPI_GET_DEVICE_SPECIFIC_DATA, PACPI_GET_DEVICE_SPECIFIC_DATA structure pointer [ACPI Devices], acpi.acpi_get_device_specific_data, PACPI_GET_DEVICE_SPECIFIC_DATA, acpiioct/PACPI_GET_DEVICE_SPECIFIC_DATA
