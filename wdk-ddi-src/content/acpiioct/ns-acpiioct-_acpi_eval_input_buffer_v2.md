...
ms.date: 12/31/2017
ms.keywords: ACPI_EVAL_INPUT_BUFFER_V2, _ACPI_EVAL_INPUT_BUFFER_V2, PACPI_EVAL_INPUT_BUFFER_V2, acpiioct/ACPI_EVAL_INPUT_BUFFER_V2, PACPI_EVAL_INPUT_BUFFER_V2 structure pointer [ACPI Devices], acpi.acpi_eval_input_buffer_v2, ACPI_EVAL_INPUT_BUFFER_V2 structure [ACPI Devices], acpiioct/PACPI_EVAL_INPUT_BUFFER_V2, *PACPI_EVAL_INPUT_BUFFER_V2
