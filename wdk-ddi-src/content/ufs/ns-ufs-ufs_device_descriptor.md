...
ms.date: 1/10/2018
ms.keywords: PUFS_DEVICE_DESCRIPTOR structure pointer [Storage Devices], PUFS_DEVICE_DESCRIPTOR, ufs/UFS_DEVICE_DESCRIPTOR, ufs/PUFS_DEVICE_DESCRIPTOR, *PUFS_DEVICE_DESCRIPTOR, UFS_DEVICE_DESCRIPTOR, UFS_DEVICE_DESCRIPTOR structure [Storage Devices], storage.ufs_device_descriptor
