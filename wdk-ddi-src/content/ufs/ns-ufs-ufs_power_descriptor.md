...
ms.date: 2/16/2018
ms.keywords: PUFS_POWER_DESCRIPTOR structure pointer [Storage Devices], PUFS_POWER_DESCRIPTOR, UFS_POWER_DESCRIPTOR structure [Storage Devices], storage.ufs_power_descriptor, UFS_POWER_DESCRIPTOR, ufs/UFS_POWER_DESCRIPTOR, *PUFS_POWER_DESCRIPTOR, ufs/PUFS_POWER_DESCRIPTOR
