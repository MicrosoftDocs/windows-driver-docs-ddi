...
ms.date: 2/22/2018
ms.keywords: GetXpsPart method [Print Devices], GetXpsPart method [Print Devices], IXpsDocumentProvider interface, print.ixpsdocumentprovider_getxpspart, filterpipeline_e99337a9-3674-4d34-886c-684a85a8dd0d.xml, IXpsDocumentProvider::GetXpsPart, GetXpsPart, IXpsDocumentProvider, filterpipeline/IXpsDocumentProvider::GetXpsPart, IXpsDocumentProvider interface [Print Devices], GetXpsPart method
