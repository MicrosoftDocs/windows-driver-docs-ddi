...
ms.date: 2/2/2018
ms.keywords: print.ipartbase_getpartcompression, IPartBase, filterpipeline/IPartBase::GetPartCompression, GetPartCompression method [Print Devices], IPartBase interface, GetPartCompression, IPartBase::GetPartCompression, GetPartCompression method [Print Devices], IPartBase interface [Print Devices], GetPartCompression method, filterpipeline_384bc679-c974-4c0d-86cd-32cdd0ebf7be.xml
