...
ms.date: 1/18/2018
ms.keywords: filterpipeline/IXpsDocumentConsumer::CloseSender, IXpsDocumentConsumer::CloseSender, IXpsDocumentConsumer interface [Print Devices], CloseSender method, filterpipeline_64223953-a027-45c8-b296-a07ef3340a41.xml, CloseSender, CloseSender method [Print Devices], print.ixpsdocumentconsumer_closesender, IXpsDocumentConsumer, CloseSender method [Print Devices], IXpsDocumentConsumer interface
