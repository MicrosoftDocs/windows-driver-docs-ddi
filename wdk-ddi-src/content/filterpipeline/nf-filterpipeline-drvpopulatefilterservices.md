...
The <a href="/windows-hardware/drivers/print/xpsdrv-printer-driver">XPSDrv printer driver</a> can specify filter service provider module using the <<i>FilterServiceProvider</i>>  or <<i>OptionalFilterServiceProvider</i>> element in the <a href="/windows-hardware/drivers/print/filter-pipeline-configuration-file">filter pipeline configuration file</a>.   The service provider module must export the <b>DrvPopulateFilterServices</b> function.

## -see-also

<a href="/windows-hardware/drivers/print/filter-pipeline-configuration-file">Filter pipeline configuration file</a>
...
<a href="/windows-hardware/drivers/print/xpsdrv-printer-driver">XPSDrv printer driver</a>
