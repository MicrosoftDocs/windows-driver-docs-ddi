...
ms.date: 2/22/2018
ms.keywords: IFixedDocumentSequence::GetUri, print.ifixeddocumentsequence_geturi, filterpipeline_6d286919-21a8-40e8-8c6b-dd035ffe0ae1.xml, GetUri method [Print Devices], GetUri method [Print Devices], IFixedDocumentSequence interface, IFixedDocumentSequence interface [Print Devices], GetUri method, GetUri, IFixedDocumentSequence, filterpipeline/IFixedDocumentSequence::GetUri
