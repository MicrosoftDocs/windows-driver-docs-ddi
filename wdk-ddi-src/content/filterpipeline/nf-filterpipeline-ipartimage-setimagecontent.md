...
ms.date: 1/18/2018
ms.keywords: filterpipeline_1bbf6da0-f016-486d-a06d-768614fe1d5a.xml, IPartImage, print.ipartimage_setimagecontent, SetImageContent method [Print Devices], IPartImage interface, SetImageContent method [Print Devices], filterpipeline/IPartImage::SetImageContent, IPartImage::SetImageContent, IPartImage interface [Print Devices], SetImageContent method, SetImageContent
