...
The <b xmlns:loc="https://microsoft.com/wdcml/l10n">IPartBase</b> interface inherits from the <a href="https://docs.microsoft.com/windows/desktop/api/unknwn/nn-unknwn-iunknown">IUnknown</a> interface. <b>IPartBase</b> also has these types of members:
<ul>
