...
ms.date: 2/22/2018
ms.keywords: IPartFont, IPartFont::GetFontProperties, filterpipeline/IPartFont::GetFontProperties, IPartFont interface [Print Devices], GetFontProperties method, GetFontProperties method [Print Devices], GetFontProperties method [Print Devices], IPartFont interface, filterpipeline_a84d2506-3e75-4dc9-ad3e-ef481bd2fd20.xml, GetFontProperties, print.ipartfont_getfontproperties
