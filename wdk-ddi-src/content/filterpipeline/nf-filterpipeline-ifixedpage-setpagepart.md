...
ms.date: 1/18/2018
ms.keywords: IFixedPage::SetPagePart, IFixedPage interface [Print Devices], SetPagePart method, filterpipeline_03059a3d-9aac-4ff2-8506-7754327942f6.xml, SetPagePart, print.ifixedpage_setpagepart, SetPagePart method [Print Devices], IFixedPage interface, IFixedPage, filterpipeline/IFixedPage::SetPagePart, SetPagePart method [Print Devices]
