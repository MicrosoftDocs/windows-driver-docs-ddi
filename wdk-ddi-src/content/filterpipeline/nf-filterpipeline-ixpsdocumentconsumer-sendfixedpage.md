...
ms.date: 2/22/2018
ms.keywords: filterpipeline_fbf758b4-801f-4c68-879c-2820736e459e.xml, SendFixedPage method [Print Devices], IXpsDocumentConsumer interface, IXpsDocumentConsumer::SendFixedPage, IXpsDocumentConsumer, SendFixedPage method [Print Devices], print.ixpsdocumentconsumer_sendfixedpage, IXpsDocumentConsumer interface [Print Devices], SendFixedPage method, SendFixedPage, filterpipeline/IXpsDocumentConsumer::SendFixedPage
