...
ms.date: 2/22/2018
ms.keywords: filterpipeline/IPrintPipelinePropertyBag::GetProperty, IPrintPipelinePropertyBag interface [Print Devices], GetProperty method, GetProperty method [Print Devices], IPrintPipelinePropertyBag, GetProperty, filterpipeline_6a2e804b-b8dd-4e20-a71a-7817181b825c.xml, print.iprintpipelinepropertybag_getproperty, IPrintPipelinePropertyBag::GetProperty, GetProperty method [Print Devices], IPrintPipelinePropertyBag interface
