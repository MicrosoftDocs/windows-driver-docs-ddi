...
ms.date: 2/2/2018
ms.keywords: IXpsDocument::GetThumbnail, print.ixpsdocument_getthumbnail, filterpipeline_dbbd8b80-198b-4cdd-af97-68093d87c4e1.xml, GetThumbnail method [Print Devices], IXpsDocument interface, GetThumbnail, IXpsDocument interface [Print Devices], GetThumbnail method, GetThumbnail method [Print Devices], IXpsDocument, filterpipeline/IXpsDocument::GetThumbnail
