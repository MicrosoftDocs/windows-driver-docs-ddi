...
ms.date: 2/2/2018
ms.keywords: filterpipeline/IPartBase::SetPartCompression, IPartBase::SetPartCompression, IPartBase, IPartBase interface [Print Devices], SetPartCompression method, filterpipeline_5b8af27e-6198-49df-9e01-423c7ea67228.xml, SetPartCompression method [Print Devices], IPartBase interface, SetPartCompression method [Print Devices], SetPartCompression, print.ipartbase_setpartcompression
