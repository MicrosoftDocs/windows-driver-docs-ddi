...
## -description
The <b>IPartPrintTicket</b> interface is the abstraction for a print ticket in an XPS document.



## -inheritance
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IPartPrintTicket</b> interface inherits from <a href="..\filterpipeline\nn-filterpipeline-ipartbase.md">IPartBase</a> but does not have additional members.
