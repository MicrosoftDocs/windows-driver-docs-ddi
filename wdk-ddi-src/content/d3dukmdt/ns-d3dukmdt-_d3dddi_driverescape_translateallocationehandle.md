...
[in/out] On entry, a handle to a DirectX graphics allocation that was returned from [**DxgkddiCreateAllocation**](../d3dkmddi/nc-d3dkmddi-dxgkddi_createallocation.md).
