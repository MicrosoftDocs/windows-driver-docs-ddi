...
ms.date: 12/29/2017
ms.keywords: DXGK_MIRACAST_CHUNK_INFO structure [Display Devices], d3dukmdt/DXGK_MIRACAST_CHUNK_INFO, DXGK_MIRACAST_CHUNK_INFO, display.dxgk_miracast_chunk_info
