...
ms.date: 2/22/2018
ms.keywords: d3dukmdt/DXGKVGPU_ESCAPE_HEAD, _DXGKVGPU_ESCAPE_HEAD, DXGKVGPU_ESCAPE_HEAD structure [Display Devices], display.dxgkvgpu_escape_head_, DXGKVGPU_ESCAPE_HEAD
