...
f1_keywords:
 ...
 - d3d10umddi/PFND3DWDDM2_0DDI_SETHARDWAREPROTECTION
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
A handle to the resource object that was created through a call to the <a href="/windows-hardware/drivers/ddi/d3dumddi/nc-d3dumddi-pfnd3dddi_createresource">CreateResource</a>DDI.
