...
<ul>
<li>
The input and output <a href="/windows/win32/api/windef/ns-windef-rect">RECT</a> structures may be adjusted if the rectangles are not aligned properly according to the requirements of the format.
