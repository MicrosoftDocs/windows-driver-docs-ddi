...
description: PFND3D10DDI_CALCPRIVATERASTERIZERSTATESIZE determines the size of the private memory region used by the user-mode display driver for a rasterizer state.
