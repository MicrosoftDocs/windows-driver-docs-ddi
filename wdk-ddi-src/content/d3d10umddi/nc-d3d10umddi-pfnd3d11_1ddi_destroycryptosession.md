...
ms.topic: callback
f1_keywords:
 - "d3d10umddi/pfnDestroyCryptoSession"
...
Releases resources for the cryptographic session that were created through a call to the <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/d3d10umddi/nc-d3d10umddi-pfnd3d11_1ddi_createcryptosession">CreateCryptoSession</a> function.
