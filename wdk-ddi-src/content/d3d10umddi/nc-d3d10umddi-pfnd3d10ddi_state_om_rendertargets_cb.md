...
ms.date: 05/10/2018
keywords: ["PFND3D10DDI_STATE_OM_RENDERTARGETS_CB callback function"]
...
f1_keywords:
 ...
 - d3d10umddi/PFND3D10DDI_STATE_OM_RENDERTARGETS_CB
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The <b>pfnStateOmRenderTargetsCb</b> function calls the user-mode display driver's <a href="/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d10ddi_setrendertargets">SetRenderTargets</a> function with all of the currently set render target surfaces.
