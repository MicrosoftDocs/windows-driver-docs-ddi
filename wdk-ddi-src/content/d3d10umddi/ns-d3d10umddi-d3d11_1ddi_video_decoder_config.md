...
| **Value** | **Meaning** | 
|:--|:--|
| **pContentKey** | A pointer to the [D3DWDDM2_0DDI_VIDEO_DECODER_BEGIN_FRAME_CRYPTO_SESSION](https://msdn.microsoft.com/library/windows/hardware/dn894618) structure, indicating which CryptoSession and the key information used to decrypt the frame. | 
| **ContentKeySize** | Set to the size of the [D3DWDDM2_0DDI_VIDEO_DECODER_BEGIN_FRAME_CRYPTO_SESSION](https://msdn.microsoft.com/library/windows/hardware/dn894618) structure. | 
