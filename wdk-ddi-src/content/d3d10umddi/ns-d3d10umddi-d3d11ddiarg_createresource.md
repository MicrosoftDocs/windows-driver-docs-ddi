...
description: The D3D11DDIARG_CREATERESOURCE structure describes the parameters that the user-mode display driver uses to create a resource.
...
req.target-min-winverclnt: Windows 7 (WDDM 1.1)
...
A valid bitwise OR of values of type [**D3D10_DDI_RESOURCE_BIND_FLAG**](ne-d3d10umddi-d3d10_ddi_resource_bind_flag.md) that indicates how the resource is bound.
...
A valid bitwise OR of values of type [**D3D10_DDI_RESOURCE_MISC_FLAG**](ne-d3d10umddi-d3d10_ddi_resource_misc_flag.md) that indicates miscellaneous information about the resource.
...
### -field DecoderBufferType [in]

A value of type [**D3D11_DDI_VIDEO_DECODER_BUFFER_TYPE**](ne-d3d10umddi-d3d11_ddi_video_decoder_buffer_type.md) that indicates the  buffer type used by the video decoder.
...
[**CreateResource(D3D11)**](nc-d3d10umddi-pfnd3d11ddi_createresource.md)
...
[**D3D11_DDI_VIDEO_DECODER_BUFFER_TYPE**](ne-d3d10umddi-d3d11_ddi_video_decoder_buffer_type.md)
