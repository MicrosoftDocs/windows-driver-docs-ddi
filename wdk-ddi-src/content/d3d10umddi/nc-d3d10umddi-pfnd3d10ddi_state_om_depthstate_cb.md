...
f1_keywords:
 ...
 - d3d10umddi/PFND3D10DDI_STATE_OM_DEPTHSTATE_CB
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The <b>pfnStateOmDepthStateCb</b> function calls the user-mode display driver's <a href="/windows-hardware/drivers/ddi/d3d10umddi/nc-d3d10umddi-pfnd3d10ddi_setdepthstencilstate">SetDepthStencilState</a> function with the current depth stencil state.
