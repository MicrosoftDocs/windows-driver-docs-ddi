...
ms.date: 2/22/2018
ms.keywords: Selected property [Print Devices], IPrintSchemaOption interface, IPrintSchemaOption.Selected, IPrintSchemaOption, IPrintSchemaOption::get_Selected, print.iprintschemaoption_selected, IPrintSchemaOption interface [Print Devices], Selected property, get_Selected, printerextension/IPrintSchemaOption::Selected, Selected property [Print Devices], printerextension/IPrintSchemaOption::get_Selected
