...
ms.date: 2/22/2018
ms.keywords: NotifyXmlChanged, IPrintSchemaTicket, IPrintSchemaTicket interface [Print Devices], NotifyXmlChanged method, printerextension/IPrintSchemaTicket::NotifyXmlChanged, NotifyXmlChanged method [Print Devices], IPrintSchemaTicket interface, print.iprintschematicket_notifyxmlchanged, NotifyXmlChanged method [Print Devices], IPrintSchemaTicket::NotifyXmlChanged
