...
ms.date: 2/22/2018
ms.keywords: IPrintSchemaFeature::get_DisplayUI, IPrintSchemaFeature interface [Print Devices], DisplayUI property, print.iprintschemafeature_displayui, IPrintSchemaFeature.DisplayUI, IPrintSchemaFeature, printerextension/IPrintSchemaFeature::get_DisplayUI, DisplayUI property [Print Devices], IPrintSchemaFeature interface, printerextension/IPrintSchemaFeature::DisplayUI, get_DisplayUI, DisplayUI property [Print Devices]
