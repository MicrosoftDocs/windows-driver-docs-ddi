...
ms.date: 2/2/2018
ms.keywords: GetCapabilities method [Print Devices], IPrintSchemaTicket interface [Print Devices], GetCapabilities method, GetCapabilities method [Print Devices], IPrintSchemaTicket interface, GetCapabilities, IPrintSchemaTicket::GetCapabilities, printerextension/IPrintSchemaTicket::GetCapabilities, print.iprintschematicket_getcapabilities, IPrintSchemaTicket
