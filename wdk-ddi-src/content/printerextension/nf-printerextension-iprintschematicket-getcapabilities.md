...
ms.date: 2/21/2018
ms.keywords: printerextension/IPrintSchemaTicket::GetCapabilities, GetCapabilities, IPrintSchemaTicket, print.iprintschematicket_getcapabilities, IPrintSchemaTicket::GetCapabilities, GetCapabilities method [Print Devices], IPrintSchemaTicket interface, GetCapabilities method [Print Devices], IPrintSchemaTicket interface [Print Devices], GetCapabilities method
