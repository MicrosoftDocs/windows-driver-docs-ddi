...
ms.date: 1/18/2018
ms.keywords: GetCapabilities method [Print Devices], IPrintSchemaTicket interface, IPrintSchemaTicket interface [Print Devices], GetCapabilities method, printerextension/IPrintSchemaTicket::GetCapabilities, GetCapabilities, GetCapabilities method [Print Devices], print.iprintschematicket_getcapabilities, IPrintSchemaTicket::GetCapabilities, IPrintSchemaTicket
