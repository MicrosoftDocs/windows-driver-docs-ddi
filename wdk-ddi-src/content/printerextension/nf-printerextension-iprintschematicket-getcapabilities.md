...
ms.date: 2/2/2018
ms.keywords: print.iprintschematicket_getcapabilities, IPrintSchemaTicket interface [Print Devices], GetCapabilities method, GetCapabilities method [Print Devices], IPrintSchemaTicket::GetCapabilities, GetCapabilities method [Print Devices], IPrintSchemaTicket interface, IPrintSchemaTicket, printerextension/IPrintSchemaTicket::GetCapabilities, GetCapabilities
