...
ms.date: 2/21/2018
ms.keywords: IPrinterQueueViewEvent interface [Print Devices], OnChanged method, print.iprinterqueueviewevent_onchanged, printerextension/IPrinterQueueViewEvent::OnChanged, IPrinterQueueViewEvent::OnChanged, OnChanged method [Print Devices], IPrinterQueueViewEvent interface, OnChanged method [Print Devices], IPrinterQueueViewEvent, OnChanged
