...
ms.date: 2/22/2018
ms.keywords: print.iprintschemafeature_put_selectedoption, IPrintSchemaFeature, printerextension/IPrintSchemaFeature::put_SelectedOption, IPrintSchemaFeature interface [Print Devices], SelectedOption property, IPrintSchemaFeature::put_SelectedOption, SelectedOption property [Print Devices], IPrintSchemaFeature interface, SelectedOption property [Print Devices], IPrintSchemaFeature.SelectedOption, IPrintSchemaFeature::get_SelectedOption, printerextension/IPrintSchemaFeature::SelectedOption, get_SelectedOption
