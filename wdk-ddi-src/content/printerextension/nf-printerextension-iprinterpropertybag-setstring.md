...
ms.date: 2/21/2018
ms.keywords: printerextension/IPrinterPropertyBag::SetString, IPrinterPropertyBag, SetString, SetString method [Print Devices], IPrinterPropertyBag interface, IPrinterPropertyBag interface [Print Devices], SetString method, print.iprinterpropertybag_setstring, IPrinterPropertyBag::SetString, SetString method [Print Devices]
