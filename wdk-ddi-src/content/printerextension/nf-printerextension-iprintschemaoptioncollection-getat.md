...
ms.date: 2/21/2018
ms.keywords: GetAt, IPrintSchemaOptionCollection, printerextension/IPrintSchemaOptionCollection::GetAt, GetAt method [Print Devices], print.iprintschemaoptioncollection_getat, IPrintSchemaOptionCollection::GetAt, IPrintSchemaOptionCollection interface [Print Devices], GetAt method, GetAt method [Print Devices], IPrintSchemaOptionCollection interface
