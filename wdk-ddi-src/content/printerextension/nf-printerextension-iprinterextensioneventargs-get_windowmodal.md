...
ms.date: 2/21/2018
ms.keywords: print.iprinterextensioneventargs_windowmodal, WindowModal property [Print Devices], IPrinterExtensionEventArgs interface, printerextension/IPrinterExtensionEventArgs::WindowModal, IPrinterExtensionEventArgs.WindowModal, IPrinterExtensionEventArgs::get_WindowModal, IPrinterExtensionEventArgs interface [Print Devices], WindowModal property, printerextension/IPrinterExtensionEventArgs::get_WindowModal, IPrinterExtensionEventArgs, WindowModal property [Print Devices], get_WindowModal
