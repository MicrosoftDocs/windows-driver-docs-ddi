...
ms.date: 2/21/2018
ms.keywords: IPrintJobCollection, get_Count, Count property [Print Devices], IPrinterExtensionContextCollection interface, printerextension/IPrinterExtensionContextCollection::get_Count, IPrinterExtensionContextCollection.Count, IPrinterExtensionContextCollection interface [Print Devices], Count property, print.iprinterextensioncontextcollection_count, IPrintJobCollection::get_Count, IPrinterExtensionContextCollection::get_Count, Count property [Print Devices], printerextension/IPrinterExtensionContextCollection::Count, IPrinterExtensionContextCollection
