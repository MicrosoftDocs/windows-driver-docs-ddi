...
ms.date: 2/22/2018
ms.keywords: IPrinterExtensionContextCollection::get_Count, printerextension/IPrinterExtensionContextCollection::get_Count, IPrinterExtensionContextCollection interface [Print Devices], Count property, Count property [Print Devices], IPrinterExtensionContextCollection interface, IPrintJobCollection, print.iprinterextensioncontextcollection_count, printerextension/IPrinterExtensionContextCollection::Count, IPrintJobCollection::get_Count, get_Count, IPrinterExtensionContextCollection.Count, Count property [Print Devices], IPrinterExtensionContextCollection
