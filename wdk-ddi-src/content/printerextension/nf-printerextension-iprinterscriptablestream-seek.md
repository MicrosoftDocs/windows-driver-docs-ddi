...
ms.date: 2/21/2018
ms.keywords: print.iprinterscriptablestream__seek, IPrinterScriptableStream::Seek, IPrinterScriptableStream, Seek method [Print Devices], Seek, IPrinterScriptableStream interface [Print Devices], Seek method, printerextension/IPrinterScriptableStream::Seek, Seek method [Print Devices], IPrinterScriptableStream interface
