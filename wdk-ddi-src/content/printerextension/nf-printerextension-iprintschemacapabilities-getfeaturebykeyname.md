...
ms.date: 2/22/2018
ms.keywords: printerextension/IPrintSchemaCapabilities::GetFeatureByKeyName, GetFeatureByKeyName method [Print Devices], IPrintSchemaCapabilities interface, IPrintSchemaCapabilities::GetFeatureByKeyName, GetFeatureByKeyName method [Print Devices], IPrintSchemaCapabilities, print.iprintschemacapabilities_getfeaturebykeyname, IPrintSchemaCapabilities interface [Print Devices], GetFeatureByKeyName method, GetFeatureByKeyName
