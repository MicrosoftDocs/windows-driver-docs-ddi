...
ms.date: 1/4/2018
ms.keywords: buses.udecx_wdf_device_config, udecxwdfdevice/UDECX_WDF_DEVICE_CONFIG, UDECX_WDF_DEVICE_CONFIG structure [Buses], PUDECX_WDF_DEVICE_CONFIG, PUDECX_WDF_DEVICE_CONFIG structure pointer [Buses], _UDECX_WDF_DEVICE_CONFIG, *PUDECX_WDF_DEVICE_CONFIG, UDECX_WDF_DEVICE_CONFIG, udecxwdfdevice/PUDECX_WDF_DEVICE_CONFIG
