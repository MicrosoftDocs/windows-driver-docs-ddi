...
# USB_BUS_INTERFACE_USBDI_V1 structure (usbbusif.h)
...
Pointer to a routine that determines whether the USB device is operating at high speed. This routine returns <b>TRUE</b> if the USB device is operating at high speed (USB 2.0-compliant device). Otherwise this routine returns <b>FALSE</b>. For more information about this routine, see <a href="/windows-hardware/drivers/ddi/usbbusif/nc-usbbusif-pusb_busiffn_is_device_high_speed">IsDeviceHighSpeed</a>.
