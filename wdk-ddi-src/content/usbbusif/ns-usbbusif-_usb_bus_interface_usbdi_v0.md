...
For information about how to query for these interfaces, see <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/index">Querying for USB Interfaces</a>. Callers of the routines in this structure can be running at IRQL <= DISPATCH_LEVEL. 
