---
UID: NF:usermode_accessors.WriteBooleanToMode
tech.root: kernel
title: WriteBooleanToMode
ms.date: 07/02/2025
targetos: Windows
description: The WriteBooleanToMode function safely writes a BOOLEAN value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteBooleanToMode
 - usermode_accessors/WriteBooleanToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteBooleanToMode
...
The **WriteBooleanToMode** function safely writes a BOOLEAN value to memory based on the specified processor mode.

## -parameters

### -param Destination

[out] A pointer to the memory location where the BOOLEAN value will be written.
...
This function provides a safe way to write a BOOLEAN value to memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**WriteBooleanToUser**](nf-usermode_accessors-writebooleantouser.md)

[**ReadBooleanFromMode**](nf-usermode_accessors-readbooleanfrommode.md)
