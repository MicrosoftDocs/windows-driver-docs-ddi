---
UID: NF:usermode_accessors.ReadCharFromMode
tech.root: kernel
title: ReadCharFromMode
ms.date: 07/02/2025
targetos: Windows
description: The ReadCharFromMode function safely reads a CHAR value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadCharFromMode
 - usermode_accessors/ReadCharFromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadCharFromMode
...
The **ReadCharFromMode** function safely reads a CHAR value from memory based on the specified processor mode.

## -parameters

### -param Source

[in] A pointer to the memory location from which to read the CHAR value.
...
**ReadCharFromMode** returns the CHAR value read from the specified memory address.

## -remarks

This function provides a safe way to read a CHAR value from memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
