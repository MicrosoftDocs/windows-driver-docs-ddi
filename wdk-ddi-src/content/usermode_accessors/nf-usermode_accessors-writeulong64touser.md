---
UID: NF:usermode_accessors.WriteULong64ToUser
tech.root: kernel
title: WriteULong64ToUser
ms.date: 07/02/2025
targetos: Windows
description: The WriteULong64ToUser function safely writes a ULONG64 value to user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteULong64ToUser
 - usermode_accessors/WriteULong64ToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WriteULong64ToUser
