---
UID: NF:usermode_accessors.WriteLongToMode
tech.root: kernel
title: WriteLongToMode
ms.date: 07/02/2025
targetos: Windows
description: The WriteLongToMode function safely writes a LONG value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteLongToMode
 - usermode_accessors/WriteLongToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteLongToMode
...
[**ReadLongFromMode**](nf-usermode_accessors-readlongfrommode.md)
