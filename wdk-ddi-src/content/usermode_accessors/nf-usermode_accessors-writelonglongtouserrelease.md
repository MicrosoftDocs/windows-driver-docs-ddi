---
UID: NF:usermode_accessors.WriteLonglongToUserRelease
tech.root: kernel
title: WriteLonglongToUserRelease
ms.date: 06/24/2025
targetos: Windows
description: The WriteLonglongToUserRelease function safely writes a LONGLONG value to user-mode memory with release semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteLonglongToUserRelease
 - usermode_accessors/WriteLonglongToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteLonglongToUserRelease
...
The **WriteLonglongToUserRelease** function safely writes a LONGLONG value to user-mode memory with [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).

## -parameters

### -param Destination

[out] A pointer to the user-mode memory location where the LONGLONG value will be written.
...
[**ReadLonglongFromUserAcquire**](nf-usermode_accessors-readlonglongfromuseracquire.md)
