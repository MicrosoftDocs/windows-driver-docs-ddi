---
UID: NF:usermode_accessors.WriteLongPtrToMode
tech.root: kernel
title: WriteLongPtrToMode
ms.date: 07/02/2025
targetos: Windows
description: The WriteLongPtrToMode function safely writes a LONG_PTR value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteLongPtrToMode
 - usermode_accessors/WriteLongPtrToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteLongPtrToMode
...
[out] A pointer to the memory location where the LONG_PTR value will be written.
...
This function provides a safe way to write a LONG_PTR value to memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**WriteLongPtrToUser**](nf-usermode_accessors-writelongptrtouser.md)

[**ReadLongPtrFromMode**](nf-usermode_accessors-readlongptrfrommode.md)
