---
UID: NF:usermode_accessors.WriteULonglongToMode
tech.root: kernel
...
f1_keywords:
 - WriteULonglongToMode
 - usermode_accessors/WriteULonglongToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteULonglongToMode
...
The **WriteULonglongToMode** function safely writes a ULONGLONG value to memory based on the specified processor mode.

## -parameters

### -param Destination

[out] A pointer to the memory location where the ULONGLONG value will be written.
...
This function provides a safe way to write a ULONGLONG value to memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**ReadULonglongFromMode**](nf-usermode_accessors-readulonglongfrommode.md)
