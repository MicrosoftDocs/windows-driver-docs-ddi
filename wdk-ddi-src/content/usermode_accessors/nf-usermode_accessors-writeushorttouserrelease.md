---
UID: NF:usermode_accessors.WriteUShortToUserRelease
tech.root: kernel
title: WriteUShortToUserRelease
ms.date: 06/19/2025
targetos: Windows
description: The WriteUShortToUserRelease function safely writes a USHORT value to user-mode memory with release semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteUShortToUserRelease
 - usermode_accessors/WriteUShortToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteUShortToUserRelease
...
The **WriteUShortToUserRelease** function safely writes a USHORT value to user-mode memory with [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
[**ReadUShortFromUserAcquire**](nf-usermode_accessors-readushortfromuseracquire.md)
