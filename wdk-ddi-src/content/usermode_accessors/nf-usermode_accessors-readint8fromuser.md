---
UID: NF:usermode_accessors.ReadInt8FromUser
tech.root: kernel
title: ReadInt8FromUser
ms.date: 06/24/2025
targetos: Windows
description: The ReadInt8FromUser function safely reads an INT8 value from user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadInt8FromUser
 - usermode_accessors/ReadInt8FromUser
dev_langs:
 - c++
helpviewer_keywords:
 - ReadInt8FromUser
...
The **ReadInt8FromUser** function safely reads an INT8 value from user-mode memory.
...
This function provides a safe way to read an INT8 value from user-mode memory. It ensures the provided address is a user-mode address before reading it.
