---
UID: NF:usermode_accessors.WriteShortToMode
tech.root: kernel
title: WriteShortToMode
ms.date: 07/02/2025
targetos: Windows
description: The WriteShortToMode function safely writes a SHORT value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteShortToMode
 - usermode_accessors/WriteShortToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteShortToMode
...
The **WriteShortToMode** function safely writes a SHORT value to memory based on the specified processor mode.

## -parameters

### -param Destination

[out] A pointer to the memory location where the SHORT value will be written.
...
This function provides a safe way to write a SHORT value to memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**ReadShortFromMode**](nf-usermode_accessors-readshortfrommode.md)
