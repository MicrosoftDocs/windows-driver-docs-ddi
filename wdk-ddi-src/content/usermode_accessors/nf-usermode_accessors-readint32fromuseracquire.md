---
UID: NF:usermode_accessors.ReadInt32FromUserAcquire
tech.root: kernel
title: ReadInt32FromUserAcquire
ms.date: 06/24/2025
targetos: Windows
description: The ReadInt32FromUserAcquire function safely reads an INT32 value from user-mode memory with acquire semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadInt32FromUserAcquire
 - usermode_accessors/ReadInt32FromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadInt32FromUserAcquire
...
The **ReadInt32FromUserAcquire** function safely reads an INT32 value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
[**WriteInt32ToUserRelease**](nf-usermode_accessors-writeint32touserrelease.md)
