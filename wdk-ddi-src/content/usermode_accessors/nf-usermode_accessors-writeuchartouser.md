---
UID: NF:usermode_accessors.WriteUCharToUser
tech.root: kernel
title: WriteUCharToUser
ms.date: 06/24/2025
targetos: Windows
description: The WriteUCharToUser function safely writes a UCHAR value to user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteUCharToUser
 - usermode_accessors/WriteUCharToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WriteUCharToUser
...
[**WriteUCharToUserMode**](nf-usermode_accessors-writeuchartomode.md)
