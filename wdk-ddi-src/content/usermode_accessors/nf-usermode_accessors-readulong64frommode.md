...
f1_keywords:
 - ReadULong64FromMode
 - usermode_accessors/ReadULong64FromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadULong64FromMode
...
The **ReadULong64FromMode** function safely reads a ULONG64 value from memory based on the specified processor mode.

## -parameters

### -param Source

[in] A pointer to the memory location from which to read the ULONG64 value.
...
**ReadULong64FromMode** returns the ULONG64 value read from the specified memory address.

## -remarks

This function provides a safe way to read a ULONG64 value from memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
