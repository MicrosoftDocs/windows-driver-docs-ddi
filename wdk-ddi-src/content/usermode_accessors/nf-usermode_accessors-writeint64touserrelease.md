...
f1_keywords:
 - WriteInt64ToUserRelease
 - usermode_accessors/WriteInt64ToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteInt64ToUserRelease
...
The **WriteInt64ToUserRelease** function safely writes a INT64 value to user-mode memory with [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
[**ReadInt64FromUserAcquire**](nf-usermode_accessors-readint64fromuseracquire.md)
