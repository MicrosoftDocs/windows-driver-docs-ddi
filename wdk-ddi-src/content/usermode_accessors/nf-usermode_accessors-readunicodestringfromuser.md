...
f1_keywords:
 - ReadUnicodeStringFromUser
 - usermode_accessors/ReadUnicodeStringFromUser
dev_langs:
 - c++
helpviewer_keywords:
 - ReadUnicodeStringFromUser
...
The **ReadUnicodeStringFromUser** function safely reads a [UNICODE_STRING](/windows/win32/api/ntdef/ns-ntdef-_unicode_string) structure from user-mode memory.
...
This function provides a safe way to read a  [UNICODE_STRING](/windows/win32/api/ntdef/ns-ntdef-_unicode_string) structure from user-mode memory. It ensures the provided address is a user-mode address before reading it.
