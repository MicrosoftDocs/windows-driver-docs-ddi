---
UID: NF:usermode_accessors.WriteIntPtrToUserRelease
tech.root: kernel
title: WriteIntPtrToUserRelease
ms.date: 07/02/2025
targetos: Windows
description: The WriteIntPtrToUserRelease function safely writes an INT_PTR value to user-mode memory with release semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteIntPtrToUserRelease
 - usermode_accessors/WriteIntPtrToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteIntPtrToUserRelease
...
The **WriteIntPtrToUserRelease** function safely writes an INT_PTR value to user-mode memory with [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).

## -parameters

### -param Destination

[out] A pointer to the user-mode memory location where the INT_PTR value will be written.
...
[**WriteIntPtrToUser**](nf-usermode_accessors-writeintptrtouser.md)

[**ReadIntPtrFromUserAcquire**](nf-usermode_accessors-readintptrfromuseracquire.md)
