---
UID: NF:usermode_accessors.WriteLongToUser
tech.root: kernel
title: WriteLongToUser
ms.date: 07/02/2025
targetos: Windows
description: The WriteLongToUser function safely writes a LONG value to user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteLongToUser
 - usermode_accessors/WriteLongToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WriteLongToUser
