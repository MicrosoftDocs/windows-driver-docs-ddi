---
UID: NF:usermode_accessors.WritePointerToUserRelease
tech.root: kernel
title: WritePointerToUserRelease
ms.date: 06/20/2025
targetos: Windows
description: The WritePointerToUserRelease function safely writes a PVOID value to user-mode memory with release semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WritePointerToUserRelease
 - usermode_accessors/WritePointerToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WritePointerToUserRelease
...
The **WritePointerToUserRelease** function safely writes a PVOID value to user-mode memory with [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
[**WritePointerToUser**](nf-usermode_accessors-writepointertouser.md)

[**ReadPointerFromUserAcquire**](nf-usermode_accessors-readpointerfromuseracquire.md)
