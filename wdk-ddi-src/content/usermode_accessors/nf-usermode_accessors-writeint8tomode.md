---
UID: NF:usermode_accessors.WriteInt8ToMode
tech.root: kernel
title: WriteInt8ToMode
ms.date: 06/24/2025
targetos: Windows
description: The WriteInt8ToMode function safely writes an INT8 value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteInt8ToMode
 - usermode_accessors/WriteInt8ToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteInt8ToMode
...
The **WriteInt8ToMode** function safely writes an INT8 value to memory based on the specified processor mode.

## -parameters

### -param Destination

[out] A pointer to the memory location where the INT8 value will be written.
...
This function provides a safe way to write an INT8 value to memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**WriteInt8ToUser**](nf-usermode_accessors-writeint8touser.md)

[**ReadInt8FromMode**](nf-usermode_accessors-readint8frommode.md)
