---
UID: NF:usermode_accessors.ReadCharFromUserAcquire
tech.root: kernel
title: ReadCharFromUserAcquire
ms.date: 06/24/2025
targetos: Windows
description: The ReadCharFromUserAcquire function safely reads a CHAR value from user-mode memory with acquire semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadCharFromUserAcquire
 - usermode_accessors/ReadCharFromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadCharFromUserAcquire
...
The **ReadCharFromUserAcquire** function safely reads a CHAR value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
This function provides a safe way to read a CHAR value from user-mode memory. It ensures the provided address is a user-mode address before reading it. The [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that subsequent memory operations can't be reordered before this read operation.
...
[**WriteCharToUserRelease**](nf-usermode_accessors-writechartouserrelease.md)
