---
UID: NF:usermode_accessors.ReadInt64FromUserAcquire
tech.root: kernel
title: ReadInt64FromUserAcquire
ms.date: 06/24/2025
targetos: Windows
description: The ReadInt64FromUserAcquire function safely reads an INT64 value from user-mode memory with acquire semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadInt64FromUserAcquire
 - usermode_accessors/ReadInt64FromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadInt64FromUserAcquire
...
The **ReadInt64FromUserAcquire** function safely reads an INT64 value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
This function provides a safe way to read an INT64 value from user-mode memory. It ensures the provided address is a user-mode address before reading it. The [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that subsequent memory operations can't be reordered before this read operation.
...
[**WriteInt64ToUserRelease**](nf-usermode_accessors-writeint64touserrelease.md)
