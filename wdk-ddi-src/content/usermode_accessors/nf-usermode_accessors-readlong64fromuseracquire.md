---
UID: NF:usermode_accessors.ReadLong64FromUserAcquire
tech.root: kernel
title: ReadLong64FromUserAcquire
ms.date: 07/02/2025
targetos: Windows
description: The ReadLong64FromUserAcquire function safely reads a LONG64 value from user-mode memory with acquire semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadLong64FromUserAcquire
 - usermode_accessors/ReadLong64FromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadLong64FromUserAcquire
...
The **ReadLong64FromUserAcquire** function safely reads a LONG64 value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
This function provides a safe way to read a LONG64 value from user-mode memory. It ensures the provided address is a user-mode address before reading it. The [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that subsequent memory operations can't be reordered before this read operation.
...
[**ReadLong64FromUser**](nf-usermode_accessors-readlong64fromuser.md)

[**WriteLong64ToUserRelease**](nf-usermode_accessors-writelong64touserrelease.md)
