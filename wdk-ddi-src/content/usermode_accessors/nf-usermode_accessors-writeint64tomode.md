---
UID: NF:usermode_accessors.WriteInt64ToMode
tech.root: kernel
title: WriteInt64ToMode
ms.date: 07/02/2025
targetos: Windows
description: The WriteInt64ToMode function safely writes a INT64 value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteInt64ToMode
 - usermode_accessors/WriteInt64ToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteInt64ToMode
...
The **WriteInt64ToMode** function safely writes an INT64 value to memory based on the specified processor mode.

## -parameters

### -param Destination

[out] A pointer to the memory location where the INT64 value will be written.
...
This function provides a safe way to write an INT64 value to memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**WriteInt64ToUser**](nf-usermode_accessors-writeint64touser.md)

[**ReadInt64FromMode**](nf-usermode_accessors-readint64frommode.md)
