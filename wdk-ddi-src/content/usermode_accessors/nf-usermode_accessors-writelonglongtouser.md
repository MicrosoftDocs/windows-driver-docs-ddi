...
f1_keywords:
 - WriteLonglongToUser
 - usermode_accessors/WriteLonglongToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WriteLonglongToUser
...
The **WriteLonglongToUser** function safely writes a LONGLONG value to user-mode memory.
...
This function provides a safe way to write a LONGLONG value to user-mode memory. It ensures the provided address is a user-mode address before writing to it.
