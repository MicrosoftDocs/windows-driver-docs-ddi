...
f1_keywords:
 - WriteBooleanToUserRelease
 - usermode_accessors/WriteBooleanToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteBooleanToUserRelease
...
The **WriteBooleanToUserRelease** function safely writes a BOOLEAN value to user-mode memory with [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
[**ReadBooleanFromUserAcquire**](nf-usermode_accessors-readbooleanfromuseracquire.md)
