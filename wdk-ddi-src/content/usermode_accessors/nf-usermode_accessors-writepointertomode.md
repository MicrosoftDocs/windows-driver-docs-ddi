---
UID: NF:usermode_accessors.WritePointerToMode
tech.root: kernel
title: WritePointerToMode
ms.date: 07/02/2025
targetos: Windows
description: The WritePointerToMode function safely writes a PVOID value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WritePointerToMode
 - usermode_accessors/WritePointerToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WritePointerToMode
...
[**ReadPointerFromMode**](nf-usermode_accessors-readpointerfrommode.md)
