...
f1_keywords:
 - WriteInt8ToUserRelease
 - usermode_accessors/WriteInt8ToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteInt8ToUserRelease
...
The **WriteInt8ToUserRelease** function safely writes an INT8 value to user-mode memory with [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
[**ReadInt8FromUserAcquire**](nf-usermode_accessors-readint8fromuseracquire.md)
