---
UID: NF:usermode_accessors.ReadULongPtrFromUserAcquire
tech.root: kernel
title: ReadULongPtrFromUserAcquire
ms.date: 07/02/2025
targetos: Windows
description: The ReadULongPtrFromUserAcquire function safely reads a ULONG_PTR value from user-mode memory with acquire semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadULongPtrFromUserAcquire
 - usermode_accessors/ReadULongPtrFromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadULongPtrFromUserAcquire
...
The **ReadULongPtrFromUserAcquire** function safely reads a ULONG_PTR value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
This function provides a safe way to read a ULONG_PTR value from user-mode memory. It ensures the provided address is a user-mode address before reading it. The [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that subsequent memory operations can't be reordered before this read operation.
...
[**WriteULongPtrToUserRelease**](nf-usermode_accessors-writeulongptrtouserrelease.md)
