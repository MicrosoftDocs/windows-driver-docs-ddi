---
UID: NF:usermode_accessors.ReadNtStatusFromUserAcquire
tech.root: kernel
title: ReadNtStatusFromUserAcquire
ms.date: 07/02/2025
targetos: Windows
description: The ReadNtStatusFromUserAcquire function safely reads an NTSTATUS value from user-mode memory with acquire semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadNtStatusFromUserAcquire
 - usermode_accessors/ReadNtStatusFromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadNtStatusFromUserAcquire
...
The **ReadNtStatusFromUserAcquire** function safely reads an NTSTATUS value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
This function provides a safe way to read an NTSTATUS value from user-mode memory. It ensures the provided address is a user-mode address before reading it. The [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that subsequent memory operations can't be reordered before this read operation.
...
[**WriteNtStatusToUserRelease**](nf-usermode_accessors-writentstatustouserrelease.md)
