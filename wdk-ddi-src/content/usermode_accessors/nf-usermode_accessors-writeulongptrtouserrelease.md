---
UID: NF:usermode_accessors.WriteULongPtrToUserRelease
tech.root: kernel
title: WriteULongPtrToUserRelease
ms.date: 07/02/2025
targetos: Windows
description: The WriteULongPtrToUserRelease function safely writes a ULONG_PTR value to user-mode memory with release semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteULongPtrToUserRelease
 - usermode_accessors/WriteULongPtrToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteULongPtrToUserRelease
...
The **WriteULongPtrToUserRelease** function safely writes a ULONG_PTR value to user-mode memory with [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
This function provides a safe way to write a ULONG_PTR value to user-mode memory. It ensures the provided address is a user-mode address before writing to it. The [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that preceding memory operations can't be reordered after this write operation.
...
[**WriteULongPtrToUser**](nf-usermode_accessors-writeulongptrtouser.md)

[**ReadULongPtrFromUserAcquire**](nf-usermode_accessors-readulongptrfromuseracquire.md)
