---
UID: NF:usermode_accessors.ReadULong64FromUserAcquire
tech.root: kernel
title: ReadULong64FromUserAcquire
ms.date: 07/02/2025
targetos: Windows
description: The ReadULong64FromUserAcquire function safely reads a ULONG64 value from user-mode memory with acquire semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadULong64FromUserAcquire
 - usermode_accessors/ReadULong64FromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadULong64FromUserAcquire
...
The **ReadULong64FromUserAcquire** function safely reads a ULONG64 value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
This function provides a safe way to read a ULONG64 value from user-mode memory. It ensures the provided address is a user-mode address before reading it. The [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that subsequent memory operations can't be reordered before this read operation.
...
[**WriteULong64ToUserRelease**](nf-usermode_accessors-writeulong64touserrelease.md)
