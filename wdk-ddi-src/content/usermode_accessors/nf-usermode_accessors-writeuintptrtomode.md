---
UID: NF:usermode_accessors.WriteUIntPtrToMode
tech.root: kernel
title: WriteUIntPtrToMode
ms.date: 07/02/2025
targetos: Windows
description: The WriteUIntPtrToMode function safely writes a UINT_PTR value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteUIntPtrToMode
 - usermode_accessors/WriteUIntPtrToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteUIntPtrToMode
