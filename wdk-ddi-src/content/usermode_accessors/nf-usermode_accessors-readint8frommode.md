---
UID: NF:usermode_accessors.ReadInt8FromMode
tech.root: kernel
title: ReadInt8FromMode
ms.date: 07/02/2025
targetos: Windows
description: The ReadInt8FromMode function safely reads an INT8 value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadInt8FromMode
 - usermode_accessors/ReadInt8FromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadInt8FromMode
...
The **ReadInt8FromMode** function safely reads an INT8 value from memory based on the specified processor mode.

## -parameters

### -param Source

[in] A pointer to the memory location from which to read the INT8 value.
...
**ReadInt8FromMode** returns the INT8 value read from the specified memory address.

## -remarks

This function provides a safe way to read an INT8 value from memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**WriteInt8ToMode**](nf-usermode_accessors-writeint8tomode.md)
