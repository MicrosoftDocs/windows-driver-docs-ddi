...
This function provides atomic access to a 32-bit value in user-mode memory, performing a bitwise AND operation between the value at **Destination** and **Value**. The interlocked functions provide a simple mechanism for synchronizing access to a variable that is shared by multiple threads.
