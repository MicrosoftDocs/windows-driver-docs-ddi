---
UID: NF:usermode_accessors.ReadInt16FromUserAcquire
tech.root: kernel
title: ReadInt16FromUserAcquire
ms.date: 07/02/2025
targetos: Windows
description: The ReadInt16FromUserAcquire function safely reads an INT16 value from user-mode memory with acquire semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadInt16FromUserAcquire
 - usermode_accessors/ReadInt16FromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadInt16FromUserAcquire
...
The **ReadInt16FromUserAcquire** function safely reads an INT16 value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
This function provides a safe way to read an INT16 value from user-mode memory. It ensures the provided address is a user-mode address before reading it. The [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that subsequent memory operations can't be reordered before this read operation.
...
[**WriteInt16ToUserRelease**](nf-usermode_accessors-writeint16touserrelease.md)
