---
UID: NF:usermode_accessors.ReadLongFromUserAcquire
tech.root: kernel
title: ReadLongFromUserAcquire
ms.date: 07/02/2025
targetos: Windows
description: The ReadLongFromUserAcquire function safely reads a LONG value from user-mode memory with acquire semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadLongFromUserAcquire
 - usermode_accessors/ReadLongFromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadLongFromUserAcquire
...
The **ReadLongFromUserAcquire** function safely reads a LONG value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
This function provides a safe way to read a LONG value from user-mode memory. It ensures the provided address is a user-mode address before reading it. The [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that subsequent memory operations can't be reordered before this read operation.
...
[**ReadLongFromUser**](nf-usermode_accessors-readlongfromuser.md)

[**WriteLongToUserRelease**](nf-usermode_accessors-writelongtouserrelease.md)
