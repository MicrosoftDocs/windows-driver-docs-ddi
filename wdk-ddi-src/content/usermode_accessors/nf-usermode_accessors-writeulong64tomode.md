---
UID: NF:usermode_accessors.WriteULong64ToMode
tech.root: kernel
title: WriteULong64ToMode
ms.date: 07/02/2025
targetos: Windows
description: The WriteULong64ToMode function safely writes a ULONG64 value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteULong64ToMode
 - usermode_accessors/WriteULong64ToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteULong64ToMode
...
The **WriteULong64ToMode** function safely writes a ULONG64 value to memory based on the specified processor mode.

## -parameters

### -param Destination

[out] A pointer to the memory location where the ULONG64 value will be written.
...
This function provides a safe way to write a ULONG64 value to memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**WriteULong64ToUser**](nf-usermode_accessors-writeulong64touser.md)

[**ReadULong64FromMode**](nf-usermode_accessors-readulong64frommode.md)
