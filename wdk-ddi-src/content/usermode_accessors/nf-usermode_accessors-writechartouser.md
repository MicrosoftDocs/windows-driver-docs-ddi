---
UID: NF:usermode_accessors.WriteCharToUser
tech.root: kernel
title: WriteCharToUser
ms.date: 07/02/2025
targetos: Windows
description: The WriteCharToUser function safely writes a CHAR value to user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteCharToUser
 - usermode_accessors/WriteCharToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WriteCharToUser
