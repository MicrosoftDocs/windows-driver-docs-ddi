---
UID: NF:usermode_accessors.ReadLongPtrFromUser
tech.root: kernel
title: ReadLongPtrFromUser
ms.date: 07/02/2025
targetos: Windows
description: The ReadLongPtrFromUser function safely reads a LONG_PTR value from user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadLongPtrFromUser
 - usermode_accessors/ReadLongPtrFromUser
dev_langs:
 - c++
helpviewer_keywords:
 - ReadLongPtrFromUser
...
The **ReadLongPtrFromUser** function safely reads a LONG_PTR value from user-mode memory.
...
This function provides a safe way to read a LONG_PTR value from user-mode memory. It ensures the provided address is a user-mode address before reading it.
