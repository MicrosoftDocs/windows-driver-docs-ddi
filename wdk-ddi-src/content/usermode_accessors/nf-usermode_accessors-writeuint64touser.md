---
UID: NF:usermode_accessors.WriteUInt64ToUser
tech.root: kernel
title: WriteUInt64ToUser
ms.date: 07/02/2025
targetos: Windows
description: The WriteUInt64ToUser function safely writes a UINT64 value to user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteUInt64ToUser
 - usermode_accessors/WriteUInt64ToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WriteUInt64ToUser
