---
UID: NF:usermode_accessors.ReadLargeIntegerFromMode
tech.root: kernel
title: ReadLargeIntegerFromMode
ms.date: 07/02/2025
targetos: Windows
description: The ReadLargeIntegerFromMode function safely reads a LARGE_INTEGER value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadLargeIntegerFromMode
 - usermode_accessors/ReadLargeIntegerFromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadLargeIntegerFromMode
...
[**ReadLargeIntegerFromUser**](nf-usermode_accessors-readlargeintegerfromuser.md)

[**WriteLargeIntegerToMode**](nf-usermode_accessors-writelargeintegertomode.md)
