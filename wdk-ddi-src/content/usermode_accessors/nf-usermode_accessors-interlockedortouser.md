---
UID: NF:usermode_accessors.InterlockedOrToUser
tech.root: kernel
title: InterlockedOrToUser
ms.date: 07/02/2025
targetos: Windows
description: The InterlockedOrToUser function performs an atomic OR operation on a 32-bit value in user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - InterlockedOrToUser
 - usermode_accessors/InterlockedOrToUser
dev_langs:
 - c++
helpviewer_keywords:
 - InterlockedOrToUser
...
This function provides atomic access to a 32-bit value in user-mode memory, performing a bitwise OR operation between the value at **Destination** and **Value**. The interlocked functions provide a simple mechanism for synchronizing access to a variable that is shared by multiple threads.
