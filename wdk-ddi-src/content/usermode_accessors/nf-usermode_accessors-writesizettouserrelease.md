---
UID: NF:usermode_accessors.WriteSizeTToUserRelease
tech.root: kernel
title: WriteSizeTToUserRelease
ms.date: 07/02/2025
targetos: Windows
description: The WriteSizeTToUserRelease function safely writes a SIZE_T value to user-mode memory with release semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteSizeTToUserRelease
 - usermode_accessors/WriteSizeTToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteSizeTToUserRelease
...
The **WriteSizeTToUserRelease** function safely writes a SIZE_T value to user-mode memory with [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).

## -parameters

### -param Destination

[out] A pointer to the user-mode memory location where the SIZE_T value will be written.
...
[**WriteSizeTToUser**](nf-usermode_accessors-writesizettouser.md)

[**ReadSizeTFromUserAcquire**](nf-usermode_accessors-readsizetfromuseracquire.md)
