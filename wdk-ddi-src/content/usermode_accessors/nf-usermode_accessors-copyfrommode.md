...
If you are copying from a fixed-sized structure, you should use [**ReadStructFromMode**](nf-usermode_accessors-readstructfrommode.md) instead, so as to avoid the risk of passing the wrong size.
