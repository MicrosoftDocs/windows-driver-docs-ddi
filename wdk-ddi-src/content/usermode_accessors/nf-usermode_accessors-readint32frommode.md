---
UID: NF:usermode_accessors.ReadInt32FromMode
tech.root: kernel
title: ReadInt32FromMode
ms.date: 07/02/2025
targetos: Windows
description: The ReadInt32FromMode function safely reads an INT32 value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadInt32FromMode
 - usermode_accessors/ReadInt32FromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadInt32FromMode
...
The **ReadInt32FromMode** function safely reads an INT32 value from memory based on the specified processor mode.

## -parameters

### -param Source

[in] A pointer to the memory location from which to read the INT32 value.
...
**ReadInt32FromMode** returns the INT32 value read from the specified memory address.

## -remarks

This function provides a safe way to read an INT32 value from memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
