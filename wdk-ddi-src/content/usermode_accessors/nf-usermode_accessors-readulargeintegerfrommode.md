---
UID: NF:usermode_accessors.ReadULargeIntegerFromMode
tech.root: kernel
title: ReadULargeIntegerFromMode
ms.date: 07/02/2025
targetos: Windows
description: The ReadULargeIntegerFromMode function safely reads a ULARGE_INTEGER value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadULargeIntegerFromMode
 - usermode_accessors/ReadULargeIntegerFromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadULargeIntegerFromMode
...
The **ReadULargeIntegerFromMode** function safely reads a ULARGE_INTEGER value from memory based on the specified processor mode.

## -parameters

### -param Source

[in] A pointer to the memory location from which to read the ULARGE_INTEGER value.
...
This function provides a safe way to read a ULARGE_INTEGER value from memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**ReadULargeIntegerFromUser**](nf-usermode_accessors-readulargeintegerfromuser.md)

[**WriteULargeIntegerToMode**](nf-usermode_accessors-writeulargeintegertomode.md)
