---
UID: NF:usermode_accessors.ReadULongFromMode
tech.root: kernel
title: ReadULongFromMode
ms.date: 07/02/2025
targetos: Windows
description: The ReadULongFromMode function safely reads a ULONG value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadULongFromMode
 - usermode_accessors/ReadULongFromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadULongFromMode
...
The **ReadULongFromMode** function safely reads a ULONG value from memory based on the specified processor mode.

## -parameters

### -param Source

[in] A pointer to the memory location from which to read the ULONG value.
...
**ReadULongFromMode** returns the ULONG value read from the specified memory address.

## -remarks

This function provides a safe way to read a ULONG value from memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**ReadULongFromUser**](nf-usermode_accessors-readulongfromuser.md)

[**WriteULongToMode**](nf-usermode_accessors-writeulongtomode.md)
