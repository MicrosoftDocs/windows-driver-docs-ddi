...
f1_keywords:
 - WriteLongToUserRelease
 - usermode_accessors/WriteLongToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteLongToUserRelease
...
The **WriteLongToUserRelease** function safely writes a LONG value to user-mode memory with [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).

## -parameters

### -param Destination

[out] A pointer to the user-mode memory location where the LONG value will be written.
...
This function provides a safe way to write a LONG value to user-mode memory. It ensures the provided address is a user-mode address before writing to it. The [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that preceding memory operations can't be reordered after this write operation.
...
[**WriteLongToUser**](nf-usermode_accessors-writelongtouser.md)

[**ReadLongFromUserAcquire**](nf-usermode_accessors-readlongfromuseracquire.md)
