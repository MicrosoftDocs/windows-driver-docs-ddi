---
UID: NF:usermode_accessors.ReadPointerFromUserAcquire
tech.root: kernel
title: ReadPointerFromUserAcquire
ms.date: 06/20/2025
targetos: Windows
description: The ReadPointerFromUserAcquire function safely reads a PVOID value from user-mode memory with acquire semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadPointerFromUserAcquire
 - usermode_accessors/ReadPointerFromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadPointerFromUserAcquire
...
The **ReadPointerFromUserAcquire** function safely reads a PVOID value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
This function provides a safe way to read a PVOID value from user-mode memory. It ensures the provided address is a user-mode address before reading it. The [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that subsequent memory operations can't be reordered before this read operation.
...
[**WritePointerToUserRelease**](nf-usermode_accessors-writepointertouserrelease.md)
