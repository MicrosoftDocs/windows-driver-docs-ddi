---
UID: NF:usermode_accessors.InterlockedCompareExchange64ToUser
tech.root: kernel
title: InterlockedCompareExchange64ToUser
ms.date: 07/02/2025
targetos: Windows
description: The InterlockedCompareExchange64ToUser function performs an atomic compare-and-exchange operation on a 64-bit value in user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - InterlockedCompareExchange64ToUser
 - usermode_accessors/InterlockedCompareExchange64ToUser
dev_langs:
 - c++
helpviewer_keywords:
 - InterlockedCompareExchange64ToUser
...
[in, out] A pointer to the user-mode memory location containing the destination value.
