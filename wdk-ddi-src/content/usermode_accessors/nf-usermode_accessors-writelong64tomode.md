...
f1_keywords:
 - WriteLong64ToMode
 - usermode_accessors/WriteLong64ToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteLong64ToMode
...
The **WriteLong64ToMode** function safely writes a LONG64 value to memory based on the specified processor mode.

## -parameters

### -param Destination

[out] A pointer to the memory location where the LONG64 value will be written.
...
This function provides a safe way to write a LONG64 value to memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**ReadLong64FromMode**](nf-usermode_accessors-readlong64frommode.md)
