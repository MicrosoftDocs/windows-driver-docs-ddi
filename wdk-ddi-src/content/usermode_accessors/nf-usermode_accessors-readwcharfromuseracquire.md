---
UID: NF:usermode_accessors.ReadWCharFromUserAcquire
tech.root: kernel
title: ReadWCharFromUserAcquire
ms.date: 07/02/2025
targetos: Windows
description: The ReadWCharFromUserAcquire function safely reads a WCHAR value from user-mode memory with acquire semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadWCharFromUserAcquire
 - usermode_accessors/ReadWCharFromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadWCharFromUserAcquire
...
The **ReadWCharFromUserAcquire** function safely reads a WCHAR value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
This function provides a safe way to read a WCHAR value from user-mode memory. It ensures the provided address is a user-mode address before reading it. The [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that subsequent memory operations can't be reordered before this read operation.
...
[**WriteWCharToUserRelease**](nf-usermode_accessors-writewchartouserrelease.md)
