---
UID: NF:usermode_accessors.WriteIntPtrToUser
tech.root: kernel
title: WriteIntPtrToUser
ms.date: 07/02/2025
targetos: Windows
description: The WriteIntPtrToUser function safely writes an INT_PTR value to user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteIntPtrToUser
 - usermode_accessors/WriteIntPtrToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WriteIntPtrToUser
...
The **WriteIntPtrToUser** function safely writes an INT_PTR value to user-mode memory.
