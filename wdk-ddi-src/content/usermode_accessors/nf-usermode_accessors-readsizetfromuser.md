...
f1_keywords:
 - ReadSizeTFromUser
 - usermode_accessors/ReadSizeTFromUser
dev_langs:
 - c++
helpviewer_keywords:
 - ReadSizeTFromUser
...
[in] A pointer to the user-mode memory location from which to read the SIZE_T value.
...
This function provides a safe way to read a SIZE_T value from user-mode memory. It ensures the provided address is a user-mode address before reading it.
...
[**ReadSizeTFromMode**](nf-usermode_accessors-readsizetfrommode.md)
