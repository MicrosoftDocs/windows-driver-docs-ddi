---
UID: NF:usermode_accessors.ReadInt16FromMode
tech.root: kernel
title: ReadInt16FromMode
ms.date: 06/24/2025
targetos: Windows
description: The ReadInt16FromMode function safely reads an INT16 value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadInt16FromMode
 - usermode_accessors/ReadInt16FromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadInt16FromMode
