---
UID: NF:usermode_accessors.WriteNtStatusToMode
tech.root: kernel
title: WriteNtStatusToMode
ms.date: 07/02/2025
targetos: Windows
description: The WriteNtStatusToMode function safely writes an NTSTATUS value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteNtStatusToMode
 - usermode_accessors/WriteNtStatusToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteNtStatusToMode
...
The **WriteNtStatusToMode** function safely writes an NTSTATUS value to memory based on the specified processor mode.

## -parameters

### -param Destination

[out] A pointer to the memory location where the NTSTATUS value will be written.
...
This function provides a safe way to write an NTSTATUS value to memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**WriteNtStatusToUser**](nf-usermode_accessors-writentstatustouser.md)

[**ReadNtStatusFromMode**](nf-usermode_accessors-readntstatusfrommode.md)
