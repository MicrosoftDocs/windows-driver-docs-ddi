---
UID: NF:usermode_accessors.ReadIntPtrFromUser
tech.root: kernel
title: ReadIntPtrFromUser
ms.date: 07/02/2025
targetos: Windows
description: The ReadIntPtrFromUser function safely reads an INT_PTR value from user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadIntPtrFromUser
 - usermode_accessors/ReadIntPtrFromUser
dev_langs:
 - c++
helpviewer_keywords:
 - ReadIntPtrFromUser
...
The **ReadIntPtrFromUser** function safely reads an INT_PTR value from user-mode memory.
...
This function provides a safe way to read an INT_PTR value from user-mode memory. It ensures the provided address is a user-mode address before reading it.
...
[**ReadIntPtrFromMode**](nf-usermode_accessors-readintptrfrommode.md)
