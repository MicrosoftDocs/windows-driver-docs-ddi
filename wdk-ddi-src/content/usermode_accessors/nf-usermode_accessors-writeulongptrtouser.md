---
UID: NF:usermode_accessors.WriteULongPtrToUser
tech.root: kernel
title: WriteULongPtrToUser
ms.date: 06/20/2025
targetos: Windows
description: The WriteULongPtrToUser function safely writes a ULONG_PTR value to user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteULongPtrToUser
 - usermode_accessors/WriteULongPtrToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WriteULongPtrToUser
