...
f1_keywords:
 - WriteInt16ToMode
 - usermode_accessors/WriteInt16ToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteInt16ToMode
...
The **WriteInt16ToMode** function safely writes an INT16 value to memory based on the specified processor mode.

## -parameters

### -param Destination

[out] A pointer to the memory location where the INT16 value will be written.
...
VOID
Writeint16tomode (
    _Out_ volatile INT16* Destination,
    _In_ INT16 Value,
...
This function provides a safe way to write an INT16 value to memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**WriteInt16ToUser**](nf-usermode_accessors-writeint16touser.md)

[**ReadInt16FromMode**](nf-usermode_accessors-readint16frommode.md)
