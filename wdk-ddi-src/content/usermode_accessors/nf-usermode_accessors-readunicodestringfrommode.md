---
UID: NF:usermode_accessors.ReadUnicodeStringFromMode
tech.root: kernel
title: ReadUnicodeStringFromMode
ms.date: 07/02/2025
targetos: Windows
description: The ReadUnicodeStringFromMode function safely reads a UNICODE_STRING structure from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadUnicodeStringFromMode
 - usermode_accessors/ReadUnicodeStringFromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadUnicodeStringFromMode
...
The **ReadUnicodeStringFromMode** function safely reads a [UNICODE_STRING](/windows/win32/api/ntdef/ns-ntdef-_unicode_string) structure from memory based on the specified processor mode.

## -parameters

### -param Source

[in] A pointer to the memory location from which to read the [UNICODE_STRING](/windows/win32/api/ntdef/ns-ntdef-_unicode_string) structure.
...
This function provides a safe way to read a [UNICODE_STRING](/windows/win32/api/ntdef/ns-ntdef-_unicode_string) structure from memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
