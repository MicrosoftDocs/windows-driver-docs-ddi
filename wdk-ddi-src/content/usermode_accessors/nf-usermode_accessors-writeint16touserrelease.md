---
UID: NF:usermode_accessors.WriteInt16ToUserRelease
tech.root: kernel
title: WriteInt16ToUserRelease
ms.date: 07/02/2025
targetos: Windows
description: The WriteInt16ToUserRelease function safely writes an INT16 value to user-mode memory with release semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteInt16ToUserRelease
 - usermode_accessors/WriteInt16ToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteInt16ToUserRelease
...
The **WriteInt16ToUserRelease** function safely writes an INT16 value to user-mode memory with [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
[**ReadInt16FromUserAcquire**](nf-usermode_accessors-readint16fromuseracquire.md)
