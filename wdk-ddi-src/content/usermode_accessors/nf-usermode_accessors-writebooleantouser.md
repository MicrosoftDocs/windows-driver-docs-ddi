---
UID: NF:usermode_accessors.WriteBooleanToUser
tech.root: kernel
title: WriteBooleanToUser
ms.date: 07/02/2025
targetos: Windows
description: The WriteBooleanToUser function safely writes a BOOLEAN value to user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteBooleanToUser
 - usermode_accessors/WriteBooleanToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WriteBooleanToUser
