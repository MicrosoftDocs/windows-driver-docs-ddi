---
UID: NF:usermode_accessors.ReadBooleanFromUserAcquire
tech.root: kernel
title: ReadBooleanFromUserAcquire
ms.date: 07/02/2025
targetos: Windows
description: The ReadBooleanFromUserAcquire function safely reads a BOOLEAN value from user-mode memory with acquire semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadBooleanFromUserAcquire
 - usermode_accessors/ReadBooleanFromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadBooleanFromUserAcquire
...
The **ReadBooleanFromUserAcquire** function safely reads a BOOLEAN value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).

## -parameters

### -param Source

[in] A pointer to the user-mode memory location from which to read the BOOLEAN value.
...
This function provides a safe way to read a BOOLEAN value from user-mode memory. It ensures the provided address is a user-mode address before reading it. The [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that subsequent memory operations can't be reordered before this read operation.
...
[**WriteBooleanToUserRelease**](nf-usermode_accessors-writebooleantouserrelease.md)
