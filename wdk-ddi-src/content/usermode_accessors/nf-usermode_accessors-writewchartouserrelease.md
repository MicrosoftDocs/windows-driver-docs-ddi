...
f1_keywords:
 - WriteWCharToUserRelease
 - usermode_accessors/WriteWCharToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteWCharToUserRelease
...
The **WriteWCharToUserRelease** function safely writes a WCHAR value to user-mode memory with [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
[**ReadWCharFromUserAcquire**](nf-usermode_accessors-readwcharfromuseracquire.md)
