---
UID: NF:usermode_accessors.WriteULong64ToUserRelease
tech.root: kernel
title: WriteULong64ToUserRelease
ms.date: 07/02/2025
targetos: Windows
description: The WriteULong64ToUserRelease function safely writes a ULONG64 value to user-mode memory with release semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteULong64ToUserRelease
 - usermode_accessors/WriteULong64ToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteULong64ToUserRelease
...
The **WriteULong64ToUserRelease** function safely writes a ULONG64 value to user-mode memory with [release semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
[**ReadULong64FromUserAcquire**](nf-usermode_accessors-readulong64fromuseracquire.md)
