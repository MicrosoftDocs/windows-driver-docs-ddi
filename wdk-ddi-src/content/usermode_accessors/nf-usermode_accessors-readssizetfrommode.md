---
UID: NF:usermode_accessors.ReadSSizeTFromMode
tech.root: kernel
title: ReadSSizeTFromMode
ms.date: 07/02/2025
targetos: Windows
description: The ReadSSizeTFromMode function safely reads a SSIZE_T value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadSSizeTFromMode
 - usermode_accessors/ReadSSizeTFromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadSSizeTFromMode
...
The **ReadSSizeTFromMode** function safely reads a SSIZE_T value from memory based on the specified processor mode.

## -parameters

### -param Source

[in] A pointer to the memory location from which to read the SSIZE_T value.
...
**ReadSSizeTFromMode** returns the SSIZE_T value read from the specified memory address.

## -remarks

This function provides a safe way to read a SSIZE_T value from memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**ReadSSizeTFromUser**](nf-usermode_accessors-readssizetfromuser.md)

[**WriteSSizeTToMode**](nf-usermode_accessors-writessizettomode.md)
