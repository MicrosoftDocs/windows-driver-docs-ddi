---
UID: NF:usermode_accessors.ReadIntPtrFromMode
tech.root: kernel
title: ReadIntPtrFromMode
ms.date: 07/02/2025
targetos: Windows
description: The ReadIntPtrFromMode function safely reads an INT_PTR value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadIntPtrFromMode
 - usermode_accessors/ReadIntPtrFromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadIntPtrFromMode
...
The **ReadIntPtrFromMode** function safely reads an INT_PTR value from memory based on the specified processor mode.

## -parameters

### -param Source

[in] A pointer to the memory location from which to read the INT_PTR value.
...
**ReadIntPtrFromMode** returns the INT_PTR value read from the specified memory address.

## -remarks

This function provides a safe way to read an INT_PTR value from memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**ReadIntPtrFromUser**](nf-usermode_accessors-readintptrfromuser.md)

[**WriteIntPtrToMode**](nf-usermode_accessors-writeintptrtomode.md)
