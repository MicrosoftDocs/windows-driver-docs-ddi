---
UID: NF:usermode_accessors.WriteLonglongToMode
tech.root: kernel
title: WriteLonglongToMode
ms.date: 07/02/2025
targetos: Windows
description: The WriteLonglongToMode function safely writes a LONGLONG value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteLonglongToMode
 - usermode_accessors/WriteLonglongToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteLonglongToMode
...
[out] A pointer to the memory location where the LONGLONG value will be written.
...
This function provides a safe way to write a LONGLONG value to memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**WriteLonglongToUser**](nf-usermode_accessors-writelonglongtouser.md)

[**ReadLonglongFromMode**](nf-usermode_accessors-readlonglongfrommode.md)
