...
f1_keywords:
 - ReadUIntPtrFromUserAcquire
 - usermode_accessors/ReadUIntPtrFromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadUIntPtrFromUserAcquire
...
The **ReadUIntPtrFromUserAcquire** function safely reads a UINT_PTR value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
This function provides a safe way to read a UINT_PTR value from user-mode memory. It ensures the provided address is a user-mode address before reading it. The [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that subsequent memory operations can't be reordered before this read operation.
...
[**ReadUIntPtrFromUser**](nf-usermode_accessors-readuintptrfromuser.md)

[**WriteUIntPtrToUserRelease**](nf-usermode_accessors-writeuintptrtouserrelease.md)
