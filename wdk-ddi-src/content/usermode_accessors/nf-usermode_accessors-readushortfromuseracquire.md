---
UID: NF:usermode_accessors.ReadUShortFromUserAcquire
tech.root: kernel
title: ReadUShortFromUserAcquire
ms.date: 07/02/2025
targetos: Windows
description: The ReadUShortFromUserAcquire function safely reads a USHORT value from user-mode memory with acquire semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadUShortFromUserAcquire
 - usermode_accessors/ReadUShortFromUserAcquire
dev_langs:
 - c++
helpviewer_keywords:
 - ReadUShortFromUserAcquire
...
The **ReadUShortFromUserAcquire** function safely reads a USHORT value from user-mode memory with [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics).
...
This function provides a safe way to read a USHORT value from user-mode memory. It ensures the provided address is a user-mode address before reading it. The [acquire semantics](/windows-hardware/drivers/kernel/acquire-and-release-semantics) ensure that subsequent memory operations can't be reordered before this read operation.
...
[**WriteUShortToUserRelease**](nf-usermode_accessors-writeushorttouserrelease.md)
