---
UID: NF:usermode_accessors.WriteUInt64ToUserRelease
tech.root: kernel
title: WriteUInt64ToUserRelease
ms.date: 07/02/2025
targetos: Windows
description: The WriteUInt64ToUserRelease function safely writes a UINT64 value to user-mode memory with release semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteUInt64ToUserRelease
 - usermode_accessors/WriteUInt64ToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteUInt64ToUserRelease
...
[out] A pointer to the user-mode memory location where the UINT64 value will be written.
...
VOID
Writeuint64touserrelease (
    _Out_ volatile UINT64* Destination,
    _In_ UINT64 Value
    );
```
