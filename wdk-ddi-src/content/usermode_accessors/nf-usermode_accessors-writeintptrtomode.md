---
UID: NF:usermode_accessors.WriteIntPtrToMode
tech.root: kernel
title: WriteIntPtrToMode
ms.date: 07/02/2025
targetos: Windows
description: The WriteIntPtrToMode function safely writes an INT_PTR value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteIntPtrToMode
 - usermode_accessors/WriteIntPtrToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteIntPtrToMode
