---
UID: NF:usermode_accessors.WriteCharToMode
tech.root: kernel
title: WriteCharToMode
ms.date: 06/24/2025
targetos: Windows
description: The WriteCharToMode function safely writes a CHAR value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteCharToMode
 - usermode_accessors/WriteCharToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteCharToMode
...
[**ReadCharFromMode**](nf-usermode_accessors-readcharfrommode.md)
