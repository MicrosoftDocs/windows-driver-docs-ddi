...
f1_keywords:
 - ReadLong64FromUser
 - usermode_accessors/ReadLong64FromUser
dev_langs:
 - c++
helpviewer_keywords:
 - ReadLong64FromUser
...
The **ReadLong64FromUser** function safely reads a LONG64 value from user-mode memory.
...
This function provides a safe way to read a LONG64 value from user-mode memory. It ensures the provided address is a user-mode address before reading it.
