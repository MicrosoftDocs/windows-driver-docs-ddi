---
UID: NF:usermode_accessors.WriteUnicodeStringToUser
tech.root: kernel
title: WriteUnicodeStringToUser
ms.date: 07/02/2025
targetos: Windows
description: The WriteUnicodeStringToUser function safely writes a UNICODE_STRING structure to user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteUnicodeStringToUser
 - usermode_accessors/WriteUnicodeStringToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WriteUnicodeStringToUser
...
The **WriteUnicodeStringToUser** function safely writes a [UNICODE_STRING](/windows/win32/api/ntdef/ns-ntdef-_unicode_string) structure to user-mode memory.

## -parameters

### -param Destination

[out] A pointer to the user-mode memory location where the [UNICODE_STRING](/windows/win32/api/ntdef/ns-ntdef-_unicode_string) structure will be written.
...
[**ReadUnicodeStringFromUser**](nf-usermode_accessors-readunicodestringfromuser.md)

[**WriteUnicodeStringToMode**](nf-usermode_accessors-writeunicodestringtomode.md)
