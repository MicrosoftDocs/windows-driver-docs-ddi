---
UID: NF:usermode_accessors.ReadUInt8FromMode
tech.root: kernel
title: ReadUInt8FromMode
ms.date: 07/02/2025
targetos: Windows
description: The ReadUInt8FromMode function safely reads a UINT8 value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadUInt8FromMode
 - usermode_accessors/ReadUInt8FromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadUInt8FromMode
...
[**WriteUInt8ToMode**](nf-usermode_accessors-writeuint8tomode.md)
