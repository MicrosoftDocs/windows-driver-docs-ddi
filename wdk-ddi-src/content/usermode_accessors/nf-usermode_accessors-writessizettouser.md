---
UID: NF:usermode_accessors.WriteSSizeTToUser
tech.root: kernel
title: WriteSSizeTToUser
ms.date: 07/02/2025
targetos: Windows
description: The WriteSSizeTToUser function safely writes a SSIZE_T value to user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteSSizeTToUser
 - usermode_accessors/WriteSSizeTToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WriteSSizeTToUser
