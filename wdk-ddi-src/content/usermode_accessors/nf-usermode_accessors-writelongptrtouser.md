---
UID: NF:usermode_accessors.WriteLongPtrToUser
tech.root: kernel
title: WriteLongPtrToUser
ms.date: 07/02/2025
targetos: Windows
description: The WriteLongPtrToUser function safely writes a LONG_PTR value to user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteLongPtrToUser
 - usermode_accessors/WriteLongPtrToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WriteLongPtrToUser
...
The **WriteLongPtrToUser** function safely writes a LONG_PTR value to user-mode memory.

## -parameters

### -param Destination

[out] A pointer to the user-mode memory location where the LONG_PTR value will be written.
