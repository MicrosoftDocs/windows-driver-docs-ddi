---
UID: NF:usermode_accessors.WriteUInt32ToUserRelease
tech.root: kernel
title: WriteUInt32ToUserRelease
ms.date: 07/02/2025
targetos: Windows
description: The WriteUInt32ToUserRelease function safely writes a UINT32 value to user-mode memory with release semantics.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteUInt32ToUserRelease
 - usermode_accessors/WriteUInt32ToUserRelease
dev_langs:
 - c++
helpviewer_keywords:
 - WriteUInt32ToUserRelease
...
[out] A pointer to the user-mode memory location where the UINT32 value will be written.
