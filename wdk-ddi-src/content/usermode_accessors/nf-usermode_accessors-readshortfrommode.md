---
UID: NF:usermode_accessors.ReadShortFromMode
tech.root: kernel
title: ReadShortFromMode
ms.date: 06/20/2025
targetos: Windows
description: The ReadShortFromMode function safely reads a SHORT value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadShortFromMode
 - usermode_accessors/ReadShortFromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadShortFromMode
...
[**WriteShortToMode**](nf-usermode_accessors-writeshorttomode.md)
