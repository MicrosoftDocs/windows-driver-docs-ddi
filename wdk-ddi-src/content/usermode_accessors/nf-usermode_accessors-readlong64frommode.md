---
UID: NF:usermode_accessors.ReadLong64FromMode
tech.root: kernel
title: ReadLong64FromMode
ms.date: 07/02/2025
targetos: Windows
description: The ReadLong64FromMode function safely reads a LONG64 value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadLong64FromMode
 - usermode_accessors/ReadLong64FromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadLong64FromMode
...
[**WriteLong64ToMode**](nf-usermode_accessors-writelong64tomode.md)
