---
UID: NF:usermode_accessors.ReadSizeTFromMode
tech.root: kernel
title: ReadSizeTFromMode
ms.date: 07/02/2025
targetos: Windows
description: The ReadSizeTFromMode function safely reads a SIZE_T value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadSizeTFromMode
 - usermode_accessors/ReadSizeTFromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadSizeTFromMode
...
The **ReadSizeTFromMode** function safely reads a SIZE_T value from memory based on the specified processor mode.

## -parameters

### -param Source

[in] A pointer to the memory location from which to read the SIZE_T value.
...
**ReadSizeTFromMode** returns the SIZE_T value read from the specified memory address.

## -remarks

This function provides a safe way to read a SIZE_T value from memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**ReadSizeTFromUser**](nf-usermode_accessors-readsizetfromuser.md)

[**WriteSizeTToMode**](nf-usermode_accessors-writesizettomode.md)
