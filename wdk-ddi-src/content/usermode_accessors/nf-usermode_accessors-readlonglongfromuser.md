---
UID: NF:usermode_accessors.ReadLonglongFromUser
tech.root: kernel
title: ReadLonglongFromUser
ms.date: 06/24/2025
targetos: Windows
description: The ReadLonglongFromUser function safely reads a LONGLONG value from user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadLonglongFromUser
 - usermode_accessors/ReadLonglongFromUser
dev_langs:
 - c++
helpviewer_keywords:
 - ReadLonglongFromUser
...
The **ReadLonglongFromUser** function safely reads a LONGLONG value from user-mode memory.
...
This function provides a safe way to read a LONGLONG value from user-mode memory. It ensures the provided address is a user-mode address before reading it.
