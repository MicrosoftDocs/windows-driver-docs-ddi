---
UID: NF:usermode_accessors.ReadLonglongFromMode
tech.root: kernel
title: ReadLonglongFromMode
ms.date: 06/24/2025
targetos: Windows
description: The ReadLonglongFromMode function safely reads a LONGLONG value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadLonglongFromMode
 - usermode_accessors/ReadLonglongFromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadLonglongFromMode
...
[in] A pointer to the memory location from which to read the LONGLONG value.
...
This function provides a safe way to read a LONGLONG value from memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**WriteLonglongToMode**](nf-usermode_accessors-writelonglongtomode.md)
