...
f1_keywords:
 - ReadUInt16FromMode
 - usermode_accessors/ReadUInt16FromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadUInt16FromMode
...
The **ReadUInt16FromMode** function safely reads a UINT16 value from memory based on the specified processor mode.

## -parameters

### -param Source

[in] A pointer to the memory location from which to read the UINT16 value.
...
**ReadUInt16FromMode** returns the UINT16 value read from the specified memory address.

## -remarks

This function provides a safe way to read a UINT16 value from memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**ReadUInt16FromUser**](nf-usermode_accessors-readuint16fromuser.md)

[**WriteUInt16ToMode**](nf-usermode_accessors-writeuint16tomode.md)
