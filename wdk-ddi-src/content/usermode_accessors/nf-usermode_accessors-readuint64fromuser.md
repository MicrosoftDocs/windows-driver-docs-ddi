---
UID: NF:usermode_accessors.ReadUInt64FromUser
tech.root: kernel
title: ReadUInt64FromUser
ms.date: 07/02/2025
targetos: Windows
description: The ReadUInt64FromUser function safely reads a UINT64 value from user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadUInt64FromUser
 - usermode_accessors/ReadUInt64FromUser
dev_langs:
 - c++
helpviewer_keywords:
 - ReadUInt64FromUser
