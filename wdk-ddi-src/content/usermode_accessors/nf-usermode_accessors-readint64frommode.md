---
UID: NF:usermode_accessors.ReadInt64FromMode
tech.root: kernel
...
f1_keywords:
 - ReadInt64FromMode
 - usermode_accessors/ReadInt64FromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadInt64FromMode
...
[in] A pointer to the memory location from which to read the INT64 value.
...
**ReadInt64FromMode** returns the INT64 value read from the specified memory address.
