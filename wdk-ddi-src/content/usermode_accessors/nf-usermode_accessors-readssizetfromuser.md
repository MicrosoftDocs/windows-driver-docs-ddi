---
UID: NF:usermode_accessors.ReadSSizeTFromUser
tech.root: kernel
title: ReadSSizeTFromUser
ms.date: 07/02/2025
targetos: Windows
description: The ReadSSizeTFromUser function safely reads a SSIZE_T value from user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadSSizeTFromUser
 - usermode_accessors/ReadSSizeTFromUser
dev_langs:
 - c++
helpviewer_keywords:
 - ReadSSizeTFromUser
...
This function provides a safe way to read a SSIZE_T value from user-mode memory. It ensures the provided address is a user-mode address before reading it.
...
[**ReadSSizeTFromMode**](nf-usermode_accessors-readssizetfrommode.md)
