---
UID: NF:usermode_accessors.ReadWCharFromUser
tech.root: kernel
title: ReadWCharFromUser
ms.date: 07/02/2025
targetos: Windows
description: The ReadWCharFromUser function safely reads a WCHAR value from user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadWCharFromUser
 - usermode_accessors/ReadWCharFromUser
dev_langs:
 - c++
helpviewer_keywords:
 - ReadWCharFromUser
...
The **ReadWCharFromUser** function safely reads a WCHAR value from user-mode memory.
...
**ReadWCharFromUser** returns the WCHAR value read from the specified user-mode memory address.

## -remarks

This function provides a safe way to read a WCHAR value from user-mode memory. It ensures the provided address is a user-mode address before reading it.
