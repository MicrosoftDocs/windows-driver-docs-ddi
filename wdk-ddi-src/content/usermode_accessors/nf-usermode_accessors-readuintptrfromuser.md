---
UID: NF:usermode_accessors.ReadUIntPtrFromUser
tech.root: kernel
title: ReadUIntPtrFromUser
ms.date: 07/02/2025
targetos: Windows
description: The ReadUIntPtrFromUser function safely reads a UINT_PTR value from user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadUIntPtrFromUser
 - usermode_accessors/ReadUIntPtrFromUser
dev_langs:
 - c++
helpviewer_keywords:
 - ReadUIntPtrFromUser
...
[**ReadUIntPtrFromMode**](nf-usermode_accessors-readuintptrfrommode.md)

[**WriteUIntPtrToUser**](nf-usermode_accessors-writeuintptrtouser.md)
