---
UID: NF:usermode_accessors.ReadNtStatusFromUser
tech.root: kernel
title: ReadNtStatusFromUser
ms.date: 07/02/2025
targetos: Windows
description: The ReadNtStatusFromUser function safely reads an NTSTATUS value from user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadNtStatusFromUser
 - usermode_accessors/ReadNtStatusFromUser
dev_langs:
 - c++
helpviewer_keywords:
 - ReadNtStatusFromUser
...
This function provides a safe way to read an NTSTATUS value from user-mode memory. It ensures the provided address is a user-mode address before reading it.
