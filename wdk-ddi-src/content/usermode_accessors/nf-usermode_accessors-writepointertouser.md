---
UID: NF:usermode_accessors.WritePointerToUser
tech.root: kernel
title: WritePointerToUser
ms.date: 07/02/2025
targetos: Windows
description: The WritePointerToUser function safely writes a PVOID value to user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WritePointerToUser
 - usermode_accessors/WritePointerToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WritePointerToUser
...
The **WritePointerToUser** function safely writes a PVOID value to user-mode memory.

## -parameters

### -param Destination

[out] A pointer to the user-mode memory location where the PVOID value will be written.
