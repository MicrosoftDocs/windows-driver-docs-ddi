---
UID: NF:usermode_accessors.WriteUInt16ToMode
tech.root: kernel
title: WriteUInt16ToMode
ms.date: 07/02/2025
targetos: Windows
description: The WriteUInt16ToMode function safely writes a UINT16 value to memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteUInt16ToMode
 - usermode_accessors/WriteUInt16ToMode
dev_langs:
 - c++
helpviewer_keywords:
 - WriteUInt16ToMode
...
[out] A pointer to the memory location where the UINT16 value will be written.
...
This function provides a safe way to write a UINT16 value to memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
