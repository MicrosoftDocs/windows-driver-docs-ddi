---
UID: NF:usermode_accessors.ReadUCharFromMode
tech.root: kernel
title: ReadUCharFromMode
ms.date: 06/24/2025
targetos: Windows
description: The ReadUCharFromMode function safely reads a UCHAR value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadUCharFromMode
 - usermode_accessors/ReadUCharFromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadUCharFromMode
...
The **ReadUCharFromMode** function safely reads a UCHAR value from memory based on the specified processor mode.

## -parameters

### -param Source

[in] A pointer to the memory location from which to read the UCHAR value.
...
This function provides a safe way to read a UCHAR value from memory, with extra safety checks when accessing user-mode memory. It ensures that the provided address is valid and accessible based on the specified processor mode.
...
[**ReadUCharFromUser**](nf-usermode_accessors-readucharfromuser.md)

[**WriteUCharToMode**](nf-usermode_accessors-writeuchartomode.md)
