---
UID: NF:usermode_accessors.ReadLongFromMode
tech.root: kernel
title: ReadLongFromMode
ms.date: 06/24/2025
targetos: Windows
description: The ReadLongFromMode function safely reads a LONG value from memory based on the specified processor mode.
prerelease: false
req.assembly: 
...
f1_keywords:
 - ReadLongFromMode
 - usermode_accessors/ReadLongFromMode
dev_langs:
 - c++
helpviewer_keywords:
 - ReadLongFromMode
...
[**WriteLongToMode**](nf-usermode_accessors-writelongtomode.md)
