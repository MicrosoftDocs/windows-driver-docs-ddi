---
UID: NF:usermode_accessors.WriteInt16ToUser
tech.root: kernel
title: WriteInt16ToUser
ms.date: 07/02/2025
targetos: Windows
description: The WriteInt16ToUser function safely writes an INT16 value to user-mode memory.
prerelease: false
req.assembly: 
...
f1_keywords:
 - WriteInt16ToUser
 - usermode_accessors/WriteInt16ToUser
dev_langs:
 - c++
helpviewer_keywords:
 - WriteInt16ToUser
...
The **WriteInt16ToUser** function safely writes an INT16 value to user-mode memory.
...
This function provides a safe way to write an INT16 value to user-mode memory. It ensures the provided address is a user-mode address before writing to it.
...
[**ReadInt16FromUser**](nf-usermode_accessors-readint16fromuser.md)

[**WriteInt16ToMode**](nf-usermode_accessors-writeint16tomode.md)
