...
ms.date: 1/10/2018
ms.keywords: PDVD_DISK_KEY_DESCRIPTOR, ntddcdvd/PDVD_DISK_KEY_DESCRIPTOR, ntddcdvd/DVD_DISK_KEY_DESCRIPTOR, PDVD_DISK_KEY_DESCRIPTOR structure pointer [Storage Devices], _DVD_DISK_KEY_DESCRIPTOR, *PDVD_DISK_KEY_DESCRIPTOR, DVD_DISK_KEY_DESCRIPTOR structure [Storage Devices], structs-DVD_b5c88389-0128-4069-b460-d9fa81a2150e.xml, DVD_DISK_KEY_DESCRIPTOR, storage.dvd_disk_key_descriptor
