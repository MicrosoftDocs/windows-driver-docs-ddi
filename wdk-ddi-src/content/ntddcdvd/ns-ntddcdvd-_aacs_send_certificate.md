...
ms.date: 2/16/2018
ms.keywords: ntddcdvd/PAACS_SEND_CERTIFICATE, _AACS_SEND_CERTIFICATE, AACS_SEND_CERTIFICATE, PAACS_SEND_CERTIFICATE structure pointer [Storage Devices], structs-DVD_0f4e9fce-96a6-4064-bbb2-4c7077dad635.xml, *PAACS_SEND_CERTIFICATE, storage.aacs_send_certificate, AACS_SEND_CERTIFICATE structure [Storage Devices], ntddcdvd/AACS_SEND_CERTIFICATE, PAACS_SEND_CERTIFICATE
