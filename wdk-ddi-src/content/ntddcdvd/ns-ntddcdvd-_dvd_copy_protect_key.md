...
The <b>DVD_COPY_PROTECT_KEY</b> structure is used in conjunction with the <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntddcdvd/ni-ntddcdvd-ioctl_dvd_read_key">IOCTL_DVD_READ_KEY</a> request to execute a report key command of the specified type. 
...
<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntddcdvd/ne-ntddcdvd-dvd_key_type">DVD_KEY_TYPE</a>
