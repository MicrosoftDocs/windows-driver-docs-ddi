...
The DVD_STRUCTURE_FORMAT enumeration type is used in conjunction with the <a href="/windows-hardware/drivers/ddi/ntddcdvd/ni-ntddcdvd-ioctl_dvd_read_structure">IOCTL_DVD_READ_STRUCTURE</a> request and the <a href="/windows-hardware/drivers/ddi/ntddcdvd/ns-ntddcdvd-dvd_read_structure">DVD_READ_STRUCTURE</a> structure to retrieve a DVD descriptor.
