...
ms.date: 2/22/2018
ms.keywords: PUSBSIDEBANDAUDIO_MUTE_PARAMS structure pointer [Audio Devices], PUSBSIDEBANDAUDIO_MUTE_PARAMS, _USBSIDEBANDAUDIO_MUTE_PARAMS, USBSIDEBANDAUDIO_MUTE_PARAMS, USBSIDEBANDAUDIO_MUTE_PARAMS structure [Audio Devices], usbsidebandaudio/PUSBSIDEBANDAUDIO_MUTE_PARAMS, usbsidebandaudio/USBSIDEBANDAUDIO_MUTE_PARAMS, audio.usbsidebandaudio_mute_params, *PUSBSIDEBANDAUDIO_MUTE_PARAMS
