...
ms.date: 12/14/2017
ms.keywords: usbsidebandaudio/USBSIDEBANDAUDIO_SUPPORTED_FORMATS, _USBSIDEBANDAUDIO_SUPPORTED_FORMATS, *PUSBSIDEBANDAUDIO_SUPPORTED_FORMATS, audio.usbsidebandaudio_supported_formats, PUSBSIDEBANDAUDIO_SUPPORTED_FORMATS, USBSIDEBANDAUDIO_SUPPORTED_FORMATS, PUSBSIDEBANDAUDIO_SUPPORTED_FORMATS structure pointer [Audio Devices], usbsidebandaudio/PUSBSIDEBANDAUDIO_SUPPORTED_FORMATS, USBSIDEBANDAUDIO_SUPPORTED_FORMATS structure [Audio Devices]
...
typedef struct _USBSIDEBANDAUDIO_SUPPORTED_FORMATS {
  ULONG                             Reserved 0;
  ULONG                             Reserved 1;
  KSDATAFORMAT_WAVEFORMATEXTENSIBLE Reserved 2;
