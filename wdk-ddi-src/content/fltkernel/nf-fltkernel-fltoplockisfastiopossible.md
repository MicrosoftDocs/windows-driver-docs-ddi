...
<ul>
<li>
If the <i>Oplock</i> parameter is <b>NULL</b>, or if the value of **Oplock* is <b>NULL</b>, there are no outstanding oplocks on the file, and fast I/O can be performed on the file. 
