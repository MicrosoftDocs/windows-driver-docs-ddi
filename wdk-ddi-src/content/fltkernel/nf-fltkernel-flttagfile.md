...
Minifilter drivers should use <b>FltTagFile</b> instead of [FSCTL_SET_REPARSE_POINT](/windows-hardware/drivers/ifs/fsctl-set-reparse-point) to set a reparse point. 
