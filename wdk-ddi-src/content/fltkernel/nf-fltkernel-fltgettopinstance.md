...
<b>FltGetTopInstance</b> adds a rundown reference to the opaque instance pointer returned in the <i>Instance</i> parameter. When this pointer is no longer needed, the caller must release it by calling <a href="/windows-hardware/drivers/ddi/fltkernel/nf-fltkernel-fltobjectdereference">FltObjectDereference</a>. Thus every successful call to <b>FltGetTopInstance</b> must be matched by a subsequent call to <b>FltObjectDereference</b>.
