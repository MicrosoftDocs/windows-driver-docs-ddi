...
[out]
Pointer to a caller-supplied <a href="/windows-hardware/drivers/ddi/wdm/ns-wdm-_file_full_ea_information">FILE_FULL_EA_INFORMATION</a>-structured input buffer where the extended attribute values are to be returned.
...
[in, optional]
Pointer to a caller-supplied <a href="/windows-hardware/drivers/ddi/ntifs/ns-ntifs-_file_get_ea_information">FILE_GET_EA_INFORMATION</a>-structured input buffer specifying the extended attributes to be queried. This parameter is optional and can be <b>NULL</b>.
...
<a href="/windows-hardware/drivers/ddi/fltkernel/nf-fltkernel-fltseteafile">FltSetEaFile</a>
