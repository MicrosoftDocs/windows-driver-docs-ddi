...
To detach a minifilter driver instance from a volume, call <a href="/windows-hardware/drivers/ddi/fltkernel/nf-fltkernel-fltdetachvolume">FltDetachVolume</a>.
