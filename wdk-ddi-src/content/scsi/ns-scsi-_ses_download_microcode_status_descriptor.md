...
description: The _SES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR structure (scsi.h) specifies the status and additional status of a download microcode.
...
f1_keywords:
 ...
 - scsi/_SES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR
 - PSES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR
 - scsi/PSES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR
 - SES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR
 - scsi/SES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# SES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR structure (scsi.h)
