...
ms.date: 2/16/2018
ms.keywords: RECEIVE_TOKEN_INFORMATION_HEADER, SERVICE_ACTION_POPULATE_TOKEN, TRANSFER_COUNT_UNITS_PEBIBYTES, TRANSFER_COUNT_UNITS_TEBIBYTES, PRECEIVE_TOKEN_INFORMATION_HEADER, scsi/RECEIVE_TOKEN_INFORMATION_HEADER, TRANSFER_COUNT_UNITS_MEBIBYTES, TRANSFER_COUNT_UNITS_NUMBER_BLOCKS, *PRECEIVE_TOKEN_INFORMATION_HEADER, TRANSFER_COUNT_UNITS_EXBIBYTES, PRECEIVE_TOKEN_INFORMATION_HEADER structure pointer [Storage Devices], scsi/PRECEIVE_TOKEN_INFORMATION_HEADER, TRANSFER_COUNT_UNITS_GIBIBYTES, storage.receive_token_information_header, TRANSFER_COUNT_UNITS_BYTES, TRANSFER_COUNT_UNITS_KIBIBYTES, RECEIVE_TOKEN_INFORMATION_HEADER structure [Storage Devices], SERVICE_ACTION_WRITE_USING_TOKEN
