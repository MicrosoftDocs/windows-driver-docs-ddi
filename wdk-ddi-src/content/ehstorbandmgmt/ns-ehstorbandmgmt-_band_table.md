...
ms.date: 2/16/2018
ms.keywords: BAND_TABLE, ehstorbandmgmt/PBAND_TABLE, _BAND_TABLE, storage.band_table, BAND_TABLE structure [Storage Devices], ehstorbandmgmt/BAND_TABLE, PBAND_TABLE, PBAND_TABLE structure pointer [Storage Devices], *PBAND_TABLE
