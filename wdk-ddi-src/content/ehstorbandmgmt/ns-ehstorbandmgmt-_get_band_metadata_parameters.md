...
ms.date: 1/10/2018
ms.keywords: GET_BAND_METADATA_PARAMETERS, _GET_BAND_METADATA_PARAMETERS, ehstorbandmgmt/GET_BAND_METADATA_PARAMETERS, PGET_BAND_METADATA_PARAMETERS structure pointer [Storage Devices], ehstorbandmgmt/PGET_BAND_METADATA_PARAMETERS, storage.get_band_metadata_parameters, GET_BAND_METADATA_PARAMETERS structure [Storage Devices], *PGET_BAND_METADATA_PARAMETERS, PGET_BAND_METADATA_PARAMETERS
