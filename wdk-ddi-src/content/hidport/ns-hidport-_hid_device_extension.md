...
ms.date: 12/21/2017
ms.keywords: PHID_DEVICE_EXTENSION, hidport/HID_DEVICE_EXTENSION, _HID_DEVICE_EXTENSION, hidport/PHID_DEVICE_EXTENSION, PHID_DEVICE_EXTENSION structure pointer [Human Input Devices], hidstrct_faf2bb84-b1f7-4cfa-84b0-5328dfb521dc.xml, HID_DEVICE_EXTENSION structure [Human Input Devices], *PHID_DEVICE_EXTENSION, hid.hid_device_extension, HID_DEVICE_EXTENSION
