...
ms.date: 2/15/2018
ms.keywords: HID_DEVICE_EXTENSION structure [Human Input Devices], hid.hid_device_extension, HID_DEVICE_EXTENSION, PHID_DEVICE_EXTENSION structure pointer [Human Input Devices], PHID_DEVICE_EXTENSION, hidport/PHID_DEVICE_EXTENSION, hidstrct_faf2bb84-b1f7-4cfa-84b0-5328dfb521dc.xml, _HID_DEVICE_EXTENSION, hidport/HID_DEVICE_EXTENSION, *PHID_DEVICE_EXTENSION
