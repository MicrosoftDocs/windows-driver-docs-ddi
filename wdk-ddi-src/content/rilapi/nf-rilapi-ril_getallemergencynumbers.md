...
ms.date: 2/16/2018
ms.keywords: RIL_GetAllEmergencyNumbers, rilapi/RIL_GetAllEmergencyNumbers, RIL_GetAllEmergencyNumbers method [Network Drivers Starting with Windows Vista], netvista.ril_getallemergencynumbers
