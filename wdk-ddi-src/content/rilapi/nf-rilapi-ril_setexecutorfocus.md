...
ms.date: 1/18/2018
ms.keywords: netvista.ril_setexecutorfocus, RIL_SetExecutorFocus method [Network Drivers Starting with Windows Vista], RIL_SetExecutorFocus, rilapi/RIL_SetExecutorFocus
