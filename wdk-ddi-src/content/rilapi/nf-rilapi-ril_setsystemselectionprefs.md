...
ms.date: 2/16/2018
ms.keywords: netvista.ril_setsystemselectionprefs, rilapi/RIL_SetSystemSelectionPrefs, RIL_SetSystemSelectionPrefs method [Network Drivers Starting with Windows Vista], RIL_SetSystemSelectionPrefs
