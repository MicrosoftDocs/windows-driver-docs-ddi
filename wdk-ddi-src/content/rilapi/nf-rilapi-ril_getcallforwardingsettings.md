...
ms.date: 1/18/2018
ms.keywords: netvista.ril_getcallforwardingsettings, rilapi/RIL_GetCallForwardingSettings, RIL_GetCallForwardingSettings method [Network Drivers Starting with Windows Vista], RIL_GetCallForwardingSettings
