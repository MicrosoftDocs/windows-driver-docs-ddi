...
ms.date: 2/16/2018
ms.keywords: netvista.ril_setcellbroadcastmsgconfig, RIL_SetCellBroadcastMsgConfig, RIL_SetCellBroadcastMsgConfig method [Network Drivers Starting with Windows Vista], rilapi/RIL_SetCellBroadcastMsgConfig
