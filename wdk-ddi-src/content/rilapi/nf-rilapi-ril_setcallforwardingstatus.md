...
title: RIL_SetCallForwardingStatus function (rilapi.h)
description: "Microsoft reserves the RIL_SetCallForwardingStatus function for internal use only. Don't use this function in your code."
