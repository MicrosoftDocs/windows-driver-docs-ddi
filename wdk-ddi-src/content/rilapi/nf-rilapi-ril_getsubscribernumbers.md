...
ms.date: 1/18/2018
ms.keywords: RIL_GetSubscriberNumbers, rilapi/RIL_GetSubscriberNumbers, netvista.ril_getsubscribernumbers, RIL_GetSubscriberNumbers method [Network Drivers Starting with Windows Vista]
