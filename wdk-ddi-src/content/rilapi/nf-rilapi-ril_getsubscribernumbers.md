...
ms.date: 2/16/2018
ms.keywords: RIL_GetSubscriberNumbers method [Network Drivers Starting with Windows Vista], netvista.ril_getsubscribernumbers, RIL_GetSubscriberNumbers, rilapi/RIL_GetSubscriberNumbers
