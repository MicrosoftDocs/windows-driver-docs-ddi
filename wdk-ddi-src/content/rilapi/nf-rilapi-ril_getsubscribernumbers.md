...
ms.date: 2/16/2018
ms.keywords: rilapi/RIL_GetSubscriberNumbers, RIL_GetSubscriberNumbers method [Network Drivers Starting with Windows Vista], RIL_GetSubscriberNumbers, netvista.ril_getsubscribernumbers
