...
description: "Microsoft reserves the RIL_ExchangeUiccAPDU function for internal use only. Don't use this function in your code."
...
# RIL_ExchangeUiccAPDU function (rilapi.h)
