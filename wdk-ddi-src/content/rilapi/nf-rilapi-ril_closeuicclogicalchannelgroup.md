...
ms.date: 2/16/2018
ms.keywords: RIL_CloseUiccLogicalChannelGroup method [Network Drivers Starting with Windows Vista], netvista.ril_closeuicclogicalchannelgroup, RIL_CloseUiccLogicalChannelGroup, rilapi/RIL_CloseUiccLogicalChannelGroup
