...
description: "Microsoft reserves the RIL_WritePhonebookEntry function for internal use only. Don't use this function in your code."
...
# RIL_WritePhonebookEntry function (rilapi.h)
