...
description: "Microsoft reserves the RIL_GetMsgInUiccStatus function for internal use only. Don't use this function in your code."
...
# RIL_GetMsgInUiccStatus function (rilapi.h)
