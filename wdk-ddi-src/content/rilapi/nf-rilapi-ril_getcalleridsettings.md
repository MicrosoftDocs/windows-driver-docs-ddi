...
ms.date: 2/16/2018
ms.keywords: netvista.ril_getcalleridsettings, rilapi/RIL_GetCallerIdSettings, RIL_GetCallerIdSettings method [Network Drivers Starting with Windows Vista], RIL_GetCallerIdSettings
