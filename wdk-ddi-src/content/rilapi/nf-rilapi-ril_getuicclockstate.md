...
description: "Microsoft reserves the RIL_GetUiccLockState function for internal use only. Don't use this function in your code."
...
# RIL_GetUiccLockState function (rilapi.h)
