...
description: "Microsoft reserves the RIL_GetUiccServiceState function for internal use only. Don't use this function in your code."
...
# RIL_GetUiccServiceState function (rilapi.h)
