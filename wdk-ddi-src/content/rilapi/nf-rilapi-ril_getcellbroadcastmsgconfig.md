...
ms.date: 1/18/2018
ms.keywords: RIL_GetCellBroadcastMsgConfig method [Network Drivers Starting with Windows Vista], rilapi/RIL_GetCellBroadcastMsgConfig, RIL_GetCellBroadcastMsgConfig, netvista.ril_getcellbroadcastmsgconfig
