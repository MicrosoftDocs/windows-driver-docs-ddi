...
ms.date: 2/16/2018
ms.keywords: RIL_GetRadioStateDetails method [Network Drivers Starting with Windows Vista], RIL_GetRadioStateDetails, rilapi/RIL_GetRadioStateDetails, netvista.ril_getradiostatedetails
