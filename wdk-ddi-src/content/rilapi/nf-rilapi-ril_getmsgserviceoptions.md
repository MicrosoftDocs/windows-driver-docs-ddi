...
ms.date: 2/16/2018
ms.keywords: netvista.ril_getmsgserviceoptions, RIL_GetMsgServiceOptions method [Network Drivers Starting with Windows Vista], rilapi/RIL_GetMsgServiceOptions, RIL_GetMsgServiceOptions
