...
ms.date: 1/18/2018
ms.keywords: RIL_SetExecutorRFState, RIL_SetExecutorRFState method [Network Drivers Starting with Windows Vista], rilapi/RIL_SetExecutorRFState, netvista.ril_setexecutorrfstate
