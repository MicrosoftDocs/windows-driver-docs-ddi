...
ms.date: 2/16/2018
ms.keywords: rilapi/RIL_SetCallBarringStatus, RIL_SetCallBarringStatus method [Network Drivers Starting with Windows Vista], RIL_SetCallBarringStatus, netvista.ril_setcallbarringstatus
