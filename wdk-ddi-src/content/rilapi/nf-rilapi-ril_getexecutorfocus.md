...
description: "Microsoft reserves the RIL_GetExecutorFocus function for internal use only. Don't use this function in your code."
...
# RIL_GetExecutorFocus function (rilapi.h)
