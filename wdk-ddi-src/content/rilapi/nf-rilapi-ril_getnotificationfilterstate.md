...
ms.date: 1/18/2018
ms.keywords: netvista.ril_getnotificationfilterstate, RIL_GetNotificationFilterState method [Network Drivers Starting with Windows Vista], rilapi/RIL_GetNotificationFilterState, RIL_GetNotificationFilterState
