...
ms.date: 2/16/2018
ms.keywords: ",  , A, I, L, M, R, RIL_SendMsgAck, RIL_SendMsgAck method [Network Drivers Starting with Windows Vista], S, _, c, d, e, g, k, n, netvista.ril_sendmsgack, rilapi/RIL_SendMsgAck, s"
