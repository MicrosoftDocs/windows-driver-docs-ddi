...
ms.date: 1/18/2018
ms.keywords: RIL_SetMsgMemoryStatus, RIL_SetMsgMemoryStatus method [Network Drivers Starting with Windows Vista], rilapi/RIL_SetMsgMemoryStatus, netvista.ril_setmsgmemorystatus
