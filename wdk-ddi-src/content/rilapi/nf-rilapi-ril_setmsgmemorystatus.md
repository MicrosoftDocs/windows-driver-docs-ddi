...
description: "Microsoft reserves the RIL_SetMsgMemoryStatus function for internal use only. Don't use this function in your code."
...
# RIL_SetMsgMemoryStatus function (rilapi.h)
