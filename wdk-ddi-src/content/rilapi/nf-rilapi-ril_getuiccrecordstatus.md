...
ms.date: 2/16/2018
ms.keywords: netvista.ril_getuiccrecordstatus, RIL_GetUiccRecordStatus method [Network Drivers Starting with Windows Vista], rilapi/RIL_GetUiccRecordStatus, RIL_GetUiccRecordStatus
