...
ms.date: 1/18/2018
ms.keywords: netvista.ril_getpsmediaconfiguration, RIL_GetPSMediaConfiguration method [Network Drivers Starting with Windows Vista], rilapi/RIL_GetPSMediaConfiguration, RIL_GetPSMediaConfiguration
