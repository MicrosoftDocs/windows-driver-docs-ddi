...
ms.date: 2/16/2018
ms.keywords: PWDI_MESSAGE_HEADER, dot11wdi/PWDI_MESSAGE_HEADER, _WDI_MESSAGE_HEADER, dot11wdi/WDI_MESSAGE_HEADER, *PWDI_MESSAGE_HEADER, WDI_MESSAGE_HEADER structure [Network Drivers Starting with Windows Vista], PWDI_MESSAGE_HEADER structure pointer [Network Drivers Starting with Windows Vista], netvista.wdi_message_header, WDI_MESSAGE_HEADER
