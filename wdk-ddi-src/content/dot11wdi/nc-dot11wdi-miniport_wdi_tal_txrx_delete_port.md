...
f1_keywords:
 ...
 - dot11wdi/MINIPORT_WDI_TAL_TXRX_DELETE_PORT
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The 
  MiniportWdiTalTxRxDeletePort handler  function notifies the datapath components of the deletion of a virtual port. It is invoked after the completion of the <a href="/windows-hardware/drivers/network/oid-wdi-task-delete-port">OID_WDI_TASK_DELETE_PORT</a> command. The functional components RXEngine and TxEngine have already stopped operations associated  with this port and any pending data frames completed/returned.
...
<a href="/windows-hardware/drivers/network/oid-wdi-task-delete-port">OID_WDI_TASK_DELETE_PORT</a>
