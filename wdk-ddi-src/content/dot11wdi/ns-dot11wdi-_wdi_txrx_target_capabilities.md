...
ms.date: 2/16/2018
ms.keywords: netvista.wifi_txrx_target_capabilities, PWDI_TXRX_CAPABILITIES, netvista.wdi_txrx_target_capabilities, WDI_TXRX_CAPABILITIES, PWDI_TXRX_CAPABILITIES structure pointer [Network Drivers Starting with Windows Vista], WDI_TXRX_CAPABILITIES structure [Network Drivers Starting with Windows Vista], _WDI_TXRX_TARGET_CAPABILITIES, netvista.wdi_txrx_capabilities, *PWDI_TXRX_CAPABILITIES, dot11wdi/PWDI_TXRX_CAPABILITIES, dot11wdi/WDI_TXRX_TARGET_CAPABILITIES
