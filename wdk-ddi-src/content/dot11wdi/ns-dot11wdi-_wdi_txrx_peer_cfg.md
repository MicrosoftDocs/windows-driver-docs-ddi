...
ms.date: 2/16/2018
ms.keywords: WDI_TXRX_PEER_CFG structure [Network Drivers Starting with Windows Vista], dot11wdi/PWDI_TXRX_PEER_CFG, PWDI_TXRX_PEER_CFG structure pointer [Network Drivers Starting with Windows Vista], *PWDI_TXRX_PEER_CFG, netvista.wdi_txrx_peer_cfg, _WDI_TXRX_PEER_CFG, netvista.wifi_txrx_peer_cfg, PWDI_TXRX_PEER_CFG, dot11wdi/WDI_TXRX_PEER_CFG, WDI_TXRX_PEER_CFG
