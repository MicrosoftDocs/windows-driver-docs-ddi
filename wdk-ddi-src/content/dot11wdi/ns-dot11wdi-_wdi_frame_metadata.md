...
ms.date: 1/18/2018
ms.keywords: netvista.wdi_frame_metadata, netvista.wifi_frame_metadata, PWDI_FRAME_METADATA, dot11wdi/WDI_FRAME_METADATA, WDI_FRAME_METADATA structure [Network Drivers Starting with Windows Vista], *PWDI_FRAME_METADATA, _WDI_FRAME_METADATA, dot11wdi/PWDI_FRAME_METADATA, PWDI_FRAME_METADATA structure pointer [Network Drivers Starting with Windows Vista], WDI_FRAME_METADATA
