...
In port queuing mode, the <a href="/windows-hardware/drivers/network/wdi-peer-id">WDI_PEER_ID</a> and <a href="/windows-hardware/drivers/network/wdi-extended-tid">WDI_EXTENDED_TID</a> are set to wildcards.
