...
ms.date: 2/16/2018
ms.keywords: PTAL_TXRX_PARAMETERS structure pointer [Network Drivers Starting with Windows Vista], dot11wdi/TAL_TXRX_PARAMETERS, _TAL_TXRX_PARAMETERS, TAL_TXRX_PARAMETERS structure [Network Drivers Starting with Windows Vista], dot11wdi/PTAL_TXRX_PARAMETERS, netvista.tal_txrx_parameters, TAL_TXRX_PARAMETERS, *PTAL_TXRX_PARAMETERS, PTAL_TXRX_PARAMETERS
