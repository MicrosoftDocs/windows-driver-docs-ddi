...
ms.date: 1/18/2018
ms.keywords: "_WDI_MAC_ADDRESS, dot11wdi/PWDI_MAC_ADDRESS, WDI_MAC_ADDRESS structure [Network Drivers Starting with Windows Vista], dot11wdi/WDI_MAC_ADDRESS, *PWDI_MAC_ADDRESS, PWDI_MAC_ADDRESS structure pointer [Network Drivers Starting with Windows Vista], WDI_MAC_ADDRESS, netvista.wifi_mac_address, netvista.wdi_mac_address, PWDI_MAC_ADDRESS"
