...
ms.date: 2/22/2018
ms.keywords: scstruct_260d5a02-28d8-4ef4-ac2a-e81d3ac2814a.xml, CLOCK_RATE_CONVERSION, PCLOCK_RATE_CONVERSION structure pointer [Smart Card Reader Devices], *PCLOCK_RATE_CONVERSION, smclib/CLOCK_RATE_CONVERSION, PCLOCK_RATE_CONVERSION, CLOCK_RATE_CONVERSION structure [Smart Card Reader Devices], _CLOCK_RATE_CONVERSION, smclib/PCLOCK_RATE_CONVERSION, smartcrd.clock_rate_conversion
