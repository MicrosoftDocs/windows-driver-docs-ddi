...
The following code example is an <a href="/windows-hardware/drivers/ddi/wdfiotarget/nc-wdfiotarget-evt_wdf_io_target_query_remove">EvtIoTargetQueryRemove</a> callback function from the <a href="/windows-hardware/drivers/wdf/sample-kmdf-drivers">Toaster</a> sample driver. 
