...
ms.date: 2/22/2018
ms.keywords: ",  , E, I, L, N, O, P, R, S, SENSOR_PROPERTY_LIST_SIZE, SENSOR_PROPERTY_LIST_SIZE function [Sensor Devices], T, Y, Z, _, sensors.sensor_property_list_size, sensorsdef/SENSOR_PROPERTY_LIST_SIZE"
