...
ms.date: 12/14/2017
ms.keywords: sensorsdef/SENSOR_PROPERTY_LIST_INIT, SENSOR_PROPERTY_LIST_INIT function [Sensor Devices], SENSOR_PROPERTY_LIST_INIT, sensors.sensor_property_list_init
