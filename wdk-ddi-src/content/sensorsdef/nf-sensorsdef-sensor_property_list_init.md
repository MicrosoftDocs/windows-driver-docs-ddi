...
ms.date: 2/22/2018
ms.keywords: ",  , E, I, L, N, O, P, R, S, SENSOR_PROPERTY_LIST_INIT, SENSOR_PROPERTY_LIST_INIT function [Sensor Devices], T, Y, _, sensors.sensor_property_list_init, sensorsdef/SENSOR_PROPERTY_LIST_INIT"
