...
ms.date: 2/16/2018
ms.keywords: PO_FX_DEVICE_V1, *PPO_FX_DEVICE_V1, kernel.po_fx_device, wdm/PO_FX_DEVICE, PPO_FX_DEVICE_V1 structure pointer [Kernel-Mode Driver Architecture], wdm/PPO_FX_DEVICE_V1, *PPO_FX_DEVICE, PO_FX_DEVICE_V2, *PPO_FX_DEVICE_V2, PPO_FX_DEVICE_V1, wdm/PO_FX_DEVICE_V1, PO_FX_DEVICE structure [Kernel-Mode Driver Architecture], PO_FX_DEVICE, _PO_FX_DEVICE_V2, _PO_FX_DEVICE_V1, PO_FX_DEVICE_V1 structure [Kernel-Mode Driver Architecture]
