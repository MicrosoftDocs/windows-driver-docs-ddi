...
ms.date: 2/16/2018
ms.keywords: CM_PARTIAL_RESOURCE_DESCRIPTOR structure [Kernel-Mode Driver Architecture], wdm/CM_PARTIAL_RESOURCE_DESCRIPTOR, PCM_PARTIAL_RESOURCE_DESCRIPTOR, CmResourceShareShared, CM_PARTIAL_RESOURCE_DESCRIPTOR, PCM_PARTIAL_RESOURCE_DESCRIPTOR structure pointer [Kernel-Mode Driver Architecture], _CM_PARTIAL_RESOURCE_DESCRIPTOR, kernel.cm_partial_resource_descriptor, CmResourceShareDeviceExclusive, CM_RESOURCE_CONNECTION_TYPE_SERIAL_SPI, *PCM_PARTIAL_RESOURCE_DESCRIPTOR, CmResourceShareDriverExclusive, CM_RESOURCE_CONNECTION_CLASS_SERIAL, CM_RESOURCE_CONNECTION_TYPE_SERIAL_I2C, wdm/PCM_PARTIAL_RESOURCE_DESCRIPTOR, CM_RESOURCE_CONNECTION_TYPE_SERIAL_UART, CM_RESOURCE_CONNECTION_TYPE_GPIO_IO, CM_RESOURCE_CONNECTION_CLASS_GPIO, kstruct_a_2a821975-e3b8-4ce0-9dd5-8afe348001d8.xml
