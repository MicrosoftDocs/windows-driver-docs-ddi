...
ms.date: 2/24/2018
ms.keywords: ",  , C, D, E, F, G, I, M, N, O, P, R, T, U, UCM_CONNECTOR_PD_CONFIG_INIT, UCM_CONNECTOR_PD_CONFIG_INIT function [Buses], _, buses.ucm_connector_pd_config_init, ucmmanager/UCM_CONNECTOR_PD_CONFIG_INIT"
