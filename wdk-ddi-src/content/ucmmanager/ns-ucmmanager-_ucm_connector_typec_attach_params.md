...
ms.date: 2/15/2018
ms.keywords: UCM_CONNECTOR_TYPEC_ATTACH_PARAMS structure [Buses], UCM_CONNECTOR_TYPEC_ATTACH_PARAMS, PUCM_CONNECTOR_TYPEC_ATTACH_PARAMS, *PUCM_CONNECTOR_TYPEC_ATTACH_PARAMS, ucmmanager/UCM_CONNECTOR_TYPEC_ATTACH_PARAMS, PUCM_CONNECTOR_TYPEC_ATTACH_PARAMS structure pointer [Buses], buses.ucm_connector_typec_attach_params, _UCM_CONNECTOR_TYPEC_ATTACH_PARAMS, ucmmanager/PUCM_CONNECTOR_TYPEC_ATTACH_PARAMS
