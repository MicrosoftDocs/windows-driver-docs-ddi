...
ms.date: 1/18/2018
ms.keywords: wditypes/WDI_FIPS_MODE, wditypes/WDI_FIPS_MODE_UNKNOWN, WDI_FIPS_MODE_ENABLED, wditypes/WDI_FIPS_MODE_ENABLED, WDI_FIPS_MODE_UNKNOWN, wditypes/WDI_FIPS_MODE_DISABLED, _WDI_FIPS_MODE, WDI_FIPS_MODE_DISABLED, netvista.wdi_fips_mode, WDI_FIPS_MODE enumeration [Network Drivers Starting with Windows Vista], WDI_FIPS_MODE
