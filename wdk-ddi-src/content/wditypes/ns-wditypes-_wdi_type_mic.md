...
ms.date: 1/18/2018
ms.keywords: WDI_TYPE_MIC structure [Network Drivers Starting with Windows Vista], wditypes/WDI_TYPE_MIC, PWDI_TYPE_MIC structure pointer [Network Drivers Starting with Windows Vista], _WDI_TYPE_MIC, netvista.wdi_type_mic, WDI_TYPE_MIC, PWDI_TYPE_MIC, *PWDI_TYPE_MIC, wditypes/PWDI_TYPE_MIC
