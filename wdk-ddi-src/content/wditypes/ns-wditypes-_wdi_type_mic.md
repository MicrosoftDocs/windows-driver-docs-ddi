...
ms.date: 2/16/2018
ms.keywords: PWDI_TYPE_MIC, WDI_TYPE_MIC structure [Network Drivers Starting with Windows Vista], PWDI_TYPE_MIC structure pointer [Network Drivers Starting with Windows Vista], *PWDI_TYPE_MIC, _WDI_TYPE_MIC, wditypes/PWDI_TYPE_MIC, wditypes/WDI_TYPE_MIC, netvista.wdi_type_mic, WDI_TYPE_MIC
