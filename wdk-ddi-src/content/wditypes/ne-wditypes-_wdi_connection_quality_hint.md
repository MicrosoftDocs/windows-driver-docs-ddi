...
ms.date: 2/16/2018
ms.keywords: WDI_CONNECTION_QUALITY_HINT, WDI_CONNECTION_QUALITY_LOW_LATENCY, wditypes/WDI_CONNECTION_QUALITY_HIGH_CHANNEL_AVAILABILITY, WDI_CONNECTION_QUALITY_HINT enumeration [Device and Driver Installation], wditypes/WDI_CONNECTION_QUALITY_HIGH_THROUGHPUT, netvista.wdi_connection_quality_hint, WDI_CONNECTION_QUALITY_HIGH_THROUGHPUT, _WDI_CONNECTION_QUALITY_HINT, devinst.wfi_connection_quality_hint, WDI_CONNECTION_QUALITY_AUTO_POWER_SAVE, wditypes/WDI_CONNECTION_QUALITY_LOW_LATENCY, wditypes/WDI_CONNECTION_QUALITY_HINT, wditypes/WDI_CONNECTION_QUALITY_AUTO_POWER_SAVE, WDI_CONNECTION_QUALITY_HIGH_CHANNEL_AVAILABILITY
