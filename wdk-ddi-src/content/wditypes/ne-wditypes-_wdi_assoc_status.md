...
ms.date: 2/16/2018
ms.keywords: wditypes/WDI_ASSOC_STATUS_ROAMING_BETTER_AP_FOUND, wditypes/WDI_ASSOC_STATUS_AUTH_FAILED_BY_PEER, wditypes/WDI_ASSOC_STATUS_BAD_ASSOC_RESPONSE, wditypes/WDI_ASSOC_STATUS_AUTH_REQUEST_TX_NO_ACK, _WDI_ASSOC_STATUS, wditypes/WDI_ASSOC_STATUS_PEER_DEAUTHENTICATED, wditypes/WDI_ASSOC_STATUS_ASSOC_REQUEST_TX_NO_ACK, WDI_ASSOC_STATUS_ASSOC_EXCHANGE_FAILURE, WDI_ASSOC_STATUS_UNREACHABLE, wditypes/WDI_ASSOC_STATUS_DISASSOCIATED_BY_HOST, WDI_ASSOC_STATUS_AUTH_REQUEST_TX_NO_ACK, WDI_ASSOC_STATUS_NO_ASSOC_RESPONSE, wditypes/WDI_ASSOC_STATUS_NO_ASSOC_RESPONSE, WDI_ASSOC_STATUS_ASSOC_REQUEST_TX_NO_ACK, wditypes/WDI_ASSOC_STATUS_ASSOC_EXCHANGE_FAILURE, WDI_ASSOC_STATUS_DISASSOCIATE_NEEDED_REASSOC, wditypes/WDI_ASSOC_STATUS_FAILURE, wditypes/WDI_ASSOC_STATUS_BAD_AUTH_RESPONSE, wditypes/WDI_ASSOC_STATUS_ASSOC_RESPONSE_CAPABILITY_MISMATCH, wditypes/WDI_ASSOC_STATUS_PEER_DISASSOCIATED, WDI_ASSOC_STATUS_ASSOC_RESPONSE_CAPABILITY_MISMATCH, wditypes/WDI_ASSOC_STATUS_CANDIDATE_LIST_EXHAUSTED, WDI_ASSOC_STATUS_NO_AUTH_RESPONSE, wditypes/WDI_ASSOC_STATUS, WDI_ASSOC_STATUS_ASSOC_FAILED_BY_PEER, WDI_ASSOC_STATUS_RADIO_OFF, WDI_ASSOC_STATUS_CANDIDATE_LIST_EXHAUSTED, WDI_ASSOC_STATUS_AUTH_EXCHANGE_FAILURE, WDI_ASSOC_STATUS_BAD_AUTH_RESPONSE, wditypes/WDI_ASSOC_STATUS_ROAMING_LOW_LINK_QUALITY, WDI_ASSOC_STATUS_BAD_ASSOC_RESPONSE, wditypes/WDI_ASSOC_STATUS_AUTH_EXCHANGE_FAILURE, wditypes/WDI_ASSOC_STATUS_ROAMING_ASSOCIATION_LOST, wditypes/WDI_ASSOC_STATUS_NO_AUTH_RESPONSE, WDI_ASSOC_STATUS, WDI_ASSOC_STATUS_ROAMING_ASSOCIATION_LOST, WDI_ASSOC_STATUS_ABORTED, WDI_ASSOC_STATUS_NO_BEACON_PROBE_RESPONSE, WDI_ASSOC_STATUS_AUTH_FAILED_BY_PEER, WDI_ASSOC_STATUS_ROAMING_BETTER_AP_FOUND, wditypes/WDI_ASSOC_STATUS_PROBE_TX_FAILURE, WDI_ASSOC_STATUS_AUTH_RESPONSE_CAPABILITY_MISMATCH, wditypes/WDI_ASSOC_STATUS_DISASSOCIATE_NEEDED_REASSOC, wditypes/WDI_ASSOC_STATUS_AUTH_RESPONSE_CAPABILITY_MISMATCH, WDI_ASSOC_STATUS_PROBE_TX_FAILURE, wditypes/WDI_ASSOC_STATUS_ASSOC_FAILED_BY_PEER, wditypes/WDI_ASSOC_STATUS_DISASSOCIATE_BY_DEVICE_RESET, wditypes/WDI_ASSOC_STATUS_UNREACHABLE, WDI_ASSOC_STATUS_FAILURE, WDI_ASSOC_STATUS_SUCCESS, netvista.wdi_assoc_status, wditypes/WDI_ASSOC_STATUS_ABORTED, WDI_ASSOC_STATUS_DISASSOCIATE_UNABLE_TO_MAINTAIN, wditypes/WDI_ASSOC_STATUS_DISASSOCIATE_NOT_VISIBLE, netvista.wifi_assoc_status, wditypes/WDI_ASSOC_STATUS_SUCCESS, wditypes/WDI_ASSOC_STATUS_DISASSOCIATE_UNABLE_TO_MAINTAIN, wditypes/WDI_ASSOC_STATUS_RADIO_OFF, WDI_ASSOC_STATUS_ROAMING_LOW_LINK_QUALITY, WDI_ASSOC_STATUS_PEER_DEAUTHENTICATED, WDI_ASSOC_STATUS_DISASSOCIATE_BY_DEVICE_RESET, WDI_ASSOC_STATUS enumeration [Device and Driver Installation], wditypes/WDI_ASSOC_STATUS_NO_BEACON_PROBE_RESPONSE, WDI_ASSOC_STATUS_DISASSOCIATED_BY_HOST, WDI_ASSOC_STATUS_PEER_DISASSOCIATED, WDI_ASSOC_STATUS_DISASSOCIATE_NOT_VISIBLE
