...
ms.date: 2/16/2018
ms.keywords: PWDI_DATA_RATE_ENTRY structure pointer [Device and Driver Installation], _WDI_DATA_RATE_ENTRY, WDI_DATA_RATE_ENTRY structure [Device and Driver Installation], wditypes/WDI_DATA_RATE_ENTRY, netvista.wifi_data_rate_entry, *PWDI_DATA_RATE_ENTRY, PWDI_DATA_RATE_ENTRY, wditypes/PWDI_DATA_RATE_ENTRY, netvista.wdi_data_rate_entry, WDI_DATA_RATE_ENTRY
