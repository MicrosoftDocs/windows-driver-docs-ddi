...
ms.date: 1/18/2018
ms.keywords: netvista.wdi_scan_type, wditypes/WDI_SCAN_TYPE, wditypes/WDI_SCAN_TYPE_PASSIVE_ONLY, WDI_SCAN_TYPE_PASSIVE_ONLY, wditypes/WDI_SCAN_TYPE_ACTIVE_ONLY, netvista.wifi_scan_type, wditypes/WDI_SCAN_TYPE_AUTO, _WDI_SCAN_TYPE, WDI_SCAN_TYPE_AUTO, WDI_SCAN_TYPE enumeration [Device and Driver Installation], WDI_SCAN_TYPE, WDI_SCAN_TYPE_ACTIVE_ONLY
