...
ms.date: 1/18/2018
ms.keywords: wditypes/WDI_SCAN_TYPE_AUTO, WDI_SCAN_TYPE_PASSIVE_ONLY, netvista.wifi_scan_type, netvista.wdi_scan_type, WDI_SCAN_TYPE_ACTIVE_ONLY, _WDI_SCAN_TYPE, wditypes/WDI_SCAN_TYPE, wditypes/WDI_SCAN_TYPE_PASSIVE_ONLY, WDI_SCAN_TYPE_AUTO, wditypes/WDI_SCAN_TYPE_ACTIVE_ONLY, WDI_SCAN_TYPE enumeration [Device and Driver Installation], WDI_SCAN_TYPE
