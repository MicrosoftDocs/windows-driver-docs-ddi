...
ms.date: 2/16/2018
ms.keywords: HBA_FCPBINDING, HBA_FCPBinding structure [Storage Devices], HBA_FCPBINDING structure [Storage Devices], *PHBA_FCPBINDING, storage.hba_fcpbinding, PHBA_FCPBINDING, hbaapi/PHBA_FCPBINDING, hbaapi/HBA_FCPBinding, PHBA_FCPBINDING structure pointer [Storage Devices], structs-Fibre_c02a809a-3b65-4e19-93e0-c72a0aead81c.xml, HBA_FCPBinding
