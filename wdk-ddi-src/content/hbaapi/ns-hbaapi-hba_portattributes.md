...
ms.date: 1/10/2018
ms.keywords: PHBA_PORTATTRIBUTES, storage.hba_portattributes, structs-Fibre_86dd88a9-06cc-4e24-a665-f4fa240795fb.xml, hbaapi/HBA_PortAttributes, HBA_PORTATTRIBUTES, hbaapi/PHBA_PORTATTRIBUTES, PHBA_PORTATTRIBUTES structure pointer [Storage Devices], HBA_PORTATTRIBUTES structure [Storage Devices], HBA_PortAttributes structure [Storage Devices], HBA_PortAttributes, *PHBA_PORTATTRIBUTES
