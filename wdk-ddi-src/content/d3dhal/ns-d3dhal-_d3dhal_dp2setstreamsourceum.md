...
title: _D3DHAL_DP2SETSTREAMSOURCEUM (d3dhal.h)
...
ms.date: 05/10/2018
keywords: ["D3DHAL_DP2SETSTREAMSOURCEUM structure"]
...
f1_keywords:
 - _D3DHAL_DP2SETSTREAMSOURCEUM
 - d3dhal/_D3DHAL_DP2SETSTREAMSOURCEUM
 - D3DHAL_DP2SETSTREAMSOURCEUM
...
The D3DHAL_DP2SETSTREAMSOURCEUM structure is used to bind a vertex stream source to a user memory buffer for <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dhal/nc-d3dhal-lpd3dhal_drawprimitives2cb">D3dDrawPrimitives2</a>.
...
The actual user memory pointer to the vertex data should be extracted from the <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dhal/ns-d3dhal-_d3dhal_drawprimitives2data">D3DHAL_DRAWPRIMITIVES2DATA</a> passed when actually drawing primitives.
...
<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/d3dhal/ns-d3dhal-_d3dhal_dp2setstreamsource">D3DHAL_DP2SETSTREAMSOURCE</a>
