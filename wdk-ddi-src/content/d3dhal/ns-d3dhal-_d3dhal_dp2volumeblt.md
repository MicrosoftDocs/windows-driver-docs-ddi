...
ms.date: 05/10/2018
keywords: ["D3DHAL_DP2VOLUMEBLT structure"]
...
f1_keywords:
 - _D3DHAL_DP2VOLUMEBLT
 - d3dhal/_D3DHAL_DP2VOLUMEBLT
 - D3DHAL_DP2VOLUMEBLT
...
The D3DHAL_DP2VOLUMEBLT structure is used for volume texture blts when <a href="/windows-hardware/drivers/ddi/d3dhal/nc-d3dhal-lpd3dhal_drawprimitives2cb">D3dDrawPrimitives2</a> responds to the D3DDP2OP_VOLUMEBLT command token.
...
The <a href="/windows/win32/api/ddrawint/nc-ddrawint-pdd_createsurfaceex">D3dCreateSurfaceEx</a> callback creates the small integer handles to the volume textures that can be used as source and destination volume textures for volume texture blts.

See Remarks for <a href="/windows-hardware/drivers/ddi/d3dhal/ns-d3dhal-_d3dhal_dp2texblt">D3DHAL_DP2TEXBLT</a>.
...
<a href="/windows-hardware/drivers/ddi/d3dhal/ns-d3dhal-_d3dhal_dp2texblt">D3DHAL_DP2TEXBLT</a>
