...
f1_keywords:
 ...
 - d3dhal/_D3DHAL_CONTEXTDESTROYDATA
 - D3DHAL_CONTEXTDESTROYDATA
...
The D3DHAL_CONTEXTDESTROYDATA structure contains the information that the <a href="/windows-hardware/drivers/ddi/d3dhal/nc-d3dhal-lpd3dhal_contextdestroycb">D3dContextDestroy</a> function requires to delete a context.
...
Specifies the location where the driver writes the return code for <a href="/windows-hardware/drivers/ddi/d3dhal/nc-d3dhal-lpd3dhal_contextdestroycb">D3dContextDestroy</a>. D3D_OK indicates success. For more information, see <a href="/windows-hardware/drivers/display/return-codes-for-direct3d-driver-callbacks">Return Codes for Direct3D Driver Callbacks</a>.
