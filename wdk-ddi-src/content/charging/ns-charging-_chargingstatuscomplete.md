...
ms.date: 12/14/2017
ms.keywords: CHARGINGSTATUSCOMPLETE, CHARGINGSTATUSCOMPLETE structure [Battery Devices], *PCHARGINGSTATUSCOMPLETE, _CHARGINGSTATUSCOMPLETE, battery.chargingstatuscomplete, charging/BATTERY_INFORMATION
