...
ms.date: 12/14/2017
ms.keywords: POWERSOURCESTATUS, _POWERSOURCESTATUS, *PPOWERSOURCESTATUS, POWERSOURCESTATUS structure [Battery Devices], battery.powersourcestatus, charging/BATTERY_INFORMATION
