...
ms.date: 12/14/2017
ms.keywords: charging/BATTERY_INFORMATION, POWERSOURCESTATUS structure [Battery Devices], battery.powersourcestatus, _POWERSOURCESTATUS, POWERSOURCESTATUS, *PPOWERSOURCESTATUS
