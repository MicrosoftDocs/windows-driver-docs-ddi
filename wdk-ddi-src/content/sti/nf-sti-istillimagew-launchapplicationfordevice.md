...
ms.date: 2/22/2018
ms.keywords: image.istillimage_launchapplicationfordevice, LaunchApplicationForDevice, IStillImageW::LaunchApplicationForDevice, LaunchApplicationForDevice method [Imaging Devices], IStillImage interface, IStillImage interface [Imaging Devices], LaunchApplicationForDevice method, LaunchApplicationForDevice method [Imaging Devices], stifnc_3ecda881-3b82-4323-b739-614e4f8f78a7.xml, IStillImageW, IStillImage::LaunchApplicationForDevice, sti/IStillImage::LaunchApplicationForDevice
