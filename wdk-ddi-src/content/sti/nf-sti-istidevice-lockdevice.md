...
<a href="/windows-hardware/drivers/ddi/sti/nf-sti-istidevice-diagnostic">IStiDevice::Diagnostic</a>
...
<a href="/windows-hardware/drivers/ddi/sti/nf-sti-istidevice-rawreaddata">IStiDevice::RawReadData</a>
...
If the <b>IStiDevice::LockDevice</b> method is able to obtain an <b>IStiDevice</b>-level lock on the device within the specified time-out period, it then calls <a href="/windows-hardware/drivers/ddi/stiusd/nf-stiusd-istiusd-lockdevice">IStiUSD::LockDevice</a> in the appropriate vendor-supplied minidriver.
