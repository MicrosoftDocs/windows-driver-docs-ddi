...
ms.date: 12/18/2017
ms.keywords: NFC_CX_TRANSPORT_I2C, *PNFC_CX_TRANSPORT_TYPE, nfccx/NFC_CX_TRANSPORT_TYPE, NFC_CX_TRANSPORT_UART, nfccx/NFC_CX_TRANSPORT_I2C, NFC_CX_TRANSPORT_TYPE, nfccx/NFC_CX_TRANSPORT_CUSTOM, _NFC_CX_TRANSPORT_TYPE, nfccx/NFC_CX_TRANSPORT_SPI, NFC_CX_TRANSPORT_CUSTOM, NFC_CX_TRANSPORT_TYPE, *PNFC_CX_TRANSPORT_TYPE enumeration [Near-Field Proximity Drivers], nfccx/NFC_CX_TRANSPORT_UART, NFC_CX_TRANSPORT_TYPE, *PNFC_CX_TRANSPORT_TYPE, NFC_CX_TRANSPORT_TYPE enumeration [Near-Field Proximity Drivers], nfpdrivers.nfc_cx_transport_type, NFC_CX_TRANSPORT_SPI
