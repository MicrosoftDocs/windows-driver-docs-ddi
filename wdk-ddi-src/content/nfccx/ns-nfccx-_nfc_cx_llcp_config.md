...
ms.date: 12/18/2017
ms.keywords: nfccx/PNFC_CX_LLCP_CONFIG, _NFC_CX_LLCP_CONFIG, NFC_CX_LLCP_CONFIG, nfccx/NFC_CX_LLCP_CONFIG, PNFC_CX_LLCP_CONFIG structure pointer [Near-Field Proximity Drivers], NFC_CX_LLCP_CONFIG structure [Near-Field Proximity Drivers], nfpdrivers.nfc_cx_llcp_config, *PNFC_CX_LLCP_CONFIG, PNFC_CX_LLCP_CONFIG
