...
ms.date: 2/15/2018
ms.keywords: PNFC_CX_HARDWARE_EVENT structure pointer [Near-Field Proximity Drivers], NFC_CX_HARDWARE_EVENT, *PNFC_CX_HARDWARE_EVENT, nfpdrivers.nfc_cx_hardware_event, nfccx/NFC_CX_HARDWARE_EVENT, PNFC_CX_HARDWARE_EVENT, NFC_CX_HARDWARE_EVENT structure [Near-Field Proximity Drivers], _NFC_CX_HARDWARE_EVENT, nfccx/PNFC_CX_HARDWARE_EVENT
