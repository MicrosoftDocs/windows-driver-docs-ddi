...
ms.date: 12/18/2017
ms.keywords: nfpdrivers.nfc_cx_llcp_config_init, NFC_CX_LLCP_CONFIG_INIT function [Near-Field Proximity Drivers], NFC_CX_LLCP_CONFIG_INIT, nfccx/NFC_CX_LLCP_CONFIG_INIT
