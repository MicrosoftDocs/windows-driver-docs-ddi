...
ms.date: 2/15/2018
ms.keywords: NFC_CX_CE_NFC_A, NFC_CX_CE_MODE_CONFIG, nfccx/NFC_CX_CE_NFC_F, _NFC_CX_CE_MODE_CONFIG, NFC_CX_CE_NFC_B, nfccx/NFC_CX_CE_NFC_A, nfccx/NFC_CX_CE_NFC_B, NFC_CX_CE_DEFAULT, NFC_CX_CE_NFC_F, NFC_CX_CE_MODE_CONFIG enumeration [Near-Field Proximity Drivers], NFC_CX_CE_MODE_CONFIG, *PNFC_CX_CE_MODE_CONFIG, nfccx/NFC_CX_CE_MODE_CONFIG, *PNFC_CX_CE_MODE_CONFIG, NFC_CX_CE_MODE_CONFIG, *PNFC_CX_CE_MODE_CONFIG enumeration [Near-Field Proximity Drivers], nfpdrivers.nfc_cx_ce_mode_config, nfccx/NFC_CX_CE_DEFAULT
