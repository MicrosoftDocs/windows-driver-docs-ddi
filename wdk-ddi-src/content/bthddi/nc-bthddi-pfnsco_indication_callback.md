...
For incoming remote connection request indications, this is the context specified by the profile
     ...
     <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_sco_register_server">_BRB_SCO_REGISTER_SERVER</a> structure
     ...
     <a href="/previous-versions/ff536626(v=vs.85)">BRB_SCO_OPEN_CHANNEL</a> BRB.

### -param Indication 

[in]
A 
     <a href="/windows-hardware/drivers/ddi/bthddi/ne-bthddi-_sco_indication_code">SCO_INDICATION_CODE</a> value that indicates
...
In the second case, the profile driver acts as a client and attempts to connect to a remote device
    ...
    <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_sco_open_channel">_BRB_SCO_OPEN_CHANNEL</a> structure passed
...
<a href="/windows-hardware/drivers/ddi/bthddi/ne-bthddi-_sco_indication_code">SCO_INDICATION_CODE</a>
