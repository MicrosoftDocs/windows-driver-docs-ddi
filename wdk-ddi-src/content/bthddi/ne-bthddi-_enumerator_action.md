...
ms.date: 12/21/2017
ms.keywords: ENUMERATOR_ACTION enumeration [Bluetooth Devices], PENUMERATOR_ACTION, ENUMERATOR_ACTION, ENUMERATOR_ACTION enumeration pointer [Bluetooth Devices], PENUMERATOR_ACTION enumeration pointer [Bluetooth Devices], ENUMERATOR_ACTION_MAX, bthddi/ENUMERATOR_ACTION_DESTROY, ENUMERATOR_ACTION_REMOVE, bthddi/PENUMERATOR_ACTION, bthddi/ENUMERATOR_ACTION_MAX, bthddi/ENUMERATOR_ACTION_REMOVE, _ENUMERATOR_ACTION, ENUMERATOR_ACTION_DESTROY, bthddi/ENUMERATOR_ACTION, *PENUMERATOR_ACTION, bltooth.enumerator_action, bthddi/ENUMERATOR_ACTION_CREATE, ENUMERATOR_ACTION_CREATE, bth_enums_5ffc09cb-5aae-408c-ba92-b1872890541a.xml
