...
ms.date: 12/21/2017
ms.keywords: bthddi/ENUMERATOR_ACTION_MAX, ENUMERATOR_ACTION enumeration pointer [Bluetooth Devices], bltooth.enumerator_action, bthddi/ENUMERATOR_ACTION_REMOVE, bthddi/PENUMERATOR_ACTION, ENUMERATOR_ACTION_REMOVE, ENUMERATOR_ACTION_DESTROY, PENUMERATOR_ACTION, bth_enums_5ffc09cb-5aae-408c-ba92-b1872890541a.xml, ENUMERATOR_ACTION_MAX, *PENUMERATOR_ACTION, ENUMERATOR_ACTION enumeration [Bluetooth Devices], _ENUMERATOR_ACTION, ENUMERATOR_ACTION, PENUMERATOR_ACTION enumeration pointer [Bluetooth Devices], ENUMERATOR_ACTION_CREATE, bthddi/ENUMERATOR_ACTION_CREATE, bthddi/ENUMERATOR_ACTION, bthddi/ENUMERATOR_ACTION_DESTROY
