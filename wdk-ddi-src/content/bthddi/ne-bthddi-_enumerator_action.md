...
ms.date: 2/15/2018
ms.keywords: bthddi/ENUMERATOR_ACTION_MAX, ENUMERATOR_ACTION_DESTROY, *PENUMERATOR_ACTION, bltooth.enumerator_action, ENUMERATOR_ACTION_MAX, bthddi/PENUMERATOR_ACTION, ENUMERATOR_ACTION_REMOVE, bthddi/ENUMERATOR_ACTION_DESTROY, PENUMERATOR_ACTION enumeration pointer [Bluetooth Devices], ENUMERATOR_ACTION_CREATE, ENUMERATOR_ACTION, PENUMERATOR_ACTION, bthddi/ENUMERATOR_ACTION_REMOVE, _ENUMERATOR_ACTION, bthddi/ENUMERATOR_ACTION_CREATE, bthddi/ENUMERATOR_ACTION, ENUMERATOR_ACTION enumeration pointer [Bluetooth Devices], ENUMERATOR_ACTION enumeration [Bluetooth Devices], bth_enums_5ffc09cb-5aae-408c-ba92-b1872890541a.xml
