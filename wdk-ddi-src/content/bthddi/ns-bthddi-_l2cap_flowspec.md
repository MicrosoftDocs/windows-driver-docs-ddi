...
ms.date: 12/21/2017
ms.keywords: bthddi/L2CAP_CONFIG_VALUE_RANGE, L2CAP_FLOWSPEC structure [Bluetooth Devices], PL2CAP_FLOWSPEC, L2CAP_FLOWSPEC, *PL2CAP_FLOWSPEC, bltooth.l2cap_flowspec, _L2CAP_FLOWSPEC, PL2CAP_FLOWSPEC structure pointer [Bluetooth Devices], L2CAP_FLOWSPEC Structure structure [Bluetooth Devices], L2CAP_FLOWSPEC Structure, bthddi/PL2CAP_FLOWSPEC, bth_structs_2d7077bd-6328-4d54-9238-f463fad371d6.xml
