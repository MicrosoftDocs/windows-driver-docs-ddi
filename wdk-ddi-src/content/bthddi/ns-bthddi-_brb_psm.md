...
When the _BRB_PSM structure is passed as input for a 
     <a href="/previous-versions/ff536621(v=vs.85)">BRB_REGISTER_PSM</a> BRB call, this is the PSM
...
When the _BRB_PSM structure is passed as input for a 
     <a href="/previous-versions/ff536632(v=vs.85)">BRB_UNREGISTER_PSM</a> BRB call, this is the
...
To register a PSM, profile drivers should 
    ...
    <a href="/previous-versions/ff536621(v=vs.85)">BRB_REGISTER_PSM</a> request.
...
Profile drivers cannot register a PSM that has already been registered by another driver. If one
    ...
    <a href="/windows-hardware/drivers/ddi/bthioctl/ni-bthioctl-ioctl_bth_sdp_submit_record">
    IOCTL_BTH_SDP_SUBMIT_RECORD</a> IOCTL.

To unregister a previously registered PSM, profile drivers should 
    <a href="/previous-versions/ff536657(v=vs.85)">build and send</a> a 
    <a href="/previous-versions/ff536632(v=vs.85)">BRB_UNREGISTER_PSM</a> request. Profile
...
A <b>BRB_UNREGISTER_PSM</b> request has no effect on SDP records that attempt to connect to the PSM. Profile
    ...
    <a href="/windows-hardware/drivers/ddi/bthioctl/ni-bthioctl-ioctl_bth_sdp_remove_record">
...
<a href="/previous-versions/ff536621(v=vs.85)">BRB_REGISTER_PSM</a>



<a href="/previous-versions/ff536632(v=vs.85)">BRB_UNREGISTER_PSM</a>
