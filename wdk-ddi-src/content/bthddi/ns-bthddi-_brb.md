...
Defines the format of a L2CAP close channel command sent to the Bluetooth device. For more
      ...
      <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_l2ca_close_channel">_BRB_L2CA_CLOSE_CHANNEL</a>.
...
Defines the format of a command that sends a L2CAP_EchoReq message to and receives a
      ...
      <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_l2ca_ping">_BRB_L2CA_PING</a>.
...
Defines the format of a command that performs read and write operations over a L2CAP connection
      ...
      <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_l2ca_acl_transfer">_BRB_L2CA_ACL_TRANSFER</a>.
...
Defines the format of a command that returns the address of the local Bluetooth radio. For more
      ...
      <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_get_local_bd_addr">_BRB_GET_LOCAL_BD_ADDR</a>.
...
Defines the format for the commands that register and unregister a Protocol/Service Multiplexer
      ...
      <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_psm">_BRB_PSM</a>.
...
Defines the format of a command that updates the settings of a L2CAP channel to a Bluetooth
      ...
      <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_l2ca_update_channel">_BRB_L2CA_UPDATE_CHANNEL</a>.
...
Defines the format for a command to unregister a previously registered SCO server. For more
      ...
      <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_sco_unregister_server">
...
Defines the format of SCO open channel and the SCO open channel response commands sent to the
      ...
      <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_sco_open_channel">_BRB_SCO_OPEN_CHANNEL</a>.
...
Defines the format of a SCO close channel command sent to the Bluetooth device. For more
      ...
      <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_sco_close_channel">_BRB_SCO_CLOSE_CHANNEL</a>.

### -field BrbScoFlushChannel

Defines the format of a SCO flush channel command. For more information about flushing a SCO
      channel, see 
      <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_sco_flush_channel">_BRB_SCO_FLUSH_CHANNEL</a>.
...
Defines the format of a command that reads isochronous data from or writes data to a SCO channel
      ...
      <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_sco_transfer">_BRB_SCO_TRANSFER</a>.
...
Defines the format of a command that reads the SCO settings of the local system. For more
      ...
      <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_sco_get_system_info">_BRB_SCO_GET_SYSTEM_INFO</a>.
...
Defines the format of the enhanced L2CAP open channel and the enhanced L2CAP open channel response commands sent to
      ...
      <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_l2ca_open_enhanced_channel">_BRB_L2CA_OPEN_ENHANCED_CHANNEL</a>. This member is present in Windows 8 and later versions of Windows.
...
<a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_acl_enter_active_mode">_BRB_ACL_ENTER_ACTIVE_MODE</a>
...
<a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_brb_l2ca_unregister_server">_BRB_L2CA_UNREGISTER_SERVER</a>
