...
f1_keywords:
 ...
 - bthddi/PFNBTHPORT_INDICATION_CALLBACK_ENHANCED
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The 
    <a href="/windows-hardware/drivers/ddi/bthddi/ns-bthddi-_indication_parameters_enhanced">INDICATION_PARAMETERS_ENHANCED</a> structure held in
    the 
