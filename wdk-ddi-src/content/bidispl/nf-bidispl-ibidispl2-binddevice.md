...
ms.date: 2/2/2018
ms.keywords: BindDevice method [Print Devices], IBidiSpl2 interface, gdi.ibidispl2_ibidispl2__binddevice, BIDI_ACCESS_USER, BindDevice method [Print Devices], _win32_IBidiSpl2_BindDevice, IBidiSpl2 interface [Print Devices], BindDevice method, BIDI_ACCESS_ADMINISTRATOR, IBidiSpl2::BindDevice, IBidiSpl2, bidispl/IBidiSpl2::BindDevice, print.ibidispl2_ibidispl2__binddevice, BindDevice
