...
ms.date: 2/22/2018
ms.keywords: ",  , *, *PSYNTH_REVERB_PARAMS, ,, A, B, E, H, M, N, P, PSYNTH_REVERB_PARAMS, PSYNTH_REVERB_PARAMS structure pointer [Audio Devices], R, S, SYNTH_REVERB_PARAMS, SYNTH_REVERB_PARAMS structure [Audio Devices], T, V, Y, _, _SYNTH_REVERB_PARAMS, audio.synth_reverb_params, dmusprop/PSYNTH_REVERB_PARAMS, dmusprop/SYNTH_REVERB_PARAMS"
