...
ms.date: 2/22/2018
ms.keywords: SYNTH_REVERB_PARAMS, PSYNTH_REVERB_PARAMS structure pointer [Audio Devices], *PSYNTH_REVERB_PARAMS, dmusprop/PSYNTH_REVERB_PARAMS, audio.synth_reverb_params, PSYNTH_REVERB_PARAMS, SYNTH_REVERB_PARAMS structure [Audio Devices], _SYNTH_REVERB_PARAMS, dmusprop/SYNTH_REVERB_PARAMS
