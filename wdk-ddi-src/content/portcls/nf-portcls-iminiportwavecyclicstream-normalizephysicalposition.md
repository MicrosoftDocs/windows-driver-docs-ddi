...
ms.date: 2/8/2018
ms.keywords: audmp-routines_a1b6d530-8199-4c5d-87ee-8f00d60436b0.xml, NormalizePhysicalPosition method [Audio Devices], IMiniportWaveCyclicStream interface, IMiniportWaveCyclicStream::NormalizePhysicalPosition, IMiniportWaveCyclicStream interface [Audio Devices], NormalizePhysicalPosition method, portcls/IMiniportWaveCyclicStream::NormalizePhysicalPosition, NormalizePhysicalPosition, IMiniportWaveCyclicStream, NormalizePhysicalPosition method [Audio Devices], audio.iminiportwavecyclicstream_normalizephysicalposition
