...
ms.date: 2/22/2018
ms.keywords: audio.iservicegroup_requestdelayedservice, RequestDelayedService, audmp-routines_2f9be34c-bff3-46d4-a490-595c8f4311b9.xml, RequestDelayedService method [Audio Devices], IServiceGroup, portcls/IServiceGroup::RequestDelayedService, RequestDelayedService method [Audio Devices], IServiceGroup interface, IServiceGroup::RequestDelayedService, IServiceGroup interface [Audio Devices], RequestDelayedService method
