...
ms.date: 12/14/2017
ms.keywords: audio.iminiportwavepcistream_revokemappings, RevokeMappings method [Audio Devices], IMiniportWavePciStream interface, IMiniportWavePciStream::RevokeMappings, IMiniportWavePciStream interface [Audio Devices], RevokeMappings method, RevokeMappings, audmp-routines_f995bc15-917a-416d-9066-3d5667866973.xml, IMiniportWavePciStream, RevokeMappings method [Audio Devices], portcls/IMiniportWavePciStream::RevokeMappings
