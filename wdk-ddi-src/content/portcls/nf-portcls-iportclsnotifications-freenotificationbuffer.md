...
ms.date: 2/22/2018
ms.keywords: audio.iportclsnotifications_freenotification, IPortClsNotifications interface [Audio Devices], FreeNotificationBuffer method, portcls/IPortClsNotifications::FreeNotificationBuffer, FreeNotificationBuffer method [Audio Devices], IPortClsNotifications, FreeNotificationBuffer, FreeNotificationBuffer method [Audio Devices], IPortClsNotifications interface, IPortClsNotifications::FreeNotificationBuffer
