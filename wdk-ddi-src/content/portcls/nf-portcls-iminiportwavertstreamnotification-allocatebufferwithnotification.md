...
ms.date: 12/14/2017
ms.keywords: audmp-routines_84faf4d3-ee36-4996-8de2-0f89b41c18fe.xml, audio.iminiportwavertstreamnotification_allocatebufferwithnotification, IMiniportWaveRTStreamNotification::AllocateBufferWithNotification, AllocateBufferWithNotification, AllocateBufferWithNotification method [Audio Devices], IMiniportWaveRTStreamNotification interface, AllocateBufferWithNotification method [Audio Devices], IMiniportWaveRTStreamNotification, IMiniportWaveRTStreamNotification interface [Audio Devices], AllocateBufferWithNotification method, portcls/IMiniportWaveRTStreamNotification::AllocateBufferWithNotification
