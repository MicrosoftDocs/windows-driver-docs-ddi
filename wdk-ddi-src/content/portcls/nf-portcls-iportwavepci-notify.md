...
ms.date: 12/14/2017
ms.keywords: Notify method [Audio Devices], IPortWavePci, audio.iportwavepci_notify, audmp-routines_5b988b85-05d1-4a66-b04d-fdd21dcf0310.xml, portcls/IPortWavePci::Notify, Notify method [Audio Devices], IPortWavePci interface, IPortWavePci interface [Audio Devices], Notify method, Notify, IPortWavePci::Notify
