...
ms.date: 12/14/2017
ms.keywords: audmp-routines_fd2d7813-ebe8-4cf3-8a6c-4ebfccca5826.xml, Init method [Audio Devices], IMiniportWavePci interface, Init method [Audio Devices], IMiniportWavePci interface [Audio Devices], Init method, IMiniportWavePci, audio.iminiportwavepci_init, Init, IMiniportWavePci::Init, portcls/IMiniportWavePci::Init
