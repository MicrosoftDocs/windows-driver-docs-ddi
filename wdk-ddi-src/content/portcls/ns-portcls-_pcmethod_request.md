...
ms.date: 2/22/2018
ms.keywords: portcls/PCMETHOD_REQUEST, PPCMETHOD_REQUEST, portcls/PPCMETHOD_REQUEST, PCMETHOD_REQUEST structure [Audio Devices], PPCMETHOD_REQUEST structure pointer [Audio Devices], audpc-struct_08efa6de-5d0e-445b-9402-563604dd8d5d.xml, _PCMETHOD_REQUEST, *PPCMETHOD_REQUEST, audio.pcmethod_request, PCMETHOD_REQUEST
