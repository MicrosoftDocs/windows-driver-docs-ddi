...
ms.date: 2/22/2018
ms.keywords: SetTechnology method [Audio Devices], audio.imusictechnology_settechnology, portcls/IMusicTechnology::SetTechnology, audmp-routines_d1d6abaa-c4b8-4dce-8ce5-9fc12cc87852.xml, IMusicTechnology, IMusicTechnology::SetTechnology, IMusicTechnology interface [Audio Devices], SetTechnology method, SetTechnology, SetTechnology method [Audio Devices], IMusicTechnology interface
