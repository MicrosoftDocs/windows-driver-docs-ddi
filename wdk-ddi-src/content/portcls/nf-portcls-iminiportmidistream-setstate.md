...
ms.date: 2/22/2018
ms.keywords: IMiniportMidiStream, SetState, SetState method [Audio Devices], audio.iminiportmidistream_setstate, audmp-routines_23f064df-faef-4c45-a58e-c5e3e1d7d7a5.xml, SetState method [Audio Devices], IMiniportMidiStream interface, portcls/IMiniportMidiStream::SetState, IMiniportMidiStream::SetState, IMiniportMidiStream interface [Audio Devices], SetState method
