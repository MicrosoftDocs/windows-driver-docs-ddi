...
An adapter driver forms a miniport/port driver pair by binding an <code>IMiniportWavePci</code> object to an <a href="/previous-versions/windows/hardware/drivers/ff536905(v=vs.85)">IPortWavePci</a> object. The PortCls system driver registers this pair with the system as a <a href="/windows-hardware/drivers/audio/wave-filters">wave filter</a>.
