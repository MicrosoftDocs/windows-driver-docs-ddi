...
ms.date: 12/14/2017
ms.keywords: GetLfxState method [Audio Devices], IMiniportStreamAudioEngineNode interface, portcls/IMiniportStreamAudioEngineNode::GetLfxState, IMiniportStreamAudioEngineNode interface [Audio Devices], GetLfxState method, audio.iminiportstreamaudioenginenode_getlfxstate, GetLfxState, IMiniportStreamAudioEngineNode, IMiniportStreamAudioEngineNode::GetLfxState, GetLfxState method [Audio Devices]
