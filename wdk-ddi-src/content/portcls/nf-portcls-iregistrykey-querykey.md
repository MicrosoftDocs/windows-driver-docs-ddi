...
ms.date: 12/14/2017
ms.keywords: QueryKey method [Audio Devices], audmp-routines_88fe19d0-095e-4f70-b8aa-a0c908600296.xml, QueryKey method [Audio Devices], IRegistryKey interface, IRegistryKey, IRegistryKey::QueryKey, portcls/IRegistryKey::QueryKey, IRegistryKey interface [Audio Devices], QueryKey method, QueryKey, audio.iregistrykey_querykey
