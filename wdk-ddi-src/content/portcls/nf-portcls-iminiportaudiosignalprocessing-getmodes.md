...
ms.date: 2/22/2018
ms.keywords: IMiniportAudioSignalProcessing interface [Audio Devices], GetModes method, GetModes method [Audio Devices], IMiniportAudioSignalProcessing interface, audio.iminiportaudiosignalprocessing_getmodes, IMiniportAudioSignalProcessing::GetModes, GetModes, IMiniportAudioSignalProcessing, GetModes method [Audio Devices], portcls/IMiniportAudioSignalProcessing::GetModes
