...
ms.date: 12/14/2017
ms.keywords: IPortWavePci, IPortWavePci interface [Audio Devices], NewMasterDmaChannel method, IPortWavePci::NewMasterDmaChannel, audmp-routines_01c562e8-f0b7-4232-9595-2312175c097f.xml, NewMasterDmaChannel method [Audio Devices], NewMasterDmaChannel method [Audio Devices], IPortWavePci interface, portcls/IPortWavePci::NewMasterDmaChannel, audio.iportwavepci_newmasterdmachannel, NewMasterDmaChannel
