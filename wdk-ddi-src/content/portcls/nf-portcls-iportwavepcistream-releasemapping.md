...
ms.date: 12/14/2017
ms.keywords: audio.iportwavepcistream_releasemapping, IPortWavePciStream interface [Audio Devices], ReleaseMapping method, ReleaseMapping method [Audio Devices], IPortWavePciStream interface, audmp-routines_a4e274f7-02f8-4775-854f-befdc7dc6f03.xml, IPortWavePciStream, portcls/IPortWavePciStream::ReleaseMapping, ReleaseMapping method [Audio Devices], IPortWavePciStream::ReleaseMapping, ReleaseMapping
