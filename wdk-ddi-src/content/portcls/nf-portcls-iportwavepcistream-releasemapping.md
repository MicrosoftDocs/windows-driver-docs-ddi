...
ms.date: 12/14/2017
ms.keywords: audio.iportwavepcistream_releasemapping, audmp-routines_a4e274f7-02f8-4775-854f-befdc7dc6f03.xml, portcls/IPortWavePciStream::ReleaseMapping, ReleaseMapping method [Audio Devices], IPortWavePciStream interface, ReleaseMapping, IPortWavePciStream, ReleaseMapping method [Audio Devices], IPortWavePciStream interface [Audio Devices], ReleaseMapping method, IPortWavePciStream::ReleaseMapping
