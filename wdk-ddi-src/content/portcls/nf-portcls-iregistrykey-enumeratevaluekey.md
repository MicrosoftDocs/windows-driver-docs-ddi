...
ms.date: 12/14/2017
ms.keywords: EnumerateValueKey method [Audio Devices], portcls/IRegistryKey::EnumerateValueKey, audmp-routines_8b4fc752-24a3-4331-b90b-85642dc2121a.xml, IRegistryKey interface [Audio Devices], EnumerateValueKey method, audio.iregistrykey_enumeratevaluekey, IRegistryKey, EnumerateValueKey method [Audio Devices], IRegistryKey interface, IRegistryKey::EnumerateValueKey, EnumerateValueKey
