...
ms.date: 12/14/2017
ms.keywords: PinCount, audio.ipincount_pincount, audmp-routines_bded3ce8-936c-4391-901f-df6b2061c7c3.xml, IPinCount::PinCount, portcls/IPinCount::PinCount, PinCount method [Audio Devices], IPinCount, PinCount method [Audio Devices], IPinCount interface, IPinCount interface [Audio Devices], PinCount method
