...
ms.date: 2/22/2018
ms.keywords: audio.iinterruptsync_getkinterrupt, GetKInterrupt method [Audio Devices], audmp-routines_7782adef-dc02-4876-bd48-812f8b3e58da.xml, portcls/IInterruptSync::GetKInterrupt, IInterruptSync interface [Audio Devices], GetKInterrupt method, GetKInterrupt, IInterruptSync::GetKInterrupt, IInterruptSync, GetKInterrupt method [Audio Devices], IInterruptSync interface
