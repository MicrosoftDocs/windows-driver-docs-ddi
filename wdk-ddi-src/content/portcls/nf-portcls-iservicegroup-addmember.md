...
ms.date: 2/22/2018
ms.keywords: portcls/IServiceGroup::AddMember, IServiceGroup::AddMember, audio.iservicegroup_addmember, AddMember, IServiceGroup interface [Audio Devices], AddMember method, audmp-routines_0d318d56-28e9-4e42-84b3-1d0eb4110f71.xml, IServiceGroup, AddMember method [Audio Devices], IServiceGroup interface, AddMember method [Audio Devices]
