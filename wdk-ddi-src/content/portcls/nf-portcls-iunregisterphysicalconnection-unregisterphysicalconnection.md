...
ms.date: 12/14/2017
ms.keywords: UnregisterPhysicalConnection, IUnregisterPhysicalConnection::UnregisterPhysicalConnection, IUnregisterPhysicalConnection interface [Audio Devices], UnregisterPhysicalConnection method, audmp-routines_5ecc7a84-6d2c-4514-9de8-cb1e4c60a61c.xml, UnregisterPhysicalConnection method [Audio Devices], IUnregisterPhysicalConnection interface, portcls/IUnregisterPhysicalConnection::UnregisterPhysicalConnection, UnregisterPhysicalConnection method [Audio Devices], audio.iunregisterphysicalconnection_unregisterphysicalconnection, IUnregisterPhysicalConnection
