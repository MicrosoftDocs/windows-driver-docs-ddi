...
ms.date: 12/14/2017
ms.keywords: SetGfxState, SetGfxState method [Audio Devices], portcls/IMiniportAudioEngineNode::SetGfxState, SetGfxState method [Audio Devices], IMiniportAudioEngineNode interface, IMiniportAudioEngineNode, audio.iminiportaudioenginenode_setgfxstate, IMiniportAudioEngineNode interface [Audio Devices], SetGfxState method, IMiniportAudioEngineNode::SetGfxState
