...
ms.date: 12/14/2017
ms.keywords: IPortClsNotifications, IPortClsNotifications::AllocNotificationBuffer, AllocNotificationBuffer
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: IPortClsNotifications.AllocNotificationBuffer
