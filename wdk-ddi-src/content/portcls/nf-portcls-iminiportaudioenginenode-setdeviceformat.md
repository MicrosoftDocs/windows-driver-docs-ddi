...
ms.date: 2/22/2018
ms.keywords: SetDeviceFormat method [Audio Devices], IMiniportAudioEngineNode interface, IMiniportAudioEngineNode, SetDeviceFormat method [Audio Devices], SetDeviceFormat, audio.iminiportaudioenginenode_setdeviceformat, IMiniportAudioEngineNode interface [Audio Devices], SetDeviceFormat method, IMiniportAudioEngineNode::SetDeviceFormat, portcls/IMiniportAudioEngineNode::SetDeviceFormat
