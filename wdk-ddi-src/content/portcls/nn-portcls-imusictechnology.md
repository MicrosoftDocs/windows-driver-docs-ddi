...
The system-supplied miniport drivers DMusUART and UART both support the <code>IMusicTechnology</code> interface. For information about these drivers, see <a href="/windows-hardware/drivers/ddi/portcls/nf-portcls-pcnewminiport">PcNewMiniport</a>.

For other MIDI and DMus miniport drivers, support for <code>IMusicTechnology</code> is optional. For more information, see <a href="/windows-hardware/drivers/audio/music-technology-guids">Music Technology GUIDs</a>.