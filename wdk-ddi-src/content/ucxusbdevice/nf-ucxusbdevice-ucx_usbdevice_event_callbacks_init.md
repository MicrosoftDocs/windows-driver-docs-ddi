...
ms.date: 2/8/2018
ms.keywords: UCX_USBDEVICE_EVENT_CALLBACKS_INIT function [Buses], ucxusbdevice/UCX_USBDEVICE_EVENT_CALLBACKS_INIT, buses._ucx_usbdevice_event_callbacks_init, UCX_USBDEVICE_EVENT_CALLBACKS_INIT
