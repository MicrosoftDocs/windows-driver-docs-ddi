...
tech.root: usbref
ms.date: 05/07/2018
keywords: ["USBDEVICE_DISABLE structure"]
...
f1_keywords:
 - _USBDEVICE_DISABLE
 - ucxusbdevice/_USBDEVICE_DISABLE
 - PUSBDEVICE_DISABLE
 - ucxusbdevice/PUSBDEVICE_DISABLE
 - USBDEVICE_DISABLE
...
Contains parameters for a request to disable the specified device. This structure is passed by UCX in request parameters (<b>Parameters.Others.Arg1</b>) of a framework request object of the <a href="/windows-hardware/drivers/ddi/ucxusbdevice/nc-ucxusbdevice-evt_ucx_usbdevice_disable">EVT_UCX_USBDEVICE_DISABLE</a> callback function.
...
<a href="/windows-hardware/drivers/ddi/ucxusbdevice/nc-ucxusbdevice-evt_ucx_usbdevice_disable">EVT_UCX_USBDEVICE_DISABLE</a>
