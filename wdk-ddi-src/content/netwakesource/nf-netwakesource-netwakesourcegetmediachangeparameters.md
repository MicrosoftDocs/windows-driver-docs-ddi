...
description: The NetWakeSourceGetMediaChangeParameters method gets parameters for a media change wake-on-LAN (WoL) wake source for a net adapter.
tech.root: netvista
...
The **NetWakeSourceGetMediaChangeParameters** method gets parameters for a media change source of a wake-on-LAN (WoL) wake source from a net adapter.
