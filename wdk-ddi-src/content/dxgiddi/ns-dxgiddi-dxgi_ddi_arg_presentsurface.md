...
ms.date: 2/22/2018
ms.keywords: DXGI_DDI_ARG_PRESENTSURFACE structure [Display Devices], DXGI_DDI_ARG_PRESENTSURFACE, dxgiddi/DXGI_DDI_ARG_PRESENTSURFACE, display.dxgi_ddi_arg_presentsurface
