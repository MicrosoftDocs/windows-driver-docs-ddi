...
ms.date: 12/29/2017
ms.keywords: display.dxgi_ddi_arg_presentmultiplaneoverlay, dxgiddi/DXGI_DDI_ARG_PRESENTMULTIPLANEOVERLAY, DXGI_DDI_ARG_PRESENTMULTIPLANEOVERLAY structure [Display Devices], DXGI_DDI_ARG_PRESENTMULTIPLANEOVERLAY, _DXGI_DDI_ARG_PRESENTMULTIPLANEOVERLAY
