...
ms.date: 05/10/2018
keywords: ["DXGI_DDI_ARG_CHECKPRESENTDURATIONSUPPORT structure"]
...
f1_keywords:
 ...
 - dxgiddi/_DXGI_DDI_ARG_CHECKPRESENTDURATIONSUPPORT
...
Used in a call to the <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/dxgiddi/ns-dxgiddi-_dxgi_ddi_arg_checkpresentdurationsupport">pfnCheckPresentDurationSupport(DXGI)</a> function to check details on hardware device support for seamlessly switching to a new monitor refresh rate.
...
<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/dxgiddi/ns-dxgiddi-_dxgi_ddi_arg_checkpresentdurationsupport">pfnCheckPresentDurationSupport(DXGI)</a>
