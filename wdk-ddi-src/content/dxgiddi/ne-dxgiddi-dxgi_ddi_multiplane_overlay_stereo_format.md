...
tech.root: display
ms.date: 05/10/2018
keywords: ["DXGI_DDI_MULTIPLANE_OVERLAY_STEREO_FORMAT enumeration"]
...
f1_keywords:
 ...
 - dxgiddi/DXGI_DDI_MULTIPLANE_OVERLAY_STEREO_FORMAT
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# DXGI_DDI_MULTIPLANE_OVERLAY_STEREO_FORMAT enumeration (dxgiddi.h)
