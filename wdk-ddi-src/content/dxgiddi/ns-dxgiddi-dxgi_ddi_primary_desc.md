...
ms.date: 12/29/2017
ms.keywords: display.dxgi_ddi_primary_desc, dxgiddi/DXGI_DDI_PRIMARY_DESC, DXGI_DDI_PRIMARY_DESC structure [Display Devices], UMDisplayDriver_Dx10param_Structs_a733016c-aa05-4d79-b13b-96d1bc33dac2.xml, DXGI_DDI_PRIMARY_DESC
