...
ms.date: 2/22/2018
ms.keywords: DXGI_DDI_BASE_ARGS structure [Display Devices], dxgiddi/DXGI_DDI_BASE_ARGS, display.dxgi_ddi_base_args, UMDisplayDriver_Dx10param_Structs_3dec4197-80df-4de3-96ca-d4f90f23e85d.xml, DXGI_DDI_BASE_ARGS
