...
ms.date: 12/29/2017
ms.keywords: DXGI_DDI_MULTIPLANE_OVERLAY_ATTRIBUTES structure [Display Devices], DXGI_DDI_MULTIPLANE_OVERLAY_ATTRIBUTES, display.dxgi_ddi_multiplane_overlay_attributes, dxgiddi/DXGI_DDI_MULTIPLANE_OVERLAY_ATTRIBUTES
