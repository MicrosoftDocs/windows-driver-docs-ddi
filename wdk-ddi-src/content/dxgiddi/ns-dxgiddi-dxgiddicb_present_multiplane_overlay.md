...
description: The DXGIDDICB_PRESENT_MULTIPLANE_OVERLAY structure contains information that describes multiplane overlay allocations that content is copied to and from.
...
A handle to the Microsoft DirectX Graphics Infrastructure (DXGI)  context. This handle is opaque to the driver. The driver should assign the handle from the <b>pDXGIContext</b> member of the <a href="/windows-hardware/drivers/ddi/dxgiddi/ns-dxgiddi-_dxgi_ddi_arg_presentmultiplaneoverlay">DXGI_DDI_ARG_PRESENTMULTIPLANEOVERLAY</a> structure that the driver received in a call to its <a href="/windows-hardware/drivers/ddi/dxgiddi/nc-dxgiddi-pfnddxgiddi_present_multiplane_overlaycb">pfnPresentMultiplaneOverlay (DXGI)</a> function to this member.
...
The number of allocations in the array that the <b>AllocationInfo</b> member specifies. The maximum number is 16, the value of the <b>DXGI_DDI_MAX_MULTIPLANE_OVERLAY_ALLOCATIONS</b> constant.

### -field AllocationInfo

An array of structures of type <a href="/windows-hardware/drivers/ddi/dxgiddi/ns-dxgiddi-dxgiddi_multiplane_overlay_allocation_info">DXGIDDI_MULTIPLANE_OVERLAY_ALLOCATION_INFO</a> that specify info about the multiplane overlay allocations.

## -see-also

<a href="/windows-hardware/drivers/ddi/dxgiddi/ns-dxgiddi-dxgiddi_multiplane_overlay_allocation_info">DXGIDDI_MULTIPLANE_OVERLAY_ALLOCATION_INFO</a>
...
<a href="/windows-hardware/drivers/ddi/dxgiddi/nc-dxgiddi-pfnddxgiddi_present_multiplane_overlaycb">pfnPresentMultiplaneOverlay (DXGI)</a>
