...
ms.date: 12/29/2017
ms.keywords: display.dxgi_ddi_multiplane_overlay_caps, DXGI_DDI_MULTIPLANE_OVERLAY_CAPS, DXGI_DDI_MULTIPLANE_OVERLAY_CAPS structure [Display Devices], dxgiddi/DXGI_DDI_MULTIPLANE_OVERLAY_CAPS
