...
Client drivers typically call this method to begin the process of posting packets. Drivers later complete this process by calling [**NetPacketIteratorSet**](../netringiterator/nf-netringiterator-netpacketiteratorset.md).
