...
title: _PCI_EXPRESS_ROOT_CAPABILITIES_REGISTER (ntddk.h)
description: The _PCI_EXPRESS_ROOT_CAPABILITIES_REGISTER structure (ntddk.h) describes a PCI Express (PCIe) root capabilities register of a PCIe capability structure.
...
f1_keywords:
 ...
 - ntddk/_PCI_EXPRESS_ROOT_CAPABILITIES_REGISTER
 - PPCI_EXPRESS_ROOT_CAPABILITIES_REGISTER
 - ntddk/PPCI_EXPRESS_ROOT_CAPABILITIES_REGISTER
 - PCI_EXPRESS_ROOT_CAPABILITIES_REGISTER
 - ntddk/PCI_EXPRESS_ROOT_CAPABILITIES_REGISTER
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# PCI_EXPRESS_ROOT_CAPABILITIES_REGISTER structure (ntddk.h)
