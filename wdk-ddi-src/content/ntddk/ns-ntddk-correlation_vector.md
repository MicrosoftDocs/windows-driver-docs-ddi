...
ms.date: 2/16/2018
ms.keywords: CORRELATION_VECTOR structure [Kernel-Mode Driver Architecture], CORRELATION_VECTOR, *PCORRELATION_VECTOR, ntddk/CORRELATION_VECTOR, kernel.correlation_vector
