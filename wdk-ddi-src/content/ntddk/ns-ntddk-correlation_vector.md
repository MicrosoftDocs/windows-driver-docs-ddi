...
ms.date: 1/4/2018
ms.keywords: CORRELATION_VECTOR, CORRELATION_VECTOR structure [Kernel-Mode Driver Architecture], ntddk/CORRELATION_VECTOR, *PCORRELATION_VECTOR, kernel.correlation_vector
