...
ms.date: 12/14/2017
ms.keywords: SOC_SUBSYS_AUDIO_DSP, SOC_SUBSYSTEM_WIRELESS_MODEM, ntddk/SOC_SUBSYSTEM_TYPE, *PSOC_SUBSYSTEM_TYPE, SOC_SUBSYS_WIRELSS_CONNECTIVITY, ntddk/SOC_SUBSYS_VENDOR_DEFINED, ntddk/SOC_SUBSYS_WIRELSS_CONNECTIVITY, ntddk/SOC_SUBSYS_AUDIO_DSP, SOC_SUBSYS_VENDOR_DEFINED, _SOC_SUBSYSTEM_TYPE, SOC_SUBSYSTEM_TYPE enumeration [WHEA Drivers and Applications], ntddk/SOC_SUBSYSTEM_WIRELESS_MODEM, ntddk/SOC_SUBSYS_SENSORS, SOC_SUBSYS_SENSORS, whea.soc_sybsystem_type, SOC_SUBSYSTEM_TYPE
