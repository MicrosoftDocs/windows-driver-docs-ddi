...
ms.date: 2/20/2018
ms.keywords: ntddk/SOC_SUBSYS_VENDOR_DEFINED, SOC_SUBSYSTEM_TYPE enumeration [WHEA Drivers and Applications], whea.soc_sybsystem_type, SOC_SUBSYSTEM_TYPE, ntddk/SOC_SUBSYS_WIRELSS_CONNECTIVITY, SOC_SUBSYS_VENDOR_DEFINED, *PSOC_SUBSYSTEM_TYPE, ntddk/SOC_SUBSYS_AUDIO_DSP, ntddk/SOC_SUBSYSTEM_TYPE, SOC_SUBSYS_SENSORS, ntddk/SOC_SUBSYSTEM_WIRELESS_MODEM, ntddk/SOC_SUBSYS_SENSORS, SOC_SUBSYS_WIRELSS_CONNECTIVITY, _SOC_SUBSYSTEM_TYPE, SOC_SUBSYS_AUDIO_DSP, SOC_SUBSYSTEM_WIRELESS_MODEM
