...
ms.date: 1/4/2018
ms.keywords: ntddk/MM_COPY_ADDRESS, PMM_COPY_ADDRESS, PMM_COPY_ADDRESS structure pointer [Kernel-Mode Driver Architecture], MM_COPY_ADDRESS structure [Kernel-Mode Driver Architecture], _MM_COPY_ADDRESS, *PMMCOPY_ADDRESS, kernel.mm_copy_address, ntddk/PMM_COPY_ADDRESS, MM_COPY_ADDRESS
