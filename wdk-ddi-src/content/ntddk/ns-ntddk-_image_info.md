...
ms.date: 2/16/2018
ms.keywords: IMAGE_INFO structure [Kernel-Mode Driver Architecture], ntddk/PIMAGE_INFO, ntddk/IMAGE_INFO, PIMAGE_INFO structure pointer [Kernel-Mode Driver Architecture], PIMAGE_INFO, _IMAGE_INFO, kernel.image_info, *PIMAGE_INFO, IMAGE_INFO
