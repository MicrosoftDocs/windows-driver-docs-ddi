...
description: The _PCI_EXPRESS_DEVICE_CONTROL_REGISTER structure (ntddk.h) describes a PCI Express (PCIe) device control register of a PCIe capability structure.
...
f1_keywords:
 ...
 - ntddk/_PCI_EXPRESS_DEVICE_CONTROL_REGISTER
...
# PCI_EXPRESS_DEVICE_CONTROL_REGISTER structure (ntddk.h)
