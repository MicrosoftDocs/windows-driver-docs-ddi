...
##### - RegisterData.XPF_CONTEXT_INFO_64BITCONTEXT

The buffer contains a WHEA_X64_REGISTER_STATE structure.


##### - RegisterContextType.XPF_CONTEXT_INFO_64BITDEBUGREGS

64-bit debug registers.


##### - RegisterData.XPF_CONTEXT_INFO_MMREGISTERS
...
##### - RegisterData.XPF_CONTEXT_INFO_UNCLASSIFIEDDATA
...
##### - RegisterContextType.XPF_CONTEXT_INFO_UNCLASSIFIEDDATA

Unclassified processor context data.


##### - RegisterData.XPF_CONTEXT_INFO_32BITCONTEXT

The buffer contains a WHEA_X86_REGISTER_STATE structure.


##### - RegisterContextType.XPF_CONTEXT_INFO_32BITCONTEXT

32-bit execution context registers.


##### - RegisterData.XPF_CONTEXT_INFO_64BITDEBUGREGS

The buffer contains an array of eight 64-bit values that contain the 64-bit debug registers DR0-DR7.


##### - RegisterContextType.XPF_CONTEXT_INFO_MSRREGISTERS

Machine check and other machine-specific registers.


##### - RegisterData.XPF_CONTEXT_INFO_32BITDEBUGREGS
...
##### - RegisterContextType.XPF_CONTEXT_INFO_32BITDEBUGREGS

32-bit debug registers.


##### - RegisterData.XPF_CONTEXT_INFO_FXSAVE
...
##### - RegisterContextType.XPF_CONTEXT_INFO_64BITCONTEXT

64-bit execution context registers.


##### - RegisterData.XPF_CONTEXT_INFO_MSRREGISTERS
...
##### - RegisterContextType.XPF_CONTEXT_INFO_FXSAVE
...
##### - RegisterContextType.XPF_CONTEXT_INFO_MMREGISTERS
