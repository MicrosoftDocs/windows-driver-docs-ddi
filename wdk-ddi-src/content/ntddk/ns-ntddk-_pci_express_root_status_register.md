...
ms.date: 12/29/2017
ms.keywords: ntddk/PPCI_EXPRESS_ROOT_STATUS_REGISTER, _PCI_EXPRESS_ROOT_STATUS_REGISTER, PCI.pci_express_root_status_register, PCI_EXPRESS_ROOT_STATUS_REGISTER, PPCI_EXPRESS_ROOT_STATUS_REGISTER, PCI_EXPRESS_ROOT_STATUS_REGISTER union [Buses], *PPCI_EXPRESS_ROOT_STATUS_REGISTER, PPCI_EXPRESS_ROOT_STATUS_REGISTER union pointer [Buses], pci_struct_ff3a211f-421b-41f3-9250-d658636bfe49.xml, ntddk/PCI_EXPRESS_ROOT_STATUS_REGISTER
