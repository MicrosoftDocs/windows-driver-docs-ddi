...
description: The _PCI_EXPRESS_ROOT_STATUS_REGISTER structure (ntddk.h) describes a PCI Express (PCIe) root status register of a PCIe capability structure.
...
# PCI_EXPRESS_ROOT_STATUS_REGISTER structure (ntddk.h)
