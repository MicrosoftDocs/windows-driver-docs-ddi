...
The <i>ExpandedStackCall</i> routine must handle all exceptions. Any unhandled exception causes the system to bug check with <a href="/windows-hardware/drivers/debugger/bug-check-0x1e--kmode-exception-not-handled">Bug Check 0x1E: KMODE_EXCEPTION_NOT_HANDLED</a>.
