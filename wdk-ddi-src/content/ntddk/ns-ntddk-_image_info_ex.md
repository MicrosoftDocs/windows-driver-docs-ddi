...
ms.date: 2/24/2018
ms.keywords: ",  , *, *PIMAGE_INFO_EX, ,, A, E, F, G, I, IMAGE_INFO_EX, IMAGE_INFO_EX structure [Kernel-Mode Driver Architecture], M, N, O, P, PIMAGE_INFO_EX, PIMAGE_INFO_EX structure pointer [Kernel-Mode Driver Architecture], X, _, _IMAGE_INFO_EX, kernel.image_info_ex, ntddk/IMAGE_INFO_EX, ntddk/PIMAGE_INFO_EX"
