...
ms.date: 2/20/2018
ms.keywords: SwitchToPollingThresholdRW, SwitchToPollingWindowRW, WHEA_NOTIFICATION_DESCRIPTOR structure [WHEA Drivers and Applications], *PWHEA_NOTIFICATION_DESCRIPTOR, WHEA_NOTIFICATION_TYPE_EXTERNALINTERRUPT, WHEA_NOTIFICATION_DESCRIPTOR, whearef_c2a5ab66-2598-447b-8f5b-d6398c55ff1a.xml, WHEA_NOTIFICATION_TYPE_SCI, PollIntervalRW, WHEA_NOTIFICATION_TYPE_NMI, ErrorThresholdRW, ntddk/WHEA_NOTIFICATION_DESCRIPTOR, AsUSHORT, Reserved, _WHEA_NOTIFICATION_DESCRIPTOR, whea.whea_notification_descriptor, WHEA_NOTIFICATION_TYPE_LOCALINTERRUPT, WHEA_NOTIFICATION_TYPE_POLLED, ErrorThresholdWindowRW
