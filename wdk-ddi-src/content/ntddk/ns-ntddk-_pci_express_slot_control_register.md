...
description: The _PCI_EXPRESS_SLOT_CONTROL_REGISTER structure (ntddk.h) describes a PCI Express (PCIe) slot control register.
...
# PCI_EXPRESS_SLOT_CONTROL_REGISTER structure (ntddk.h)
