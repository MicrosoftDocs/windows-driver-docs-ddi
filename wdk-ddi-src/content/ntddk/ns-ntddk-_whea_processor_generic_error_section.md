...
ms.date: 2/20/2018
ms.keywords: GENPROC_PROCISA_X64, GENPROC_PROCISA_IPF, ntddk/WHEA_PROCESSOR_GENERIC_ERROR_SECTION, GENPROC_OP_INSTRUCTIONEXE, GENPROC_PROCERRTYPE_CACHE, GENPROC_PROCERRTYPE_TLB, GENPROC_PROCERRTYPE_UNKNOWN, PWHEA_PROCESSOR_GENERIC_ERROR_SECTION structure pointer [WHEA Drivers and Applications], GENPROC_OP_DATAWRITE, GENPROC_FLAGS_PRECISEIP, PWHEA_PROCESSOR_GENERIC_ERROR_SECTION, GENPROC_FLAGS_RESTARTABLE, whearef_589ac6c8-3889-4033-8776-0d8f402d1f69.xml, GENPROC_PROCTYPE_IPF, GENPROC_OP_GENERIC, GENPROC_PROCISA_X86, _WHEA_PROCESSOR_GENERIC_ERROR_SECTION, whea.whea_processor_generic_error_section, ntddk/PWHEA_PROCESSOR_GENERIC_ERROR_SECTION, WHEA_PROCESSOR_GENERIC_ERROR_SECTION structure [WHEA Drivers and Applications], GENPROC_OP_DATAREAD, GENPROC_PROCERRTYPE_BUS, GENPROC_FLAGS_OVERFLOW, GENPROC_PROCERRTYPE_MAE, GENPROC_PROCTYPE_XPF, GENPROC_FLAGS_CORRECTED, WHEA_GENERIC_PROCESSOR_ERROR, *PWHEA_PROCESSOR_GENERIC_ERROR_SECTION, *PWHEA_GENERIC_PROCESSOR_ERROR, WHEA_PROCESSOR_GENERIC_ERROR_SECTION
