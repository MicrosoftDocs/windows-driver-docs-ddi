...
ms.date: 2/8/2018
ms.keywords: GENPROC_PROCISA_X64, GENPROC_FLAGS_CORRECTED, GENPROC_PROCISA_IPF, PWHEA_PROCESSOR_GENERIC_ERROR_SECTION, WHEA_GENERIC_PROCESSOR_ERROR, GENPROC_PROCERRTYPE_MAE, GENPROC_FLAGS_OVERFLOW, whea.whea_processor_generic_error_section, WHEA_PROCESSOR_GENERIC_ERROR_SECTION structure [WHEA Drivers and Applications], ntddk/PWHEA_PROCESSOR_GENERIC_ERROR_SECTION, GENPROC_OP_GENERIC, ntddk/WHEA_PROCESSOR_GENERIC_ERROR_SECTION, GENPROC_OP_DATAWRITE, GENPROC_PROCERRTYPE_BUS, GENPROC_OP_INSTRUCTIONEXE, *PWHEA_GENERIC_PROCESSOR_ERROR, GENPROC_PROCTYPE_IPF, GENPROC_FLAGS_PRECISEIP, WHEA_PROCESSOR_GENERIC_ERROR_SECTION, GENPROC_PROCERRTYPE_UNKNOWN, GENPROC_PROCTYPE_XPF, _WHEA_PROCESSOR_GENERIC_ERROR_SECTION, *PWHEA_PROCESSOR_GENERIC_ERROR_SECTION, GENPROC_PROCERRTYPE_CACHE, PWHEA_PROCESSOR_GENERIC_ERROR_SECTION structure pointer [WHEA Drivers and Applications], whearef_589ac6c8-3889-4033-8776-0d8f402d1f69.xml, GENPROC_PROCERRTYPE_TLB, GENPROC_PROCISA_X86, GENPROC_OP_DATAREAD, GENPROC_FLAGS_RESTARTABLE
