...
description: The _PCI_EXPRESS_DEVICE_CAPABILITIES_REGISTER structure (ntddk.h) describes a PCI Express (PCIe) device capabilities register of a PCIe capability structure.
...
# PCI_EXPRESS_DEVICE_CAPABILITIES_REGISTER structure (ntddk.h)
...
A PCI_EXPRESS_DEVICE_CAPABILITIES_REGISTER structure is contained in the <a href="/windows-hardware/drivers/ddi/ntddk/ns-ntddk-_pci_express_capability">PCI_EXPRESS_CAPABILITY</a> structure.
