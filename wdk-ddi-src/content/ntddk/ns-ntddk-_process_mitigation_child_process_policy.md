...
ms.date: 1/4/2018
ms.keywords: kernel.process_mitigation_child_process_policy, ntddk/PROCESS_MITIGATION_CHILD_PROCESS_POLICY, _PROCESS_MITIGATION_CHILD_PROCESS_POLICY, PROCESS_MITIGATION_CHILD_PROCESS_POLICY structure [Kernel-Mode Driver Architecture], PROCESS_MITIGATION_CHILD_PROCESS_POLICY, *PPROCESS_MITIGATION_CHILD_PROCESS_POLICY
...
#### DUMMYSTRUCTNAME.NoChildProcessCreation

If set, the process cannot create child processes.


#### DUMMYSTRUCTNAME.AuditNoChildProcessCreation
...
#### DUMMYSTRUCTNAME.AllowSecureProcessCreation
