...
ms.date: 2/20/2018
ms.keywords: whea.whea_error_packet_flags, ntddk/WHEA_ERROR_PACKET_FLAGS, PWHEA_ERROR_PACKET_FLAGS, WHEA_ERROR_PACKET_FLAGS, _WHEA_ERROR_PACKET_FLAGS, WHEA_ERROR_PACKET_FLAGS union [WHEA Drivers and Applications], whearef_c193e4e7-f233-4de0-93ac-5e7b841a6c6e.xml, ntddk/PWHEA_ERROR_PACKET_FLAGS, PWHEA_ERROR_PACKET_FLAGS union pointer [WHEA Drivers and Applications], *PWHEA_ERROR_PACKET_FLAGS
