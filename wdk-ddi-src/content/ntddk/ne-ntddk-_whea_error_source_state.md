...
ms.date: 2/20/2018
ms.keywords: ntddk/PWHEA_ERROR_SOURCE_STATE, ntddk/WheaErrSrcStateStarted, WHEA_ERROR_SOURCE_STATE enumeration [WHEA Drivers and Applications], WheaErrSrcStateStarted, ntddk/WHEA_ERROR_SOURCE_STATE, PWHEA_ERROR_SOURCE_STATE, _WHEA_ERROR_SOURCE_STATE, ntddk/WheaErrSrcStateStopped, whea.whea_error_source_state, *PWHEA_ERROR_SOURCE_STATE, WheaErrSrcStateStopped, whearef_c6edca73-b5ec-4473-bbe3-9ed5e48f017d.xml, PWHEA_ERROR_SOURCE_STATE enumeration pointer [WHEA Drivers and Applications], WHEA_ERROR_SOURCE_STATE
