...
f1_keywords:
 ...
 - ntddmmc/_GET_CONFIGURATION_IOCTL_INPUT
 - PGET_CONFIGURATION_IOCTL_INPUT
 - ntddmmc/PGET_CONFIGURATION_IOCTL_INPUT
...
The GET_CONFIGURATION_IOCTL_INPUT structure is used in conjunction with the <a href="/windows-hardware/drivers/ddi/ntddcdrm/ni-ntddcdrm-ioctl_cdrom_get_configuration">IOCTL_CDROM_GET_CONFIGURATION</a> request to specify the sort of feature data that the request retrieves.
