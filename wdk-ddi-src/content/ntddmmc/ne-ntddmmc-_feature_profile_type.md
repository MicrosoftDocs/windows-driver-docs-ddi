...
tech.root: storage
ms.date: 03/29/2018
keywords: ["FEATURE_PROFILE_TYPE enumeration"]
...
f1_keywords:
 ...
 - ntddmmc/_FEATURE_PROFILE_TYPE
 - PFEATURE_PROFILE_TYPE
 - ntddmmc/PFEATURE_PROFILE_TYPE
 - FEATURE_PROFILE_TYPE
 - ntddmmc/FEATURE_PROFILE_TYPE
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# FEATURE_PROFILE_TYPE enumeration (ntddmmc.h)
