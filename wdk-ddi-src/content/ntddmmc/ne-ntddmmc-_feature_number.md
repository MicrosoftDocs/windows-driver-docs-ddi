...
ms.date: 2/16/2018
ms.keywords: ntddmmc/FeatureDvdPlusRDualLayer, FeatureDvdRead, ntddmmc/FeatureHDDVDWrite, FeatureRandomReadable, ntddmmc/FeatureEnhancedDefectReporting, ntddmmc/FeatureRandomReadable, ntddmmc/FeatureVCPS, FeatureRealTimeStreaming, ntddmmc/FeatureMultiRead, ntddmmc/FeatureDDCDRWrite, FeatureCore, ntddmmc/FeatureHDDVDRead, FeatureProfileList, FeatureBDRead, ntddmmc/FeatureRestrictedOverwrite, FeatureDvdPlusRWDualLayer, ntddmmc/FeatureCore, ntddmmc/FeatureDvdPlusRW, FeatureDvdPlusRW, FeatureDDCDRWWrite, ntddmmc/FeatureCdRead, FEATURE_NUMBER enumeration [Storage Devices], ntddmmc/FeatureDDCDRead, FeatureHybridDisc, ntddmmc/FeatureTimeout, FeatureBDRPseudoOverwrite, ntddmmc/FeatureFirmwareDate, FeatureBDWrite, ntddmmc/FeatureDvdPlusRWDualLayer, FeatureCdTrackAtOnce, ntddmmc/FeatureDefectManagement, ntddmmc/FeatureDvdPlusR, FeatureRandomWritable, ntddmmc/FeatureBDRead, FeatureDvdRecordableWrite, ntddmmc/FeatureMrw, ntddmmc/FeatureDiscControlBlocks, FeatureDefectManagement, ntddmmc/FeatureWriteOnce, *PFEATURE_NUMBER, ntddmmc/FeatureDvdCPRM, ntddmmc/FeatureDvdCSS, ntddmmc/FeatureAACS, FeatureFirmwareDate, ntddmmc/FeatureMicrocodeUpgrade, ntddmmc/FeatureCdTrackAtOnce, FeatureDvdPlusR, FeatureEmbeddedChanger, PFEATURE_NUMBER enumeration pointer [Storage Devices], ntddmmc/FeatureRealTimeStreaming, storage.feature_number, FeatureDvdCPRM, ntddmmc/FeaturePowerManagement, FeatureCdMastering, PFEATURE_NUMBER, structs-CD-ROM_6d75ed9b-8d13-4715-ae9a-51bc2a6025f0.xml, FeatureRigidRestrictedOverwrite, FeatureLayerJumpRecording, FeatureTSR, ntddmmc/FeatureCdrwCAVWrite, ntddmmc/FeatureRigidRestrictedOverwrite, FeatureVCPS, FeatureRemovableMedium, FeatureEnhancedDefectReporting, ntddmmc/FeatureCDRWMediaWriteSupport, FeatureCDAudioAnalogPlay, ntddmmc/FeatureIncrementalStreamingWritable, FeatureWriteOnce, _FEATURE_NUMBER, FeatureAACS, ntddmmc/FeatureFormattable, ntddmmc/FeatureRemovableMedium, FeatureMultiRead, FeatureTimeout, FeatureDvdCSS, FeatureMrw, ntddmmc/FeatureDvdRead, ntddmmc/FeatureSectorErasable, ntddmmc/FeatureEmbeddedChanger, FeatureSMART, ntddmmc/FeatureLogicalUnitSerialNumber, ntddmmc/FeatureLayerJumpRecording, ntddmmc/FeatureDvdRecordableWrite, FeatureHDDVDWrite, ntddmmc/FeatureWriteProtect, FeatureCdrwCAVWrite, ntddmmc/FeatureHybridDisc, ntddmmc/FeatureMediaSerialNumber, ntddmmc/FeatureProfileList, ntddmmc/PFEATURE_NUMBER, FeatureDvdPlusRDualLayer, ntddmmc/FEATURE_NUMBER, FeatureSectorErasable, FEATURE_NUMBER, ntddmmc/FeatureDDCDRWWrite, FeatureRestrictedOverwrite, ntddmmc/FeatureSMART, ntddmmc/FeatureMorphing, FeatureWriteProtect, ntddmmc/FeatureCDAudioAnalogPlay, FeatureIncrementalStreamingWritable, FeatureHDDVDRead, ntddmmc/FeatureCdMastering, FeatureMicrocodeUpgrade, FeatureMorphing, FeatureCDRWMediaWriteSupport, ntddmmc/FeatureRandomWritable, FeatureFormattable, FeatureDDCDRWrite, FeatureLogicalUnitSerialNumber, FeatureMediaSerialNumber, ntddmmc/FeatureTSR, FeatureDDCDRead, ntddmmc/FeatureBDRPseudoOverwrite, FeatureDiscControlBlocks, FeaturePowerManagement, ntddmmc/FeatureBDWrite, FeatureCdRead
