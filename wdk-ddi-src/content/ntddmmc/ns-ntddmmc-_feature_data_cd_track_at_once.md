...
ms.date: 1/10/2018
ms.keywords: ntddmmc/FEATURE_DATA_CD_TRACK_AT_ONCE, storage.feature_data_cd_track_at_once, _FEATURE_DATA_CD_TRACK_AT_ONCE, FEATURE_DATA_CD_TRACK_AT_ONCE structure [Storage Devices], structs-CD-ROM_d2648aa5-b3d5-49f2-98d1-01e90dd72332.xml, PFEATURE_DATA_CD_TRACK_AT_ONCE structure pointer [Storage Devices], FEATURE_DATA_CD_TRACK_AT_ONCE, ntddmmc/PFEATURE_DATA_CD_TRACK_AT_ONCE, *PFEATURE_DATA_CD_TRACK_AT_ONCE, PFEATURE_DATA_CD_TRACK_AT_ONCE
