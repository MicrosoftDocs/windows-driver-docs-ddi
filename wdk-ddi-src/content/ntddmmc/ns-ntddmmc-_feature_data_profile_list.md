...
ms.date: 2/16/2018
ms.keywords: PFEATURE_DATA_PROFILE_LIST structure pointer [Storage Devices], FEATURE_DATA_PROFILE_LIST structure [Storage Devices], FEATURE_DATA_PROFILE_LIST, PFEATURE_DATA_PROFILE_LIST, ntddmmc/PFEATURE_DATA_PROFILE_LIST, *PFEATURE_DATA_PROFILE_LIST, structs-CD-ROM_fae1990f-a605-4281-a8e6-e8e08431493d.xml, storage.feature_data_profile_list, _FEATURE_DATA_PROFILE_LIST, ntddmmc/FEATURE_DATA_PROFILE_LIST
