...
ms.date: 2/16/2018
ms.keywords: STORAGE_PREDICT_FAILURE, *PSTORAGE_PREDICT_FAILURE, _STORAGE_PREDICT_FAILURE, STORAGE_PREDICT_FAILURE structure [Storage Devices], ntddstor/STORAGE_PREDICT_FAILURE, PSTORAGE_PREDICT_FAILURE structure pointer [Storage Devices], storage.storage_predict_failure, structs-general_b1bed4c9-33a9-4adf-a456-e420d1e2f317.xml, ntddstor/PSTORAGE_PREDICT_FAILURE, PSTORAGE_PREDICT_FAILURE
