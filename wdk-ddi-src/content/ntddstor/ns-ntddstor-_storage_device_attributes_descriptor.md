...
ms.date: 1/10/2018
ms.keywords: STORAGE_ATTRIBUTE_ASYNC_EVENT_NOTIFICATION, storage.storage_device_attributes_descriptor, ntddstor/PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_ATTRIBUTE_DYNAMIC_PERSISTENCE, PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR structure pointer [Storage Devices], STORAGE_ATTRIBUTE_PERF_SIZE_INDEPENDENT, _STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, ntddstor/STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_ATTRIBUTE_VOLATILE, STORAGE_ATTRIBUTE_BLOCK_IO, STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_ATTRIBUTE_BYTE_ADDRESSABLE_IO, PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR structure [Storage Devices]
