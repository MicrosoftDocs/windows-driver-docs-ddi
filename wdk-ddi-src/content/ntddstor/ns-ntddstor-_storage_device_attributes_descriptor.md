...
ms.date: 1/10/2018
ms.keywords: STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_ATTRIBUTE_BLOCK_IO, STORAGE_ATTRIBUTE_VOLATILE, storage.storage_device_attributes_descriptor, PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_ATTRIBUTE_DYNAMIC_PERSISTENCE, STORAGE_ATTRIBUTE_ASYNC_EVENT_NOTIFICATION, STORAGE_ATTRIBUTE_PERF_SIZE_INDEPENDENT, STORAGE_ATTRIBUTE_BYTE_ADDRESSABLE_IO, STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR structure [Storage Devices], ntddstor/PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, ntddstor/STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, _STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR structure pointer [Storage Devices]
