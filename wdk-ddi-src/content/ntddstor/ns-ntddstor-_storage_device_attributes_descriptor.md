...
ms.date: 2/16/2018
ms.keywords: STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR structure pointer [Storage Devices], STORAGE_ATTRIBUTE_DYNAMIC_PERSISTENCE, STORAGE_ATTRIBUTE_ASYNC_EVENT_NOTIFICATION, STORAGE_ATTRIBUTE_VOLATILE, ntddstor/STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, _STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_ATTRIBUTE_PERF_SIZE_INDEPENDENT, STORAGE_ATTRIBUTE_BLOCK_IO, STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR structure [Storage Devices], PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, storage.storage_device_attributes_descriptor, STORAGE_ATTRIBUTE_BYTE_ADDRESSABLE_IO, ntddstor/PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR
