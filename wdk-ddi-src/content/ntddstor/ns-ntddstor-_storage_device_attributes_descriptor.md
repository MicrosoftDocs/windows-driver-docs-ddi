...
ms.date: 2/16/2018
ms.keywords: STORAGE_ATTRIBUTE_VOLATILE, ntddstor/STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR structure pointer [Storage Devices], STORAGE_ATTRIBUTE_ASYNC_EVENT_NOTIFICATION, STORAGE_ATTRIBUTE_BLOCK_IO, STORAGE_ATTRIBUTE_BYTE_ADDRESSABLE_IO, _STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_ATTRIBUTE_DYNAMIC_PERSISTENCE, STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR structure [Storage Devices], storage.storage_device_attributes_descriptor, ntddstor/PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_ATTRIBUTE_PERF_SIZE_INDEPENDENT
