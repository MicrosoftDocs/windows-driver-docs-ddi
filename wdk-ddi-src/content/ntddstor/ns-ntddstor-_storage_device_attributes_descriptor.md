...
ms.date: 1/10/2018
ms.keywords: storage.storage_device_attributes_descriptor, ntddstor/STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_ATTRIBUTE_BLOCK_IO, STORAGE_ATTRIBUTE_ASYNC_EVENT_NOTIFICATION, STORAGE_ATTRIBUTE_DYNAMIC_PERSISTENCE, STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR structure [Storage Devices], STORAGE_ATTRIBUTE_BYTE_ADDRESSABLE_IO, PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR structure pointer [Storage Devices], _STORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_ATTRIBUTE_VOLATILE, PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, ntddstor/PSTORAGE_DEVICE_ATTRIBUTES_DESCRIPTOR, STORAGE_ATTRIBUTE_PERF_SIZE_INDEPENDENT
