...
ms.date: 2/16/2018
ms.keywords: PDEVICE_WRITE_AGGREGATION_DESCRIPTOR structure pointer [Storage Devices], DEVICE_WRITE_AGGREGATION_DESCRIPTOR structure [Storage Devices], *PDEVICE_WRITE_AGGREGATION_DESCRIPTOR, storage.device_write_aggregation_descriptor, ntddstor/DEVICE_WRITE_AGGREGATION_DESCRIPTOR, ntddstor/PDEVICE_WRITE_AGGREGATION_DESCRIPTOR, PDEVICE_WRITE_AGGREGATION_DESCRIPTOR, _DEVICE_WRITE_AGGREGATION_DESCRIPTOR, DEVICE_WRITE_AGGREGATION_DESCRIPTOR
