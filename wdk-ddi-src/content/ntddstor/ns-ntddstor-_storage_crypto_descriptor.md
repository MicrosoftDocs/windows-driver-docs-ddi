...
ms.date: 1/10/2018
ms.keywords: ntddstor/STORAGE_CRYPTO_DESCRIPTOR, *PSTORAGE_CRYPTO_DESCRIPTOR, storage.storage_crypto_descriptor, ntddstor/PSTORAGE_CRYPTO_DESCRIPTOR, _STORAGE_CRYPTO_DESCRIPTOR, STORAGE_CRYPTO_DESCRIPTOR structure [Storage Devices], STORAGE_CRYPTO_DESCRIPTOR, PSTORAGE_CRYPTO_DESCRIPTOR structure pointer [Storage Devices], PSTORAGE_CRYPTO_DESCRIPTOR
