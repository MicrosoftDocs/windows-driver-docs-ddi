...
ms.date: 1/10/2018
ms.keywords: ntddstor/STORAGE_DEVICE_RESILIENCY_DESCRIPTOR, PSTORAGE_DEVICE_RESILIENCY_DESCRIPTOR, storage.storage_device_resiliency_descriptor, ntddstor/PSTORAGE_DEVICE_RESILIENCY_DESCRIPTOR, STORAGE_DEVICE_RESILIENCY_DESCRIPTOR, STORAGE_DEVICE_RESILIENCY_DESCRIPTOR structure [Storage Devices], PSTORAGE_DEVICE_RESILIENCY_DESCRIPTOR structure pointer [Storage Devices], _STORAGE_DEVICE_RESILIENCY_DESCRIPTOR
