...
ms.date: 1/10/2018
ms.keywords: storage.storage_crypto_capability, PSTORAGE_CRYPTO_CAPABILITY, *PSTORAGE_CRYPTO_CAPABILITY, PSTORAGE_CRYPTO_CAPABILITY structure pointer [Storage Devices], ntddstor/STORAGE_CRYPTO_CAPABILITY, STORAGE_CRYPTO_CAPABILITY, STORAGE_CRYPTO_CAPABILITY structure [Storage Devices], ntddstor/PSTORAGE_CRYPTO_CAPABILITY, _STORAGE_CRYPTO_CAPABILITY
