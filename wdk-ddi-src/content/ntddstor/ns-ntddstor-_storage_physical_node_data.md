...
ms.date: 1/10/2018
ms.keywords: STORAGE_PHYSICAL_NODE_DATA structure [Storage Devices], PSTORAGE_PHYSICAL_NODE_DATA, STORAGE_PHYSICAL_NODE_DATA, *PSTORAGE_PHYSICAL_NODE_DATA, ntddstor/PSTORAGE_PHYSICAL_NODE_DATA, ntddstor/STORAGE_PHYSICAL_NODE_DATA, PSTORAGE_PHYSICAL_NODE_DATA structure pointer [Storage Devices], storage.storage_physical_node_data, _STORAGE_PHYSICAL_NODE_DATA
