...
ms.date: 2/16/2018
ms.keywords: storage.get_media_types, ntddstor/GET_MEDIA_TYPES, GET_MEDIA_TYPES, PGET_MEDIA_TYPES, _GET_MEDIA_TYPES, ntddstor/PGET_MEDIA_TYPES, *PGET_MEDIA_TYPES, structs-general_68f75a58-b2a5-4d6a-b9ba-0019e36034ef.xml, PGET_MEDIA_TYPES structure pointer [Storage Devices], GET_MEDIA_TYPES structure [Storage Devices]
