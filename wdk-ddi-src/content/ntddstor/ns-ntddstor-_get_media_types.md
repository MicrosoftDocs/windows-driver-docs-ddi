...
ms.date: 1/10/2018
ms.keywords: GET_MEDIA_TYPES structure [Storage Devices], storage.get_media_types, GET_MEDIA_TYPES, PGET_MEDIA_TYPES structure pointer [Storage Devices], PGET_MEDIA_TYPES, structs-general_68f75a58-b2a5-4d6a-b9ba-0019e36034ef.xml, _GET_MEDIA_TYPES, ntddstor/GET_MEDIA_TYPES, ntddstor/PGET_MEDIA_TYPES, *PGET_MEDIA_TYPES
