...
f1_keywords:
 ...
 - ntddstor/_STORAGE_DEVICE_ID_DESCRIPTOR
 - PSTORAGE_DEVICE_ID_DESCRIPTOR
 - ntddstor/PSTORAGE_DEVICE_ID_DESCRIPTOR
...
# STORAGE_DEVICE_ID_DESCRIPTOR structure (ntddstor.h)
...
The <b>STORAGE_DEVICE_ID_DESCRIPTOR</b> structure is used in conjunction with the <a href="/windows-hardware/drivers/ddi/ntddstor/ni-ntddstor-ioctl_storage_query_property">IOCTL_STORAGE_QUERY_PROPERTY</a> request to retrieve the device ID descriptor data for a device.
