...
ms.date: 1/10/2018
ms.keywords: Any other value, storage.storage_offload_token, ntddstor/STORAGE_OFFLOAD_TOKEN, PSTORAGE_OFFLOAD_TOKEN, ntddstor/PSTORAGE_OFFLOAD_TOKEN, STORAGE_OFFLOAD_TOKEN structure [Storage Devices], *PSTORAGE_OFFLOAD_TOKEN, _STORAGE_OFFLOAD_TOKEN, STORAGE_OFFLOAD_TOKEN_TYPE_ZERO_DATA, STORAGE_OFFLOAD_TOKEN, PSTORAGE_OFFLOAD_TOKEN structure pointer [Storage Devices]
