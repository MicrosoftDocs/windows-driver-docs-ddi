...
f1_keywords:
 ...
 - ntddstor/_STORAGE_BUS_RESET_REQUEST
 - PSTORAGE_BUS_RESET_REQUEST
 - ntddstor/PSTORAGE_BUS_RESET_REQUEST
...
The STORAGE_BUS_RESET_REQUEST structure is used in conjunction with the <a href="/windows-hardware/drivers/ddi/ntddstor/ni-ntddstor-ioctl_storage_reset_bus">IOCTL_STORAGE_RESET_BUS</a> request to specify the path of the bus to be reset.
