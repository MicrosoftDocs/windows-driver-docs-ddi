...
ms.date: 1/10/2018
ms.keywords: PSTORAGE_OFFLOAD_READ_OUTPUT structure pointer [Storage Devices], ntddstor/STORAGE_OFFLOAD_READ_OUTPUT, storage.storage_offload_read_output, PSTORAGE_OFFLOAD_READ_OUTPUT, _STORAGE_OFFLOAD_READ_OUTPUT, STORAGE_OFFLOAD_READ_OUTPUT, *PSTORAGE_OFFLOAD_READ_OUTPUT, STORAGE_OFFLOAD_READ_OUTPUT structure [Storage Devices], ntddstor/PSTORAGE_OFFLOAD_READ_OUTPUT
