...
The buffer at <b>Irp->AssociatedIrp.SystemBuffer</b> contains a <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntddstor/ns-ntddstor-storage_break_reservation_request">STORAGE_BREAK_RESERVATION_REQUEST</a> structure that identifies the bus to reset.


### -input-buffer-length

The length of a <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntddstor/ns-ntddstor-storage_break_reservation_request">STORAGE_BREAK_RESERVATION_REQUEST</a> structure.
...
<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntddstor/ns-ntddstor-storage_break_reservation_request">STORAGE_BREAK_RESERVATION_REQUEST</a>
 
