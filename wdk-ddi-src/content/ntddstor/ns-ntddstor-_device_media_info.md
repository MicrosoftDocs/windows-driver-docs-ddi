...
ms.date: 1/10/2018
ms.keywords: MEDIA_CURRENTLY_MOUNTED, MEDIA_READ_ONLY, MEDIA_READ_WRITE, *PDEVICE_MEDIA_INFO, PDEVICE_MEDIA_INFO structure pointer [Storage Devices], DEVICE_MEDIA_INFO structure [Storage Devices], ntddstor/PDEVICE_MEDIA_INFO, PDEVICE_MEDIA_INFO, ntddstor/DEVICE_MEDIA_INFO, storage.device_media_info, MEDIA_WRITE_ONCE, structs-general_e2c363ff-f053-45be-a807-f90480c0ae1f.xml, DEVICE_MEDIA_INFO, _DEVICE_MEDIA_INFO, MEDIA_ERASEABLE, MEDIA_WRITE_PROTECTED
...
#### RemovableDiskInfo.Cylinders

Specifies the number of cylinders on this disk. 


#### RemovableDiskInfo.MediaType
...
#### RemovableDiskInfo.TracksPerCylinder

Specifies the number of tracks per cylinder.


#### RemovableDiskInfo.SectorsPerTrack

Specifies the number of sectors per track.


#### RemovableDiskInfo.BytesPerSector

Specifies the number of bytes per sector.


#### RemovableDiskInfo.NumberMediaSides

Specifies the number of sides of the disk that can contain data: 1 for one-sided media or 2 for two-sided media.


#### RemovableDiskInfo.MediaCharacteristics
...
#### TapeInfo.BusSpecificData.ScsiInformation
...
#### TapeInfo.BusSpecificData.ScsiInformation.MediumType

Specifies the SCSI-specific medium type.


#### TapeInfo.BusSpecificData.ScsiInformation.DensityCode
