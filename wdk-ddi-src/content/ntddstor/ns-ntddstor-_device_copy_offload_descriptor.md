...
f1_keywords:
 ...
 - ntddstor/_DEVICE_COPY_OFFLOAD_DESCRIPTOR
 - PDEVICE_COPY_OFFLOAD_DESCRIPTOR
 - ntddstor/PDEVICE_COPY_OFFLOAD_DESCRIPTOR
...
Used in conjunction with the 
   <a href="/windows-hardware/drivers/ddi/ntddstor/ni-ntddstor-ioctl_storage_query_property">IOCTL_STORAGE_QUERY_PROPERTY</a> request to describe the copy offload capabilities of a storage device.
