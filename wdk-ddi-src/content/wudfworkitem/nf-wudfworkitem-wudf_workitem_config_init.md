...
ms.date: 1/11/2018
ms.keywords: wudfworkitem/WUDF_WORKITEM_CONFIG_INIT, WUDF_WORKITEM_CONFIG_INIT function, umdf.wudf_workitem_config_init, wdf.wudf_workitem_config_init, WUDF_WORKITEM_CONFIG_INIT
