...
A pointer to a linked list of 
     <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wsk/ns-wsk-_wsk_data_indication">WSK_DATA_INDICATION</a> structures that
...
The WSK application accepted at least some of the received data. If the WSK application accepted
       ...
       <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wsk/nc-wsk-pfn_wsk_receive">WskReceive</a> function. After the WSK
...
The WSK application accepted the data but did not retrieve all of the data contained in the
       linked list of 
       <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wsk/ns-wsk-_wsk_data_indication">WSK_DATA_INDICATION</a> structures. The
...
If a WSK application's 
    ...
    <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wsk/nc-wsk-pfn_wsk_receive">WskReceive</a> function on the same
