...
ms.date: 1/18/2018
ms.keywords: PWSK_CLIENT_CONNECTION_DISPATCH, wsk/PWSK_CLIENT_CONNECTION_DISPATCH, wsk/WSK_CLIENT_CONNECTION_DISPATCH, netvista.wsk_client_connection_dispatch, WSK_CLIENT_CONNECTION_DISPATCH structure [Network Drivers Starting with Windows Vista], *PWSK_CLIENT_CONNECTION_DISPATCH, PWSK_CLIENT_CONNECTION_DISPATCH structure pointer [Network Drivers Starting with Windows Vista], _WSK_CLIENT_CONNECTION_DISPATCH, wskref_2fd26ffb-dab8-4529-9fd0-6043509312c9.xml, WSK_CLIENT_CONNECTION_DISPATCH
