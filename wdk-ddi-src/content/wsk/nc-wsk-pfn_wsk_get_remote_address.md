...
A WSK application can call the 
    ...
    remote transport address. A stream socket is connected to a remote transport address by calling the <a href="/windows-hardware/drivers/ddi/wsk/nc-wsk-pfn_wsk_connect">WskConnect</a> function. A connection-oriented socket is connected to a remote transport address in one
