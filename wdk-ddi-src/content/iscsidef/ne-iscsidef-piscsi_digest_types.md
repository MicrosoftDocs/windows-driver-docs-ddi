...
ms.date: 2/16/2018
ms.keywords: iscsidef/ISCSI_DIGEST_TYPE_NONE, iscsidef/ISCSI_DIGEST_TYPE_CRC32C, *PISCSI_DIGEST_TYPES, storage.iscsi_digest_types, ISCSI_DIGEST_TYPES, iscsidef/PISCSI_DIGEST_TYPES, PISCSI_DIGEST_TYPES, ISCSI_DIGEST_TYPE_NONE, ISCSI_DIGEST_TYPE_CRC32C, ISCSI_DIGEST_TYPES enumeration [Storage Devices], structs-iSCSI_107b48fe-7dd1-41d3-b329-d82ba0cd13d4.xml, PISCSI_DIGEST_TYPES enumeration pointer [Storage Devices], iscsidef/ISCSI_DIGEST_TYPES
