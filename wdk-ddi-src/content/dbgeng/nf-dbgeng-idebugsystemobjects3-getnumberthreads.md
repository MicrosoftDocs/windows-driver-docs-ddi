...
description: The GetNumberThreads method returns the number of threads in the current process. This method belongs to the IDebugSystemObjects3 interface.
