...
ms.date: 1/19/2018
ms.keywords: STACK_SRC_INFO structure [Windows Debugging], dbgeng/STACK_SRC_INFO, *PSTACK_SRC_INFO, debugger.stack_src_info, PSTACK_SRC_INFO structure pointer [Windows Debugging], STACK_SRC_INFO, PSTACK_SRC_INFO, _STACK_SRC_INFO, dbgeng/PSTACK_SRC_INFO
