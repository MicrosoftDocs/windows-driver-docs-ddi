...
ms.date: 1/19/2018
ms.keywords: dbgeng/IDebugControl::GetExceptionFilterSecondCommand, IDebugControl_fba6b716-8dba-4581-87c3-b808d3ab40a1.xml, IDebugControl2::GetExceptionFilterSecondCommand, IDebugControl interface [Windows Debugging], GetExceptionFilterSecondCommand method, GetExceptionFilterSecondCommand method [Windows Debugging], IDebugControl2 interface, IDebugControl3, dbgeng/IDebugControl2::GetExceptionFilterSecondCommand, IDebugControl2 interface [Windows Debugging], GetExceptionFilterSecondCommand method, GetExceptionFilterSecondCommand method [Windows Debugging], IDebugControl interface, dbgeng/IDebugControl3::GetExceptionFilterSecondCommand, GetExceptionFilterSecondCommand method [Windows Debugging], debugger.getexceptionfiltersecondcommand, IDebugControl3 interface [Windows Debugging], GetExceptionFilterSecondCommand method, GetExceptionFilterSecondCommand, GetExceptionFilterSecondCommand method [Windows Debugging], IDebugControl3 interface, IDebugControl::GetExceptionFilterSecondCommand, IDebugControl3::GetExceptionFilterSecondCommand
