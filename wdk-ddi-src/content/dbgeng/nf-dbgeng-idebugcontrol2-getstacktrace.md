...
ms.date: 2/22/2018
ms.keywords: IDebugControl2::GetStackTrace, GetStackTrace, GetStackTrace method [Windows Debugging], IDebugControl interface, IDebugControl3::GetStackTrace, IDebugControl2 interface [Windows Debugging], GetStackTrace method, IDebugControl interface [Windows Debugging], GetStackTrace method, IDebugControl::GetStackTrace, GetStackTrace method [Windows Debugging], IDebugControl3 interface, GetStackTrace method [Windows Debugging], IDebugControl, IDebugControl2, debugger.getstacktrace, GetStackTrace method [Windows Debugging], IDebugControl2 interface, dbgeng/IDebugControl2::GetStackTrace, IDebugControl3 interface [Windows Debugging], GetStackTrace method, dbgeng/IDebugControl::GetStackTrace, IDebugControl_ef51127a-c022-4e3d-bb63-55553daea893.xml, dbgeng/IDebugControl3::GetStackTrace
