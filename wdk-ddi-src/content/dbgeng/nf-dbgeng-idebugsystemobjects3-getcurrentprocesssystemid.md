...
description: The GetCurrentProcessSystemId method returns the system process ID of the current process. This method belongs to the IDebugSystemObjects3 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugSystemObjects3::GetCurrentProcessSystemId
topic_type:
 - APIRef
 - kbSyntax
api_type:
