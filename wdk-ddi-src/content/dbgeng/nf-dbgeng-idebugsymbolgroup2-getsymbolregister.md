...
ms.date: 2/15/2018
ms.keywords: GetSymbolRegister method [Windows Debugging], IDebugSymbolGroup2 interface [Windows Debugging], GetSymbolRegister method, debugger.getsymbolregister, IDebugSymbolGroup2::GetSymbolRegister, dbgeng/IDebugSymbolGroup2::GetSymbolRegister, ComOther_9383fee9-ec27-4ccb-8768-02bd550746d7.xml, IDebugSymbolGroup2, GetSymbolRegister, GetSymbolRegister method [Windows Debugging], IDebugSymbolGroup2 interface
