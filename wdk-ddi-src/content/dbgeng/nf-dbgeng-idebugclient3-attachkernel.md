...
title: IDebugClient3::AttachKernel (dbgeng.h)
description: The AttachKernel methods connect the debugger engine to a kernel target. This method belongs to the IDebugClient3 interface.
old-location: debugger\attachkernel.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient3::AttachKernel"]
...
f1_keywords:
 ...
 - dbgeng/IDebugClient3::AttachKernel
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The <b>AttachKernel</b>  methods connect the <a href="/windows-hardware/drivers/debugger/d">debugger engine</a> to a kernel target.
...
<div class="alert"><b>Note</b>    The engine doesn't completely attach to the kernel until the <a href="/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugcontrol3-waitforevent">WaitForEvent</a> method has been called.  Only after the kernel has generated an event -- for example, the initial breakpoint -- does it become available in the debugger session.</div>
<div> </div>
...
<a href="/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugclient5-getkernelconnectionoptions">GetKernelConnectionOptions</a>
