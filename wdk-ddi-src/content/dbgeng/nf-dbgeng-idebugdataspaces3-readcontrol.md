...
title: IDebugDataSpaces3::ReadControl (dbgeng.h)
description: Learn about the IDebugDataSpaces3.ReadControl method, which reads implementation-specific system data. You can specify which processor's data to read.
old-location: debugger\readcontrol.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugDataSpaces3::ReadControl"]
...
f1_keywords:
 ...
 - dbgeng/IDebugDataSpaces3::ReadControl
topic_type:
 - APIRef
 - kbSyntax
api_type:
