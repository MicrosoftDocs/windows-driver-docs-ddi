...
description: The WritePointersVirtual method is a convenience method for writing pointers to the target's virtual address space. This method belongs to IDebugDataSpaces2.
old-location: debugger\writepointersvirtual.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugDataSpaces2::WritePointersVirtual"]
...
f1_keywords:
 ...
 - dbgeng/IDebugDataSpaces2::WritePointersVirtual
topic_type:
 - APIRef
 - kbSyntax
api_type:
