...
description: The IDebugSymbols2::GetOffsetByLine method returns the location of the instruction that corresponds to a specified line in the source code.
...
f1_keywords:
 ...
 - dbgeng/IDebugSymbols2::GetOffsetByLine
topic_type:
 - APIRef
 - kbSyntax
api_type:
