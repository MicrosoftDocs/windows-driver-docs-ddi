...
ms.date: 1/19/2018
ms.keywords: IDebugControl3, GetAssemblyOptions, GetAssemblyOptions method [Windows Debugging], dbgeng/IDebugControl3::GetAssemblyOptions, IDebugControl3::GetAssemblyOptions, IDebugControl3 interface [Windows Debugging], GetAssemblyOptions method, debugger.getassemblyoptions, IDebugControl_600ee4dc-0a79-42a9-a394-2ff053874f00.xml, GetAssemblyOptions method [Windows Debugging], IDebugControl3 interface
