...
description: The WriteDumpFile2 method creates a user-mode or kernel-modecrash dump file. This method belongs to the IDebugClient4 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugClient4::WriteDumpFile2
topic_type:
 - APIRef
 - kbSyntax
api_type:
