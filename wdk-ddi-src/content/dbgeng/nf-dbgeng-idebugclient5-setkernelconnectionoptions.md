...
description: The SetKernelConnectionOptions method updates some of the connection options for a live kernel target. This method belongs to the IDebugClient5 interface.
