...
title: IDebugControl2::ControlledOutputVaList (dbgeng.h)
description: The IDebugControl2::ControlledOutputVaList method formats a string and sends the result to output callbacks registered with some of the engine's clients.
old-location: debugger\controlledoutputvalist.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugControl2::ControlledOutputVaList"]
...
f1_keywords:
 ...
 - dbgeng/IDebugControl2::ControlledOutputVaList
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The <b>ControlledOutputVaList</b>  method formats a string and sends the result to <a href="/windows-hardware/drivers/debugger/using-input-and-output">output callbacks</a> that were registered with some of the engine's clients.
