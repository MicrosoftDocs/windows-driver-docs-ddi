...
description: Learn about the IDebugControl2.RemoveBreakpoint method, which removes a breakpoint. This method might also return other error values.
...
f1_keywords:
 ...
 - dbgeng/IDebugControl2::RemoveBreakpoint
topic_type:
 - APIRef
 - kbSyntax
api_type:
