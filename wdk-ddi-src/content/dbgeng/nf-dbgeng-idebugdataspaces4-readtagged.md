...
ms.date: 2/22/2018
ms.keywords: dbgeng/IDebugDataSpaces3::ReadTagged, IDebugDataSpaces_cdf64ddf-da14-4607-8df2-1d4703a2eebf.xml, IDebugDataSpaces4::ReadTagged, IDebugDataSpaces4, ReadTagged method [Windows Debugging], IDebugDataSpaces3 interface, ReadTagged method [Windows Debugging], IDebugDataSpaces4 interface, IDebugDataSpaces3 interface [Windows Debugging], ReadTagged method, debugger.readtagged, ReadTagged method [Windows Debugging], IDebugDataSpaces3::ReadTagged, ReadTagged, IDebugDataSpaces3, IDebugDataSpaces4 interface [Windows Debugging], ReadTagged method, dbgeng/IDebugDataSpaces4::ReadTagged
