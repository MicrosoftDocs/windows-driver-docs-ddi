...
description: The IDebugControl3::ControlledOutput method formats a string and sends the result to output callbacks that were registered with some of the engine's clients.
old-location: debugger\controlledoutput.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugControl3::ControlledOutput"]
...
f1_keywords:
 ...
 - dbgeng/IDebugControl3::ControlledOutput
topic_type:
 - APIRef
 - kbSyntax
api_type:
