...
The <b>GetModuleByModuleName2Wide</b>  method searches through the process's <a href="/windows-hardware/drivers/debugger/modules">modules</a> for one with the specified name.
