...
The <b>AddSyntheticModule</b>  method adds a synthetic module to the module list the debugger maintains for the <a href="/windows-hardware/drivers/debugger/c">current process</a>.
