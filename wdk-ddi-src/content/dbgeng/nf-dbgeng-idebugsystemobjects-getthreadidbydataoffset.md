...
description: "The IDebugSystemObjects::GetThreadIdByDataOffset method returns the engine thread ID for a thread. The thread is specified by its system data structure."
