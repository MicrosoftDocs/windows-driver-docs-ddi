...
description: The AttachKernel methods connect the debugger engine to a kernel target. This method belongs to the IDebugClient4 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugClient4::AttachKernel
topic_type:
 - APIRef
 - kbSyntax
api_type:
