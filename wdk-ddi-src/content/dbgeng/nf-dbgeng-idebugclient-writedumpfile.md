...
description: The WriteDumpFile method creates a user-mode or kernel-modecrash dump file. This method belongs to the IDebugClient interface.
old-location: debugger\writedumpfile.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient::WriteDumpFile"]
