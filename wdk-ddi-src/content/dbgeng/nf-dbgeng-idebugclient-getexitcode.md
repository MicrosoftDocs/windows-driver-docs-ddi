...
title: IDebugClient::GetExitCode (dbgeng.h)
description: The IDebugClient::GetExitCode method returns the exit code of the current process if that process has already run through to completion.
