...
description: The IDebugAdvanced3::FindSourceFileAndToken method returns the filename of a source file on the source path or returns the value of a variable associated with a file token.
