...
description: The GetCurrentThreadDataOffset method returns the location of the system data structure for the current thread. This method belongs to IDebugSystemObjects.
