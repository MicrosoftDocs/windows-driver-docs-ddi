...
title: IDebugSystemObjects4::GetProcessIdByDataOffset (dbgeng.h)
description: The IDebugSystemObjects4::GetProcessIdByDataOffset method returns the engine process ID for the specified process. The process is specified by its data offset.
old-location: debugger\getprocessidbydataoffset.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSystemObjects4::GetProcessIdByDataOffset"]
