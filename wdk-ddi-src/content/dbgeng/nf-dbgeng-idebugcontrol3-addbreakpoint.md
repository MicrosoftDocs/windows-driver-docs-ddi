...
ms.date: 2/15/2018
ms.keywords: AddBreakpoint method [Windows Debugging], IDebugControl3 interface, AddBreakpoint method [Windows Debugging], IDebugControl::AddBreakpoint, dbgeng/IDebugControl3::AddBreakpoint, IDebugControl, IDebugControl2, IDebugControl2::AddBreakpoint, IDebugControl3, dbgeng/IDebugControl::AddBreakpoint, dbgeng/IDebugControl2::AddBreakpoint, IDebugControl2 interface [Windows Debugging], AddBreakpoint method, AddBreakpoint method [Windows Debugging], IDebugControl2 interface, debugger.addbreakpoint, AddBreakpoint, IDebugControl_3d11665a-ec78-4742-8195-2798601814e9.xml, IDebugControl interface [Windows Debugging], AddBreakpoint method, IDebugControl3 interface [Windows Debugging], AddBreakpoint method, IDebugControl3::AddBreakpoint, AddBreakpoint method [Windows Debugging], IDebugControl interface
