...
description: The GetIdentity method returns a string describing the computer and user this client represents. This method belongs to the IDebugClient2 interface.
...
f1_keywords:
 - IDebugClient2::GetIdentity
 - dbgeng/IDebugClient2::GetIdentity
topic_type:
 - APIRef
 - kbSyntax
api_type:
