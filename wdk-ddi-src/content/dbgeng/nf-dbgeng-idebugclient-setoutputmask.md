...
description: The SetOutputMask method sets the output mask for the client. This method belongs to the IDebugClient interface.
old-location: debugger\setoutputmask.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient::SetOutputMask"]
