...
The method <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugregisters2-outputregisters">OutputRegisters</a> performs the same task as this method but always uses the target as the register source.
