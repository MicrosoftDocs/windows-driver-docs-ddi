...
The <b>SetExceptionFilterParameters</b> method changes the <a href="/windows-hardware/drivers/debugger/debug-filter-xxx">break status</a> and <a href="/windows-hardware/drivers/debugger/debug-filter-xxx">handling status</a> for some exception filters.
