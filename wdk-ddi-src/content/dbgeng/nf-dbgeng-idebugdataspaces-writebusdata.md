...
ms.date: 1/19/2018
ms.keywords: WriteBusData method [Windows Debugging], IDebugDataSpaces::WriteBusData, WriteBusData method [Windows Debugging], IDebugDataSpaces interface, WriteBusData method [Windows Debugging], IDebugDataSpaces3 interface, IDebugDataSpaces interface [Windows Debugging], WriteBusData method, dbgeng/IDebugDataSpaces2::WriteBusData, WriteBusData, IDebugDataSpaces, debugger.writebusdata, IDebugDataSpaces4 interface [Windows Debugging], WriteBusData method, IDebugDataSpaces2 interface [Windows Debugging], WriteBusData method, WriteBusData method [Windows Debugging], IDebugDataSpaces4 interface, IDebugDataSpaces2::WriteBusData, dbgeng/IDebugDataSpaces4::WriteBusData, dbgeng/IDebugDataSpaces3::WriteBusData, IDebugDataSpaces_a1fb8543-dee8-475d-b42c-17077d72b06e.xml, WriteBusData method [Windows Debugging], IDebugDataSpaces2 interface, IDebugDataSpaces3 interface [Windows Debugging], WriteBusData method, IDebugDataSpaces3::WriteBusData, dbgeng/IDebugDataSpaces::WriteBusData, IDebugDataSpaces4::WriteBusData
