...
title: IDebugDataSpaces::WriteBusData (dbgeng.h)
description: The WriteBusData method writes data to a system bus. This method belongs to the IDebugDataSpaces interface.
