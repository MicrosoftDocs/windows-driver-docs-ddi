...
description: The AddExtension method loads an extension library into the debugger engine. This method belongs to the IDebugControl2 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugControl2::AddExtension
topic_type:
 - APIRef
 - kbSyntax
api_type:
