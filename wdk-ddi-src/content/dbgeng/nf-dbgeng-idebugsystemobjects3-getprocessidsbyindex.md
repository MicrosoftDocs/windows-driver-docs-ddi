...
description: "The IDebugSystemObjects3::GetProcessIdsByIndex method returns the engine process ID and system process ID for the specified processes in the current target."
old-location: debugger\getprocessidsbyindex.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSystemObjects3::GetProcessIdsByIndex"]
