...
description: The GetIdentity method returns a string describing the computer and user this client represents. This method belongs to the IDebugClient4 interface.
