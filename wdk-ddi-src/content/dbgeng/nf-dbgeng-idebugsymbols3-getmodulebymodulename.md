...
description: The GetModuleByModuleName method searches through the target's modules for one with the specified name. This method belongs to the IDebugSymbols3 interface.
