...
title: IDebugClient4::GetKernelConnectionOptions (dbgeng.h)
description: The GetKernelConnectionOptions method returns the connection options for the current kernel target. This method belongs to the IDebugClient4 interface.
old-location: debugger\getkernelconnectionoptions.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient4::GetKernelConnectionOptions"]
...
f1_keywords:
 - IDebugClient4::GetKernelConnectionOptions
 - dbgeng/IDebugClient4::GetKernelConnectionOptions
topic_type:
 - APIRef
 - kbSyntax
api_type:
