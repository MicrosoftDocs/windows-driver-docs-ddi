...
ms.date: 2/15/2018
ms.keywords: IDebugControl3, IDebugControl, dbgeng/IDebugControl::GetSpecificFilterParameters, dbgeng/IDebugControl3::GetSpecificFilterParameters, GetSpecificFilterParameters method [Windows Debugging], IDebugControl2 interface, IDebugControl interface [Windows Debugging], GetSpecificFilterParameters method, GetSpecificFilterParameters, IDebugControl2, debugger.getspecificfilterparameters, IDebugControl2::GetSpecificFilterParameters, GetSpecificFilterParameters method [Windows Debugging], IDebugControl interface, IDebugControl3 interface [Windows Debugging], GetSpecificFilterParameters method, IDebugControl_ebe245a7-c76c-4b31-aa58-ccad250ed92a.xml, IDebugControl2 interface [Windows Debugging], GetSpecificFilterParameters method, IDebugControl3::GetSpecificFilterParameters, dbgeng/IDebugControl2::GetSpecificFilterParameters, IDebugControl::GetSpecificFilterParameters, GetSpecificFilterParameters method [Windows Debugging], GetSpecificFilterParameters method [Windows Debugging], IDebugControl3 interface
