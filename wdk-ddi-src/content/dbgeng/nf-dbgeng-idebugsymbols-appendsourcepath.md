...
ms.date: 2/22/2018
ms.keywords: AppendSourcePath method [Windows Debugging], IDebugSymbols3 interface, AppendSourcePath, AppendSourcePath method [Windows Debugging], IDebugSymbols interface, AppendSourcePath method [Windows Debugging], IDebugSymbols2 interface, IDebugSymbols3::AppendSourcePath, IDebugSymbols3 interface [Windows Debugging], AppendSourcePath method, IDebugSymbols interface [Windows Debugging], AppendSourcePath method, dbgeng/IDebugSymbols::AppendSourcePath, IDebugSymbols2::AppendSourcePath, IDebugSymbols::AppendSourcePath, dbgeng/IDebugSymbols2::AppendSourcePath, dbgeng/IDebugSymbols3::AppendSourcePath, debugger.appendsourcepath, IDebugSymbols, AppendSourcePath method [Windows Debugging], IDebugSymbols2 interface [Windows Debugging], AppendSourcePath method, IDebugSymbols_8e47c1ea-e190-4f34-a952-1dcf4ef9e971.xml
