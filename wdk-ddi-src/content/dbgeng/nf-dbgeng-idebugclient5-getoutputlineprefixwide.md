...
ms.date: 1/19/2018
ms.keywords: IDebugClient5, GetOutputLinePrefixWide, debugger.idebugclient5_getoutputlineprefixwide, dbgeng/IDebugClient5::GetOutputLinePrefixWide, GetOutputLinePrefixWide method [Windows Debugging], IDebugClient5 interface, GetOutputLinePrefixWide method [Windows Debugging], IDebugClient5 interface [Windows Debugging], GetOutputLinePrefixWide method, IDebugClient5::GetOutputLinePrefixWide
