...
ms.date: 05/03/2018
keywords: ["IDebugSymbols3::GetSymbolEntriesByName"]
...
The <b>GetSymbolEntriesByName</b>  method returns the <a href="/windows-hardware/drivers/debugger/symbols4">symbols</a> whose names match a given pattern.
