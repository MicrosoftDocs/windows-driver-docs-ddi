...
ms.date: 2/15/2018
ms.keywords: dbgeng/IDebugControl2::GetSpecificFilterParameters, IDebugControl, dbgeng/IDebugControl::GetSpecificFilterParameters, dbgeng/IDebugControl3::GetSpecificFilterParameters, GetSpecificFilterParameters method [Windows Debugging], IDebugControl2 interface, IDebugControl interface [Windows Debugging], GetSpecificFilterParameters method, GetSpecificFilterParameters, IDebugControl2 interface [Windows Debugging], GetSpecificFilterParameters method, debugger.getspecificfilterparameters, IDebugControl2, GetSpecificFilterParameters method [Windows Debugging], IDebugControl interface, IDebugControl3 interface [Windows Debugging], GetSpecificFilterParameters method, IDebugControl3::GetSpecificFilterParameters, IDebugControl_ebe245a7-c76c-4b31-aa58-ccad250ed92a.xml, GetSpecificFilterParameters method [Windows Debugging], IDebugControl::GetSpecificFilterParameters, IDebugControl2::GetSpecificFilterParameters, GetSpecificFilterParameters method [Windows Debugging], IDebugControl3 interface
