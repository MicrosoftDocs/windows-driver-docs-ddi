...
description: The CreateProcessWide method creates a process from the specified command line. This method belongs to the IDebugClient5 interface.
old-location: debugger\createprocesswide.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient5::CreateProcessWide"]
...
f1_keywords:
 ...
 - dbgeng/IDebugClient5::CreateProcessWide
topic_type:
 - APIRef
 - kbSyntax
api_type:
