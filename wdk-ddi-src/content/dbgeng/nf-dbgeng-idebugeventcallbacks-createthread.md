...
ms.date: 2/22/2018
ms.keywords: CreateThread, debugger.idebugeventcallbacks_createthread, IDebugEventCallbacks::CreateThread, CreateThread method [Windows Debugging], IDebugEventCallbacks, dbgeng/IDebugEventCallbacks::CreateThread, ComCallbacks_db1fe5dc-8392-4c79-a1ed-9752170eed3c.xml, IDebugEventCallbacks interface [Windows Debugging], CreateThread method, CreateThread method [Windows Debugging], IDebugEventCallbacks interface
