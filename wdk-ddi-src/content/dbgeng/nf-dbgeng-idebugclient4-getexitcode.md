...
description: The IDebugClient4::GetExitCode method returns the exit code of the current process if that process has already run through to completion.
...
f1_keywords:
 ...
 - dbgeng/IDebugClient4::GetExitCode
topic_type:
 - APIRef
 - kbSyntax
api_type:
