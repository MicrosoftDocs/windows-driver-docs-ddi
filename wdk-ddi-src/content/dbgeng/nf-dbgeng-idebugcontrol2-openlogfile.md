...
ms.date: 2/22/2018
ms.keywords: IDebugControl2 interface [Windows Debugging], OpenLogFile method, dbgeng/IDebugControl2::OpenLogFile, OpenLogFile method [Windows Debugging], IDebugControl3 interface, IDebugControl::OpenLogFile, IDebugControl interface [Windows Debugging], OpenLogFile method, dbgeng/IDebugControl3::OpenLogFile, dbgeng/IDebugControl::OpenLogFile, IDebugControl2::OpenLogFile, OpenLogFile method [Windows Debugging], IDebugControl2 interface, IDebugControl, IDebugControl2, OpenLogFile method [Windows Debugging], IDebugControl interface, OpenLogFile method [Windows Debugging], IDebugControl3::OpenLogFile, IDebugControl3 interface [Windows Debugging], OpenLogFile method, IDebugControl_984f684e-c1c0-4819-b8ac-02718581c6ad.xml, OpenLogFile, debugger.openlogfile
