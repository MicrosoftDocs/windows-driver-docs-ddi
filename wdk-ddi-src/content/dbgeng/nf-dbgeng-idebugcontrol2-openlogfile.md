...
title: IDebugControl2::OpenLogFile (dbgeng.h)
description: Learn about the OpenLogFile method, which opens a log file that receives output from the client objects.
...
f1_keywords:
 ...
 - dbgeng/IDebugControl2::OpenLogFile
topic_type:
 - APIRef
 - kbSyntax
api_type:
