...
ms.date: 1/19/2018
ms.keywords: IDebugClient::SetEventCallbacks, dbgeng/IDebugClient2::SetEventCallbacks, IDebugClient2 interface [Windows Debugging], SetEventCallbacks method, IDebugClient2::SetEventCallbacks, IDebugClient interface [Windows Debugging], SetEventCallbacks method, dbgeng/IDebugClient5::SetEventCallbacks, IDebugClient3::SetEventCallbacks, IDebugClient5::SetEventCallbacks, dbgeng/IDebugClient::SetEventCallbacks, SetEventCallbacks method [Windows Debugging], IDebugClient5 interface, SetEventCallbacks method [Windows Debugging], dbgeng/IDebugClient3::SetEventCallbacks, IDebugClient2, IDebugClient_a234bf28-5dd1-4e92-ab72-aa8d9a3a282b.xml, SetEventCallbacks method [Windows Debugging], IDebugClient interface, SetEventCallbacks method [Windows Debugging], IDebugClient3 interface, IDebugClient5 interface [Windows Debugging], SetEventCallbacks method, IDebugClient4, IDebugClient3, debugger.seteventcallbacks, IDebugClient, dbgeng/IDebugClient4::SetEventCallbacks, IDebugClient4 interface [Windows Debugging], SetEventCallbacks method, IDebugClient4::SetEventCallbacks, IDebugClient3 interface [Windows Debugging], SetEventCallbacks method, SetEventCallbacks, SetEventCallbacks method [Windows Debugging], IDebugClient4 interface, SetEventCallbacks method [Windows Debugging], IDebugClient2 interface
