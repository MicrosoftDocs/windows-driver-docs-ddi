...
description: Learn about the SetSpecificFilterArgument method, which sets the value of filter argument for the specific filters that can have an argument.
...
f1_keywords:
 ...
 - dbgeng/IDebugControl2::SetSpecificFilterArgument
topic_type:
 - APIRef
 - kbSyntax
api_type:
