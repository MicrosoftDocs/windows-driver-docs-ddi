...
description: Learn how this method returns the executing processor type for the processor for which the last event occurred.
...
f1_keywords:
 ...
 - dbgeng/IDebugControl3::GetExecutingProcessorType
topic_type:
 - APIRef
 - kbSyntax
api_type:
