...
ms.date: 1/19/2018
ms.keywords: PDEBUG_LAST_EVENT_INFO_EXIT_PROCESS structure pointer [Windows Debugging], PDEBUG_LAST_EVENT_INFO_EXIT_PROCESS, *PDEBUG_LAST_EVENT_INFO_EXIT_PROCESS, DEBUG_LAST_EVENT_INFO_EXIT_PROCESS, debugger.debug_last_event_info_exit_process, dbgeng/PDEBUG_LAST_EVENT_INFO_EXIT_PROCESS, DEBUG_LAST_EVENT_INFO_EXIT_PROCESS structure [Windows Debugging], dbgeng/DEBUG_LAST_EVENT_INFO_EXIT_PROCESS, _DEBUG_LAST_EVENT_INFO_EXIT_PROCESS
