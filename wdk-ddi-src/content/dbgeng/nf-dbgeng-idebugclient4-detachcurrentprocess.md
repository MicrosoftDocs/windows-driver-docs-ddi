...
description: The DetachCurrentProcess method detaches the debugger engine from the current process, resuming all its threads. This method belongs to IDebugClient4.
