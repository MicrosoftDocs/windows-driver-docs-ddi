...
ms.date: 2/15/2018
ms.keywords: IDebugSymbols5::SetScopeFrameByIndexEx, dbgeng/IDebugSymbols5::SetScopeFrameByIndexEx, IDebugSymbols5 interface [Windows Debugging], SetScopeFrameByIndexEx method, SetScopeFrameByIndexEx, SetScopeFrameByIndexEx method [Windows Debugging], IDebugSymbols5, debugger.idebugsymbols5_setscopeframebyindexex, SetScopeFrameByIndexEx method [Windows Debugging], IDebugSymbols5 interface
