...
description: The GetEventThread method returns the engine thread ID for the thread on which the last event occurred. This method belongs to IDebugSystemObjects3.
...
f1_keywords:
 ...
 - dbgeng/IDebugSystemObjects3::GetEventThread
topic_type:
 - APIRef
 - kbSyntax
api_type:
