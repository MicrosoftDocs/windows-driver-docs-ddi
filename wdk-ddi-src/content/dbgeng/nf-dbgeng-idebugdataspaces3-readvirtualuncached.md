...
title: IDebugDataSpaces3::ReadVirtualUncached method
...
ms.date: 2/15/2018
ms.keywords: ReadVirtualUncached method [Windows Debugging], IDebugDataSpaces3 interface, ReadVirtualUncached method [Windows Debugging], IDebugDataSpaces4 interface, ReadVirtualUncached method [Windows Debugging], dbgeng/IDebugDataSpaces4::ReadVirtualUncached, IDebugDataSpaces_265817a7-d690-4b8c-957f-06ec5d4f2f08.xml, IDebugDataSpaces2::ReadVirtualUncached, dbgeng/IDebugDataSpaces::ReadVirtualUncached, IDebugDataSpaces3::ReadVirtualUncached, IDebugDataSpaces2 interface [Windows Debugging], ReadVirtualUncached method, ReadVirtualUncached method [Windows Debugging], IDebugDataSpaces2 interface, IDebugDataSpaces4 interface [Windows Debugging], ReadVirtualUncached method, IDebugDataSpaces3, ReadVirtualUncached method [Windows Debugging], IDebugDataSpaces interface, IDebugDataSpaces::ReadVirtualUncached, dbgeng/IDebugDataSpaces3::ReadVirtualUncached, debugger.readvirtualuncached, IDebugDataSpaces, dbgeng/IDebugDataSpaces2::ReadVirtualUncached, IDebugDataSpaces4::ReadVirtualUncached, IDebugDataSpaces3 interface [Windows Debugging], ReadVirtualUncached method, ReadVirtualUncached, IDebugDataSpaces2, IDebugDataSpaces interface [Windows Debugging], ReadVirtualUncached method
...
<a href="mailto:wsddocfb@microsoft.com?subject=Documentation%20feedback [Debugger\debugger]:%20IDebugDataSpaces::ReadVirtualUncached method%20 RELEASE:%20(2/15/2018)&amp;body=%0A%0APRIVACY STATEMENT%0A%0AWe use your feedback to improve the documentation. We don't use your email address for any other purpose, and we'll remove your email address from our system after the issue that you're reporting is fixed. While we're working to fix this issue, we might send you an email message to ask for more info. Later, we might also send you an email message to let you know that we've addressed your feedback.%0A%0AFor more info about Microsoft's privacy policy, see http://privacy.microsoft.com/en-us/default.aspx." title="Send comments about this topic to Microsoft">Send comments about this topic to Microsoft</a>
