...
title: IDebugClient2::SetOtherOutputMask (dbgeng.h)
description: The SetOtherOutputMask method sets the output mask for another client. This method belongs to the IDebugClient2 interface.
old-location: debugger\setotheroutputmask.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient2::SetOtherOutputMask"]
...
f1_keywords:
 ...
 - dbgeng/IDebugClient2::SetOtherOutputMask
topic_type:
 - APIRef
 - kbSyntax
api_type:
