...
description: The AddProcessOptions method adds the process options to those options that affect the current process. This method belongs to the IDebugClient4 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugClient4::AddProcessOptions
topic_type:
 - APIRef
 - kbSyntax
api_type:
