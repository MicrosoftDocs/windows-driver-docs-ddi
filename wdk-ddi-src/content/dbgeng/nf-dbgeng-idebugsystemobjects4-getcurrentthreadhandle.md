...
description: The GetCurrentThreadHandle method returns the system handle for the current thread. This method belongs to the IDebugSystemObjects4 interface.
old-location: debugger\getcurrentthreadhandle.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSystemObjects4::GetCurrentThreadHandle"]
...
f1_keywords:
 ...
 - dbgeng/IDebugSystemObjects4::GetCurrentThreadHandle
topic_type:
 - APIRef
 - kbSyntax
api_type:
