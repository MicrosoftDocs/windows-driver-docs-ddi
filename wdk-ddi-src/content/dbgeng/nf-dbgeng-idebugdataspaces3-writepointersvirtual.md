...
title: IDebugDataSpaces3::WritePointersVirtual (dbgeng.h)
description: The WritePointersVirtual method is a convenience method for writing pointers to the target's virtual address space. This method belongs to IDebugDataSpaces3.
old-location: debugger\writepointersvirtual.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugDataSpaces3::WritePointersVirtual"]
...
f1_keywords:
 - IDebugDataSpaces3::WritePointersVirtual
 - dbgeng/IDebugDataSpaces3::WritePointersVirtual
topic_type:
 - APIRef
 - kbSyntax
api_type:
