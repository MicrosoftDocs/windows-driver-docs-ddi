...
ms.date: 1/19/2018
ms.keywords: WritePointersVirtual method [Windows Debugging], IDebugDataSpaces interface, WritePointersVirtual, WritePointersVirtual method [Windows Debugging], IDebugDataSpaces4 interface, IDebugDataSpaces::WritePointersVirtual, IDebugDataSpaces2, dbgeng/IDebugDataSpaces2::WritePointersVirtual, IDebugDataSpaces2 interface [Windows Debugging], WritePointersVirtual method, IDebugDataSpaces interface [Windows Debugging], WritePointersVirtual method, IDebugDataSpaces_da1045b5-8b82-4412-8e83-58c285dccce0.xml, WritePointersVirtual method [Windows Debugging], IDebugDataSpaces3 interface, dbgeng/IDebugDataSpaces::WritePointersVirtual, IDebugDataSpaces3, IDebugDataSpaces2::WritePointersVirtual, WritePointersVirtual method [Windows Debugging], IDebugDataSpaces2 interface, IDebugDataSpaces4::WritePointersVirtual, WritePointersVirtual method [Windows Debugging], IDebugDataSpaces, dbgeng/IDebugDataSpaces3::WritePointersVirtual, IDebugDataSpaces3 interface [Windows Debugging], WritePointersVirtual method, IDebugDataSpaces4 interface [Windows Debugging], WritePointersVirtual method, IDebugDataSpaces3::WritePointersVirtual, dbgeng/IDebugDataSpaces4::WritePointersVirtual, debugger.writepointersvirtual
