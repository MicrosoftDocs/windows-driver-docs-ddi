...
ms.date: 2/22/2018
ms.keywords: GetType method [Windows Debugging], IDebugBreakpoint2 interface, debugger.gettype, GetType method [Windows Debugging], IDebugBreakpoint interface, GetType method [Windows Debugging], IDebugBreakpoint2::GetType, IDebugBreakpoint, IDebugBreakpoint::GetType, IDebugBreakpoint2 interface [Windows Debugging], GetType method, dbgeng/IDebugBreakpoint2::GetType, IDebugBreakpoint interface [Windows Debugging], GetType method, dbgeng/IDebugBreakpoint::GetType, IDebugBreakpoint2, ComOther_3305c400-f816-463b-a643-4495bf546460.xml, GetType
