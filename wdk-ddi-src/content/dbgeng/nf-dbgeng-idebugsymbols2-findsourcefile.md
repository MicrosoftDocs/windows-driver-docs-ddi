...
description: The FindSourceFile method searches the source path for a specified source file. This method belongs to the IDebugSymbols2 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugSymbols2::FindSourceFile
topic_type:
 - APIRef
 - kbSyntax
api_type:
