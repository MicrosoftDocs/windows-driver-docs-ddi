...
description: The IsKernelDebuggerEnabled method checks whether kernel debugging is enabled for the local kernel. This method belongs to the IDebugClient5 interface.
old-location: debugger\iskerneldebuggerenabled.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient5::IsKernelDebuggerEnabled"]
...
f1_keywords:
 ...
 - dbgeng/IDebugClient5::IsKernelDebuggerEnabled
topic_type:
 - APIRef
 - kbSyntax
api_type:
