...
f1_keywords:
 ...
 - dbgeng/IDebugSymbols3::SetSymbolOptions
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
This method will set the engine's global symbol options to those specified in <i>Options</i>.  Unlike <a href="/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugsymbols3-addsymboloptions">AddSymbolOptions</a>, any symbol options not in the bit-set <i>Options</i> will be removed.
...
<a href="/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugsymbols3-addsymboloptions">AddSymbolOptions</a>
