...
description: The GetNumberRegisters method returns the number of registers on the target computer. This method belongs to the IDebugRegisters2 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugRegisters2::GetNumberRegisters
topic_type:
 - APIRef
 - kbSyntax
api_type:
