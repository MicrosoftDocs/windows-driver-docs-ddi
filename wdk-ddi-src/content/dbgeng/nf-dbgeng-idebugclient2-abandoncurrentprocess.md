...
description: The IDebugClient2::AbandonCurrentProcess method removes the current process from the engine's process list without detaching or terminating the process.
old-location: debugger\abandoncurrentprocess.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient2::AbandonCurrentProcess"]
