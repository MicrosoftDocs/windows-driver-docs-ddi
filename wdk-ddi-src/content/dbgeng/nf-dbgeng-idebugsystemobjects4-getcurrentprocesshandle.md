...
description: The GetCurrentProcessHandle method returns the system handle for the current process. This method belongs to the IDebugSystemObjects4 interface.
