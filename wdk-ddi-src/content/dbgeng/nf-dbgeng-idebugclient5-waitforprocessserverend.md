...
title: IDebugClient5::WaitForProcessServerEnd (dbgeng.h)
description: The WaitForProcessServerEnd method waits for a local process server to exit. This method belongs to the IDebugClient5 interface.
old-location: debugger\waitforprocessserverend.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient5::WaitForProcessServerEnd"]
...
f1_keywords:
 ...
 - dbgeng/IDebugClient5::WaitForProcessServerEnd
topic_type:
 - APIRef
 - kbSyntax
api_type:
