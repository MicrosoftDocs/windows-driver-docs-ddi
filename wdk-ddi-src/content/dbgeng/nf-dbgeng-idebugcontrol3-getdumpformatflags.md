...
ms.date: 2/22/2018
ms.keywords: IDebugControl3 interface [Windows Debugging], GetDumpFormatFlags method, IDebugControl_fc8bec39-ffc3-46bd-9d18-954f0420906f.xml, debugger.getdumpformatflags, IDebugControl3, dbgeng/IDebugControl3::GetDumpFormatFlags, IDebugControl2, GetDumpFormatFlags method [Windows Debugging], IDebugControl3 interface, IDebugControl2 interface [Windows Debugging], GetDumpFormatFlags method, dbgeng/IDebugControl2::GetDumpFormatFlags, IDebugControl2::GetDumpFormatFlags, GetDumpFormatFlags method [Windows Debugging], GetDumpFormatFlags, GetDumpFormatFlags method [Windows Debugging], IDebugControl2 interface, IDebugControl3::GetDumpFormatFlags
