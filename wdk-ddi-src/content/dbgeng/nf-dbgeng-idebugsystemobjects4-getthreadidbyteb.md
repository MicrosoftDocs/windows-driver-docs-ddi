...
title: IDebugSystemObjects4::GetThreadIdByTeb (dbgeng.h)
description: The (IDebugSystemObjects4) GetThreadIdByTeb method returns the engine thread ID for a thread specified by its thread environment block (TEB).
