...
description: The ConnectProcessServer methods connect to a process server. This method belongs to the IDebugClient interface.
...
The <b>ConnectProcessServer</b>  methods connect to a <a href="/windows-hardware/drivers/debugger/p">process server</a>.
