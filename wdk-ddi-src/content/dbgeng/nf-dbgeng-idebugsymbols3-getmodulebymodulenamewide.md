...
The <b>GetModuleByModuleNameWide</b>  method searches through the target's <a href="/windows-hardware/drivers/debugger/modules">modules</a> for one with the specified name.
