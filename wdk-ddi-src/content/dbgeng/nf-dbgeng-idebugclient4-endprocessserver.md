...
description: The EndProcessServer method requests that a process server be shut down. This method belongs to the IDebugClient4 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugClient4::EndProcessServer
topic_type:
 - APIRef
 - kbSyntax
api_type:
