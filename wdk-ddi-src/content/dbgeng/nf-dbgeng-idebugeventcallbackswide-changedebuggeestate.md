...
description: The ChangeDebuggeeState callback method is called by the engine when it makes or detects changes to the target. This method belongs to IDebugEventCallbacksWide.
