...
ms.date: 2/15/2018
ms.keywords: GetQuitLockString, dbgeng/IDebugClient5::GetQuitLockString, IDebugClient5 interface [Windows Debugging], GetQuitLockString method, GetQuitLockString method [Windows Debugging], IDebugClient5::GetQuitLockString, IDebugClient5, debugger.idebugclient5_getquitlockstring, GetQuitLockString method [Windows Debugging], IDebugClient5 interface
