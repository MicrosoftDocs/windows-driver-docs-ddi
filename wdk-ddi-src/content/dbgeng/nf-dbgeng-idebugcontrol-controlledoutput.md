...
title: IDebugControl::ControlledOutput (dbgeng.h)
description: The IDebugControl::ControlledOutput method formats a string and sends the result to output callbacks that were registered with some of the engine's clients.
old-location: debugger\controlledoutput.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugControl::ControlledOutput"]
