...
description: The TerminateProcesses method attempts to terminate all processes in all targets. This method belongs to the IDebugClient3 interface.
old-location: debugger\terminateprocesses.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient3::TerminateProcesses"]
...
f1_keywords:
 ...
 - dbgeng/IDebugClient3::TerminateProcesses
topic_type:
 - APIRef
 - kbSyntax
api_type:
