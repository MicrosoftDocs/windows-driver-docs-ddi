...
ms.date: 2/22/2018
ms.keywords: dbgeng/IDebugSymbols2::AddTypeOptions, IDebugSymbols2 interface [Windows Debugging], AddTypeOptions method, AddTypeOptions method [Windows Debugging], IDebugSymbols3, AddTypeOptions, IDebugSymbols_e856a688-7f26-4a00-b911-5b23a0bafa11.xml, AddTypeOptions method [Windows Debugging], IDebugSymbols3 interface, dbgeng/IDebugSymbols3::AddTypeOptions, AddTypeOptions method [Windows Debugging], IDebugSymbols2 interface, IDebugSymbols3 interface [Windows Debugging], AddTypeOptions method, IDebugSymbols2::AddTypeOptions, IDebugSymbols2, debugger.addtypeoptions, IDebugSymbols3::AddTypeOptions
