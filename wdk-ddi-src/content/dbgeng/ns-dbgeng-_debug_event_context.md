...
ms.date: 1/19/2018
ms.keywords: DEBUG_EVENT_CONTEXT, PDEBUG_EVENT_CONTEXT, dbgeng/PDEBUG_EVENT_CONTEXT, dbgeng/DEBUG_EVENT_CONTEXT, PDEBUG_EVENT_CONTEXT structure pointer [Windows Debugging], *PDEBUG_EVENT_CONTEXT, _DEBUG_EVENT_CONTEXT, DEBUG_EVENT_CONTEXT structure [Windows Debugging], debugger.debug_event_context
