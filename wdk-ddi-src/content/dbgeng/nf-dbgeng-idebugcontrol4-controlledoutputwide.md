...
ms.date: 1/19/2018
ms.keywords: IDebugControl4, ControlledOutputWide method [Windows Debugging], IDebugControl4 interface, dbgeng/IDebugControl4::ControlledOutputWide, IDebugControl4 interface [Windows Debugging], ControlledOutputWide method, ControlledOutputWide, debugger.controlledoutputwide, IDebugControl4::ControlledOutputWide, ControlledOutputWide method [Windows Debugging]
