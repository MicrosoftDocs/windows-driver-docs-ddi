...
description: The CoerceValues method converts an array of values into an array of values of different types. This method belongs to the IDebugControl2 interface.
