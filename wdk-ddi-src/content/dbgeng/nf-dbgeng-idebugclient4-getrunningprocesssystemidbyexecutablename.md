...
title: IDebugClient4::GetRunningProcessSystemIdByExecutableName (dbgeng.h)
description: The IDebugClient4::GetRunningProcessSystemIdByExecutableName method searches for a process with a given executable file name and return its process ID.
old-location: debugger\getrunningprocesssystemidbyexecutablename.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient4::GetRunningProcessSystemIdByExecutableName"]
