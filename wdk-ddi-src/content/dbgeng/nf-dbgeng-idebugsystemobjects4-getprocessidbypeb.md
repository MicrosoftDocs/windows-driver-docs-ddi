...
description: "The IDebugSystemObjects4::GetProcessIdByPeb method returns the engine process ID for the specified process."
old-location: debugger\getprocessidbypeb.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSystemObjects4::GetProcessIdByPeb"]
...
f1_keywords:
 ...
 - dbgeng/IDebugSystemObjects4::GetProcessIdByPeb
topic_type:
 - APIRef
 - kbSyntax
api_type:
