...
description: The IDebugClient3::CreateProcessAndAttachWide method creates a process from a specified command line, then attach to another user-mode process.
old-location: debugger\createprocessandattachwide.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient3::CreateProcessAndAttachWide"]
