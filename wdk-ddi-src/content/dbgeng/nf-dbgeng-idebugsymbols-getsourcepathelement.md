...
ms.date: 2/15/2018
ms.keywords: IDebugSymbols interface [Windows Debugging], GetSourcePathElement method, IDebugSymbols3 interface [Windows Debugging], GetSourcePathElement method, IDebugSymbols::GetSourcePathElement, debugger.getsourcepathelement, dbgeng/IDebugSymbols3::GetSourcePathElement, GetSourcePathElement method [Windows Debugging], IDebugSymbols3 interface, dbgeng/IDebugSymbols::GetSourcePathElement, IDebugSymbols_517435f9-812c-43c2-bf82-5924de7955a2.xml, GetSourcePathElement method [Windows Debugging], dbgeng/IDebugSymbols2::GetSourcePathElement, IDebugSymbols2::GetSourcePathElement, GetSourcePathElement method [Windows Debugging], IDebugSymbols2 interface, IDebugSymbols3::GetSourcePathElement, GetSourcePathElement method [Windows Debugging], IDebugSymbols interface, GetSourcePathElement, IDebugSymbols2 interface [Windows Debugging], GetSourcePathElement method, IDebugSymbols
