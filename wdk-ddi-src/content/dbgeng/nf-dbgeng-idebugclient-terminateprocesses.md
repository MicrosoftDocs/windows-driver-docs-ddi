...
description: The TerminateProcesses method attempts to terminate all processes in all targets. This method belongs to the IDebugClient interface.
old-location: debugger\terminateprocesses.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient::TerminateProcesses"]
