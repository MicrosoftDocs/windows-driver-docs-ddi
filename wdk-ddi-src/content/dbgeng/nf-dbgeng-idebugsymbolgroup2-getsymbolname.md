...
ms.date: 2/22/2018
ms.keywords: dbgeng/IDebugSymbolGroup::GetSymbolName, IDebugSymbolGroup interface [Windows Debugging], GetSymbolName method, IDebugSymbolGroup2 interface [Windows Debugging], GetSymbolName method, IDebugSymbolGroup, debugger.getsymbolname, GetSymbolName method [Windows Debugging], IDebugSymbolGroup interface, GetSymbolName, ComOther_e12d7aee-985e-4770-8567-7c3748a79905.xml, IDebugSymbolGroup2::GetSymbolName, IDebugSymbolGroup::GetSymbolName, IDebugSymbolGroup2, GetSymbolName method [Windows Debugging], GetSymbolName method [Windows Debugging], IDebugSymbolGroup2 interface, dbgeng/IDebugSymbolGroup2::GetSymbolName
