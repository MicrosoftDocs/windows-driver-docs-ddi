...
ms.date: 1/19/2018
ms.keywords: IDebugSymbolGroup2::GetSymbolName, IDebugSymbolGroup2, GetSymbolName method [Windows Debugging], IDebugSymbolGroup::GetSymbolName, dbgeng/IDebugSymbolGroup::GetSymbolName, IDebugSymbolGroup interface [Windows Debugging], GetSymbolName method, IDebugSymbolGroup2 interface [Windows Debugging], GetSymbolName method, ComOther_e12d7aee-985e-4770-8567-7c3748a79905.xml, GetSymbolName method [Windows Debugging], IDebugSymbolGroup2 interface, GetSymbolName method [Windows Debugging], IDebugSymbolGroup interface, debugger.getsymbolname, GetSymbolName, dbgeng/IDebugSymbolGroup2::GetSymbolName
