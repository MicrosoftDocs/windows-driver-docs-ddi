...
description: Learn about the IDebugDataSpaces2.ReadBusData method, which reads data from a system bus. You can specify which bus data type to read from.
...
f1_keywords:
 ...
 - dbgeng/IDebugDataSpaces2::ReadBusData
topic_type:
 - APIRef
 - kbSyntax
api_type:
