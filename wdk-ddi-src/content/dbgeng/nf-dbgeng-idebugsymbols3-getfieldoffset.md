...
ms.date: 1/19/2018
ms.keywords: IDebugSymbols::GetFieldOffset, IDebugSymbols2::GetFieldOffset, debugger.getfieldoffset2, IDebugSymbols3::GetFieldOffset, GetFieldOffset method [Windows Debugging], IDebugSymbols3 interface, GetFieldOffset method [Windows Debugging], IDebugSymbols2 interface, GetFieldOffset, GetFieldOffset method [Windows Debugging], IDebugSymbols2 interface [Windows Debugging], GetFieldOffset method, dbgeng/IDebugSymbols3::GetFieldOffset, IDebugSymbols3, IDebugSymbols interface [Windows Debugging], GetFieldOffset method, dbgeng/IDebugSymbols::GetFieldOffset, dbgeng/IDebugSymbols2::GetFieldOffset, GetFieldOffset method [Windows Debugging], IDebugSymbols interface, IDebugSymbols_3e5be57a-3af9-4fe3-a7cc-4f31fb9b54f0.xml, IDebugSymbols3 interface [Windows Debugging], GetFieldOffset method
