...
ms.date: 2/22/2018
ms.keywords: GetEventCallbacksWide method [Windows Debugging], IDebugClient5 interface, IDebugClient5::GetEventCallbacksWide, debugger.geteventcallbackswide, GetEventCallbacksWide, dbgeng/IDebugClient5::GetEventCallbacksWide, IDebugClient5, GetEventCallbacksWide method [Windows Debugging], IDebugClient5 interface [Windows Debugging], GetEventCallbacksWide method
