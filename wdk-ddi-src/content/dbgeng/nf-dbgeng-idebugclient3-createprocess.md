...
description: The CreateProcess method creates a process from the specified command line. This method belongs to the IDebugClient3 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugClient3::CreateProcess
topic_type:
 - APIRef
 - kbSyntax
api_type:
