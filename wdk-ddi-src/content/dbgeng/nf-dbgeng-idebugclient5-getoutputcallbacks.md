...
title: IDebugClient5::GetOutputCallbacks (dbgeng.h)
description: The GetOutputCallbacks method returns the output callbacks object registered with the client. This method belongs to the IDebugClient5 interface.
old-location: debugger\getoutputcallbacks.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient5::GetOutputCallbacks"]
...
f1_keywords:
 ...
 - dbgeng/IDebugClient5::GetOutputCallbacks
topic_type:
 - APIRef
 - kbSyntax
api_type:
