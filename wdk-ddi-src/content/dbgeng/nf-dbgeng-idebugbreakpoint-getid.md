...
description: The GetId method returns a breakpoint ID, which is the engine's unique identifier for a breakpoint. This method belongs to the IDebugBreakpoint interface.
