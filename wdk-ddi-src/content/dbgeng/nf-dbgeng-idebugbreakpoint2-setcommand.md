...
description: The SetCommand method sets the command that is executed when a breakpoint is triggered. This method belongs to the IDebugBreakpoint2 interface.
old-location: debugger\setcommand.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugBreakpoint2::SetCommand"]
...
f1_keywords:
 ...
 - dbgeng/IDebugBreakpoint2::SetCommand
topic_type:
 - APIRef
 - kbSyntax
api_type:
