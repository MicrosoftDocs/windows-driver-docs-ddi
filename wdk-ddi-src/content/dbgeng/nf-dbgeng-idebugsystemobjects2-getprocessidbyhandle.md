...
description: "The IDebugSystemObjects2::GetProcessIdByHandle method returns the engine process ID for the specified process. The process is specified by its system handle."
...
f1_keywords:
 ...
 - dbgeng/IDebugSystemObjects2::GetProcessIdByHandle
topic_type:
 - APIRef
 - kbSyntax
api_type:
