...
ms.date: 2/22/2018
ms.keywords: IDebugEventCallbacks::SessionStatus, dbgeng/IDebugEventCallbacks::SessionStatus, ComCallbacks_72cb31db-cc24-41b7-b891-65921c50ce12.xml, SessionStatus, IDebugEventCallbacks, IDebugEventCallbacks interface [Windows Debugging], SessionStatus method, SessionStatus method [Windows Debugging], SessionStatus method [Windows Debugging], IDebugEventCallbacks interface, debugger.idebugeventcallbacks_sessionstatus
