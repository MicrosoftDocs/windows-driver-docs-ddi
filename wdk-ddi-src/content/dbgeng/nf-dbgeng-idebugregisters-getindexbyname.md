...
ms.date: 2/22/2018
ms.keywords: IDebugRegisters, debugger.getindexbyname, IDebugRegisters2 interface [Windows Debugging], GetIndexByName method, IDebugRegisters_5b85eaa4-3c90-47e0-9f7f-7f493617fa37.xml, GetIndexByName, IDebugRegisters interface [Windows Debugging], GetIndexByName method, GetIndexByName method [Windows Debugging], IDebugRegisters2 interface, IDebugRegisters::GetIndexByName, GetIndexByName method [Windows Debugging], IDebugRegisters interface, dbgeng/IDebugRegisters2::GetIndexByName, IDebugRegisters2::GetIndexByName, GetIndexByName method [Windows Debugging], dbgeng/IDebugRegisters::GetIndexByName
