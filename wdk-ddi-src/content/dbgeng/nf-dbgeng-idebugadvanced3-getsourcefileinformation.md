...
title: IDebugAdvanced3::GetSourceFileInformation (dbgeng.h)
description: The (IDebugAdvanced3) GetSourceFileInformation method returns information about a source file that is specified using the Which parameter.
old-location: debugger\getsourcefileinformation.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugAdvanced3::GetSourceFileInformation"]
...
f1_keywords:
 - IDebugAdvanced3::GetSourceFileInformation
 - dbgeng/IDebugAdvanced3::GetSourceFileInformation
topic_type:
 - APIRef
 - kbSyntax
api_type:
