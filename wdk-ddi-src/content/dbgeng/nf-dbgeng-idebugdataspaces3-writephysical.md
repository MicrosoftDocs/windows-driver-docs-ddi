...
description: The WritePhysical method writes data to the specified physical address in the target's memory. This method belongs to the IDebugDataSpaces3 interface.
old-location: debugger\writephysical3.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugDataSpaces3::WritePhysical"]
...
f1_keywords:
 ...
 - dbgeng/IDebugDataSpaces3::WritePhysical
topic_type:
 - APIRef
 - kbSyntax
api_type:
