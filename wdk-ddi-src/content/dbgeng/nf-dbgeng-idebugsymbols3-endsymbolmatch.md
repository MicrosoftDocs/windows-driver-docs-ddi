...
description: The EndSymbolMatch method releases the resources used by a symbol search. This method belongs to the IDebugSymbols3 interface.
old-location: debugger\endsymbolmatch.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSymbols3::EndSymbolMatch"]
...
f1_keywords:
 ...
 - dbgeng/IDebugSymbols3::EndSymbolMatch
topic_type:
 - APIRef
 - kbSyntax
api_type:
