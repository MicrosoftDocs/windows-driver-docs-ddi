...
ms.date: 2/22/2018
ms.keywords: IDebugSymbols::EndSymbolMatch, IDebugSymbols_1661cc8a-ad5c-4cd3-83fe-f829bd07e453.xml, IDebugSymbols2::EndSymbolMatch, dbgeng/IDebugSymbols2::EndSymbolMatch, IDebugSymbols3, dbgeng/IDebugSymbols3::EndSymbolMatch, EndSymbolMatch method [Windows Debugging], IDebugSymbols3 interface, IDebugSymbols interface [Windows Debugging], EndSymbolMatch method, debugger.endsymbolmatch, EndSymbolMatch method [Windows Debugging], IDebugSymbols interface, IDebugSymbols3::EndSymbolMatch, IDebugSymbols, EndSymbolMatch method [Windows Debugging], IDebugSymbols3 interface [Windows Debugging], EndSymbolMatch method, IDebugSymbols2 interface [Windows Debugging], EndSymbolMatch method, EndSymbolMatch, dbgeng/IDebugSymbols::EndSymbolMatch, IDebugSymbols2, EndSymbolMatch method [Windows Debugging], IDebugSymbols2 interface
