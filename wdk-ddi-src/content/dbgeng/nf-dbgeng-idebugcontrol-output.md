...
title: IDebugControl::Output (dbgeng.h)
description: Learn how the Output method formats a string and send the result to output callbacks that have been registered with the engine's clients.
old-location: debugger\output.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugControl::Output"]
