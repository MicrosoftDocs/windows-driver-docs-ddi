...
title: IDebugClient4::WaitForProcessServerEnd (dbgeng.h)
description: The WaitForProcessServerEnd method waits for a local process server to exit. This method belongs to the IDebugClient4 interface.
