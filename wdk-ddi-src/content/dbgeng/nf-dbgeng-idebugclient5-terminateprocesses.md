...
ms.date: 1/10/2018
ms.keywords: IDebugClient5, IDebugClient5::TerminateProcesses, TerminateProcesses
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: IDebugClient.TerminateProcesses,IDebugClient2.TerminateProcesses,IDebugClient3.TerminateProcesses,IDebugClient4.TerminateProcesses,IDebugClient5.TerminateProcesses
...
## -description
The <b>TerminateProcesses</b> method attempts to terminate all <a href="debugger.controlling_threads_and_processes#processes#processes">processes</a> in all targets.
