...
title: IDebugControl2::GetCodeLevel (dbgeng.h)
description: The GetCodeLevel method returns the current code level and is mainly used when stepping through code. This method belongs to the IDebugControl2 interface.
old-location: debugger\getcodelevel.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugControl2::GetCodeLevel"]
...
f1_keywords:
 ...
 - dbgeng/IDebugControl2::GetCodeLevel
topic_type:
 - APIRef
 - kbSyntax
api_type:
