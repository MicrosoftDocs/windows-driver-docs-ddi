...
ms.date: 2/22/2018
ms.keywords: IDebugControl interface [Windows Debugging], GetCodeLevel method, GetCodeLevel method [Windows Debugging], IDebugControl::GetCodeLevel, dbgeng/IDebugControl::GetCodeLevel, debugger.getcodelevel, IDebugControl_8533dd3f-f004-4d89-9f02-b7835fc6169e.xml, GetCodeLevel method [Windows Debugging], IDebugControl2 interface, IDebugControl2 interface [Windows Debugging], GetCodeLevel method, dbgeng/IDebugControl2::GetCodeLevel, IDebugControl, IDebugControl2::GetCodeLevel, GetCodeLevel, IDebugControl2, dbgeng/IDebugControl3::GetCodeLevel, GetCodeLevel method [Windows Debugging], IDebugControl interface, GetCodeLevel method [Windows Debugging], IDebugControl3 interface, IDebugControl3 interface [Windows Debugging], GetCodeLevel method, IDebugControl3::GetCodeLevel
