...
title: IDebugBreakpoint::GetPassCount (dbgeng.h)
description: The IDebugBreakpoint::GetPassCount method returns how many times the target was originally required to reach the breakpoint before the breakpoint is triggered.
old-location: debugger\getpasscount.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugBreakpoint::GetPassCount"]
