...
title: IDebugControl2::OutputPrompt (dbgeng.h)
description: Learn about the OutputPrompt method, which formats and sends a user prompt to the output callback objects.
old-location: debugger\outputprompt.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugControl2::OutputPrompt"]
