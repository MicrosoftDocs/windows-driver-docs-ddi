...
ms.date: 2/22/2018
ms.keywords: IDebugSymbols3 interface [Windows Debugging], GetSourceEntryString method, IDebugSymbols3, GetSourceEntryString, GetSourceEntryString method [Windows Debugging], IDebugSymbols3 interface, IDebugSymbols3::GetSourceEntryString, GetSourceEntryString method [Windows Debugging], debugger.idebugsymbols3_getsourceentrystring, dbgeng/IDebugSymbols3::GetSourceEntryString
