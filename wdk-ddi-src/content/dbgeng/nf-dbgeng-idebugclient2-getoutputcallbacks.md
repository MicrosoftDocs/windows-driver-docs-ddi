...
description: The GetOutputCallbacks method returns the output callbacks object registered with the client. This method belongs to the IDebugClient2 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugClient2::GetOutputCallbacks
topic_type:
 - APIRef
 - kbSyntax
api_type:
