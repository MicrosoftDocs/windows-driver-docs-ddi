...
description: The SetOtherOutputMask method sets the output mask for another client. This method belongs to the IDebugClient5 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugClient5::SetOtherOutputMask
topic_type:
 - APIRef
 - kbSyntax
api_type:
