...
ms.date: 1/19/2018
ms.keywords: GetSourcePathElement method [Windows Debugging], IDebugSymbols2::GetSourcePathElement, dbgeng/IDebugSymbols3::GetSourcePathElement, GetSourcePathElement method [Windows Debugging], IDebugSymbols interface, IDebugSymbols::GetSourcePathElement, dbgeng/IDebugSymbols::GetSourcePathElement, IDebugSymbols3::GetSourcePathElement, IDebugSymbols3, IDebugSymbols3 interface [Windows Debugging], GetSourcePathElement method, debugger.getsourcepathelement, IDebugSymbols_517435f9-812c-43c2-bf82-5924de7955a2.xml, IDebugSymbols2, IDebugSymbols, GetSourcePathElement method [Windows Debugging], IDebugSymbols3 interface, GetSourcePathElement method [Windows Debugging], IDebugSymbols2 interface, GetSourcePathElement, IDebugSymbols2 interface [Windows Debugging], GetSourcePathElement method, IDebugSymbols interface [Windows Debugging], GetSourcePathElement method, dbgeng/IDebugSymbols2::GetSourcePathElement
