...
description: The AddEngineOptions method turns on some of the debugger engine's options. This method belongs to the IDebugControl3 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugControl3::AddEngineOptions
topic_type:
 - APIRef
 - kbSyntax
api_type:
