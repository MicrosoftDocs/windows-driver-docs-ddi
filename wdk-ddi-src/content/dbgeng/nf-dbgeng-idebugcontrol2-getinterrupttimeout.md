...
ms.date: 2/15/2018
ms.keywords: debugger.getinterrupttimeout, dbgeng/IDebugControl::GetInterruptTimeout, IDebugControl::GetInterruptTimeout, IDebugControl, IDebugControl2, GetInterruptTimeout method [Windows Debugging], IDebugControl3 interface, dbgeng/IDebugControl2::GetInterruptTimeout, dbgeng/IDebugControl3::GetInterruptTimeout, IDebugControl2 interface [Windows Debugging], GetInterruptTimeout method, GetInterruptTimeout method [Windows Debugging], IDebugControl interface, IDebugControl3::GetInterruptTimeout, GetInterruptTimeout, GetInterruptTimeout method [Windows Debugging], IDebugControl2::GetInterruptTimeout, IDebugControl_33383d54-faba-46a1-8e14-8a3215b0d2f7.xml, IDebugControl interface [Windows Debugging], GetInterruptTimeout method, GetInterruptTimeout method [Windows Debugging], IDebugControl2 interface, IDebugControl3 interface [Windows Debugging], GetInterruptTimeout method
...
<a href="mailto:wsddocfb@microsoft.com?subject=Documentation%20feedback [Debugger\debugger]:%20IDebugControl::GetInterruptTimeout method%20 RELEASE:%20(2/15/2018)&amp;body=%0A%0APRIVACY STATEMENT%0A%0AWe use your feedback to improve the documentation. We don't use your email address for any other purpose, and we'll remove your email address from our system after the issue that you're reporting is fixed. While we're working to fix this issue, we might send you an email message to ask for more info. Later, we might also send you an email message to let you know that we've addressed your feedback.%0A%0AFor more info about Microsoft's privacy policy, see http://privacy.microsoft.com/en-us/default.aspx." title="Send comments about this topic to Microsoft">Send comments about this topic to Microsoft</a>
