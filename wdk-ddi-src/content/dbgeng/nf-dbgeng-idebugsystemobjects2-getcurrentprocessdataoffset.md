...
title: IDebugSystemObjects2::GetCurrentProcessDataOffset (dbgeng.h)
description: The IDebugSystemObjects2::GetCurrentProcessDataOffset method returns the location of the system data structure describing the current process.
old-location: debugger\getcurrentprocessdataoffset.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSystemObjects2::GetCurrentProcessDataOffset"]
