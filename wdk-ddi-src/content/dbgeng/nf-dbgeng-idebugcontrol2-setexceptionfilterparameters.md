...
title: IDebugControl2::SetExceptionFilterParameters (dbgeng.h)
description: Learn about the SetExceptionFilterParameters method, which changes the break status and handling status for some exception filters.
