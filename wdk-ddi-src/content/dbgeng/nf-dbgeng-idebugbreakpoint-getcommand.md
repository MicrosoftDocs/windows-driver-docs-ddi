...
description: The GetCommand method returns the command string that is executed when a breakpoint is triggered. This method belongs to the IDebugBreakpoint interface.
