...
description: The GetCurrentProcessUpTime method returns the length of time the current process has been running. This method belongs to the IDebugSystemObjects4 interface.
