...
description: The AppendSourcePath method appends directories to the source path. This method belongs to the IDebugSymbols3 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugSymbols3::AppendSourcePath
topic_type:
 - APIRef
 - kbSyntax
api_type:
