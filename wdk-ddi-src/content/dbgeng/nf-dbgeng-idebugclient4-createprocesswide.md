...
description: The CreateProcessWide method creates a process from the specified command line. This method belongs to the IDebugClient4 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugClient4::CreateProcessWide
topic_type:
 - APIRef
 - kbSyntax
api_type:
