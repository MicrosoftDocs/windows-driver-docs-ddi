...
description: The GetDebuggeeType method describes the nature of the current target. This method belongs to the IDebugControl3 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugControl3::GetDebuggeeType
topic_type:
 - APIRef
 - kbSyntax
api_type:
