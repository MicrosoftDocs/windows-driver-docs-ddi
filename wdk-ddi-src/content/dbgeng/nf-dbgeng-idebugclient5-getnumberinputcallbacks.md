...
The <b>GetNumberInputCallbacks</b> method returns the number of <a href="/windows-hardware/drivers/debugger/using-input-and-output">input callbacks</a> registered over all clients.
