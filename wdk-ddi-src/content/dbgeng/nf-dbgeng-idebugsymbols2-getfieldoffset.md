...
description: The GetFieldOffset method returns the offset of a field from the base address of an instance of a type. This method belongs to the IDebugSymbols2 interface.
old-location: debugger\getfieldoffset2.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSymbols2::GetFieldOffset"]
...
f1_keywords:
 ...
 - dbgeng/IDebugSymbols2::GetFieldOffset
topic_type:
 - APIRef
 - kbSyntax
api_type:
