...
description: The AttachProcess method connects the debugger engine to a user-modeprocess. This method belongs to the IDebugClient3 interface.
old-location: debugger\attachprocess.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient3::AttachProcess"]
...
f1_keywords:
 - IDebugClient3::AttachProcess
 - dbgeng/IDebugClient3::AttachProcess
topic_type:
 - APIRef
 - kbSyntax
api_type:
