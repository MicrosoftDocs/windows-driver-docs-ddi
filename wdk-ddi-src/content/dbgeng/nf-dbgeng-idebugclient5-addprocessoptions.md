...
description: The AddProcessOptions method adds the process options to those options that affect the current process. This method belongs to the IDebugClient5 interface.
