...
ms.date: 1/19/2018
ms.keywords: IDebugControl3 interface [Windows Debugging], WaitForEvent method, dbgeng/IDebugControl2::WaitForEvent, debugger.waitforevent, WaitForEvent method [Windows Debugging], IDebugControl interface, WaitForEvent, IDebugControl2::WaitForEvent, WaitForEvent method [Windows Debugging], dbgeng/IDebugControl::WaitForEvent, IDebugControl_19a7d8b3-1f16-400e-bf8f-c782d48b2cf5.xml, WaitForEvent method [Windows Debugging], IDebugControl3 interface, IDebugControl interface [Windows Debugging], WaitForEvent method, IDebugControl3::WaitForEvent, dbgeng/IDebugControl3::WaitForEvent, IDebugControl2 interface [Windows Debugging], WaitForEvent method, IDebugControl, IDebugControl::WaitForEvent, WaitForEvent method [Windows Debugging], IDebugControl2 interface
