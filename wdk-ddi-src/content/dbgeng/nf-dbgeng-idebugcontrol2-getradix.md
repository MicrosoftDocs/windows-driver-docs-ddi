...
description: Learn how the GetRadix method returns the default radix used by the debugger engine when it evaluates and displays MASM expressions or symbol information.
