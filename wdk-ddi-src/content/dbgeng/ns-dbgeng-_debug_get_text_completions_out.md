...
ms.date: 2/22/2018
ms.keywords: PDEBUG_GET_TEXT_COMPLETIONS_OUT, DEBUG_GET_TEXT_COMPLETIONS_OUT, dbgeng/DEBUG_GET_TEXT_COMPLETIONS_OUT, DEBUG_GET_TEXT_COMPLETIONS_IS_SYMBOL, DEBUG_GET_TEXT_COMPLETIONS_IS_DOT_COMMAND, PDEBUG_GET_TEXT_COMPLETIONS_OUT structure pointer [Windows Debugging], debugger.debug_get_text_completions_out, *PDEBUG_GET_TEXT_COMPLETIONS_OUT, DEBUG_GET_TEXT_COMPLETIONS_OUT structure [Windows Debugging], dbgeng/PDEBUG_GET_TEXT_COMPLETIONS_OUT, DEBUG_GET_TEXT_COMPLETIONS_IS_EXTENSION_COMMAND, _DEBUG_GET_TEXT_COMPLETIONS_OUT
