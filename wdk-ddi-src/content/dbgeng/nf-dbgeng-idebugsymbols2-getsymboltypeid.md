...
description: The GetSymbolTypeId method returns the type ID and module of the specified symbol. This method belongs to the IDebugSymbols2 interface.
old-location: debugger\getsymboltypeid.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSymbols2::GetSymbolTypeId"]
...
f1_keywords:
 ...
 - dbgeng/IDebugSymbols2::GetSymbolTypeId
topic_type:
 - APIRef
 - kbSyntax
api_type:
