...
description: The IDebugEventCallbacksWide::UnloadModule callback method is called by the engine when a module-unload debugging event occurs in the target.
