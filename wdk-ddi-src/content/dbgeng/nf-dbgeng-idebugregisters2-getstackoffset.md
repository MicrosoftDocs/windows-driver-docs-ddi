...
ms.date: 2/22/2018
ms.keywords: IDebugRegisters, IDebugRegisters2 interface [Windows Debugging], GetStackOffset method, GetStackOffset method [Windows Debugging], IDebugRegisters interface [Windows Debugging], GetStackOffset method, IDebugRegisters::GetStackOffset, dbgeng/IDebugRegisters2::GetStackOffset, dbgeng/IDebugRegisters::GetStackOffset, debugger.getstackoffset, IDebugRegisters2::GetStackOffset, GetStackOffset method [Windows Debugging], IDebugRegisters interface, GetStackOffset method [Windows Debugging], IDebugRegisters2 interface, IDebugRegisters_40c9da48-e41f-4890-ace2-b15a2e1cc4ba.xml, IDebugRegisters2, GetStackOffset
