...
description: The (IDebugSystemObjects) GetTotalNumberThreads method returns the total number of threads for all processes and the largest number of threads in any process.
old-location: debugger\gettotalnumberthreads.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSystemObjects::GetTotalNumberThreads"]
