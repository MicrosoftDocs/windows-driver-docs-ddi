...
ms.date: 1/19/2018
ms.keywords: AddBreakpoint method [Windows Debugging], AddBreakpoint method [Windows Debugging], IDebugControl3 interface, IDebugControl2, IDebugControl_3d11665a-ec78-4742-8195-2798601814e9.xml, IDebugControl interface [Windows Debugging], AddBreakpoint method, AddBreakpoint method [Windows Debugging], IDebugControl2 interface, debugger.addbreakpoint, AddBreakpoint method [Windows Debugging], IDebugControl interface, dbgeng/IDebugControl::AddBreakpoint, dbgeng/IDebugControl3::AddBreakpoint, IDebugControl3::AddBreakpoint, IDebugControl3 interface [Windows Debugging], AddBreakpoint method, IDebugControl, AddBreakpoint, dbgeng/IDebugControl2::AddBreakpoint, IDebugControl::AddBreakpoint, IDebugControl2::AddBreakpoint, IDebugControl2 interface [Windows Debugging], AddBreakpoint method
