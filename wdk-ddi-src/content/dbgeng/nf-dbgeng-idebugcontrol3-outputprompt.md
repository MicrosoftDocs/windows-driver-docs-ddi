...
ms.date: 1/10/2018
ms.keywords: IDebugControl3, IDebugControl3::OutputPrompt, OutputPrompt
...
## -description
The <b>OutputPrompt</b>  method formats and sends a user prompt to the <a href="debugger.using_callback_objects#output_callbacks#output_callbacks">output callback objects</a>.
