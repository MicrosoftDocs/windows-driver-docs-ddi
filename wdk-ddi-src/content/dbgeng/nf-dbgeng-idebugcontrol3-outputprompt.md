...
ms.date: 1/19/2018
ms.keywords: OutputPrompt method [Windows Debugging], IDebugControl2 interface, IDebugControl::OutputPrompt, OutputPrompt method [Windows Debugging], IDebugControl interface, debugger.outputprompt, OutputPrompt method [Windows Debugging], IDebugControl3 interface, dbgeng/IDebugControl3::OutputPrompt, dbgeng/IDebugControl::OutputPrompt, OutputPrompt method [Windows Debugging], OutputPrompt, IDebugControl_bb972181-80f5-4c7a-8705-919273529eee.xml, IDebugControl3 interface [Windows Debugging], OutputPrompt method, IDebugControl interface [Windows Debugging], OutputPrompt method, IDebugControl2::OutputPrompt, IDebugControl3, dbgeng/IDebugControl2::OutputPrompt, IDebugControl3::OutputPrompt, IDebugControl2 interface [Windows Debugging], OutputPrompt method
