...
ms.date: 05/03/2018
keywords: ["IDebugControl3::OutputPrompt"]
...
f1_keywords:
 ...
 - dbgeng/IDebugControl3::OutputPrompt
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The <b>OutputPrompt</b>  method formats and sends a user prompt to the <a href="/windows-hardware/drivers/debugger/using-callback-objects">output callback objects</a>.
