...
description: The (IDebugAdvanced2) GetSymbolInformation method returns information about a symbol that is specified using the Which parameter.
old-location: debugger\getsymbolinformation.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugAdvanced2::GetSymbolInformation"]
