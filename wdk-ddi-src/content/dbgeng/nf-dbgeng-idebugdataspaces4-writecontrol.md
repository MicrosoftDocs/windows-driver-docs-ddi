...
description: The WriteControl method writes implementation-specific system data. This method belongs to the IDebugDataSpaces4 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugDataSpaces4::WriteControl
topic_type:
 - APIRef
 - kbSyntax
api_type:
