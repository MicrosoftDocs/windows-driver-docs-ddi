...
ms.date: 1/19/2018
ms.keywords: IDebugControl3::GetEngineOptions, dbgeng/IDebugControl2::GetEngineOptions, dbgeng/IDebugControl3::GetEngineOptions, debugger.getengineoptions, IDebugControl_75edd4f2-c81d-408d-a61a-3c2fcf5932e6.xml, IDebugControl3, GetEngineOptions method [Windows Debugging], dbgeng/IDebugControl::GetEngineOptions, GetEngineOptions method [Windows Debugging], IDebugControl3 interface, GetEngineOptions, IDebugControl3 interface [Windows Debugging], GetEngineOptions method, GetEngineOptions method [Windows Debugging], IDebugControl2 interface, IDebugControl2 interface [Windows Debugging], GetEngineOptions method, GetEngineOptions method [Windows Debugging], IDebugControl interface, IDebugControl2::GetEngineOptions, IDebugControl::GetEngineOptions, IDebugControl interface [Windows Debugging], GetEngineOptions method
