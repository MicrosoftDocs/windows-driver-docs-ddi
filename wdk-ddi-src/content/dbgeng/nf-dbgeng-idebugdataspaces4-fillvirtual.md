...
ms.date: 2/15/2018
ms.keywords: FillVirtual, dbgeng/IDebugDataSpaces4::FillVirtual, IDebugDataSpaces_26ed83e1-6084-4826-bf6c-30be250d3e3f.xml, FillVirtual method [Windows Debugging], IDebugDataSpaces2 interface, IDebugDataSpaces4::FillVirtual, dbgeng/IDebugDataSpaces3::FillVirtual, IDebugDataSpaces4, IDebugDataSpaces4 interface [Windows Debugging], FillVirtual method, IDebugDataSpaces3 interface [Windows Debugging], FillVirtual method, IDebugDataSpaces2, FillVirtual method [Windows Debugging], IDebugDataSpaces3 interface, debugger.fillvirtual, IDebugDataSpaces3, IDebugDataSpaces3::FillVirtual, IDebugDataSpaces2::FillVirtual, FillVirtual method [Windows Debugging], dbgeng/IDebugDataSpaces2::FillVirtual, FillVirtual method [Windows Debugging], IDebugDataSpaces4 interface, IDebugDataSpaces2 interface [Windows Debugging], FillVirtual method
