...
title: IDebugClient4::TerminateCurrentProcess (dbgeng.h)
description: The TerminateCurrentProcess method attempts to terminate the current process. This method belongs to the IDebugClient4 interface.
old-location: debugger\terminatecurrentprocess.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient4::TerminateCurrentProcess"]
...
f1_keywords:
 ...
 - dbgeng/IDebugClient4::TerminateCurrentProcess
topic_type:
 - APIRef
 - kbSyntax
api_type:
