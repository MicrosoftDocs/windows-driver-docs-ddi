...
title: IDebugSymbols2::GetModuleByModuleName (dbgeng.h)
...
ms.date: 05/03/2018
keywords: ["IDebugSymbols2::GetModuleByModuleName"]
...
f1_keywords:
 ...
 - dbgeng/IDebugSymbols2::GetModuleByModuleName
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The <b>GetModuleByModuleName</b>  method searches through the target's <a href="https://docs.microsoft.com/windows-hardware/drivers/debugger/modules">modules</a> for one with the specified name.
