...
description: The GetScope method returns information about the current scope. This method belongs to the IDebugSymbols3 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugSymbols3::GetScope
topic_type:
 - APIRef
 - kbSyntax
api_type:
