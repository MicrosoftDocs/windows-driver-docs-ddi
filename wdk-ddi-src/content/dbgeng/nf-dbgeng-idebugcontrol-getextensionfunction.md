...
title: IDebugControl::GetExtensionFunction (dbgeng.h)
description: Learn how the GetExtensionFunction method returns a pointer to an extension function from an extension library.
old-location: debugger\getextensionfunction.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugControl::GetExtensionFunction"]
...
f1_keywords:
 ...
 - dbgeng/IDebugControl::GetExtensionFunction
topic_type:
 - APIRef
 - kbSyntax
api_type:
