...
ms.date: 1/19/2018
ms.keywords: SetValue method [Windows Debugging], IDebugRegisters2 interface [Windows Debugging], SetValue method, SetValue method [Windows Debugging], IDebugRegisters interface, SetValue method [Windows Debugging], IDebugRegisters2 interface, IDebugRegisters2::SetValue, IDebugRegisters::SetValue, IDebugRegisters interface [Windows Debugging], SetValue method, debugger.setvalue, dbgeng/IDebugRegisters::SetValue, IDebugRegisters_f704c31f-5062-47d7-9f44-35bc85e0d0aa.xml, SetValue, dbgeng/IDebugRegisters2::SetValue, IDebugRegisters2
