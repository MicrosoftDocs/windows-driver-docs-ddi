...
ms.date: 1/19/2018
ms.keywords: GetSupportedProcessorTypes method [Windows Debugging], IDebugControl2 interface, dbgeng/IDebugControl3::GetSupportedProcessorTypes, IDebugControl_555eef6a-df68-4f94-9cfa-dc31aee27014.xml, IDebugControl::GetSupportedProcessorTypes, GetSupportedProcessorTypes method [Windows Debugging], IDebugControl3 interface, IDebugControl3 interface [Windows Debugging], GetSupportedProcessorTypes method, GetSupportedProcessorTypes method [Windows Debugging], IDebugControl2::GetSupportedProcessorTypes, GetSupportedProcessorTypes method [Windows Debugging], IDebugControl interface, IDebugControl3::GetSupportedProcessorTypes, IDebugControl, IDebugControl interface [Windows Debugging], GetSupportedProcessorTypes method, dbgeng/IDebugControl::GetSupportedProcessorTypes, IDebugControl2 interface [Windows Debugging], GetSupportedProcessorTypes method, GetSupportedProcessorTypes, dbgeng/IDebugControl2::GetSupportedProcessorTypes, debugger.getsupportedprocessortypes
