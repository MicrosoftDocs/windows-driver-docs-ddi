...
description: The Disassemble method disassembles a processor instruction in the target's memory. This method belongs to the IDebugControl3 interface.
old-location: debugger\disassemble.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugControl3::Disassemble"]
...
f1_keywords:
 ...
 - dbgeng/IDebugControl3::Disassemble
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The disassembly options--returned by <a href="/windows-hardware/drivers/ddi/dbgeng/nf-dbgeng-idebugcontrol3-getassemblyoptions">GetAssemblyOptions</a>--affect the operation of this method.
