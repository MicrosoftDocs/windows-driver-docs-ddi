...
title: IDebugClient5::DisconnectProcessServer (dbgeng.h)
description: The DisconnectProcessServer method disconnects the debugger engine from a process server. This method belongs to the IDebugClient5 interface.
old-location: debugger\disconnectprocessserver.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient5::DisconnectProcessServer"]
...
f1_keywords:
 ...
 - dbgeng/IDebugClient5::DisconnectProcessServer
topic_type:
 - APIRef
 - kbSyntax
api_type:
