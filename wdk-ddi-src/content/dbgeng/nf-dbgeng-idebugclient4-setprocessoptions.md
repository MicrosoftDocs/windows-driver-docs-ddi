...
description: The SetProcessOptions method sets the process options affecting the current process. This method belongs to the IDebugClient4 interface.
old-location: debugger\setprocessoptions.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient4::SetProcessOptions"]
...
f1_keywords:
 ...
 - dbgeng/IDebugClient4::SetProcessOptions
topic_type:
 - APIRef
 - kbSyntax
api_type:
