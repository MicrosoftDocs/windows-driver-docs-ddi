...
title: IDebugClient2::OutputServers (dbgeng.h)
description: The OutputServers method lists the servers running on a given computer. This method belongs to the IDebugClient2 interface.
old-location: debugger\outputservers.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient2::OutputServers"]
...
f1_keywords:
 ...
 - dbgeng/IDebugClient2::OutputServers
topic_type:
 - APIRef
 - kbSyntax
api_type:
