...
ms.date: 1/19/2018
ms.keywords: IDebugSymbols3::GetModuleByModuleName2, debugger.getmodulebymodulename2, GetModuleByModuleName2 method [Windows Debugging], IDebugSymbols3 interface, IDebugSymbols3, GetModuleByModuleName2, dbgeng/IDebugSymbols3::GetModuleByModuleName2, IDebugSymbols_f5630cfb-3af4-4722-8851-0a12523fbf82.xml, GetModuleByModuleName2 method [Windows Debugging], IDebugSymbols3 interface [Windows Debugging], GetModuleByModuleName2 method
