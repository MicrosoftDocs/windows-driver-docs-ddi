...
title: IDebugControl::SetExceptionFilterSecondCommand (dbgeng.h)
description: This method sets the command that's executed by the debugger engine on the second chance of a specified exception.
