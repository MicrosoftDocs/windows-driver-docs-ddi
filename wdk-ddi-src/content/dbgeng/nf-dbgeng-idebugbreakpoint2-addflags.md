...
ms.date: 2/22/2018
ms.keywords: IDebugBreakpoint2, ComOther_2becec27-600b-4d57-93b0-8a794ff2f068.xml, IDebugBreakpoint::AddFlags, dbgeng/IDebugBreakpoint::AddFlags, IDebugBreakpoint2 interface [Windows Debugging], AddFlags method, AddFlags method [Windows Debugging], IDebugBreakpoint, debugger.addflags, IDebugBreakpoint interface [Windows Debugging], AddFlags method, AddFlags method [Windows Debugging], IDebugBreakpoint interface, AddFlags, AddFlags method [Windows Debugging], IDebugBreakpoint2 interface, dbgeng/IDebugBreakpoint2::AddFlags, IDebugBreakpoint2::AddFlags
