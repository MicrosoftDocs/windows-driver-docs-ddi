...
title: IDebugDataSpaces3::WriteControl (dbgeng.h)
description: The WriteControl method writes implementation-specific system data. This method belongs to the IDebugDataSpaces3 interface.
old-location: debugger\writecontrol.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugDataSpaces3::WriteControl"]
...
f1_keywords:
 ...
 - dbgeng/IDebugDataSpaces3::WriteControl
topic_type:
 - APIRef
 - kbSyntax
api_type:
