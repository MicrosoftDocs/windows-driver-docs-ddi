...
ms.date: 1/19/2018
ms.keywords: IDebugSymbols::GetModuleByIndex, GetModuleByIndex method [Windows Debugging], IDebugSymbols2 interface, GetModuleByIndex, GetModuleByIndex method [Windows Debugging], IDebugSymbols interface, IDebugSymbols2 interface [Windows Debugging], GetModuleByIndex method, GetModuleByIndex method [Windows Debugging], IDebugSymbols2, GetModuleByIndex method [Windows Debugging], IDebugSymbols3 interface, IDebugSymbols2::GetModuleByIndex, dbgeng/IDebugSymbols2::GetModuleByIndex, IDebugSymbols3::GetModuleByIndex, dbgeng/IDebugSymbols3::GetModuleByIndex, debugger.getmodulebyindex, dbgeng/IDebugSymbols::GetModuleByIndex, IDebugSymbols, IDebugSymbols3 interface [Windows Debugging], GetModuleByIndex method, IDebugSymbols interface [Windows Debugging], GetModuleByIndex method, IDebugSymbols_0406a71f-e9eb-4acd-93e8-1637ee2506df.xml
