...
title: IDebugControl2::ControlledOutput (dbgeng.h)
description: The IDebugControl2::ControlledOutput method formats a string and sends the result to output callbacks that were registered with some of the engine's clients.
