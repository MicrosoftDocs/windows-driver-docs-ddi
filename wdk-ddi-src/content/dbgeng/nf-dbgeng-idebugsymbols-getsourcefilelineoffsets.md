...
description: The GetSourceFileLineOffsets method maps each line in a source file to a location in the target's memory. This method belongs to the IDebugSymbols interface.
old-location: debugger\getsourcefilelineoffsets.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSymbols::GetSourceFileLineOffsets"]
