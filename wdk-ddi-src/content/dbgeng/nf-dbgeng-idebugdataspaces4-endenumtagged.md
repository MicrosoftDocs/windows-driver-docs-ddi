...
ms.date: 1/19/2018
ms.keywords: IDebugDataSpaces4 interface [Windows Debugging], EndEnumTagged method, EndEnumTagged, IDebugDataSpaces3::EndEnumTagged, IDebugDataSpaces3, EndEnumTagged method [Windows Debugging], IDebugDataSpaces3 interface, EndEnumTagged method [Windows Debugging], debugger.endenumtagged, IDebugDataSpaces3 interface [Windows Debugging], EndEnumTagged method, dbgeng/IDebugDataSpaces4::EndEnumTagged, dbgeng/IDebugDataSpaces3::EndEnumTagged, EndEnumTagged method [Windows Debugging], IDebugDataSpaces4 interface, IDebugDataSpaces_a6366d17-1a38-43ca-af52-3c7e2b73be9e.xml, IDebugDataSpaces4, IDebugDataSpaces4::EndEnumTagged
