...
title: IDebugClient3::ConnectProcessServer (dbgeng.h)
description: The ConnectProcessServer methods connect to a process server. This method belongs to the IDebugClient3 interface.
old-location: debugger\connectprocessserver.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient3::ConnectProcessServer"]
...
f1_keywords:
 - IDebugClient3::ConnectProcessServer
 - dbgeng/IDebugClient3::ConnectProcessServer
topic_type:
 - APIRef
 - kbSyntax
api_type:
