...
description: The SetProcessOptions method sets the process options affecting the current process. This method belongs to the IDebugClient2 interface.
old-location: debugger\setprocessoptions.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugClient2::SetProcessOptions"]
...
f1_keywords:
 ...
 - dbgeng/IDebugClient2::SetProcessOptions
topic_type:
 - APIRef
 - kbSyntax
api_type:
