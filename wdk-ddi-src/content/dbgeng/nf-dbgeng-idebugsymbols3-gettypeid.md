...
title: IDebugSymbols3::GetTypeId (dbgeng.h)
description: The GetTypeId method looks up the specified type and return its type ID. This method belongs to the IDebugSymbols3 interface.
old-location: debugger\gettypeid.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSymbols3::GetTypeId"]
...
f1_keywords:
 ...
 - dbgeng/IDebugSymbols3::GetTypeId
topic_type:
 - APIRef
 - kbSyntax
api_type:
