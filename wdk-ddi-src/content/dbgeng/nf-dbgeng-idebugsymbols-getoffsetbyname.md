...
description: The GetOffsetByName method returns the location of a symbol identified by name. This method belongs to the IDebugSymbols interface.
old-location: debugger\getoffsetbyname.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSymbols::GetOffsetByName"]
