...
description: The DispatchCallbacks method lets the debugger engine use the current thread for callbacks. This method belongs to the IDebugClient4 interface.
