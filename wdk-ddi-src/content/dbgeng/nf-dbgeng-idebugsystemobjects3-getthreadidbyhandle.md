...
description: The IDebugSystemObjects3::GetThreadIdByHandle method returns the engine thread ID for the specified thread. The thread is specified by its system handle.
old-location: debugger\getthreadidbyhandle.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSystemObjects3::GetThreadIdByHandle"]
...
f1_keywords:
 ...
 - dbgeng/IDebugSystemObjects3::GetThreadIdByHandle
topic_type:
 - APIRef
 - kbSyntax
api_type:
