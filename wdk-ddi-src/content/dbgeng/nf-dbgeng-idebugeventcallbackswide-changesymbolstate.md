...
ms.date: 2/22/2018
ms.keywords: IDebugEventCallbacksWide interface [Windows Debugging], ChangeSymbolState method, IDebugEventCallbacksWide::ChangeSymbolState, ChangeSymbolState method [Windows Debugging], ChangeSymbolState, ChangeSymbolState method [Windows Debugging], IDebugEventCallbacksWide interface, debugger.idebugeventcallbackswide_changesymbolstate, dbgeng/IDebugEventCallbacksWide::ChangeSymbolState, IDebugEventCallbacksWide
