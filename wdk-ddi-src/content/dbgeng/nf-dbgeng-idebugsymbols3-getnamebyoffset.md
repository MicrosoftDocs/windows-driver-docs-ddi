...
description: The IDebugSymbols3::GetNameByOffset method returns the name of the symbol at the specified location in the target's virtual address space.
old-location: debugger\getnamebyoffset.htm
tech.root: debugger
ms.date: 05/03/2018
keywords: ["IDebugSymbols3::GetNameByOffset"]
...
f1_keywords:
 ...
 - dbgeng/IDebugSymbols3::GetNameByOffset
topic_type:
 - APIRef
 - kbSyntax
api_type:
