...
title: IDebugClient::GetOtherOutputMask (dbgeng.h)
description: The GetOtherOutputMask method returns the output mask for another client. This method belongs to the IDebugClient interface.
