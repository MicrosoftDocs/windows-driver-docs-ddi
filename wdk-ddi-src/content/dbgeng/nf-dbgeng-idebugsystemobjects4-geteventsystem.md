...
ms.date: 1/19/2018
ms.keywords: GetEventSystem, dbgeng/IDebugSystemObjects3::GetEventSystem, IDebugSystemObjects3 interface [Windows Debugging], GetEventSystem method, IDebugSystemObjects4 interface [Windows Debugging], GetEventSystem method, IDebugSystemObjects4::GetEventSystem, dbgeng/IDebugSystemObjects4::GetEventSystem, IDebugSystemObjects4, IDebugSystemObjects3::GetEventSystem, GetEventSystem method [Windows Debugging], GetEventSystem method [Windows Debugging], IDebugSystemObjects4 interface, GetEventSystem method [Windows Debugging], IDebugSystemObjects3 interface, debugger.geteventsystem, IDebugSystemObjects_6cb96e5a-e9a5-4ff7-9f36-a7770bc77ef1.xml
