...
ms.date: 1/19/2018
ms.keywords: IDebugEventCallbacksWide interface [Windows Debugging], CreateProcess method, CreateProcess method [Windows Debugging], IDebugEventCallbacksWide interface, IDebugEventCallbacksWide, IDebugEventCallbacksWide::CreateProcess, CreateProcess, debugger.idebugeventcallbackswide_createprocess, CreateProcess method [Windows Debugging], dbgeng/IDebugEventCallbacksWide::CreateProcess
