...
description: Learn about the GetNotifyEventHandle method, which receives the handle of the event that will be signaled after the next exception in a target.
