...
ms.date: 1/10/2018
ms.keywords: IDebugClient5, IDebugClient5::GetInputCallbacks, GetInputCallbacks
...
## -description
The <b>GetInputCallbacks</b> method returns the <a href="debugger.using_input_and_output#input_callbacks#input_callbacks">input callbacks</a> object registered with this client.
