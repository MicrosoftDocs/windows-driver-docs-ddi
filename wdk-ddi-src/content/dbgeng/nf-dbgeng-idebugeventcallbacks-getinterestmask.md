...
ms.date: 2/22/2018
ms.keywords: GetInterestMask, IDebugEventCallbacks, GetInterestMask method [Windows Debugging], GetInterestMask method [Windows Debugging], IDebugEventCallbacks interface, IDebugEventCallbacks::GetInterestMask, dbgeng/IDebugEventCallbacks::GetInterestMask, IDebugEventCallbacks interface [Windows Debugging], GetInterestMask method, debugger.idebugeventcallbacks_getinterestmask, ComCallbacks_564e7fce-ee9a-404e-9ae4-06805cb0b677.xml
