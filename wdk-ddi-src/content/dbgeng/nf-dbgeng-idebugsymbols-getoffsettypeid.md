...
description: The GetOffsetTypeId method returns the type ID of the symbol closest to the specified memory location. This method belongs to the IDebugSymbols interface.
