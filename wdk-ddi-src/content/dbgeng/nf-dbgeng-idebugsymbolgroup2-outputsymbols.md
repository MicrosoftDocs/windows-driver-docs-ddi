...
description: The OutputSymbols method prints the specified symbols to the debugger console. This method belongs to the IDebugSymbolGroup2 interface.
...
f1_keywords:
 ...
 - dbgeng/IDebugSymbolGroup2::OutputSymbols
topic_type:
 - APIRef
 - kbSyntax
api_type:
