...
ms.date: 2/22/2018
ms.keywords: ComOther_2becec27-600b-4d57-93b0-8a794ff2f068.xml, IDebugBreakpoint::AddFlags, dbgeng/IDebugBreakpoint::AddFlags, IDebugBreakpoint2 interface [Windows Debugging], AddFlags method, AddFlags method [Windows Debugging], IDebugBreakpoint, IDebugBreakpoint interface [Windows Debugging], AddFlags method, AddFlags method [Windows Debugging], IDebugBreakpoint interface, dbgeng/IDebugBreakpoint2::AddFlags, AddFlags, AddFlags method [Windows Debugging], IDebugBreakpoint2 interface, debugger.addflags, IDebugBreakpoint2::AddFlags
