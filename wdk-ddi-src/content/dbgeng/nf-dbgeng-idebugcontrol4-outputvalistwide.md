...
The <b>OutputVaListWide</b>  method formats a string and sends the result to the <a href="/windows-hardware/drivers/debugger/using-input-and-output">output callbacks</a> that are registered with the engine's clients.
