...
ms.date: 08/04/2021
targetos: Windows
description: Adds an ACX circuit device to a parent device representing an audio path.
prerelease: true
req.assembly: 
...
Adds an ACX circuit device to a specified parent device representing an audio path.
