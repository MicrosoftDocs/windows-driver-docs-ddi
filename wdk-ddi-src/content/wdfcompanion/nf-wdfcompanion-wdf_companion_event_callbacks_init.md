...
ms.date: 2/20/2018
ms.keywords: WDF_COMPANION_EVENT_CALLBACKS_INIT, wdf.wdf_companion_event_callbacks_init, WDF_COMPANION_EVENT_CALLBACKS_INIT method, wdfcompanion/WDF_COMPANION_EVENT_CALLBACKS_INIT
