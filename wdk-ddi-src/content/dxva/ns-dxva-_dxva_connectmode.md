...
title: DXVA_ConnectMode (dxva.h)
description: Learn more about the DXVA_ConnectMode structure.
tech.root: display
ms.date: 09/27/2023
...
Specifies the GUID associated with the [restricted profile](/windows-hardware/drivers/display/restricted-profiles) to be used.
...
The following GUIDs placed in the **guidMode** member of this structure set the [restricted profile](/windows-hardware/drivers/display/restricted-profiles) to be used. The constants that define the GUIDs used are in *dxva.h*.
