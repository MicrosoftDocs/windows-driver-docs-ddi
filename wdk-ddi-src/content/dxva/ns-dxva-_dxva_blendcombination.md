...
Specifies the area of the source graphic image as a <a href="https://docs.microsoft.com/windows/win32/api/windef/ns-windef-tagrect">RECT</a> structure. This area is combined with the part of the source picture specified by <b>PictureSourceRect16thPel</b> to create the alpha-blended picture.

### -field GraphicDestinationRect

Specifies the area of the destination graphic image as a <a href="https://docs.microsoft.com/windows/win32/api/windef/ns-windef-tagrect">RECT</a> structure.
...
The following restrictions apply to the <a href="https://docs.microsoft.com/windows/win32/api/windef/ns-windef-tagrect">RECT</a> dimensions of <b>PictureSourceRect16thPel</b>:
...
The following restrictions apply to the <a href="https://docs.microsoft.com/windows/win32/api/windef/ns-windef-tagrect">RECT</a> dimensions for <b>PictureDestinationRect</b>:
...
The following restrictions apply to the <a href="https://docs.microsoft.com/windows/win32/api/windef/ns-windef-tagrect">RECT</a> dimensions of <b>GraphicDestinationRect</b>:
...
<a href="https://docs.microsoft.com/windows/win32/api/ddrawint/nc-ddrawint-pdd_mocompcb_beginframe">DdMoCompBeginFrame</a>
