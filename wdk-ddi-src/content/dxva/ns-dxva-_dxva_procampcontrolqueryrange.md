...
ms.date: 12/29/2017
ms.keywords: display.dxva_procampcontrolqueryrange, dxva/DXVA_ProcAmpControlQueryRange, dxva/LPDXVA_ProcAmpControlQueryRange, DXVA_ProcAmpControlQueryRange structure [Display Devices], dxvaref_5122c77d-0d7a-42a4-be26-f03993fb52db.xml, LPDXVA_ProcAmpControlQueryRange structure pointer [Display Devices], LPDXVA_ProcAmpControlQueryRange, *LPDXVA_ProcAmpControlQueryRange, _DXVA_ProcAmpControlQueryRange, DXVA_ProcAmpControlQueryRange
