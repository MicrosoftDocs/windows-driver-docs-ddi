...
title: _DXVA_VideoSample2 (dxva.h)
...
The <b>SampleFormat</b> member indicates whether the sample is a reference for a deinterlace operation or a video substream sample that must be combined with the deinterlaced video frame. The DXVA_SampleSubStream value (new for Windows Server 2003 with SP1 and later and Windows XP with SP2 and later) of the <a href="/windows-hardware/drivers/ddi/dxva/ne-dxva-_dxva_sampleformat">DXVA_SampleFormat</a> enumeration type specifies the format for a video substream sample.
...
For information about how input samples are arranged in the array in the <b>Source</b> member of the <a href="/windows-hardware/drivers/ddi/dxva/ns-dxva-_dxva_deinterlacebltex">DXVA_DeinterlaceBltEx</a> structure, see <a href="/windows-hardware/drivers/display/input-buffer-order">Input Buffer Order</a>.
