...
ms.date: 2/22/2018
ms.keywords: LPDXVA_DeinterlaceCaps structure pointer [Display Devices], DXVA_DeinterlaceCaps, dxvaref_daa1a58d-aec2-4370-9baa-7a3b8cbcacf8.xml, dxva/DXVA_DeinterlaceCaps, *LPDXVA_DeinterlaceCaps, LPDXVA_DeinterlaceCaps, DXVA_DeinterlaceCaps structure [Display Devices], display.dxva_deinterlacecaps, _DXVA_DeinterlaceCaps, dxva/LPDXVA_DeinterlaceCaps
