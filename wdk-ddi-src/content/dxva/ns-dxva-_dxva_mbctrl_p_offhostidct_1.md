...
# DXVA_MBctrl_P_OffHostIDCT_1 structure (dxva.h)
...
| 2 | *MotionBackward*<br/>Used as specified for the corresponding macroblock_motion_backwardparameter in MPEG-2. If the bPicBackwardPrediction member of [DXVA_PictureParameters](./ns-dxva-_dxva_pictureparameters.md)  is zero, MotionBackward must be zero. The use of this bit is further explained in the following Remarks section. | 
...
An array containing the value of the motion vector(s) for the macroblock, each represented using a <a href="/windows-hardware/drivers/ddi/dxva/ns-dxva-_dxva_mvvalue">DXVA_MVvalue</a> structure.
