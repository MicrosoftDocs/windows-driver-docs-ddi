...
tech.root: display
ms.date: 05/10/2018
keywords: ["DXVA_NominalRange enumeration"]
...
# DXVA_NominalRange enumeration (dxva.h)
...
One of the enumerators of DXVA_NominalRange can be specified in the <b>NominalRange</b> member of the <a href="/windows-hardware/drivers/ddi/dxva/ns-dxva-_dxva_extendedformat">DXVA_ExtendedFormat</a> structure.
