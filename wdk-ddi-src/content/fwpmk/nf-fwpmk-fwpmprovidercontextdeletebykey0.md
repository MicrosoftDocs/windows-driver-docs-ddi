...
ms.date: 06/12/2024
targetos: Windows
description: The FwpmProviderContextDeleteByKey0 function removes a provider context from the system.
prerelease: false
req.assembly: 
...
# FwpmProviderContextDeleteByKey0 function (fwpmk.h)
...
Unique identifier of the object being removed from the system. This is a pointer to the same GUID that was specified when the application called **[FwpmProviderContextAdd0](nf-fwpmk-fwpmprovidercontextadd0.md)** for this object.
...
**FwpmProviderContextDeleteByKey0** is a specific implementation of **FwpmProviderContextDeleteByKey**. See [WFP Version-Independent Names and Targeting Specific Versions of Windows](/windows/desktop/FWP/wfp-version-independent-names-and-targeting-specific-versions-of-windows) for more information.
