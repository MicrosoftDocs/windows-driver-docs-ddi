...
The client driver calls the  **NET_ADAPTER_WAKE_REASON_MAGIC_PACKET_INIT** method to initialize a [**NET_ADAPTER_WAKE_REASON_PACKET**](../netadapter/ns-netadapter-_net_adapter_wake_reason_packet.md) structure when reporting that a magic packet caused a wake-up event.
...
This method zeroes out the memory for the **NET_ADAPTER_WAKE_REASON_PACKET** structure, sets the **Size** member, and sets the **PatternId** member to NetAdapterWakeMagicPatternId.
