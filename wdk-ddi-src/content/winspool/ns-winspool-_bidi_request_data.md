...
ms.date: 1/18/2018
ms.keywords: winspool/LPBIDI_REQUEST_DATA, LPBIDI_REQUEST_DATA structure pointer [Print Devices], *PBIDI_REQUEST_DATA, PBIDI_REQUEST_DATA structure pointer [Print Devices], spoolfnc_ab7c70f5-9161-4245-8f25-350f68144f82.xml, winspool/BIDI_REQUEST_DATA, LPBIDI_REQUEST_DATA, *LPBIDI_REQUEST_DATA, _BIDI_REQUEST_DATA, winspool/PBIDI_REQUEST_DATA, print.bidi_request_data, PBIDI_REQUEST_DATA, BIDI_REQUEST_DATA structure [Print Devices], BIDI_REQUEST_DATA
