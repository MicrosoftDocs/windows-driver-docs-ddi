...
ms.date: 2/22/2018
ms.keywords: PDRIVER_INFO_8, winspool/PDRIVER_INFO_8, _DRIVER_INFO_8A, print.driver_info_8, LPDRIVER_INFO_8, DRIVER_INFO_8 structure [Print Devices], print_ticket-package_dba844e8-6e97-4eaf-8de4-1003562e01d5.xml, DRIVER_INFO_8, PDRIVER_INFO_8 structure pointer [Print Devices], DRIVER_INFO_8A, winspool/DRIVER_INFO_8, LPDRIVER_INFO_8 structure pointer [Print Devices], *LPDRIVER_INFO_8A, *PDRIVER_INFO_8A, winspool/LPDRIVER_INFO_8
