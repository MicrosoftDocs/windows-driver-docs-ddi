...
ms.date: 2/22/2018
ms.keywords: LPBIDI_RESPONSE_DATA, BIDI_RESPONSE_DATA structure [Print Devices], *PBIDI_RESPONSE_DATA, winspool/LPBIDI_RESPONSE_DATA, winspool/BIDI_RESPONSE_DATA, *LPBIDI_RESPONSE_DATA, PBIDI_RESPONSE_DATA, BIDI_RESPONSE_DATA, print.bidi_response_data, winspool/PBIDI_RESPONSE_DATA, spoolfnc_eb6aa91d-8fbc-4079-a8b8-57d5c3ff7abf.xml, _BIDI_RESPONSE_DATA, LPBIDI_RESPONSE_DATA structure pointer [Print Devices], PBIDI_RESPONSE_DATA structure pointer [Print Devices]
