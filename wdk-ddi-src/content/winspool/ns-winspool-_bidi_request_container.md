...
ms.date: 2/22/2018
ms.keywords: spoolfnc_26c43d0f-69f8-415c-8653-79ef503fe139.xml, PBIDI_REQUEST_CONTAINER structure pointer [Print Devices], LPBIDI_REQUEST_CONTAINER structure pointer [Print Devices], LPBIDI_REQUEST_CONTAINER, BIDI_REQUEST_CONTAINER, *PBIDI_REQUEST_CONTAINER, print.bidi_request_container, PBIDI_REQUEST_CONTAINER, _BIDI_REQUEST_CONTAINER, BIDI_REQUEST_CONTAINER structure [Print Devices], winspool/PBIDI_REQUEST_CONTAINER, *LPBIDI_REQUEST_CONTAINER, winspool/LPBIDI_REQUEST_CONTAINER, winspool/BIDI_REQUEST_CONTAINER
