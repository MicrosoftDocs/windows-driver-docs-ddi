...
ms.date: 2/20/2018
ms.keywords: ",  , A, B, D, E, F, G, L, N, O, P, R, T, U, W, WDF_READ_PORT_BUFFER_ULONG, WDF_READ_PORT_BUFFER_ULONG function, _, wdf.wdf_read_port_buffer_ulong, wdfhwaccess/WDF_READ_PORT_BUFFER_ULONG"
