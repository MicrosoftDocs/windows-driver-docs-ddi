...
ms.date: 2/20/2018
ms.keywords: ",  , A, B, C, D, E, F, G, H, I, R, S, T, U, W, WDF_READ_REGISTER_BUFFER_UCHAR, WDF_READ_REGISTER_BUFFER_UCHAR function, _, wdf.wdf_read_register_buffer_uchar, wdfhwaccess/WDF_READ_REGISTER_BUFFER_UCHAR"
