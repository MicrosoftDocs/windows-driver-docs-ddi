...
ms.date: 2/20/2018
ms.keywords: ",  , B, D, E, F, H, I, O, P, R, S, T, U, W, WDF_WRITE_PORT_BUFFER_USHORT, WDF_WRITE_PORT_BUFFER_USHORT function, _, wdf.wdf_write_port_buffer_ushort, wdfhwaccess/WDF_WRITE_PORT_BUFFER_USHORT"
