...
ms.date: 2/20/2018
ms.keywords: ",  , B, D, E, F, G, H, I, O, R, S, T, U, W, WDF_WRITE_REGISTER_BUFFER_USHORT, WDF_WRITE_REGISTER_BUFFER_USHORT function, _, wdf.wdf_write_register_buffer_ushort, wdfhwaccess/WDF_WRITE_REGISTER_BUFFER_USHORT"
