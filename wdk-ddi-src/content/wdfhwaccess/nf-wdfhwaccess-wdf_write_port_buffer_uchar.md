...
ms.date: 2/20/2018
ms.keywords: ",  , A, B, C, D, E, F, H, I, O, P, R, T, U, W, WDF_WRITE_PORT_BUFFER_UCHAR, WDF_WRITE_PORT_BUFFER_UCHAR function, _, wdf.wdf_write_port_buffer_uchar, wdfhwaccess/WDF_WRITE_PORT_BUFFER_UCHAR"
