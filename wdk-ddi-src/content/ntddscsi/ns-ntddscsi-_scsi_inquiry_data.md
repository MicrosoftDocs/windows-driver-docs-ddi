...
f1_keywords:
 - _SCSI_INQUIRY_DATA
 - ntddscsi/_SCSI_INQUIRY_DATA
 - PSCSI_INQUIRY_DATA
 - ntddscsi/PSCSI_INQUIRY_DATA
 - SCSI_INQUIRY_DATA
...
The SCSI_INQUIRY_DATA structure is used in conjunction with the <a href="/windows-hardware/drivers/ddi/ntddscsi/ni-ntddscsi-ioctl_scsi_get_inquiry_data">IOCTL_SCSI_GET_INQUIRY_DATA</a> request to retrieve the SCSI inquiry data for all devices on a given SCSI bus. 
