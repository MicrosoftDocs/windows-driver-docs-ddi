...
ms.date: 2/16/2018
ms.keywords: storage.scsi_address, SCSI_ADDRESS structure [Storage Devices], PSCSI_ADDRESS structure pointer [Storage Devices], ntddscsi/PSCSI_ADDRESS, PSCSI_ADDRESS, ntddscsi/SCSI_ADDRESS, SCSI_ADDRESS, _SCSI_ADDRESS, *PSCSI_ADDRESS, structs-scsibus_6b7a15bf-09f3-4fe2-bbef-77e1fd6e1744.xml
