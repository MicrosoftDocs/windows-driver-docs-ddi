...
ms.date: 2/16/2018
ms.keywords: ntddscsi/SCSI_ADDRESS, PSCSI_ADDRESS structure pointer [Storage Devices], _SCSI_ADDRESS, structs-scsibus_6b7a15bf-09f3-4fe2-bbef-77e1fd6e1744.xml, *PSCSI_ADDRESS, SCSI_ADDRESS, PSCSI_ADDRESS, SCSI_ADDRESS structure [Storage Devices], ntddscsi/PSCSI_ADDRESS, storage.scsi_address
