...
ms.date: 1/10/2018
ms.keywords: SCSI_ADDRESS, ntddscsi/PSCSI_ADDRESS, PSCSI_ADDRESS, _SCSI_ADDRESS, structs-scsibus_6b7a15bf-09f3-4fe2-bbef-77e1fd6e1744.xml, SCSI_ADDRESS structure [Storage Devices], PSCSI_ADDRESS structure pointer [Storage Devices], storage.scsi_address, *PSCSI_ADDRESS, ntddscsi/SCSI_ADDRESS
