...
ms.date: 2/16/2018
ms.keywords: IO_SCSI_CAPABILITIES structure [Storage Devices], ntddscsi/IO_SCSI_CAPABILITIES, _IO_SCSI_CAPABILITIES, PIO_SCSI_CAPABILITIES structure pointer [Storage Devices], ntddscsi/PIO_SCSI_CAPABILITIES, IO_SCSI_CAPABILITIES, PIO_SCSI_CAPABILITIES, *PIO_SCSI_CAPABILITIES, storage.io_scsi_capabilities, structs-scsibus_9329ca36-3fe4-4d9a-a3c7-f63a216244b5.xml
