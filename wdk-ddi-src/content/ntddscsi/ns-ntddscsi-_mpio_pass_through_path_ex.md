...
ms.date: 1/10/2018
ms.keywords: ntddscsi/MPIO_PASS_THROUGH_PATH_EX, ntddscsi/PMPIO_PASS_THROUGH_PATH_EX, *PMPIO_PASS_THROUGH_PATH_EX, PMPIO_PASS_THROUGH_PATH_EX, _MPIO_PASS_THROUGH_PATH_EX, MPIO_PASS_THROUGH_PATH_EX, PMPIO_PASS_THROUGH_PATH_EX structure pointer [Storage Devices], MPIO_PASS_THROUGH_PATH_EX structure [Storage Devices], storage.mpio_pass_through_path_ex
