...
ms.date: 1/10/2018
ms.keywords: storage.changer_send_volume_tag_information, CHANGER_SEND_VOLUME_TAG_INFORMATION structure [Storage Devices], _CHANGER_SEND_VOLUME_TAG_INFORMATION, PCHANGER_SEND_VOLUME_TAG_INFORMATION structure pointer [Storage Devices], PCHANGER_SEND_VOLUME_TAG_INFORMATION, *PCHANGER_SEND_VOLUME_TAG_INFORMATION, structs-changer_3f8d7f13-bf38-41fe-aa74-bbd9083bbbb6.xml, CHANGER_SEND_VOLUME_TAG_INFORMATION, ntddchgr/PCHANGER_SEND_VOLUME_TAG_INFORMATION, ntddchgr/CHANGER_SEND_VOLUME_TAG_INFORMATION
