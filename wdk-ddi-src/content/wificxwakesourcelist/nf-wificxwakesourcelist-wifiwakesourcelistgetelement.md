...
tech.root: netvista
title: WifiWakeSourceListGetElement
ms.date: 04/30/2021
ms.topic: language-reference
targetos: Windows
description: "Microsoft reserves the WifiWakeSourceListGetElement function for internal use only. Don't use this function in your code."
req.assembly: 
