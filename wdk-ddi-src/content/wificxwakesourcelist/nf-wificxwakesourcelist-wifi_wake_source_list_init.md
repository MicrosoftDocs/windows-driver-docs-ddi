...
tech.root: netvista
title: WIFI_WAKE_SOURCE_LIST_INIT
ms.date: 04/30/2021
ms.topic: language-reference
targetos: Windows
description: "Microsoft reserves the WIFI_WAKE_SOURCE_LIST_INIT function for internal use only. Don't use this function in your code."
req.assembly: 
