...
ms.date: 2/20/2018
ms.keywords: IWDTFEnhancedDeviceTestSupportActions2 interface [Windows Device Testing Framework], IsEnabled method, dtf.iwdtfenhanceddevicetestsupportactions2_isenabled, IsEnabled method [Windows Device Testing Framework], IWDTFEnhancedDeviceTestSupportActions2 interface, IWDTFEnhancedDeviceTestSupportActions2, IsEnabled, IWDTFEnhancedDeviceTestSupportActions2::IsEnabled, wdtfedtaction/IWDTFEnhancedDeviceTestSupportActions2::IsEnabled, IsEnabled method [Windows Device Testing Framework]
