...
Indicates the type of pool memory to allocate. See <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/ne-wdm-_pool_type">POOL_TYPE</a> for a list of types.
