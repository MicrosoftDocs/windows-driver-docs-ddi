...
ms.date: 2/22/2018
ms.keywords: SRB_UNKNOWN_DEVICE_COMMAND, strmini/SRB_OPEN_STREAM, SRB_GET_STREAM_STATE, strmini/SRB_PROPOSE_DATA_FORMAT, strmini/SRB_DEVICE_METHOD, strmini/SRB_SET_STREAM_RATE, SRB_INITIALIZE_DEVICE, SRB_OPEN_DEVICE_INSTANCE, strmini/SRB_SURPRISE_REMOVAL, strmini/SRB_PAGING_OUT_DRIVER, strmini/SRB_OPEN_DEVICE_INSTANCE, strmini/SRB_STREAM_METHOD, SRB_GET_STREAM_PROPERTY, strmini/SRB_GET_DATA_INTERSECTION, SRB_SET_DEVICE_PROPERTY, SRB_SET_STREAM_STATE, strmini/SRB_WRITE_DATA, strmini/SRB_BEGIN_FLUSH, SRB_OPEN_STREAM, strmini/SRB_INITIALIZE_DEVICE, strmini/SRB_CHANGE_POWER_STATE, SRB_BEGIN_FLUSH, SRB_NOTIFY_IDLE_STATE, strmini/SRB_INITIALIZATION_COMPLETE, SRB_CLOSE_MASTER_CLOCK, SRB_COMMAND enumeration [Streaming Media Devices], strmini/SRB_GET_DATA_FORMAT, strmini/SRB_INDICATE_MASTER_CLOCK, SRB_PAGING_OUT_DRIVER, SRB_SET_STREAM_RATE, strmini/SRB_CLOSE_DEVICE_INSTANCE, SRB_CLOSE_STREAM, strmini/SRB_END_FLUSH, SRB_INITIALIZATION_COMPLETE, strmini/SRB_GET_STREAM_STATE, SRB_DEVICE_METHOD, strmini/SRB_READ_DATA, SRB_OPEN_MASTER_CLOCK, strmini/SRB_CLOSE_MASTER_CLOCK, strmini/SRB_UNINITIALIZE_DEVICE, strmini/SRB_NOTIFY_IDLE_STATE, strmini/SRB_SET_DATA_FORMAT, strmini/SRB_GET_DEVICE_PROPERTY, SRB_COMMAND, SRB_WRITE_DATA, SRB_END_FLUSH, strmini/SRB_SET_DEVICE_PROPERTY, strmini/SRB_COMMAND, stream.srb_command, strmini/SRB_UNKNOWN_STREAM_COMMAND, SRB_UNKNOWN_STREAM_COMMAND, _SRB_COMMAND, strmini/SRB_GET_STREAM_INFO, SRB_CLOSE_DEVICE_INSTANCE, SRB_PROPOSE_DATA_FORMAT, SRB_UNINITIALIZE_DEVICE, strmini/SRB_OPEN_MASTER_CLOCK, strmini/SRB_SET_STREAM_PROPERTY, SRB_SET_STREAM_PROPERTY, SRB_INDICATE_MASTER_CLOCK, SRB_PROPOSE_STREAM_RATE, strmini/SRB_PROPOSE_STREAM_RATE, SRB_SET_DATA_FORMAT, SRB_GET_DATA_FORMAT, strmini/SRB_UNKNOWN_DEVICE_COMMAND, SRB_SURPRISE_REMOVAL, strmini/SRB_CLOSE_STREAM, SRB_STREAM_METHOD, SRB_GET_STREAM_INFO, SRB_GET_DEVICE_PROPERTY, SRB_GET_DATA_INTERSECTION, strmini/SRB_SET_STREAM_STATE, strmini/SRB_GET_STREAM_PROPERTY, SRB_CHANGE_POWER_STATE, SRB_READ_DATA
