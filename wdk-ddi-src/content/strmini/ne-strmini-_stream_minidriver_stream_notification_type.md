...
ms.date: 2/22/2018
ms.keywords: DeleteStreamEvent, PSTREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE enumeration pointer [Streaming Media Devices], STREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE enumeration [Streaming Media Devices], StreamRequestComplete, strmini/SignalMultipleStreamEvents, strmini/SignalStreamEvent, strmini/PSTREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE, HardwareStarved, strmini/HardwareStarved, StreamNotificationMaximum, ReadyForNextStreamControlRequest, strmini/StreamNotificationMaximum, strmini/StreamRequestComplete, STREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE, strmini/ReadyForNextStreamControlRequest, strmini/STREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE, _STREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE, ReadyForNextStreamDataRequest, SignalMultipleStreamEvents, strmini/DeleteStreamEvent, strmini/ReadyForNextStreamDataRequest, stream.stream_minidriver_stream_notification_type, SignalStreamEvent, *PSTREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE, PSTREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE
