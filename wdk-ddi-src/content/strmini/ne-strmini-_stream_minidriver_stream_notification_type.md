...
ms.date: 1/9/2018
ms.keywords: strmini/ReadyForNextStreamControlRequest, StreamNotificationMaximum, strmini/STREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE, ReadyForNextStreamDataRequest, PSTREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE enumeration pointer [Streaming Media Devices], STREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE, SignalMultipleStreamEvents, *PSTREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE, HardwareStarved, ReadyForNextStreamControlRequest, strmini/SignalStreamEvent, strmini/StreamRequestComplete, DeleteStreamEvent, strmini/ReadyForNextStreamDataRequest, STREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE enumeration [Streaming Media Devices], strmini/HardwareStarved, PSTREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE, _STREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE, StreamRequestComplete, SignalStreamEvent, strmini/SignalMultipleStreamEvents, strmini/DeleteStreamEvent, strmini/PSTREAM_MINIDRIVER_STREAM_NOTIFICATION_TYPE, strmini/StreamNotificationMaximum, stream.stream_minidriver_stream_notification_type
