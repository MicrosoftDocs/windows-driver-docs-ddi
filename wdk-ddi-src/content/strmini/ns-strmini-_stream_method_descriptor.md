...
ms.date: 2/22/2018
ms.keywords: PSTREAM_METHOD_DESCRIPTOR, *PSTREAM_METHOD_DESCRIPTOR, PSTREAM_METHOD_DESCRIPTOR structure pointer [Streaming Media Devices], STREAM_METHOD_DESCRIPTOR, STREAM_METHOD_DESCRIPTOR structure [Streaming Media Devices], strmini/PSTREAM_METHOD_DESCRIPTOR, strmini/STREAM_METHOD_DESCRIPTOR, stream.stream_method_descriptor, _STREAM_METHOD_DESCRIPTOR
