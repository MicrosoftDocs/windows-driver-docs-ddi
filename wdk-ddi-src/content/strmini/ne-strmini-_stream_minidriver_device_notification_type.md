...
ms.date: 2/22/2018
ms.keywords: PSTREAM_MINIDRIVER_DEVICE_NOTIFICATION_TYPE, DeleteDeviceEvent, ReadyForNextDeviceRequest, strmini/DeviceRequestComplete, strmini/DeleteDeviceEvent, *PSTREAM_MINIDRIVER_DEVICE_NOTIFICATION_TYPE, strmini/SignalMultipleDeviceEvents, strmini/SignalMultipleDeviceInstanceEvents, strmini/PSTREAM_MINIDRIVER_DEVICE_NOTIFICATION_TYPE, STREAM_MINIDRIVER_DEVICE_NOTIFICATION_TYPE, SignalMultipleDeviceInstanceEvents, DeviceRequestComplete, stream.stream_minidriver_device_notification_type, _STREAM_MINIDRIVER_DEVICE_NOTIFICATION_TYPE, STREAM_MINIDRIVER_DEVICE_NOTIFICATION_TYPE enumeration [Streaming Media Devices], strmini/ReadyForNextDeviceRequest, SignalMultipleDeviceEvents, strmini/SignalDeviceEvent, strmini/DeviceNotificationMaximum, strmini/STREAM_MINIDRIVER_DEVICE_NOTIFICATION_TYPE, PSTREAM_MINIDRIVER_DEVICE_NOTIFICATION_TYPE enumeration pointer [Streaming Media Devices], DeviceNotificationMaximum, SignalDeviceEvent
