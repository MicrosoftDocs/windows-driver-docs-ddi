...
ms.date: 1/9/2018
ms.keywords: strmini/HW_EVENT_DESCRIPTOR, *PHW_EVENT_DESCRIPTOR, _HW_EVENT_DESCRIPTOR, HW_EVENT_DESCRIPTOR, PHW_EVENT_DESCRIPTOR, HW_EVENT_DESCRIPTOR structure [Streaming Media Devices], stream.hw_event_descriptor, PHW_EVENT_DESCRIPTOR structure pointer [Streaming Media Devices], strmini/PHW_EVENT_DESCRIPTOR, strclass-struct_ca0c15b2-17d1-4114-9765-5638dd81ca24.xml
