...
ms.date: 09/30/2018
keywords: ["UCMUCSI_PPM_GET_UCSI_DATA_BLOCK_IN_PARAMS structure"]
...
f1_keywords:
 ...
 - ucmucsippmrequests/PUCMUCSI_PPM_GET_UCSI_DATA_BLOCK_IN_PARAMS
 - UCMUCSI_PPM_GET_UCSI_DATA_BLOCK_IN_PARAMS
 - ucmucsippmrequests/UCMUCSI_PPM_GET_UCSI_DATA_BLOCK_IN_PARAMS
topic_type:
 - apiref
api_type:
 - HeaderDef
...
# UCMUCSI_PPM_GET_UCSI_DATA_BLOCK_IN_PARAMS structure (ucmucsippmrequests.h)
