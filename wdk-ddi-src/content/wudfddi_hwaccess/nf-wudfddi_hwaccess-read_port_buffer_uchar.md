...
ms.date: 2/20/2018
ms.keywords: ",  , A, B, C, D, E, F, H, O, P, R, READ_PORT_BUFFER_UCHAR, READ_PORT_BUFFER_UCHAR function, T, U, _, umdf.read_port_buffer_uchar, wdf.read_port_buffer_uchar, wudfddi_hwaccess/READ_PORT_BUFFER_UCHAR"
