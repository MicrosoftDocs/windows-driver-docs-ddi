...
description: The READ_REGISTER_BUFFER_ULONG64 function (wudfddi_hwaccess.h) reads a number of ULONG64 values from the specified register address into a buffer.
