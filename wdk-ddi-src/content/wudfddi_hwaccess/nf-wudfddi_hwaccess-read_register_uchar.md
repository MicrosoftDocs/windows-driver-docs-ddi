...
ms.date: 2/20/2018
ms.keywords: ",  , A, C, D, E, G, H, I, R, READ_REGISTER_UCHAR, READ_REGISTER_UCHAR function, S, T, U, _, umdf.read_register_uchar, wdf.read_register_uchar, wudfddi_hwaccess/READ_REGISTER_UCHAR"
