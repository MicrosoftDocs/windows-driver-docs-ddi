...
description: The READ_REGISTER_ULONG64 function (wudfddi_hwaccess.h) reads a ULONG64 value from the specified register address.
...
f1_keywords:
 ...
 - wudfddi_hwaccess/READ_REGISTER_ULONG64
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# READ_REGISTER_ULONG64 function (wudfddi_hwaccess.h)
