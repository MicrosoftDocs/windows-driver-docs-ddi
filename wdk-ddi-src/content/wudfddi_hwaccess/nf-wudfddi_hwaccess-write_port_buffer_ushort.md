...
ms.date: 2/20/2018
ms.keywords: ",  , B, E, F, H, I, O, P, R, S, T, U, W, WRITE_PORT_BUFFER_USHORT, WRITE_PORT_BUFFER_USHORT function, _, umdf.write_port_buffer_ushort, wdf.write_port_buffer_ushort, wudfddi_hwaccess/WRITE_PORT_BUFFER_USHORT"
