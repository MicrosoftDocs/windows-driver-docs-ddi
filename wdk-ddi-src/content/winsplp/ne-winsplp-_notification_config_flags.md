...
ms.date: 1/18/2018
ms.keywords: NOTIFICATION_CONFIG_ASYNC_CHANNEL, winsplp/NOTIFICATION_CONFIG_EVENT_TRIGGER, winsplp/NOTIFICATION_CONFIG_FLAGS, NOTIFICATION_CONFIG_REGISTER_CALLBACK, winsplp/NOTIFICATION_CONFIG_ASYNC_CHANNEL, NOTIFICATION_CONFIG_EVENT_TRIGGER, _NOTIFICATION_CONFIG_FLAGS, NOTIFICATION_CONFIG_FLAGS, winsplp/NOTIFICATION_CONFIG_REGISTER_CALLBACK, print.notification_config_flags, NOTIFICATION_CONFIG_FLAGS enumeration [Print Devices], winsplp/NOTIFICATION_CONFIG_CREATE_EVENT, NOTIFICATION_CONFIG_CREATE_EVENT
