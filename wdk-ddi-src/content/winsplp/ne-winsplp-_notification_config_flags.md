...
ms.date: 2/2/2018
ms.keywords: winsplp/NOTIFICATION_CONFIG_REGISTER_CALLBACK, NOTIFICATION_CONFIG_REGISTER_CALLBACK, NOTIFICATION_CONFIG_FLAGS, NOTIFICATION_CONFIG_ASYNC_CHANNEL, _NOTIFICATION_CONFIG_FLAGS, NOTIFICATION_CONFIG_EVENT_TRIGGER, winsplp/NOTIFICATION_CONFIG_FLAGS, print.notification_config_flags, winsplp/NOTIFICATION_CONFIG_EVENT_TRIGGER, winsplp/NOTIFICATION_CONFIG_ASYNC_CHANNEL, NOTIFICATION_CONFIG_CREATE_EVENT, NOTIFICATION_CONFIG_FLAGS enumeration [Print Devices], winsplp/NOTIFICATION_CONFIG_CREATE_EVENT
