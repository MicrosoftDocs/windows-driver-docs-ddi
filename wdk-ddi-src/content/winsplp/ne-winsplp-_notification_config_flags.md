...
ms.date: 2/21/2018
ms.keywords: winsplp/NOTIFICATION_CONFIG_CREATE_EVENT, NOTIFICATION_CONFIG_FLAGS, NOTIFICATION_CONFIG_FLAGS enumeration [Print Devices], winsplp/NOTIFICATION_CONFIG_REGISTER_CALLBACK, winsplp/NOTIFICATION_CONFIG_EVENT_TRIGGER, NOTIFICATION_CONFIG_ASYNC_CHANNEL, winsplp/NOTIFICATION_CONFIG_ASYNC_CHANNEL, winsplp/NOTIFICATION_CONFIG_FLAGS, NOTIFICATION_CONFIG_REGISTER_CALLBACK, print.notification_config_flags, _NOTIFICATION_CONFIG_FLAGS, NOTIFICATION_CONFIG_CREATE_EVENT, NOTIFICATION_CONFIG_EVENT_TRIGGER
