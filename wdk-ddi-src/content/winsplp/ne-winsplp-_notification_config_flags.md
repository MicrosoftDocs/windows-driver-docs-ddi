...
ms.date: 2/22/2018
ms.keywords: winsplp/NOTIFICATION_CONFIG_EVENT_TRIGGER, NOTIFICATION_CONFIG_EVENT_TRIGGER, _NOTIFICATION_CONFIG_FLAGS, winsplp/NOTIFICATION_CONFIG_FLAGS, NOTIFICATION_CONFIG_FLAGS enumeration [Print Devices], winsplp/NOTIFICATION_CONFIG_CREATE_EVENT, NOTIFICATION_CONFIG_REGISTER_CALLBACK, NOTIFICATION_CONFIG_ASYNC_CHANNEL, print.notification_config_flags, NOTIFICATION_CONFIG_FLAGS, winsplp/NOTIFICATION_CONFIG_ASYNC_CHANNEL, winsplp/NOTIFICATION_CONFIG_REGISTER_CALLBACK, NOTIFICATION_CONFIG_CREATE_EVENT
