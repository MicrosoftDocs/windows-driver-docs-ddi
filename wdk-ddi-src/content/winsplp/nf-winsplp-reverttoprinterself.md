...
If <code>RevertToPrinterSelf</code> returns a non-<b>NULL</b> value, <a href="/windows-hardware/drivers/ddi/winsplp/nf-winsplp-impersonateprinterclient">ImpersonatePrinterClient</a> must be called with the return value to complete the operation and clean up the thread handle.

## -see-also

<a href="/windows-hardware/drivers/ddi/winsplp/nf-winsplp-impersonateprinterclient">ImpersonatePrinterClient</a>