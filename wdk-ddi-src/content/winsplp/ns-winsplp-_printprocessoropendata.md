...
ms.date: 2/2/2018
ms.keywords: "*LPPRINTPROCESSOROPENDATA, PRINTPROCESSOROPENDATA structure [Print Devices], PPRINTPROCESSOROPENDATA structure pointer [Print Devices], LPPRINTPROCESSOROPENDATA structure pointer [Print Devices], print.printprocessoropendata, spoolfnc_d24c3eae-da3e-473a-bd25-5ec09d23fe89.xml, winsplp/PPRINTPROCESSOROPENDATA, PPRINTPROCESSOROPENDATA, LPPRINTPROCESSOROPENDATA, winsplp/PRINTPROCESSOROPENDATA, *PPRINTPROCESSOROPENDATA, winsplp/LPPRINTPROCESSOROPENDATA, PRINTPROCESSOROPENDATA, _PRINTPROCESSOROPENDATA"
