...
ms.date: 2/2/2018
ms.keywords: PNOTIFICATION_CONFIG_1, print.notification_config_1, *PNOTIFICATION_CONFIG_1, NOTIFICATION_CONFIG_1, NOTIFICATION_CONFIG_1 structure [Print Devices], _NOTIFICATION_CONFIG_1, winsplp/NOTIFICATION_CONFIG_1, PNOTIFICATION_CONFIG_1 structure pointer [Print Devices], winsplp/PNOTIFICATION_CONFIG_1
