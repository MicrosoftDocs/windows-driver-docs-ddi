...
ms.date: 2/15/2018
ms.keywords: spbcx/SPB_TRANSFER_DESCRIPTOR_INIT, SPB_TRANSFER_DESCRIPTOR_INIT function [Buses], SPB.spb_transfer_descriptor_init, SPB_TRANSFER_DESCRIPTOR_INIT
