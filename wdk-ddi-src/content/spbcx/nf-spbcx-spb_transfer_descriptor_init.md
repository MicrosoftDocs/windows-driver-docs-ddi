...
ms.date: 2/15/2018
ms.keywords: ",  , A, B, C, D, E, F, I, N, O, P, R, S, SPB.spb_transfer_descriptor_init, SPB_TRANSFER_DESCRIPTOR_INIT, SPB_TRANSFER_DESCRIPTOR_INIT function [Buses], T, _, spbcx/SPB_TRANSFER_DESCRIPTOR_INIT"
