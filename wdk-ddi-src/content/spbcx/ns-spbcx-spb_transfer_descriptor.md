...
f1_keywords:
 ...
 - spbcx/PSPB_TRANSFER_DESCRIPTOR
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The <b>SPB_TRANSFER_DESCRIPTOR</b> structure describes a single transfer in an <a href="/windows-hardware/drivers/spb/i-o-transfer-sequences">I/O transfer sequence</a>.
...
This structure is used by the <a href="/windows-hardware/drivers/ddi/spbcx/nf-spbcx-spbrequestgettransferparameters">SpbRequestGetTransferParameters</a> method. Before passing an <b>SPB_TRANSFER_DESCRIPTOR</b> structure to this method, initialize the structure by calling the <a href="/windows-hardware/drivers/ddi/spbcx/nf-spbcx-spb_transfer_descriptor_init">SPB_TRANSFER_DESCRIPTOR_INIT</a> function.
