...
ms.date: 2/15/2018
ms.keywords: spbcx/PSPB_CONTROLLER_CONFIG, _SPB_CONTROLLER_CONFIG, *PSPB_CONTROLLER_CONFIG, SPB_CONTROLLER_CONFIG structure [Buses], PSPB_CONTROLLER_CONFIG structure pointer [Buses], spbcx/SPB_CONTROLLER_CONFIG, SPB.spb_controller_config, SPB_CONTROLLER_CONFIG, PSPB_CONTROLLER_CONFIG
