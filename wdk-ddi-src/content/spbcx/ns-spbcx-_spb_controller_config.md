...
ms.date: 12/14/2017
ms.keywords: SPB_CONTROLLER_CONFIG, PSPB_CONTROLLER_CONFIG, _SPB_CONTROLLER_CONFIG, spbcx/PSPB_CONTROLLER_CONFIG, SPB_CONTROLLER_CONFIG structure [Buses], PSPB_CONTROLLER_CONFIG structure pointer [Buses], *PSPB_CONTROLLER_CONFIG, SPB.spb_controller_config, spbcx/SPB_CONTROLLER_CONFIG
