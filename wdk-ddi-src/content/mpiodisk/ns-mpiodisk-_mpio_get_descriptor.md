...
ms.date: 2/16/2018
ms.keywords: MPIO_GET_DESCRIPTOR structure [Storage Devices], MPIO_GET_DESCRIPTOR, _MPIO_GET_DESCRIPTOR, mpiodisk/PMPIO_GET_DESCRIPTOR, PMPIO_GET_DESCRIPTOR, PMPIO_GET_DESCRIPTOR structure pointer [Storage Devices], mpiodisk/MPIO_GET_DESCRIPTOR, *PMPIO_GET_DESCRIPTOR, structs-scsibus_4d648295-24f6-44c1-a0a9-8a46aeada604.xml, storage.mpio_get_descriptor
