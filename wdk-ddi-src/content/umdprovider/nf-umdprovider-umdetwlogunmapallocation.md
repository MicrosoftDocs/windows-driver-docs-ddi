...
ms.date: 12/29/2017
ms.keywords: display.umdetwlogunmapallocation, UMDEtwLogUnmapAllocation, UMDEtwLogUnmapAllocation function [Display Devices], umdprovider/UMDEtwLogUnmapAllocation
