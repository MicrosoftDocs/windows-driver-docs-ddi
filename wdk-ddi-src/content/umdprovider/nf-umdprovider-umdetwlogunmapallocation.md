...
ms.date: 12/29/2017
ms.keywords: UMDEtwLogUnmapAllocation, umdprovider/UMDEtwLogUnmapAllocation, UMDEtwLogUnmapAllocation function [Display Devices], display.umdetwlogunmapallocation
