...
description: The bus driver passes NOTIFICATION_INFO_W2K to pass information to the driver-provided notification routine for a driver-allocated address range in the computer's IEEE 1394 address space.
