...
ms.date: 12/14/2017
ms.keywords: IRB_REQ_GET_SPEED_TOPOLOGY_MAPS structure [Buses], IRB_REQ_GET_SPEED_TOPOLOGY_MAPS, IEEE.irb_req_get_speed_topology_maps, _IRB_REQ_GET_SPEED_TOPOLOGY_MAPS, 1394/IRB_REQ_GET_SPEED_TOPOLOGY_MAPS
