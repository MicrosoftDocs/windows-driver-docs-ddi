...
ms.date: 2/15/2018
ms.keywords: IRB_REQ_GET_CONFIG_ROM, _IRB_REQ_GET_CONFIG_ROM, IEEE.irb_req_get_config_rom, IRB_REQ_GET_CONFIG_ROM structure [Buses], 1394/IRB_REQ_GET_CONFIG_ROM
