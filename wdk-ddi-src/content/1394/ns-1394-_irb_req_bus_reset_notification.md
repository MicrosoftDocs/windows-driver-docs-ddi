...
ms.date: 12/14/2017
ms.keywords: IEEE.irb_req_bus_reset_notification, 1394/IRB_REQ_BUS_RESET_NOTIFICATION, IRB_REQ_BUS_RESET_NOTIFICATION, IRB_REQ_BUS_RESET_NOTIFICATION structure [Buses], _IRB_REQ_BUS_RESET_NOTIFICATION
