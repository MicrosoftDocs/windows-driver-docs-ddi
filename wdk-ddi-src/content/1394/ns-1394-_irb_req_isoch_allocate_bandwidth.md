...
ms.date: 12/14/2017
ms.keywords: IEEE.irb_req_isoch_allocate_bandwidth, IRB_REQ_ISOCH_ALLOCATE_BANDWIDTH, _IRB_REQ_ISOCH_ALLOCATE_BANDWIDTH, 1394/IRB_REQ_ISOCH_ALLOCATE_BANDWIDTH, IRB_REQ_ISOCH_ALLOCATE_BANDWIDTH structure [Buses]
