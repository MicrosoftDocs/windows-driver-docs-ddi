...
ms.date: 12/14/2017
ms.keywords: IRB_REQ_ISOCH_QUERY_RESOURCES, IRB_REQ_ISOCH_QUERY_RESOURCES structure [Buses], _IRB_REQ_ISOCH_QUERY_RESOURCES, IEEE.irb_req_isoch_query_resources, 1394/IRB_REQ_ISOCH_QUERY_RESOURCES
