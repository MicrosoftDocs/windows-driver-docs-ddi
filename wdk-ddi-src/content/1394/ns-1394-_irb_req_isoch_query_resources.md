...
ms.date: 12/14/2017
ms.keywords: IRB_REQ_ISOCH_QUERY_RESOURCES structure [Buses], IRB_REQ_ISOCH_QUERY_RESOURCES, _IRB_REQ_ISOCH_QUERY_RESOURCES, 1394/IRB_REQ_ISOCH_QUERY_RESOURCES, IEEE.irb_req_isoch_query_resources
