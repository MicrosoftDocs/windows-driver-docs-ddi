...
ms.date: 2/15/2018
ms.keywords: ",  , *, *PBBRT_TABLE, ,, A, B, BBRT_TABLE, BBRT_TABLE structure [ACPI Devices], E, L, P, PBBRT_TABLE, PBBRT_TABLE structure pointer [ACPI Devices], R, T, _, _BBRT_TABLE, acpi.bbrt_table, acpitabl/BBRT_TABLE, acpitabl/PBBRT_TABLE"
