...
ms.date: 2/15/2018
ms.keywords: PBBRT_TABLE, acpitabl/BBRT_TABLE, BBRT_TABLE structure [ACPI Devices], BBRT_TABLE, _BBRT_TABLE, *PBBRT_TABLE, acpitabl/PBBRT_TABLE, acpi.bbrt_table, PBBRT_TABLE structure pointer [ACPI Devices]
