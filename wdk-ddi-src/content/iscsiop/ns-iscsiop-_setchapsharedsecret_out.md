...
ms.date: 1/10/2018
ms.keywords: structs-iSCSI_f11f03d2-424a-4537-9cbd-f4fd3ca0e59d.xml, PSetCHAPSharedSecret_OUT structure pointer [Storage Devices], _SetCHAPSharedSecret_OUT, iscsiop/PSetCHAPSharedSecret_OUT, iscsiop/SetCHAPSharedSecret_OUT, storage.setchapsharedsecret_out, SetCHAPSharedSecret_OUT structure [Storage Devices], *PSetCHAPSharedSecret_OUT, PSetCHAPSharedSecret_OUT, SetCHAPSharedSecret_OUT
