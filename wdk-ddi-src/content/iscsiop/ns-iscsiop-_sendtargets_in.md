...
ms.date: 1/10/2018
ms.keywords: "*PSendTargets_IN, SendTargets_IN structure [Storage Devices], _SendTargets_IN, PSendTargets_IN, iscsiop/SendTargets_IN, PSendTargets_IN structure pointer [Storage Devices], iscsiop/PSendTargets_IN, SendTargets_IN, structs-iSCSI_448fb50f-6420-43ca-be0e-b3dd110cd48b.xml, storage.sendtargets_in"
