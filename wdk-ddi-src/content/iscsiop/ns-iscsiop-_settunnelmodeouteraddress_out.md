...
The SetTunnelModeOuterAddress_OUT structure holds the output data for the <a href="/windows-hardware/drivers/storage/settunnelmodeouteraddress">SetTunnelModeOuterAddress</a> method.

## -struct-fields

### -field Status

On output, the status of the <b>SetTunnelModeOuterAddress</b> operation. For a list of status qualifiers, see <a href="/windows-hardware/drivers/storage/iscsi-status-qualifiers">ISCSI_STATUS_QUALIFIERS</a>.
...
<a href="/windows-hardware/drivers/ddi/iscsiop/ns-iscsiop-_settunnelmodeouteraddress_in">SetTunnelModeOuterAddress_IN</a>
