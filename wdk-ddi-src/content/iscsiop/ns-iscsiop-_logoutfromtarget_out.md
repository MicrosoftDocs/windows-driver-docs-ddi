...
# LogoutFromTarget_OUT structure (iscsiop.h)
...
The LogoutFromTarget_OUT structure holds the output data for the <a href="/windows-hardware/drivers/storage/logoutfromtarget">LogoutFromTarget</a> method.

## -struct-fields

### -field Status

On output from <b>LogoutFromTarget</b>, the status of the logoff operation. For a list of status qualifiers, see <a href="/windows-hardware/drivers/storage/iscsi-status-qualifiers">ISCSI_STATUS_QUALIFIERS</a>.
...
<a href="/windows-hardware/drivers/storage/logoutfromtarget">LogoutFromTarget</a>



<a href="/windows-hardware/drivers/ddi/iscsiop/ns-iscsiop-_logoutfromtarget_in">LogoutFromTarget_IN</a>
