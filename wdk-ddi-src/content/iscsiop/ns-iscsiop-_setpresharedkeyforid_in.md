...
tech.root: storage
ms.date: 03/29/2018
keywords: ["SetPresharedKeyForId_IN structure"]
...
f1_keywords:
 ...
 - iscsiop/_SetPresharedKeyForId_IN
 - PSetPresharedKeyForId_IN
 - iscsiop/PSetPresharedKeyForId_IN
...
The SetPresharedKeyForId_IN structure holds the input data for the <a href="/windows-hardware/drivers/storage/setpresharedkeyforid">SetPresharedKeyForId</a> method.
