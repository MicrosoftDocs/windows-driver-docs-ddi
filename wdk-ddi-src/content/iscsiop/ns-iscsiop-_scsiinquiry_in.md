...
The ScsiInquiry_IN structure holds the input data for the <a href="https://docs.microsoft.com/windows-hardware/drivers/storage/scsiinquiry">ScsiInquiry</a> method, which is used to send a SCSI inquiry command.
...
<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/iscsiop/ns-iscsiop-_scsiinquiry_out">ScsiInquiry_OUT</a>
 
