...
# DeleteInitiatorNodeName_IN structure (iscsiop.h)
...
The DeleteInitiatorNodeName_IN structure holds the input data for the <a href="/windows-hardware/drivers/storage/deleteinitiatornodename">DeleteInitiatorNodeName</a> method, which is used to delete an initiator node name.
