...
ms.date: 03/29/2018
keywords: ["MSiSCSI_TargetMappings structure"]
...
f1_keywords:
 ...
 - iscsiop/_MSiSCSI_TargetMappings
 - PMSiSCSI_TargetMappings
 - iscsiop/PMSiSCSI_TargetMappings
 - MSiSCSI_TargetMappings
...
A variable-length array of <a href="/windows-hardware/drivers/ddi/iscsidef/ns-iscsidef-_iscsi_targetmapping">ISCSI_TargetMapping</a> structures, each of which provides a list of LUN mappings that are associated with a particular iSCSI session that is associated with the adapter ID.
