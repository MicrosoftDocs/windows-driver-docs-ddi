...
ms.date: 12/14/2017
ms.keywords: PCIP_CANCEL_FRAME structure pointer [Buses], *PCIP_CANCEL_FRAME, _CIP_CANCEL_FRAME, CIP_CANCEL_FRAME, 61883/CIP_CANCEL_FRAME, 61883/PCIP_CANCEL_FRAME, CIP_CANCEL_FRAME structure [Buses], PCIP_CANCEL_FRAME, IEEE.cip_cancel_frame
