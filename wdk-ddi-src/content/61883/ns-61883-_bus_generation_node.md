...
tech.root: IEEE
ms.date: 02/15/2018
keywords: ["BUS_GENERATION_NODE structure"]
...
f1_keywords:
 ...
 - 61883/_BUS_GENERATION_NODE
 - PBUS_GENERATION_NODE
 - 61883/PBUS_GENERATION_NODE
 - BUS_GENERATION_NODE
...
The BUS_GENERATION_NODE structure is used in conjunction with the <a href="/previous-versions/ff536983(v=vs.85)">Av61883_GetUnitInfo</a> request to retrieve bus characteristics.
