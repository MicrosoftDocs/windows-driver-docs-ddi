...
ms.date: 2/15/2018
ms.keywords: UNIT_ISOCH_PARAMS structure [Buses], UNIT_ISOCH_PARAMS, *PUNIT_ISOCH_PARAMS, _UNIT_ISOCH_PARAMS, IEEE.unit_isoch_params, PUNIT_ISOCH_PARAMS, 61883/PUNIT_ISOCH_PARAMS, 61883_structures_eece3eb1-516b-40a8-9529-e4a3d8832f02.xml, PUNIT_ISOCH_PARAMS structure pointer [Buses], 61883/UNIT_ISOCH_PARAMS
