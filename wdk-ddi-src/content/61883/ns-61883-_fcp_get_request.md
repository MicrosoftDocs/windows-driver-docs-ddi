...
f1_keywords:
 - _FCP_GET_REQUEST
 - 61883/_FCP_GET_REQUEST
 - PFCP_GET_REQUEST
 - 61883/PFCP_GET_REQUEST
 - FCP_GET_REQUEST
...
On input, a pointer to a caller-allocated <a href="/windows-hardware/drivers/ddi/61883/ns-61883-_fcp_frame">FCP_FRAME</a> structure to receive the FCP request. On output, the FCP frame written to the caller-allocated <b>FCP_FRAME</b> structure by the protocol driver.
