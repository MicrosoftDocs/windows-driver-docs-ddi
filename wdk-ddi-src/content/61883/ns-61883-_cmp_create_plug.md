...
ms.date: 2/15/2018
ms.keywords: ",  , *, *PCMP_CREATE_PLUG, ,, 61883/CMP_CREATE_PLUG, 61883/PCMP_CREATE_PLUG, A, C, CMP_CREATE_PLUG, CMP_CREATE_PLUG structure [Buses], E, G, IEEE.cmp_create_plug, L, M, P, PCMP_CREATE_PLUG, PCMP_CREATE_PLUG structure pointer [Buses], R, T, U, _, _CMP_CREATE_PLUG"
