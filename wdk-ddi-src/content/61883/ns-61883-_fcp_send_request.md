...
On input, a pointer to an <a href="/windows-hardware/drivers/ddi/61883/ns-61883-_fcp_frame">FCP_FRAME</a> structure that contains the FCP request to send to the device.
