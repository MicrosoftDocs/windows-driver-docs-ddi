...
The <b>RtlUnicodeStringCbCopyNEx</b> function copies a string from one <a href="/windows/win32/api/ntdef/ns-ntdef-_unicode_string">UNICODE_STRING</a> structure to another while limiting the size of the copied string.
...
<b>RtlUnicodeStringCbCopyNEx</b> adds to the functionality of the <a href="/windows-hardware/drivers/ddi/ntstrsafe/nf-ntstrsafe-rtlunicodestringcbcopyn">RtlUnicodeStringCbCopyN</a> function by returning a <a href="/windows/win32/api/ntdef/ns-ntdef-_unicode_string">UNICODE_STRING</a> structure that identifies the end of the destination string and the number of bytes that are left unused in that string. You can pass flags to <b>RtlUnicodeStringCbCopyNEx</b> for additional control.
...
<a href="/windows-hardware/drivers/ddi/ntstrsafe/nf-ntstrsafe-rtlunicodestringcbcopyn">RtlUnicodeStringCbCopyN</a>
