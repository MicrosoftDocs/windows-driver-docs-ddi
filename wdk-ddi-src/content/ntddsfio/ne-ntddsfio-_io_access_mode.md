...
ms.date: 2/16/2018
ms.keywords: kernel.io_access_mode, IO_ACCESS_MODE, SequentialAccess, RandomAccess, wdm/RandomAccess, wdm/SequentialAccess, IO_ACCESS_MODE enumeration [Kernel-Mode Driver Architecture], wdm/IO_ACCESS_MODE, _IO_ACCESS_MODE
