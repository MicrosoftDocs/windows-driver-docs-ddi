...
# WDF_IO_QUEUE_READY function (wdfio.h)
...
Your driver can call <b>WDF_IO_QUEUE_READY</b> after it has called <a href="/windows-hardware/drivers/ddi/wdfio/nf-wdfio-wdfioqueuegetstate">WdfIoQueueGetState</a>.
