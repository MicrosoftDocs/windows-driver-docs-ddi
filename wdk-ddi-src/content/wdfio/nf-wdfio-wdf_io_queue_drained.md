...
Your driver can call <b>WDF_IO_QUEUE_DRAINED</b> after it has called <a href="/windows-hardware/drivers/ddi/wdfio/nf-wdfio-wdfioqueuegetstate">WdfIoQueueGetState</a>.
