...
ms.date: 1/18/2018
ms.keywords: NDIS_PD_QUEUE_PARAMETERS, NDIS_PD_QUEUE_PARAMETERS structure [Network Drivers Starting with Windows Vista], _NDIS_PD_QUEUE_PARAMETERS, netvista.ndis_pd_queue_parameters, ndis/NDIS_PD_QUEUE_PARAMETERS
