...
Pass the buffer on to the next underlying driver by calling the 
      <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfsendnetbufferlists">NdisFSendNetBufferLists</a> function. The filter driver can modify the buffer contents before calling      
...
Reject the buffer by calling the 
      <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfsendnetbufferlistscomplete">NdisFSendNetBufferListsComplete</a> function.
