...
# NdisAcquireSpinLock function (ndis.h)
...
After acquiring a spin lock with 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisreleasespinlock">NdisReleaseSpinLock</a>. A driver must
    call 
...
A spin lock acquired with 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisdpracquirespinlock">NdisDprAcquireSpinLock</a> must be
    released with 
