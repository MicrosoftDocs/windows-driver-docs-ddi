...
ms.date: 2/16/2018
ms.keywords: NDIS_PD_FILTER_PARAMETERS structure [Network Drivers Starting with Windows Vista], _NDIS_PD_FILTER_PARAMETERS, ndis/NDIS_PD_FILTER_PARAMETERS, NDIS_PD_FILTER_PARAMETERS, netvista.ndis_pd_filter_parameters
