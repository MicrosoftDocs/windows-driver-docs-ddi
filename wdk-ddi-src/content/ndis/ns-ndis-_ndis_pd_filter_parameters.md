...
ms.date: 1/18/2018
ms.keywords: netvista.ndis_pd_filter_parameters, NDIS_PD_FILTER_PARAMETERS structure [Network Drivers Starting with Windows Vista], ndis/NDIS_PD_FILTER_PARAMETERS, NDIS_PD_FILTER_PARAMETERS, _NDIS_PD_FILTER_PARAMETERS
