...
The 
  ...
  with 
  <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisclderegistersap">NdisClDeregisterSap</a>. Otherwise, such a
...
NDIS had marked the state of the AF as "closing," so the associated SAP represented by the 
       ...
       <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisclderegistersap">
...
A call to 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisclderegistersap">NdisClDeregisterSap</a> has been processed
    by the call manager.
