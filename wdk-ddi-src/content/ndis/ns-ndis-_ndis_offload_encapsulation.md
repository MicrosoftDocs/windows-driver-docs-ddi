...
ms.date: 1/18/2018
ms.keywords: tcpip_offload_ref_d3154816-5813-4616-b17f-b76362d9a58f.xml, NDIS_OFFLOAD_ENCAPSULATION, *PNDIS_OFFLOAD_ENCAPSULATION, NDIS_ENCAPSULATION_IEEE_LLC_SNAP_ROUTED, NDIS_OFFLOAD_ENCAPSULATION structure [Network Drivers Starting with Windows Vista], ndis/NDIS_OFFLOAD_ENCAPSULATION, NDIS_ENCAPSULATION_IEEE_802_3, PNDIS_OFFLOAD_ENCAPSULATION structure pointer [Network Drivers Starting with Windows Vista], PNDIS_OFFLOAD_ENCAPSULATION, netvista.ndis_offload_encapsulation, ndis/PNDIS_OFFLOAD_ENCAPSULATION, _NDIS_OFFLOAD_ENCAPSULATION
