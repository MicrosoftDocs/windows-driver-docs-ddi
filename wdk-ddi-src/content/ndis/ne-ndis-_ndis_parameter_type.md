...
ms.date: 2/16/2018
ms.keywords: PNDIS_PARAMETER_TYPE, NdisParameterInteger, NdisParameterHexInteger, NdisParameterBinary, ndis/NdisParameterHexInteger, ndis/PNDIS_PARAMETER_TYPE, NdisParameterString, ndis/NdisParameterBinary, _NDIS_PARAMETER_TYPE, *PNDIS_PARAMETER_TYPE, netvista.ndis_parameter_type, NDIS_PARAMETER_TYPE, ndis/NdisParameterString, ndis/NdisParameterMultiString, PNDIS_PARAMETER_TYPE enumeration pointer [Network Drivers Starting with Windows Vista], ndis_configuration_ref_05a453df-2660-470b-8eaf-7a59dcb20e04.xml, ndis/NDIS_PARAMETER_TYPE, ndis/NdisParameterInteger, NDIS_PARAMETER_TYPE enumeration [Network Drivers Starting with Windows Vista], NdisParameterMultiString
