...
ms.date: 1/18/2018
ms.keywords: ndis/NdisMWriteConfigBlock, netvista.ndismwriteconfigblock, NdisMWriteConfigBlock function [Network Drivers Starting with Windows Vista], NdisMWriteConfigBlock
