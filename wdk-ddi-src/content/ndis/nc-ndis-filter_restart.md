...
The filter driver will complete the request asynchronously with a call to the 
       <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ndis/nf-ndis-ndisfrestartcomplete">NdisFRestartComplete</a> function
...
Must, if the filter driver changes restart attributes, provide a 
      <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ndis/nc-ndis-filter_oid_request">FilterOidRequest</a> function. The
...
After the filter driver returns its status or calls the 
    <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ndis/nf-ndis-ndisfrestartcomplete">NdisFRestartComplete</a> function, the
