...
ms.date: 05/02/2018
keywords: ["FILTER_CANCEL_DIRECT_OID_REQUEST callback function"]
...
f1_keywords:
 ...
 - ndis/FILTER_CANCEL_DIRECT_OID_REQUEST
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
If the filter driver forwarded the request to an underlying driver and the processing is still not
    ...
    <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfcanceldirectoidrequest">
...
<a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfcanceldirectoidrequest">NdisFCancelDirectOidRequest</a>
