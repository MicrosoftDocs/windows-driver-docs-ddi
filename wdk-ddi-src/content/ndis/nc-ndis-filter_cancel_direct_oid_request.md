...
If the filter driver forwarded the request to an underlying driver and the processing is still not
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfcanceldirectoidrequest">
...
<a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfcanceldirectoidrequest">NdisFCancelDirectOidRequest</a>
