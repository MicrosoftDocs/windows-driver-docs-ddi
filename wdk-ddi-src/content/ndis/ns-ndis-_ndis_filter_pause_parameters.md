...
ms.date: 1/18/2018
ms.keywords: NDIS_FILTER_PAUSE_PARAMETERS, NDIS_FILTER_PAUSE_PARAMETERS structure [Network Drivers Starting with Windows Vista], PNDIS_FILTER_PAUSE_PARAMETERS structure pointer [Network Drivers Starting with Windows Vista], *PNDIS_FILTER_PAUSE_PARAMETERS, ndis/NDIS_FILTER_PAUSE_PARAMETERS, netvista.ndis_filter_pause_parameters, filter_structures_ref_78bd5df6-c235-4af1-9b2f-1ddce38a0017.xml, ndis/PNDIS_FILTER_PAUSE_PARAMETERS, _NDIS_FILTER_PAUSE_PARAMETERS, PNDIS_FILTER_PAUSE_PARAMETERS
