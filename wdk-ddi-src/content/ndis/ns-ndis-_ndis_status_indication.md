...
ms.date: 1/18/2018
ms.keywords: NDIS_STATUS_INDICATION, PNDIS_STATUS_INDICATION, NDIS_STATUS_INDICATION structure [Network Drivers Starting with Windows Vista], *PNDIS_STATUS_INDICATION, _NDIS_STATUS_INDICATION, PNDIS_STATUS_INDICATION structure pointer [Network Drivers Starting with Windows Vista], ndis/PNDIS_STATUS_INDICATION, ndis_status_ref_6c475f32-573d-4e1b-ae74-bd9e9b8943db.xml, netvista.ndis_status_indication, ndis/NDIS_STATUS_INDICATION
