...
The 
  ...
  <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndiscooidrequest">NdisCoOidRequest</a> function or that a
...
The client, or call manager is handling this request asynchronously, and it will call the 
       <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndiscooidrequestcomplete">
...
CoNDIS clients and call managers send information to each other by specifying a non-<b>NULL</b> value in the 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndiscooidrequest">NdisCoOidRequest</a> function. Similarly,
    MCMs call the 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndismcmoidrequest">NdisMCmOidRequest</a> with explicit values
    for 
