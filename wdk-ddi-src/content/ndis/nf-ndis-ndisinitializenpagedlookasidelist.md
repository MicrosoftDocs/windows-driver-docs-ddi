...
# NdisInitializeNPagedLookasideList function (ndis.h)
...
It is more efficient for a driver to allow the 
    ...
    the 
    <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-exallocatepoolwithtag">ExAllocatePoolWithTag</a> and 
    <a href="/windows-hardware/drivers/ddi/ntddk/nf-ntddk-exfreepool">ExFreePool</a> functions). However, a driver that
