...
<a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-miniport_restart">MiniportRestart</a> successfully restarted the flow of network data through the
       miniport adapter.
...
<i>MiniportRestart</i> did not complete the restart operation and the operation
       ...
       <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndismrestartcomplete">NdisMRestartComplete</a> function when
...
<a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-miniport_restart">MiniportRestart</a> failed because of insufficient resources.
...
Should make sure that the 
      ...
      <a href="/windows-hardware/drivers/ddi/ntddndis/ns-ntddndis-_ndis_object_header">NDIS_OBJECT_HEADER</a> structure that is
      specified in the 
...
After the miniport driver successfully restarts the send and receive operations, it must complete the
    ...
    driver calls the 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndismrestartcomplete">NdisMRestartComplete</a> function. After
...
<a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndismrestartcomplete">NdisMRestartComplete</a>
