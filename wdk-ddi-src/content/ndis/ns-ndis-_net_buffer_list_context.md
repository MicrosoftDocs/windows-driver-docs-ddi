...
ms.date: 2/16/2018
ms.keywords: netvista.net_buffer_list_context, PNET_BUFFER_LIST_CONTEXT, ndis/PNET_BUFFER_LIST_CONTEXT, NET_BUFFER_LIST_CONTEXT, ndis_netbuf_structures_ref_8f7ae065-a4d5-4fc9-92f1-36e25e19bac2.xml, NET_BUFFER_LIST_CONTEXT structure [Network Drivers Starting with Windows Vista], PNET_BUFFER_LIST_CONTEXT structure pointer [Network Drivers Starting with Windows Vista], ndis/NET_BUFFER_LIST_CONTEXT, _NET_BUFFER_LIST_CONTEXT, *PNET_BUFFER_LIST_CONTEXT
