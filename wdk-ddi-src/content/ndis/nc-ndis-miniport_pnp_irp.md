...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: (*MINIPORT_PNP_IRP_HANDLER)
req.alt-loc: Ndis.h
req.ddi-compliance: 
req.unicode-ansi: 
req.idl: 
...
</dl>The miniport driver handled the start device request successfully.
<dl>
<dt><b>NDIS_STATUS_RESOURCES</b></dt>
</dl>The miniport driver could not handle the start device request because of low resources.
<dl>
<dt><b>NDIS_STATUS_FAILURE</b></dt>
</dl><i>MiniportFilterResourceRequirements</i> failed for reasons other than
