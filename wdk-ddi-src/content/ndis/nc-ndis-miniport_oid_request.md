...
The miniport driver will complete the request asynchronously. After the miniport driver has
       ...
       <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndismoidrequestcomplete">
...
NDIS calls the 
    ...
    called the 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisoidrequest">NdisOidRequest</a> function. Miniport drivers
