...
The miniport driver will complete the request asynchronously. After the miniport driver has
       ...
       <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ndis/nf-ndis-ndismoidrequestcomplete">
...
NDIS calls the 
    ...
    called the 
    <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ndis/nf-ndis-ndisoidrequest">NdisOidRequest</a> function. Miniport drivers
