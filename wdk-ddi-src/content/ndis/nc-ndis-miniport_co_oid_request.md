...
A handle to a miniport driver-allocated context area in which the miniport driver maintains its
     ...
     <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-miniport_co_create_vc">MiniportCoCreateVc</a> function. If the
     request is 
...
The value that was specified in the 
       ...
       <a href="/windows-hardware/drivers/ddi/oidrequest/ns-oidrequest-ndis_oid_request">NDIS_OID_REQUEST</a> structure at 
...
To register 
    ...
    from the 
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-set_options">MiniportSetOptions</a> function. In 
...
NDIS calls the 
    ...
    called the 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndiscooidrequest">NdisCoOidRequest</a> function. Miniport
