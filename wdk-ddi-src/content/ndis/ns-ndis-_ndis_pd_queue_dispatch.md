...
tech.root: netvista
ms.date: 05/02/2018
keywords: ["NDIS_PD_QUEUE_DISPATCH structure"]
...
The <a href="/windows-hardware/drivers/ddi/objectheader/ns-objectheader-ndis_object_header">NDIS_OBJECT_HEADER</a> structure for the <b>NDIS_PD_QUEUE_DISPATCH</b> structure. Set the members of this structure as follows:
...
A pointer to the provider's <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-ndis_pd_post_and_drain_buffer_list">PDPostAndDrainBufferList</a> routine.

### -field PDQueryQueueDepth

A pointer to the provider's <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-ndis_pd_query_queue_depth">PDQueryQueueDepth</a> routine.
