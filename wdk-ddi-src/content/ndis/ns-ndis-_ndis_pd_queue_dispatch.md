...
ms.date: 2/16/2018
ms.keywords: ndis/PNDIS_PD_QUEUE_DISPATCH, PNDIS_PD_QUEUE_DISPATCH structure pointer [Network Drivers Starting with Windows Vista], ndis/NDIS_PD_QUEUE_DISPATCH, NDIS_PD_QUEUE_DISPATCH structure [Network Drivers Starting with Windows Vista], NDIS_PD_QUEUE_DISPATCH, netvista.ndis_pd_queue_dispatch, _NDIS_PD_QUEUE_DISPATCH, PNDIS_PD_QUEUE_DISPATCH
