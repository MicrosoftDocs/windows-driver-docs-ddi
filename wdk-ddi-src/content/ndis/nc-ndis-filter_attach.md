...
<i>FilterAttach</i> is a required function. NDIS calls a filter driver's 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-set_options">FilterSetOptions</a> function returns.
...
<li>
Calls the 
      <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfsetattributes">NdisFSetAttributes</a> function together
      with the 
...
NDIS calls a filter driver's 
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-filter_detach">FilterDetach</a> function to release all the
