...
[in]
A pointer to an 
     <a href="/windows-hardware/drivers/ddi/ndis/ns-ndis-_ndis_bind_parameters">NDIS_BIND_PARAMETERS</a> structure that
     NDIS created.
...
<i>ProtocolBindAdapterEx</i> allocates sufficient memory to maintain the binding
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisopenadapterex">NdisOpenAdapterEx</a> function to bind
...
<i>ProtocolBindAdapterEx</i> passes 
    ...
    <a href="/windows-hardware/drivers/ddi/ntddndis/ne-ntddndis-_ndis_medium">NDIS_MEDIUM</a> types. NDIS indicates the selected
    medium type at the 
...
Protocol drivers should use the 
    <a href="/windows-hardware/drivers/ddi/ndis/ns-ndis-_ndis_bind_parameters">NDIS_BIND_PARAMETERS</a> structure to
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisoidrequest">NdisOidRequest</a> function to query the
    ...
    <a href="/windows-hardware/drivers/network/protocol-driver-oid-requests">Protocol Driver OID Requests</a>.
...
NDIS can call a protocol driver's 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-protocol_status_ex">ProtocolStatusEx</a> function after the
...
Every protocol driver should allocate sufficient 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/ns-ndis-_net_buffer_list">NET_BUFFER_LIST</a> structure pools. The driver
...
If the protocol driver successfully opens the miniport adapter but the bind operation fails (for
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndiscloseadapterex">NdisCloseAdapterEx</a> from 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisunbindadapter">NdisUnbindAdapter</a> function and call 
...
<a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisunbindadapter">NdisUnbindAdapter</a>
