...
ms.date: 1/18/2018
ms.keywords: filter_structures_ref_8711cb33-bba0-41ba-912b-af351c7e758d.xml, ndis/NDIS_FILTER_ATTRIBUTES, _NDIS_FILTER_ATTRIBUTES, *PNDIS_FILTER_ATTRIBUTES, PNDIS_FILTER_ATTRIBUTES structure pointer [Network Drivers Starting with Windows Vista], netvista.ndis_filter_attributes, NDIS_FILTER_ATTRIBUTES structure [Network Drivers Starting with Windows Vista], NDIS_FILTER_ATTRIBUTES, PNDIS_FILTER_ATTRIBUTES, ndis/PNDIS_FILTER_ATTRIBUTES
