...
ms.date: 05/02/2018
keywords: ["NDIS_FILTER_ATTRIBUTES structure"]
...
A filter drivers passes an NDIS_FILTER_ATTRIBUTES structure to the 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfsetattributes">NdisFSetAttributes</a> function.
