...
In the Ndis.h header file, the SET_OPTIONS callback function is further defined as follows:<pre class="syntax"><code>typedef SET_OPTIONS (*SET_OPTIONS_HANDLER);
