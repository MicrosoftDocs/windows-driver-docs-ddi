...
The processor count that 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisgroupactiveprocessormask">
...
To obtain the maximum number of processors in a group, call the 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisgroupmaxprocessorcount">
    NdisGroupMaxProcessorCount</a> function.

## -see-also

<a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisgroupactiveprocessormask">NdisGroupActiveProcessorMask</a>
