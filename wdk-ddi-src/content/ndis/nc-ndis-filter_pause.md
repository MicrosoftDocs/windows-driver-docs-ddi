...
The filter driver will complete the request asynchronously with a call to the 
       <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfpausecomplete">NdisFPauseComplete</a> function.
...
After the filter driver returns NDIS_STATUS_SUCCESS from 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfpausecomplete">NdisFPauseComplete</a> function, the pause
...
NDIS calls the 
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-filter_restart">FilterRestart</a> function to initiate a
...
<a href="/windows-hardware/drivers/ddi/ndis/ns-ndis-_ndis_filter_pause_parameters">NDIS_FILTER_PAUSE_PARAMETERS</a>
...
<a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfpausecomplete">NdisFPauseComplete</a>
