...
NDIS calls the filter driver's 
    ...
    calling the 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfdirectoidrequest">NdisFDirectOidRequest</a> function. As
...
NDIS does not serialize requests that it sends to 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-filter_oid_request">FilterOidRequest</a> or 
