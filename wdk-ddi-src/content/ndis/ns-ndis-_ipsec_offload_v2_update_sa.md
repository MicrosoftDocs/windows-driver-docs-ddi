...
# IPSEC_OFFLOAD_V2_UPDATE_SA structure (ndis.h)
...
An NDIS handle that identifies the SA. The miniport driver provided this handle in response to an 
     OID set request of <a href="/windows-hardware/drivers/network/oid-tcp-task-ipsec-offload-v2-add-sa">OID_TCP_TASK_IPSEC_OFFLOAD_V2_ADD_SA</a>.

### -field Operation

The IPsec operation for which the SA is to be used. The 
     <a href="/windows-hardware/drivers/ddi/ndis/ne-ndis-_ipsec_offload_v2_operation">
