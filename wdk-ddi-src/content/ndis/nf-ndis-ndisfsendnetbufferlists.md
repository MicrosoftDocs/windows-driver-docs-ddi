...
ms.date: 1/18/2018
ms.keywords: NdisFSendNetBufferLists, netvista.ndisfsendnetbufferlists, ndis/NdisFSendNetBufferLists, filter_ndis_functions_ref_333e9ef3-6858-4b5b-bca1-4f06da775906.xml, NdisFSendNetBufferLists function [Network Drivers Starting with Windows Vista]
...
<div class="alert"><b>Note</b>  A filter driver should keep track of send requests that it originates and make
      ...
      NdisFSendNetBufferListsComplete</a> function when such requests are complete.</div><div> </div>
