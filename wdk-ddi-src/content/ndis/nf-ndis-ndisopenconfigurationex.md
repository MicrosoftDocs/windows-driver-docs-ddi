...
A pointer to a caller-supplied and initialized 
     <a href="/windows-hardware/drivers/ddi/ndis/ns-ndis-_ndis_configuration_object">
...
If the driver obtained the handle in 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisreadnetworkaddress">NdisReadNetworkAddress</a> function to
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-miniport_halt">MiniportHaltEx</a> function returns.
...
If the driver obtained the handle in 
    ...
    it calls the 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndiscloseadapterex">NdisCloseAdapterEx</a> function.
...
If a filter driver obtained the handle in 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-filter_detach">FilterDetach</a> function returns. If a
...
<a href="/windows-hardware/drivers/ddi/ndis/ns-ndis-_ndis_configuration_object">NDIS_CONFIGURATION_OBJECT</a>
