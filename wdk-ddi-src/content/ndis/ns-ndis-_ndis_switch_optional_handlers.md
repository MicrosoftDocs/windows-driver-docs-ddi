...
ms.date: 1/18/2018
ms.keywords: "*PNDIS_SWITCH_OPTIONAL_HANDLERS, netvista.ndis_switch_optional_handlers, ndis/NDIS_SWITCH_OPTIONAL_HANDLERS, PNDIS_SWITCH_OPTIONAL_HANDLERS structure pointer [Network Drivers Starting with Windows Vista], PNDIS_SWITCH_OPTIONAL_HANDLERS, NDIS_SWITCH_OPTIONAL_HANDLERS structure [Network Drivers Starting with Windows Vista], ndis/PNDIS_SWITCH_OPTIONAL_HANDLERS, NDIS_SWITCH_OPTIONAL_HANDLERS, _NDIS_SWITCH_OPTIONAL_HANDLERS"
