...
The driver object that is associated with an NDIS miniport driver specifies an 
    <a href="/windows-hardware/drivers/ddi/wdm/nc-wdm-driver_unload">Unload</a> routine. The operating system calls the 
...
If a miniport driver manages more than one device instance, such as a load-balancing driver, NDIS will
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-miniport_halt">MiniportHaltEx</a> function one time for
