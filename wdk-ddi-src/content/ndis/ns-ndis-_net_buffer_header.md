...
ms.date: 1/18/2018
ms.keywords: ndis/PNET_BUFFER_HEADER, netvista.net_buffer_header, PNET_BUFFER_HEADER, _NET_BUFFER_HEADER, PNET_BUFFER_HEADER union pointer [Network Drivers Starting with Windows Vista], *PNET_BUFFER_HEADER, ndis/NET_BUFFER_HEADER, NET_BUFFER_HEADER, NET_BUFFER_HEADER union [Network Drivers Starting with Windows Vista], ndis_netbuf_structures_ref_a19368c6-0bef-4fe6-be52-d76e0c6ea99d.xml
