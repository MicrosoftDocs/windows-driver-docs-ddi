...
NDIS calls the 
    ...
    <a href="/windows-hardware/drivers/network/ndis-status-reset-start">NDIS_STATUS_RESET_START</a> code and
    later, when the reset operation is complete, NDIS specifies the 
    <a href="/windows-hardware/drivers/network/ndis-status-reset-end">NDIS_STATUS_RESET_END</a> code.
...
<a href="/windows-hardware/drivers/network/ndis-status-reset-end">NDIS_STATUS_RESET_END</a>



<a href="/windows-hardware/drivers/network/ndis-status-reset-start">NDIS_STATUS_RESET_START</a>
