...
ms.date: 2/16/2018
ms.keywords: NDIS_ENUM_FILTERS, _NDIS_ENUM_FILTERS, NDIS_ENUM_FILTERS structure [Network Drivers Starting with Windows Vista], ndis/PNDIS_ENUM_FILTERS, netvista.ndis_enum_filters, PNDIS_ENUM_FILTERS structure pointer [Network Drivers Starting with Windows Vista], filter_structures_ref_4fe2a9d2-2539-40bc-9131-735a6337831e.xml, ndis/NDIS_ENUM_FILTERS, PNDIS_ENUM_FILTERS, *PNDIS_ENUM_FILTERS
