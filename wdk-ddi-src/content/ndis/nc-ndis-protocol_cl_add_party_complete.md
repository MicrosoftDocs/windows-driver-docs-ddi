...
tech.root: netvista
ms.date: 05/02/2018
keywords: ["PROTOCOL_CL_ADD_PARTY_COMPLETE callback function"]
...
f1_keywords:
 ...
 - ndis/PROTOCOL_CL_ADD_PARTY_COMPLETE
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The 
  ...
  <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndiscladdparty">NdisClAddParty</a>. Otherwise, such a protocol
  driver's registered 
...
A call to 
    ...
    client called 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndiscladdparty">NdisClAddParty</a>. If the input 
...
If the attempt to add a party succeeded, 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndiscldropparty">NdisClDropParty</a> eventually unless the
...
Depending on the signaling protocol of the call manager, the traffic parameters at 
    ...
    set up with 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisclmakecall">NdisClMakeCall</a>, it can supply only the
