...
NDIS calls the 
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-allocate_shared_memory_handler">NetAllocateSharedMemory</a> function of a shared memory provider from the context of the call to 
    <b>NdisAllocateSharedMemory</b>.

The driver must call the 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfreesharedmemory">NdisFreeSharedMemory</a> function to free
