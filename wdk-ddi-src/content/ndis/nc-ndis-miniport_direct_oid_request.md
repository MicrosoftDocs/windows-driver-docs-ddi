...
f1_keywords:
 ...
 - ndis/MINIPORT_DIRECT_OID_REQUEST
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
The miniport driver will provide an OID completion status with a subsequent status indication. A
       ...
       <a href="/windows-hardware/drivers/ddi/ndis/ns-ndis-_ndis_oid_request">NDIS_OID_REQUEST</a> and 
...
NDIS does not serialize requests that it sends to 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-miniport_oid_request">MiniportOidRequest</a> or 
