...
A pointer to an opaque driver object that the filter driver received in its 
     ...
     <a href="/windows-hardware/drivers/network/initializing-a-filter-driver">DriverEntry of NDIS Filter
     Drivers</a>.)
...
A pointer to an 
     <a href="/windows-hardware/drivers/ddi/ndis/ns-ndis-_ndis_filter_driver_characteristics">
...
A pointer to a handle variable. If the call to 
    ...
    NdisFRegisterFilterDriver</b> succeeds, NDIS fills this variable with a filter driver handle. The
     ...
     <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfderegisterfilterdriver">NdisFDeregisterFilterDriver</a>,
...
Drivers that call <b>
    NdisFRegisterFilterDriver</b> must be prepared for an immediate call to any of their <i>FilterXxx</i> functions. For more information see <a href="/windows-hardware/drivers/network/initializing-a-filter-driver">Initializing a Filter Driver</a>.
...
To allow filter drivers to register optional services, NDIS calls the 
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-set_options">FilterSetOptions</a> function within the
    context of 
    <b>
...
Filter drivers call the 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisfderegisterfilterdriver">
