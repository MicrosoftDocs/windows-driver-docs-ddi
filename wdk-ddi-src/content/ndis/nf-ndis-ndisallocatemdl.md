...
ms.date: 1/18/2018
ms.keywords: NdisAllocateMdl function [Network Drivers Starting with Windows Vista], netvista.ndisallocatemdl, ndis_netbuf_functions_ref_73b9ab32-14a8-4441-a057-c6fe91ddfb43.xml, NdisAllocateMdl, ndis/NdisAllocateMdl
