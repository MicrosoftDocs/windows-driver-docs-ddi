...
A handle that identifies the virtual connection (VC) that the caller is requesting or setting
     ...
     <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndismcmcreatevc">NdisMCmCreateVc</a> function, or as an input
     parameter to its 
...
After the MCM calls 
    ...
    <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-protocol_co_oid_request">ProtocolCoOidRequest</a> function of
    the client.
