...
ms.date: 2/16/2018
ms.keywords: netvista.ndis_open_parameters, ndis/NDIS_OPEN_PARAMETERS, PNDIS_OPEN_PARAMETERS structure pointer [Network Drivers Starting with Windows Vista], ndis/PNDIS_OPEN_PARAMETERS, PNDIS_OPEN_PARAMETERS, _NDIS_OPEN_PARAMETERS, protocol_structures_ref_6de65643-050b-43b6-875f-13c493b3d9de.xml, *PNDIS_OPEN_PARAMETERS, NDIS_OPEN_PARAMETERS structure [Network Drivers Starting with Windows Vista], NDIS_OPEN_PARAMETERS
