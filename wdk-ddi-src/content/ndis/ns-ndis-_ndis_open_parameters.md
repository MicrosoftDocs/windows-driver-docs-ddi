...
A Unicode string that contains the name of the miniport adapter that NDIS passed to 
     <a href="/windows-hardware/drivers/ddi/ndis/nc-ndis-protocol_bind_adapter_ex">ProtocolBindAdapterEx</a> in the 
...
A pointer to an array of 
     ...
     <a href="/windows-hardware/drivers/ddi/ntddndis/ne-ntddndis-_ndis_medium">NDIS_MEDIUM</a> types.
...
A protocol driver passes an NDIS_OPEN_PARAMETERS structure when it calls the 
    <a href="/windows-hardware/drivers/ddi/ndis/nf-ndis-ndisopenadapterex">NdisOpenAdapterEx</a> function to open a
    miniport adapter.
