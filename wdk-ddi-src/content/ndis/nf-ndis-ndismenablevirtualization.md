...
ms.date: 1/18/2018
ms.keywords: ndis/NdisMEnableVirtualization, netvista.ndismenablevirtualization, NdisMEnableVirtualization function [Network Drivers Starting with Windows Vista], NdisMEnableVirtualization
