...
After the extension calls <i>ReferenceSwitchPort</i>, it must call <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/ndis/nc-ndis-ndis_switch_dereference_switch_port">DereferenceSwitchPort</a> to decrement the reference counter.
