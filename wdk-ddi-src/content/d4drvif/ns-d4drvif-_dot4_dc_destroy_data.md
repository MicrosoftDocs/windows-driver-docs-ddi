...
ms.date: 2/2/2018
ms.keywords: d4drvif/DOT4_DC_DESTROY_DATA, PDOT4_DC_DESTROY_DATA, PDOT4_DC_DESTROY_DATA structure pointer [Print Devices], d4drvif/PDOT4_DC_DESTROY_DATA, DOT4_DC_DESTROY_DATA, DOT4_DC_DESTROY_DATA structure [Print Devices], _DOT4_DC_DESTROY_DATA, *PDOT4_DC_DESTROY_DATA, print.dot4_dc_destroy_data
