...
title: IOCTL_DOT4_REMOVE_ACTIVITY_BROADCAST (d4drvif.h)
...
tech.root: print
ms.date: 04/20/2018
keywords: ["IOCTL_DOT4_REMOVE_ACTIVITY_BROADCAST IOCTL"]
...
# IOCTL_DOT4_REMOVE_ACTIVITY_BROADCAST IOCTL (d4drvif.h)
