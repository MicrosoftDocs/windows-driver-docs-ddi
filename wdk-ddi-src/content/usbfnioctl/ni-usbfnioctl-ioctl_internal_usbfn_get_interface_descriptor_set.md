...
A pointer to a buffer that contains a <a href="/windows-hardware/drivers/ddi/usbfnbase/ns-usbfnbase-_usbfn_interface_info">USBFN_INTERFACE_INFO</a> structure.
...
A pointer to a buffer that contains a <a href="/windows-hardware/drivers/ddi/usbfnbase/ns-usbfnbase-_usbfn_interface_info">USBFN_INTERFACE_INFO</a> structure. USB function class extension (UFX) populates the structure with the entire interface descriptor set including its endpoint descriptors.
...
<a href="/windows-hardware/drivers/ddi/usbfnbase/ns-usbfnbase-_usbfn_interface_info">USBFN_INTERFACE_INFO</a>
