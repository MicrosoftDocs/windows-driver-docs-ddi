...
ms.date: 2/15/2018
ms.keywords: ",  , 2, 2/SERCX2_PIO_TRANSMIT_CONFIG_INIT, A, C, E, F, G, I, M, N, O, P, R, S, SERCX2_PIO_TRANSMIT_CONFIG_INIT, SERCX2_PIO_TRANSMIT_CONFIG_INIT function [Serial Ports], T, X, _, serports.sercx2_pio_transmit_config_init"
