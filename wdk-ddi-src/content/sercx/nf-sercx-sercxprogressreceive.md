...
If the <b>SerCxProgressReceive</b> does not complete all outstanding work for the read operation, the caller must call the <a href="/windows-hardware/drivers/ddi/sercx/nf-sercx-sercxretrievereceivebuffer">SerCxRetrieveReceiveBuffer</a> method again to get a new buffer descriptor and continue to receive data.
...
<a href="/windows-hardware/drivers/ddi/sercx/nf-sercx-sercxretrievereceivebuffer">SerCxRetrieveReceiveBuffer</a>
