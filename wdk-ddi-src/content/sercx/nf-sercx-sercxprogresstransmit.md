...
For more information about these values, see <a href="/windows-hardware/drivers/ddi/sercx/ne-sercx-_sercx_status">SERCX_STATUS</a>.

<div class="alert"><b>Note</b>  The <b>SerCxStatusTimeout</b> value is valid only for receive operations. No interval time-out can be specified for a transmit operation. For more information, see <a href="/windows-hardware/drivers/ddi/ntddser/ns-ntddser-_serial_timeouts">SERIAL_TIMEOUTS</a>.</div>
<div> </div>
...
If the <b>SerCxProgressTransmit</b> call does not complete all outstanding work for the write operation, the caller must call <a href="/windows-hardware/drivers/ddi/sercx/nf-sercx-sercxretrievetransmitbuffer">SerCxRetrieveTransmitBuffer</a> again to get a new buffer descriptor and continue to transmit data.

## -see-also

<a href="/windows-hardware/drivers/ddi/sercx/ne-sercx-_sercx_status">SERCX_STATUS</a>
