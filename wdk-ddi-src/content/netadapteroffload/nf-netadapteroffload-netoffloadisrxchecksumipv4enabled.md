...
The **NetOffloadIsRxChecksumIPv4Enabled** method determines whether a net adapter has Rx IPv4 checksum offload enabled.
...
Returns **TRUE** if Rx IPv4 checksum offload is enabled, or **FALSE** if it is not.

## -remarks

Client drivers typically call this method during their [*EvtNetAdapterOffloadSetRxChecksum*](../netadapteroffload/nc-netadapteroffload-evt_net_adapter_offload_set_rx_checksum.md) callback to test whether an updated set of active Rx checksum capabilities includes Rx IPv4 checksum offload.
