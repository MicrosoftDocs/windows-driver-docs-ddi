...
description: The NetAdapterOffloadSetLsoChecksumCapabilities function sets the hardware large send offload (LSO) offload capabilities of a network adapter.
tech.root: netvista
