...
ms.date: 2/16/2018
ms.keywords: PNET_DMA_PNP_NOTIFICATION, netdma/PNET_DMA_PNP_NOTIFICATION, netdma_ref_276d7903-f1d8-4fd4-91f0-dda490f8da02.xml, _NET_DMA_PNP_NOTIFICATION, NET_DMA_PNP_NOTIFICATION, netvista.net_dma_pnp_notification, netdma/NET_DMA_PNP_NOTIFICATION, *PNET_DMA_PNP_NOTIFICATION, PNET_DMA_PNP_NOTIFICATION structure pointer [Network Drivers Starting with Windows Vista], NET_DMA_PNP_NOTIFICATION structure [Network Drivers Starting with Windows Vista]
