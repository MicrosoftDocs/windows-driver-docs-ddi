...
ms.date: 2/16/2018
ms.keywords: "_NET_DMA_PNP_NOTIFICATION_CODE, netdma/NetDmaNotificationChannelArrival, netdma/NetDmaNotificationProviderArrival, PNET_DMA_PNP_NOTIFICATION_CODE, NetDmaNotificationProviderArrival, netdma/NetDmaNotificationProviderRemoval, netdma/NET_DMA_PNP_NOTIFICATION_CODE, NET_DMA_PNP_NOTIFICATION_CODE enumeration [Network Drivers Starting with Windows Vista], NetDmaNotificationProviderRemoval, NetDmaNotificationMax, NetDmaNotificationProviderRegistered, netvista.net_dma_pnp_notification_code, NET_DMA_PNP_NOTIFICATION_CODE, netdma/NetDmaNotificationProviderRegistered, PNET_DMA_PNP_NOTIFICATION_CODE enumeration pointer [Network Drivers Starting with Windows Vista], netdma/PNET_DMA_PNP_NOTIFICATION_CODE, netdma_ref_ce8373ae-1547-410d-b33e-d95eb42d649e.xml, netdma/NetDmaNotificationProviderPowerUp, NetDmaNotificationChannelArrival, *PNET_DMA_PNP_NOTIFICATION_CODE, NetDmaNotificationProviderPowerDown, netdma/NetDmaNotificationMax, netdma/NetDmaNotificationProviderPowerDown, NetDmaNotificationProviderPowerUp"
