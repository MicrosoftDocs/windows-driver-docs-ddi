...
ms.date: 1/18/2018
ms.keywords: xpsrassvc/IXpsRasterizer::SetMinimalLineWidth, print.ixpsrasterizer_setminimallinewidth, IXpsRasterizer interface [Print Devices], SetMinimalLineWidth method, SetMinimalLineWidth method [Print Devices], print_xpsrast_2208b605-31bd-4ab9-8bd5-6941a921ff7a.xml, IXpsRasterizer, IXpsRasterizer::SetMinimalLineWidth, SetMinimalLineWidth method [Print Devices], IXpsRasterizer interface, SetMinimalLineWidth
