...
ms.date: 1/18/2018
ms.keywords: "_WWAN_UICC_RESET_INFO, WWAN_UICC_RESET_INFO, WWAN_UICC_RESET_INFO structure [Network Drivers Starting with Windows Vista], netvista.wwan_uicc_reset_info, wwan/WWAN_UICC_RESET_INFO, PWWAN_UICC_RESET_INFO structure pointer [Network Drivers Starting with Windows Vista], *PWWAN_UICC_RESET_INFO, wwan/PWWAN_UICC_RESET_INFO, PWWAN_UICC_RESET_INFO"
