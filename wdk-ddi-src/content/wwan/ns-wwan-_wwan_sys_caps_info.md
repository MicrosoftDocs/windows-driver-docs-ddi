...
ms.date: 1/18/2018
ms.keywords: netvista.wwan_sys_caps, PWWAN_SYS_CAPS_INFO structure pointer [Network Drivers Starting with Windows Vista], *PWWAN_SYS_CAPS_INFO, wwan/WWAN_SYS_CAPS_INFO, WWAN_SYS_CAPS_INFO, WWAN_SYS_CAPS_INFO structure [Network Drivers Starting with Windows Vista], PWWAN_SYS_CAPS_INFO, wwan/PWWAN_SYS_CAPS_INFO, _WWAN_SYS_CAPS_INFO
