...
ms.date: 2/16/2018
ms.keywords: PWWAN_ACTIVATION_STATE, WwanRef_d1e0cf59-316c-45a2-8ae3-231c30cae091.xml, wwan/WwanActivationStateMax, WWAN_ACTIVATION_STATE enumeration [Network Drivers Starting with Windows Vista], *PWWAN_ACTIVATION_STATE, WwanActivationStateActivated, wwan/WWAN_ACTIVATION_STATE, _WWAN_ACTIVATION_STATE, WwanActivationStateDeactivated, wwan/WwanActivationStateUnknown, WwanActivationStateUnknown, wwan/PWWAN_ACTIVATION_STATE, wwan/WwanActivationStateActivating, wwan/WwanActivationStateDeactivated, PWWAN_ACTIVATION_STATE enumeration pointer [Network Drivers Starting with Windows Vista], WwanActivationStateMax, WwanActivationStateDeactivating, wwan/WwanActivationStateActivated, WWAN_ACTIVATION_STATE, wwan/WwanActivationStateDeactivating, WwanActivationStateActivating, netvista.wwan_activation_state
