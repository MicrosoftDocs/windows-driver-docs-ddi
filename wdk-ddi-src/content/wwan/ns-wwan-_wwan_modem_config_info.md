...
ms.date: 1/18/2018
ms.keywords: wwan/WWAN_MODEM_CONFIG_INFO, WWAN_MODEM_CONFIG_INFO, *PWWAN_MODEM_CONFIG_INFO, _WWAN_MODEM_CONFIG_INFO, PWWAN_MODEM_CONFIG_INFO structure pointer [Network Drivers Starting with Windows Vista], WWAN_MODEM_CONFIG_INFO structure [Network Drivers Starting with Windows Vista], wwan/PWWAN_MODEM_CONFIG_INFO, netvista.wwan_modem_config_info, PWWAN_MODEM_CONFIG_INFO
