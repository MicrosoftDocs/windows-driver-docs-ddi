...
ms.date: 1/18/2018
ms.keywords: WWAN_BASE_STATIONS_INFO, wwan/PWWAN_BASE_STATIONS_INFO, PWWAN_BASE_STATIONS_INFO structure pointer [Network Drivers Starting with Windows Vista], PWWAN_BASE_STATIONS_INFO, _WWAN_BASE_STATIONS_INFO, WWAN_BASE_STATIONS_INFO structure [Network Drivers Starting with Windows Vista], *PWWAN_BASE_STATIONS_INFO, netvista.wwan_base_stations_info, wwan/WWAN_BASE_STATIONS_INFO
