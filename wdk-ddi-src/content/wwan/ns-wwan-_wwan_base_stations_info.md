...
ms.date: 2/16/2018
ms.keywords: "_WWAN_BASE_STATIONS_INFO, WWAN_BASE_STATIONS_INFO structure [Network Drivers Starting with Windows Vista], PWWAN_BASE_STATIONS_INFO structure pointer [Network Drivers Starting with Windows Vista], wwan/PWWAN_BASE_STATIONS_INFO, *PWWAN_BASE_STATIONS_INFO, netvista.wwan_base_stations_info, wwan/WWAN_BASE_STATIONS_INFO, PWWAN_BASE_STATIONS_INFO, WWAN_BASE_STATIONS_INFO"
