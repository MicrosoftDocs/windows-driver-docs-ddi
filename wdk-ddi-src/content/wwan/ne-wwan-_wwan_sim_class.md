...
ms.date: 2/16/2018
ms.keywords: WwanSimClassSimRemovable, PWWAN_SIM_CLASS enumeration pointer [Network Drivers Starting with Windows Vista], wwan/WwanSimClassMax, *PWWAN_SIM_CLASS, wwan/PWWAN_SIM_CLASS, wwan/WwanSimClassUnknown, netvista.wwan_sim_class, WWAN_SIM_CLASS, WWAN_SIM_CLASS enumeration [Network Drivers Starting with Windows Vista], wwan/WwanSimClassSimRemovable, _WWAN_SIM_CLASS, wwan/WWAN_SIM_CLASS, WwanSimClassUnknown, WwanSimClassMax, wwan/WwanSimClassSimLogical, WwanRef_8c5184eb-4ac5-40a7-bb52-875554517f70.xml, WwanSimClassSimLogical, PWWAN_SIM_CLASS, wwan/WwanSimClassSimRemote, WwanSimClassSimRemote
