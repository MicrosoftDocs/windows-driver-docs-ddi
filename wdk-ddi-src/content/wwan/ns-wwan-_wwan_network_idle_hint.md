...
ms.date: 2/16/2018
ms.keywords: wwan/PWWAN_NETWORK_IDLE_HINT, PWWAN_NETWORK_IDLE_HINT, wwan/WWAN_NETWORK_IDLE_HINT, WWAN_NETWORK_IDLE_HINT, *PWWAN_NETWORK_IDLE_HINT, PWWAN_NETWORK_IDLE_HINT structure pointer [Network Drivers Starting with Windows Vista], _WWAN_NETWORK_IDLE_HINT, WWAN_NETWORK_IDLE_HINT structure [Network Drivers Starting with Windows Vista], netvista.wwan_network_idle_hint
