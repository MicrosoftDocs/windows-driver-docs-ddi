...
ms.date: 1/18/2018
ms.keywords: wwan/WWAN_CDMA_MRL, PWWAN_CDMA_MRL structure pointer [Network Drivers Starting with Windows Vista], WWAN_CDMA_MRL, _WWAN_CDMA_MRL, netvista.wwan_cdma_mrl, WWAN_CDMA_MRL structure [Network Drivers Starting with Windows Vista], wwan/PWWAN_CDMA_MRL, PWWAN_CDMA_MRL, *PWWAN_CDMA_MRL
