...
ms.date: 1/18/2018
ms.keywords: wwan/WWAN_CDMA_MRL_INFO, netvista.wwan_cdma_mrl_info, *PWWAN_CDMA_MRL_INFO, PWWAN_CDMA_MRL_INFO, _WWAN_CDMA_MRL_INFO, PWWAN_CDMA_MRL_INFO structure pointer [Network Drivers Starting with Windows Vista], wwan/PWWAN_CDMA_MRL_INFO, WWAN_CDMA_MRL_INFO structure [Network Drivers Starting with Windows Vista], WWAN_CDMA_MRL_INFO
