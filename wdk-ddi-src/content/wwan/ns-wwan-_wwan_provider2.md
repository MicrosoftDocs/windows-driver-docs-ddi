...
ms.date: 2/16/2018
ms.keywords: wwan/WWAN_PROVIDER2, wwan/PWWAN_PROVIDER2, PWWAN_PROVIDER2, WWAN_PROVIDER2 structure [Network Drivers Starting with Windows Vista], PWWAN_PROVIDER2 structure pointer [Network Drivers Starting with Windows Vista], _WWAN_PROVIDER2, *PWWAN_PROVIDER2, netvista.wwan_provider2, WWAN_PROVIDER2
