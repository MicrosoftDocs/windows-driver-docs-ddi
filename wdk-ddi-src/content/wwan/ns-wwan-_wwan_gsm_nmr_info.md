...
ms.date: 2/16/2018
ms.keywords: PWWAN_GSM_NMR_INFO, WWAN_GSM_NMR_INFO, PWWAN_GSM_NMR_INFO structure pointer [Network Drivers Starting with Windows Vista], WWAN_GSM_NMR_INFO structure [Network Drivers Starting with Windows Vista], wwan/WWAN_GSM_NMR_INFO, wwan/PWWAN_GSM_NMR_INFO, netvista.wwan_gsm_nmr_info, _WWAN_GSM_NMR_INFO, *PWWAN_GSM_NMR_INFO
