...
ms.date: 1/18/2018
ms.keywords: WwanRef_d68f5af0-d14e-4b01-a77d-4d3fea6db828.xml, WWAN_SMS_CONFIGURATION structure [Network Drivers Starting with Windows Vista], PWWAN_SMS_CONFIGURATION structure pointer [Network Drivers Starting with Windows Vista], netvista.wwan_sms_configuration, _WWAN_SMS_CONFIGURATION, wwan/PWWAN_SMS_CONFIGURATION, WWAN_SMS_CONFIGURATION, PWWAN_SMS_CONFIGURATION, wwan/WWAN_SMS_CONFIGURATION, *PWWAN_SMS_CONFIGURATION
