...
ms.date: 1/18/2018
ms.keywords: "_WWAN_USSD_EVENT, *PWWAN_USSD_EVENT, wwan/WWAN_USSD_EVENT, netvista.wwan_ussd_event, WWAN_USSD_EVENT, PWWAN_USSD_EVENT, PWWAN_USSD_EVENT structure pointer [Network Drivers Starting with Windows Vista], WWAN_USSD_EVENT structure [Network Drivers Starting with Windows Vista], wwan/PWWAN_USSD_EVENT"
