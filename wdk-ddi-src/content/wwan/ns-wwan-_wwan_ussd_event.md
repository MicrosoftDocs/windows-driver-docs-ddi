...
ms.date: 1/18/2018
ms.keywords: WWAN_USSD_EVENT, netvista.wwan_ussd_event, PWWAN_USSD_EVENT, *PWWAN_USSD_EVENT, wwan/PWWAN_USSD_EVENT, PWWAN_USSD_EVENT structure pointer [Network Drivers Starting with Windows Vista], wwan/WWAN_USSD_EVENT, WWAN_USSD_EVENT structure [Network Drivers Starting with Windows Vista], _WWAN_USSD_EVENT
