...
ms.date: 2/16/2018
ms.keywords: wwan/WWAN_SMS_PDU_RECORD, netvista.wwan_sms_pdu_record, WWAN_SMS_PDU_RECORD structure [Network Drivers Starting with Windows Vista], PWWAN_SMS_PDU_RECORD structure pointer [Network Drivers Starting with Windows Vista], *PWWAN_SMS_PDU_RECORD, PWWAN_SMS_PDU_RECORD, WwanRef_b21c5d84-e8d4-4cf4-9942-f6f1a14c23c0.xml, WWAN_SMS_PDU_RECORD, _WWAN_SMS_PDU_RECORD, wwan/PWWAN_SMS_PDU_RECORD
