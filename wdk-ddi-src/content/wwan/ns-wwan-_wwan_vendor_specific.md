...
ms.date: 2/16/2018
ms.keywords: PWWAN_VENDOR_SPECIFIC structure pointer [Network Drivers Starting with Windows Vista], *PWWAN_VENDOR_SPECIFIC, netvista.wwan_vendor_specific, WWAN_VENDOR_SPECIFIC, WWAN_VENDOR_SPECIFIC structure [Network Drivers Starting with Windows Vista], wwan/WWAN_VENDOR_SPECIFIC, PWWAN_VENDOR_SPECIFIC, wwan/PWWAN_VENDOR_SPECIFIC, _WWAN_VENDOR_SPECIFIC, WwanRef_9261cb07-079e-4266-8358-fff73af8c31a.xml
