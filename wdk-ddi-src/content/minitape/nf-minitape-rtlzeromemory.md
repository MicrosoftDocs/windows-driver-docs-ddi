...
title: RtlZeroMemory macro (minitape.h)
description: The RtlZeroMemory macro (minitape.h) fills a block of memory with zeros, given a pointer to the block and the length, in bytes, to be filled.
