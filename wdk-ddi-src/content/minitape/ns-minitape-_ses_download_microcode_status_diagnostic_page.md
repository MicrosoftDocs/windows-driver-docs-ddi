...
description: The _SES_DOWNLOAD_MICROCODE_STATUS_DIAGNOSTIC_PAGE structure (minitape.h) contains information about the status of one or more download microcode operations.
...
# SES_DOWNLOAD_MICROCODE_STATUS_DIAGNOSTIC_PAGE structure (minitape.h)
