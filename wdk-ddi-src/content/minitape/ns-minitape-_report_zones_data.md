...
ms.date: 1/10/2018
ms.keywords: storage.report_zones_data, REPORT_ZONES_DATA structure [Storage Devices], scsi/PREPORT_ZONES_DATA, PREPORT_ZONES_DATA structure pointer [Storage Devices], _REPORT_ZONES_DATA, *PREPORT_ZONES_DATA, PREPORT_ZONES_DATA, REPORT_ZONES_DATA, scsi/REPORT_ZONES_DATA
