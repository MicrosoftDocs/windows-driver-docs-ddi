...
description: Don't use this structure in your code. Microsoft reserves the REPORT_ZONES_DATA structure for internal use only. 
...
# REPORT_ZONES_DATA structure (minitape.h)
