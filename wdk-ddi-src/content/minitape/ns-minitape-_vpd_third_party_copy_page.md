...
description: The _VPD_THIRD_PARTY_COPY_PAGE structure (minitape.h) defines the vital product data (VPD) page for offload data transfer operations.
...
f1_keywords:
 ...
 - minitape/_VPD_THIRD_PARTY_COPY_PAGE
 - PVPD_THIRD_PARTY_COPY_PAGE
 - minitape/PVPD_THIRD_PARTY_COPY_PAGE
...
# VPD_THIRD_PARTY_COPY_PAGE structure (minitape.h)
