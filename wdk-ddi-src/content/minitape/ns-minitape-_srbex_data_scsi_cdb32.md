...
description: The _SRBEX_DATA_SCSI_CDB32 structure (minitape.h) contains the extended SRB data for a 32-byte SCSI command data block (CDB).
...
f1_keywords:
 ...
 - minitape/_SRBEX_DATA_SCSI_CDB32
 - PSRBEX_DATA_SCSI_CDB32
 - minitape/PSRBEX_DATA_SCSI_CDB32
 - SRBEX_DATA_SCSI_CDB32
 - minitape/SRBEX_DATA_SCSI_CDB32
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# _SRBEX_DATA_SCSI_CDB32 structure (minitape.h)
