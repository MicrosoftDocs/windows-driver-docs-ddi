...
description: The _SRBEX_DATA_POWER structure (minitape.h) contains the request data for an extended power SCSI Request Block (SRB).
...
f1_keywords:
 - _SRBEX_DATA_POWER
 - minitape/_SRBEX_DATA_POWER
 - PSRBEX_DATA_POWER
 - minitape/PSRBEX_DATA_POWER
 - SRBEX_DATA_POWER
...
# _SRBEX_DATA_POWER structure (minitape.h)
...
<a href="/windows-hardware/drivers/ddi/storport/ne-storport-_stor_device_power_state">STOR_DEVICE_POWER_STATE</a>
