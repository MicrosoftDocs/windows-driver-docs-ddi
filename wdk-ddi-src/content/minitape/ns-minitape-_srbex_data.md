...
ms.date: 2/16/2018
ms.keywords: PSRBEX_DATA, SrbExDataTypeIoInfo, *PSRBEX_DATA, SrbExDataTypeUnknown, SrbExDataTypeWmi, PSRBEX_DATA structure pointer [Storage Devices], SrbExDataTypeBidirectional, SRBEX_DATA structure [Storage Devices], storage.srbex_data, SrbExDataTypeScsiCdb32, SrbExDataTypePower, SrbExDataTypeScsiCdbVar, SrbExDataTypePnp, storport/SRBEX_DATA, SrbExDataTypeScsiCdb16, _SRBEX_DATA, storport/PSRBEX_DATA, SRBEX_DATA
