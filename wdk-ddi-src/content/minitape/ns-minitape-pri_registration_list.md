...
ms.date: 2/16/2018
ms.keywords: structs-general_ad5a83a3-3ac6-4579-be4f-c24181e9d59e.xml, storport/PPRI_REGISTRATION_LIST, *PPRI_REGISTRATION_LIST, PRI_REGISTRATION_LIST structure [Storage Devices], PPRI_REGISTRATION_LIST, storage.pri_registration_list, storport/PRI_REGISTRATION_LIST, PPRI_REGISTRATION_LIST structure pointer [Storage Devices], PRI_REGISTRATION_LIST
