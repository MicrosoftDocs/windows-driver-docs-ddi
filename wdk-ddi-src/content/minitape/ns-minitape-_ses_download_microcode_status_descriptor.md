...
ms.date: 2/16/2018
ms.keywords: scsi/PSES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR, _SES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR, scsi/SES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR, PSES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR, PSES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR structure pointer [Storage Devices], *PSES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR, SES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR, storage.ses_download_microcode_status_descriptor, SES_DOWNLOAD_MICROCODE_STATUS_DESCRIPTOR structure [Storage Devices]
