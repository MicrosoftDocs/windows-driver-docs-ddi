...
description: The _SRBEX_DATA_BIDIRECTIONAL structure (minitape.h) contains the extended SCSI Request Block (SRB) data for bi-directional transfer commands.
...
f1_keywords:
 ...
 - minitape/_SRBEX_DATA_BIDIRECTIONAL
 - PSRBEX_DATA_BIDIRECTIONAL
 - minitape/PSRBEX_DATA_BIDIRECTIONAL
...
# _SRBEX_DATA_BIDIRECTIONAL structure (minitape.h)
