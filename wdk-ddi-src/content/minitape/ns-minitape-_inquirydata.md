...
title: INQUIRYDATA (minitape.h)
description: The _INQUIRYDATA structure (minitape.h) contains information about the SCSI inquiry data associated with a tape device.
...
f1_keywords:
 - _INQUIRYDATA
 - minitape/_INQUIRYDATA
 - PINQUIRYDATA
 - minitape/PINQUIRYDATA
 - INQUIRYDATA
...
The **INQUIRYDATA** structure is used in conjunction with the [**TapeMiniExtensionInit**](nc-minitape-tape_extension_init_routine.md) and [**TapeMiniVerifyInquiry**](nc-minitape-tape_verify_inquiry_routine.md) routines to report SCSI inquiry data associated with a tape device.
