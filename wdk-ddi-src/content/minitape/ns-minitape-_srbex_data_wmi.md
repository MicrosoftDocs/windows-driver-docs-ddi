...
description: The _SRBEX_DATA_WMI structure (minitape.h) contains the request data for an extended WMI SCSI Request Block (SRB).
...
f1_keywords:
 - _SRBEX_DATA_WMI
 - minitape/_SRBEX_DATA_WMI
 - PSRBEX_DATA_WMI
 - minitape/PSRBEX_DATA_WMI
 - SRBEX_DATA_WMI
