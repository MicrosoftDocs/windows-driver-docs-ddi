...
title: _SRBEX_DATA_IO_INFO (minitape.h)
description: The _SRBEX_DATA_IO_INFO structure (minitape.h ) contains additional information related to a read or write request in an extended SCSI Request Block (SRB).
...
f1_keywords:
 - _SRBEX_DATA_IO_INFO
 - minitape/_SRBEX_DATA_IO_INFO
 - PSRBEX_DATA_IO_INFO
 - minitape/PSRBEX_DATA_IO_INFO
 - SRBEX_DATA_IO_INFO
 - minitape/SRBEX_DATA_IO_INFO
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# _SRBEX_DATA_IO_INFO structure (minitape.h)
