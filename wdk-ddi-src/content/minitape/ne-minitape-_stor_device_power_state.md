...
description: The _STOR_DEVICE_POWER_STATE enumeration (minitape.h) contains values that indicate a device power state.
...
f1_keywords:
 ...
 - minitape/_STOR_DEVICE_POWER_STATE
 - PSTOR_DEVICE_POWER_STATE
 - minitape/PSTOR_DEVICE_POWER_STATE
 - STOR_DEVICE_POWER_STATE
 - minitape/STOR_DEVICE_POWER_STATE
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# _STOR_DEVICE_POWER_STATE enumeration (minitape.h)
