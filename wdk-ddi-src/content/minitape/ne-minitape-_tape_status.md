...
ms.date: 2/16/2018
ms.keywords: TAPE_STATUS_DEVICE_DATA_ERROR, minitape/TAPE_STATUS_SUCCESS, minitape/TAPE_STATUS_SEND_SRB_AND_CALLBACK, minitape/TAPE_STATUS_BEGINNING_OF_MEDIA, minitape/TAPE_STATUS_INVALID_BLOCK_LENGTH, _TAPE_STATUS, minitape/TAPE_STATUS_INSUFFICIENT_RESOURCES, minitape/TAPE_STATUS_INVALID_PARAMETER, TAPE_STATUS_CHECK_TEST_UNIT_READY, TAPE_STATUS_DEVICE_NOT_CONNECTED, minitape/TAPE_STATUS, minitape/TAPE_STATUS_MEDIA_WRITE_PROTECTED, TAPE_STATUS_SETMARK_DETECTED, TAPE_STATUS_FILEMARK_DETECTED, minitape/TAPE_STATUS_DEVICE_DATA_ERROR, TAPE_STATUS_IO_TIMEOUT, TAPE_STATUS_INSUFFICIENT_RESOURCES, minitape/TAPE_STATUS_BUS_RESET, minitape/TAPE_STATUS_EOM_OVERFLOW, minitape/TAPE_STATUS_DEVICE_BUSY, minitape/TAPE_STATUS_REQUIRES_CLEANING, minitape/TAPE_STATUS_CLEANER_CARTRIDGE_INSTALLED, TAPE_STATUS_END_OF_MEDIA, minitape/TAPE_STATUS_BUFFER_OVERFLOW, TAPE_STATUS_CALLBACK, TAPE_STATUS_INVALID_BLOCK_LENGTH, TAPE_STATUS_DEVICE_BUSY, minitape/TAPE_STATUS_NO_MEDIA, minitape/TAPE_STATUS_IO_TIMEOUT, TAPE_STATUS_NOT_IMPLEMENTED, TAPE_STATUS_DATA_OVERRUN, structs-tape_c79a2dd4-8c91-4735-9440-de39b23aa982.xml, *PTAPE_STATUS, PTAPE_STATUS, TAPE_STATUS, minitape/TAPE_STATUS_DEVICE_NOT_READY, TAPE_STATUS_UNRECOGNIZED_MEDIA, TAPE_STATUS_BUFFER_OVERFLOW, PTAPE_STATUS enumeration pointer [Storage Devices], TAPE_STATUS_CLEANER_CARTRIDGE_INSTALLED, minitape/TAPE_STATUS_SETMARK_DETECTED, TAPE_STATUS_NO_SUCH_DEVICE, minitape/TAPE_STATUS_FILEMARK_DETECTED, storage.tape_status, TAPE_STATUS_SEND_SRB_AND_CALLBACK, minitape/TAPE_STATUS_IO_DEVICE_ERROR, TAPE_STATUS_IO_DEVICE_ERROR, minitape/TAPE_STATUS_NOT_IMPLEMENTED, minitape/TAPE_STATUS_NO_DATA_DETECTED, minitape/TAPE_STATUS_INVALID_DEVICE_REQUEST, minitape/TAPE_STATUS_CALLBACK, minitape/TAPE_STATUS_DEVICE_NOT_CONNECTED, TAPE_STATUS enumeration [Storage Devices], minitape/TAPE_STATUS_CHECK_TEST_UNIT_READY, TAPE_STATUS_DEVICE_NOT_READY, minitape/TAPE_STATUS_UNRECOGNIZED_MEDIA, TAPE_STATUS_SUCCESS, minitape/PTAPE_STATUS, minitape/TAPE_STATUS_END_OF_MEDIA, TAPE_STATUS_EOM_OVERFLOW, TAPE_STATUS_INVALID_PARAMETER, TAPE_STATUS_REQUIRES_CLEANING, TAPE_STATUS_NO_MEDIA, TAPE_STATUS_BEGINNING_OF_MEDIA, TAPE_STATUS_NO_DATA_DETECTED, TAPE_STATUS_MEDIA_CHANGED, TAPE_STATUS_MEDIA_WRITE_PROTECTED, minitape/TAPE_STATUS_MEDIA_CHANGED, TAPE_STATUS_BUS_RESET, minitape/TAPE_STATUS_DATA_OVERRUN, minitape/TAPE_STATUS_NO_SUCH_DEVICE, TAPE_STATUS_INVALID_DEVICE_REQUEST
