...
ms.date: 1/10/2018
ms.keywords: TAPE_STATUS_INVALID_PARAMETER, minitape/TAPE_STATUS_INSUFFICIENT_RESOURCES, TAPE_STATUS_END_OF_MEDIA, minitape/TAPE_STATUS_EOM_OVERFLOW, TAPE_STATUS_NO_SUCH_DEVICE, TAPE_STATUS_DEVICE_DATA_ERROR, TAPE_STATUS_INVALID_BLOCK_LENGTH, TAPE_STATUS enumeration [Storage Devices], TAPE_STATUS_CALLBACK, minitape/TAPE_STATUS_IO_DEVICE_ERROR, TAPE_STATUS_SUCCESS, minitape/TAPE_STATUS_DATA_OVERRUN, *PTAPE_STATUS, TAPE_STATUS, minitape/TAPE_STATUS_END_OF_MEDIA, minitape/TAPE_STATUS_SETMARK_DETECTED, TAPE_STATUS_NO_MEDIA, minitape/TAPE_STATUS_MEDIA_WRITE_PROTECTED, TAPE_STATUS_CLEANER_CARTRIDGE_INSTALLED, minitape/TAPE_STATUS_CHECK_TEST_UNIT_READY, TAPE_STATUS_IO_TIMEOUT, minitape/TAPE_STATUS_BUS_RESET, minitape/TAPE_STATUS_SUCCESS, TAPE_STATUS_NO_DATA_DETECTED, TAPE_STATUS_IO_DEVICE_ERROR, TAPE_STATUS_INSUFFICIENT_RESOURCES, minitape/TAPE_STATUS_SEND_SRB_AND_CALLBACK, minitape/TAPE_STATUS_UNRECOGNIZED_MEDIA, minitape/TAPE_STATUS_INVALID_DEVICE_REQUEST, TAPE_STATUS_BUFFER_OVERFLOW, TAPE_STATUS_INVALID_DEVICE_REQUEST, TAPE_STATUS_DATA_OVERRUN, TAPE_STATUS_REQUIRES_CLEANING, storage.tape_status, TAPE_STATUS_FILEMARK_DETECTED, minitape/TAPE_STATUS_NO_DATA_DETECTED, TAPE_STATUS_MEDIA_CHANGED, minitape/TAPE_STATUS_NOT_IMPLEMENTED, minitape/TAPE_STATUS_DEVICE_NOT_READY, TAPE_STATUS_BUS_RESET, TAPE_STATUS_MEDIA_WRITE_PROTECTED, TAPE_STATUS_CHECK_TEST_UNIT_READY, minitape/TAPE_STATUS_BEGINNING_OF_MEDIA, TAPE_STATUS_DEVICE_NOT_READY, minitape/TAPE_STATUS_NO_SUCH_DEVICE, minitape/TAPE_STATUS_DEVICE_NOT_CONNECTED, minitape/TAPE_STATUS_REQUIRES_CLEANING, minitape/TAPE_STATUS_MEDIA_CHANGED, TAPE_STATUS_DEVICE_NOT_CONNECTED, minitape/TAPE_STATUS_CLEANER_CARTRIDGE_INSTALLED, TAPE_STATUS_EOM_OVERFLOW, minitape/TAPE_STATUS_IO_TIMEOUT, TAPE_STATUS_NOT_IMPLEMENTED, minitape/TAPE_STATUS_FILEMARK_DETECTED, TAPE_STATUS_BEGINNING_OF_MEDIA, TAPE_STATUS_UNRECOGNIZED_MEDIA, minitape/TAPE_STATUS_DEVICE_DATA_ERROR, minitape/TAPE_STATUS_BUFFER_OVERFLOW, minitape/TAPE_STATUS_NO_MEDIA, TAPE_STATUS_SETMARK_DETECTED, minitape/TAPE_STATUS, minitape/TAPE_STATUS_INVALID_PARAMETER, PTAPE_STATUS enumeration pointer [Storage Devices], structs-tape_c79a2dd4-8c91-4735-9440-de39b23aa982.xml, minitape/TAPE_STATUS_DEVICE_BUSY, minitape/PTAPE_STATUS, minitape/TAPE_STATUS_INVALID_BLOCK_LENGTH, TAPE_STATUS_SEND_SRB_AND_CALLBACK, minitape/TAPE_STATUS_CALLBACK, PTAPE_STATUS, _TAPE_STATUS, TAPE_STATUS_DEVICE_BUSY
