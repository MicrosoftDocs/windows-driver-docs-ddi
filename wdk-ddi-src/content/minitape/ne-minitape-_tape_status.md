...
ms.date: 2/16/2018
ms.keywords: minitape/TAPE_STATUS_END_OF_MEDIA, minitape/TAPE_STATUS_BEGINNING_OF_MEDIA, minitape/TAPE_STATUS_NO_DATA_DETECTED, structs-tape_c79a2dd4-8c91-4735-9440-de39b23aa982.xml, TAPE_STATUS_END_OF_MEDIA, minitape/TAPE_STATUS_CALLBACK, TAPE_STATUS_INVALID_PARAMETER, minitape/TAPE_STATUS_NO_MEDIA, TAPE_STATUS_IO_TIMEOUT, minitape/TAPE_STATUS_UNRECOGNIZED_MEDIA, TAPE_STATUS_DEVICE_NOT_CONNECTED, TAPE_STATUS_INVALID_DEVICE_REQUEST, _TAPE_STATUS, minitape/TAPE_STATUS_CHECK_TEST_UNIT_READY, minitape/TAPE_STATUS_SEND_SRB_AND_CALLBACK, TAPE_STATUS_BUFFER_OVERFLOW, minitape/TAPE_STATUS_DEVICE_NOT_READY, minitape/TAPE_STATUS_NO_SUCH_DEVICE, TAPE_STATUS_IO_DEVICE_ERROR, TAPE_STATUS_CHECK_TEST_UNIT_READY, minitape/TAPE_STATUS_MEDIA_WRITE_PROTECTED, minitape/TAPE_STATUS_INVALID_BLOCK_LENGTH, minitape/TAPE_STATUS, minitape/TAPE_STATUS_SETMARK_DETECTED, PTAPE_STATUS, minitape/TAPE_STATUS_IO_DEVICE_ERROR, *PTAPE_STATUS, minitape/TAPE_STATUS_FILEMARK_DETECTED, TAPE_STATUS_INVALID_BLOCK_LENGTH, minitape/TAPE_STATUS_DEVICE_DATA_ERROR, TAPE_STATUS_BEGINNING_OF_MEDIA, storage.tape_status, TAPE_STATUS_CLEANER_CARTRIDGE_INSTALLED, minitape/TAPE_STATUS_IO_TIMEOUT, TAPE_STATUS_FILEMARK_DETECTED, TAPE_STATUS_MEDIA_WRITE_PROTECTED, TAPE_STATUS_DEVICE_BUSY, TAPE_STATUS_INSUFFICIENT_RESOURCES, minitape/TAPE_STATUS_NOT_IMPLEMENTED, minitape/TAPE_STATUS_MEDIA_CHANGED, minitape/TAPE_STATUS_EOM_OVERFLOW, TAPE_STATUS_NO_MEDIA, TAPE_STATUS_EOM_OVERFLOW, minitape/TAPE_STATUS_INVALID_PARAMETER, TAPE_STATUS_NO_DATA_DETECTED, minitape/TAPE_STATUS_INVALID_DEVICE_REQUEST, TAPE_STATUS_DEVICE_DATA_ERROR, TAPE_STATUS_REQUIRES_CLEANING, minitape/TAPE_STATUS_DATA_OVERRUN, minitape/TAPE_STATUS_DEVICE_NOT_CONNECTED, TAPE_STATUS enumeration [Storage Devices], minitape/TAPE_STATUS_SUCCESS, minitape/PTAPE_STATUS, TAPE_STATUS_SETMARK_DETECTED, TAPE_STATUS_NO_SUCH_DEVICE, minitape/TAPE_STATUS_CLEANER_CARTRIDGE_INSTALLED, PTAPE_STATUS enumeration pointer [Storage Devices], TAPE_STATUS_SEND_SRB_AND_CALLBACK, TAPE_STATUS_SUCCESS, minitape/TAPE_STATUS_BUFFER_OVERFLOW, minitape/TAPE_STATUS_DEVICE_BUSY, TAPE_STATUS, TAPE_STATUS_UNRECOGNIZED_MEDIA, minitape/TAPE_STATUS_REQUIRES_CLEANING, TAPE_STATUS_BUS_RESET, TAPE_STATUS_MEDIA_CHANGED, TAPE_STATUS_NOT_IMPLEMENTED, minitape/TAPE_STATUS_INSUFFICIENT_RESOURCES, TAPE_STATUS_DEVICE_NOT_READY, TAPE_STATUS_DATA_OVERRUN, TAPE_STATUS_CALLBACK, minitape/TAPE_STATUS_BUS_RESET
...
<a href="mailto:wsddocfb@microsoft.com?subject=Documentation%20feedback [storage\storage]:%20TAPE_STATUS enumeration%20 RELEASE:%20(2/16/2018)&amp;body=%0A%0APRIVACY STATEMENT%0A%0AWe use your feedback to improve the documentation. We don't use your email address for any other purpose, and we'll remove your email address from our system after the issue that you're reporting is fixed. While we're working to fix this issue, we might send you an email message to ask for more info. Later, we might also send you an email message to let you know that we've addressed your feedback.%0A%0AFor more info about Microsoft's privacy policy, see http://privacy.microsoft.com/en-us/default.aspx." title="Send comments about this topic to Microsoft">Send comments about this topic to Microsoft</a>
