...
ms.date: 2/16/2018
ms.keywords: SRB_STATUS_ABORT_FAILED, SRB_STATUS_BUS_RESET, STORAGE_REQUEST_BLOCK, SRB_STATUS_AUTOSENSE_VALID, SRB_FUNCTION_LOCK_QUEUE, SRB_FUNCTION_DUMP_POINTERS, SRB_STATUS_NOT_POWERED, SRB_FUNCTION_FREE_DUMP_POINTERS, SRB_STATUS_REQUEST_FLUSHED, SRB_FLAGS_SGLIST_FROM_POOL, SRB_FLAGS_NO_KEEP_AWAKE, SRB_FUNCTION_RELEASE_RECOVERY, SRB_FUNCTION_RECEIVE_EVENT, SRB_FLAGS_ALLOCATED_FROM_ZONE, SRB_STATUS_INVALID_LUN, SRB_FUNCTION_UNLOCK_QUEUE, SRB_STATUS_PENDING, SRB_STATUS_ERROR, SRB_STATUS_BUSY, SRB_STATUS_NO_HBA, SRB_FUNCTION_CRYPTO_OPERATION, SRB_STATUS_REQUEST_SENSE_FAILED, SRB_STATUS_BAD_SRB_BLOCK_LENGTH, SRB_STATUS_MESSAGE_REJECTED, SRB_STATUS_PHASE_SEQUENCE_FAILURE, SRB_STATUS_LINK_DOWN, SRB_STATUS_UNEXPECTED_BUS_FREE, SRB_FLAGS_DISABLE_DISCONNECT, SRB_FUNCTION_SHUTDOWN, SRB_FUNCTION_POWER, SRB_FLAGS_ADAPTER_CACHE_ENABLE, _STORAGE_REQUEST_BLOCK, SRB_FLAGS_BYPASS_FROZEN_QUEUE, SRB_FLAGS_DISABLE_AUTOSENSE, SRB_FUNCTION_IO_CONTROL, SRB_FLAGS_DISABLE_SYNCH_TRANSFER, SRB_STATUS_DATA_OVERRUN, STORAGE_REQUEST_BLOCK structure [Storage Devices], SRB_STATUS_INVALID_REQUEST, SRB_STATUS_QUEUE_FROZEN, SRB_STATUS_BAD_FUNCTION, SRB_STATUS_NO_DEVICE, SRB_FLAGS_NO_QUEUE_FREEZE, storport/STORAGE_REQUEST_BLOCK, SRB_FLAGS_UNSPECIFIED_DIRECTION, SRB_FUNCTION_FLUSH, SRB_FUNCTION_PNP, storport/PSTORAGE_REQUEST_BLOCK, SRB_FLAGS_FREE_SENSE_BUFFER, SRB_FUNCTION_RESET_BUS, SRB_FUNCTION_EXECUTE_SCSI, SRB_STATUS_INTERNAL_ERROR, SRB_STATUS_ABORTED, SRB_STATUS_TIMEOUT, SRB_STATUS_ERROR_RECOVERY, SRB_STATUS_INVALID_TARGET_ID, storage.storage_request_block, SRB_STATUS_COMMAND_TIMEOUT, SRB_FUNCTION_ABORT_COMMAND, SRB_FLAGS_QUEUE_ACTION_ENABLE, SRB_FLAGS_DATA_OUT, SRB_FLAGS_NO_DATA_TRANSFER, SRB_STATUS_INVALID_PATH_ID, SRB_STATUS_SELECTION_TIMEOUT, SRB_FUNCTION_RESET_DEVICE, SRB_FLAGS_D3_PROCESSING, SRB_FLAGS_DATA_IN, SRB_FLAGS_BYPASS_LOCKED_QUEUE, SRB_FUNCTION_QUIESCE_DEVICE, SRB_FLAGS_IS_ACTIVE, PSTORAGE_REQUEST_BLOCK structure pointer [Storage Devices], PSTORAGE_REQUEST_BLOCK, SRB_FUNCTION_TERMINATE_IO, SRB_FUNCTION_WMI, SRB_STATUS_PARITY_ERROR, SRB_STATUS_SUCCESS, SRB_FUNCTION_RESET_LOGICAL_UNIT
...
Indicates the request-sense command failed. This is returned only if the host bus adapter (HBA) performs auto request sense and the miniport driver set <b>AutoRequestSense</b> to <b>TRUE</b> in the <a href="..\srb\ns-srb-_port_configuration_information.md">PORT_CONFIGURATION_INFORMATION</a> for this HBA.
...
The miniport driver should flush any cached data for the target device. This request is sent to the miniport driver only if it set <b>CachesData</b> to <b>TRUE</b> in the <a href="..\srb\ns-srb-_port_configuration_information.md">PORT_CONFIGURATION_INFORMATION</a> for the HBA. Extended SRB data is not required for this function.
...
Points to the data buffer. Miniport drivers should not use this value as a data pointer unless the miniport driver set <b>MapBuffers</b> to <b>TRUE</b> in the <a href="..\srb\ns-srb-_port_configuration_information.md">PORT_CONFIGURATION_INFORMATION</a> for the HBA. In the case of SRB_FUNCTION_IO_CONTROL requests, however, miniport drivers can use this value as a data pointer regardless of the value of <b>MapBuffers</b>.
