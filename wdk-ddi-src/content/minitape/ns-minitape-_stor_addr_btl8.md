...
description: The _STOR_ADDR_BTL8 structure (minitape.h) contains the addressing information for an 8-bit Bus-Target-LUN (BTL8) address.
...
f1_keywords:
 - _STOR_ADDR_BTL8
 - minitape/_STOR_ADDR_BTL8
 - PSTOR_ADDR_BTL8
 - minitape/PSTOR_ADDR_BTL8
 - STOR_ADDR_BTL8
