...
ms.date: 1/10/2018
ms.keywords: SES_CONFIGURATION_DIAGNOSTIC_PAGE structure [Storage Devices], PSES_CONFIGURATION_DIAGNOSTIC_PAGE, scsi/SES_CONFIGURATION_DIAGNOSTIC_PAGE, *PSES_CONFIGURATION_DIAGNOSTIC_PAGE, _SES_CONFIGURATION_DIAGNOSTIC_PAGE, SES_CONFIGURATION_DIAGNOSTIC_PAGE, PSES_CONFIGURATION_DIAGNOSTIC_PAGE structure pointer [Storage Devices], scsi/PSES_CONFIGURATION_DIAGNOSTIC_PAGE, storage.ses_configuration_diagnostic_page
