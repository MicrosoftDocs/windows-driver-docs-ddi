...
title: STORAGE_MEDIA_TYPE (minitape.h)
description: The _STORAGE_MEDIA_TYPE enumeration (minitape.h) contains values that indicate the types of media that a device supports.
...
f1_keywords:
 - _STORAGE_MEDIA_TYPE
 - minitape/_STORAGE_MEDIA_TYPE
 - PSTORAGE_MEDIA_TYPE
 - minitape/PSTORAGE_MEDIA_TYPE
 - STORAGE_MEDIA_TYPE
...
The STORAGE_MEDIA_TYPE enumeration is used in conjunction with the [**IOCTL_STORAGE_GET_MEDIA_TYPES_EX**](../ntddstor/ni-ntddstor-ioctl_storage_get_media_types_ex.md) request to query the class driver for the types of media that a device supports.
...
[**DEVICE_MEDIA_INFO**](../ntddstor/ns-ntddstor-_device_media_info.md)

[**GET_MEDIA_TYPES**](../ntddstor/ns-ntddstor-_get_media_types.md)

[**IOCTL_STORAGE_GET_MEDIA_TYPES_EX**](../ntddstor/ni-ntddstor-ioctl_storage_get_media_types_ex.md)
