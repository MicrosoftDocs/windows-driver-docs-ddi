...
<b>VideoPortGetMdl</b> retrieves the memory descriptor list (<a href="/windows-hardware/drivers/ddi/wdm/ns-wdm-_mdl">MDL</a>) that represents the page table of the locked buffer.
