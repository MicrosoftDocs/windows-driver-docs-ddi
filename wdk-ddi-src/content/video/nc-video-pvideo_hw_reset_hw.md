...
<i>HwVidResetHw</i> must not call <a href="/windows-hardware/drivers/ddi/video/nf-video-videoportint10">VideoPortInt10</a>. A miniport driver's <a href="/windows-hardware/drivers/ddi/video/nc-video-pvideo_hw_start_io">HwVidStartIO</a> function is called with the <a href="/windows-hardware/drivers/ddi/ntddvdeo/ni-ntddvdeo-ioctl_video_reset_device">IOCTL_VIDEO_RESET_DEVICE</a><a href="/windows-hardware/drivers/">VRP</a> to reset the adapter whenever the Display program is used to test or change the graphics display mode, <i>not</i> the miniport driver's <i>HwVidResetHw</i> function.
...
<a href="/windows-hardware/drivers/ddi/ntddvdeo/ni-ntddvdeo-ioctl_video_reset_device">IOCTL_VIDEO_RESET_DEVICE</a>
