...
tech.root: display
ms.date: 05/10/2018
keywords: ["VIDEO_X86_BIOS_ARGUMENTS structure"]
...
f1_keywords:
 ...
 - video/_VIDEO_X86_BIOS_ARGUMENTS
 - PVIDEO_X86_BIOS_ARGUMENTS
 - video/PVIDEO_X86_BIOS_ARGUMENTS
...
# VIDEO_X86_BIOS_ARGUMENTS structure (video.h)
...
MS-DOS INT10s are usually "set mode" requests for the video adapter. Each value is put in the appropriate register and an INT10 call is performed by <a href="/windows-hardware/drivers/ddi/video/nf-video-videoportint10">VideoPortInt10</a>.
