...
ms.date: 12/29/2017
ms.keywords: Video_Structs_15076908-e598-4025-8884-a9ed60b1668c.xml, *PVIDEO_PORT_WCMEMORYPROTECTION_INTERFACE, display.video_port_wcmemoryprotection_interface, PVIDEO_PORT_WCMEMORYPROTECTION_INTERFACE, _VIDEO_PORT_WCMEMORYPROTECTION_INTERFACE, VIDEO_PORT_WCMEMORYPROTECTION_INTERFACE, video/VIDEO_PORT_WCMEMORYPROTECTION_INTERFACE, PVIDEO_PORT_WCMEMORYPROTECTION_INTERFACE structure pointer [Display Devices], VIDEO_PORT_WCMEMORYPROTECTION_INTERFACE structure [Display Devices], video/PVIDEO_PORT_WCMEMORYPROTECTION_INTERFACE
