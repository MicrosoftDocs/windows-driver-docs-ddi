...
<li>
The miniport driver's interrupt handler (<a href="/windows-hardware/drivers/ddi/video/nc-video-pvideo_hw_interrupt">HwVidInterrupt</a>) queues a DPC routine (<a href="/windows-hardware/drivers/ddi/video/nc-video-pminiport_dpc_routine">HwVidDpcRoutine</a>) by calling <a href="/windows-hardware/drivers/ddi/video/nf-video-videoportqueuedpc">VideoPortQueueDpc</a>.
...
<b>VideoPortEnumerateChildren</b> causes <a href="/windows-hardware/drivers/ddi/video/nc-video-pvideo_hw_get_child_descriptor">HwVidGetVideoChildDescriptor</a> to be called, allowing the Plug and Play Manager to enumerate all of the adapter's child devices.
