...
ms.date: 12/29/2017
ms.keywords: VIDEO_PORT_CONFIG_INFO structure [Display Devices], PVIDEO_PORT_CONFIG_INFO structure pointer [Display Devices], _VIDEO_PORT_CONFIG_INFO, video/VIDEO_PORT_CONFIG_INFO, Video_Structs_5566366c-4ec3-4983-873f-28af2fe51bd6.xml, video/PVIDEO_PORT_CONFIG_INFO, *PVIDEO_PORT_CONFIG_INFO, display.video_port_config_info, VIDEO_PORT_CONFIG_INFO, PVIDEO_PORT_CONFIG_INFO
