...
ms.date: 12/29/2017
ms.keywords: display.vp_scatter_gather_list, PVP_SCATTER_GATHER_LIST structure pointer [Display Devices], VP_SCATTER_GATHER_LIST, _VP_SCATTER_GATHER_LIST, video/VP_SCATTER_GATHER_LIST, PVP_SCATTER_GATHER_LIST, VP_SCATTER_GATHER_LIST structure [Display Devices], video/PVP_SCATTER_GATHER_LIST, Video_Structs_0b59cadd-bf97-44c9-b987-d4dfc5eaaf15.xml, *PVP_SCATTER_GATHER_LIST
