...
ms.date: 12/29/2017
ms.keywords: VP_SCATTER_GATHER_LIST structure [Display Devices], video/VP_SCATTER_GATHER_LIST, *PVP_SCATTER_GATHER_LIST, Video_Structs_0b59cadd-bf97-44c9-b987-d4dfc5eaaf15.xml, video/PVP_SCATTER_GATHER_LIST, display.vp_scatter_gather_list, PVP_SCATTER_GATHER_LIST structure pointer [Display Devices], VP_SCATTER_GATHER_LIST, _VP_SCATTER_GATHER_LIST, PVP_SCATTER_GATHER_LIST
