...
You should not call <a href="/windows-hardware/drivers/ddi/video/nf-video-videoportdisableinterrupt">VideoPortDisableInterrupt</a> or <b>VideoPortEnableInterrupt</b> for the following reasons:
...
If the video miniport driver has not registered an <a href="/windows-hardware/drivers/ddi/video/nc-video-pvideo_hw_interrupt">HwVidInterrupt</a> routine for the display adapter, <b>VideoPortEnableInterrupt</b> returns ERROR_INVALID_FUNCTION.
