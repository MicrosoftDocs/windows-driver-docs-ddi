...
ms.date: 2/16/2018
ms.keywords: MmProbeAndLockSelectedPages routine [Kernel-Mode Driver Architecture], wdm/MmProbeAndLockSelectedPages, MmProbeAndLockSelectedPages, kernel.mmprobeandlockselectedpages_
