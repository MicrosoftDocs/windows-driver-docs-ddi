...
ms.date: 2/16/2018
ms.keywords: PCLFS_LSN, *PCLFS_LSN, PPCLS_LSN, PPCLS_LSN structure pointer [Kernel-Mode Driver Architecture], wdm/PCLFS_LSN, PCLS_LSN structure pointer [Kernel-Mode Driver Architecture], CLFS_LSN, wdm/PPCLS_LSN, wdm/PPCLFS_LSN, PPCLFS_LSN structure pointer [Kernel-Mode Driver Architecture], PPCLFS_LSN, CLS_LSN, *PCLS_LSN, wdm/PCLS_LSN, _CLS_LSN, kernel.clfs_lsn, CLS_LSN structure [Kernel-Mode Driver Architecture], wdm/CLS_LSN, kstruct_a_25e68bfe-85ad-4716-a47f-7f248ca068e4.xml, PCLFS_LSN structure pointer [Kernel-Mode Driver Architecture], PCLFS_LSN structure [Kernel-Mode Driver Architecture], PCLS_LSN
