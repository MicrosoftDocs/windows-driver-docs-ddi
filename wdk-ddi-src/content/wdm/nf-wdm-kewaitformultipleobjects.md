...
The <i>Alertable</i> parameter determines when the thread can be alerted and its wait state consequently aborted. For additional information, see <a href="/windows-hardware/drivers/kernel/waits-and-apcs">Waits and APCs</a>.
