...
description: The IoGetAttachedDeviceReference routine in wdm.h returns a pointer to the highest level device object in a driver stack and increments the reference count.
...
f1_keywords:
 ...
 - wdm/IoGetAttachedDeviceReference
topic_type:
 - APIRef
 - kbSyntax
api_type:
