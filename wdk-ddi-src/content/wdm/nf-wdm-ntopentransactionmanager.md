...
tech.root: kernel
ms.date: 04/30/2018
keywords: ["NtOpenTransactionManager function"]
...
# NtOpenTransactionManager function (wdm.h)
...
<li>
Use the <i>ObjectAttributes</i> parameter to supply an <a href="/windows/win32/api/ntdef/ns-ntdef-_object_attributes">OBJECT_ATTRIBUTES</a> structure that contains the object name that the caller previously specified to the <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-ntcreatetransactionmanager">ZwCreateTransactionManager</a> routine. 
...
Your TPS component must call <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-ntrecovertransactionmanager">ZwRecoverTransactionManager</a> after it has called <b>ZwOpenTransactionManager</b>.

A TPS component that calls <b>ZwOpenTransactionManager</b> must eventually call <a href="/windows-hardware/drivers/ddi/ntifs/nf-ntifs-ntclose">ZwClose</a> to close the object handle.

For more information about how to use <b>ZwOpenTransactionManager</b>, see <a href="/windows-hardware/drivers/kernel/transaction-manager-objects">Transaction Manager Objects</a> and <a href="/windows-hardware/drivers/kernel/creating-a-resource-manager">Creating a Resource Manager</a>.
