...
ms.date: 1/4/2018
ms.keywords: _REG_ENUMERATE_VALUE_KEY_INFORMATION, *PREG_ENUMERATE_VALUE_KEY_INFORMATION, REG_ENUMERATE_VALUE_KEY_INFORMATION
...
req.kmdf-ver: 
req.umdf-ver: 
req.alt-api: REG_ENUMERATE_VALUE_KEY_INFORMATION
req.alt-loc: Wdm.h
req.ddi-compliance: 
req.unicode-ansi: 
req.idl: 
