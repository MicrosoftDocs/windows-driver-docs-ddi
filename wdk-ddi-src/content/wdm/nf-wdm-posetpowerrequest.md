...
ms.date: 2/16/2018
ms.keywords: portn_8f3abb03-a324-4841-b630-b62344d656ce.xml, PoSetPowerRequest routine [Kernel-Mode Driver Architecture], PoSetPowerRequest, wdm/PoSetPowerRequest, kernel.posetpowerrequest
...
A driver can call the <b>PoSetPowerRequest</b> routine to request that the <a href="https://msdn.microsoft.com/library/windows/hardware/ff559829">power manager</a> override several types of default power behavior, which are specified as <a href="..\ntpoapi\ne-ntpoapi-_power_request_type.md">POWER_REQUEST_TYPE</a> enumeration values. To restore the default behavior, the driver cancels the request by calling the <a href="..\ntifs\nf-ntifs-poclearpowerrequest.md">PoClearPowerRequest</a> routine.
