...
ms.date: 2/16/2018
ms.keywords: DMA_ TRANSFER _INFO_V1 structure [Kernel-Mode Driver Architecture], DMA_TRANSFER_INFO_V1, wdm/ DMA_ TRANSFER _INFO_V1, kernel.dma_transfer_info_v1, wdm/PDMA_ TRANSFER _INFO_V1, DMA_ TRANSFER _INFO_V1, PDMA_ TRANSFER _INFO_V1, PDMA_ TRANSFER _INFO_V1 structure pointer [Kernel-Mode Driver Architecture], _DMA_TRANSFER_INFO_V1, *PDMA_TRANSFER_INFO_V1, DMA_TRANSFER_INFO_V1 structure [Kernel-Mode Driver Architecture]
