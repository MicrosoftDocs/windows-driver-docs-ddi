...
ms.date: 1/4/2018
ms.keywords: HWPROFILE_CHANGE_NOTIFICATION structure [Kernel-Mode Driver Architecture], wdm/HWPROFILE_CHANGE_NOTIFICATION, kernel.hwprofile_change_notification, PHWPROFILE_CHANGE_NOTIFICATION, *PHWPROFILE_CHANGE_NOTIFICATION, wdm/PHWPROFILE_CHANGE_NOTIFICATION, HWPROFILE_CHANGE_NOTIFICATION, _HWPROFILE_CHANGE_NOTIFICATION, PHWPROFILE_CHANGE_NOTIFICATION structure pointer [Kernel-Mode Driver Architecture], kstruct_b_2e8d0c69-abe9-49a9-96f6-fba3b0020ff8.xml
