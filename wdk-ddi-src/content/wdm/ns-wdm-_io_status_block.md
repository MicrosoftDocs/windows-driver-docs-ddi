...
ms.date: 04/30/2018
keywords: ["IO_STATUS_BLOCK structure"]
...
f1_keywords:
 - _IO_STATUS_BLOCK
 - wdm/_IO_STATUS_BLOCK
 - PIO_STATUS_BLOCK
 - wdm/PIO_STATUS_BLOCK
 - IO_STATUS_BLOCK
 - wdm/IO_STATUS_BLOCK
topic_type:
 - APIRef
...
A driver sets an IRP's I/O status block to indicate the final status of an I/O request, before calling <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-iocompleterequest">IoCompleteRequest</a> for the IRP.
