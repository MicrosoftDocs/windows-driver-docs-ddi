...
ms.date: 2/16/2018
ms.keywords: wdm/CmGetBoundTransaction, kernel.cmgetboundtransaction, CmGetBoundTransaction routine [Kernel-Mode Driver Architecture], CmGetBoundTransaction, ConfigMgrRef_bf8b79d4-04cf-4cd2-b25c-4e59c63f0b86.xml
