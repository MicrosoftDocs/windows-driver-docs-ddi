...
The <b>IoStartNextPacket</b> routine dequeues the next IRP, if any, from the given device object's associated device queue and calls the driver's <a href="/windows-hardware/drivers/ddi/wdm/nc-wdm-driver_startio">StartIo</a> routine.
...
<a href="/windows-hardware/drivers/ddi/ntifs/nf-ntifs-iosetstartioattributes">IoSetStartIoAttributes</a>
