...
ms.date: 1/4/2018
ms.keywords: "_PO_FX_DEVICE_V2, *PPO_FX_DEVICE_V1, PO_FX_DEVICE structure [Kernel-Mode Driver Architecture], wdm/PO_FX_DEVICE_V1, PO_FX_DEVICE, PPO_FX_DEVICE_V1, _PO_FX_DEVICE_V1, PO_FX_DEVICE_V1 structure [Kernel-Mode Driver Architecture], kernel.po_fx_device, wdm/PPO_FX_DEVICE_V1, wdm/PO_FX_DEVICE, PO_FX_DEVICE_V2, PPO_FX_DEVICE_V1 structure pointer [Kernel-Mode Driver Architecture], PO_FX_DEVICE_V1, *PPO_FX_DEVICE_V2, *PPO_FX_DEVICE"
