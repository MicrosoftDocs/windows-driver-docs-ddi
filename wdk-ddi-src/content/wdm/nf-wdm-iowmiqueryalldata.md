...
To query for multiple WMI classes, use <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nf-wdm-iowmiqueryalldatamultiple">IoWMIQueryAllDataMultiple</a>.
