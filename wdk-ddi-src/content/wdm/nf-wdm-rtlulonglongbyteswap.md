...
# RtlUlonglongByteSwap function (wdm.h)
...
To reverse the ordering of bytes in a USHORT value, use the <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-rtlushortbyteswap">RtlUshortByteSwap</a> routine. To reverse ordering of bytes in a ULONG value, use the <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-rtlulongbyteswap">RtlUlongByteSwap</a> routine.
