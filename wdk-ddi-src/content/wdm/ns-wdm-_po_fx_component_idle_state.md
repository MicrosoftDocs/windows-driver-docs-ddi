...
tech.root: kernel
ms.date: 04/30/2018
keywords: ["PO_FX_COMPONENT_IDLE_STATE structure"]
...
f1_keywords:
 ...
 - wdm/_PO_FX_COMPONENT_IDLE_STATE
 - PPO_FX_COMPONENT_IDLE_STATE
 - wdm/PPO_FX_COMPONENT_IDLE_STATE
 - PO_FX_COMPONENT_IDLE_STATE
 - wdm/PO_FX_COMPONENT_IDLE_STATE
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# PO_FX_COMPONENT_IDLE_STATE structure (wdm.h)
...
## -remarks
 ...
 The <a href="/windows-hardware/drivers/ddi/wdm/ns-wdm-_po_fx_component_v1">PO_FX_COMPONENT</a> structure contains a pointer to an array of <b>PO_FX_COMPONENT_IDLE_STATE</b> structures. Each array element specifies the attributes of an Fx state. Element 0 describes F0, element 1 describes F1, and so on.
