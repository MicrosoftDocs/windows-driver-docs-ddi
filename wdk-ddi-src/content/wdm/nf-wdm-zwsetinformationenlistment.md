...
tech.root: kernel
ms.date: 04/30/2018
keywords: ["ZwSetInformationEnlistment function"]
...
# ZwSetInformationEnlistment function (wdm.h)
...
The <b>ZwSetInformationEnlistment</b> routine sets information for a specified <a href="/windows-hardware/drivers/kernel/enlistment-objects">enlistment object</a>.
...
A <a href="/windows-hardware/drivers/ddi/wdm/ne-wdm-_enlistment_information_class">ENLISTMENT_INFORMATION_CLASS</a>-typed enumeration value that specifies the type of information to be set. This value must be <b>EnlistmentRecoveryInformation</b>.
...
A resource manager can use the <b>ZwSetInformationEnlistment</b> routine to set recovery information for an enlistment. KTM writes the recovery information to the log stream, and the resource manager can call <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-ntqueryinformationenlistment">ZwQueryInformationEnlistment</a> to read this information from the log stream at any time.
...
For more information about how to use <b>ZwSetInformationEnlistment</b>, see <a href="/windows-hardware/drivers/kernel/using-log-streams-with-ktm">Using Log Streams with KTM</a>.
