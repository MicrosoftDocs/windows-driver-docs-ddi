...
The PCW_DATA structure describes the array of data blocks that are associated with an instance. This structure is used with the <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-pcwaddinstance">PcwAddInstance</a> and <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/wdm/nf-wdm-pcwcreateinstance">PcwCreateInstance</a> functions. Most developers do not need to access this structure directly because it is automatically managed by the Add/Create helper functions generated by the <a href="https://docs.microsoft.com/windows/win32/perfctrs/ctrpp">CTRPP.exe</a> tool.
