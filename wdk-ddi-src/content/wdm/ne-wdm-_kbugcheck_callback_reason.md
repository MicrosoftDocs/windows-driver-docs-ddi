...
Specifies that the callback is executed to add virtual memory ranges the driver wants in the dump file. For more information about this type of callback, see <a href="..\wdm\nc-wdm-kbugcheck_reason_callback_routine.md">BugCheckAddPagesCallback</a>. This enumeration value is supported in Windows 10 RS5 / Windows Server 2019 and later versions of Windows.
