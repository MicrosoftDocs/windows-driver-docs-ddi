...
Calling <b>ClfsReserveAndAppendLog</b> is equivalent to calling <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-clfsreserveandappendlogaligned">ClfsReserveAndAppendLogAligned</a> with the <i>cbEntryAlignment</i> parameter set to one.
