...
ms.date: 1/4/2018
ms.keywords: kstruct_d_79809cef-3593-4774-8407-c26c281735eb.xml, kernel.reg_create_key_information_v1, REG_OPEN_KEY_INFORMATION_V1 structure [Kernel-Mode Driver Architecture], PREG_CREATE_KEY_INFORMATION_V1 structure pointer [Kernel-Mode Driver Architecture], REG_CREATE_KEY_INFORMATION_V1, *PREG_OPEN_KEY_INFORMATION_V1, wdm/REG_CREATE_KEY_INFORMATION_V1, wdm/PREG_OPEN_KEY_INFORMATION_V1, wdm/REG_OPEN_KEY_INFORMATION_V1, PREG_CREATE_KEY_INFORMATION_V1, _REG_CREATE_KEY_INFORMATION_V1, *PREG_CREATE_KEY_INFORMATION_V1, PREG_OPEN_KEY_INFORMATION_V1 structure pointer [Kernel-Mode Driver Architecture], REG_CREATE_KEY_INFORMATION_V1 structure [Kernel-Mode Driver Architecture], REG_OPEN_KEY_INFORMATION_V1, wdm/PREG_CREATE_KEY_INFORMATION_V1, PREG_OPEN_KEY_INFORMATION_V1
