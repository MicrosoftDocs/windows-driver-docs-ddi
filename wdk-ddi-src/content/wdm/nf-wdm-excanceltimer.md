...
The <b>ExCancelTimer</b> routine cancels a timer that was set by a previous call to the <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-exsettimer">ExSetTimer</a> routine.
