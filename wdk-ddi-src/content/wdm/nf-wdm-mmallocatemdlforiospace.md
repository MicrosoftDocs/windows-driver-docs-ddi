...
ms.date: 1/4/2018
ms.keywords: kernel.mmallocatemdlforiospace, wdm/MmAllocateMdlForIoSpace, MmAllocateMdlForIoSpace, MmAllocateMdlForIoSpace routine [Kernel-Mode Driver Architecture]
