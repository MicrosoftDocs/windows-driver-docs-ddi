...
For better performance, use <b>KeClearEvent</b> unless the caller uses the value returned by <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-keresetevent">KeResetEvent</a> to determine what to do next.
