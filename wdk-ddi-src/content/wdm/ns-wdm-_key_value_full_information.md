...
f1_keywords:
 ...
 - wdm/_KEY_VALUE_FULL_INFORMATION
 - PKEY_VALUE_FULL_INFORMATION
 - wdm/PKEY_VALUE_FULL_INFORMATION
...
Specifies the system-defined type for the registry value(s) following the <b>Name</b> member. For a summary of these types, see <a href="/windows-hardware/drivers/ddi/wdm/ns-wdm-_key_value_basic_information">KEY_VALUE_BASIC_INFORMATION</a>.
