...
description: The _PCI_SLOT_NUMBER structure (wdm.h) is obsolete. It defines the format of the Slot parameter to the obsolete HalXxxBusData routines.
...
f1_keywords:
 - _PCI_SLOT_NUMBER
 - wdm/_PCI_SLOT_NUMBER
 - PPCI_SLOT_NUMBER
 - wdm/PPCI_SLOT_NUMBER
 - PCI_SLOT_NUMBER
 - wdm/PCI_SLOT_NUMBER
topic_type:
 - APIRef
...
# PCI_SLOT_NUMBER structure (wdm.h)
