...
ms.date: 1/4/2018
ms.keywords: wdm/IoReportInterruptInactive, kernel.ioreportinterruptinactive, IoReportInterruptInactive, IoReportInterruptInactive routine [Kernel-Mode Driver Architecture]
