...
ms.date: 2/24/2018
ms.keywords: ",  , *, *PEXT_SET_PARAMETERS, *PKT2_SET_PARAMETERS, ,, 0, 2, A, E, EXT_SET_PARAMETERS, EXT_SET_PARAMETERS structure [Kernel-Mode Driver Architecture], K, KT2_SET_PARAMETERS, M, P, PEXT_SET_PARAMETERS, PEXT_SET_PARAMETERS structure pointer [Kernel-Mode Driver Architecture], R, S, T, V, X, _, _EXT_SET_PARAMETERS_V0, kernel.ext_set_parameters, wdm/EXT_SET_PARAMETERS, wdm/PEXT_SET_PARAMETERS"
