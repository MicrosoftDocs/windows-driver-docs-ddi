...
Specifies the target DRIPS device power state. Possible values are defined in the <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wudfddi/ne-wudfddi-_device_power_state">DEVICE_POWER_STATE</a> enumeration. This value must
