...
The <b>ZwRecoverTransactionManager</b> routine tries to reconstruct the state of the transaction manager object, including all transactions, enlistments, and resource managers, from the recovery information that is in the object's log stream, beginning at the last <a href="/windows-hardware/drivers/kernel/reading-restart-records-from-a-clfs-stream">restart area</a> that KTM created and ending at the stream's end.

To recover up to a specific virtual time, use the <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-ntrollforwardtransactionmanager">ZwRollforwardTransactionManager</a> routine instead of <b>ZwRecoverTransactionManager</b>.

Your TPS component must call <b>ZwRecoverTransactionManager</b> after it has called <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-ntcreatetransactionmanager">ZwCreateTransactionManager</a> or <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-ntopentransactionmanager">ZwOpenTransactionManager</a>.
