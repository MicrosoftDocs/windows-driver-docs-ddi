...
tech.root: kernel
ms.date: 04/30/2018
keywords: ["REG_RENAME_KEY_INFORMATION structure"]
...
f1_keywords:
 ...
 - wdm/_REG_RENAME_KEY_INFORMATION
 - PREG_RENAME_KEY_INFORMATION
 - wdm/PREG_RENAME_KEY_INFORMATION
...
# REG_RENAME_KEY_INFORMATION structure (wdm.h)
...
A pointer to a <a href="/windows/win32/api/ntdef/ns-ntdef-_unicode_string">UNICODE_STRING</a> structure that contains the new name for the registry key.
