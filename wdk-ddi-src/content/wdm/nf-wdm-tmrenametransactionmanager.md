...
ms.date: 1/4/2018
ms.keywords: kernel.tmrenametransactionmanager_, TmRenameTransactionManager routine [Kernel-Mode Driver Architecture], TmRenameTransactionManager, wdm/TmRenameTransactionManager
