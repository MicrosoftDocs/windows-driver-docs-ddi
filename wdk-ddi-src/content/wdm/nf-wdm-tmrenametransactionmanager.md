...
ms.date: 2/16/2018
ms.keywords: kernel.tmrenametransactionmanager_, wdm/TmRenameTransactionManager, TmRenameTransactionManager routine [Kernel-Mode Driver Architecture], TmRenameTransactionManager
