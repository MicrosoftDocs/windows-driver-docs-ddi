...
ms.date: 1/4/2018
ms.keywords: KBUGCHECK_SECONDARY_DUMP_DATA, wdm/PKBUGCHECK_SECONDARY_DUMP_DATA, kernel.kbugcheck_secondary_dump_data, PKBUGCHECK_SECONDARY_DUMP_DATA, KBUGCHECK_SECONDARY_DUMP_DATA structure [Kernel-Mode Driver Architecture], PKBUGCHECK_SECONDARY_DUMP_DATA structure pointer [Kernel-Mode Driver Architecture], *PKBUGCHECK_SECONDARY_DUMP_DATA, wdm/KBUGCHECK_SECONDARY_DUMP_DATA, _KBUGCHECK_SECONDARY_DUMP_DATA, kstruct_c_a9e0d726-41eb-4cf2-b2d4-c977be8750bb.xml
