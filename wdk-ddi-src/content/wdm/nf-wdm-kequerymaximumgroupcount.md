...
To obtain the number of active groups in a multiprocessor system, call the <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/ntddk/nf-ntddk-kequeryactivegroupcount">KeQueryActiveGroupCount</a> routine.
