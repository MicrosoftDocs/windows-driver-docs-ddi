...
ms.date: 1/4/2018
ms.keywords: wdm/PowerRequestExecutionRequired, kernel.power_request_type, PowerRequestSystemRequired, wdm/PPOWER_REQUEST_TYPE, PowerRequestAwayModeRequired, wdm/POWER_REQUEST_TYPE, PowerRequestExecutionRequired, wdm/PowerRequestSystemRequired, *PPOWER_REQUEST_TYPE, _POWER_REQUEST_TYPE, PPOWER_REQUEST_TYPE, sysenum_2d1a5da5-2541-4db1-bfde-2bd06f38b17c.xml, PowerRequestDisplayRequired, wdm/PowerRequestDisplayRequired, POWER_REQUEST_TYPE enumeration [Kernel-Mode Driver Architecture], POWER_REQUEST_TYPE, PPOWER_REQUEST_TYPE enumeration pointer [Kernel-Mode Driver Architecture], wdm/PowerRequestAwayModeRequired
