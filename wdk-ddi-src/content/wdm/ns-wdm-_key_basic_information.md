...
ms.date: 2/16/2018
ms.keywords: wdm/PKEY_BASIC_INFORMATION, KEY_BASIC_INFORMATION structure [Kernel-Mode Driver Architecture], PKEY_BASIC_INFORMATION structure pointer [Kernel-Mode Driver Architecture], kernel.key_basic_information, *PKEY_BASIC_INFORMATION, wdm/KEY_BASIC_INFORMATION, PKEY_BASIC_INFORMATION, KEY_BASIC_INFORMATION, _KEY_BASIC_INFORMATION, kstruct_c_85ec4926-6fc1-42c1-8992-dd37ee92e5cf.xml
