...
ms.date: 2/16/2018
ms.keywords: "_REG_POST_CREATE_KEY_INFORMATION, REG_POST_CREATE_KEY_INFORMATION structure [Kernel-Mode Driver Architecture], kernel.reg_post_create_key_information, wdm/REG_POST_CREATE_KEY_INFORMATION, *PREG_POST_OPEN_KEY_INFORMATION, REG_POST_CREATE_KEY_INFORMATION, wdm/PREG_POST_CREATE_KEY_INFORMATION, REG_POST_OPEN_KEY_INFORMATION, REG_POST_OPEN_KEY_INFORMATION structure [Kernel-Mode Driver Architecture], PREG_POST_CREATE_KEY_INFORMATION structure pointer [Kernel-Mode Driver Architecture], wdm/REG_POST_OPEN_KEY_INFORMATION, PREG_POST_CREATE_KEY_INFORMATION, kstruct_d_31e99ef7-d3dc-425d-9cc4-2735c50dd7dc.xml, *PREG_POST_CREATE_KEY_INFORMATION"
