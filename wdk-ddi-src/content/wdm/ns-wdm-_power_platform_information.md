...
ms.date: 1/4/2018
ms.keywords: PPOWER_PLATFORM_INFORMATION, wdm/PPOWER_PLATFORM_INFORMATION, _POWER_PLATFORM_INFORMATION, POWER_PLATFORM_INFORMATION structure [Kernel-Mode Driver Architecture], PPOWER_PLATFORM_INFORMATION structure pointer [Kernel-Mode Driver Architecture], kernel.power_platform_information, wdm/POWER_PLATFORM_INFORMATION, *PPOWER_PLATFORM_INFORMATION, POWER_PLATFORM_INFORMATION
