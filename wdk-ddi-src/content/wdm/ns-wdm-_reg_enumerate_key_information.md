...
ms.date: 2/16/2018
ms.keywords: PREG_ENUMERATE_KEY_INFORMATION structure pointer [Kernel-Mode Driver Architecture], kstruct_d_e20923be-cb64-43a0-b3d0-a28290fadc07.xml, REG_ENUMERATE_KEY_INFORMATION structure [Kernel-Mode Driver Architecture], REG_ENUMERATE_KEY_INFORMATION, wdm/REG_ENUMERATE_KEY_INFORMATION, wdm/PREG_ENUMERATE_KEY_INFORMATION, PREG_ENUMERATE_KEY_INFORMATION, kernel.reg_enumerate_key_information, _REG_ENUMERATE_KEY_INFORMATION, *PREG_ENUMERATE_KEY_INFORMATION
