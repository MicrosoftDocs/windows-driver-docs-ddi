...
The **DEVICE_RESET_TYPE** enumeration specifies the type of device reset that is being requested by a call to the [DeviceReset](/windows-hardware/drivers/ddi/wdm/nc-wdm-device_reset_handler) routine of the GUID_DEVICE_RESET_INTERFACE_STANDARD interface.
