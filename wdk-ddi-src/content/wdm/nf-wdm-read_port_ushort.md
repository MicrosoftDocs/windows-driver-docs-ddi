...
title: READ_PORT_USHORT function (wdm.h)
description: The READ_PORT_USHORT function (wdm.h) returns a USHORT value that is read from the specified port address in resident, mapped device memory.
