...
ms.date: 2/16/2018
ms.keywords: wdm/ClfsMgmtPolicyLogTail, wdm/ClfsMgmtPolicyNewContainerSize, wdm/ClfsMgmtPolicyAutoShrink, ClfsMgmtPolicyMinimumSize, kernel.clfs_mgmt_policy_type, CLFS_MGMT_POLICY_TYPE, ClfsMgmtPolicyNewContainerPrefix, wdm/ClfsMgmtPolicyMinimumSize, PCLFS_MGMT_POLICY_TYPE enumeration pointer [Kernel-Mode Driver Architecture], wdm/CLFS_MGMT_POLICY_TYPE, wdm/ClfsMgmtPolicyMaximumSize, wdm/ClfsMgmtPolicyNewContainerExtension, wdm/ClfsMgmtPolicyAutoGrow, sysenum_bae8275b-5f70-40fb-ae14-f803eaeb0a42.xml, wdm/ClfsMgmtPolicyInvalid, PCLFS_MGMT_POLICY_TYPE, ClfsMgmtPolicyNewContainerSize, ClfsMgmtPolicyLogTail, wdm/ClfsMgmtPolicyNewContainerPrefix, ClfsMgmtPolicyAutoShrink, _CLFS_MGMT_POLICY_TYPE, ClfsMgmtPolicyMaximumSize, ClfsMgmtPolicyInvalid, ClfsMgmtPolicyNewContainerSuffix, ClfsMgmtPolicyGrowthRate, wdm/PCLFS_MGMT_POLICY_TYPE, ClfsMgmtPolicyNewContainerExtension, wdm/ClfsMgmtPolicyNewContainerSuffix, *PCLFS_MGMT_POLICY_TYPE, ClfsMgmtPolicyAutoGrow, wdm/ClfsMgmtPolicyGrowthRate, CLFS_MGMT_POLICY_TYPE enumeration [Kernel-Mode Driver Architecture]
