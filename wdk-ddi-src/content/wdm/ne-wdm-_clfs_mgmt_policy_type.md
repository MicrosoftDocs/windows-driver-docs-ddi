...
ms.date: 2/16/2018
ms.keywords: wdm/ClfsMgmtPolicyNewContainerSize, wdm/ClfsMgmtPolicyInvalid, ClfsMgmtPolicyNewContainerSuffix, ClfsMgmtPolicyNewContainerSize, PCLFS_MGMT_POLICY_TYPE enumeration pointer [Kernel-Mode Driver Architecture], CLFS_MGMT_POLICY_TYPE enumeration [Kernel-Mode Driver Architecture], ClfsMgmtPolicyMinimumSize, wdm/ClfsMgmtPolicyAutoShrink, wdm/ClfsMgmtPolicyNewContainerSuffix, ClfsMgmtPolicyAutoGrow, _CLFS_MGMT_POLICY_TYPE, PCLFS_MGMT_POLICY_TYPE, ClfsMgmtPolicyLogTail, wdm/ClfsMgmtPolicyLogTail, kernel.clfs_mgmt_policy_type, sysenum_bae8275b-5f70-40fb-ae14-f803eaeb0a42.xml, ClfsMgmtPolicyInvalid, ClfsMgmtPolicyAutoShrink, wdm/PCLFS_MGMT_POLICY_TYPE, wdm/ClfsMgmtPolicyAutoGrow, *PCLFS_MGMT_POLICY_TYPE, ClfsMgmtPolicyGrowthRate, wdm/ClfsMgmtPolicyGrowthRate, wdm/ClfsMgmtPolicyMinimumSize, ClfsMgmtPolicyNewContainerPrefix, ClfsMgmtPolicyNewContainerExtension, wdm/CLFS_MGMT_POLICY_TYPE, wdm/ClfsMgmtPolicyMaximumSize, CLFS_MGMT_POLICY_TYPE, wdm/ClfsMgmtPolicyNewContainerPrefix, wdm/ClfsMgmtPolicyNewContainerExtension, ClfsMgmtPolicyMaximumSize
