...
ms.date: 2/16/2018
ms.keywords: PLINK_SHARE_ACCESS, wdm/LINK_SHARE_ACCESS, PLINK_SHARE_ACCESS structure pointer [Kernel-Mode Driver Architecture], _LINK_SHARE_ACCESS, *PLINK_SHARE_ACCESS, wdm/PLINK_SHARE_ACCESS, LINK_SHARE_ACCESS structure [Kernel-Mode Driver Architecture], kernel.link_share_access, LINK_SHARE_ACCESS
