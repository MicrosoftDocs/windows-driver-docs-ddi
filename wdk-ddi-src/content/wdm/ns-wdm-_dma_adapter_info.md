...
ms.date: 1/4/2018
ms.keywords: kernel.dma_adapter_info, DMA_ADAPTER_INFO, _DMA_ADAPTER_INFO, wdm/DMA_ADAPTER_INFO, PDMA_ADAPTER_INFO, *PDMA_ADAPTER_INFO, wdm/PDMA_ADAPTER_INFO, PDMA_ADAPTER_INFO structure pointer [Kernel-Mode Driver Architecture], DMA_ADAPTER_INFO structure [Kernel-Mode Driver Architecture]
...
product: Windows
targetos: Windows
req.typenames: "*PDMA_ADAPTER_INFO, DMA_ADAPTER_INFO"
