...
ms.date: 1/4/2018
ms.keywords: CM_SCSI_DEVICE_DATA structure [Kernel-Mode Driver Architecture], PCM_SCSI_DEVICE_DATA, PCM_SCSI_DEVICE_DATA structure pointer [Kernel-Mode Driver Architecture], _CM_SCSI_DEVICE_DATA, kstruct_a_af6c0c9a-2191-45f9-ba0f-20c54a202e0a.xml, wdm/CM_SCSI_DEVICE_DATA, kernel.cm_scsi_device_data, *PCM_SCSI_DEVICE_DATA, wdm/PCM_SCSI_DEVICE_DATA, CM_SCSI_DEVICE_DATA
