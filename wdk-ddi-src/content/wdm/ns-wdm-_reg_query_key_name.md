...
ms.date: 2/16/2018
ms.keywords: PREG_QUERY_KEY_NAME, wdm/REG_QUERY_KEY_NAME, REG_QUERY_KEY_NAME structure [Kernel-Mode Driver Architecture], PREG_QUERY_KEY_NAME structure pointer [Kernel-Mode Driver Architecture], *PREG_QUERY_KEY_NAME, REG_QUERY_KEY_NAME, _REG_QUERY_KEY_NAME, kernel.reg_query_key_name, wdm/PREG_QUERY_KEY_NAME
