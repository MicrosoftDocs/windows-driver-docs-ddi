...
After completing the access, the driver calls <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-exreleaserundownprotection">ExReleaseRundownProtection</a> to release the previously acquired run-down protection.
