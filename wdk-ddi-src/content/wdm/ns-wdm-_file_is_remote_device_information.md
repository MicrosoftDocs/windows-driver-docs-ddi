...
ms.date: 1/4/2018
ms.keywords: PFILE_IS_REMOTE_DEVICE_INFORMATION structure pointer [Kernel-Mode Driver Architecture], *PFILE_IS_REMOTE_DEVICE_INFORMATION, wdm/FILE_IS_REMOTE_DEVICE_INFORMATION, FILE_IS_REMOTE_DEVICE_INFORMATION, _FILE_IS_REMOTE_DEVICE_INFORMATION, PFILE_IS_REMOTE_DEVICE_INFORMATION, kernel.file_is_remote_device_information, FILE_IS_REMOTE_DEVICE_INFORMATION structure [Kernel-Mode Driver Architecture], wdm/PFILE_IS_REMOTE_DEVICE_INFORMATION
