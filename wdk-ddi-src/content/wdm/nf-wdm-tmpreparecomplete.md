...
# TmPrepareComplete function (wdm.h)
...
The <b>TmPrepareComplete</b> routine is a pointer-based version of the <a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-ntpreparecomplete">ZwPrepareComplete</a> routine.
