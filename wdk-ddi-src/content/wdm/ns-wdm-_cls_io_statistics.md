...
ms.date: 1/4/2018
ms.keywords: PCLS_IO_STATISTICS structure pointer [Kernel-Mode Driver Architecture], *PCLFS_IO_STATISTICS, wdm/CLFS_IO_STATISTICS, PPCLFS_IO_STATISTICS, wdm/PPCLS_IO_STATISTICS, CLFS_IO_STATISTICS structure [Kernel-Mode Driver Architecture], CLFS_IO_STATISTICS, CLS_IO_STATISTICS, CLS_IO_STATISTICS structure [Kernel-Mode Driver Architecture], PCLS_IO_STATISTICS, _CLS_IO_STATISTICS, PPCLFS_IO_STATISTICS structure pointer [Kernel-Mode Driver Architecture], PPCLS_IO_STATISTICS, kernel.clfs_io_statistics, PCLFS_IO_STATISTICS, kstruct_a_2e43db78-8c4e-462f-ad85-8c799be2f2e3.xml, wdm/PPCLFS_IO_STATISTICS, wdm/PCLFS_IO_STATISTICS, PPCLS_IO_STATISTICS structure pointer [Kernel-Mode Driver Architecture], *PCLS_IO_STATISTICS, PCLFS_IO_STATISTICS structure pointer [Kernel-Mode Driver Architecture], wdm/CLS_IO_STATISTICS, wdm/PCLS_IO_STATISTICS
