...
ms.date: 2/16/2018
ms.keywords: "*PCLFS_IO_STATISTICS, wdm/PPCLFS_IO_STATISTICS, PCLS_IO_STATISTICS, CLS_IO_STATISTICS structure [Kernel-Mode Driver Architecture], CLS_IO_STATISTICS, wdm/CLS_IO_STATISTICS, wdm/PPCLS_IO_STATISTICS, _CLS_IO_STATISTICS, CLFS_IO_STATISTICS structure [Kernel-Mode Driver Architecture], wdm/PCLS_IO_STATISTICS, PPCLS_IO_STATISTICS, PPCLS_IO_STATISTICS structure pointer [Kernel-Mode Driver Architecture], kstruct_a_2e43db78-8c4e-462f-ad85-8c799be2f2e3.xml, *PCLS_IO_STATISTICS, PPCLFS_IO_STATISTICS, PCLS_IO_STATISTICS structure pointer [Kernel-Mode Driver Architecture], wdm/PCLFS_IO_STATISTICS, PPCLFS_IO_STATISTICS structure pointer [Kernel-Mode Driver Architecture], PCLFS_IO_STATISTICS structure pointer [Kernel-Mode Driver Architecture], kernel.clfs_io_statistics, CLFS_IO_STATISTICS, wdm/CLFS_IO_STATISTICS, PCLFS_IO_STATISTICS"
