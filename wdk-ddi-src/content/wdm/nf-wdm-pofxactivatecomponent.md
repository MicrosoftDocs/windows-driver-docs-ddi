...
ms.date: 2/16/2018
ms.keywords: PoFxActivateComponent routine [Kernel-Mode Driver Architecture], PoFxActivateComponent, PO_FX_FLAG_BLOCKING, kernel.pofxactivatecomponent, wdm/PoFxActivateComponent, PO_FX_FLAG_ASYNC_ONLY
