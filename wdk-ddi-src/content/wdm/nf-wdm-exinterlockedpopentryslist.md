...
## -returns
**ExInterlockedPopEntrySList** returns a pointer to the first [**SLIST_ENTRY**](https://msdn.microsoft.com/library/windows/hardware/ff563805) structure on the list. If the list was empty, the routine returns NULL.
