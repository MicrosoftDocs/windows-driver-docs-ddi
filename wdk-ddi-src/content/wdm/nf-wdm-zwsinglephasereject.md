...
description: Learn how the ZwSinglePhaseReject routine informs KTM that the calling resource manager will not support single-phase commit operations for a specified enlistment.
...
The <b>ZwSinglePhaseReject</b> routine informs KTM that the calling resource manager will not support <a href="/windows-hardware/drivers/kernel/handling-commit-operations">single-phase commit operations</a> for a specified enlistment.
...
A resource manager can call <b>ZwSinglePhaseReject</b> when it receives a TRANSACTION_NOTIFY_SINGLE_PHASE_COMMIT <a href="/windows-hardware/drivers/kernel/transaction-notifications">notification</a>. 

For more information about <b>ZwSinglePhaseReject</b>, see <a href="/windows-hardware/drivers/kernel/handling-commit-operations">Handling Commit Operations</a>.
...
<a href="/windows-hardware/drivers/ddi/wdm/nf-wdm-tmsinglephasereject">TmSinglePhaseReject</a>
