...
<b>FlushAdapterBuffersEx</b> is an extended version of the <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/wdm/nc-wdm-pflush_adapter_buffers">FlushAdapterBuffers</a> routine. <b>FlushAdapterBuffersEx</b> can flush an entire scatter/gather list in one call. In contrast, to use <b>FlushAdapterBuffers</b> to flush a scatter/gather list requires a separate call for each MDL in the MDL chain.
