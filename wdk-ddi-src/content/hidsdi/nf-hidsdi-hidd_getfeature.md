...
ms.date: 12/21/2017
ms.keywords: HidD_GetFeature routine [Human Input Devices], hid.hidd_getfeature, hidsdi/HidD_GetFeature, hidfunc_2992bcaf-4ca6-4b6f-9a85-d0add8c7fe99.xml, HidD_GetFeature
...
</ul>The feature report is returned in the <i>ReportBuffer</i>  parameter. Depending on the report ID, the caller parses the report by calling one of the following functions:
<ul>
<li>
