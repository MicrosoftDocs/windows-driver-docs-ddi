...
title: RILMSGMWIDETAIL (ntddrilapitypes.h)
description: "Microsoft reserves the RILMSGMWIDETAIL structure for internal use only. Don't use the RILMSGMWIDETAIL structure in your code."
