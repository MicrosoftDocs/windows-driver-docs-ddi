...
ms.date: 1/18/2018
ms.keywords: RILCALLMEDIAID structure [Network Drivers Starting with Windows Vista], netvista.rilcallmediaid, *LPRILCALLMEDIAID, ntddrilapitypes/RILCALLMEDIAID, RILCALLMEDIAID
