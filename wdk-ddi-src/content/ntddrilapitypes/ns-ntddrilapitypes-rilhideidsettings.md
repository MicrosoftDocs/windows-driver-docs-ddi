...
title: RILHIDEIDSETTINGS (ntddrilapitypes.h)
description: "Microsoft reserves the RILHIDEIDSETTINGS structure for internal use only. Don't use the RILHIDEIDSETTINGS structure in your code."
old-location: netvista\rilhideidsettings.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILHIDEIDSETTINGS structure"]
...
f1_keywords:
 ...
 - LPRILHIDEIDSETTINGS
 - ntddrilapitypes/LPRILHIDEIDSETTINGS
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# RILHIDEIDSETTINGS structure (ntddrilapitypes.h)
