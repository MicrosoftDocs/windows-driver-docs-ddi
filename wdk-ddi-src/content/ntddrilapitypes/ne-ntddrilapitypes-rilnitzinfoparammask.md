...
title: RILNITZINFOPARAMMASK (ntddrilapitypes.h)
description: "Microsoft reserves the RILNITZINFOPARAMMASK enumeration for internal use only. Don't use the RILNITZINFOPARAMMASK enumeration in your code."
...
f1_keywords:
 ...
 - ntddrilapitypes/RILNITZINFOPARAMMASK
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# RILNITZINFOPARAMMASK enumeration (ntddrilapitypes.h)
