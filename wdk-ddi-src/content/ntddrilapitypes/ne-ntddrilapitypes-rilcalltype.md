...
title: RILCALLTYPE (ntddrilapitypes.h)
description: "Microsoft reserves the RILCALLTYPE enumeration for internal use only. Don't use the RILCALLTYPE enumeration in your code."
