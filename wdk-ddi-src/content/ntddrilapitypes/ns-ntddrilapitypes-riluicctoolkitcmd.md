...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RILUICCTOOLKITCMD, RILUICCTOOLKITCMD structure [Network Drivers Starting with Windows Vista], *LPRILUICCTOOLKITCMD, netvista.riluicctoolkitcmd, RILUICCTOOLKITCMD
