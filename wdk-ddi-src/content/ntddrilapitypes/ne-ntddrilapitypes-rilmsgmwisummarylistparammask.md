...
description: "Microsoft reserves the RILMSGMWISUMMARYLISTPARAMMASK enumeration for internal use only. Don't use this enumeration in your code."
old-location: netvista\rilmsgmwisummarylistparammask.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILMSGMWISUMMARYLISTPARAMMASK enumeration"]
...
f1_keywords:
 ...
 - ntddrilapitypes/RILMSGMWISUMMARYLISTPARAMMASK
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# RILMSGMWISUMMARYLISTPARAMMASK enumeration (ntddrilapitypes.h)
