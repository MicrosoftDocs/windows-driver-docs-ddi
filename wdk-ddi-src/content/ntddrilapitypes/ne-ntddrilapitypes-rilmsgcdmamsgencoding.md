...
title: RILMSGCDMAMSGENCODING (ntddrilapitypes.h)
description: "Microsoft reserves the RILMSGCDMAMSGENCODING enumeration for internal use only. Don't use the RILMSGCDMAMSGENCODING enumeration in your code."
