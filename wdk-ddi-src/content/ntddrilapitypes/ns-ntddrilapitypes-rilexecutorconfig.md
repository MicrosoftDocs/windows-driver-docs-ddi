...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RILEXECUTORCONFIG, netvista.rilexecutorconfig, RILEXECUTORCONFIG structure [Network Drivers Starting with Windows Vista], RILEXECUTORCONFIG, *LPRILEXECUTORCONFIG
