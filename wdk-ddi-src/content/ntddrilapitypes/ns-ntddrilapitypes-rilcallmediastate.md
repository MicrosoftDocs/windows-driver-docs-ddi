...
ms.date: 1/18/2018
ms.keywords: RILCALLMEDIASTATE, ntddrilapitypes/RILCALLMEDIASTATE, RILCALLMEDIASTATE structure [Network Drivers Starting with Windows Vista], netvista.rilcallmediastate, *LPRILCALLMEDIASTATE
