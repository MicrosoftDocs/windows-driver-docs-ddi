...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RILCALLMEDIASTATE, RILCALLMEDIASTATE structure [Network Drivers Starting with Windows Vista], netvista.rilcallmediastate, *LPRILCALLMEDIASTATE, RILCALLMEDIASTATE
