...
ms.date: 2/16/2018
ms.keywords: RILPROVISIONSTATUSPROVISIONSTATUS enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PROVISIONSTAT_FAILURE_RETRY, ntddrilapitypes/RIL_PROVISIONSTAT_NEEDED, RIL_PROVISIONSTAT_MAX, RILPROVISIONSTATUSPROVISIONSTATUS, RIL_PROVISIONSTAT_BIP_STARTED, ntddrilapitypes/RILPROVISIONSTATUSPROVISIONSTATUS, ntddrilapitypes/RIL_PROVISIONSTAT_FAILURE_END, ntddrilapitypes/RIL_PROVISIONSTAT_BIP_STARTED, ntddrilapitypes/RIL_PROVISIONSTAT_BIP_SUCCESS, ntddrilapitypes/RIL_PROVISIONSTAT_MAX, RIL_PROVISIONSTAT_SUCCESS, ntddrilapitypes/RIL_PROVISIONSTAT_SUCCESS, RIL_PROVISIONSTAT_FAILURE_END, RIL_PROVISIONSTAT_BIP_SUCCESS, netvista.rilprovisionstatusprovisionstatus, RIL_PROVISIONSTAT_FAILURE_RETRY, RIL_PROVISIONSTAT_NEEDED
