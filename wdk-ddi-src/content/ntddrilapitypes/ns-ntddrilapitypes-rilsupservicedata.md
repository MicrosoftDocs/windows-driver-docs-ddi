...
title: RILSUPSERVICEDATA (ntddrilapitypes.h)
description: "Microsoft reserves the RILSUPSERVICEDATA structure for internal use only. Don't use the RILSUPSERVICEDATA structure in your code."
...
f1_keywords:
 ...
 - LPRILSUPSERVICEDATA
 - ntddrilapitypes/LPRILSUPSERVICEDATA
topic_type:
 - APIRef
 - kbSyntax
api_type:
