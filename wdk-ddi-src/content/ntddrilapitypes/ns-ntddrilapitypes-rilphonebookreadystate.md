...
title: RILPHONEBOOKREADYSTATE (ntddrilapitypes.h)
description: "Microsoft reserves the RILPHONEBOOKREADYSTATE structure for internal use only. Don't use the RILPHONEBOOKREADYSTATE structure in your code."
...
f1_keywords:
 ...
 - ntddrilapitypes/RILPHONEBOOKREADYSTATE
 - LPRILPHONEBOOKREADYSTATE
 - ntddrilapitypes/LPRILPHONEBOOKREADYSTATE
topic_type:
 - APIRef
 - kbSyntax
api_type:
