...
ms.date: 1/18/2018
ms.keywords: RILCALLHANDOVERSTATE, ntddrilapitypes/RILCALLHANDOVERSTATE, netvista.rilcallhandoverstate, RILCALLHANDOVERSTATE structure [Network Drivers Starting with Windows Vista], *LPRILCALLHANDOVERSTATE
