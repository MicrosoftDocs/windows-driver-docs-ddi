...
description: Microsoft reserves the RIL3GPPTONE enumeration for internal use only. Don't use the RIL3GPPTONE enumeration in your code.
...
# RIL3GPPTONE enumeration (ntddrilapitypes.h)
