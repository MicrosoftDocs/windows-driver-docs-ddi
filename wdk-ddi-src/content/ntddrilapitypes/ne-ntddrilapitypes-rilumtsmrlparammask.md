...
ms.date: 2/16/2018
ms.keywords: RIL_PARAM_UMTSMRL_ALL, RIL_PARAM_UMTSMRL_MNC, RIL_PARAM_UMTSMRL_UARFCN, rilapitypes/RIL_PARAM_UMTSMRL_MNC, rilapitypes/RIL_PARAM_UMTSMRL_PRIMARY_SC, RIL_PARAM_UMTSMRL_CELLID, rilapitypes/RILUMTSMRLPARAMMASK, rilapitypes/RIL_PARAM_UMTSMRL_RSCP, rilapitypes/RIL_PARAM_UMTSMRL_LAC, RILUMTSMRLPARAMMASK enumeration [Network Drivers Starting with Windows Vista], netvista.rilumtsmrlparammask, RIL_PARAM_UMTSMRL_LAC, RIL_PARAM_UMTSMRL_PRIMARY_SC, RIL_PARAM_UMTSMRL_RSCP, rilapitypes/RIL_PARAM_UMTSMRL_UARFCN, RIL_PARAM_UMTSMRL_ECNO, RIL_PARAM_UMTSMRL_MCC, rilapitypes/RIL_PARAM_UMTSMRL_ECNO, rilapitypes/RIL_PARAM_UMTSMRL_PATHLOSS, RIL_PARAM_UMTSMRL_PATHLOSS, rilapitypes/RIL_PARAM_UMTSMRL_ALL, rilapitypes/RIL_PARAM_UMTSMRL_MCC, RILUMTSMRLPARAMMASK, rilapitypes/RIL_PARAM_UMTSMRL_CELLID
