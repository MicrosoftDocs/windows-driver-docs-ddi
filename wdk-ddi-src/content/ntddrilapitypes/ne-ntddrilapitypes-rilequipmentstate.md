...
ms.date: 1/18/2018
ms.keywords: RILEQUIPMENTSTATE enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_EQSTATE_MAX, RILEQUIPMENTSTATE, ntddrilapitypes/RIL_EQSTATE_FULL, ntddrilapitypes/RILEQUIPMENTSTATE, ntddrilapitypes/RIL_EQSTATE_SHUTDOWN, RIL_EQSTATE_MAX, RIL_EQSTATE_FULL, RIL_EQSTATE_SHUTDOWN, netvista.rilequipmentstate
