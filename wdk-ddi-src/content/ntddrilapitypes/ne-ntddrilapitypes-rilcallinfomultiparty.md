...
description: "Microsoft reserves the RILCALLINFOMULTIPARTY enumeration for internal use only. Don't use the RILCALLINFOMULTIPARTY enumeration in your code."
