...
ms.date: 2/16/2018
ms.keywords: RILACCESSTECHNOLOGY structure [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILACCESSTECHNOLOGY, netvista.rilaccesstechnology, RILACCESSTECHNOLOGY, *LPRILACCESSTECHNOLOGY
