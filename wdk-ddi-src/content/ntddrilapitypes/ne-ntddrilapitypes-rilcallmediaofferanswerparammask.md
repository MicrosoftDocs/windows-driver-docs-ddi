...
ms.date: 2/16/2018
ms.keywords: RILCALLMEDIAOFFERANSWERPARAMMASK enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PARAM_CMOA_OLD_STATE, RILCALLMEDIAOFFERANSWERPARAMMASK, RIL_PARAM_CMOA_NEW_STATE, ntddrilapitypes/RIL_PARAM_CMOA_NEW_STATE, ntddrilapitypes/RIL_PARAM_CMOA_CHANGE, netvista.rilcallmediaofferanswerparammask, RIL_PARAM_CMOA_ALL, ntddrilapitypes/RIL_PARAM_CMOA_ALL, RIL_PARAM_CMOA_CHANGE, RIL_PARAM_CMOA_OLD_STATE, ntddrilapitypes/RIL_PARAM_CMOA_ACTION, ntddrilapitypes/RILCALLMEDIAOFFERANSWERPARAMMASK, RIL_PARAM_CMOA_ACTION
