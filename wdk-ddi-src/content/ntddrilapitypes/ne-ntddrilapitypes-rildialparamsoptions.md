...
title: RILDIALPARAMSOPTIONS (ntddrilapitypes.h)
description: "Microsoft reserves the RILDIALPARAMSOPTIONS enumeration for internal use only. Don't use the RILDIALPARAMSOPTIONS enumeration in your code."
...
f1_keywords:
 ...
 - ntddrilapitypes/RILDIALPARAMSOPTIONS
topic_type:
 - APIRef
 - kbSyntax
api_type:
