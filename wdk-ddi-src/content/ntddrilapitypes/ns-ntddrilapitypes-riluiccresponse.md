...
ms.date: 1/18/2018
ms.keywords: RILUICCRESPONSE, netvista.riluiccresponse, ntddrilapitypes/RILUICCRESPONSE, RILUICCRESPONSE structure [Network Drivers Starting with Windows Vista], *LPRILUICCRESPONSE
