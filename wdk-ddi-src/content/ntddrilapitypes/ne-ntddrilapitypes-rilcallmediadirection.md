...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RILCALLMEDIADIRECTION, RILCALLMEDIADIRECTION, ntddrilapitypes/RIL_CALLMEDIADIRECTION_RXTX, RIL_CALLMEDIADIRECTION_TX, RIL_CALLMEDIADIRECTION_RX, RILCALLMEDIADIRECTION enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_CALLMEDIADIRECTION_MAX, RIL_CALLMEDIADIRECTION_MAX, netvista.rilcallmediadirection, ntddrilapitypes/RIL_CALLMEDIADIRECTION_RX, RIL_CALLMEDIADIRECTION_RXTX, ntddrilapitypes/RIL_CALLMEDIADIRECTION_TX
