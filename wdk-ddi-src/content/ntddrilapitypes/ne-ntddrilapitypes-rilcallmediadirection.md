...
title: RILCALLMEDIADIRECTION (ntddrilapitypes.h)
description: "Microsoft reserves the RILCALLMEDIADIRECTION enumeration for internal use only. Don't use the RILCALLMEDIADIRECTION enumeration in your code."
