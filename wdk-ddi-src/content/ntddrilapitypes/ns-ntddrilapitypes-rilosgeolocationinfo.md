...
description: "Microsoft reserves the RILOSGEOLOCATIONINFO structure for internal use only. Don't use this structure in your code."
...
f1_keywords:
 ...
 - ntddrilapitypes/LPRILOSGEOLOCATIONINFO
topic_type:
 - APIRef
 - kbSyntax
api_type:
