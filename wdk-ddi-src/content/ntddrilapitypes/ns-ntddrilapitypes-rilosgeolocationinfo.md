...
ms.date: 1/18/2018
ms.keywords: RILOSGEOLOCATIONINFO, RILOSGEOLOCATIONINFO structure [Network Drivers Starting with Windows Vista], *LPRILOSGEOLOCATIONINFO, netvista.rilosgeolocationinfo, ntddrilapitypes/RILOSGEOLOCATIONINFO
