...
ms.date: 1/18/2018
ms.keywords: RILUICCSERVICEINFO, *LPRILUICCSERVICEINFO, netvista.riluiccserviceinfo, RILUICCSERVICEINFO structure [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILUICCSERVICEINFO
