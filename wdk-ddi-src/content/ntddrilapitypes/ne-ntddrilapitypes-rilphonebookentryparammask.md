...
description: "Microsoft reserves the RILPHONEBOOKENTRYPARAMMASK enumeration for internal use only. Don't use this enumeration in your code."
...
f1_keywords:
 ...
 - ntddrilapitypes/RILPHONEBOOKENTRYPARAMMASK
topic_type:
 - APIRef
 - kbSyntax
api_type:
