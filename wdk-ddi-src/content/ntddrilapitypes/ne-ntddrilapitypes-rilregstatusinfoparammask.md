...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RIL_PARAM_REGSI_REGSTATUS, RIL_PARAM_REGSI_NETWORKCODE, RIL_PARAM_REGSI_ACCESSTECHNOLOGY, RIL_PARAM_REGSI_HUICCAPP, RIL_PARAM_REGSI_REGSTATUS, RILREGSTATUSINFOPARAMMASK, ntddrilapitypes/RILREGSTATUSINFOPARAMMASK, RIL_PARAM_REGSI_REGREJECTREASON, ntddrilapitypes/RIL_PARAM_REGSI_ALL, ntddrilapitypes/RIL_PARAM_REGSI_ACCESSTECHNOLOGY, netvista.rilregstatusinfoparammask, ntddrilapitypes/RIL_PARAM_REGSI_SYSTEMCAPS, RIL_PARAM_REGSI_ALL, ntddrilapitypes/RIL_PARAM_REGSI_HUICCAPP, RIL_PARAM_REGSI_VOICEDOMAIN, ntddrilapitypes/RIL_PARAM_REGSI_REGREJECTREASON, ntddrilapitypes/RIL_PARAM_REGSI_NETWORKCODE, RIL_PARAM_REGSI_SYSTEMCAPS, ntddrilapitypes/RIL_PARAM_REGSI_CURRENTOPERATOR, ntddrilapitypes/RIL_PARAM_REGSI_VOICEDOMAIN, RIL_PARAM_REGSI_CURRENTOPERATOR, RILREGSTATUSINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista]
