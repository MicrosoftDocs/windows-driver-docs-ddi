...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_PARAM_REGSI_ACCESSTECHNOLOGY, ntddrilapitypes/RIL_PARAM_REGSI_SYSTEMCAPS, RIL_PARAM_REGSI_NETWORKCODE, ntddrilapitypes/RIL_PARAM_REGSI_ALL, RIL_PARAM_REGSI_REGSTATUS, RIL_PARAM_REGSI_VOICEDOMAIN, ntddrilapitypes/RIL_PARAM_REGSI_HUICCAPP, RIL_PARAM_REGSI_ACCESSTECHNOLOGY, RIL_PARAM_REGSI_ALL, ntddrilapitypes/RILREGSTATUSINFOPARAMMASK, RIL_PARAM_REGSI_REGREJECTREASON, RILREGSTATUSINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PARAM_REGSI_NETWORKCODE, RIL_PARAM_REGSI_CURRENTOPERATOR, ntddrilapitypes/RIL_PARAM_REGSI_VOICEDOMAIN, RILREGSTATUSINFOPARAMMASK, ntddrilapitypes/RIL_PARAM_REGSI_REGSTATUS, netvista.rilregstatusinfoparammask, RIL_PARAM_REGSI_HUICCAPP, ntddrilapitypes/RIL_PARAM_REGSI_CURRENTOPERATOR, ntddrilapitypes/RIL_PARAM_REGSI_REGREJECTREASON, RIL_PARAM_REGSI_SYSTEMCAPS
