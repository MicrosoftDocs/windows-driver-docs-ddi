...
ms.date: 2/16/2018
ms.keywords: RIL_PARAM_REGSI_CURRENTOPERATOR, ntddrilapitypes/RIL_PARAM_REGSI_CURRENTOPERATOR, RIL_PARAM_REGSI_SYSTEMCAPS, RIL_PARAM_REGSI_REGSTATUS, RIL_PARAM_REGSI_HUICCAPP, ntddrilapitypes/RILREGSTATUSINFOPARAMMASK, RILREGSTATUSINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_REGSI_NETWORKCODE, ntddrilapitypes/RIL_PARAM_REGSI_NETWORKCODE, RIL_PARAM_REGSI_ALL, RIL_PARAM_REGSI_REGREJECTREASON, ntddrilapitypes/RIL_PARAM_REGSI_REGSTATUS, RIL_PARAM_REGSI_ACCESSTECHNOLOGY, RIL_PARAM_REGSI_VOICEDOMAIN, ntddrilapitypes/RIL_PARAM_REGSI_SYSTEMCAPS, ntddrilapitypes/RIL_PARAM_REGSI_ALL, netvista.rilregstatusinfoparammask, ntddrilapitypes/RIL_PARAM_REGSI_HUICCAPP, ntddrilapitypes/RIL_PARAM_REGSI_ACCESSTECHNOLOGY, RILREGSTATUSINFOPARAMMASK, ntddrilapitypes/RIL_PARAM_REGSI_REGREJECTREASON, ntddrilapitypes/RIL_PARAM_REGSI_VOICEDOMAIN
