...
description: "Microsoft reserves the RILCALLDISCONNECTDETAILSDISCONNECTGROUP enumeration for internal use only. Don't use the RILCALLDISCONNECTDETAILSDISCONNECTGROUP enumeration in your code."
