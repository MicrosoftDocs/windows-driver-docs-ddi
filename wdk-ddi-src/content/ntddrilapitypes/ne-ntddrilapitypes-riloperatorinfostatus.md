...
ms.date: 1/18/2018
ms.keywords: RILOPERATORINFOSTATUS enumeration [Network Drivers Starting with Windows Vista], RIL_OPSTATUS_FORBIDDEN, RIL_OPSTATUS_AVAILABLE, RILOPERATORINFOSTATUS, RIL_OPSTATUS_MAX, netvista.riloperatorinfostatus, ntddrilapitypes/RILOPERATORINFOSTATUS, ntddrilapitypes/RIL_OPSTATUS_CURRENT, ntddrilapitypes/RIL_OPSTATUS_MAX, ntddrilapitypes/RIL_OPSTATUS_AVAILABLE, RIL_OPSTATUS_CURRENT, ntddrilapitypes/RIL_OPSTATUS_FORBIDDEN
