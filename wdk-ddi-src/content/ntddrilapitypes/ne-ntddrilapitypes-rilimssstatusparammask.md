...
ms.date: 2/16/2018
ms.keywords: RILIMSSSTATUSPARAMMASK, RIL_PARAM_IMSSTATUS_AVAILABLESERVICES, ntddrilapitypes/RIL_PARAM_IMSSTATUS_ALL, RIL_PARAM_IMSSTATUS_ALL, ntddrilapitypes/RIL_PARAM_IMSSTATUS_AVAILABLESERVICES, RIL_PARAM_IMSSTATUS_HUICCAPP, ntddrilapitypes/RIL_PARAM_IMSSTATUS_SMSSUPPORTEDFORMAT, ntddrilapitypes/RIL_PARAM_IMSSTATUS_SYSTEMTYPE, ntddrilapitypes/RIL_PARAM_IMSSTATUS_HUICCAPP, RIL_PARAM_IMSSTATUS_SMSSUPPORTEDFORMAT, RIL_PARAM_IMSSTATUS_SERVINGDOMAIN, ntddrilapitypes/RIL_PARAM_IMSSTATUS_SERVINGDOMAIN, RILIMSSSTATUSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], netvista.rilimssstatusparammask, ntddrilapitypes/RILIMSSSTATUSPARAMMASK, RIL_PARAM_IMSSTATUS_SYSTEMTYPE
