...
ms.date: 1/18/2018
ms.keywords: RILDELETEMSGPARAMS structure [Network Drivers Starting with Windows Vista], *LPRILDELETEMSGPARAMS, ntddrilapitypes/RILDELETEMSGPARAMS, netvista.rildeletemsgparams, RILDELETEMSGPARAMS
