...
title: RILGEOSCOPE (ntddrilapitypes.h)
description: "Microsoft reserves the RILGEOSCOPE enumeration for internal use only. Don't use the RILGEOSCOPE enumeration in your code."
