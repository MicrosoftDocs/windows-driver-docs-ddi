...
ms.date: 1/18/2018
ms.keywords: RILSETSMSCPARAMS structure [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILSETSMSCPARAMS, netvista.rilsetsmscparams, *LPRILSETSMSCPARAMS, RILSETSMSCPARAMS
