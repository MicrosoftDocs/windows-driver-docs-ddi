...
description: "Microsoft reserves the RILCALLHANDOVERPHASE enumeration for internal use only. Don't use the RILCALLHANDOVERPHASE enumeration in your code."
...
# RILCALLHANDOVERPHASE enumeration (ntddrilapitypes.h)
