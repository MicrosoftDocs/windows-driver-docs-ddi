...
ms.date: 1/18/2018
ms.keywords: RILCALLHANDOVERPHASE, ntddrilapitypes/RILCALLHANDOVERPHASE, RIL_CALLHANDOVERPHASE_COMPLETED, ntddrilapitypes/RIL_CALLHANDOVERPHASE_CANCELLED, ntddrilapitypes/RIL_CALLHANDOVERPHASE_FAILED, RIL_CALLHANDOVERPHASE_MAX, RIL_CALLHANDOVERPHASE_CANCELLED, ntddrilapitypes/RIL_CALLHANDOVERPHASE_MAX, RIL_CALLHANDOVERPHASE_FAILED, netvista.rilcallhandoverphase, RILCALLHANDOVERPHASE enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_CALLHANDOVERPHASE_COMPLETED
