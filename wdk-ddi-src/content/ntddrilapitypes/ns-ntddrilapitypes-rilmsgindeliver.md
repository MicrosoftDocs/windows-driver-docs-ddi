...
ms.date: 1/18/2018
ms.keywords: netvista.rilmsgindeliver, ntddrilapitypes/RILMSGINDELIVER, RILMSGINDELIVER structure [Network Drivers Starting with Windows Vista], *LPRILMSGINDELIVER, RILMSGINDELIVER
