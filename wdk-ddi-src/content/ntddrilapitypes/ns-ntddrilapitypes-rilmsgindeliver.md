...
ms.date: 1/18/2018
ms.keywords: RILMSGINDELIVER structure [Network Drivers Starting with Windows Vista], *LPRILMSGINDELIVER, netvista.rilmsgindeliver, RILMSGINDELIVER, ntddrilapitypes/RILMSGINDELIVER
