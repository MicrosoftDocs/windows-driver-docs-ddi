...
description: "Microsoft reserves the RILUMTSKIND enumeration for internal use only. Don't use the RILUMTSKIND enumeration in your code."
...
# RILUMTSKIND enumeration (ntddrilapitypes.h)
