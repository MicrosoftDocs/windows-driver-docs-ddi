...
title: RILCALLINFO_V1 (ntddrilapitypes.h)
description: "Microsoft reserves the RILCALLINFO_V1 structure for internal use only. Don't use the RILCALLINFO_V1 structure in your code."
old-location: netvista\rilcallinfo_v1.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILCALLINFO_V1 structure"]
...
f1_keywords:
 ...
 - LPRILCALLINFO_V1
 - ntddrilapitypes/LPRILCALLINFO_V1
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# RILCALLINFO_V1 structure (ntddrilapitypes.h)
