...
description: "Microsoft reserves the RILMSGCDMAMSGDISPLAYMODE enumeration for internal use only. Don't use the RILMSGCDMAMSGDISPLAYMODE enumeration in your code."
old-location: netvista\rilmsgcdmamsgdisplaymode.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILMSGCDMAMSGDISPLAYMODE enumeration"]
...
f1_keywords:
 ...
 - ntddrilapitypes/RILMSGCDMAMSGDISPLAYMODE
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# RILMSGCDMAMSGDISPLAYMODE enumeration (ntddrilapitypes.h)
