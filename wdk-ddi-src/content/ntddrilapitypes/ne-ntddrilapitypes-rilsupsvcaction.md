...
ms.date: 1/18/2018
ms.keywords: RIL_SUPSVCACTION_INTERROGATE, ntddrilapitypes/RILSUPSVCACTION, ntddrilapitypes/RIL_SUPSVCACTION_REGISTER_PW, RIL_SUPSVCACTION_REGISTER, ntddrilapitypes/RIL_SUPSVCACTION_INTERROGATE, RILSUPSVCACTION, RIL_SUPSVCACTION_MAX, RIL_SUPSVCACTION_USSD, RIL_SUPSVCACTION_DEACTIVATE, ntddrilapitypes/RIL_SUPSVCACTION_MAX, ntddrilapitypes/RIL_SUPSVCACTION_DEACTIVATE, RILSUPSVCACTION enumeration [Network Drivers Starting with Windows Vista], netvista.rilsupsvcaction, ntddrilapitypes/RIL_SUPSVCACTION_REGISTER, ntddrilapitypes/RIL_SUPSVCACTION_ERASE, RIL_SUPSVCACTION_ERASE, ntddrilapitypes/RIL_SUPSVCACTION_USSD, RIL_SUPSVCACTION_REGISTER_PW
