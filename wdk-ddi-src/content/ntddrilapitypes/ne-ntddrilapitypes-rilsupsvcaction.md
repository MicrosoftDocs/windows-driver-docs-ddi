...
title: RILSUPSVCACTION (ntddrilapitypes.h)
description: "Microsoft reserves the RILSUPSVCACTION enumeration for internal use only. Don't use the RILSUPSVCACTION enumeration in your code."
...
# RILSUPSVCACTION enumeration (ntddrilapitypes.h)
