...
ms.date: 2/16/2018
ms.keywords: RIL_SUPSVCACTION_INTERROGATE, ntddrilapitypes/RIL_SUPSVCACTION_ERASE, ntddrilapitypes/RIL_SUPSVCACTION_USSD, netvista.rilsupsvcaction, RIL_SUPSVCACTION_MAX, ntddrilapitypes/RIL_SUPSVCACTION_REGISTER_PW, RILSUPSVCACTION, RIL_SUPSVCACTION_DEACTIVATE, RIL_SUPSVCACTION_ERASE, ntddrilapitypes/RIL_SUPSVCACTION_INTERROGATE, RIL_SUPSVCACTION_USSD, ntddrilapitypes/RIL_SUPSVCACTION_MAX, ntddrilapitypes/RIL_SUPSVCACTION_DEACTIVATE, ntddrilapitypes/RIL_SUPSVCACTION_REGISTER, ntddrilapitypes/RILSUPSVCACTION, RILSUPSVCACTION enumeration [Network Drivers Starting with Windows Vista], RIL_SUPSVCACTION_REGISTER, RIL_SUPSVCACTION_REGISTER_PW
