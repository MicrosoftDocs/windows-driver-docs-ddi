...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RIL_SUPSVCACTION_INTERROGATE, RILSUPSVCACTION enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_SUPSVCACTION_MAX, RIL_SUPSVCACTION_DEACTIVATE, ntddrilapitypes/RIL_SUPSVCACTION_DEACTIVATE, RIL_SUPSVCACTION_INTERROGATE, RIL_SUPSVCACTION_ERASE, RIL_SUPSVCACTION_USSD, RIL_SUPSVCACTION_REGISTER_PW, ntddrilapitypes/RIL_SUPSVCACTION_USSD, ntddrilapitypes/RIL_SUPSVCACTION_REGISTER, ntddrilapitypes/RIL_SUPSVCACTION_ERASE, ntddrilapitypes/RIL_SUPSVCACTION_REGISTER_PW, RIL_SUPSVCACTION_MAX, netvista.rilsupsvcaction, RIL_SUPSVCACTION_REGISTER, RILSUPSVCACTION, ntddrilapitypes/RILSUPSVCACTION
