...
title: RILCALLMEDIAVIDEOFLAGPARAMMASK (ntddrilapitypes.h)
description: "Microsoft reserves the RILCALLMEDIAVIDEOFLAGPARAMMASK enumeration for internal use only. Don't use the RILCALLMEDIAVIDEOFLAGPARAMMASK enumeration in your code."
...
f1_keywords:
 ...
 - ntddrilapitypes/RILCALLMEDIAVIDEOFLAGPARAMMASK
topic_type:
 - APIRef
 - kbSyntax
api_type:
