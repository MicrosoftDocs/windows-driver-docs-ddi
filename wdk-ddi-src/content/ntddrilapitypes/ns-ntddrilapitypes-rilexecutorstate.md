...
ms.date: 2/16/2018
ms.keywords: RILEXECUTORSTATE, RILEXECUTORSTATE structure [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILEXECUTORSTATE, netvista.rilexecutorstate, *LPRILEXECUTORSTATE
