...
description: "Microsoft reserves the RILEXECUTORSTATE structure for internal use only. Don't use this structure in your code."
old-location: netvista\rilexecutorstate.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILEXECUTORSTATE structure"]
...
f1_keywords:
 ...
 - LPRILEXECUTORSTATE
 - ntddrilapitypes/LPRILEXECUTORSTATE
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# RILEXECUTORSTATE structure (ntddrilapitypes.h)
