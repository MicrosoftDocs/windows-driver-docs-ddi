...
ms.date: 1/18/2018
ms.keywords: RILEXECUTORFOCUSSTATE structure [Network Drivers Starting with Windows Vista], RILEXECUTORFOCUSSTATE, *LPRILEXECUTORFOCUSSTATE, ntddrilapitypes/RILEXECUTORFOCUSSTATE, netvista.rilexecutorfocusstate
