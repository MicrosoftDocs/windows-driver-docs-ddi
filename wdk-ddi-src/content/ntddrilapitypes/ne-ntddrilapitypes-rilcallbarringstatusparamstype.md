...
ms.date: 1/18/2018
ms.keywords: RIL_BARRTYPE_INCOMINGROAMING, ntddrilapitypes/RIL_BARRTYPE_OUTGOINGINT, ntddrilapitypes/RIL_BARRTYPE_INCOMINGNOTINUICC, ntddrilapitypes/RIL_BARRTYPE_ALLOUTGOINGBARRING, RILCALLBARRINGSTATUSPARAMSTYPE, netvista.rilcallbarringstatusparamstype, ntddrilapitypes/RIL_BARRTYPE_ALLINCOMING, ntddrilapitypes/RIL_BARRTYPE_ALLBARRING, RIL_BARRTYPE_ALL, ntddrilapitypes/RIL_BARRTYPE_ALLINCOMINGBARRING, RIL_BARRTYPE_OUTGOINGINT, RIL_BARRTYPE_ALLINCOMING, ntddrilapitypes/RIL_BARRTYPE_INCOMINGROAMING, RIL_BARRTYPE_INCOMINGNOTINUICC, RIL_BARRTYPE_ALLINCOMINGBARRING, ntddrilapitypes/RIL_BARRTYPE_OUTGOINGINTEXTOHOME, RIL_BARRTYPE_ALLBARRING, ntddrilapitypes/RILCALLBARRINGSTATUSPARAMSTYPE, RILCALLBARRINGSTATUSPARAMSTYPE enumeration [Network Drivers Starting with Windows Vista], RIL_BARRTYPE_ALLOUTGOINGBARRING, ntddrilapitypes/RIL_BARRTYPE_ALL, RIL_BARRTYPE_OUTGOINGINTEXTOHOME
