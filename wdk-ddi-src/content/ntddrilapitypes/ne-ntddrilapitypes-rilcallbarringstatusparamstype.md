...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RILCALLBARRINGSTATUSPARAMSTYPE, RILCALLBARRINGSTATUSPARAMSTYPE, ntddrilapitypes/RIL_BARRTYPE_INCOMINGNOTINUICC, netvista.rilcallbarringstatusparamstype, RIL_BARRTYPE_OUTGOINGINT, ntddrilapitypes/RIL_BARRTYPE_ALLINCOMINGBARRING, RILCALLBARRINGSTATUSPARAMSTYPE enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_BARRTYPE_ALLINCOMING, ntddrilapitypes/RIL_BARRTYPE_ALLOUTGOINGBARRING, ntddrilapitypes/RIL_BARRTYPE_ALLBARRING, RIL_BARRTYPE_ALLINCOMINGBARRING, RIL_BARRTYPE_ALLOUTGOINGBARRING, ntddrilapitypes/RIL_BARRTYPE_OUTGOINGINT, RIL_BARRTYPE_OUTGOINGINTEXTOHOME, RIL_BARRTYPE_ALLINCOMING, RIL_BARRTYPE_INCOMINGNOTINUICC, ntddrilapitypes/RIL_BARRTYPE_INCOMINGROAMING, RIL_BARRTYPE_INCOMINGROAMING, ntddrilapitypes/RIL_BARRTYPE_ALL, ntddrilapitypes/RIL_BARRTYPE_OUTGOINGINTEXTOHOME, RIL_BARRTYPE_ALL, RIL_BARRTYPE_ALLBARRING
