...
ms.date: 1/18/2018
ms.keywords: RIL_BARRTYPE_OUTGOINGINT, ntddrilapitypes/RILCALLBARRINGSTATUSPARAMSTYPE, RIL_BARRTYPE_INCOMINGNOTINUICC, RIL_BARRTYPE_INCOMINGROAMING, RIL_BARRTYPE_ALLINCOMINGBARRING, ntddrilapitypes/RIL_BARRTYPE_ALLOUTGOINGBARRING, ntddrilapitypes/RIL_BARRTYPE_INCOMINGROAMING, RIL_BARRTYPE_ALLBARRING, ntddrilapitypes/RIL_BARRTYPE_OUTGOINGINT, ntddrilapitypes/RIL_BARRTYPE_OUTGOINGINTEXTOHOME, netvista.rilcallbarringstatusparamstype, RIL_BARRTYPE_OUTGOINGINTEXTOHOME, ntddrilapitypes/RIL_BARRTYPE_ALL, ntddrilapitypes/RIL_BARRTYPE_ALLBARRING, ntddrilapitypes/RIL_BARRTYPE_ALLINCOMING, RIL_BARRTYPE_ALL, RIL_BARRTYPE_ALLOUTGOINGBARRING, ntddrilapitypes/RIL_BARRTYPE_ALLINCOMINGBARRING, RILCALLBARRINGSTATUSPARAMSTYPE enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_BARRTYPE_INCOMINGNOTINUICC, RILCALLBARRINGSTATUSPARAMSTYPE, RIL_BARRTYPE_ALLINCOMING
