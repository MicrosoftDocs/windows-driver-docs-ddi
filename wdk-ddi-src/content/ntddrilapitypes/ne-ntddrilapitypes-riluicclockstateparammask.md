...
ms.date: 2/16/2018
ms.keywords: RILUICCLOCKSTATEPARAMMASK, RIL_PARAM_UICCLOCKSTATE_LOCKSTATE, netvista.riluicclockstateparammask, RIL_PARAM_UICCLOCKSTATE_VERIFYATTEMPTSLEFT, rilapitypes/RIL_PARAM_UICCLOCKSTATE_UICCLOCK, RILUICCLOCKSTATEPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_UICCLOCKSTATE_UNBLOCKATTEMPTSLEFT, rilapitypes/RIL_PARAM_UICCLOCKSTATE_VERIFYATTEMPTSLEFT, rilapitypes/RIL_PARAM_UICCLOCKSTATE_LOCKSTATE, rilapitypes/RIL_PARAM_UICCLOCKSTATE_UNBLOCKATTEMPTSLEFT, RIL_PARAM_UICCLOCKSTATE_ALL, rilapitypes/RIL_PARAM_UICCLOCKSTATE_ALL, RIL_PARAM_UICCLOCKSTATE_UICCLOCK, rilapitypes/RILUICCLOCKSTATEPARAMMASK
