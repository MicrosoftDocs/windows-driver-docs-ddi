...
ms.date: 1/18/2018
ms.keywords: RILCBMSGCONFIG structure [Network Drivers Starting with Windows Vista], *LPRILCBMSGCONFIG, RILCBMSGCONFIG, netvista.rilcbmsgconfig, ntddrilapitypes/RILCBMSGCONFIG
