...
ms.date: 2/16/2018
ms.keywords: netvista.rilconfparticipantstatusparammask, ntddrilapitypes/RIL_PARAM_CPS_CALLTRANSFER, RIL_PARAM_CPS_ALL, ntddrilapitypes/RILCONFPARTICIPANTSTATUSPARAMMASK, RILCONFPARTICIPANTSTATUSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PARAM_CPS_ID, RIL_PARAM_CPS_ID, RIL_PARAM_CPS_PARTICIPANTOP, ntddrilapitypes/RIL_PARAM_CPS_PARTICIPANTOP, RIL_PARAM_CPS_SIPSTATUS, ntddrilapitypes/RIL_PARAM_CPS_SIPSTATUS, ntddrilapitypes/RIL_PARAM_CPS_ADDRESS, ntddrilapitypes/RIL_PARAM_CPS_ALL, RILCONFPARTICIPANTSTATUSPARAMMASK, RIL_PARAM_CPS_CALLTRANSFER, RIL_PARAM_CPS_ADDRESS
