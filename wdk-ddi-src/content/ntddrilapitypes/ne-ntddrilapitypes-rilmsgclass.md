...
title: RILMSGCLASS (ntddrilapitypes.h)
description: "Microsoft reserves the RILMSGCLASS enumeration for internal use only. Don't use this enumeration in your code."
old-location: netvista\rilmsgclass.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILMSGCLASS enumeration"]
...
# RILMSGCLASS enumeration (ntddrilapitypes.h)
