...
title: RILRADIOCONFIGURATIONRADIOTYPE (ntddrilapitypes.h)
description: "Microsoft reserves this enumeration for internal use only. Don't use the RILRADIOCONFIGURATIONRADIOTYPE enumeration in your code."
...
f1_keywords:
 ...
 - ntddrilapitypes/RILRADIOCONFIGURATIONRADIOTYPE
topic_type:
 - APIRef
 - kbSyntax
api_type:
