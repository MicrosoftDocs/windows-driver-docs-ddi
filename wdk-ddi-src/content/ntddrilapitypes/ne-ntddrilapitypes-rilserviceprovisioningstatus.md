...
ms.date: 1/18/2018
ms.keywords: RIL_SVCPROV_NOTPROVISIONED, RIL_SVCPROV_TEMPMODERESTRICTED, RIL_SVCPROV_PROVISIONED, ntddrilapitypes/RILSERVICEPROVISIONINGSTATUS, RILSERVICEPROVISIONINGSTATUS enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_SVCPROV_PROVISIONED, ntddrilapitypes/RIL_SVCPROV_MAX, RIL_SVCPROV_TEMPMODEALLOWED, ntddrilapitypes/RIL_SVCPROV_NOTPROVISIONED, ntddrilapitypes/RIL_SVCPROV_TEMPMODEALLOWED, RIL_SVCPROV_MAX, RILSERVICEPROVISIONINGSTATUS, ntddrilapitypes/RIL_SVCPROV_TEMPMODERESTRICTED, netvista.rilserviceprovisioningstatus
