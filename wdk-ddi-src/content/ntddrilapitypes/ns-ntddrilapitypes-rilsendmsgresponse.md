...
ms.date: 1/18/2018
ms.keywords: netvista.rilsendmsgresponse, RILSENDMSGRESPONSE structure [Network Drivers Starting with Windows Vista], *LPRILSENDMSGRESPONSE, RILSENDMSGRESPONSE, ntddrilapitypes/RILSENDMSGRESPONSE
