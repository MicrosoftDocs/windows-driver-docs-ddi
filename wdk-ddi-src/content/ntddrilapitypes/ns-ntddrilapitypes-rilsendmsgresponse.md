...
ms.date: 2/16/2018
ms.keywords: RILSENDMSGRESPONSE structure [Network Drivers Starting with Windows Vista], RILSENDMSGRESPONSE, netvista.rilsendmsgresponse, *LPRILSENDMSGRESPONSE, ntddrilapitypes/RILSENDMSGRESPONSE
