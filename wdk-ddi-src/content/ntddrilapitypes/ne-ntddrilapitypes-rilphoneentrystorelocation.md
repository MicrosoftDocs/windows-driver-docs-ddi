...
ms.date: 2/16/2018
ms.keywords: RIL_PBLOC_ALL, RILPHONEENTRYSTORELOCATION enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PBLOC_UICCFIXDIALING, RIL_PBLOC_UICCFIXDIALING, RIL_PBLOC_UICCSERVICEDIALING, netvista.rilphoneentrystorelocation, RILPHONEENTRYSTORELOCATION, ntddrilapitypes/RILPHONEENTRYSTORELOCATION, RIL_PBLOC_UICCPHONEBOOK, ntddrilapitypes/RIL_PBLOC_UICCPHONEBOOK, ntddrilapitypes/RIL_PBLOC_UICCSERVICEDIALING, ntddrilapitypes/RIL_PBLOC_OWNNUMBERS, ntddrilapitypes/RIL_PBLOC_ALL, RIL_PBLOC_OWNNUMBERS
