...
ms.date: 1/18/2018
ms.keywords: RIL_PBLOC_ALL, ntddrilapitypes/RIL_PBLOC_UICCSERVICEDIALING, RILPHONEENTRYSTORELOCATION, RILPHONEENTRYSTORELOCATION enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PBLOC_UICCFIXDIALING, netvista.rilphoneentrystorelocation, RIL_PBLOC_UICCFIXDIALING, ntddrilapitypes/RIL_PBLOC_ALL, ntddrilapitypes/RIL_PBLOC_UICCPHONEBOOK, ntddrilapitypes/RIL_PBLOC_OWNNUMBERS, RIL_PBLOC_UICCPHONEBOOK, RIL_PBLOC_UICCSERVICEDIALING, RIL_PBLOC_OWNNUMBERS, ntddrilapitypes/RILPHONEENTRYSTORELOCATION
