...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RIL_PARAM_RPI_NUM_PRES_IND, RILREMOTEPARTYINFOVALUEPARAM, RIL_PARAM_RPI_ID, ntddrilapitypes/RIL_PARAM_RPI_ALL, RIL_PARAM_RPI_ADDRESS, RIL_PARAM_RPI_DESCRIPTION, RIL_PARAM_RPI_NUM_PRES_IND, RILREMOTEPARTYINFOPARAM, ntddrilapitypes/RIL_PARAM_RPI_DESCRIPTION, ntddrilapitypes/RILREMOTEPARTYINFOVALUEPARAM, ntddrilapitypes/RIL_PARAM_RPI_ID, RIL_PARAM_RPI_ALL, netvista.rilremotepartyinfovalueparam, RIL_PARAM_RPI_NAME_PRES_IND, RILREMOTEPARTYINFOVALUEPARAM enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PARAM_RPI_NAME_PRES_IND, RIL_PARAM_RPI_SUBADDRESS, ntddrilapitypes/RIL_PARAM_RPI_ADDRESS, ntddrilapitypes/RIL_PARAM_RPI_SUBADDRESS
