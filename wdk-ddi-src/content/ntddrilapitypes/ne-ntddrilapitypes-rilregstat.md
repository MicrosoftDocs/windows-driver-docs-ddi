...
ms.date: 2/16/2018
ms.keywords: netvista.rilregstat, RILREGSTAT enumeration [Network Drivers Starting with Windows Vista], RIL_REGSTAT_DENIED, rilapitypes/RILREGSTAT, RIL_REGSTAT_HOME, rilapitypes/RIL_REGSTAT_ATTEMPTING, rilapitypes/RIL_REGSTAT_HOME, rilapitypes/RIL_REGSTAT_UNKNOWN, RIL_REGSTAT_UNREGISTERED, rilapitypes/RIL_REGSTAT_ROAMING, RIL_REGSTAT_ROAMING_INTL, rilapitypes/RIL_REGSTAT_UNREGISTERED, RIL_REGSTAT_UNKNOWN, RIL_REGSTAT_ROAMING, rilapitypes/RIL_REGSTAT_DENIED, RIL_REGSTAT_ATTEMPTING, rilapitypes/RIL_REGSTAT_ROAMING_INTL, RILREGSTAT
