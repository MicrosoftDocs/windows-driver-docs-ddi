...
ms.date: 2/16/2018
ms.keywords: RILMSGBCGENERALWARNINGTYPE enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_WARNINGTYPE_TSUNAMI, ntddrilapitypes/RIL_WARNINGTYPE_OTHER, RIL_WARNINGTYPE_RESERVED, RIL_WARNINGTYPE_MAX, ntddrilapitypes/RIL_WARNINGTYPE_TEST, RIL_WARNINGTYPE_EARTHQUAKETSUNAMI, ntddrilapitypes/RILMSGBCGENERALWARNINGTYPE, RILMSGBCGENERALWARNINGTYPE, ntddrilapitypes/RIL_WARNINGTYPE_RESERVED, RIL_WARNINGTYPE_TSUNAMI, RIL_WARNINGTYPE_OTHER, ntddrilapitypes/RIL_WARNINGTYPE_EARTHQUAKETSUNAMI, RIL_WARNINGTYPE_TEST, ntddrilapitypes/RIL_WARNINGTYPE_MAX, netvista.rilmsgbcgeneralwarningtype
