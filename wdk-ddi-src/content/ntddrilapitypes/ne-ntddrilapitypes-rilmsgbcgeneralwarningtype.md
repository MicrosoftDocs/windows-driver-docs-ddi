...
description: "Microsoft reserves the RILMSGBCGENERALWARNINGTYPE enumeration for internal use only. Don't use the RILMSGBCGENERALWARNINGTYPE enumeration in your code."
