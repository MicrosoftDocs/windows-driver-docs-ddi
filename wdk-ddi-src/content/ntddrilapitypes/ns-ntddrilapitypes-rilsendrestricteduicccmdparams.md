...
description: "Microsoft reserves this structure for internal use only. Don't use the RILSENDRESTRICTEDUICCCMDPARAMS structure in your code."
...
f1_keywords:
 ...
 - ntddrilapitypes/LPRILSENDRESTRICTEDUICCCMDPARAMS
topic_type:
 - APIRef
 - kbSyntax
api_type:
