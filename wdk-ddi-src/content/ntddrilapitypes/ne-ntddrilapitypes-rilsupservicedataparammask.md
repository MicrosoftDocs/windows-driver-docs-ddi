...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RIL_PARAM_SSDI_STATUS, RIL_PARAM_SSDI_DATA, RIL_PARAM_SSDI_DATASIZE, ntddrilapitypes/RIL_PARAM_SSDI_ALL, RIL_PARAM_SSDI_ALL, ntddrilapitypes/RIL_PARAM_SSDI_SS_ERROR, RILSUPSERVICEDATAPARAMMASK, netvista.rilsupservicedataparammask, ntddrilapitypes/RILSUPSERVICEDATAPARAMMASK, RILSUPSERVICEDATAPARAMMASK enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PARAM_SSDI_VENDOR_ERROR, RIL_PARAM_SSDI_STATUS, RIL_PARAM_SSDI_CC_ERROR, ntddrilapitypes/RIL_PARAM_SSDI_DATASIZE, RIL_PARAM_SSDI_SS_ERROR, ntddrilapitypes/RIL_PARAM_SSDI_CC_ERROR, ntddrilapitypes/RIL_PARAM_SSDI_DATA, RIL_PARAM_SSDI_VENDOR_ERROR
