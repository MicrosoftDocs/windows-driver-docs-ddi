...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_PARAM_SSDI_SS_ERROR, ntddrilapitypes/RIL_PARAM_SSDI_ALL, RILSUPSERVICEDATAPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_SSDI_CC_ERROR, RIL_PARAM_SSDI_SS_ERROR, RILSUPSERVICEDATAPARAMMASK, ntddrilapitypes/RIL_PARAM_SSDI_VENDOR_ERROR, RIL_PARAM_SSDI_ALL, RIL_PARAM_SSDI_DATASIZE, ntddrilapitypes/RIL_PARAM_SSDI_DATA, ntddrilapitypes/RIL_PARAM_SSDI_DATASIZE, RIL_PARAM_SSDI_DATA, ntddrilapitypes/RIL_PARAM_SSDI_CC_ERROR, ntddrilapitypes/RILSUPSERVICEDATAPARAMMASK, ntddrilapitypes/RIL_PARAM_SSDI_STATUS, RIL_PARAM_SSDI_STATUS, netvista.rilsupservicedataparammask, RIL_PARAM_SSDI_VENDOR_ERROR
