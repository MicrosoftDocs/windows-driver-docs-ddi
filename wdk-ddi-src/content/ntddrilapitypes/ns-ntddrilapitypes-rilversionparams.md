...
title: RILVERSIONPARAMS (ntddrilapitypes.h)
description: "Microsoft reserves the RILVERSIONPARAMS structure for internal use only. Don't use the RILVERSIONPARAMS structure in your code."
