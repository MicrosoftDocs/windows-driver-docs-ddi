...
ms.date: 1/18/2018
ms.keywords: netvista.rilversionparams, ntddrilapitypes/RILVERSIONPARAMS, *LPRILVERSIONPARAMS, RILVERSIONPARAMS structure [Network Drivers Starting with Windows Vista], RILVERSIONPARAMS
