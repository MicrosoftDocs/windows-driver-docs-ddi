...
ms.date: 2/16/2018
ms.keywords: netvista.riluicclockstate, rilapitypes/RILUICCLOCKSTATE, RILUICCLOCKSTATE structure [Network Drivers Starting with Windows Vista], *LPRILUICCLOCKSTATE, RILUICCLOCKSTATE
