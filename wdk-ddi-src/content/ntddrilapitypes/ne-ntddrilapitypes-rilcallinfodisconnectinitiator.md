...
description: "Microsoft reserves the RILCALLINFODISCONNECTINITIATOR enumeration for internal use only. Don't use the RILCALLINFODISCONNECTINITIATOR enumeration in your code."
...
# RILCALLINFODISCONNECTINITIATOR enumeration (ntddrilapitypes.h)
