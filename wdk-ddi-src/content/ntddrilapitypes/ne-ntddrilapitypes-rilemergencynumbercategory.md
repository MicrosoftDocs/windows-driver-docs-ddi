...
ms.date: 2/16/2018
ms.keywords: RIL_ENUM_ALL, netvista.rilemergencynumbercategory, RIL_ENUM_MANUAL_ECALL, RILEMERGENCYNUMBERCATEGORY, ntddrilapitypes/RIL_ENUM_MOUNTAIN_RESCUE, ntddrilapitypes/RIL_ENUM_MARINE_GUARD, RIL_ENUM_FIRE_BRIGADE, ntddrilapitypes/RIL_ENUM_FIRE_BRIGADE, RIL_ENUM_AMBULANCE, RIL_ENUM_MOUNTAIN_RESCUE, RILEMERGENCYNUMBERCATEGORY enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_ENUM_MANUAL_ECALL, ntddrilapitypes/RIL_ENUM_ALL, ntddrilapitypes/RIL_ENUM_AMBULANCE, RIL_ENUM_AUTO_ECALL, RIL_ENUM_MARINE_GUARD, ntddrilapitypes/RIL_ENUM_AUTO_ECALL, ntddrilapitypes/RILEMERGENCYNUMBERCATEGORY
