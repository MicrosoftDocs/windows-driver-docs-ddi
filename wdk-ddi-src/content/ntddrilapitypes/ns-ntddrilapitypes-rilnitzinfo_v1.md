...
description: "Microsoft reserves the RILNITZINFO_V1 structure for internal use only. Don't use the RILNITZINFO_V1 structure in your code."
...
f1_keywords:
 ...
 - LPRILNITZINFO_V1
 - ntddrilapitypes/LPRILNITZINFO_V1
topic_type:
 - APIRef
 - kbSyntax
api_type:
