...
title: RILMSGDCSPARAMMASK (ntddrilapitypes.h)
description: "Microsoft reserves this enumeration for internal use only. Don't use the RILMSGDCSPARAMMASK enumeration in your code."
...
f1_keywords:
 - RILMSGDCSPARAMMASK
 - ntddrilapitypes/RILMSGDCSPARAMMASK
topic_type:
 - APIRef
 - kbSyntax
api_type:
