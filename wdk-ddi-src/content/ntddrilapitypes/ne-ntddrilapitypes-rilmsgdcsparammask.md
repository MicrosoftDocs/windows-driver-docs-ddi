...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_PARAM_MDCS_LANGUAGE, ntddrilapitypes/RIL_PARAM_MDCS_ALPHABET, ntddrilapitypes/RIL_PARAM_MDCS_FLAGS, ntddrilapitypes/RIL_PARAM_MDCS_ALL, ntddrilapitypes/RILMSGDCSPARAMMASK, RIL_PARAM_MDCS_MSGCLASS, RILMSGDCSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], netvista.rilmsgdcsparammask, ntddrilapitypes/RIL_PARAM_MDCS_INDICATION, RILMSGDCSPARAMMASK, RIL_PARAM_MDCS_LANGUAGE, ntddrilapitypes/RIL_PARAM_MDCS_MSGCLASS, RIL_PARAM_MDCS_ALL, RIL_PARAM_MDCS_ALPHABET, RIL_PARAM_MDCS_INDICATION, RIL_PARAM_MDCS_FLAGS
