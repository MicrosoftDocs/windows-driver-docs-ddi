...
title: RILUICCFILES (ntddrilapitypes.h)
description: "Microsoft reserves the RILUICCFILES structure for internal use only. Don't use the RILUICCFILES structure in your code."
