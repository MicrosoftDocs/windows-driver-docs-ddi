...
description: "Microsoft reserves the RILUNSOLICITEDSSINFOPARAMMASK enumeration for internal use only. Don't use this enumeration in your code."
...
# RILUNSOLICITEDSSINFOPARAMMASK enumeration (ntddrilapitypes.h)
