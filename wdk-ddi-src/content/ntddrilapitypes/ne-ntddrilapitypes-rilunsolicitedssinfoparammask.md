...
ms.date: 1/18/2018
ms.keywords: RILUNSOLICITEDSSINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_UNSSS_ADDRESS, ntddrilapitypes/RIL_PARAM_UNSSS_SUBADDR, RIL_PARAM_UNSSS_ID, RIL_PARAM_UNSSS_HISTLENGTH, RIL_PARAM_UNSSS_HISTINFO, ntddrilapitypes/RIL_PARAM_UNSSS_CUGINDEX, ntddrilapitypes/RIL_PARAM_UNSSS_HISTLENGTH, RIL_PARAM_UNSSS_ALL, ntddrilapitypes/RIL_PARAM_UNSSS_HISTINFO, netvista.rilunsolicitedssinfoparammask, ntddrilapitypes/RIL_PARAM_UNSSS_ADDRESS, RILUNSOLICITEDSSINFOPARAMMASK, RIL_PARAM_UNSSS_NOTIFICATIONCODE, ntddrilapitypes/RIL_PARAM_UNSSS_ALL, RIL_PARAM_UNSSS_CUGINDEX, ntddrilapitypes/RILUNSOLICITEDSSINFOPARAMMASK, ntddrilapitypes/RIL_PARAM_UNSSS_ID, RIL_PARAM_UNSSS_SUBADDR, ntddrilapitypes/RIL_PARAM_UNSSS_NOTIFICATIONCODE
