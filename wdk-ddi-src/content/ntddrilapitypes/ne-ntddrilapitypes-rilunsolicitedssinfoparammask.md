...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_PARAM_UNSSS_CUGINDEX, RIL_PARAM_UNSSS_SUBADDR, RIL_PARAM_UNSSS_ALL, RIL_PARAM_UNSSS_HISTINFO, RILUNSOLICITEDSSINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RILUNSOLICITEDSSINFOPARAMMASK, ntddrilapitypes/RIL_PARAM_UNSSS_SUBADDR, RIL_PARAM_UNSSS_ID, netvista.rilunsolicitedssinfoparammask, RIL_PARAM_UNSSS_NOTIFICATIONCODE, RIL_PARAM_UNSSS_HISTLENGTH, ntddrilapitypes/RIL_PARAM_UNSSS_ID, RIL_PARAM_UNSSS_ADDRESS, ntddrilapitypes/RIL_PARAM_UNSSS_HISTINFO, ntddrilapitypes/RILUNSOLICITEDSSINFOPARAMMASK, ntddrilapitypes/RIL_PARAM_UNSSS_HISTLENGTH, RIL_PARAM_UNSSS_CUGINDEX, ntddrilapitypes/RIL_PARAM_UNSSS_NOTIFICATIONCODE, ntddrilapitypes/RIL_PARAM_UNSSS_ALL, ntddrilapitypes/RIL_PARAM_UNSSS_ADDRESS
