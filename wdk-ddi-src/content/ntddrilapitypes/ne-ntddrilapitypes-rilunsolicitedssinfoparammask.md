...
ms.date: 2/16/2018
ms.keywords: RIL_PARAM_UNSSS_HISTINFO, ntddrilapitypes/RIL_PARAM_UNSSS_HISTINFO, ntddrilapitypes/RIL_PARAM_UNSSS_ID, RIL_PARAM_UNSSS_ALL, RILUNSOLICITEDSSINFOPARAMMASK, netvista.rilunsolicitedssinfoparammask, RILUNSOLICITEDSSINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_UNSSS_SUBADDR, RIL_PARAM_UNSSS_ID, RIL_PARAM_UNSSS_ADDRESS, RIL_PARAM_UNSSS_NOTIFICATIONCODE, RIL_PARAM_UNSSS_HISTLENGTH, ntddrilapitypes/RIL_PARAM_UNSSS_HISTLENGTH, ntddrilapitypes/RIL_PARAM_UNSSS_ALL, RIL_PARAM_UNSSS_CUGINDEX, ntddrilapitypes/RILUNSOLICITEDSSINFOPARAMMASK, ntddrilapitypes/RIL_PARAM_UNSSS_CUGINDEX, ntddrilapitypes/RIL_PARAM_UNSSS_SUBADDR, ntddrilapitypes/RIL_PARAM_UNSSS_NOTIFICATIONCODE, ntddrilapitypes/RIL_PARAM_UNSSS_ADDRESS
