...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RIL_PARAM_UNSSS_HISTLENGTH, ntddrilapitypes/RIL_PARAM_UNSSS_HISTINFO, RIL_PARAM_UNSSS_ALL, ntddrilapitypes/RILUNSOLICITEDSSINFOPARAMMASK, ntddrilapitypes/RIL_PARAM_UNSSS_ALL, RIL_PARAM_UNSSS_HISTINFO, netvista.rilunsolicitedssinfoparammask, RILUNSOLICITEDSSINFOPARAMMASK, RILUNSOLICITEDSSINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_UNSSS_NOTIFICATIONCODE, RIL_PARAM_UNSSS_ADDRESS, ntddrilapitypes/RIL_PARAM_UNSSS_ID, ntddrilapitypes/RIL_PARAM_UNSSS_SUBADDR, ntddrilapitypes/RIL_PARAM_UNSSS_NOTIFICATIONCODE, RIL_PARAM_UNSSS_HISTLENGTH, ntddrilapitypes/RIL_PARAM_UNSSS_ADDRESS, RIL_PARAM_UNSSS_ID, ntddrilapitypes/RIL_PARAM_UNSSS_CUGINDEX, RIL_PARAM_UNSSS_CUGINDEX, RIL_PARAM_UNSSS_SUBADDR
