...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_PARAM_MSGRES_CDMAERRORCLASS, netvista.rilsendmsgresponseparammask, RIL_PARAM_MSGRES_MSGID, ntddrilapitypes/RIL_PARAM_MSGRES_GWLTRANSPORTCODE, ntddrilapitypes/RIL_PARAM_MSGRES_GWLRELAYCODE, ntddrilapitypes/RIL_PARAM_MSGRES_MSGID, RIL_PARAM_MSGRES_CDMACAUSECODE, RILSENDMSGRESPONSEPARAMMASK enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILSENDMSGRESPONSEPARAMMASK, RIL_PARAM_MSGRES_GWLTRANSPORTCODE, RIL_PARAM_MSGRES_ALL, ntddrilapitypes/RIL_PARAM_MSGRES_ALL, ntddrilapitypes/RIL_PARAM_MSGRES_CDMACAUSECODE, RILSENDMSGRESPONSEPARAMMASK, RIL_PARAM_MSGRES_GWLRELAYCODE, RIL_PARAM_MSGRES_CDMAERRORCLASS
