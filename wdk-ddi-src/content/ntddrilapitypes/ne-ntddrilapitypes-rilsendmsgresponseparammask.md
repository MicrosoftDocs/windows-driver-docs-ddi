...
description: "Microsoft reserves the RILSENDMSGRESPONSEPARAMMASK enumeration for internal use only. Don't use this enumeration in your code."
...
# RILSENDMSGRESPONSEPARAMMASK enumeration (ntddrilapitypes.h)
