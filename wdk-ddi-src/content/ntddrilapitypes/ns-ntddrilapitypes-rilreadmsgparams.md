...
ms.date: 2/16/2018
ms.keywords: RILREADMSGPARAMS structure [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILREADMSGPARAMS, netvista.rilreadmsgparams, *LPRILREADMSGPARAMS, RILREADMSGPARAMS
