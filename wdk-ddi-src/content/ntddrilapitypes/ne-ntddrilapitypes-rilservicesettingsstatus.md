...
title: RILSERVICESETTINGSSTATUS (ntddrilapitypes.h)
description: "Don't use this enumeration in your code. Microsoft reserves the RILSERVICESETTINGSSTATUS enumeration for internal use only."
