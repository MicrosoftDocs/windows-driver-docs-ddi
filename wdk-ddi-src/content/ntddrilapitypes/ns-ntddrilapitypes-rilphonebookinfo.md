...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RILPHONEBOOKINFO, netvista.rilphonebookinfo, RILPHONEBOOKINFO, RILPHONEBOOKINFO structure [Network Drivers Starting with Windows Vista], *LPRILPHONEBOOKINFO
