...
ms.date: 1/18/2018
ms.keywords: netvista.rilphonebookinfo, *LPRILPHONEBOOKINFO, RILPHONEBOOKINFO structure [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILPHONEBOOKINFO, RILPHONEBOOKINFO
