...
description: "Microsoft reserves the RILCALLSUPPORTCAPS enumeration for internal use only. Don't use this enumeration in your code."
...
f1_keywords:
 - RILCALLSUPPORTCAPS
 - ntddrilapitypes/RILCALLSUPPORTCAPS
topic_type:
 - APIRef
 - kbSyntax
api_type:
