...
ms.date: 2/16/2018
ms.keywords: RIL_PARAM_HANDOVER_NEW_TYPE, RILCALLHANDOVERSTATEPARAMMASK, RILCALLHANDOVERSTATEPARAMMASK enumeration [Network Drivers Starting with Windows Vista], RIL_PARAM_HANDOVER_ALL, ntddrilapitypes/RIL_PARAM_HANDOVER_3GPPCAUSE, netvista.rilcallhandoverstateparammask, ntddrilapitypes/RIL_PARAM_HANDOVER_ALL, RIL_PARAM_HANDOVER_3GPPCAUSE, ntddrilapitypes/RIL_PARAM_HANDOVER_OLD_TYPE, RIL_PARAM_HANDOVER_OLD_TYPE, ntddrilapitypes/RILCALLHANDOVERSTATEPARAMMASK, ntddrilapitypes/RIL_PARAM_HANDOVER_NEW_TYPE
