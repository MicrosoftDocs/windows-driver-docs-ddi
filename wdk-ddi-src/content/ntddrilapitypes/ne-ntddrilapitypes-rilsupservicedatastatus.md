...
title: RILSUPSERVICEDATASTATUS (ntddrilapitypes.h)
description: "Microsoft reserves this enumeration for internal use only. Don't use the RILSUPSERVICEDATASTATUS enumeration in your code."
...
f1_keywords:
 ...
 - ntddrilapitypes/RILSUPSERVICEDATASTATUS
topic_type:
 - APIRef
 - kbSyntax
api_type:
