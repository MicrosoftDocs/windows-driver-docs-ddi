...
description: "Microsoft reserves the RILCALLINFOPARAMMASK enumeration for internal use only. Don't use this enumeration in your code."
...
f1_keywords:
 ...
 - ntddrilapitypes/RILCALLINFOPARAMMASK
topic_type:
 - APIRef
 - kbSyntax
api_type:
