...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_PARAM_CI_NUM_PRES_IND, ntddrilapitypes/RIL_PARAM_CI_DESCRIPTION, ntddrilapitypes/RIL_PARAM_CI_FLAGS, RIL_PARAM_CI_MULTIPARTY, RIL_PARAM_CI_NAME_PRES_IND, RIL_PARAM_CI_RTTCAPINFO, ntddrilapitypes/RIL_PARAM_CI_RTTCAPINFO, netvista.rilcallinfoparammask, RIL_PARAM_CI_OFFERANSWER, RIL_PARAM_CI_DESCRIPTION, ntddrilapitypes/RIL_PARAM_CI_ID, ntddrilapitypes/RIL_PARAM_CI_DIRECTION, RIL_PARAM_CI_HANDOVERSTATE, RILCALLINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PARAM_CI_NAME_PRES_IND, ntddrilapitypes/RIL_PARAM_CI_OFFERANSWER, ntddrilapitypes/RIL_PARAM_CI_TYPE, RIL_PARAM_CI_ID, ntddrilapitypes/RIL_PARAM_CI_STATUS, ntddrilapitypes/RIL_PARAM_CI_DISCONNECTINITIATOR, RIL_PARAM_CI_DIRECTION, RIL_PARAM_CI_RTTMODETYPE, ntddrilapitypes/RIL_PARAM_CI_ADDRESS, RIL_PARAM_CI_DISCONNECTINITIATOR, RIL_PARAM_CI_FLAGS, ntddrilapitypes/RIL_PARAM_CI_ALL, ntddrilapitypes/RIL_PARAM_CI_RTTMODETYPE, ntddrilapitypes/RIL_PARAM_CI_DISCONNECTREASON, ntddrilapitypes/RILCALLINFOPARAMMASK, RIL_PARAM_CI_CALLMODIFICATIONCAUSE, ntddrilapitypes/RIL_PARAM_CI_RTTACTION, RIL_PARAM_CI_STATUS, RILCALLINFOPARAMMASK, RIL_PARAM_CI_DISCONNECTREASON, ntddrilapitypes/RIL_PARAM_CI_CALLMODIFICATIONCAUSE, RIL_PARAM_CI_NUM_PRES_IND, RIL_PARAM_CI_RTTACTION, RIL_PARAM_CI_ADDRESS, ntddrilapitypes/RIL_PARAM_CI_SUBADDRESS, ntddrilapitypes/RIL_PARAM_CI_HANDOVERSTATE, ntddrilapitypes/RIL_PARAM_CI_DISCONNECTDETAILS, RIL_PARAM_CI_DISCONNECTDETAILS, ntddrilapitypes/RIL_PARAM_CI_MULTIPARTY, RIL_PARAM_CI_SUBADDRESS, RIL_PARAM_CI_ALL, RIL_PARAM_CI_TYPE
