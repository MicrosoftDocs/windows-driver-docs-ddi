...
ms.date: 1/18/2018
ms.keywords: RILCALLRTTCAP structure [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILCALLRTTCAP, *LPRILCALLRTTCAP, netvista.rilcallrttcap, RILCALLRTTCAP
