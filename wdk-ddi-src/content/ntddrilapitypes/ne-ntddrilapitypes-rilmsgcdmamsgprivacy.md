...
description: "Microsoft reserves the RILMSGCDMAMSGPRIVACY enumeration for internal use only. Don't use the RILMSGCDMAMSGPRIVACY enumeration in your code."
...
# RILMSGCDMAMSGPRIVACY enumeration (ntddrilapitypes.h)
