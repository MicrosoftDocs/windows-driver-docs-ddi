...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_DISCREASON_RADIOFADE, ntddrilapitypes/RIL_DISCREASON_BUSY, RIL_DISCREASON_HANDOVER_MERGE, RIL_DISCREASON_EMERGENCYFAILOVER, RIL_DISCREASON_RADIOFADE, ntddrilapitypes/RIL_DISCREASON_EMERGENCYONLY, RIL_DISCREASON_NETWORKERROR, ntddrilapitypes/RIL_DISCREASON_HANDOVER_MERGE, RIL_DISCREASON_CONGESTION, ntddrilapitypes/RIL_DISCREASON_NOSERVICE, RIL_DISCREASON_OTHEREXECUTORBUSY, RILCALLINFODISCONNECTREASON, netvista.rilcallinfodisconnectreason, ntddrilapitypes/RIL_DISCREASON_MAX, RIL_DISCREASON_EMERGENCYONLY, RIL_DISCREASON_MAX, RIL_DISCREASON_NOSERVICE, RILCALLINFODISCONNECTREASON enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_DISCREASON_EMERGENCYFAILOVER, ntddrilapitypes/RILCALLINFODISCONNECTREASON, ntddrilapitypes/RIL_DISCREASON_NETWORKERROR, RIL_DISCREASON_BUSY, ntddrilapitypes/RIL_DISCREASON_OTHEREXECUTORBUSY, ntddrilapitypes/RIL_DISCREASON_CONGESTION
