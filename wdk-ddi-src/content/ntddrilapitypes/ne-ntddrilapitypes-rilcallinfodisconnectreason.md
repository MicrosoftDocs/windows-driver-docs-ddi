...
ms.date: 1/18/2018
ms.keywords: RILCALLINFODISCONNECTREASON, ntddrilapitypes/RIL_DISCREASON_EMERGENCYONLY, ntddrilapitypes/RIL_DISCREASON_NETWORKERROR, RIL_DISCREASON_CONGESTION, RIL_DISCREASON_EMERGENCYFAILOVER, ntddrilapitypes/RIL_DISCREASON_CONGESTION, netvista.rilcallinfodisconnectreason, ntddrilapitypes/RILCALLINFODISCONNECTREASON, RIL_DISCREASON_OTHEREXECUTORBUSY, RIL_DISCREASON_BUSY, RILCALLINFODISCONNECTREASON enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_DISCREASON_HANDOVER_MERGE, ntddrilapitypes/RIL_DISCREASON_OTHEREXECUTORBUSY, ntddrilapitypes/RIL_DISCREASON_RADIOFADE, RIL_DISCREASON_MAX, RIL_DISCREASON_HANDOVER_MERGE, ntddrilapitypes/RIL_DISCREASON_EMERGENCYFAILOVER, RIL_DISCREASON_EMERGENCYONLY, RIL_DISCREASON_NOSERVICE, RIL_DISCREASON_RADIOFADE, ntddrilapitypes/RIL_DISCREASON_MAX, RIL_DISCREASON_NETWORKERROR, ntddrilapitypes/RIL_DISCREASON_BUSY, ntddrilapitypes/RIL_DISCREASON_NOSERVICE
