...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RIL_DISCREASON_EMERGENCYONLY, ntddrilapitypes/RIL_DISCREASON_BUSY, RILCALLINFODISCONNECTREASON enumeration [Network Drivers Starting with Windows Vista], RILCALLINFODISCONNECTREASON, RIL_DISCREASON_HANDOVER_MERGE, ntddrilapitypes/RILCALLINFODISCONNECTREASON, RIL_DISCREASON_BUSY, ntddrilapitypes/RIL_DISCREASON_MAX, RIL_DISCREASON_MAX, ntddrilapitypes/RIL_DISCREASON_OTHEREXECUTORBUSY, RIL_DISCREASON_OTHEREXECUTORBUSY, RIL_DISCREASON_RADIOFADE, RIL_DISCREASON_CONGESTION, ntddrilapitypes/RIL_DISCREASON_NOSERVICE, RIL_DISCREASON_EMERGENCYONLY, RIL_DISCREASON_EMERGENCYFAILOVER, ntddrilapitypes/RIL_DISCREASON_NETWORKERROR, ntddrilapitypes/RIL_DISCREASON_RADIOFADE, ntddrilapitypes/RIL_DISCREASON_HANDOVER_MERGE, RIL_DISCREASON_NETWORKERROR, ntddrilapitypes/RIL_DISCREASON_EMERGENCYFAILOVER, ntddrilapitypes/RIL_DISCREASON_CONGESTION, RIL_DISCREASON_NOSERVICE, netvista.rilcallinfodisconnectreason
