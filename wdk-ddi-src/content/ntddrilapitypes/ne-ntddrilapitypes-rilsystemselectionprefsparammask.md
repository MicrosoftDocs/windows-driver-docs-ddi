...
ms.date: 1/18/2018
ms.keywords: RIL_PARAM_SSP_SYSTEMTYPES, ntddrilapitypes/RIL_PARAM_SSP_MODE, ntddrilapitypes/RIL_PARAM_SSP_ROAMINGMODE, RIL_PARAM_SSP_ROAMINGMODE, RIL_PARAM_SSP_ALL, RIL_PARAM_SSP_ACQUISITIONORDERSIZE, ntddrilapitypes/RIL_PARAM_SSP_ACQUISITIONORDERSIZE, RILSYSTEMSELECTIONPREFSPARAMMASK enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PARAM_SSP_ALL, ntddrilapitypes/RIL_PARAM_SSP_ACQUISITIONORDER, ntddrilapitypes/RIL_PARAM_SSP_PLMNINFO, RIL_PARAM_SSP_MODE, RILSYSTEMSELECTIONPREFSPARAMMASK, RIL_PARAM_SSP_ACQUISITIONORDER, ntddrilapitypes/RILSYSTEMSELECTIONPREFSPARAMMASK, ntddrilapitypes/RIL_PARAM_SSP_SYSTEMTYPES, netvista.rilsystemselectionprefsparammask, RIL_PARAM_SSP_PLMNINFO
