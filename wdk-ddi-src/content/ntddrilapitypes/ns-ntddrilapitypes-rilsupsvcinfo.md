...
title: RILSUPSVCINFO (ntddrilapitypes.h)
description: "Don't use the RILSUPSVCINFO structure in your code. Microsoft reserves the RILSUPSVCINFO structure for internal use only."
...
f1_keywords:
 ...
 - LPRILSUPSVCINFO
 - ntddrilapitypes/LPRILSUPSVCINFO
topic_type:
 - APIRef
 - kbSyntax
api_type:
