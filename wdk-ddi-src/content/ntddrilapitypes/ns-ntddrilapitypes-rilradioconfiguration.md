...
ms.date: 2/16/2018
ms.keywords: ",  , *, *LPRILRADIOCONFIGURATION, ,, A, C, D, F, G, I, L, N, O, P, R, RILRADIOCONFIGURATION, RILRADIOCONFIGURATION structure [Network Drivers Starting with Windows Vista], T, U, netvista.rilradioconfiguration, ntddrilapitypes/RILRADIOCONFIGURATION"
