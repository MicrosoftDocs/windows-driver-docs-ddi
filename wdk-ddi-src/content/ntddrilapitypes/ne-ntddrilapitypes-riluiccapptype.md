...
ms.date: 2/16/2018
ms.keywords: RIL_UICCAPPTYPE_UNKNOWN, rilapitypes/RIL_UICCAPPTYPE_MF_RUIM, RIL_UICCAPPTYPE_ISIM, rilapitypes/RIL_UICCAPPTYPE_ISIM, rilapitypes/RIL_UICCAPPTYPE_MF, rilapitypes/RIL_UICCAPPTYPE_MF_SIM, rilapitypes/RILUICCAPPTYPE, rilapitypes/RIL_UICCAPPTYPE_USIM, RIL_UICCAPPTYPE_CSIM, RILUICCAPPTYPE enumeration [Network Drivers Starting with Windows Vista], rilapitypes/RIL_UICCAPPTYPE_UNKNOWN, RIL_UICCAPPTYPE_MF, RILUICCAPPTYPE, RIL_UICCAPPTYPE_MF_SIM, RIL_UICCAPPTYPE_USIM, RIL_UICCAPPTYPE_MF_RUIM, netvista.riluiccapptype, rilapitypes/RIL_UICCAPPTYPE_CSIM
