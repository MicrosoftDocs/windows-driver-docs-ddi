...
description: "Microsoft reserves the RILINFOCLASS enumeration for internal use only. Don't use the RILINFOCLASS enumeration in your code."
...
# RILINFOCLASS enumeration (ntddrilapitypes.h)
