...
ms.date: 2/16/2018
ms.keywords: RIL_MSGFLAG_HEADER, ntddrilapitypes/RILMESSAGEFLAGS, RILMESSAGEFLAGS enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_MSGFLAG_STATUSREPORTREQUESTED, ntddrilapitypes/RIL_MSGFLAG_REPLYPATH, ntddrilapitypes/RIL_MSGFLAG_CAUSEDBYCOMMAND, ntddrilapitypes/RIL_MSGFLAG_HEADER, RIL_MSGFLAG_ALL, RIL_MSGFLAG_MORETOSEND, RIL_MSGFLAG_REPLYPATH, ntddrilapitypes/RIL_MSGFLAG_ALL, netvista.rilmessageflags, RIL_MSGFLAG_REJECTDUPS, ntddrilapitypes/RIL_MSGFLAG_REJECTDUPS, RIL_MSGFLAG_STATUSREPORTRETURNED, RIL_MSGFLAG_STATUSREPORTREQUESTED, ntddrilapitypes/RIL_MSGFLAG_STATUSREPORTRETURNED, RIL_MSGFLAG_CAUSEDBYCOMMAND, RILMESSAGEFLAGS, ntddrilapitypes/RIL_MSGFLAG_MORETOSEND
