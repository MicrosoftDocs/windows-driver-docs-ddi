...
ms.date: 1/18/2018
ms.keywords: netvista.rilpsmediapreference, RILPSMEDIAPREFERENCE, ntddrilapitypes/RIL_PSMPREF_WIFIONLY, ntddrilapitypes/RILPSMEDIAPREFERENCE, RIL_PSMPREF_WIFIPREFERRED, RIL_PSMPREF_NUMBER_OF_VALUES, ntddrilapitypes/RIL_PSMPREF_CELLPREFERRED, ntddrilapitypes/RIL_PSMPREF_WIFIPREFERRED, RIL_PSMPREF_CELLONLY, RILPSMEDIAPREFERENCE enumeration [Network Drivers Starting with Windows Vista], RIL_PSMPREF_CELLPREFERRED, ntddrilapitypes/RIL_PSMPREF_CELLONLY, ntddrilapitypes/RIL_PSMPREF_NUMBER_OF_VALUES, RIL_PSMPREF_WIFIONLY
