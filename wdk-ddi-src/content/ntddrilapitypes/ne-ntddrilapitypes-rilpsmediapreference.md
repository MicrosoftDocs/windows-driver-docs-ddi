...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_PSMPREF_WIFIONLY, RIL_PSMPREF_WIFIONLY, RIL_PSMPREF_CELLONLY, RILPSMEDIAPREFERENCE, ntddrilapitypes/RILPSMEDIAPREFERENCE, RILPSMEDIAPREFERENCE enumeration [Network Drivers Starting with Windows Vista], RIL_PSMPREF_NUMBER_OF_VALUES, ntddrilapitypes/RIL_PSMPREF_WIFIPREFERRED, ntddrilapitypes/RIL_PSMPREF_CELLONLY, RIL_PSMPREF_CELLPREFERRED, ntddrilapitypes/RIL_PSMPREF_NUMBER_OF_VALUES, netvista.rilpsmediapreference, ntddrilapitypes/RIL_PSMPREF_CELLPREFERRED, RIL_PSMPREF_WIFIPREFERRED
