...
description: "Microsoft reserves the RILLOCATIONINFOPARAMMASK enumeration for internal use only. Don't use the RILLOCATIONINFOPARAMMASK enumeration in your code."
old-location: netvista\rillocationinfoparammask.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILLOCATIONINFOPARAMMASK enumeration"]
...
f1_keywords:
 ...
 - ntddrilapitypes/RILLOCATIONINFOPARAMMASK
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# RILLOCATIONINFOPARAMMASK enumeration (ntddrilapitypes.h)
