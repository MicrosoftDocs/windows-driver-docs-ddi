...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RILMESSAGEINFO, RILMESSAGEINFO structure [Network Drivers Starting with Windows Vista], netvista.rilmessageinfo, *LPRILMESSAGEINFO, RILMESSAGEINFO
