...
ms.date: 1/18/2018
ms.keywords: RILMESSAGEINFO structure [Network Drivers Starting with Windows Vista], netvista.rilmessageinfo, ntddrilapitypes/RILMESSAGEINFO, RILMESSAGEINFO, *LPRILMESSAGEINFO
