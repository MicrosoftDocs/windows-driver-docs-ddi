...
description: "Microsoft reserves the RILMSGCDMAMSGPRIORITY enumeration for internal use only. Don't use the RILMSGCDMAMSGPRIORITY enumeration in your code."
