...
ms.date: 1/18/2018
ms.keywords: RILCALLERIDSETTINGS, ntddrilapitypes/RILCALLERIDSETTINGS, netvista.rilcalleridsettings, RILCALLERIDSETTINGS structure [Network Drivers Starting with Windows Vista], *LPRILCALLERIDSETTINGS
