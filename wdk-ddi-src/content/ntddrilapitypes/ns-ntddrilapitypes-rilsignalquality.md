...
ms.date: 1/18/2018
ms.keywords: netvista.rilsignalquality, RILSIGNALQUALITY, *LPRILSIGNALQUALITY, RILSIGNALQUALITY structure [Network Drivers Starting with Windows Vista], ntddrilapitypes/RILSIGNALQUALITY
