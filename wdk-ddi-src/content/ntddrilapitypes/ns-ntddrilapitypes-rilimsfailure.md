...
title: RILIMSFAILURE (ntddrilapitypes.h)
description: "Microsoft reserves the RILIMSFAILURE structure for internal use only. Don't use the RILIMSFAILURE structure in your code."
