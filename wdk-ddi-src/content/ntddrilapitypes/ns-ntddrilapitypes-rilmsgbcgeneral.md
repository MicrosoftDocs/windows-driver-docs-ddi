...
description: "Microsoft reserves the RILMSGBCGENERAL structure for internal use only. Don't use the RILMSGBCGENERAL structure in your code."
...
f1_keywords:
 ...
 - LPRILMSGBCGENERAL
 - ntddrilapitypes/LPRILMSGBCGENERAL
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# RILMSGBCGENERAL structure (ntddrilapitypes.h)
