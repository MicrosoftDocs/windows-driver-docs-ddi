...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_CAPSTYPE_PBSTORELOCATIONS, ntddrilapitypes/RIL_CAPSTYPE_ARG_SMALLEST, RIL_CAPSTYPE_MAX, ntddrilapitypes/RIL_CAPSTYPE_SMSSUPPORT, RILCAPSTYPE enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_CAPSTYPE_PBMAXREAD, netvista.rilcapstype, RIL_CAPSTYPE_PBSTORELOCATIONS, RILCAPSTYPE, ntddrilapitypes/RIL_CAPSTYPE_ARG_LARGEST, RIL_CAPSTYPE_SMSSUPPORT, ntddrilapitypes/RIL_CAPSTYPE_NITZNOTIFICATION, RIL_CAPSTYPE_NITZNOTIFICATION, RIL_CAPSTYPE_ARG_LARGEST, RIL_CAPSTYPE_RADIOCONFIGURATIONS, ntddrilapitypes/RIL_CAPSTYPE_RADIOCONFIGURATIONS, ntddrilapitypes/RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, RIL_CAPSTYPE_ARG_SMALLEST, RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, RIL_CAPSTYPE_CALLSUPPORT, ntddrilapitypes/RILCAPSTYPE, ntddrilapitypes/RIL_CAPSTYPE_MAX, ntddrilapitypes/RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, ntddrilapitypes/RIL_CAPSTYPE_CALLSUPPORT, RIL_CAPSTYPE_PBMAXREAD
