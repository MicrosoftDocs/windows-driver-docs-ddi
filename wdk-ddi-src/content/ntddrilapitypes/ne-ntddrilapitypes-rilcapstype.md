...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RIL_CAPSTYPE_MAX, ntddrilapitypes/RIL_CAPSTYPE_SMSSUPPORT, RIL_CAPSTYPE_ARG_LARGEST, ntddrilapitypes/RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, ntddrilapitypes/RIL_CAPSTYPE_ARG_SMALLEST, RIL_CAPSTYPE_SMSSUPPORT, ntddrilapitypes/RIL_CAPSTYPE_CALLSUPPORT, RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, RILCAPSTYPE enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_CAPSTYPE_PBSTORELOCATIONS, ntddrilapitypes/RIL_CAPSTYPE_PBMAXREAD, RILCAPSTYPE, RIL_CAPSTYPE_RADIOCONFIGURATIONS, ntddrilapitypes/RIL_CAPSTYPE_RADIOCONFIGURATIONS, RIL_CAPSTYPE_NITZNOTIFICATION, ntddrilapitypes/RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, RIL_CAPSTYPE_PBSTORELOCATIONS, RIL_CAPSTYPE_CALLSUPPORT, netvista.rilcapstype, RIL_CAPSTYPE_PBMAXREAD, RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, ntddrilapitypes/RIL_CAPSTYPE_NITZNOTIFICATION, ntddrilapitypes/RIL_CAPSTYPE_ARG_LARGEST, ntddrilapitypes/RILCAPSTYPE, RIL_CAPSTYPE_MAX, RIL_CAPSTYPE_ARG_SMALLEST
