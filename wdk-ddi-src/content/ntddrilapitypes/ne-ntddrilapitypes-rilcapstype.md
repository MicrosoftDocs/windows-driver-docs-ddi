...
ms.date: 1/18/2018
ms.keywords: RIL_CAPSTYPE_ARG_LARGEST, RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, RILCAPSTYPE, RIL_CAPSTYPE_RADIOCONFIGURATIONS, RIL_CAPSTYPE_PBMAXREAD, RIL_CAPSTYPE_ARG_SMALLEST, RIL_CAPSTYPE_CALLSUPPORT, RIL_CAPSTYPE_PBSTORELOCATIONS, ntddrilapitypes/RIL_CAPSTYPE_CALLSUPPORT, netvista.rilcapstype, ntddrilapitypes/RIL_CAPSTYPE_ARG_LARGEST, RIL_CAPSTYPE_MAX, ntddrilapitypes/RIL_CAPSTYPE_RADIOCONFIGURATIONS, ntddrilapitypes/RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, ntddrilapitypes/RIL_CAPSTYPE_SMSSUPPORT, RIL_CAPSTYPE_NITZNOTIFICATION, RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, RILCAPSTYPE enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_CAPSTYPE_MAX, ntddrilapitypes/RIL_CAPSTYPE_PBMAXREAD, ntddrilapitypes/RIL_CAPSTYPE_PBSTORELOCATIONS, ntddrilapitypes/RIL_CAPSTYPE_NITZNOTIFICATION, RIL_CAPSTYPE_SMSSUPPORT, ntddrilapitypes/RIL_CAPSTYPE_ARG_SMALLEST, ntddrilapitypes/RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, ntddrilapitypes/RILCAPSTYPE
