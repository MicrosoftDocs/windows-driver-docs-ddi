...
ms.date: 1/18/2018
ms.keywords: RILCAPSTYPE enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_CAPSTYPE_ARG_SMALLEST, ntddrilapitypes/RILCAPSTYPE, RILCAPSTYPE, RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, RIL_CAPSTYPE_SMSSUPPORT, ntddrilapitypes/RIL_CAPSTYPE_PERSOLOCKPWDLENGTH, RIL_CAPSTYPE_CALLSUPPORT, RIL_CAPSTYPE_RADIOCONFIGURATIONS, ntddrilapitypes/RIL_CAPSTYPE_MAX, RIL_CAPSTYPE_ARG_SMALLEST, RIL_CAPSTYPE_ARG_LARGEST, RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, netvista.rilcapstype, ntddrilapitypes/RIL_CAPSTYPE_SIGNALQUALITYIMPLEMENTATION, RIL_CAPSTYPE_NITZNOTIFICATION, ntddrilapitypes/RIL_CAPSTYPE_PBMAXREAD, ntddrilapitypes/RIL_CAPSTYPE_PBSTORELOCATIONS, ntddrilapitypes/RIL_CAPSTYPE_ARG_LARGEST, ntddrilapitypes/RIL_CAPSTYPE_RADIOCONFIGURATIONS, RIL_CAPSTYPE_PBMAXREAD, ntddrilapitypes/RIL_CAPSTYPE_SMSSUPPORT, ntddrilapitypes/RIL_CAPSTYPE_NITZNOTIFICATION, RIL_CAPSTYPE_MAX, RIL_CAPSTYPE_PBSTORELOCATIONS, ntddrilapitypes/RIL_CAPSTYPE_CALLSUPPORT
