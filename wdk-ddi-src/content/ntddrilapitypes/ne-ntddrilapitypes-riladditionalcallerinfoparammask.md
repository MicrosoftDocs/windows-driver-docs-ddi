...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RILADDITIONALCALLERINFOPARAMMASK, RILADDITIONALCALLERINFOPARAMMASK enumeration [Network Drivers Starting with Windows Vista], ntddrilapitypes/RIL_PARAM_ADDTLCI_CALLERINFO, ntddrilapitypes/RIL_PARAM_ADDTLCI_ALL, RIL_PARAM_ADDTLCI_CALLERINFOLENGTH, RIL_PARAM_ADDTLCI_CALLERINFO, RILADDITIONALCALLERINFOPARAMMASK, RIL_PARAM_ADDTLCI_ALL, RIL_PARAM_ADDTLCI_CALLID, ntddrilapitypes/RIL_PARAM_ADDTLCI_CALLERINFOLENGTH, netvista.riladditionalcallerinfoparammask, ntddrilapitypes/RIL_PARAM_ADDTLCI_CALLID
