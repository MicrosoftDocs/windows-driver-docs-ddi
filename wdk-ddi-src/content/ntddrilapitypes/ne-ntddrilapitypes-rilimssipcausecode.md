...
description: "Microsoft reserves the RILIMSSIPCAUSECODE enumeration for internal use only. Don't use the RILIMSSIPCAUSECODE enumeration in your code."
...
f1_keywords:
 - RILIMSSIPCAUSECODE
 - ntddrilapitypes/RILIMSSIPCAUSECODE
topic_type:
 - APIRef
 - kbSyntax
api_type:
