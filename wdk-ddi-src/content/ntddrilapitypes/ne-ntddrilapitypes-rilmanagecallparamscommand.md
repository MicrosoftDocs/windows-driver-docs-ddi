...
title: RILMANAGECALLPARAMSCOMMAND (ntddrilapitypes.h)
description: "Microsoft reserves this enumeration for internal use only. Don't use the RILMANAGECALLPARAMSCOMMAND enumeration in your code."
old-location: netvista\rilmanagecallparamscommand.htm
tech.root: netvista
ms.date: 05/02/2018
keywords: ["RILMANAGECALLPARAMSCOMMAND enumeration"]
...
f1_keywords:
 ...
 - ntddrilapitypes/RILMANAGECALLPARAMSCOMMAND
topic_type:
 - APIRef
 - kbSyntax
api_type:
