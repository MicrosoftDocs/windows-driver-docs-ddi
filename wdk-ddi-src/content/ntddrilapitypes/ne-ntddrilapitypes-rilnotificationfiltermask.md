...
title: RILNOTIFICATIONFILTERMASK (ntddrilapitypes.h)
description: "Microsoft reserves this enumeration for internal use only. Don't use the RILNOTIFICATIONFILTERMASK enumeration in your code."
