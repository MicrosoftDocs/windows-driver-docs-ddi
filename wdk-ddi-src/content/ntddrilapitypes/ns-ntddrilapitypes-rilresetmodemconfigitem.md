...
ms.date: 1/18/2018
ms.keywords: RILRESETMODEMCONFIGITEM structure [Network Drivers Starting with Windows Vista], RILRESETMODEMCONFIGITEM, *LPRILRESETMODEMCONFIGITEM, netvista.rilresetmodemconfigitem, ntddrilapitypes/RILRESETMODEMCONFIGITEM
