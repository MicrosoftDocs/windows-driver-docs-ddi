...
description: "Microsoft reserves this enumeration for internal use only. Don't use the RILCALLMODIFICATIONINFOMODIFICATIONTYPE enumeration in your code."
...
# RILCALLMODIFICATIONINFOMODIFICATIONTYPE enumeration (ntddrilapitypes.h)
