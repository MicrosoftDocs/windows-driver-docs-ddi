...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RILLOCATIONINFO, RILLOCATIONINFO structure [Network Drivers Starting with Windows Vista], *LPRILLOCATIONINFO, netvista.rillocationinfo, RILLOCATIONINFO
