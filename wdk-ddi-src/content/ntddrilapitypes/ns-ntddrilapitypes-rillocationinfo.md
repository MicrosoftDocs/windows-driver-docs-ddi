...
ms.date: 2/16/2018
ms.keywords: ntddrilapitypes/RILLOCATIONINFO, *LPRILLOCATIONINFO, RILLOCATIONINFO structure [Network Drivers Starting with Windows Vista], netvista.rillocationinfo, RILLOCATIONINFO
