...
ms.date: 1/18/2018
ms.keywords: RILLOCATIONINFO structure [Network Drivers Starting with Windows Vista], *LPRILLOCATIONINFO, ntddrilapitypes/RILLOCATIONINFO, RILLOCATIONINFO, netvista.rillocationinfo
