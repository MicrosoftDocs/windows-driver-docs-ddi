...
ms.date: 1/18/2018
ms.keywords: RILLOCATIONINFO, ntddrilapitypes/RILLOCATIONINFO, netvista.rillocationinfo, RILLOCATIONINFO structure [Network Drivers Starting with Windows Vista], *LPRILLOCATIONINFO
