...
title: RILMSGCDMAMSGSTATUSTYPE (ntddrilapitypes.h)
description: "Microsoft reserves the RILMSGCDMAMSGSTATUSTYPE enumeration for internal use only. Don't use this enumeration in your code."
