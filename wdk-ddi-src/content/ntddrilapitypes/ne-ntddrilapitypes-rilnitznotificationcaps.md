...
title: RILNITZNOTIFICATIONCAPS (ntddrilapitypes.h)
description: "Microsoft reserves this enumeration for internal use only. Don't use the RILNITZNOTIFICATIONCAPS enumeration in your code."
...
f1_keywords:
 ...
 - ntddrilapitypes/RILNITZNOTIFICATIONCAPS
topic_type:
 - APIRef
 - kbSyntax
api_type:
