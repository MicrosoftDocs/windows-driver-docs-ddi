...
ms.date: 2/16/2018
ms.keywords: RIL_FWDREASON_ALLCONDITIONAL, RIL_FWDREASON_MAX, ntddrilapitypes/RIL_FWDREASON_MAX, RILCALLFORWARDINGSETTINGSREASON, ntddrilapitypes/RIL_FWDREASON_MOBILEBUSY, RIL_FWDREASON_UNREACHABLE, ntddrilapitypes/RIL_FWDREASON_NOREPLY, ntddrilapitypes/RIL_FWDREASON_ALLFORWARDING, ntddrilapitypes/RIL_FWDREASON_ALLCONDITIONAL, ntddrilapitypes/RILCALLFORWARDINGSETTINGSREASON, ntddrilapitypes/RIL_FWDREASON_UNREACHABLE, RIL_FWDREASON_MOBILEBUSY, netvista.rilcallforwardingsettingsreason, RIL_FWDREASON_ALLFORWARDING, RILCALLFORWARDINGSETTINGSREASON enumeration [Network Drivers Starting with Windows Vista], RIL_FWDREASON_NOREPLY
