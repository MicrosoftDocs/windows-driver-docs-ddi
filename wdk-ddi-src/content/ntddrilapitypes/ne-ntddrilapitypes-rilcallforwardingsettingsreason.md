...
ms.date: 1/18/2018
ms.keywords: ntddrilapitypes/RIL_FWDREASON_NOREPLY, ntddrilapitypes/RIL_FWDREASON_UNREACHABLE, ntddrilapitypes/RIL_FWDREASON_ALLCONDITIONAL, RIL_FWDREASON_ALLFORWARDING, ntddrilapitypes/RIL_FWDREASON_ALLFORWARDING, netvista.rilcallforwardingsettingsreason, ntddrilapitypes/RILCALLFORWARDINGSETTINGSREASON, RIL_FWDREASON_ALLCONDITIONAL, RILCALLFORWARDINGSETTINGSREASON, ntddrilapitypes/RIL_FWDREASON_MAX, ntddrilapitypes/RIL_FWDREASON_MOBILEBUSY, RIL_FWDREASON_NOREPLY, RILCALLFORWARDINGSETTINGSREASON enumeration [Network Drivers Starting with Windows Vista], RIL_FWDREASON_UNREACHABLE, RIL_FWDREASON_MOBILEBUSY, RIL_FWDREASON_MAX
