...
<i>DxgkDdiQueryInterface</i> should fill in the members of the <a href="/windows-hardware/drivers/ddi/wdm/ns-wdm-_interface">INTERFACE</a> structure that <i>QueryInterface</i>-><b>Interface</b> points to as follows:
