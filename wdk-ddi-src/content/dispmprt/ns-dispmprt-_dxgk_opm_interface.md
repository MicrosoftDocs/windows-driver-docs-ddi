...
ms.date: 2/20/2018
ms.keywords: PDXGK_OPM_INTERFACE, display.dxgk_opm_interface, dispmprt/DXGK_OPM_INTERFACE, DmStructs_e1644da8-220d-470a-b9b9-f23ba7e1c4f6.xml, DXGK_OPM_INTERFACE structure [Display Devices], DXGK_OPM_INTERFACE, *PDXGK_OPM_INTERFACE, _DXGK_OPM_INTERFACE, PDXGK_OPM_INTERFACE structure pointer [Display Devices], dispmprt/PDXGK_OPM_INTERFACE
