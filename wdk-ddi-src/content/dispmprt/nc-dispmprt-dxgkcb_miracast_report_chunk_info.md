...
f1_keywords:
 ...
 - dispmprt/DXGKCB_MIRACAST_REPORT_CHUNK_INFO
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
[in]
A pointer to a <a href="/windows-hardware/drivers/ddi/d3dukmdt/ns-d3dukmdt-dxgk_miracast_chunk_info">DXGK_MIRACAST_CHUNK_INFO</a> structure that contains chunk information that is to be reported by the display miniport driver.
...
The display miniport driver  calls this function when it wants to report chunk info to the operating system but won't create a chunk packet that will be queued in kernel mode and retrieved by the user-mode <a href="/windows-hardware/drivers/ddi/netdispumdddi/nc-netdispumdddi-pfn_get_next_chunk_data">GetNextChunkData</a> function.  This call only logs Event Tracing for Windows (ETW) events and takes no other action.

## -see-also

<a href="/windows-hardware/drivers/ddi/d3dukmdt/ns-d3dukmdt-dxgk_miracast_chunk_info">DXGK_MIRACAST_CHUNK_INFO</a>
