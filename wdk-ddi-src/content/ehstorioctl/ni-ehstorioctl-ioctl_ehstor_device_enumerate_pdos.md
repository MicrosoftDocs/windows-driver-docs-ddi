...
The returned enumeration buffer contains a result set structured according to the following rules. The leading structure in the buffer, <a href="/windows-hardware/drivers/ddi/ehstorioctl/ns-ehstorioctl-_enum_pdo_results">ENUM_PDO_RESULTS</a>, consists of a structure count and an array of <a href="/windows-hardware/drivers/ddi/ehstorioctl/ns-ehstorioctl-_enum_pdo_entry">ENUM_PDO_ENTRY</a> structures.
