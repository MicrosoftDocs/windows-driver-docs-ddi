...
f1_keywords:
 - _ENUM_PDO_RESULTS
 - ehstorioctl/_ENUM_PDO_RESULTS
 - PENUM_PDO_RESULTS
 - ehstorioctl/PENUM_PDO_RESULTS
 - ENUM_PDO_RESULTS
...
This structure describes a result set of Physical Device Objects (PDOs) that are enumerated with <a href="/windows-hardware/drivers/ddi/ehstorioctl/ni-ehstorioctl-ioctl_ehstor_device_enumerate_pdos">IOCTL_EHSTOR_DEVICE_ENUMERATE_PDOS</a>.
