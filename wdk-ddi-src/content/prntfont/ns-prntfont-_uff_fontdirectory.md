...
ms.date: 2/21/2018
ms.keywords: UFF_FONTDIRECTORY, prntfont/PUFF_FONTDIRECTORY, PUFF_FONTDIRECTORY structure pointer [Print Devices], print_unidrv-pscript_fonts_979a2793-a3e4-4939-aab1-29510951b621.xml, *PUFF_FONTDIRECTORY, _UFF_FONTDIRECTORY, prntfont/UFF_FONTDIRECTORY, PUFF_FONTDIRECTORY, UFF_FONTDIRECTORY structure [Print Devices], print.uff_fontdirectory
