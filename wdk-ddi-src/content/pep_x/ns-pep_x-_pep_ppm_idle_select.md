...
ms.date: 1/4/2018
ms.keywords: PPEP_PPM_IDLE_SELECT structure pointer [Kernel-Mode Driver Architecture], PPEP_PPM_IDLE_SELECT, *PPEP_PPM_IDLE_SELECT, _PEP_PPM_IDLE_SELECT, pep_x/PPEP_PPM_IDLE_SELECT, pep_x/PEP_PPM_IDLE_SELECT, kernel.pep_ppm_idle_select, PEP_PPM_IDLE_SELECT, PEP_PPM_IDLE_SELECT structure [Kernel-Mode Driver Architecture]
