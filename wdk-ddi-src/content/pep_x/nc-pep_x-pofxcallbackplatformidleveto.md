...
description: Learn how the PlatformIdleVeto routine increments or decrements the veto count for a veto code for a platform idle state.
...
f1_keywords:
 ...
 - pep_x/POFXCALLBACKPLATFORMIDLEVETO
topic_type:
 - APIRef
 - kbSyntax
api_type:
