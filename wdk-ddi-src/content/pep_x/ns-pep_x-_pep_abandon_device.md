...
description: Learn how the PEP_ABANDON_DEVICE structure identifies a device that has been abandoned and will no longer be used by the operating system.
...
# PEP_ABANDON_DEVICE structure (pep_x.h)
