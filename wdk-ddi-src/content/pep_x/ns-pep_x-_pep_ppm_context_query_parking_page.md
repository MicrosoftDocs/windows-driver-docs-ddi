...
description: Learn how the PEP_PPM_CONTEXT_QUERY_PARKING_PAGE structure describes the parking page for a processor.
...
# PEP_PPM_CONTEXT_QUERY_PARKING_PAGE structure (pep_x.h)
