...
description: Learn how the PEP_PPM_PERF_CONSTRAINTS structure describes the performance limits to apply to the processor.
...
# PEP_PPM_PERF_CONSTRAINTS structure (pep_x.h)
