...
description: Learn how the PEP_ACPI_SPB_SPI_RESOURCE structure describes an ACPI SPI serial bus resource.
...
f1_keywords:
 ...
 - pep_x/_PEP_ACPI_SPB_SPI_RESOURCE
 - PPEP_ACPI_SPB_SPI_RESOURCE
 - pep_x/PPEP_ACPI_SPB_SPI_RESOURCE
 - PEP_ACPI_SPB_SPI_RESOURCE
 - pep_x/PEP_ACPI_SPB_SPI_RESOURCE
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
# PEP_ACPI_SPB_SPI_RESOURCE structure (pep_x.h)
