...
ms.date: 2/16/2018
ms.keywords: pepfx/PEP_PROCESSOR_PARK_PREFERENCE, PEP_PROCESSOR_PARK_PREFERENCE structure [Kernel-Mode Driver Architecture], pepfx/PPEP_PROCESSOR_PARK_PREFERENCE, PEP_PROCESSOR_PARK_PREFERENCE, PPEP_PROCESSOR_PARK_PREFERENCE, PPEP_PROCESSOR_PARK_PREFERENCE structure pointer [Kernel-Mode Driver Architecture], *PPEP_PROCESSOR_PARK_PREFERENCE, kernel.pep_processor_park_preference, _PEP_PROCESSOR_PARK_PREFERENCE
...
product: Windows
targetos: Windows
req.typenames: PEP_PROCESSOR_PARK_PREFERENCE, *PPEP_PROCESSOR_PARK_PREFERENCE, PEP_PROCESSOR_PARK_PREFERENCE, *PPEP_PROCESSOR_PARK_PREFERENCE
---
...
The <b>Processors</b> member of the <a href="..\pep_x\ns-pep_x-_pep_ppm_park_selection.md">PEP_PPM_PARK_SELECTION</a> structure is a pointer to an array of <b>PEP_PROCESSOR_PARK_PREFERENCE</b> structures.
...
<a href="..\pep_x\ns-pep_x-_pep_ppm_park_selection.md">PEP_PPM_PARK_SELECTION</a>
