...
ms.date: 1/4/2018
ms.keywords: PPEP_WORK_IDLE_STATE structure pointer [Kernel-Mode Driver Architecture], pep_x/PPEP_WORK_IDLE_STATE, PEP_WORK_IDLE_STATE, pep_x/PEP_WORK_IDLE_STATE, PPEP_WORK_IDLE_STATE, *PPEP_WORK_IDLE_STATE, _PEP_WORK_IDLE_STATE, kernel.pep_work_idle_state, PEP_WORK_IDLE_STATE structure [Kernel-Mode Driver Architecture]
