...
title: _PEP_PPM_PARK_SELECTION (pep_x.h)
description: Learn how the PEP_PPM_PARK_SELECTION structure indicates the preferences of the operating system and platform extension plug-in (PEP) regarding which processors in the platform should be parked to reduce power consumption.
...
f1_keywords:
 ...
 - pep_x/_PEP_PPM_PARK_SELECTION
 - PPEP_PPM_PARK_SELECTION
 - pep_x/PPEP_PPM_PARK_SELECTION
...
[in/out] A pointer to an array of <a href="/windows-hardware/drivers/ddi/pepfx/ns-pepfx-_pep_processor_park_preference">PEP_PROCESSOR_PARK_PREFERENCE</a> structures. The <b>Count</b> member specifies the number of elements in the array.
