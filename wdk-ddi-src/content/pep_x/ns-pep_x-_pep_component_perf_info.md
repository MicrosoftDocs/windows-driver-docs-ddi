...
ms.date: 2/16/2018
ms.keywords: PEP_COMPONENT_PERF_INFO structure [Kernel-Mode Driver Architecture], pepfx/PEP_COMPONENT_PERF_INFO, PEP_COMPONENT_PERF_INFO, *PPEP_COMPONENT_PERF_INFO, PPEP_COMPONENT_PERF_INFO, pepfx/PPEP_COMPONENT_PERF_INFO, PPEP_COMPONENT_PERF_INFO structure pointer [Kernel-Mode Driver Architecture], kernel.pep_component_perf_info, _PEP_COMPONENT_PERF_INFO
