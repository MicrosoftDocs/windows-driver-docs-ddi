...
description: Learn how the PEP_WORK_COMPLETE_PERF_STATE structure describes the completion status of a previously requested update to the performance values assigned to a list of performance state (P-state) sets.
...
f1_keywords:
 ...
 - pep_x/_PEP_WORK_COMPLETE_PERF_STATE
 - PPEP_WORK_COMPLETE_PERF_STATE
 - pep_x/PPEP_WORK_COMPLETE_PERF_STATE
...
# PEP_WORK_COMPLETE_PERF_STATE structure (pep_x.h)
