...
ms.date: 1/4/2018
ms.keywords: PEP_KERNEL_INFORMATION_STRUCT_V1, _PEP_KERNEL_INFORMATION_STRUCT_V1, pep_x/PEP_KERNEL_INFORMATION, *PPEP_KERNEL_INFORMATION_STRUCT_V1, *PPEP_KERNEL_INFORMATION, pep_x/PPEP_KERNEL_INFORMATION_STRUCT_V1, *PPEP_KERNEL_INFORMATION_STRUCT_V2, PEP_KERNEL_INFORMATION, PEP_KERNEL_INFORMATION_STRUCT_V1 structure [Kernel-Mode Driver Architecture], _PEP_KERNEL_INFORMATION_STRUCT_V2, PEP_KERNEL_INFORMATION_STRUCT_V2, pep_x/PEP_KERNEL_INFORMATION_STRUCT_V1, PPEP_KERNEL_INFORMATION_STRUCT_V1, PPEP_KERNEL_INFORMATION_STRUCT_V1 structure pointer [Kernel-Mode Driver Architecture], kernel.pep_kernel_information, PEP_KERNEL_INFORMATION structure pointer [Kernel-Mode Driver Architecture]
