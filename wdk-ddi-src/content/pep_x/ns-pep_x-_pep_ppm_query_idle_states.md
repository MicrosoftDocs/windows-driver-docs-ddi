...
ms.date: 1/4/2018
ms.keywords: pep_x/PEP_PPM_QUERY_IDLE_STATES, kernel.pep_ppm_query_idle_states, PPEP_PPM_QUERY_IDLE_STATES structure pointer [Kernel-Mode Driver Architecture], PPEP_PPM_QUERY_IDLE_STATES, PEP_PPM_QUERY_IDLE_STATES, *PPEP_PPM_QUERY_IDLE_STATES, PEP_PPM_QUERY_IDLE_STATES structure [Kernel-Mode Driver Architecture], pep_x/PPEP_PPM_QUERY_IDLE_STATES, _PEP_PPM_QUERY_IDLE_STATES
