...
description: Learn how the PEP_REGISTER_DEVICE_V2 structure describes a device whose driver stack has just registered with the Windows power management framework (PoFx).
...
f1_keywords:
 ...
 - pep_x/_PEP_REGISTER_DEVICE_V2
 - PPEP_REGISTER_DEVICE_V2
 - pep_x/PPEP_REGISTER_DEVICE_V2
