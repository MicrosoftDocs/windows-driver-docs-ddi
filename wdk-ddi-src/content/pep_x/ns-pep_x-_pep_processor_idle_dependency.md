...
ms.date: 2/16/2018
ms.keywords: PEP_PROCESSOR_IDLE_DEPENDENCY structure [Kernel-Mode Driver Architecture], pepfx/PPEP_PROCESSOR_IDLE_DEPENDENCY, pepfx/PEP_PROCESSOR_IDLE_DEPENDENCY, PPEP_PROCESSOR_IDLE_DEPENDENCY, PEP_PROCESSOR_IDLE_DEPENDENCY, PPEP_PROCESSOR_IDLE_DEPENDENCY structure pointer [Kernel-Mode Driver Architecture], *PPEP_PROCESSOR_IDLE_DEPENDENCY, kernel.pep_processor_idle_dependency, _PEP_PROCESSOR_IDLE_DEPENDENCY
