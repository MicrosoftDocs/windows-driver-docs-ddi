...
description: Learn how the PEP_POWER_CONTROL_COMPLETE structure contains status information for a power control operation that the PEP previously requested and that the device driver has completed.
old-location: kernel\pep_power_control_complete.htm
tech.root: kernel
ms.date: 04/30/2018
keywords: ["PEP_POWER_CONTROL_COMPLETE structure"]
...
f1_keywords:
 ...
 - pep_x/_PEP_POWER_CONTROL_COMPLETE
 - PPEP_POWER_CONTROL_COMPLETE
 - pep_x/PPEP_POWER_CONTROL_COMPLETE
...
This structure is used by the <a href="/windows-hardware/drivers/ddi/pepfx/ns-pepfx-_pep_power_control_complete">PEP_DPM_POWER_CONTROL_COMPLETE</a> notification. All five members of the structure contain input values that are supplied by
