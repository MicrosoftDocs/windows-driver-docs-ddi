...
description: Learn how the PEP_PPM_QUERY_STATE_NAME structure contains information about a specific coordinated or platform idle state.
...
f1_keywords:
 ...
 - pep_x/_PEP_PPM_QUERY_STATE_NAME
 - PPEP_PPM_QUERY_STATE_NAME
 - pep_x/PPEP_PPM_QUERY_STATE_NAME
 - PEP_PPM_QUERY_STATE_NAME
 - pep_x/PEP_PPM_QUERY_STATE_NAME
topic_type:
 - APIRef
 - kbSyntax
api_type:
