...
ms.date: 2/16/2018
ms.keywords: PPEP_PPM_QUERY_STATE_NAME structure pointer [Kernel-Mode Driver Architecture], PEP_PPM_QUERY_STATE_NAME, PPEP_PPM_QUERY_STATE_NAME, PEP_PPM_QUERY_STATE_NAME structure [Kernel-Mode Driver Architecture], pepfx/PPEP_PPM_QUERY_STATE_NAME, *PPEP_PPM_QUERY_STATE_NAME, _PEP_PPM_QUERY_STATE_NAME, pepfx/PEP_PPM_QUERY_STATE_NAME, kernel.pep_ppm_query_state_name
