...
Most framework-based drivers do not report bus relations in an <i>EvtDeviceRelationsQuery</i> callback function. Instead, the drivers follow the guidelines that are described in <a href="https://docs.microsoft.com/en-us/windows-hardware/drivers/wdf/enumerating-the-devices-on-a-bus">Enumerating the Devices on a Bus</a>.
