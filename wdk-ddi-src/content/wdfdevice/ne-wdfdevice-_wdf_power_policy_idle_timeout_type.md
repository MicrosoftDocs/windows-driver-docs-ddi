...
ms.date: 2/20/2018
ms.keywords: wdf.wdf_power_policy_idle_timeout_type, PWDF_POWER_POLICY_IDLE_TIMEOUT_TYPE, kmdf.wdf_power_policy_idle_timeout_type, wdfdevice/WDF_POWER_POLICY_IDLE_TIMEOUT_TYPE, *PWDF_POWER_POLICY_IDLE_TIMEOUT_TYPE, wdfdevice/SystemManagedIdleTimeout, WDF_POWER_POLICY_IDLE_TIMEOUT_TYPE enumeration, wdfdevice/PWDF_POWER_POLICY_IDLE_TIMEOUT_TYPE, DriverManagedIdleTimeout, wdfdevice/SystemManagedIdleTimeoutWithHint, SystemManagedIdleTimeoutWithHint, _WDF_POWER_POLICY_IDLE_TIMEOUT_TYPE, wdfdevice/DriverManagedIdleTimeout, PWDF_POWER_POLICY_IDLE_TIMEOUT_TYPE enumeration pointer, WDF_POWER_POLICY_IDLE_TIMEOUT_TYPE, SystemManagedIdleTimeout
