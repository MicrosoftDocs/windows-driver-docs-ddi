...
f1_keywords:
 ...
 - wdfdevice/EVT_WDF_DEVICE_D0_EXIT
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
To register an <i>EvtDeviceD0Exit</i> callback function, a driver must call <a href="/windows-hardware/drivers/ddi/wdfdevice/nf-wdfdevice-wdfdeviceinitsetpnppowereventcallbacks">WdfDeviceInitSetPnpPowerEventCallbacks</a>. 
