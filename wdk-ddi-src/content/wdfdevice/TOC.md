...
### [EVT_WDFDEVICE_WDM_IRP_DISPATCH callback function](../wdfdevice/nc-wdfdevice-evt_wdfdevice_wdm_irp_dispatch.md)
### [EVT_WDFDEVICE_WDM_IRP_PREPROCESS callback function](../wdfdevice/nc-wdfdevice-evt_wdfdevice_wdm_irp_preprocess.md)
### [EVT_WDFDEVICE_WDM_POST_PO_FX_REGISTER_DEVICE callback function](../wdfdevice/nc-wdfdevice-evt_wdfdevice_wdm_post_po_fx_register_device.md)
### [EVT_WDFDEVICE_WDM_PRE_PO_FX_UNREGISTER_DEVICE callback function](../wdfdevice/nc-wdfdevice-evt_wdfdevice_wdm_pre_po_fx_unregister_device.md)
### [EVT_WDF_DEVICE_ARM_WAKE_FROM_S0 callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_arm_wake_from_s0.md)
### [EVT_WDF_DEVICE_ARM_WAKE_FROM_SX callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_arm_wake_from_sx.md)
### [EVT_WDF_DEVICE_ARM_WAKE_FROM_SX_WITH_REASON callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_arm_wake_from_sx_with_reason.md)
### [EVT_WDF_DEVICE_D0_ENTRY callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_d0_entry.md)
### [EVT_WDF_DEVICE_D0_ENTRY_POST_INTERRUPTS_ENABLED callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_d0_entry_post_interrupts_enabled.md)
### [EVT_WDF_DEVICE_D0_EXIT callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_d0_exit.md)
### [EVT_WDF_DEVICE_D0_EXIT_PRE_INTERRUPTS_DISABLED callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_d0_exit_pre_interrupts_disabled.md)
### [EVT_WDF_DEVICE_DISARM_WAKE_FROM_S0 callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_disarm_wake_from_s0.md)
### [EVT_WDF_DEVICE_DISARM_WAKE_FROM_SX callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_disarm_wake_from_sx.md)
### [EVT_WDF_DEVICE_FILE_CREATE callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_file_create.md)
### [EVT_WDF_DEVICE_PNP_STATE_CHANGE_NOTIFICATION callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_pnp_state_change_notification.md)
### [EVT_WDF_DEVICE_POWER_POLICY_STATE_CHANGE_NOTIFICATION callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_power_policy_state_change_notification.md)
### [EVT_WDF_DEVICE_POWER_STATE_CHANGE_NOTIFICATION callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_power_state_change_notification.md)
### [EVT_WDF_DEVICE_PREPARE_HARDWARE callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_prepare_hardware.md)
### [EVT_WDF_DEVICE_QUERY_REMOVE callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_query_remove.md)
### [EVT_WDF_DEVICE_QUERY_STOP callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_query_stop.md)
### [EVT_WDF_DEVICE_RELATIONS_QUERY callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_relations_query.md)
### [EVT_WDF_DEVICE_RELEASE_HARDWARE callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_release_hardware.md)
### [EVT_WDF_DEVICE_SELF_MANAGED_IO_CLEANUP callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_self_managed_io_cleanup.md)
### [EVT_WDF_DEVICE_SELF_MANAGED_IO_FLUSH callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_self_managed_io_flush.md)
### [EVT_WDF_DEVICE_SELF_MANAGED_IO_INIT callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_self_managed_io_init.md)
### [EVT_WDF_DEVICE_SELF_MANAGED_IO_RESTART callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_self_managed_io_restart.md)
### [EVT_WDF_DEVICE_SELF_MANAGED_IO_SUSPEND callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_self_managed_io_suspend.md)
### [EVT_WDF_DEVICE_SURPRISE_REMOVAL callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_surprise_removal.md)
### [EVT_WDF_DEVICE_USAGE_NOTIFICATION callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_usage_notification.md)
### [EVT_WDF_DEVICE_USAGE_NOTIFICATION_EX callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_usage_notification_ex.md)
### [EVT_WDF_DEVICE_WAKE_FROM_S0_TRIGGERED callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_wake_from_s0_triggered.md)
### [EVT_WDF_DEVICE_WAKE_FROM_SX_TRIGGERED callback function](../wdfdevice/nc-wdfdevice-evt_wdf_device_wake_from_sx_triggered.md)
### [EVT_WDF_FILE_CLEANUP callback function](../wdfdevice/nc-wdfdevice-evt_wdf_file_cleanup.md)
### [EVT_WDF_FILE_CLOSE callback function](../wdfdevice/nc-wdfdevice-evt_wdf_file_close.md)
### [EVT_WDF_IO_IN_CALLER_CONTEXT callback function](../wdfdevice/nc-wdfdevice-evt_wdf_io_in_caller_context.md)
