...
ms.date: 2/16/2018
ms.keywords: storage.mpio_registered_dsm, PMPIO_REGISTERED_DSM, mpiowmi/MPIO_REGISTERED_DSM, PMPIO_REGISTERED_DSM structure pointer [Storage Devices], structs-scsibus_70ceccae-5a45-4ce1-a6de-fa86c3d82d7d.xml, _MPIO_REGISTERED_DSM, mpiowmi/PMPIO_REGISTERED_DSM, MPIO_REGISTERED_DSM, MPIO_REGISTERED_DSM structure [Storage Devices], *PMPIO_REGISTERED_DSM
