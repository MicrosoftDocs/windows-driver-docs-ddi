...
ms.date: 1/10/2018
ms.keywords: PSetDSMCounters_IN structure pointer [Storage Devices], mpiowmi/SetDSMCounters_IN, *PSetDSMCounters_IN, SetDSMCounters_IN, structs-scsibus_683362cd-cba9-41b8-9e46-9cf6a22fbbf5.xml, storage.setdsmcounters_in, PSetDSMCounters_IN, SetDSMCounters_IN structure [Storage Devices], mpiowmi/PSetDSMCounters_IN, _SetDSMCounters_IN
