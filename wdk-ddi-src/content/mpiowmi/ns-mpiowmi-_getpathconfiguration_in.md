...
ms.date: 1/10/2018
ms.keywords: mpiowmi/GetPathConfiguration_IN, PGetPathConfiguration_IN, structs-scsibus_28444162-ae96-47fb-8857-562d52191bfe.xml, *PGetPathConfiguration_IN, _GetPathConfiguration_IN, GetPathConfiguration_IN, PGetPathConfiguration_IN structure pointer [Storage Devices], mpiowmi/PGetPathConfiguration_IN, GetPathConfiguration_IN structure [Storage Devices], storage.getpathconfiguration_in
