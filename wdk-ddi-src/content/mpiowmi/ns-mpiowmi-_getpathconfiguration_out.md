...
ms.date: 2/16/2018
ms.keywords: "*PGetPathConfiguration_OUT, structs-scsibus_4d2ebbae-67ff-42bc-8904-c33f914485cd.xml, GetPathConfiguration_OUT, storage.getpathconfiguration_out, PGetPathConfiguration_OUT, _GetPathConfiguration_OUT, mpiowmi/GetPathConfiguration_OUT, mpiowmi/PGetPathConfiguration_OUT, PGetPathConfiguration_OUT structure pointer [Storage Devices], GetPathConfiguration_OUT structure [Storage Devices]"
