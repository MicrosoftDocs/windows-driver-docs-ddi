...
ms.date: 2/16/2018
ms.keywords: PMPIO_DISK_HEALTH_CLASS, PMPIO_DISK_HEALTH_CLASS structure pointer [Storage Devices], structs-scsibus_b3dfb95d-08eb-4eb6-80bb-3437282a65d6.xml, MPIO_DISK_HEALTH_CLASS structure [Storage Devices], _MPIO_DISK_HEALTH_CLASS, MPIO_DISK_HEALTH_CLASS, mpiowmi/MPIO_DISK_HEALTH_CLASS, storage.mpio_disk_health_class, *PMPIO_DISK_HEALTH_CLASS, mpiowmi/PMPIO_DISK_HEALTH_CLASS
