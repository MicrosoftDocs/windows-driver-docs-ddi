...
ms.date: 1/10/2018
ms.keywords: PMPIO_DISK_HEALTH_CLASS structure pointer [Storage Devices], *PMPIO_DISK_HEALTH_CLASS, _MPIO_DISK_HEALTH_CLASS, storage.mpio_disk_health_class, MPIO_DISK_HEALTH_CLASS, mpiowmi/MPIO_DISK_HEALTH_CLASS, PMPIO_DISK_HEALTH_CLASS, MPIO_DISK_HEALTH_CLASS structure [Storage Devices], structs-scsibus_b3dfb95d-08eb-4eb6-80bb-3437282a65d6.xml, mpiowmi/PMPIO_DISK_HEALTH_CLASS
