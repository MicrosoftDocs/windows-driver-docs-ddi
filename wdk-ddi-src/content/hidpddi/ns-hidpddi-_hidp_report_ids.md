...
The index of the collection in the array of  <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/hidpddi/ns-hidpddi-_hidp_collection_desc">HIDP_COLLECTION_DESC</a> structure.
