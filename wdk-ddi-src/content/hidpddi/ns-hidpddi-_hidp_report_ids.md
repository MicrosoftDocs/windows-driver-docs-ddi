...
ms.date: 2/24/2018
ms.keywords: ",  , *, *PHIDP_REPORT_IDS, ,, D, E, H, HIDP_REPORT_IDS, HIDP_REPORT_IDS structure [Human Input Devices], I, O, P, PHIDP_REPORT_IDS, PHIDP_REPORT_IDS structure pointer [Human Input Devices], R, S, T, _, _HIDP_REPORT_IDS, hid.hidp_report_ids, hidpddi/HIDP_REPORT_IDS, hidpddi/PHIDP_REPORT_IDS"
