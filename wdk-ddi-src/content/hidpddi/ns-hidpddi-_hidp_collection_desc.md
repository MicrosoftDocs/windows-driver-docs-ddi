...
ms.date: 2/15/2018
ms.keywords: HIDP_COLLECTION_DESC structure [Human Input Devices], PHIDP_COLLECTION_DESC, hidpddi/PHIDP_COLLECTION_DESC, *PHIDP_COLLECTION_DESC, PHIDP_COLLECTION_DESC structure pointer [Human Input Devices], _HIDP_COLLECTION_DESC, hid.hidp_collection_desc, hidpddi/HIDP_COLLECTION_DESC, HIDP_COLLECTION_DESC
