...
ms.date: 2/24/2018
ms.keywords: ",  , *, *PHIDP_COLLECTION_DESC, ,, C, D, E, H, HIDP_COLLECTION_DESC, HIDP_COLLECTION_DESC structure [Human Input Devices], I, L, N, O, P, PHIDP_COLLECTION_DESC, PHIDP_COLLECTION_DESC structure pointer [Human Input Devices], S, T, _, _HIDP_COLLECTION_DESC, hid.hidp_collection_desc, hidpddi/HIDP_COLLECTION_DESC, hidpddi/PHIDP_COLLECTION_DESC"
