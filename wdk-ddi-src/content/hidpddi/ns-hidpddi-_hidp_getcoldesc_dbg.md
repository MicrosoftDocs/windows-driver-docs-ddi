...
ms.date: 12/21/2017
ms.keywords: HIDP_GETCOLDESC_DBG, PHIDP_GETCOLDESC_DBG structure pointer [Human Input Devices], hid.hidp_getcoldesc_dbg, _HIDP_GETCOLDESC_DBG, *PHIDP_GETCOLDESC_DBG, hidpddi/PHIDP_GETCOLDESC_DBG, PHIDP_GETCOLDESC_DBG, HIDP_GETCOLDESC_DBG structure [Human Input Devices], hidpddi/HIDP_GETCOLDESC_DBG
