...
ms.date: 2/15/2018
ms.keywords: HIDP_GETCOLDESC_DBG, *PHIDP_GETCOLDESC_DBG, _HIDP_GETCOLDESC_DBG, PHIDP_GETCOLDESC_DBG structure pointer [Human Input Devices], hidpddi/PHIDP_GETCOLDESC_DBG, HIDP_GETCOLDESC_DBG structure [Human Input Devices], PHIDP_GETCOLDESC_DBG, hidpddi/HIDP_GETCOLDESC_DBG, hid.hidp_getcoldesc_dbg
