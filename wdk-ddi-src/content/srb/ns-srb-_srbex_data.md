...
ms.date: 1/10/2018
ms.keywords: SrbExDataTypeScsiCdb32, SrbExDataTypePower, PSRBEX_DATA structure pointer [Storage Devices], PSRBEX_DATA, SrbExDataTypeWmi, _SRBEX_DATA, storage.srbex_data, SrbExDataTypeScsiCdb16, SrbExDataTypePnp, SrbExDataTypeBidirectional, SrbExDataTypeScsiCdbVar, SrbExDataTypeUnknown, SrbExDataTypeIoInfo, storport/PSRBEX_DATA, SRBEX_DATA, SRBEX_DATA structure [Storage Devices], *PSRBEX_DATA, storport/SRBEX_DATA
