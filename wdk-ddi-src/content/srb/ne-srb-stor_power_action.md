...
description: The STOR_POWER_ACTION (srb.h) contains values that indicate the power state that the system is about to enter during a power transition.
