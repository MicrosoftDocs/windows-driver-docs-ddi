...
description: The _SRBEX_DATA_BIDIRECTIONAL structure (srb.h) contains the extended SCSI Request Block (SRB) data for bi-directional transfer commands.
...
f1_keywords:
 ...
 - srb/_SRBEX_DATA_BIDIRECTIONAL
 - PSRBEX_DATA_BIDIRECTIONAL
 - srb/PSRBEX_DATA_BIDIRECTIONAL
...
# SRBEX_DATA_BIDIRECTIONAL structure (srb.h)
