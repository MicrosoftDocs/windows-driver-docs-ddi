...
description: The ScsiDebugPrint function (srb.h) prints debug information with a specified level of verbosity based on global values.
...
**ScsiDebugPrint** calls [**DbgPrintEx**](../wdm/nf-wdm-dbgprintex.md), passing the **DebugMessage** pointer and a debug level value mapped from **DebugPrintLevel** as follows.
