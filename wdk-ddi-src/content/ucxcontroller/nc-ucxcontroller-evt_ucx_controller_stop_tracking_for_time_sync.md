...
tech.root: usbref
ms.date: 05/07/2018
keywords: ["EVT_UCX_CONTROLLER_STOP_TRACKING_FOR_TIME_SYNC callback function"]
...
The length, in bytes, of the request's output buffer, if an output buffer
        is available. This value is the size of the <a href="/windows-hardware/drivers/ddi/usbioctl/ns-usbioctl-_usb_stop_tracking_for_time_sync_information">USB_STOP_TRACKING_FOR_TIME_SYNC_INFORMATION</a> structure.
