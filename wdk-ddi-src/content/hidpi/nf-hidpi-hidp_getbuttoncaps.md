...
The <b>HidP_GetButtonCaps</b> routine returns a <a href="/windows-hardware/drivers/hid/button-capability-arrays">button capability array</a> that describes all the HID control buttons in a <a href="/windows-hardware/drivers/hid/top-level-collections">top-level collection</a> for a specified type of HID report.
...
<i>ButtonCapsLength</i> should be set to the value of the <b>Number</b><i>Xxx</i><b>ButtonCaps</b> member of the <a href="/windows-hardware/drivers/ddi/hidpi/ns-hidpi-_hidp_caps">HIDP_CAPS</a> structure returned by <a href="/windows-hardware/drivers/ddi/hidpi/nf-hidpi-hidp_getcaps">HidP_GetCaps</a>, where <i>Xxx</i> specifies the report type.

To obtain a subset of button capabilities, selected by <a href="/windows-hardware/drivers/hid/hid-usages">usage</a>, <a href="/windows-hardware/drivers/hid/hid-usages">usage page</a>, or <a href="/windows-hardware/drivers/hid/link-collections">link collection</a>, use <a href="/windows-hardware/drivers/ddi/hidpi/nf-hidpi-hidp_getspecificbuttoncaps">HidP_GetSpecificButtonCaps</a>.
