...
The <b>HidP_SetUsageValueArray</b> routine sets a HID control <a href="/windows-hardware/drivers/hid/value-capability-arrays">usage value array</a> in a specified HID report.
