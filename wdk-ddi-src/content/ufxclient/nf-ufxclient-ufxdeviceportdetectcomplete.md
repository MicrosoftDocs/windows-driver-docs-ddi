...
The client driver typically calls <b>UfxDevicePortDetectComplete</b> from its <a href="/windows-hardware/drivers/ddi/ufxclient/nc-ufxclient-evt_ufx_device_port_detect">EVT_UFX_DEVICE_PORT_DETECT</a> callback function, as shown in this example.
