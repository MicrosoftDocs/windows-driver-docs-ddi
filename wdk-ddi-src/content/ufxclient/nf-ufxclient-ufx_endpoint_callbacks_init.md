...
ms.date: 2/15/2018
ms.keywords: ",  , A, B, C, D, E, F, I, K, L, N, O, P, S, T, U, UFX_ENDPOINT_CALLBACKS_INIT, UFX_ENDPOINT_CALLBACKS_INIT function [Buses], X, _, buses.ufx_endpoint_callbacks_init, ufxclient/UFX_ENDPOINT_CALLBACKS_INIT"
