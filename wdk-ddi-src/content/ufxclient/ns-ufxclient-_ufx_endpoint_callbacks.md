...
ms.date: 1/4/2018
ms.keywords: ufxclient/UFX_ENDPOINT_CALLBACKS, UFX_ENDPOINT_CALLBACKS, PUFX_ENDPOINT_CALLBACKS structure pointer [Buses], *PUFX_ENDPOINT_CALLBACKS, _UFX_ENDPOINT_CALLBACKS, buses.ufx_endpoint_callbacks, ufxclient/PUFX_ENDPOINT_CALLBACKS, UFX_ENDPOINT_CALLBACKS structure [Buses], PUFX_ENDPOINT_CALLBACKS
