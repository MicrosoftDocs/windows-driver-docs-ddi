...
A <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/urstypes/ne-urstypes-_urs_role">URS_ROLE</a> type value that indicates the role to set for the controller device.
