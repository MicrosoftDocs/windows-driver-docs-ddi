...
This macro is the recommended way to implement error logging, because unlike [WIAS_LERROR](./nf-wiamdef-wias_lerror.md), WIA_ERROR allows error messages to be written to the log file (*Wiatrace.log*). The utility used to view the contents of this log file is WiaTrcVw.exe.
