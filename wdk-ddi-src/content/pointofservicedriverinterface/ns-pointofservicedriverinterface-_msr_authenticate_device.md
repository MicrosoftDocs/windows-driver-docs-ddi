...
ms.date: 1/18/2018
ms.keywords: MSR_AUTHENTICATE_DEVICE structure, MSR_AUTHENTICATE_DEVICE, pos.msr_authenticate_device, *PMSR_AUTHENTICATE_DEVICE, PMSR_AUTHENTICATE_DEVICE structure pointer, pointofservicedriverinterface/MSR_AUTHENTICATE_DEVICE, PMSR_AUTHENTICATE_DEVICE, _MSR_AUTHENTICATE_DEVICE, pointofservicedriverinterface/PMSR_AUTHENTICATE_DEVICE
