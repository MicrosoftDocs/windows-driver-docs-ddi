...
# WdfIoTargetFormatRequestForWrite function (wdfiotarget.h)
...
Use the <b>WdfIoTargetFormatRequestForWrite</b> method, followed by the <a href="/windows-hardware/drivers/ddi/wdfrequest/nf-wdfrequest-wdfrequestsend">WdfRequestSend</a> method, to send write requests either synchronously or asynchronously. Alternatively, use the <a href="/windows-hardware/drivers/ddi/wdfiotarget/nf-wdfiotarget-wdfiotargetsendwritesynchronously">WdfIoTargetSendWriteSynchronously</a> method to send write requests synchronously. 
...
The driver must call <a href="/windows-hardware/drivers/ddi/wdfrequest/nf-wdfrequest-wdfrequestretrieveinputmemory">WdfRequestRetrieveInputMemory</a> to obtain a handle to a framework memory object that represents the request's input buffer and must use that handle as the value for <i>InputBuffer</i>.
...
For more information about <b>WdfIoTargetFormatRequestForWrite</b>, see <a href="/windows-hardware/drivers/wdf/sending-i-o-requests-to-general-i-o-targets">Sending I/O Requests to General I/O Targets</a>.
...
The following code example creates a framework memory object for a write request's input buffer, formats the write request, registers a <a href="/windows-hardware/drivers/ddi/wdfrequest/nc-wdfrequest-evt_wdf_request_completion_routine">CompletionRoutine</a> callback function, and sends the write request to an I/O target.
...
<a href="/windows-hardware/drivers/ddi/wdfiotarget/nf-wdfiotarget-wdfiotargetsendwritesynchronously">WdfIoTargetSendWriteSynchronously</a>
