...
ms.date: 2/16/2018
ms.keywords: PQUERY_FILE_LAYOUT_INPUT, QUERY_FILE_LAYOUT_INPUT structure [Installable File System Drivers], PQUERY_FILE_LAYOUT_INPUT structure pointer [Installable File System Drivers], QUERY_FILE_LAYOUT_INPUT, QUERY_FILE_LAYOUT_FILTER_TYPE_FILEID, _QUERY_FILE_LAYOUT_INPUT, QUERY_FILE_LAYOUT_RESTART, QUERY_FILE_LAYOUT_FILTER_TYPE_NONE, ntifs/PQUERY_FILE_LAYOUT_INPUT, QUERY_FILE_LAYOUT_INCLUDE_EXTRA_INFO, QUERY_FILE_LAYOUT_INCLUDE_NAMES, QUERY_FILE_LAYOUT_INCLUDE_STREAMS, ntifs/QUERY_FILE_LAYOUT_INPUT, QUERY_FILE_LAYOUT_FILTER_TYPE_CLUSTERS, *PQUERY_FILE_LAYOUT_INPUT, QUERY_FILE_LAYOUT_INCLUDE_STREAMS_WITH_NO_CLUSTERS_ALLOCATED, QUERY_FILE_LAYOUT_INCLUDE_EXTENTS, ifsk.query_file_layout_input
