---
UID: NF:ntifs.FsRtlFastCheckLockForWrite(PFILE_LOCK,PLARGE_INTEGER,PLARGE_INTEGER,ULONG,PVOID,PVOID)
...
The <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-fsrtlfastchecklockforwrite">FsRtlFastCheckLockForWrite</a> routine returns <b>TRUE</b> if the specified process has write access, <b>FALSE</b> otherwise.
