...
Network redirectors that conform to the Windows Vista redirector model should use <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/ntifs/nf-ntifs-fsrtlregisteruncproviderex">FsRtlRegisterUncProviderEx</a>, not <b>FsRtlRegisterUncProvider</b>.
