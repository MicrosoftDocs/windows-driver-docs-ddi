...
ms.date: 1/9/2018
ms.keywords: ifsk.token_privileges, ntifs/PTOKEN_PRIVILEGES, TOKEN_PRIVILEGES, *PTOKEN_PRIVILEGES, PTOKEN_PRIVILEGES, securitystructures_3da1d9ba-6fa7-4b16-bdd7-416890b57f7e.xml, PTOKEN_PRIVILEGES structure pointer [Installable File System Drivers], TOKEN_PRIVILEGES structure [Installable File System Drivers], _TOKEN_PRIVILEGES, ntifs/TOKEN_PRIVILEGES
