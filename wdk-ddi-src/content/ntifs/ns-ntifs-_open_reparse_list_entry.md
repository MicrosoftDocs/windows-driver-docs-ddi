...
ms.date: 2/7/2018
ms.keywords: OPEN_REPARSE_POINT_REPARSE_IF_CHILD_EXISTS, ifsk.open_reparse_list_entry_, OPEN_REPARSE_LIST_ENTRY structure [Installable File System Drivers], OPEN_REPARSE_POINT_REPARSE_IF_CHILD_NOT_EXISTS, ntifs/OPEN_REPARSE_LIST_ENTRY, OPEN_REPARSE_POINT_REPARSE_IF_DIRECTORY_FINAL_COMPONENT, ntifs/POPEN_REPARSE_LIST_ENTRY, POPEN_REPARSE_LIST_ENTRY, POPEN_REPARSE_LIST_ENTRY structure pointer [Installable File System Drivers], _OPEN_REPARSE_LIST_ENTRY, OPEN_REPARSE_POINT_TAG_ENCOUNTERED, *POPEN_REPARSE_LIST_ENTRY, OPEN_REPARSE_LIST_ENTRY, OPEN_REPARSE_POINT_VERSION_EX
