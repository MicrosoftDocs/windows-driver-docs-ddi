...
ms.date: 2/16/2018
ms.keywords: OPEN_REPARSE_POINT_REPARSE_IF_DIRECTORY_FINAL_COMPONENT, POPEN_REPARSE_LIST_ENTRY structure pointer [Installable File System Drivers], *POPEN_REPARSE_LIST_ENTRY, OPEN_REPARSE_POINT_REPARSE_IF_CHILD_EXISTS, OPEN_REPARSE_POINT_VERSION_EX, ntifs/OPEN_REPARSE_LIST_ENTRY, ifsk.open_reparse_list_entry_, OPEN_REPARSE_LIST_ENTRY structure [Installable File System Drivers], OPEN_REPARSE_LIST_ENTRY, POPEN_REPARSE_LIST_ENTRY, OPEN_REPARSE_POINT_TAG_ENCOUNTERED, OPEN_REPARSE_POINT_REPARSE_IF_CHILD_NOT_EXISTS, _OPEN_REPARSE_LIST_ENTRY, ntifs/POPEN_REPARSE_LIST_ENTRY
