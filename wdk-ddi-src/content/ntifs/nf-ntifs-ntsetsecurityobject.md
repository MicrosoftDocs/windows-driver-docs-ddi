...
Callers of <b>NtSetSecurityObject</b> must be running at IRQL = PASSIVE_LEVEL and <a href="/windows-hardware/drivers/kernel/disabling-apcs">with special kernel APCs enabled</a>.

<div class="alert"><b>Note</b>  If the call to the <b>NtSetSecurityObject</b> function occurs in user mode, you should use the name "<a href="/previous-versions/ff567106(v=vs.85)">NtSetSecurityObject</a>" instead of "<b>ZwSetSecurityObject</b>".</div>
<div> </div>
...
<a href="/previous-versions/ff567066(v=vs.85)">NtQuerySecurityObject</a>