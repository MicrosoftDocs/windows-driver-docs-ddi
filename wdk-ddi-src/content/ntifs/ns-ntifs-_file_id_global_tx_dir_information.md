...
tech.root: ifsk
ms.date: 04/16/2018
keywords: ["FILE_ID_GLOBAL_TX_DIR_INFORMATION structure"]
...
f1_keywords:
 ...
 - ntifs/_FILE_ID_GLOBAL_TX_DIR_INFORMATION
 - PFILE_ID_GLOBAL_TX_DIR_INFORMATION
 - ntifs/PFILE_ID_GLOBAL_TX_DIR_INFORMATION
...
The <b>FILE_ID_GLOBAL_TX_DIR_INFORMATION</b> structure can be implemented for file systems that return the FILE_SUPPORTS_TRANSACTIONS flag in response to a query using a <a href="/windows-hardware/drivers/ddi/ntifs/ns-ntifs-_file_fs_attribute_information">FILE_FS_ATTRIBUTE_INFORMATION</a> structure. It must not be implemented for file systems that do not return that flag.
