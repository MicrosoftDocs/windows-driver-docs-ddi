...
ms.date: 1/9/2018
ms.keywords: FsRtlAddLargeMcbEntry routine [Installable File System Drivers], ntifs/FsRtlAddLargeMcbEntry, ifsk.fsrtladdlargemcbentry, FsRtlAddLargeMcbEntry, fsrtlref_de8b7789-cdba-4535-b2b9-bbc29add7fc6.xml
...
<div class="alert"><b>Note</b>    The upper 32 bits of the LBN are ignored, but they must be set to zero. Only the lower 32 bits are used. </div><div> </div>If a new mapping run to be added overlaps an existing mapping run, <b>FsRtlAddLargeMcbEntry</b> merges them into a single mapping run. 
