...
ms.date: 2/16/2018
ms.keywords: ATOMIC_CREATE_ECP_OUT_FLAG_EOF_SET, ATOMIC_CREATE_ECP_OUT_FLAG_OPERATION_MASK, ATOMIC_CREATE_ECP_CONTEXT structure [Installable File System Drivers], _ATOMIC_CREATE_ECP_CONTEXT, ATOMIC_CREATE_ECP_OUT_FLAG_SPARSE_SET, ATOMIC_CREATE_ECP_IN_FLAG_VDL_SPECIFIED, ATOMIC_CREATE_ECP_OUT_FLAG_VDL_SET, ATOMIC_CREATE_ECP_IN_FLAG_SPARSE_SPECIFIED, ntifs/PATOMIC_CREATE_ECP_CONTEXT, PATOMIC_CREATE_ECP_CONTEXT structure pointer [Installable File System Drivers], ATOMIC_CREATE_ECP_IN_FLAG_REPARSE_POINT_SPECIFIED, ATOMIC_CREATE_ECP_IN_FLAG_EOF_SPECIFIED, PATOMIC_CREATE_ECP_CONTEXT, ATOMIC_CREATE_ECP_IN_FLAG_BEST_EFFORT, *PATOMIC_CREATE_ECP_CONTEXT, ifsk.atomic_create_ecp_context, ntifs/ATOMIC_CREATE_ECP_CONTEXT, ATOMIC_CREATE_ECP_CONTEXT, ATOMIC_CREATE_ECP_IN_FLAG_OPERATION_MASK, ATOMIC_CREATE_ECP_OUT_FLAG_REPARSE_POINT_SET
