...
<div class="alert"><b>Note</b>  If the call to the <b>NtSetInformationToken</b> function occurs in user mode, you should use the name "<a href="/previous-versions/ff567102(v=vs.85)">NtSetInformationToken</a>" instead of "<b>ZwSetInformationToken</b>".</div>
<div> </div>
...
<a href="/previous-versions/ff567055(v=vs.85)">NtQueryInformationToken</a>
