...
# ZwFreeVirtualMemory function (ntifs.h)
...
* State is COMMITTED
  ...
  You can use [**ZwAllocateVirtualMemory**](nf-ntifs-zwallocatevirtualmemory.md) to put committed memory pages into either the reserved or free state.
