---
UID: NF:ntifs.FsRtlIsTotalDeviceFailure(NTSTATUS)
...
For more information about handling device failure, see <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/index">Error Handling</a>.
