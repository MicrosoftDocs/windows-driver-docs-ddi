...
description: The IoStartTimer routine in ntifs.h enables the timer associated with a given device object so the driver-supplied IoTimer routine is called once per second.
