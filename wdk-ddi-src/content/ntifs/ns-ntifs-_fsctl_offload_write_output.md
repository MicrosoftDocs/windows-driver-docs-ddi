...
ms.date: 2/16/2018
ms.keywords: OFFLOAD_READ_FLAG_FILE_TOO_SMALL, ntifs/PFSCTL_OFFLOAD_WRITE_OUTPUT, _FSCTL_OFFLOAD_WRITE_OUTPUT, PFSCTL_OFFLOAD_WRITE_OUTPUT structure pointer [Installable File System Drivers], FSCTL_OFFLOAD_WRITE_OUTPUT structure [Installable File System Drivers], *PFSCTL_OFFLOAD_WRITE_OUTPUT, FSCTL_OFFLOAD_WRITE_OUTPUT, PFSCTL_OFFLOAD_WRITE_OUTPUT, ifsk.fsctl_offload_write_output, ntifs/FSCTL_OFFLOAD_WRITE_OUTPUT
