...
* Call [**ZwQueryDirectoryFile**](nf-ntifs-zwquerydirectoryfile.md), passing **FileIdAllExtdDirectoryInformation** as the value of [**FileInformationClass**](../wdm/ne-wdm-_file_information_class.md) and passing a caller-allocated, **FILE_ID_ALL_EXTD_DIR_INFORMATION**-structured buffer as the value of **FileInformation**.
