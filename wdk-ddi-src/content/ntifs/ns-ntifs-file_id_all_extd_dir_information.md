---
UID: NS:ntifs._FILE_ID_ALL_EXTD_DIR_INFORMATION
tech.root: ifsk
title: FILE_ID_ALL_EXTD_DIR_INFORMATION
ms.date: 02/06/2024
targetos: Windows
description: Learn more about the FILE_ID_ALL_EXTD_DIR_INFORMATION structure.
prerelease: false
...
req.target-type: 
req.typenames: FILE_ID_ALL_EXTD_DIR_INFORMATION, *PFILE_ID_ALL_EXTD_DIR_INFORMATION
...
f1_keywords:
 - _FILE_ID_ALL_EXTD_DIR_INFORMATION
 - ntifs/_FILE_ID_ALL_EXTD_DIR_INFORMATION
 - PFILE_ID_ALL_EXTD_DIR_INFORMATION
 - ntifs/PFILE_ID_ALL_EXTD_DIR_INFORMATION
 - FILE_ID_ALL_EXTD_DIR_INFORMATION
 - ntifs/FILE_ID_ALL_EXTD_DIR_INFORMATION
dev_langs:
 - c++
helpviewer_keywords:
 - _FILE_ID_ALL_EXTD_DIR_INFORMATION
...
# FILE_ID_ALL_EXTD_DIR_INFORMATION structure (ntifs.h)

## -description

The **FILE_ID_ALL_EXTD_DIR_INFORMATION** structure is used to query 64-bit and 128-bit file reference number information for the files in a directory.
...
* Call [**ZwQueryDirectoryFile**](nf-ntifs-zwqueryvirtualmemory.md), passing **FileIdAllExtdDirectoryInformation** as the value of [**FileInformationClass**](../wdm/ne-wdm-_file_information_class.md) and passing a caller-allocated, **FILE_ID_ALL_EXTD_DIR_INFORMATION**-structured buffer as the value of **FileInformation**.
