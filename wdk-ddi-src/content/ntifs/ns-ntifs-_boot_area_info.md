...
ms.date: 2/16/2018
ms.keywords: ",  , *, *PBOOT_AREA_INFO, ,, A, B, BOOT_AREA_INFO, BOOT_AREA_INFO structure [Installable File System Drivers], E, F, I, N, O, P, PBOOT_AREA_INFO, PBOOT_AREA_INFO structure pointer [Installable File System Drivers], R, T, _, _BOOT_AREA_INFO, ifsk.boot_area_info, ntifs/BOOT_AREA_INFO, ntifs/PBOOT_AREA_INFO"
