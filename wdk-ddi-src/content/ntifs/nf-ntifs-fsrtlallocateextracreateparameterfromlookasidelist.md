...
Use the [FsRtlInitExtraCreateParameterLookasideList](./nf-ntifs-fsrtlinitextracreateparameterlookasidelist.md) routine to initialize a paged or nonpaged pool lookaside list. Use the **FsRtlAllocateExtraCreateParameterFromLookasideList** routine to allocate an ECP context structure from the lookaside list, and the [FsRtlFreeExtraCreateParameter](./nf-ntifs-fsrtlfreeextracreateparameter.md) routine to deallocate the ECP context structure.

Use the [FsRtlDeleteExtraCreateParameterLookasideList](./nf-ntifs-fsrtldeleteextracreateparameterlookasidelist.md) routine to free a lookaside list.
...
[FsRtlDeleteExtraCreateParameterLookasideList](./nf-ntifs-fsrtldeleteextracreateparameterlookasidelist.md)

[FsRtlFreeExtraCreateParameter](./nf-ntifs-fsrtlfreeextracreateparameter.md)

[FsRtlInitExtraCreateParameterLookasideList](./nf-ntifs-fsrtlinitextracreateparameterlookasidelist.md)

[PFSRTL_EXTRA_CREATE_PARAMETER_CLEANUP_CALLBACK](./nc-ntifs-pfsrtl_extra_create_parameter_cleanup_callback.md)