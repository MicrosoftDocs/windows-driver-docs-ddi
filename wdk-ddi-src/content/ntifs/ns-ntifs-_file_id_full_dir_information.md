...
title: FILE_ID_FULL_DIR_INFORMATION (ntifs.h)
...
f1_keywords:
 ...
 - ntifs/_FILE_ID_FULL_DIR_INFORMATION
 - PFILE_ID_FULL_DIR_INFORMATION
 - ntifs/PFILE_ID_FULL_DIR_INFORMATION
 - FILE_ID_FULL_DIR_INFORMATION
 - ntifs/FILE_ID_FULL_DIR_INFORMATION
topic_type:
 - APIRef
 - kbSyntax
api_type:
...
* Call [**ZwQueryDirectoryFile**](nf-ntifs-zwqueryvirtualmemory.md), passing FileIdFullDirectoryInformation as the value of **FileInformationClass** and passing a caller-allocated, FILE_ID_FULL_DIR_INFORMATION-structured buffer as the value of **FileInformation**.
