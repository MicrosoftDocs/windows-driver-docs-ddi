...
* Call [**ZwQueryDirectoryFile**](nf-ntifs-zwquerydirectoryfile.md), passing FileFullDirectoryInformation as the value of **FileInformationClass** and passing a caller-allocated, FILE_FULL_DIR_INFORMATION-structured buffer as the value of **FileInformation**.
