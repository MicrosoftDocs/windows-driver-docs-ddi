...
Callers of <b>ZwUnlockFile</b> must be running at IRQL = PASSIVE_LEVEL and <a href="/windows-hardware/drivers/kernel/disabling-apcs">with special kernel APCs enabled</a>.

<div class="alert"><b>Note</b>  If the call to the <b>ZwUnlockFile</b> function occurs in user mode, you should use the name "<a href="/previous-versions/ff567118(v=vs.85)">NtUnlockFile</a>" instead of "<b>ZwUnlockFile</b>".</div>
<div> </div>
...
<a href="/previous-versions/ff566474(v=vs.85)">ZwLockFile</a>