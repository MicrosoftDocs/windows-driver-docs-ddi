...
ms.date: 2/20/2018
ms.keywords: ",  , A, D, E, F, I, K, N, O, P, S, T, W, WDF_TASK_SEND_OPTIONS_INIT, WDF_TASK_SEND_OPTIONS_INIT method, _, wdf.wdf_task_send_options_init, wdfcompaniontarget/WDF_TASK_SEND_OPTIONS_INIT"
