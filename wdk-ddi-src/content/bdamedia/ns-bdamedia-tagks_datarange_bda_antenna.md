...
ms.date: 1/9/2018
ms.keywords: stream.ks_datarange_bda_antenna, PKS_DATARANGE_BDA_ANTENNA structure pointer [Streaming Media Devices], KS_DATARANGE_BDA_ANTENNA, bdaref_ebf4214a-27fb-4746-af16-9cc98a1dcbd4.xml, bdamedia/KS_DATARANGE_BDA_ANTENNA, tagKS_DATARANGE_BDA_ANTENNA, bdamedia/PKS_DATARANGE_BDA_ANTENNA, PKS_DATARANGE_BDA_ANTENNA, *PKS_DATARANGE_BDA_ANTENNA, KS_DATARANGE_BDA_ANTENNA structure [Streaming Media Devices]
