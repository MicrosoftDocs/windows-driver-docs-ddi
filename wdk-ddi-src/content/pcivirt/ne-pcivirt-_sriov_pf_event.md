...
ms.date: 2/15/2018
ms.keywords: PCI.sriov_pf_event, _SRIOV_PF_EVENT, SRIOV_PF_EVENT, pcivirt/SriovEventPfMaximum, *PSRIOV_PF_EVENT, SriovEventPfQueryStopDevice, pcivirt/SriovEventPfRestart, SRIOV_PF_EVENT enumeration [Buses], SriovEventPfMaximum, pcivirt/SriovEventPfQueryStopDevice, pcivirt/SRIOV_PF_EVENT, SriovEventPfRestart
