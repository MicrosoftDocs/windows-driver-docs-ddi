...
title: ExtRemoteData::SetLongPtr method (engextcpp.h)
description: The SetLongPtr convenience method is provided by the ExtRemoteData class, which provides a wrapper for a small section of a target's memory.
old-location: debugger\extremotedata.htm
tech.root: debugger
ms.date: 01/19/2018
keywords: ["ExtRemoteData::SetLongPtr method"]
...
f1_keywords:
 ...
 - engextcpp/ExtRemoteData::SetLongPtr
topic_type:
 - APIRef
 - kbSyntax
api_type:
