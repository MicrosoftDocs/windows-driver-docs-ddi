...
title: ExtRemoteData::SetLong method (engextcpp.h)
description: The SetLong convenience method is provided by the ExtRemoteData class, which provides a wrapper for a small section of a target's memory.
...
f1_keywords:
 ...
 - engextcpp/ExtRemoteData::SetLong
topic_type:
 - APIRef
 - kbSyntax
api_type:
