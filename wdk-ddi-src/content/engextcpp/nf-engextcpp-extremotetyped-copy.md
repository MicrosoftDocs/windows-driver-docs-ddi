...
ms.date: 1/19/2018
ms.keywords: EngExtCpp_Ref_04970dac-e759-4a04-a1e0-8dab752c1418.xml, ExtRemoteTyped class [Windows Debugging], debugger.extremotetyped, ExtRemoteTyped, ExtRemoteTyped::Clear, ExtRemoteTyped class [Windows Debugging], described, engextcpp/ExtRemoteTyped, ExtRemoteTyped::Copy, Clear, Copy
