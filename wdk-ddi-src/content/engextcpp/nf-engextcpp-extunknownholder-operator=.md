...
ms.date: 1/19/2018
ms.keywords: debugger.extremotetyped_operatorequals_debug_typed_data, ExtDeclAlignedBuffer::operator=, ExtBuffer, operator=, operator= method [Windows Debugging], ExtDeclBuffer, ExtCheckedPointer, ExtRemoteTyped class [Windows Debugging], operator= method, ExtCheckedPointer::operator=, ExtDeleteHolder::operator=, ExtDeclBuffer::operator=, ExtUnknownHolder, ExtDeleteHolder, ExtBuffer::operator=, operator= method [Windows Debugging], ExtRemoteTyped class, ExtDeclAlignedBuffer, ExtUnknownHolder::operator=
