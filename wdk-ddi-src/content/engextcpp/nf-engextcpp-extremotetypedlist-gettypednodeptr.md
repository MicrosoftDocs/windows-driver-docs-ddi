...
ms.date: 1/19/2018
ms.keywords: debugger.extremotetypedlist_gettypednodeptr, EngExtCpp_Ref_f007b7c1-89b0-43fa-95e3-792a3272b56d.xml, ExtRemoteTypedList, ExtRemoteTypedList class [Windows Debugging], GetTypedNodePtr method, GetTypedNodePtr, ExtRemoteTypedList::GetTypedNodePtr, GetTypedNodePtr method [Windows Debugging], GetTypedNodePtr method [Windows Debugging], ExtRemoteTypedList class
