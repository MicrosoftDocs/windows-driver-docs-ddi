...
ms.date: 1/19/2018
ms.keywords: GetUlongPtr, GetUlongPtr method [Windows Debugging], ExtRemoteData class, ExtRemoteData::GetUlongPtr, GetUlongPtr method [Windows Debugging], ExtRemoteData class [Windows Debugging], GetUlongPtr method, ExtRemoteData, EngExtCpp_Ref_22ba632d-a45b-40de-b8d7-269c917357d5.xml, debugger.extremotedata_getulongptr
