...
ms.date: 2/22/2018
ms.keywords: ExtRemoteData class [Windows Debugging], GetUlongPtr method, GetUlongPtr method [Windows Debugging], GetUlongPtr method [Windows Debugging], ExtRemoteData class, debugger.extremotedata_getulongptr, ExtRemoteData::GetUlongPtr, EngExtCpp_Ref_22ba632d-a45b-40de-b8d7-269c917357d5.xml, ExtRemoteData, GetUlongPtr
