...
ms.date: 1/19/2018
ms.keywords: ExtDeclAlignedBuffer::operator=, ExtCheckedPointer::operator=, ExtBuffer, operator= method [Windows Debugging], ExtDeleteHolder, debugger.extremotetyped_operatorequals_debug_typed_data, ExtDeleteHolder::operator=, ExtBuffer::operator=, ExtDeclBuffer, ExtDeclAlignedBuffer, ExtRemoteTyped class [Windows Debugging], operator= method, ExtCheckedPointer, ExtDeclBuffer::operator=, operator=, operator= method [Windows Debugging], ExtRemoteTyped class
