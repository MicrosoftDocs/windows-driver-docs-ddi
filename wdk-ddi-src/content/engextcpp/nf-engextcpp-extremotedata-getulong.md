...
ms.date: 1/19/2018
ms.keywords: GetUlong method [Windows Debugging], EngExtCpp_Ref_41a112c3-0350-4e54-981c-b5c11697ef2d.xml, GetUlong method [Windows Debugging], ExtRemoteData class, ExtRemoteData, ExtRemoteData class [Windows Debugging], GetUlong method, GetUlong, debugger.extremotedata_getulong, ExtRemoteData::GetUlong
