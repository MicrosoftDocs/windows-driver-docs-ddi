...
title: ExtRemoteData::SetUshort method (engextcpp.h)
description: The SetUshort convenience method is provided by the ExtRemoteData class, which provides a wrapper for a small section of a target's memory.
...
f1_keywords:
 ...
 - engextcpp/ExtRemoteData::SetUshort
topic_type:
 - APIRef
 - kbSyntax
api_type:
