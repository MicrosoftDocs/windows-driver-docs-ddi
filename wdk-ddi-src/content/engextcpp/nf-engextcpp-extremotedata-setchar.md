...
ms.date: 1/19/2018
ms.keywords: ExtRemoteData::SetBoolean, ExtRemoteData::Clear, ExtRemoteData class [Windows Debugging], ExtRemoteData class [Windows Debugging], described, debugger.extremotedata, SetChar, Clear, ExtRemoteData, ExtRemoteData::SetChar, EngExtCpp_Ref_e84c03ce-1156-481b-a429-f0a918797565.xml, engextcpp/ExtRemoteData, SetBoolean
