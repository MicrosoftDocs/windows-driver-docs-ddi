...
ms.date: 1/19/2018
ms.keywords: ExtUnknownHolder::Set, ExtBuffer::Set, ExtCheckedPointer::Set, Set, ExtDeleteHolder, ExtRemoteTyped class [Windows Debugging], Set method, ExtUnknownHolder, ExtDeleteHolder::Set, debugger.extremotetyped_set_bool, Set method [Windows Debugging], ExtRemoteTyped class, ExtBuffer, Set method [Windows Debugging], ExtCheckedPointer
