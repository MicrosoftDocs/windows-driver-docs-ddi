...
ms.date: 1/19/2018
ms.keywords: ExtDeleteHolder, ExtUnknownHolder::Set, ExtBuffer, ExtCheckedPointer::Set, Set, Set method [Windows Debugging], ExtBuffer::Set, ExtCheckedPointer, ExtDeleteHolder::Set, ExtUnknownHolder, Set method [Windows Debugging], ExtRemoteTyped class, debugger.extremotetyped_set_bool, ExtRemoteTyped class [Windows Debugging], Set method
