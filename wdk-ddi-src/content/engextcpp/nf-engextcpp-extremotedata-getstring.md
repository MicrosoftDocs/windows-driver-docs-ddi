...
ms.date: 2/15/2018
ms.keywords: GetString method [Windows Debugging], ExtRemoteData::GetString, EngExtCpp_Ref_0e8b8a7f-d6d4-4262-a1ed-5829a83ec80d.xml, ExtRemoteData class [Windows Debugging], GetString method, debugger.extremotedata_getstring, GetString method [Windows Debugging], ExtRemoteData class, GetString, ExtRemoteData
