...
ms.date: 1/19/2018
ms.keywords: SetLong, SetData, ExtRemoteData class [Windows Debugging], SetDouble, ExtRemoteData::SetChar, ExtRemoteData, ExtRemoteData::SetLong, SetLongPtr, ExtRemoteData::SetShort, ExtRemoteData::SetLongPtr, ExtRemoteData::SetData, SetUchar, ExtRemoteData::Clear, ExtRemoteData class [Windows Debugging], described, EngExtCpp_Ref_e84c03ce-1156-481b-a429-f0a918797565.xml, engextcpp/ExtRemoteData, SetBoolean, ExtRemoteData::SetBoolean, ExtRemoteData::SetLong64, ExtRemoteData::SetDouble, SetLong64, SetStdBool, ExtRemoteData::SetStdBool, debugger.extremotedata, SetShort, SetChar, SetFloat, SetPtr, ExtRemoteData::SetUlong, ExtRemoteData::SetFloat, ExtRemoteData::SetUchar, Clear, SetUlong, ExtRemoteData::SetPtr
