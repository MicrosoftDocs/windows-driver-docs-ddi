...
ms.date: 2/22/2018
ms.keywords: GetDouble method [Windows Debugging], GetDouble method [Windows Debugging], ExtRemoteData class, ExtRemoteData::GetDouble, debugger.extremotedata_getdouble, ExtRemoteData, EngExtCpp_Ref_8776e6fd-9e13-4502-a445-da65a8fcfe41.xml, ExtRemoteData class [Windows Debugging], GetDouble method, GetDouble
