...
ms.date: 1/19/2018
ms.keywords: ExtRemoteData, ExtRemoteData class [Windows Debugging], GetDouble method, GetDouble, GetDouble method [Windows Debugging], GetDouble method [Windows Debugging], ExtRemoteData class, ExtRemoteData::GetDouble, EngExtCpp_Ref_8776e6fd-9e13-4502-a445-da65a8fcfe41.xml, debugger.extremotedata_getdouble
