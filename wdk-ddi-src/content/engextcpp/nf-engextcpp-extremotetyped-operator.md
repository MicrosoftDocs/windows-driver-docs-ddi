...
ms.date: 2/15/2018
ms.keywords: ExtRemoteTyped, operator*, debugger.extremotetyped_operator_, ExtRemoteTyped interface [Windows Debugging], operator* method, ExtRemoteTyped::operator*, EngExtCpp_Ref_3e10d850-c463-4d43-8639-7b7daf26c749.xml, operator* method [Windows Debugging], operator* method [Windows Debugging], ExtRemoteTyped interface
