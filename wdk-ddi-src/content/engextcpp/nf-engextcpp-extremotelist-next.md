...
ms.date: 2/22/2018
ms.keywords: debugger.extremotelist_next, ExtRemoteList, Next, Next method [Windows Debugging], ExtRemoteList::Next, Next method [Windows Debugging], ExtRemoteList class, EngExtCpp_Ref_27cc32ed-e2da-4041-8dd7-e2d5a0910c5e.xml, ExtRemoteList class [Windows Debugging], Next method
