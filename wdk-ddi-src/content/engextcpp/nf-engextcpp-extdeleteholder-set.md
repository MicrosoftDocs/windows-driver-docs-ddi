...
ms.date: 1/19/2018
ms.keywords: ExtDeleteHolder, ExtCheckedPointer::Set, debugger.extremotetyped_set_bool, Set, Set method [Windows Debugging], ExtBuffer::Set, ExtCheckedPointer, ExtDeleteHolder::Set, Set method [Windows Debugging], ExtRemoteTyped class, ExtBuffer, ExtRemoteTyped class [Windows Debugging], Set method
