...
ms.date: 2/22/2018
ms.keywords: Dereference, ExtRemoteTyped::Dereference, ExtRemoteTyped, EngExtCpp_Ref_d195c66d-88c1-4099-a227-0dd86d9d67e2.xml, ExtRemoteTyped interface [Windows Debugging], Dereference method, debugger.extremotetyped_dereference, Dereference method [Windows Debugging], ExtRemoteTyped interface, Dereference method [Windows Debugging]
