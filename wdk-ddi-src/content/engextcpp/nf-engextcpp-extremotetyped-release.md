...
ms.date: 2/22/2018
ms.keywords: Release method [Windows Debugging], ExtRemoteTyped interface, EngExtCpp_Ref_529ae2ad-c867-4b76-a53d-b0e7118f1fcd.xml, Release, ExtRemoteTyped, Release method [Windows Debugging], ExtRemoteTyped interface [Windows Debugging], Release method, ExtRemoteTyped::Release, debugger.extremotetyped_release
