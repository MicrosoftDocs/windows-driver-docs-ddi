...
title: ExtRemoteData::SetUlong64 method (engextcpp.h)
description: The SetUlong64 convenience method is provided by the ExtRemoteData class, which provides a wrapper for a small section of a target's memory.
old-location: debugger\extremotedata.htm
tech.root: debugger
ms.date: 01/19/2018
keywords: ["ExtRemoteData::SetUlong64 method"]
...
f1_keywords:
 ...
 - engextcpp/ExtRemoteData::SetUlong64
topic_type:
 - APIRef
 - kbSyntax
api_type:
