...
description: The ExtRemoteData constructor creates a new instance of the ExtRemoteData class. For a specified memory region, contents are read from the target.
