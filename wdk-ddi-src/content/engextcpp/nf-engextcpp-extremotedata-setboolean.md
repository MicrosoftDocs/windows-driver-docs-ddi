...
ms.date: 1/19/2018
ms.keywords: Clear, ExtRemoteData class [Windows Debugging], ExtRemoteData, SetBoolean, ExtRemoteData::SetBoolean, ExtRemoteData::Clear, ExtRemoteData class [Windows Debugging], described, EngExtCpp_Ref_e84c03ce-1156-481b-a429-f0a918797565.xml, debugger.extremotedata, engextcpp/ExtRemoteData
