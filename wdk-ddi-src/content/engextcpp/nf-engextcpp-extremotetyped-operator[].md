...
ms.date: 1/19/2018
ms.keywords: ExtRemoteTyped class [Windows Debugging], described, ExtRemoteTyped::Copy, Copy, ErtIoctl, operator=, EngExtCpp_Ref_04970dac-e759-4a04-a1e0-8dab752c1418.xml, ExtRemoteTyped, ExtRemoteTyped::GetSimpleValue, ExtRemoteTyped::operator=, engextcpp/ExtRemoteTyped, ExtRemoteTyped::operator[], debugger.extremotetyped, ExtRemoteTyped class [Windows Debugging], Clear, GetSimpleValue, ExtRemoteTyped::ErtIoctl, operator[], ExtRemoteTyped::Clear
