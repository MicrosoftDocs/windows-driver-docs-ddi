...
ms.date: 1/19/2018
ms.keywords: GetUchar, ExtRemoteData, EngExtCpp_Ref_687a7887-560a-4565-8417-ec46cc1ee254.xml, ExtRemoteData::GetUchar, GetUchar method [Windows Debugging], debugger.extremotedata_getuchar, ExtRemoteData class [Windows Debugging], GetUchar method, GetUchar method [Windows Debugging], ExtRemoteData class
