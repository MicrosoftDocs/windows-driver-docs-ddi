...
ms.date: 1/19/2018
ms.keywords: Set method [Windows Debugging], ExtRemoteTyped class, ExtBuffer, debugger.extremotetyped_set_bool, ExtCheckedPointer::Set, Set method [Windows Debugging], ExtRemoteTyped class [Windows Debugging], Set method, ExtCheckedPointer, ExtBuffer::Set, Set
