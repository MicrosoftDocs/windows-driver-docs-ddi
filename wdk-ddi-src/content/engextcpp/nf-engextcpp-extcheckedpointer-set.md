...
ms.date: 1/19/2018
ms.keywords: ExtBuffer, ExtRemoteTyped class [Windows Debugging], Set method, ExtCheckedPointer::Set, Set method [Windows Debugging], ExtRemoteTyped class, Set method [Windows Debugging], debugger.extremotetyped_set_bool, ExtCheckedPointer, ExtBuffer::Set, Set
