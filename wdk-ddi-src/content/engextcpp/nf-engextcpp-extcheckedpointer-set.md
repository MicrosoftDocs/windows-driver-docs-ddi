...
ms.date: 1/19/2018
ms.keywords: Set, ExtBuffer::Set, ExtBuffer, Set method [Windows Debugging], ExtRemoteTyped class, ExtRemoteTyped class [Windows Debugging], Set method, debugger.extremotetyped_set_bool, Set method [Windows Debugging], ExtCheckedPointer, ExtCheckedPointer::Set
