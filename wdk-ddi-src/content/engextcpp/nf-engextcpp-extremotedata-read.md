...
ms.date: 1/19/2018
ms.keywords: EngExtCpp_Ref_69230a7b-f83c-46fc-88c4-134b506540af.xml, debugger.extremotedata_read, Read method [Windows Debugging], ExtRemoteData class, ExtRemoteData class [Windows Debugging], Read method, ExtRemoteData, ExtRemoteData::Read, Read method [Windows Debugging], Read
