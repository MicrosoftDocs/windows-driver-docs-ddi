...
ms.date: 1/19/2018
ms.keywords: ExtRemoteTyped::GetSimpleValue, Clear, EngExtCpp_Ref_04970dac-e759-4a04-a1e0-8dab752c1418.xml, ExtRemoteTyped class [Windows Debugging], GetSimpleValue, ExtRemoteTyped::Clear, debugger.extremotetyped, ExtRemoteTyped, ExtRemoteTyped class [Windows Debugging], described, ExtRemoteTyped::ErtIoctl, ErtIoctl, ExtRemoteTyped::Copy, engextcpp/ExtRemoteTyped, Copy
