...
ms.date: 2/22/2018
ms.keywords: EngExtCpp_Ref_8ce2c346-a92a-45ef-8baa-f1c42670aca6.xml, ExtRemoteTyped::HasField, ExtRemoteTyped, HasField, ExtRemoteTyped interface [Windows Debugging], HasField method, HasField method [Windows Debugging], ExtRemoteTyped interface, HasField method [Windows Debugging], debugger.extremotetyped_hasfield
