...
ms.date: 1/19/2018
ms.keywords: debugger.extremotetyped, Copy, ExtRemoteTyped class [Windows Debugging], ExtRemoteTyped::Clear, EngExtCpp_Ref_04970dac-e759-4a04-a1e0-8dab752c1418.xml, ErtIoctl, engextcpp/ExtRemoteTyped, ExtRemoteTyped class [Windows Debugging], described, Clear, ExtRemoteTyped::Copy, ExtRemoteTyped::ErtIoctl, ExtRemoteTyped
