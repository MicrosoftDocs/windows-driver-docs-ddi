...
ms.date: 1/19/2018
ms.keywords: ExtRemoteTyped class [Windows Debugging], described, ExtRemoteTyped class [Windows Debugging], EngExtCpp_Ref_04970dac-e759-4a04-a1e0-8dab752c1418.xml, debugger.extremotetyped, engextcpp/ExtRemoteTyped, ExtRemoteTyped::Clear, Clear, ExtRemoteTyped
