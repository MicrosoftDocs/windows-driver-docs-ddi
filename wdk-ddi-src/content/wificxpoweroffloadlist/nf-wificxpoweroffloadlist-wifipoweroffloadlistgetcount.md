...
tech.root: netvista
title: WifiPowerOffloadListGetCount
ms.date: 04/30/2021
targetos: Windows
description: "Microsoft reserves the WifiPowerOffloadListGetCount function for internal use only. Don't use this function in your code."
req.assembly: 
