...
ms.date: 12/14/2017
ms.keywords: "_PARALLEL_CHIP_MODE, parports.parallel_chip_mode, cisspd_1dbc3693-e551-46a3-9a41-725b06a2ee9a.xml, PPARALLEL_CHIP_MODE structure pointer [Parallel Ports], PARALLEL_CHIP_MODE, PARALLEL_CHIP_MODE structure [Parallel Ports], parallel/PPARALLEL_CHIP_MODE, *PPARALLEL_CHIP_MODE, PPARALLEL_CHIP_MODE, parallel/PARALLEL_CHIP_MODE"
...
product: Windows
targetos: Windows
req.typenames: "*PPARALLEL_CHIP_MODE, PARALLEL_CHIP_MODE"
---
