...
The old version of the **PNEGOTIATE_IEEE_MODE** callback function. For the latest version, see the **[PNEGOTIATE_IEEE_MODE](/windows-hardware/drivers/ddi/parallel/nc-parallel-pnegotiate_ieee_mode-r1)** (new) callback function.
...
- **[PNEGOTIATE_IEEE_MODE](/windows-hardware/drivers/ddi/parallel/nc-parallel-pnegotiate_ieee_mode-r1)**
