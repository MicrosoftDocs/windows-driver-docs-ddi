...
ms.date: 2/22/2018
ms.keywords: ksproxy_d14aea61-913f-44f9-8fc0-08d31b9e8e50.xml, stream.iksclockpropertyset_ksgetstate, IKsClockPropertySet, IKsClockPropertySet interface [Streaming Media Devices], KsGetState method, ksproxy/IKsClockPropertySet::KsGetState, KsGetState method [Streaming Media Devices], IKsClockPropertySet::KsGetState, KsGetState, KsGetState method [Streaming Media Devices], IKsClockPropertySet interface
