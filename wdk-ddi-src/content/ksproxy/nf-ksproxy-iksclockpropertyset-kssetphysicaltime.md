...
ms.date: 2/22/2018
ms.keywords: IKsClockPropertySet::KsSetPhysicalTime, ksproxy_1cebc4eb-efb8-4ec6-97f4-e34fc978fb2f.xml, IKsClockPropertySet, KsSetPhysicalTime, KsSetPhysicalTime method [Streaming Media Devices], IKsClockPropertySet interface, IKsClockPropertySet interface [Streaming Media Devices], KsSetPhysicalTime method, KsSetPhysicalTime method [Streaming Media Devices], ksproxy/IKsClockPropertySet::KsSetPhysicalTime, stream.iksclockpropertyset_kssetphysicaltime
