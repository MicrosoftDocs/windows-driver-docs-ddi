...
ms.date: 2/22/2018
ms.keywords: IKsNotifyEvent interface [Streaming Media Devices], KsNotifyEvent method, KsNotifyEvent method [Streaming Media Devices], KsNotifyEvent method [Streaming Media Devices], IKsNotifyEvent interface, KsNotifyEvent, stream.iksnotifyevent_ksnotifyevent, IKsNotifyEvent::KsNotifyEvent, ksproxy_0fb6c49f-3aef-411d-90db-cf9a4186cdd9.xml, IKsNotifyEvent, ksproxy/IKsNotifyEvent::KsNotifyEvent
