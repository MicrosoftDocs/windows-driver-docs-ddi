...
ms.date: 1/9/2018
ms.keywords: IKsDataTypeHandler::KsSetMediaType, ksproxy_5992cc35-8912-4e1e-8712-ebb6f36f5193.xml, IKsDataTypeHandler interface [Streaming Media Devices], KsSetMediaType method, KsSetMediaType method [Streaming Media Devices], KsSetMediaType method [Streaming Media Devices], IKsDataTypeHandler interface, KsSetMediaType, IKsDataTypeHandler, stream.iksdatatypehandler_kssetmediatype, ksproxy/IKsDataTypeHandler::KsSetMediaType
