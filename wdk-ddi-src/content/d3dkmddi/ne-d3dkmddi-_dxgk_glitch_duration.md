...
ms.date: 12/29/2017
ms.keywords: d3dkmddi/DXGK_GLITCH_DURATION_MULTI_FRAME, DXGK_GLITCH_DURATION_SINGLE_LINE, _DXGK_GLITCH_DURATION, DXGK_GLITCH_DURATION enumeration [Display Devices], DXGK_GLITCH_DURATION, DXGK_GLITCH_DURATION_NONE, DXGK_GLITCH_DURATION_MULTI_LINE, DXGK_GLITCH_DURATION_SINGLE_FRAME, DXGK_GLITCH_DURATION_MULTI_FRAME, display.dxgk_glitch_duration, d3dkmddi/DXGK_GLITCH_DURATION_MULTI_LINE, d3dkmddi/DXGK_GLITCH_DURATION_SINGLE_FRAME, DXGK_GLITCH_DURATION_INDEFINITE, d3dkmddi/DXGK_GLITCH_DURATION, d3dkmddi/DXGK_GLITCH_DURATION_NONE, d3dkmddi/DXGK_GLITCH_DURATION_SINGLE_LINE, d3dkmddi/DXGK_GLITCH_DURATION_INDEFINITE
