...
ms.date: 2/22/2018
ms.keywords: d3dkmddi/DXGK_GLITCH_DURATION, d3dkmddi/DXGK_GLITCH_DURATION_INDEFINITE, d3dkmddi/DXGK_GLITCH_DURATION_SINGLE_LINE, DXGK_GLITCH_DURATION, DXGK_GLITCH_DURATION enumeration [Display Devices], d3dkmddi/DXGK_GLITCH_DURATION_SINGLE_FRAME, _DXGK_GLITCH_DURATION, DXGK_GLITCH_DURATION_SINGLE_LINE, display.dxgk_glitch_duration, d3dkmddi/DXGK_GLITCH_DURATION_NONE, d3dkmddi/DXGK_GLITCH_DURATION_MULTI_LINE, DXGK_GLITCH_DURATION_MULTI_FRAME, DXGK_GLITCH_DURATION_SINGLE_FRAME, d3dkmddi/DXGK_GLITCH_DURATION_MULTI_FRAME, DXGK_GLITCH_DURATION_INDEFINITE, DXGK_GLITCH_DURATION_MULTI_LINE, DXGK_GLITCH_DURATION_NONE
