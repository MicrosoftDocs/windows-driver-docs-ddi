...
A pointer to a <a href="/windows-hardware/drivers/ddi/d3dkmddi/ns-d3dkmddi-_dxgkarg_patch">DXGKARG_PATCH</a> structure that describes the DMA buffer to be patched with physical addresses.
