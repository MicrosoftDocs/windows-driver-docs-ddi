...
ms.date: 12/29/2017
ms.keywords: display.dxgk_queryphysicaladaptercapsin, d3dkmddi/DXGK_QUERYPHYSICALADAPTERCAPSIN, DXGK_QUERYPHYSICALADAPTERCAPSIN structure [Display Devices], DXGK_QUERYPHYSICALADAPTERCAPSIN, _DXGK_QUERYPHYSICALADAPTERCAPSIN
