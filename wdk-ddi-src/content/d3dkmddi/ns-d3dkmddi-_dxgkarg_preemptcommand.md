...
ms.date: 12/29/2017
ms.keywords: d3dkmddi/DXGKARG_PREEMPTCOMMAND, DmStructs_2564ca47-8304-4a95-a408-2e5ccca7353d.xml, display.dxgkarg_preemptcommand, DXGKARG_PREEMPTCOMMAND structure [Display Devices], _DXGKARG_PREEMPTCOMMAND, DXGKARG_PREEMPTCOMMAND
