...
ms.date: 2/22/2018
ms.keywords: d3dkmddi/DXGKARG_HISTORYBUFFERPRECISION, DXGKARG_HISTORYBUFFERPRECISION structure [Display Devices], display.dxgkarg_historybufferprecision, DXGKARG_HISTORYBUFFERPRECISION, _DXGKARG_HISTORYBUFFERPRECISION
