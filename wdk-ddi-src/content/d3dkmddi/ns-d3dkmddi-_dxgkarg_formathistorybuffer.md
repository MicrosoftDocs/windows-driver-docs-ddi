...
ms.date: 12/29/2017
ms.keywords: DXGKARG_FORMATHISTORYBUFFER structure [Display Devices], DXGKARG_FORMATHISTORYBUFFER, d3dkmddi/DXGKARG_FORMATHISTORYBUFFER, display.dxgkarg_formathistorybuffer, _DXGKARG_FORMATHISTORYBUFFER
