...
A pointer to a <a href="/windows-hardware/drivers/ddi/d3dkmddi/ns-d3dkmddi-_dxgkarg_getscanline">DXGKARG_GETSCANLINE</a> structure that contains the vertical blanking status of a video present target.
