...
ms.date: 2/22/2018
ms.keywords: d3dkmddi/DXGKARGCB_PROTECTEDSESSIONSTATUS, DXGKARGCB_PROTECTEDSESSIONSTATUS structure [Display Devices], DXGKARGCB_PROTECTEDSESSIONSTATUS, _DXGKARGCB_PROTECTEDSESSIONSTATUS, display.dxgkargcb_protectedsessionstatus
