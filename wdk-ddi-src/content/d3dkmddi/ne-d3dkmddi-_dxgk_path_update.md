...
ms.date: 12/29/2017
ms.keywords: d3dkmddi/DXGK_PATH_UPDATE_ADDED, DXGK_PATH_UPDATE_UNMODIFED, d3dkmddi/DXGK_PATH_UPDATE_UNMODIFED, d3dkmddi/DXGK_PATH_UPDATE_MODIFIED, d3dkmddi/DXGK_PATH_UPDATE_REMOVED, display.dxgk_path_update, _DXGK_PATH_UPDATE, DXGK_PATH_UPDATE, d3dkmddi/DXGK_PATH_UPDATE, DXGK_PATH_UPDATE_MODIFIED, DXGK_PATH_UPDATE enumeration [Display Devices], DXGK_PATH_UPDATE_REMOVED, DXGK_PATH_UPDATE_ADDED
