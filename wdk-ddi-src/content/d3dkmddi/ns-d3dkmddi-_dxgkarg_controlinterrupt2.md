...
ms.date: 12/29/2017
ms.keywords: DXGKARG_CONTROLINTERRUPT2 structure [Display Devices], display.dxgkarg_controlinterrupt2, DXGKARG_CONTROLINTERRUPT2, DXGKARG_CONTROLINTTERUPT2, DXGKARG_CONTROLINTTERUPT2 structure [Display Devices], d3dkmddi/DXGKARG_CONTROLINTERRUPT2, _DXGKARG_CONTROLINTERRUPT2
