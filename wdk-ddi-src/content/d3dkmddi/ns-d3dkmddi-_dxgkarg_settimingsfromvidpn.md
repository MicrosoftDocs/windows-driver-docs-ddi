...
ms.date: 12/29/2017
ms.keywords: "*IN_OUT_PDXGKARG_SETTIMINGSFROMVIDPN, display.dxgkarg_settimingsfromvidpn, DXGKARG_SETTIMINGSFROMVIDPN structure [Display Devices], PDXGKARG_SETTIMINGSFROMVIDPN structure pointer [Display Devices], DXGKARG_SETTIMINGSFROMVIDPN, _DXGKARG_SETTIMINGSFROMVIDPN, d3dkmddi/DXGKARG_SETTIMINGSFROMVIDPN, d3dkmddi/PDXGKARG_SETTIMINGSFROMVIDPN, PDXGKARG_SETTIMINGSFROMVIDPN"
