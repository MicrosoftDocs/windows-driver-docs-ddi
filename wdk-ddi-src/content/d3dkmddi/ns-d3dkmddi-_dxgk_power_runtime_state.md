...
ms.date: 12/29/2017
ms.keywords: display.dxgk_power_runtime_state, DXGK_POWER_RUNTIME_STATE structure [Display Devices], d3dkmddi/DXGK_POWER_RUNTIME_STATE, _DXGK_POWER_RUNTIME_STATE, DXGK_POWER_RUNTIME_STATE
