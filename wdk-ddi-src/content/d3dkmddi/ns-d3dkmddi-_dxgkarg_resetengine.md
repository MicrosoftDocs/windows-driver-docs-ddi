...
ms.date: 2/22/2018
ms.keywords: DXGKARG_RESETENGINE, display.dxgkarg_resetengine, *INOUT_PDXGKARG_RESETENGINE, DXGKARG_RESETENGINE structure [Display Devices], _DXGKARG_RESETENGINE, d3dkmddi/DXGKARG_RESETENGINE
