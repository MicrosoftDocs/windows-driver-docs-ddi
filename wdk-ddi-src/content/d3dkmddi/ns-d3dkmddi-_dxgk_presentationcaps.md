...
### -field NoSameBitmapAlphaBlend [in]
...
### -field NoSameBitmapStretchBlt [in]
...
### -field NoSameBitmapTransparentBlt [in]
...
### -field NoSameBitmapOverlappedAlphaBlend [in]
...
### -field NoSameBitmapOverlappedStretchBlt [in]
...
### -field DriverSupportsCddDwmInterop [in]
...
### -field MaxTextureHeightShift [in]
...
### -field SupportAllBltRops [in]

A UINT value that specifies whether the display miniport driver supports all GDI ROP3 raster operations with solid color as a pattern in BitBlt and ColorFill commands. If <b>SupportAllBltRops</b> is set, the driver supports such raster operations.

Setting this member is equivalent to setting the fourteenth bit of the 32-bit <b>Value</b> member (0x00002000). 

Supported starting with Windows 7.

### -field SupportMirrorStretchBlt [in]
...
### -field SupportMonoStretchBltModes [in]
...
### -field StagingRectStartPitchAligned [in]
...
### -field NoSameBitmapOverlappedBitBlt [in]
...
### -field NoCacheCoherentApertureMemory [in]
