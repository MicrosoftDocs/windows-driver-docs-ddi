...
ms.date: 12/29/2017
ms.keywords: DXGKARG_CREATEPERIODICFRAMENOTIFICATION structure [Display Devices], display.dxgkarg_createperiodicframenotification, _DXGKARG_CREATEPERIODICFRAMENOTIFICATION, d3dkmddi/DXGKARG_CREATEPERIODICFRAMENOTIFICATION, *INOUT_PDXGKARG_CREATEPERIODICFRAMENOTIFICATION, DXGKARG_CREATEPERIODICFRAMENOTIFICATION
