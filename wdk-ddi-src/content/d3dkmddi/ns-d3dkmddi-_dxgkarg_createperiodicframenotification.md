...
ms.date: 2/20/2018
ms.keywords: DXGKARG_CREATEPERIODICFRAMENOTIFICATION structure [Display Devices], DXGKARG_CREATEPERIODICFRAMENOTIFICATION, d3dkmddi/DXGKARG_CREATEPERIODICFRAMENOTIFICATION, *INOUT_PDXGKARG_CREATEPERIODICFRAMENOTIFICATION, display.dxgkarg_createperiodicframenotification, _DXGKARG_CREATEPERIODICFRAMENOTIFICATION
