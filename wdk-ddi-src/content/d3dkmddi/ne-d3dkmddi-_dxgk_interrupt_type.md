...
ms.date: 12/29/2017
ms.keywords: d3dkmddi/DXGK_INTERRUPT_DISPLAYONLY_VSYNC, DXGK_INTERRUPT_PERIODIC_MONITORED_FENCE_SIGNALED, _DXGK_INTERRUPT_TYPE, DXGK_INTERRUPT_DMA_PREEMPTED, DXGK_INTERRUPT_DMA_PAGE_FAULTED, DmEnums_5ed0a892-5813-43ff-aae9-25b03aa3ea5f.xml, d3dkmddi/DXGK_INTERRUPT_TYPE, d3dkmddi/DXGK_INTERRUPT_MICACAST_ENCODE_CHUNK_COMPLETE, DXGK_INTERRUPT_TYPE enumeration [Display Devices], d3dkmddi/DXGK_INTERRUPT_DISPLAYONLY_PRESENT_PROGRESS, d3dkmddi/DXGK_INTERRUPT_CRTC_VSYNC, d3dkmddi/DXGK_INTERRUPT_CRTC_VSYNC_WITH_MULTIPLANE_OVERLAY, DXGK_INTERRUPT_CRTC_VSYNC_WITH_MULTIPLANE_OVERLAY, d3dkmddi/DXGK_INTERRUPT_PERIODIC_MONITORED_FENCE_SIGNALED, DXGK_INTERRUPT_DMA_COMPLETED, d3dkmddi/DXGK_INTERRUPT_DMA_PREEMPTED, d3dkmddi/DXGK_INTERRUPT_DMA_FAULTED, d3dkmddi/DXGK_INTERRUPT_DMA_PAGE_FAULTED, DXGK_INTERRUPT_TYPE, DXGK_INTERRUPT_DISPLAYONLY_PRESENT_PROGRESS, DXGK_INTERRUPT_MICACAST_ENCODE_CHUNK_COMPLETE, display.dxgk_interrupt_type, DXGK_INTERRUPT_DMA_FAULTED, DXGK_INTERRUPT_DISPLAYONLY_VSYNC, d3dkmddi/DXGK_INTERRUPT_DMA_COMPLETED, DXGK_INTERRUPT_CRTC_VSYNC
