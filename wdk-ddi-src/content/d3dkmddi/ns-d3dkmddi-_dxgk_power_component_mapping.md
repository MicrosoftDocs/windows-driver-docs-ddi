...
ms.date: 2/22/2018
ms.keywords: d3dkmddi/DXGK_POWER_COMPONENT_MAPPING, DXGK_POWER_COMPONENT_MAPPING structure [Display Devices], display.dxgk_power_component_mapping, DXGK_POWER_COMPONENT_MAPPING, _DXGK_POWER_COMPONENT_MAPPING
