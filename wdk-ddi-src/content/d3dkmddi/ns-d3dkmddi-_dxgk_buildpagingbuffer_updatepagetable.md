...
ms.date: 12/29/2017
ms.keywords: DXGK_BUILDPAGINGBUFFER_UPDATEPAGETABLE structure [Display Devices], DXGK_BUILDPAGINGBUFFER_UPDATEPAGETABLE, display.dxgk_buildpagingbuffer_updatepagetable, d3dkmddi/DXGK_BUILDPAGINGBUFFER_UPDATEPAGETABLE, _DXGK_BUILDPAGINGBUFFER_UPDATEPAGETABLE
