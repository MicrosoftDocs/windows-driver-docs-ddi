...
ms.date: 12/29/2017
ms.keywords: d3dkmddi/DXGK_QUERYDISPLAYIDIN, DXGK_QUERYDISPLAYIDIN, _DXGK_QUERYDISPLAYIDIN, DXGK_QUERYDISPLAYIDIN structure [Display Devices], display.dxgk_querydisplayidin
