...
ms.date: 12/29/2017
ms.keywords: display.dxgk_querydisplayidin, _DXGK_QUERYDISPLAYIDIN, DXGK_QUERYDISPLAYIDIN, d3dkmddi/DXGK_QUERYDISPLAYIDIN, DXGK_QUERYDISPLAYIDIN structure [Display Devices]
