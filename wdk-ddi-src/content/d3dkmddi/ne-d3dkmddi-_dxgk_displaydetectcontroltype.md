...
ms.date: 12/29/2017
ms.keywords: "_DXGK_DISPLAYDETECTCONTROLTYPE, display.dxgk_displaydetectcontroltype, DXGK_DDCT_POLLONE, DXGK_DISPLAYDETECTCONTROLTYPE, d3dkmddi/DXGK_DDCT_DISABLEHPD, DXGK_DISPLAYDETECTCONTROLTYPE enumeration [Display Devices], d3dkmddi/DXGK_DISPLAYDETECTCONTROLTYPE, d3dkmddi/DXGK_DDCT_POLLALL, DXGK_DDCT_POLLALL, d3dkmddi/DXGK_DDCT_UNINITIALIZED, DXGK_DDCT_ENABLEHPD, DXGK_DDCT_DISABLEHPD, DXGK_DDCT_UNINITIALIZED, d3dkmddi/DXGK_DDCT_POLLONE, d3dkmddi/DXGK_DDCT_ENABLEHPD"
