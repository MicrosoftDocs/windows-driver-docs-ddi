...
ms.date: 2/22/2018
ms.keywords: DXGK_DDCT_POLLONE, DXGK_DISPLAYDETECTCONTROLTYPE, d3dkmddi/DXGK_DDCT_DISABLEHPD, d3dkmddi/DXGK_DDCT_POLLONE, DXGK_DISPLAYDETECTCONTROLTYPE enumeration [Display Devices], DXGK_DDCT_ENABLEHPD, d3dkmddi/DXGK_DDCT_ENABLEHPD, d3dkmddi/DXGK_DISPLAYDETECTCONTROLTYPE, d3dkmddi/DXGK_DDCT_UNINITIALIZED, DXGK_DDCT_DISABLEHPD, _DXGK_DISPLAYDETECTCONTROLTYPE, display.dxgk_displaydetectcontroltype, d3dkmddi/DXGK_DDCT_POLLALL, DXGK_DDCT_POLLALL, DXGK_DDCT_UNINITIALIZED
