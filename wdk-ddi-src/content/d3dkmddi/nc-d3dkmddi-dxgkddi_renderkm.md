...
If the display miniport driver supports GDI hardware acceleration, <i>pRenderKmArgs</i>-><b>pCommand</b> points to the <a href="https://docs.microsoft.com/windows-hardware/drivers/ddi/content/d3dkmddi/ns-d3dkmddi-_dxgk_renderkm_command">DXGK_RENDERKM_COMMAND</a> command buffer.
...
| **STATUS_NO_MEMORY** | [DxgkDdiRenderKm](https://docs.microsoft.com/windows-hardware/drivers/ddi/content/d3dkmddi/nc-d3dkmddi-dxgkddi_renderkm)  could not allocate memory that was required for it to complete. | 
