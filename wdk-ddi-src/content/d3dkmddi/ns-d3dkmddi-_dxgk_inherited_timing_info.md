...
ms.date: 2/22/2018
ms.keywords: "_DXGK_INHERITED_TIMING_INFO, d3dkmddi/DXGK_INHERITED_TIMING_INFO, PDXGK_INHERITED_TIMING_INFO, display.dxgk_inherited_timing_info, PDXGK_INHERITED_TIMING_INFO structure pointer [Display Devices], *PDXGK_INHERITED_TIMING_INFO, DXGK_INHERITED_TIMING_INFO, DXGK_INHERITED_TIMING_INFO structure [Display Devices], d3dkmddi/PDXGK_INHERITED_TIMING_INFO"
