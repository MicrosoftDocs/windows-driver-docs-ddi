...
ms.date: 12/29/2017
ms.keywords: DXGK_MONITORLINKINFO, _DXGK_MONITORLINKINFO, d3dkmddi/PDXGK_MONITORLINKINFO, DXGK_MONITORLINKINFO structure [Display Devices], PDXGK_MONITORLINKINFO structure pointer [Display Devices], display.dxgk_monitorlinkinfo, d3dkmddi/DXGK_MONITORLINKINFO, PDXGK_MONITORLINKINFO
