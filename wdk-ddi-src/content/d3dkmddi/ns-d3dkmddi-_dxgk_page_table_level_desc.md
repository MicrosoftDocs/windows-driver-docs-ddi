...
ms.date: 12/29/2017
ms.keywords: display.dxgk_page_table_level_desc, DXGK_PAGE_TABLE_LEVEL_DESC structure [Display Devices], d3dkmddi/DXGK_PAGE_TABLE_LEVEL_DESC, DXGK_PAGE_TABLE_LEVEL_DESC, _DXGK_PAGE_TABLE_LEVEL_DESC
