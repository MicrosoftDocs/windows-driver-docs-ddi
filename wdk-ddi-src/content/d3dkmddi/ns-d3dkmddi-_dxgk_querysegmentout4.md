...
ms.date: 12/29/2017
ms.keywords: d3dkmddi/DXGK_QUERYSEGMENTOUT4, DXGK_QUERYSEGMENTOUT4 structure [Display Devices], DXGK_QUERYSEGMENTOUT4, display.dxgk_querysegmentout4, _DXGK_QUERYSEGMENTOUT4
