...
ms.date: 12/29/2017
ms.keywords: d3dkmddi/DXGK_PROTECTED_SESSION_STATUS_OK, DXGK_PROTECTED_SESSION_STATUS, display.dxgk_protected_session_status, _DXGK_PROTECTED_SESSION_STATUS, d3dkmddi/DXGK_PROTECTED_SESSION_STATUS_INVALID, DXGK_PROTECTED_SESSION_STATUS_INVALID, DXGK_PROTECTED_SESSION_STATUS enumeration [Display Devices], d3dkmddi/DXGK_PROTECTED_SESSION_STATUS, DXGK_PROTECTED_SESSION_STATUS_OK
