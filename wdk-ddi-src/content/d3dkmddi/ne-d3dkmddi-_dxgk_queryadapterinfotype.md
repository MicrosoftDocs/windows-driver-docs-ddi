...
ms.date: 12/29/2017
ms.keywords: DXGKQAITYPE_HISTORYBUFFERPRECISION, d3dkmddi/DXGKQAITYPE_QUERYSEGMENT, DXGKQAITYPE_QUERYSEGMENT3, d3dkmddi/DXGKQAITYPE_POWERCOMPONENTPSTATEINFO, DXGKQAITYPE_DISPLAY_DRIVERCAPS_EXTENSION, DXGK_QUERYADAPTERINFOTYPE enumeration [Display Devices], DXGK_QUERYADAPTERINFOTYPE, d3dkmddi/DXGKQAITYPE_PREFERREDGPUNODE, DXGKQAITYPE_PHYSICALADAPTERCAPS, DXGKQAITYPE_INTEGRATED_DISPLAY_DESCRIPTOR, DXGKQAITYPE_SEGMENTMEMORYSTATE, d3dkmddi/DXGKQAITYPE_GPUMMUCAPS, DXGKQAITYPE_PREFERREDGPUNODE, DXGKQAITYPE_PAGETABLELEVELDESC, d3dkmddi/DXGKQAITYPE_QUERYSEGMENT4, d3dkmddi/DXGKQAITYPE_QUERYSEGMENT3, DXGKQAITYPE_GPUMMUCAPS, DXGKQAITYPE_QUERYCOLORIMETRYOVERRIDES, d3dkmddi/DXGKQAITYPE_ALLOCATIONGROUP, DXGKQAITYPE_ALLOCATIONGROUP, DXGKQAITYPE_UMDRIVERPRIVATE, d3dkmddi/DXGKQAITYPE_QUERYSEGMENT2, d3dkmddi/DXGKQAITYPE_PHYSICALADAPTERCAPS, d3dkmddi/DXGKQAITYPE_DISPLAY_DRIVERCAPS_EXTENSION, DXGKQAITYPE_QUERYSEGMENT4, DXGKQAITYPE_POWERCOMPONENTPSTATEINFO, display.dxgk_queryadapterinfotype, DXGKQAITYPE_QUERYSEGMENT2, d3dkmddi/DXGKQAITYPE_UEFIFRAMEBUFFERRANGES, DXGKQAITYPE_QUERYSEGMENT, DmEnums_c4637ac2-b8e0-4c30-a709-5a8ff1ee3fdc.xml, DXGKQAITYPE_NUMPOWERCOMPONENTS, d3dkmddi/DXGKQAITYPE_SEGMENTMEMORYSTATE, DXGKQAITYPE_POWERCOMPONENTINFO, d3dkmddi/DXGKQAITYPE_DRIVERCAPS, DXGKQAITYPE_UEFIFRAMEBUFFERRANGES, d3dkmddi/DXGKQAITYPE_NUMPOWERCOMPONENTS, d3dkmddi/DXGKQAITYPE_PAGETABLELEVELDESC, d3dkmddi/DXGKQAITYPE_QUERYCOLORIMETRYOVERRIDES, d3dkmddi/DXGKQAITYPE_POWERCOMPONENTINFO, d3dkmddi/DXGKQAITYPE_HISTORYBUFFERPRECISION, d3dkmddi/DXGK_QUERYADAPTERINFOTYPE, d3dkmddi/DXGKQAITYPE_INTEGRATED_DISPLAY_DESCRIPTOR, d3dkmddi/DXGKQAITYPE_UMDRIVERPRIVATE, _DXGK_QUERYADAPTERINFOTYPE, DXGKQAITYPE_DRIVERCAPS
