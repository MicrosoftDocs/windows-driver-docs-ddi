...
ms.date: 12/29/2017
ms.keywords: DXGKARGCB_NOTIFY_INTERRUPT_DATA structure [Display Devices], *IN_CONST_PDXGKARGCB_NOTIFY_INTERRUPT_DATA, _DXGKARGCB_NOTIFY_INTERRUPT_DATA, d3dkmddi/DXGKARGCB_NOTIFY_INTERRUPT_DATA, STATUS_SUCCESS, display.dxgkargcb_notify_interrupt_data, STATUS_INVALID_PARAMETER, STATUS_NO_MEMORY, DXGKARGCB_NOTIFY_INTERRUPT_DATA, DmStructs_071ed85c-70d6-44d8-95e3-7f6609331f4f.xml
