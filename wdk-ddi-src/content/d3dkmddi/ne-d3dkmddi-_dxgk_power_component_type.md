...
ms.date: 2/22/2018
ms.keywords: DXGK_POWER_COMPONENT_TYPE, DXGK_POWER_COMPONENT_ENGINE, DXGK_POWER_COMPONENT_MAX, display.dxgk_power_component_type, d3dkmddi/DXGK_POWER_COMPONENT_MONITOR_REFRESH, d3dkmddi/DXGK_POWER_COMPONENT_OTHER, d3dkmddi/DXGK_POWER_COMPONENT_MONITOR, DXGK_POWER_COMPONENT_OTHER, d3dkmddi/DXGK_POWER_COMPONENT_TYPE, DXGK_POWER_COMPONENT_MONITOR_REFRESH, d3dkmddi/DXGK_POWER_COMPONENT_ENGINE, _DXGK_POWER_COMPONENT_TYPE, d3dkmddi/DXGK_POWER_COMPONENT_MAX, DXGK_POWER_COMPONENT_MONITOR, DXGK_POWER_COMPONENT_TYPE enumeration [Display Devices]
