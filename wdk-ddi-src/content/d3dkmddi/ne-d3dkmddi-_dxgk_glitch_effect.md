...
ms.date: 2/22/2018
ms.keywords: DXGK_GLITCH_EFFECT, DXGK_GLITCH_EFFECT_SEAMLESS, display.dxgk_glitch_effect, DXGK_GLITCH_EFFECT_GARBAGE_CONTENT, d3dkmddi/DXGK_GLITCH_EFFECT, DXGK_GLITCH_EFFECT enumeration [Display Devices], d3dkmddi/DXGK_GLITCH_EFFECT_SYNC_LOSS, DXGK_GLITCH_EFFECT_DEGRADED_CONTENT, d3dkmddi/DXGK_GLITCH_EFFECT_DEGRADED_CONTENT, d3dkmddi/DXGK_GLITCH_EFFECT_STALE_CONTENT, d3dkmddi/DXGK_GLITCH_EFFECT_BLACK_CONTENT, DXGK_GLITCH_EFFECT_STALE_CONTENT, _DXGK_GLITCH_EFFECT, d3dkmddi/DXGK_GLITCH_EFFECT_SEAMLESS, DXGK_GLITCH_EFFECT_BLACK_CONTENT, DXGK_GLITCH_EFFECT_SYNC_LOSS, d3dkmddi/DXGK_GLITCH_EFFECT_GARBAGE_CONTENT
