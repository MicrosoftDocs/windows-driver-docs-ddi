...
ms.date: 12/29/2017
ms.keywords: DXGK_GLITCH_EFFECT, d3dkmddi/DXGK_GLITCH_EFFECT_STALE_CONTENT, d3dkmddi/DXGK_GLITCH_EFFECT_DEGRADED_CONTENT, DXGK_GLITCH_EFFECT_GARBAGE_CONTENT, d3dkmddi/DXGK_GLITCH_EFFECT, display.dxgk_glitch_effect, d3dkmddi/DXGK_GLITCH_EFFECT_GARBAGE_CONTENT, DXGK_GLITCH_EFFECT_STALE_CONTENT, DXGK_GLITCH_EFFECT_BLACK_CONTENT, DXGK_GLITCH_EFFECT_SEAMLESS, _DXGK_GLITCH_EFFECT, DXGK_GLITCH_EFFECT_DEGRADED_CONTENT, DXGK_GLITCH_EFFECT_SYNC_LOSS, d3dkmddi/DXGK_GLITCH_EFFECT_SYNC_LOSS, d3dkmddi/DXGK_GLITCH_EFFECT_BLACK_CONTENT, DXGK_GLITCH_EFFECT enumeration [Display Devices], d3dkmddi/DXGK_GLITCH_EFFECT_SEAMLESS
