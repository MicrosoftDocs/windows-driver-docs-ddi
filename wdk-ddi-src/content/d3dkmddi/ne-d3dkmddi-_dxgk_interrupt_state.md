...
ms.date: 12/29/2017
ms.keywords: DXGK_INTERRUPT_STATE, display.dxgk_interrupt_state, d3dkmddi/DXGK_INTERRUPT_STATE, DXGK_INTERRUPT_ENABLE, DXGK_INTERRUPT_STATE enumeration [Display Devices], d3dkmddi/DXGK_INTERRUPT_DISABLE, _DXGK_INTERRUPT_STATE, DXGK_INTERRUPT_DISABLE, d3dkmddi/DXGK_INTERRUPT_ENABLE
