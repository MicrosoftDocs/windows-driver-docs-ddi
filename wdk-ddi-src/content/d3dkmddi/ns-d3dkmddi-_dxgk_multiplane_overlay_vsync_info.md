...
ms.date: 2/22/2018
ms.keywords: DXGK_MULTIPLANE_OVERLAY_VSYNC_INFO structure [Display Devices], DXGK_MULTIPLANE_OVERLAY_VSYNC_INFO, _DXGK_MULTIPLANE_OVERLAY_VSYNC_INFO, display.dxgk_multiplane_overlay_vsync_info, d3dkmddi/DXGK_MULTIPLANE_OVERLAY_VSYNC_INFO
