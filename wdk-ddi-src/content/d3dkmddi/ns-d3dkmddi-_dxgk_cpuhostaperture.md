...
ms.date: 12/29/2017
ms.keywords: DXGK_CPUHOSTAPERTURE, d3dkmddi/DXGK_CPUHOSTAPERTURE, _DXGK_CPUHOSTAPERTURE, DXGK_CPUHOSTAPERTURE structure [Display Devices], display.dxgk_cpuhostaperture
