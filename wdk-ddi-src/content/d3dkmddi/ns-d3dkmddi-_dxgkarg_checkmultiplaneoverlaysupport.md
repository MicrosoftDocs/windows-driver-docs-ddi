...
ms.date: 12/29/2017
ms.keywords: PDXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT structure pointer [Display Devices], *IN_OUT_PDXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT, DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT, d3dkmddi/PDXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT, display.dxgkarg_checkmultiplaneoverlaysupport, d3dkmddi/DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT, PDXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT, DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT structure [Display Devices], _DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT
