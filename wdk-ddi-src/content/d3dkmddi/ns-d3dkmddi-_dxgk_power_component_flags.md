...
ms.date: 2/22/2018
ms.keywords: display.dxgk_power_component_flags, DXGK_POWER_COMPONENT_FLAGS, _DXGK_POWER_COMPONENT_FLAGS, d3dkmddi/DXGK_POWER_COMPONENT_FLAGS, DXGK_POWER_COMPONENT_FLAGS structure [Display Devices]
