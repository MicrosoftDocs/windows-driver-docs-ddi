...
ms.date: 12/29/2017
ms.keywords: d3dkmddi/PDXGK_CONNECTION_CHANGE, DXGK_CONNECTION_CHANGE structure [Display Devices], _DXGK_CONNECTION_CHANGE, PDXGK_CONNECTION_CHANGE structure pointer [Display Devices], d3dkmddi/DXGK_CONNECTION_CHANGE, *PDXGK_CONNECTION_CHANGE, DXGK_CONNECTION_CHANGE, display.dxgk_connection_change, PDXGK_CONNECTION_CHANGE
