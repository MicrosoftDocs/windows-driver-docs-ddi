...
The **DXGKARGCB_NOTIFYCURSORSUPPORTCHANGE** structure contains arguments for the [**DxgkCbNotifyCursorSupportChange**](nc-d3dkmddi-dxgkcb_notifycursorsupportchange.md) callback function.
...
[**DxgkCbNotifyCursorSupportChange**](nc-d3dkmddi-dxgkcb_notifycursorsupportchange.md)
