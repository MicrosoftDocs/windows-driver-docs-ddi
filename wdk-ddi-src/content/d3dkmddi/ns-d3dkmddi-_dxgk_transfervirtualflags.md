...
ms.date: 2/22/2018
ms.keywords: d3dkmddi/DXGK_TRANSFERVIRTUALFLAGS, _DXGK_TRANSFERVIRTUALFLAGS, DXGK_TRANSFERVIRTUALFLAGS, DXGK_TRANSFERVIRTUALFLAGS structure [Display Devices], display.dxgk_transfervirtualflags
