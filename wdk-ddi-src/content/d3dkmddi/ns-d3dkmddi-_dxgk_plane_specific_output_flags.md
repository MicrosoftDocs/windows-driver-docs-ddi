...
ms.date: 12/29/2017
ms.keywords: display.dxgk_plane_specific_output_flags, _DXGK_PLANE_SPECIFIC_OUTPUT_FLAGS, d3dkmddi/DXGK_PLANE_SPECIFIC_OUTPUT_FLAGS, DXGK_PLANE_SPECIFIC_OUTPUT_FLAGS structure [Display Devices], DXGK_PLANE_SPECIFIC_OUTPUT_FLAGS
