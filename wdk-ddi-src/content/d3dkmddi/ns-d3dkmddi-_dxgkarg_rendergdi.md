...
ms.date: 2/22/2018
ms.keywords: DXGKARG_RENDERGDI structure [Display Devices], display.dxgkarg_rendergdi, _DXGKARG_RENDERGDI, *INOUT_PDXGKARG_RENDERGDI, d3dkmddi/DXGKARG_RENDERGDI, DXGKARG_RENDERGDI
