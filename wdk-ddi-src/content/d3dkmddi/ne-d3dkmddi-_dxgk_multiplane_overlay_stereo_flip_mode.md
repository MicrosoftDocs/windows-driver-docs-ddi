...
ms.date: 12/29/2017
ms.keywords: DXGK_MULTIPLANE_OVERLAY_STEREO_FLIP_FRAME0, _DXGK_MULTIPLANE_OVERLAY_STEREO_FLIP_MODE, DXGK_MULTIPLANE_OVERLAY_STEREO_FLIP_MODE enumeration [Display Devices], d3dkmddi/DXGK_MULTIPLANE_OVERLAY_STEREO_FLIP_MODE, display.dxgk_multiplane_overlay_stereo_flip_mode, d3dkmddi/DXGK_MULTIPLANE_OVERLAY_STEREO_FLIP_FRAME1, d3dkmddi/DXGK_MULTIPLANE_OVERLAY_STEREO_FLIP_NONE, d3dkmddi/DXGK_MULTIPLANE_OVERLAY_STEREO_FLIP_FRAME0, DXGK_MULTIPLANE_OVERLAY_STEREO_FLIP_FRAME1, DXGK_MULTIPLANE_OVERLAY_STEREO_FLIP_MODE, DXGK_MULTIPLANE_OVERLAY_STEREO_FLIP_NONE
