...
ms.date: 2/22/2018
ms.keywords: d3dkmddi/LinkConfigurationFailed, d3dkmddi/DXGK_CONNECTION_STATUS, display.dxgk_connection_status, TargetStatusDisconnected, MonitorStatusUnknown, DXGK_CONNECTION_STATUS, d3dkmddi/TargetStatusJoined, LinkConfigurationSucceeded, d3dkmddi/TargetStatusConnected, MonitorStatusDisconnected, d3dkmddi/MonitorStatusUnknown, *PDXGK_CONNECTION_STATUS, d3dkmddi/MonitorStatusConnected, MonitorStatusConnected, d3dkmddi/LinkConfigurationSucceeded, LinkConfigurationFailed, d3dkmddi/TargetStatusDisconnected, LinkConfigurationStarted, TargetStatusJoined, DXGK_CONNECTION_STATUS enumeration [Display Devices], d3dkmddi/ConnectionStatusUninitialized, TargetStatusConnected, d3dkmddi/MonitorStatusDisconnected, d3dkmddi/LinkConfigurationStarted, _DXGK_CONNECTION_STATUS, ConnectionStatusUninitialized
