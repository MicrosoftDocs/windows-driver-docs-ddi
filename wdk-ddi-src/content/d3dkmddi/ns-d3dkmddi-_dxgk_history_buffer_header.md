...
ms.date: 2/22/2018
ms.keywords: d3dkmddi/DXGK_HISTORY_BUFFER_HEADER, DXGK_HISTORY_BUFFER_HEADER structure [Display Devices], DXGK_HISTORY_BUFFER_HEADER, display.dxgk_history_buffer_header, _DXGK_HISTORY_BUFFER_HEADER
