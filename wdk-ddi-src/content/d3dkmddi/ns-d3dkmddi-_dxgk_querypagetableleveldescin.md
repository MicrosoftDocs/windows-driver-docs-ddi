...
ms.date: 2/24/2018
ms.keywords: ",  , ,, A, B, C, D, DXGK_QUERYPAGETABLELEVELDESCIN, DXGK_QUERYPAGETABLELEVELDESCIN structure [Display Devices], E, G, I, K, L, N, P, Q, R, S, T, U, V, X, Y, _, _DXGK_QUERYPAGETABLELEVELDESCIN, d3dkmddi/DXGK_QUERYPAGETABLELEVELDESCIN, display.dxgk_querypagetableleveldescin"
