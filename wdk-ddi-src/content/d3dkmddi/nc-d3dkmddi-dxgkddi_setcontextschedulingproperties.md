...
Implemented by the client driver to set up or modify the scheduling properties for a device context.
...
Pointer to a DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES structure that contains the scheduling properties.
