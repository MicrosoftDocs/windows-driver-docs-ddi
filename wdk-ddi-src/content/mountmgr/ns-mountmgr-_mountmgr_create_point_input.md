...
ms.date: 2/16/2018
ms.keywords: structs-mntmgr_24dea6c0-cfff-4f87-a8d3-c019aa5b46c3.xml, MOUNTMGR_CREATE_POINT_INPUT structure [Storage Devices], _MOUNTMGR_CREATE_POINT_INPUT, *PMOUNTMGR_CREATE_POINT_INPUT, mountmgr/PMOUNTMGR_CREATE_POINT_INPUT, PMOUNTMGR_CREATE_POINT_INPUT, PMOUNTMGR_CREATE_POINT_INPUT structure pointer [Storage Devices], mountmgr/MOUNTMGR_CREATE_POINT_INPUT, storage.mountmgr_create_point_input, MOUNTMGR_CREATE_POINT_INPUT
