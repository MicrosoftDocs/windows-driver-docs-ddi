...
ms.date: 2/16/2018
ms.keywords: PMOUNTDEV_NAME structure pointer [Storage Devices], mountmgr/MOUNTDEV_NAME, mountmgr/PMOUNTDEV_NAME, _MOUNTDEV_NAME, *PMOUNTDEV_NAME, storage.mountdev_name, MOUNTDEV_NAME, MOUNTDEV_NAME structure [Storage Devices], structs-mntmgr_b7eec4f5-e4fc-4931-82e5-c6ac5cd4b48f.xml, PMOUNTDEV_NAME
