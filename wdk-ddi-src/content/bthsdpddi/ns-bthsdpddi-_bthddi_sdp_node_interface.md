...
ms.date: 12/21/2017
ms.keywords: bltooth.bthddi_sdp_node_interface, PBTHDDI_SDP_NODE_INTERFACE structure pointer [Bluetooth Devices], BTHDDI_SDP_NODE_INTERFACE structure [Bluetooth Devices], BTHDDI_SDP_NODE_INTERFACE, *PBTHDDI_SDP_NODE_INTERFACE, bthsdpddi/PBTHDDI_SDP_NODE_INTERFACE, bth_structs_54f8f76d-9f12-491d-b189-c4e2fdd9b364.xml, bthsdpddi/BTHDDI_SDP_NODE_INTERFACE, PBTHDDI_SDP_NODE_INTERFACE, _BTHDDI_SDP_NODE_INTERFACE
...
A pointer to the 
     <mshelp:link keywords="bltooth.sdpcreatenodealternative" tabindex="0"><b>
     SdpCreateNodeAlternative</b></mshelp:link> function.


### -field SdpCreateNodeSequence

A pointer to the 
     <mshelp:link keywords="bltooth.sdpcreatenodesequence" tabindex="0"><b>
     SdpCreateNodeSequence</b></mshelp:link> function.


### -field SdpAddAttributeToTree

A pointer to the 
     <mshelp:link keywords="bltooth.sdpaddattributetotree" tabindex="0"><b>
     SdpAddAttributeToTree</b></mshelp:link> function.
...
A pointer to the 
     ...
     SdpAppendNodeToContainerNode</b></mshelp:link> function.
